...
{
    [Cmdlet("Get", "OCIJmsWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.JmsService.Models.WorkRequestErrorCollection), typeof(Oci.JmsService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIJmsWorkRequestErrorsList : OCIJavaManagementServiceCmdlet
    {
