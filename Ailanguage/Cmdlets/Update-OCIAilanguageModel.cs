...
{
    [Cmdlet("Update", "OCIAilanguageModel")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AilanguageService.Responses.UpdateModelResponse) })]
    public class UpdateOCIAilanguageModel : OCIAIServiceLanguageCmdlet
    {
