...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementDiscoverExternalExadataInfrastructure")]
    ...
    public class InvokeOCIDatabasemanagementDiscoverExternalExadataInfrastructure : OCIDbManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DiscoverExternalExadataInfrastructureRequest
                {
                ...
                response = client.DiscoverExternalExadataInfrastructure(request).GetAwaiter().GetResult();
                WriteOutput(response, response.ExternalExadataInfrastructureDiscovery);
        ...
        private DiscoverExternalExadataInfrastructureResponse response;
    }
}
