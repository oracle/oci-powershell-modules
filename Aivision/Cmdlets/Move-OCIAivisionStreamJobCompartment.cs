...
{
    [Cmdlet("Move", "OCIAivisionStreamJobCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AivisionService.Responses.ChangeStreamJobCompartmentResponse) })]
    public class MoveOCIAivisionStreamJobCompartment : OCIAIServiceVisionCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeStreamJobCompartmentRequest
                {
                ...
                response = client.ChangeStreamJobCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeStreamJobCompartmentResponse response;
    }
}
