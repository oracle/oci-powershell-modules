...
namespace Oci.FleetappsmanagementService.Cmdlets
{
     ...
     */
    [Cmdlet("Export", "OCIFleetappsmanagementComplianceReport", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.FleetappsmanagementService.Responses.ExportComplianceReportResponse) })]
    public class ExportOCIFleetappsmanagementComplianceReport : OCIFleetAppsManagementOperationsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for generating compliance report")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ExportComplianceReportRequest
                {
                ...
                response = client.ExportComplianceReport(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private ExportComplianceReportResponse response;
