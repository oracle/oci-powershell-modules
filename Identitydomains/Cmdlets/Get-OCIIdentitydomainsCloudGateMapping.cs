...
{
    [Cmdlet("Get", "OCIIdentitydomainsCloudGateMapping")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.CloudGateMapping), typeof(Oci.IdentitydomainsService.Responses.GetCloudGateMappingResponse) })]
    public class GetOCIIdentitydomainsCloudGateMapping : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetCloudGateMappingRequest
                {
                ...
                response = client.GetCloudGateMapping(request).GetAwaiter().GetResult();
        ...
        private GetCloudGateMappingResponse response;
    }
}
