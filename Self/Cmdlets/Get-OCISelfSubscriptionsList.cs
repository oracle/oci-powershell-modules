...
{
    [Cmdlet("Get", "OCISelfSubscriptionsList")]
    [OutputType(new System.Type[] { typeof(Oci.SelfService.Models.SubscriptionCollection), typeof(Oci.SelfService.Responses.ListSubscriptionsResponse) })]
    public class GetOCISelfSubscriptionsList : OCISubscriptionCmdlet
    {
        ...
        public System.Nullable<Oci.SelfService.Models.LifecycleDetailsEnum> LifecycleDetails { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Subscription.")]
        ...
        public System.Nullable<Oci.SelfService.Requests.ListSubscriptionsRequest.SortByEnum> SortBy { get; set; }
