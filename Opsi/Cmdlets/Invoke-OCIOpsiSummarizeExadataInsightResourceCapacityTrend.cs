...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeExadataInsightResourceCapacityTrend")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.SummarizeExadataInsightResourceCapacityTrendCollection), typeof(Oci.OpsiService.Responses.SummarizeExadataInsightResourceCapacityTrendResponse) })]
    public class InvokeOCIOpsiSummarizeExadataInsightResourceCapacityTrend : OCIOperationsInsightsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"[OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of exadata insight resource.")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Optional list of host insight resource [OCIDs](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The order in which resource capacity trend records are listed")]
        public System.Nullable<Oci.OpsiService.Requests.SummarizeExadataInsightResourceCapacityTrendRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeExadataInsightResourceCapacityTrendRequest
                {
                ...
                response = client.SummarizeExadataInsightResourceCapacityTrend(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SummarizeExadataInsightResourceCapacityTrendCollection);
        ...
        private SummarizeExadataInsightResourceCapacityTrendResponse response;
    }
}
