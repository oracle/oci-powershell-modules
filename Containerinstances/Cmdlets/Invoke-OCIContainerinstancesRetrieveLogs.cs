...
namespace Oci.ContainerinstancesService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIContainerinstancesRetrieveLogs", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.ContainerinstancesService.Responses.RetrieveLogsResponse) })]
    public class InvokeOCIContainerinstancesRetrieveLogs : OCIContainerInstanceCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the container.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RetrieveLogsRequest
                {
                ...
                response = client.RetrieveLogs(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private RetrieveLogsResponse response;
