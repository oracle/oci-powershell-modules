...
using Oci.MngdmacService;

namespace Oci.MngdmacService.Cmdlets
{
    public abstract class OCIMacDeviceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MacDeviceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MacDeviceClient client;
