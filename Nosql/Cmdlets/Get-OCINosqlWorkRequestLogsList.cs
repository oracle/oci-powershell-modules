...
{
    [Cmdlet("Get", "OCINosqlWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.NosqlService.Models.WorkRequestLogEntryCollection), typeof(Oci.NosqlService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCINosqlWorkRequestLogsList : OCINosqlCmdlet
    {
