...
{
    [Cmdlet("Get", "OCIIdentitydomainsApp")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.App), typeof(Oci.IdentitydomainsService.Responses.GetAppResponse) })]
    public class GetOCIIdentitydomainsApp : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GetApp(request).GetAwaiter().GetResult();
        ...
        private GetAppResponse response;
    }
}
