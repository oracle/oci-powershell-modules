...
{
    [Cmdlet("Get", "OCIDevopsWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.WorkRequestCollection), typeof(Oci.DevopsService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIDevopsWorkRequestsList : OCIDevopsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only resources where the lifecycle state matches the given operation status.")]
        public System.Nullable<Oci.DevopsService.Models.OperationStatus> Status { get; set; }
