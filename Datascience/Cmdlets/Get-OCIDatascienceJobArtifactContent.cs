...
namespace Oci.DatascienceService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIDatascienceJobArtifactContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatascienceService.Responses.GetJobArtifactContentResponse) })]
    public class GetOCIDatascienceJobArtifactContent : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetJobArtifactContentRequest
                {
                    JobId = JobId,
                ...
                response = client.GetJobArtifactContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetJobArtifactContentResponse response;
