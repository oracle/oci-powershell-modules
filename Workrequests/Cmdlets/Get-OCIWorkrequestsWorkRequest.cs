...
namespace Oci.WorkrequestsService.Cmdlets
{
    ...
    [OutputType(new System.Type[] { typeof(Oci.WorkrequestsService.Models.WorkRequest), typeof(Oci.WorkrequestsService.Responses.GetWorkRequestResponse) })]
    public class GetOCIWorkrequestsWorkRequest : OCIWorkRequestCmdlet
    {
        ...
        public Oci.WorkrequestsService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
