...
{
    [Cmdlet("Get", "OCIDataintegrationWorkspace", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.Workspace), typeof(Oci.DataintegrationService.Responses.GetWorkspaceResponse) })]
    public class GetOCIDataintegrationWorkspace : OCIDataIntegrationCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"DIS workspace id", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"DIS workspace id", ParameterSetName = Default)]
        ...
        public Oci.DataintegrationService.Models.Workspace.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        private GetWorkspaceResponse response;
