...
{
    [Cmdlet("Update", "OCIDatasciencePrivateEndpoint")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.DataSciencePrivateEndpoint), typeof(Oci.DatascienceService.Responses.UpdateDataSciencePrivateEndpointResponse) })]
    public class UpdateOCIDatasciencePrivateEndpoint : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDataSciencePrivateEndpointRequest
                {
                ...
                response = client.UpdateDataSciencePrivateEndpoint(request).GetAwaiter().GetResult();
        ...
        private UpdateDataSciencePrivateEndpointResponse response;
    }
}
