...
using Oci.DatabasetoolsService;

namespace Oci.DatabasetoolsService.Cmdlets
{
    public abstract class OCIDatabaseToolsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DatabaseToolsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DatabaseToolsClient client;
