...
{
    [Cmdlet("New", "OCIMysqlReplica")]
    [OutputType(new System.Type[] { typeof(Oci.MysqlService.Models.Replica), typeof(Oci.MysqlService.Responses.CreateReplicaResponse) })]
    public class NewOCIMysqlReplica : OCIReplicasCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The parameters of the request to create the read replica.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateReplicaRequest
                {
                ...
                response = client.CreateReplica(request).GetAwaiter().GetResult();
        ...
        private CreateReplicaResponse response;
    }
}
