...
{
    [Cmdlet("Get", "OCIClusterplacementgroupsWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.ClusterplacementgroupsService.Models.WorkRequest), typeof(Oci.ClusterplacementgroupsService.Responses.GetWorkRequestResponse) })]
    public class GetOCIClusterplacementgroupsWorkRequest : OCIClusterPlacementGroupsCPCmdlet
    {
        ...
        public Oci.ClusterplacementgroupsService.Models.OperationStatus[] WaitForStatus { get; set; }
