...
namespace Oci.DatabaseService.Cmdlets
{
    ...
    public class NewOCIDatabaseDbSystem : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to launch a DB system. This parameter also accepts subtypes <Oci.DatabaseService.Models.LaunchDbSystemDetails>, <Oci.DatabaseService.Models.LaunchDbSystemFromDatabaseDetails>, <Oci.DatabaseService.Models.LaunchDbSystemFromBackupDetails> of type <Oci.DatabaseService.Models.LaunchDbSystemBase>.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to launch a DB system. This parameter also accepts subtypes <Oci.DatabaseService.Models.LaunchDbSystemDetails>, <Oci.DatabaseService.Models.LaunchDbSystemFromDatabaseDetails>, <Oci.DatabaseService.Models.LaunchDbSystemFromBackupDetails> of type <Oci.DatabaseService.Models.LaunchDbSystemBase>.", ParameterSetName = Default)]
