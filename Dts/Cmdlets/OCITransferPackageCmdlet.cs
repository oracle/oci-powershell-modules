...
{
    public abstract class OCITransferPackageCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new TransferPackageClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected TransferPackageClient client;
