...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchSecurityQuestions")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SecurityQuestions), typeof(Oci.IdentitydomainsService.Responses.SearchSecurityQuestionsResponse) })]
    public class InvokeOCIIdentitydomainsSearchSecurityQuestions : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching SecurityQuestions")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchSecurityQuestionsRequest
                {
                ...
                response = client.SearchSecurityQuestions(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SecurityQuestions);
        ...
        private SearchSecurityQuestionsResponse response;
    }
}
