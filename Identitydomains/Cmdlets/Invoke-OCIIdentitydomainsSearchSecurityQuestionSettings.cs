...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchSecurityQuestionSettings")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SecurityQuestionSettings), typeof(Oci.IdentitydomainsService.Responses.SearchSecurityQuestionSettingsResponse) })]
    public class InvokeOCIIdentitydomainsSearchSecurityQuestionSettings : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching SecurityQuestionSettings")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchSecurityQuestionSettingsRequest
                {
                ...
                response = client.SearchSecurityQuestionSettings(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SecurityQuestionSettings);
        ...
        private SearchSecurityQuestionSettingsResponse response;
    }
}
