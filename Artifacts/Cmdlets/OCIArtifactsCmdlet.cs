...
{
    public abstract class OCIArtifactsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ArtifactsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ArtifactsClient client;
