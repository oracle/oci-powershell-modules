...
{
    [Cmdlet("Move", "OCIMediaservicesMediaAssetCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.MediaservicesService.Responses.ChangeMediaAssetCompartmentResponse) })]
    public class MoveOCIMediaservicesMediaAssetCompartment : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeMediaAssetCompartmentRequest
                {
                ...
                response = client.ChangeMediaAssetCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeMediaAssetCompartmentResponse response;
    }
}
