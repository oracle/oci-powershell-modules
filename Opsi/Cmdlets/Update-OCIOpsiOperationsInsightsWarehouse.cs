...
{
    [Cmdlet("Update", "OCIOpsiOperationsInsightsWarehouse")]
    ...
    public class UpdateOCIOpsiOperationsInsightsWarehouse : OCIOperationsInsightsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateOperationsInsightsWarehouseRequest
                {
                ...
                response = client.UpdateOperationsInsightsWarehouse(request).GetAwaiter().GetResult();
        ...
        private UpdateOperationsInsightsWarehouseResponse response;
    }
}
