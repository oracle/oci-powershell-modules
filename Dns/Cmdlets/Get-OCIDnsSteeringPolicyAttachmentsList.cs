...
{
    [Cmdlet("Get", "OCIDnsSteeringPolicyAttachmentsList")]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.SteeringPolicyAttachmentSummary), typeof(Oci.DnsService.Responses.ListSteeringPolicyAttachmentsResponse) })]
    public class GetOCIDnsSteeringPolicyAttachmentsList : OCIDnsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Search by steering policy OCID. Will match any resource whose steering policy ID matches the provided value.")]
        public string SteeringPolicyId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Search by zone OCID. Will match any resource whose zone ID matches the provided value.")]
        ...
        public System.Nullable<Oci.DnsService.Models.SteeringPolicyAttachmentSummary.LifecycleStateEnum> LifecycleState { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field by which to sort steering policy attachments. If unspecified, defaults to `timeCreated`.")]
        public System.Nullable<Oci.DnsService.Requests.ListSteeringPolicyAttachmentsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSteeringPolicyAttachmentsRequest
                {
        ...
        {
            IEnumerable<ListSteeringPolicyAttachmentsResponse> DefaultRequest(ListSteeringPolicyAttachmentsRequest request) => Enumerable.Repeat(client.ListSteeringPolicyAttachments(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSteeringPolicyAttachmentsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSteeringPolicyAttachmentsResponse response;
        private delegate IEnumerable<ListSteeringPolicyAttachmentsResponse> RequestDelegate(ListSteeringPolicyAttachmentsRequest request);
