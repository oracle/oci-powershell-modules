...
{
    [Cmdlet("Remove", "OCIGoldengateDeploymentLocalPeer")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.RemoveDeploymentLocalPeerResponse) })]
    public class RemoveOCIGoldengateDeploymentLocalPeer : OCIGoldenGateCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A unique Deployment identifier.")]
        public string DeploymentId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Metadata to remove a local deployment peer")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveDeploymentLocalPeerRequest
                {
                ...
                response = client.RemoveDeploymentLocalPeer(request).GetAwaiter().GetResult();
        ...
        private RemoveDeploymentLocalPeerResponse response;
    }
}
