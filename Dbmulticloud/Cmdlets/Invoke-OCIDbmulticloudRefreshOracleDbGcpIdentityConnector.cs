...
{
    [Cmdlet("Invoke", "OCIDbmulticloudRefreshOracleDbGcpIdentityConnector")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DbmulticloudService.Responses.RefreshOracleDbGcpIdentityConnectorResponse) })]
    public class InvokeOCIDbmulticloudRefreshOracleDbGcpIdentityConnector : OCIDbMulticloudGCPProviderCmdlet
    {
...
For example, if a resource has been deleted and permanently purged from the system, a retry of the original creation request may be rejected.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RefreshOracleDbGcpIdentityConnectorRequest
                {
                ...
                response = client.RefreshOracleDbGcpIdentityConnector(request).GetAwaiter().GetResult();
        ...
        private RefreshOracleDbGcpIdentityConnectorResponse response;
    }
}
