...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeHostInsightResourceUsageTrend")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.SummarizeHostInsightResourceUsageTrendAggregationCollection), typeof(Oci.OpsiService.Responses.SummarizeHostInsightResourceUsageTrendResponse) })]
    public class InvokeOCIOpsiSummarizeHostInsightResourceUsageTrend : OCIOperationsInsightsCmdlet
    {
        ...
        public System.Collections.Generic.List<Oci.OpsiService.Requests.SummarizeHostInsightResourceUsageTrendRequest.PlatformTypeEnum> PlatformType { get; set; }
        ...
        public System.Nullable<Oci.OpsiService.Requests.SummarizeHostInsightResourceUsageTrendRequest.SortByEnum> SortBy { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Optional [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the host (Compute Id)")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeHostInsightResourceUsageTrendRequest
                {
                ...
                response = client.SummarizeHostInsightResourceUsageTrend(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SummarizeHostInsightResourceUsageTrendAggregationCollection);
        ...
        private SummarizeHostInsightResourceUsageTrendResponse response;
    }
}
