...
{
    [Cmdlet("Get", "OCIArtifactsGenericArtifact", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.ArtifactsService.Models.GenericArtifact), typeof(Oci.ArtifactsService.Responses.GetGenericArtifactResponse) })]
...
Example: `ocid1.genericartifact.oc1..exampleuniqueID`", ParameterSetName = Default)]
        ...
        public Oci.ArtifactsService.Models.GenericArtifact.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetGenericArtifactRequest
                {
        ...
        private void HandleOutput(GetGenericArtifactRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForGenericArtifact(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetGenericArtifact(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.GenericArtifact);
        }

        private GetGenericArtifactResponse response;
