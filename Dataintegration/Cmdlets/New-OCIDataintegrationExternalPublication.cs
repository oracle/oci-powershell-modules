...
{
    [Cmdlet("New", "OCIDataintegrationExternalPublication")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.ExternalPublication), typeof(Oci.DataintegrationService.Responses.CreateExternalPublicationResponse) })]
    public class NewOCIDataintegrationExternalPublication : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details needed to publish a task to OCI DataFlow application.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateExternalPublicationRequest
                {
                ...
                response = client.CreateExternalPublication(request).GetAwaiter().GetResult();
                WriteOutput(response, response.ExternalPublication);
        ...
        private CreateExternalPublicationResponse response;
    }
}
