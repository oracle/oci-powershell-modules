...
{
    [Cmdlet("Move", "OCIComputeHostGroupCompartment", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.ChangeComputeHostGroupCompartmentResponse) })]
    public class MoveOCIComputeHostGroupCompartment : OCIComputeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeComputeHostGroupCompartmentRequest
                {
        ...
        private void HandleOutput(ChangeComputeHostGroupCompartmentRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForChangeComputeHostGroupCompartment(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ChangeComputeHostGroupCompartment(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private ChangeComputeHostGroupCompartmentResponse response;
