...
{
    [Cmdlet("Remove", "OCICloudguardManagedList", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCICloudguardManagedList : OCICloudGuardCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCICloudguardManagedList", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteManagedListRequest
                {
                ...
                response = client.DeleteManagedList(request).GetAwaiter().GetResult();
        ...
        private DeleteManagedListResponse response;
    }
}
