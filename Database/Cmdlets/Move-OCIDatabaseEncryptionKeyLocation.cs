...
namespace Oci.DatabaseService.Cmdlets
{
    ...
    public class MoveOCIDatabaseEncryptionKeyLocation : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to change the source of the encryption key for the database. This parameter also accepts subtype <Oci.DatabaseService.Models.ExternalHsmEncryptionDetails> of type <Oci.DatabaseService.Models.EncryptionKeyLocationDetails>.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to change the source of the encryption key for the database. This parameter also accepts subtype <Oci.DatabaseService.Models.ExternalHsmEncryptionDetails> of type <Oci.DatabaseService.Models.EncryptionKeyLocationDetails>.", ParameterSetName = Default)]
