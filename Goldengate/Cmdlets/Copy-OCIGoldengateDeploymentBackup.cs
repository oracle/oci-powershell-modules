...
namespace Oci.GoldengateService.Cmdlets
{
    ...
    public class CopyOCIGoldengateDeploymentBackup : OCIGoldenGateCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A placeholder for any additional metadata to describe the copy of a Deployment Backup.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CopyDeploymentBackupRequest
                {
        ...
        private CopyDeploymentBackupResponse response;
    }
}
