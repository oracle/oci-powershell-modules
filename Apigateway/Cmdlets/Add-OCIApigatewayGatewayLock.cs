...
{
    [Cmdlet("Add", "OCIApigatewayGatewayLock")]
    [OutputType(new System.Type[] { typeof(Oci.ApigatewayService.Models.Gateway), typeof(Oci.ApigatewayService.Responses.AddGatewayLockResponse) })]
    public class AddOCIApigatewayGatewayLock : OCIGatewayCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddGatewayLockRequest
                {
                    GatewayId = GatewayId,
                ...
                response = client.AddGatewayLock(request).GetAwaiter().GetResult();
        ...
        private AddGatewayLockResponse response;
    }
}
