...
{
    [Cmdlet("Invoke", "OCIGoldengateClonePipeline")]
    [OutputType(new System.Type[] { typeof(Oci.GoldengateService.Models.Pipeline), typeof(Oci.GoldengateService.Responses.ClonePipelineResponse) })]
    public class InvokeOCIGoldengateClonePipeline : OCIGoldenGateCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details to clone the pipeline. This parameter also accepts subtype <Oci.GoldengateService.Models.DefaultClonePipelineDetails> of type <Oci.GoldengateService.Models.ClonePipelineDetails>.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ClonePipelineRequest
                {
                ...
                response = client.ClonePipeline(request).GetAwaiter().GetResult();
        ...
        private ClonePipelineResponse response;
    }
}
