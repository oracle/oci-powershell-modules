...
{
    public abstract class OCIAIServiceDocumentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AIServiceDocumentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AIServiceDocumentClient client;
