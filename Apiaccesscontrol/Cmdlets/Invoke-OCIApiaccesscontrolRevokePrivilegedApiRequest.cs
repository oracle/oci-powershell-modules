...
{
    [Cmdlet("Invoke", "OCIApiaccesscontrolRevokePrivilegedApiRequest")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApiaccesscontrolService.Responses.RevokePrivilegedApiRequestResponse) })]
    public class InvokeOCIApiaccesscontrolRevokePrivilegedApiRequest : OCIPrivilegedApiRequestsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details regarding the revocation of privilegedApi request created by the operator.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RevokePrivilegedApiRequestRequest
                {
                ...
                response = client.RevokePrivilegedApiRequest(request).GetAwaiter().GetResult();
        ...
        private RevokePrivilegedApiRequestResponse response;
    }
}
