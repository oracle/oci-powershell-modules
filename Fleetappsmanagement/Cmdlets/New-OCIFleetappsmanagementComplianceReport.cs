...
{
    [Cmdlet("New", "OCIFleetappsmanagementComplianceReport")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.FleetappsmanagementService.Responses.GenerateComplianceReportResponse) })]
    public class NewOCIFleetappsmanagementComplianceReport : OCIFleetAppsManagementCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for generating Compliance Report fort the Fleet.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GenerateComplianceReport(request).GetAwaiter().GetResult();
        ...
        private GenerateComplianceReportResponse response;
    }
}
