...
namespace Oci.DatascienceService.Cmdlets
{
    ...
    public class GetOCIDatascienceJobRunsList : OCIDataScienceCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the job.")]
