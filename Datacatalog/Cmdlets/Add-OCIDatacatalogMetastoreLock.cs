...
{
    [Cmdlet("Add", "OCIDatacatalogMetastoreLock")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Metastore), typeof(Oci.DatacatalogService.Responses.AddMetastoreLockResponse) })]
    public class AddOCIDatacatalogMetastoreLock : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddMetastoreLockRequest
                {
                ...
                response = client.AddMetastoreLock(request).GetAwaiter().GetResult();
        ...
        private AddMetastoreLockResponse response;
    }
}
