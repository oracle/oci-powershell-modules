...
{
    [Cmdlet("Remove", "OCIApigatewayUsagePlan", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApigatewayService.Responses.DeleteUsagePlanResponse) })]
    public class RemoveOCIApigatewayUsagePlan : OCIUsagePlansCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIApigatewayUsagePlan", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteUsagePlanRequest
                {
                ...
                response = client.DeleteUsagePlan(request).GetAwaiter().GetResult();
        ...
        private DeleteUsagePlanResponse response;
    }
}
