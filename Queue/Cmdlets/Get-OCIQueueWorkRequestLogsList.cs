...
{
    [Cmdlet("Get", "OCIQueueWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.QueueService.Models.WorkRequestLogEntryCollection), typeof(Oci.QueueService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIQueueWorkRequestLogsList : OCIQueueAdminCmdlet
    {
