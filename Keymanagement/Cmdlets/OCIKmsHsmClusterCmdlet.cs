...
{
    public abstract class OCIKmsHsmClusterCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new KmsHsmClusterClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected KmsHsmClusterClient client;
