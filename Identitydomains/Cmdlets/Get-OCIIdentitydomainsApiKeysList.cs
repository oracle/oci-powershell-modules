...
{
    [Cmdlet("Get", "OCIIdentitydomainsApiKeysList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.ApiKeys), typeof(Oci.IdentitydomainsService.Responses.ListApiKeysResponse) })]
    public class GetOCIIdentitydomainsApiKeysList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ListApiKeys(request).GetAwaiter().GetResult();
