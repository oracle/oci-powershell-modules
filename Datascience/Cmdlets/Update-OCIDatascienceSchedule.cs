...
{
    [Cmdlet("Update", "OCIDatascienceSchedule")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatascienceService.Responses.UpdateScheduleResponse) })]
    public class UpdateOCIDatascienceSchedule : OCIDataScienceCmdlet
    {
