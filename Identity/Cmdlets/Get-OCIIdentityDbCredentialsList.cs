...
{
    [Cmdlet("Get", "OCIIdentityDbCredentialsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentityService.Models.DbCredentialSummary), typeof(Oci.IdentityService.Responses.ListDbCredentialsResponse) })]
    public class GetOCIIdentityDbCredentialsList : OCIIdentityCmdlet
    {
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by Availability Domain if the scope of the resource type is within a single Availability Domain. If you call one of these ""List"" operations without specifying an Availability Domain, the resources are grouped by Availability Domain, then sorted.")]
        public System.Nullable<Oci.IdentityService.Requests.ListDbCredentialsRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.IdentityService.Requests.ListDbCredentialsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.IdentityService.Models.DbCredential.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListDbCredentialsRequest
                {
                    UserId = UserId,
                ...
                IEnumerable<ListDbCredentialsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListDbCredentialsResponse> DefaultRequest(ListDbCredentialsRequest request) => Enumerable.Repeat(client.ListDbCredentials(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListDbCredentialsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListDbCredentialsResponse response;
        private delegate IEnumerable<ListDbCredentialsResponse> RequestDelegate(ListDbCredentialsRequest request);
