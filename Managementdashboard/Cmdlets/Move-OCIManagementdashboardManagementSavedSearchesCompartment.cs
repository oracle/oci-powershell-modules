...
namespace Oci.ManagementdashboardService.Cmdlets
{
    ...
    public class MoveOCIManagementdashboardManagementSavedSearchesCompartment : OCIDashxApisCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Compartment id to move the saved search to.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeManagementSavedSearchesCompartmentRequest
                {
        ...
        private ChangeManagementSavedSearchesCompartmentResponse response;
    }
}
