...
{
    [Cmdlet("Move", "OCIDatabaseAutonomousDatabaseCompartment", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.ChangeAutonomousDatabaseCompartmentResponse) })]
    public class MoveOCIDatabaseAutonomousDatabaseCompartment : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeAutonomousDatabaseCompartmentRequest
                {
        ...
        private void HandleOutput(ChangeAutonomousDatabaseCompartmentRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForChangeAutonomousDatabaseCompartment(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ChangeAutonomousDatabaseCompartment(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private ChangeAutonomousDatabaseCompartmentResponse response;
