...
namespace Oci.EmailService.Cmdlets
{
    ...
    public class AddOCIEmailIpPoolLock : OCIEmailCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddEmailIpPoolLockRequest
                {
                ...
                response = client.AddEmailIpPoolLock(request).GetAwaiter().GetResult();
        ...
        private AddEmailIpPoolLockResponse response;
    }
}
