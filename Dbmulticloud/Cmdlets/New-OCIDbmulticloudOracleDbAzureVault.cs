...
{
    [Cmdlet("New", "OCIDbmulticloudOracleDbAzureVault")]
    [OutputType(new System.Type[] { typeof(Oci.DbmulticloudService.Models.OracleDbAzureVault), typeof(Oci.DbmulticloudService.Responses.CreateOracleDbAzureVaultResponse) })]
    public class NewOCIDbmulticloudOracleDbAzureVault : OCIOracleDbAzureVaultCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for to Create Oracle DB Azure Vault details.")]
...
For example, if a resource has been deleted and permanently purged from the system, a retry of the original creation request may be rejected.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateOracleDbAzureVaultRequest
                {
                ...
                response = client.CreateOracleDbAzureVault(request).GetAwaiter().GetResult();
        ...
        private CreateOracleDbAzureVaultResponse response;
    }
}
