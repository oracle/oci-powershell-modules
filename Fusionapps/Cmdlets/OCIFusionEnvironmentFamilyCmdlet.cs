...
using Oci.FusionappsService;

namespace Oci.FusionappsService.Cmdlets
{
    public abstract class OCIFusionEnvironmentFamilyCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new FusionEnvironmentFamilyClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected FusionEnvironmentFamilyClient client;
