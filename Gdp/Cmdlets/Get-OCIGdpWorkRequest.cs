...
{
    [Cmdlet("Get", "OCIGdpWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.GdpService.Models.GdpWorkRequest), typeof(Oci.GdpService.Responses.GetGdpWorkRequestResponse) })]
    public class GetOCIGdpWorkRequest : OCIGuardedDataPipelineCmdlet
    {
        ...
        public Oci.GdpService.Models.OperationStatus[] WaitForStatus { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetGdpWorkRequestRequest
                {
        ...
        private void HandleOutput(GetGdpWorkRequestRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForGdpWorkRequest(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.GetGdpWorkRequest(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.GdpWorkRequest);
        }

        private GetGdpWorkRequestResponse response;
