...
{
    [Cmdlet("Add", "OCIMediaservicesMediaWorkflowConfigurationLock")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.MediaWorkflowConfiguration), typeof(Oci.MediaservicesService.Responses.AddMediaWorkflowConfigurationLockResponse) })]
    public class AddOCIMediaservicesMediaWorkflowConfigurationLock : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddMediaWorkflowConfigurationLockRequest
                {
                ...
                response = client.AddMediaWorkflowConfigurationLock(request).GetAwaiter().GetResult();
        ...
        private AddMediaWorkflowConfigurationLockResponse response;
    }
}
