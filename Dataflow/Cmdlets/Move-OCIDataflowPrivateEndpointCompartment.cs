...
{
    [Cmdlet("Move", "OCIDataflowPrivateEndpointCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DataflowService.Responses.ChangePrivateEndpointCompartmentResponse) })]
    public class MoveOCIDataflowPrivateEndpointCompartment : OCIDataFlowCmdlet
    {
