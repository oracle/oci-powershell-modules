...
namespace Oci.WaaService.Cmdlets
{
    ...
    public class GetOCIWaaWebAppAcceleration : OCIWaaCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the WebAppAcceleration.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the WebAppAcceleration.", ParameterSetName = Default)]
