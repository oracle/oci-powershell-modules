...
{
    [Cmdlet("Get", "OCIIdentitydomainsMappedAttributesList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MappedAttributes), typeof(Oci.IdentitydomainsService.Responses.ListMappedAttributesResponse) })]
    public class GetOCIIdentitydomainsMappedAttributesList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMappedAttributesRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListMappedAttributes(request).GetAwaiter().GetResult();
        ...
        private ListMappedAttributesResponse response;
    }
}
