...
namespace Oci.LoadbalancerService.Cmdlets
{
    ...
    public class NewOCILoadbalancerHostname : OCILoadBalancerCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the load balancer to add the hostname to.")]
