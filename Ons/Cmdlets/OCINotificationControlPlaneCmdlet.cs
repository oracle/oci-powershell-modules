...
{
    public abstract class OCINotificationControlPlaneCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new NotificationControlPlaneClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected NotificationControlPlaneClient client;
