...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class GetOCIFusionappsFusionEnvironmentFamily : OCIFusionApplicationsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique identifier (OCID) of the FusionEnvironmentFamily.", ParameterSetName = Default)]
        ...
        public Oci.FusionappsService.Models.FusionEnvironmentFamily.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetFusionEnvironmentFamilyRequest
                {
        ...
        private void HandleOutput(GetFusionEnvironmentFamilyRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForFusionEnvironmentFamily(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetFusionEnvironmentFamily(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.FusionEnvironmentFamily);
        }

        private GetFusionEnvironmentFamilyResponse response;
