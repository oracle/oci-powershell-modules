...
{
    [Cmdlet("Remove", "OCIDevopsDeployStage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DevopsService.Responses.DeleteDeployStageResponse) })]
    public class RemoveOCIDevopsDeployStage : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDevopsDeployStage", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDeployStageRequest
                {
                ...
                response = client.DeleteDeployStage(request).GetAwaiter().GetResult();
        ...
        private DeleteDeployStageResponse response;
    }
}
