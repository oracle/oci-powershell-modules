...
{
    [Cmdlet("Remove", "OCIDatacatalogCatalogPrivateEndpoint", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatacatalogService.Responses.DeleteCatalogPrivateEndpointResponse) })]
    public class RemoveOCIDatacatalogCatalogPrivateEndpoint : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatacatalogCatalogPrivateEndpoint", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteCatalogPrivateEndpointRequest
                {
                ...
                response = client.DeleteCatalogPrivateEndpoint(request).GetAwaiter().GetResult();
        ...
        private DeleteCatalogPrivateEndpointResponse response;
    }
}
