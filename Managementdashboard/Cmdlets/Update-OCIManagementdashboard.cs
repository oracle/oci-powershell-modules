...
{
    [Cmdlet("Update", "OCIManagementdashboard")]
    ...
    public class UpdateOCIManagementdashboard : OCIDashxApisCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateManagementDashboardRequest
                {
                ...
                response = client.UpdateManagementDashboard(request).GetAwaiter().GetResult();
        ...
        private UpdateManagementDashboardResponse response;
    }
}
