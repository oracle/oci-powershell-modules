...
{
    [Cmdlet("Invoke", "OCIDatabaseReinstateAutonomousContainerDatabaseDataguard", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousContainerDatabase), typeof(Oci.DatabaseService.Responses.ReinstateAutonomousContainerDatabaseDataguardResponse) })]
    public class InvokeOCIDatabaseReinstateAutonomousContainerDatabaseDataguard : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ReinstateAutonomousContainerDatabaseDataguardRequest
                {
        ...
        private void HandleOutput(ReinstateAutonomousContainerDatabaseDataguardRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForReinstateAutonomousContainerDatabaseDataguard(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ReinstateAutonomousContainerDatabaseDataguard(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousContainerDatabase);
        }

        private ReinstateAutonomousContainerDatabaseDataguardResponse response;
