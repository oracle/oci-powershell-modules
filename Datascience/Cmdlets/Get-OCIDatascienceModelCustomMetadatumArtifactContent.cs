...
namespace Oci.DatascienceService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIDatascienceModelCustomMetadatumArtifactContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatascienceService.Responses.GetModelCustomMetadatumArtifactContentResponse) })]
    public class GetOCIDatascienceModelCustomMetadatumArtifactContent : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetModelCustomMetadatumArtifactContentRequest
                {
                    ModelId = ModelId,
                ...
                response = client.GetModelCustomMetadatumArtifactContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetModelCustomMetadatumArtifactContentResponse response;
