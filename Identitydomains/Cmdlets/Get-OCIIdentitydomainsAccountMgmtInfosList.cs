...
{
    [Cmdlet("Get", "OCIIdentitydomainsAccountMgmtInfosList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.AccountMgmtInfos), typeof(Oci.IdentitydomainsService.Responses.ListAccountMgmtInfosResponse) })]
    public class GetOCIIdentitydomainsAccountMgmtInfosList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAccountMgmtInfosRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListAccountMgmtInfos(request).GetAwaiter().GetResult();
        ...
        private ListAccountMgmtInfosResponse response;
    }
}
