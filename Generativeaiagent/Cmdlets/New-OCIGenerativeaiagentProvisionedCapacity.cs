...
{
    [Cmdlet("New", "OCIGenerativeaiagentProvisionedCapacity")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiagentService.Models.ProvisionedCapacity), typeof(Oci.GenerativeaiagentService.Responses.CreateProvisionedCapacityResponse) })]
    public class NewOCIGenerativeaiagentProvisionedCapacity : OCIGenerativeAiAgentCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new provisioned capacity.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateProvisionedCapacityRequest
                {
                ...
                response = client.CreateProvisionedCapacity(request).GetAwaiter().GetResult();
        ...
        private CreateProvisionedCapacityResponse response;
    }
}
