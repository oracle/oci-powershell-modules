...
{
    [Cmdlet("Invoke", "OCIApiaccesscontrolApprovePrivilegedApiRequest")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApiaccesscontrolService.Responses.ApprovePrivilegedApiRequestResponse) })]
    public class InvokeOCIApiaccesscontrolApprovePrivilegedApiRequest : OCIPrivilegedApiRequestsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"unique PrivilegedApiRequest identifier")]
        public string PrivilegedApiRequestId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details regarding the approval of an privilegedApi request created by the operator.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ApprovePrivilegedApiRequestRequest
                {
                ...
                response = client.ApprovePrivilegedApiRequest(request).GetAwaiter().GetResult();
        ...
        private ApprovePrivilegedApiRequestResponse response;
    }
}
