...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class ResetOCIFusionappsFusionEnvironmentPassword : OCIFusionApplicationsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ResetFusionEnvironmentPasswordRequest
                {
                ...
                response = client.ResetFusionEnvironmentPassword(request).GetAwaiter().GetResult();
        ...
        private ResetFusionEnvironmentPasswordResponse response;
    }
}
