...
{
    [Cmdlet("Get", "OCIMarketplaceCategoriesList")]
    [OutputType(new System.Type[] { typeof(Oci.MarketplaceService.Models.CategorySummary), typeof(Oci.MarketplaceService.Responses.ListCategoriesResponse) })]
    public class GetOCIMarketplaceCategoriesList : OCIMarketplaceCmdlet
    {
