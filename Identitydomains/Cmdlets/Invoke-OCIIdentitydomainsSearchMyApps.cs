...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchMyApps")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyApps), typeof(Oci.IdentitydomainsService.Responses.SearchMyAppsResponse) })]
    public class InvokeOCIIdentitydomainsSearchMyApps : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching MyApps")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchMyAppsRequest
                {
                ...
                response = client.SearchMyApps(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MyApps);
        ...
        private SearchMyAppsResponse response;
    }
}
