...
{
    [Cmdlet("Update", "OCICapacitymanagementOccmDemandSignal")]
    [OutputType(new System.Type[] { typeof(Oci.CapacitymanagementService.Models.OccmDemandSignal), typeof(Oci.CapacitymanagementService.Responses.UpdateOccmDemandSignalResponse) })]
    public class UpdateOCICapacitymanagementOccmDemandSignal : OCIDemandSignalCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateOccmDemandSignalRequest
                {
                ...
                response = client.UpdateOccmDemandSignal(request).GetAwaiter().GetResult();
        ...
        private UpdateOccmDemandSignalResponse response;
    }
}
