...
{
    [Cmdlet("Update", "OCIJmsDrsFile")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.JmsService.Responses.UpdateDrsFileResponse) })]
    public class UpdateOCIJmsDrsFile : OCIJavaManagementServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Detail information to update DRS")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDrsFileRequest
                {
                    FleetId = FleetId,
                ...
                response = client.UpdateDrsFile(request).GetAwaiter().GetResult();
        ...
        private UpdateDrsFileResponse response;
    }
}
