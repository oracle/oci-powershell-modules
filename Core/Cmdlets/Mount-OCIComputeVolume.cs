...
{
    [Cmdlet("Mount", "OCIComputeVolume", DefaultParameterSetName = Default)]
    ...
    public class MountOCIComputeVolume : OCIComputeCmdlet
    {
        ...
        private void HandleOutput(AttachVolumeRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForAttachVolume(request, waiterConfig, WaitForStatus).Execute();
                    break;
