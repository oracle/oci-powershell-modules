...
{
    [Cmdlet("Remove", "OCIIdentitydomainsOAuthPartnerCertificate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteOAuthPartnerCertificateResponse) })]
    public class RemoveOCIIdentitydomainsOAuthPartnerCertificate : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsOAuthPartnerCertificate", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteOAuthPartnerCertificateRequest
                {
                ...
                response = client.DeleteOAuthPartnerCertificate(request).GetAwaiter().GetResult();
        ...
        private DeleteOAuthPartnerCertificateResponse response;
    }
}
