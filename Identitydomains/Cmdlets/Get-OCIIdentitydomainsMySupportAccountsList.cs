...
{
    [Cmdlet("Get", "OCIIdentitydomainsMySupportAccountsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MySupportAccounts), typeof(Oci.IdentitydomainsService.Responses.ListMySupportAccountsResponse) })]
    public class GetOCIIdentitydomainsMySupportAccountsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMySupportAccountsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListMySupportAccounts(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MySupportAccounts);
        ...
        private ListMySupportAccountsResponse response;
    }
}
