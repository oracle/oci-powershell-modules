...
{
    public abstract class OCIGenerativeAiAgentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new GenerativeAiAgentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected GenerativeAiAgentClient client;
