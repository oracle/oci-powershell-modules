...
using Oci.GdpService;

namespace Oci.GdpService.Cmdlets
{
    public abstract class OCIGuardedDataPipelineCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new GuardedDataPipelineClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected GuardedDataPipelineClient client;
