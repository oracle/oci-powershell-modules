...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchMyRequestableGroups")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyRequestableGroups), typeof(Oci.IdentitydomainsService.Responses.SearchMyRequestableGroupsResponse) })]
    public class InvokeOCIIdentitydomainsSearchMyRequestableGroups : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching MyRequestableGroups")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchMyRequestableGroupsRequest
                {
                ...
                response = client.SearchMyRequestableGroups(request).GetAwaiter().GetResult();
        ...
        private SearchMyRequestableGroupsResponse response;
    }
}
