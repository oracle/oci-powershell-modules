...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class GetOCIFusionappsServiceAttachment : OCIFusionApplicationsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"OCID of the Service Attachment", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"OCID of the Service Attachment", ParameterSetName = Default)]
        ...
        public Oci.FusionappsService.Models.ServiceAttachment.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        private void HandleOutput(GetServiceAttachmentRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForServiceAttachment(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetServiceAttachment(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.ServiceAttachment);
        }

        private GetServiceAttachmentResponse response;
