...
{
    [Cmdlet("Get", "OCIDatabasemanagementCloudAsmsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.CloudAsmCollection), typeof(Oci.DatabasemanagementService.Responses.ListCloudAsmsResponse) })]
    public class GetOCIDatabasemanagementCloudAsmsList : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListCloudAsmsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListCloudAsmsRequest
                {
                ...
                IEnumerable<ListCloudAsmsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.CloudAsmCollection, true);
                }
        ...
        {
            IEnumerable<ListCloudAsmsResponse> DefaultRequest(ListCloudAsmsRequest request) => Enumerable.Repeat(client.ListCloudAsms(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListCloudAsmsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListCloudAsmsResponse response;
        private delegate IEnumerable<ListCloudAsmsResponse> RequestDelegate(ListCloudAsmsRequest request);
