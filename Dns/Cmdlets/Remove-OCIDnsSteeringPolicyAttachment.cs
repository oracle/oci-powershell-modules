...
{
    [Cmdlet("Remove", "OCIDnsSteeringPolicyAttachment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DnsService.Responses.DeleteSteeringPolicyAttachmentResponse) })]
    public class RemoveOCIDnsSteeringPolicyAttachment : OCIDnsCmdlet
    {
        ...
        private void HandleOutput(DeleteSteeringPolicyAttachmentRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteSteeringPolicyAttachment(request, waiterConfig, WaitForStatus).Execute();
                    break;
