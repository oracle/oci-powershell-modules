...
{
    [Cmdlet("Get", "OCIDblmWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.DblmService.Models.WorkRequestLogEntryCollection), typeof(Oci.DblmService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIDblmWorkRequestLogsList : OCIDbLifeCycleManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DblmService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
