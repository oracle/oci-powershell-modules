...
{
    [Cmdlet("New", "OCIDatacatalogTerm")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Term), typeof(Oci.DatacatalogService.Responses.CreateTermResponse) })]
    public class NewOCIDatacatalogTerm : OCIDataCatalogCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information used to create the term.")]
