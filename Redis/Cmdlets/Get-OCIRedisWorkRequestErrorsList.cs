...
{
    [Cmdlet("Get", "OCIRedisWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.RedisService.Models.WorkRequestErrorCollection), typeof(Oci.RedisService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIRedisWorkRequestErrorsList : OCIRedisClusterCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The the asynchronous request ID.")]
        ...
        public System.Nullable<Oci.RedisService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }
