...
{
    [Cmdlet("Remove", "OCINetworkfirewallMappedSecret", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.NetworkfirewallService.Responses.DeleteMappedSecretResponse) })]
    public class RemoveOCINetworkfirewallMappedSecret : OCINetworkFirewallCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCINetworkfirewallMappedSecret", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteMappedSecretRequest
                {
                ...
                response = client.DeleteMappedSecret(request).GetAwaiter().GetResult();
        ...
        private DeleteMappedSecretResponse response;
    }
}
