...
{
    [Cmdlet("New", "OCIFusionappsServiceAttachment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.FusionappsService.Responses.CreateServiceAttachmentResponse) })]
    public class NewOCIFusionappsServiceAttachment : OCIFusionApplicationsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateServiceAttachmentRequest
                {
                ...
                response = client.CreateServiceAttachment(request).GetAwaiter().GetResult();
        ...
        private CreateServiceAttachmentResponse response;
    }
}
