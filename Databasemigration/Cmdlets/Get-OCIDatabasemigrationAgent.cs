...
{
    [Cmdlet("Get", "OCIDatabasemigrationAgent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemigrationService.Models.Agent), typeof(Oci.DatabasemigrationService.Responses.GetAgentResponse) })]
    public class GetOCIDatabasemigrationAgent : OCIDatabaseMigrationCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the agent", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the agent", ParameterSetName = Default)]
