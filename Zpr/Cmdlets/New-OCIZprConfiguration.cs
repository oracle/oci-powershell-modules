...
{
    [Cmdlet("New", "OCIZprConfiguration")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ZprService.Responses.CreateConfigurationResponse) })]
    public class NewOCIZprConfiguration : OCIZprCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for ZPR configuration in the tenancy.")]
