...
{
    [Cmdlet("Remove", "OCIIdentitydomainsMyUserDbCredential", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteMyUserDbCredentialResponse) })]
    public class RemoveOCIIdentitydomainsMyUserDbCredential : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsMyUserDbCredential", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteMyUserDbCredentialRequest
                {
                ...
                response = client.DeleteMyUserDbCredential(request).GetAwaiter().GetResult();
        ...
        private DeleteMyUserDbCredentialResponse response;
    }
}
