...
{
    [Cmdlet("Get", "OCIAilanguageModel", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.AilanguageService.Models.Model), typeof(Oci.AilanguageService.Responses.GetModelResponse) })]
    public class GetOCIAilanguageModel : OCIAIServiceLanguageCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"unique model OCID.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"unique model OCID.", ParameterSetName = Default)]
        ...
        public Oci.AilanguageService.Models.Model.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
