...
{
    public abstract class OCIOciCacheBackupCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OciCacheBackupClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OciCacheBackupClient client;
