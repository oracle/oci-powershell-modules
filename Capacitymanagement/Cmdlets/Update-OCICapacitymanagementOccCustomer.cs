...
{
    [Cmdlet("Update", "OCICapacitymanagementOccCustomer")]
    [OutputType(new System.Type[] { typeof(Oci.CapacitymanagementService.Models.OccCustomer), typeof(Oci.CapacitymanagementService.Responses.UpdateOccCustomerResponse) })]
    public class UpdateOCICapacitymanagementOccCustomer : OCICapacityManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The tenancy id of the customer.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateOccCustomerRequest
                {
                ...
                response = client.UpdateOccCustomer(request).GetAwaiter().GetResult();
        ...
        private UpdateOccCustomerResponse response;
    }
}
