...
{
    public abstract class OCIQuoteAttachmentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new QuoteAttachmentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected QuoteAttachmentClient client;
