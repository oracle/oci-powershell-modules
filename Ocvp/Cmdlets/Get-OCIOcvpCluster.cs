...
{
    [Cmdlet("Get", "OCIOcvpCluster", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OcvpService.Models.Cluster), typeof(Oci.OcvpService.Responses.GetClusterResponse) })]
    public class GetOCIOcvpCluster : OCIClusterCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the SDDC Cluster.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the SDDC Cluster.", ParameterSetName = Default)]
