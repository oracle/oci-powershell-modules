...
{
    [Cmdlet("Remove", "OCIIotDigitalTwinAdapter", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IotService.Responses.DeleteDigitalTwinAdapterResponse) })]
    public class RemoveOCIIotDigitalTwinAdapter : OCIIotCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIotDigitalTwinAdapter", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDigitalTwinAdapterRequest
                {
                ...
                response = client.DeleteDigitalTwinAdapter(request).GetAwaiter().GetResult();
        ...
        private DeleteDigitalTwinAdapterResponse response;
    }
}
