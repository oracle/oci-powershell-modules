...
{
    [Cmdlet("Remove", "OCIAutoscalingPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCIAutoscalingPolicy : OCIAutoScalingCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAutoscalingPolicy", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteAutoScalingPolicy(request).GetAwaiter().GetResult();
        ...
        private DeleteAutoScalingPolicyResponse response;
    }
}
