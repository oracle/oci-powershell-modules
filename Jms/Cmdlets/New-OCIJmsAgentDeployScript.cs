...
namespace Oci.JmsService.Cmdlets
{
     ...
     */
    [Cmdlet("New", "OCIJmsAgentDeployScript", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.JmsService.Responses.GenerateAgentDeployScriptResponse) })]
    public class NewOCIJmsAgentDeployScript : OCIJavaManagementServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Attributes to generate the agent deploy script for a Fleet.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GenerateAgentDeployScriptRequest
                {
                    FleetId = FleetId,
                ...
                response = client.GenerateAgentDeployScript(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GenerateAgentDeployScriptResponse response;
