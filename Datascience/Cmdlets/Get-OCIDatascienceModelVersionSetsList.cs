...
{
    [Cmdlet("Get", "OCIDatascienceModelVersionSetsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.ModelVersionSetSummary), typeof(Oci.DatascienceService.Responses.ListModelVersionSetsResponse) })]
    public class GetOCIDatascienceModelVersionSetsList : OCIDataScienceCmdlet
    {
        ...
        public System.Nullable<Oci.DatascienceService.Models.ModelVersionSetLifecycleState> LifecycleState { get; set; }
...
See [List Pagination](https://docs.oracle.com/iaas/Content/General/Concepts/usingapi.htm#nine).")]
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListModelVersionSetsRequest.SortOrderEnum> SortOrder { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifies the field to sort by. Accepts only one field. By default, when you sort by `timeCreated`, the results are shown in descending order.")]
        public System.Nullable<Oci.DatascienceService.Requests.ListModelVersionSetsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListModelVersionSetsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListModelVersionSetsResponse> DefaultRequest(ListModelVersionSetsRequest request) => Enumerable.Repeat(client.ListModelVersionSets(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListModelVersionSetsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListModelVersionSetsResponse response;
        private delegate IEnumerable<ListModelVersionSetsResponse> RequestDelegate(ListModelVersionSetsRequest request);
