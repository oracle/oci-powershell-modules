...
{
    [Cmdlet("Get", "OCIFleetappsmanagementWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.FleetappsmanagementService.Models.WorkRequest), typeof(Oci.FleetappsmanagementService.Responses.GetWorkRequestResponse) })]
    public class GetOCIFleetappsmanagementWorkRequest : OCIFleetAppsManagementWorkRequestCmdlet
    {
        ...
        public Oci.FleetappsmanagementService.Models.OperationStatus[] WaitForStatus { get; set; }
