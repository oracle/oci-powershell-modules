...
{
    [Cmdlet("Get", "OCIWlmsWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.WlmsService.Models.WorkRequestErrorCollection), typeof(Oci.WlmsService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIWlmsWorkRequestErrorsList : OCIWeblogicManagementServiceCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field to sort by. Default order for `timestamp` is descending.")]
        public System.Nullable<Oci.WlmsService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order is either 'ASC' or 'DESC'.")]
        public System.Nullable<Oci.WlmsService.Requests.ListWorkRequestErrorsRequest.SortOrderEnum> SortOrder { get; set; }
