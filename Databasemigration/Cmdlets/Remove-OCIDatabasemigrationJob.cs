...
{
    [Cmdlet("Remove", "OCIDatabasemigrationJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatabasemigrationService.Responses.DeleteJobResponse) })]
    public class RemoveOCIDatabasemigrationJob : OCIDatabaseMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabasemigrationJob", "Remove"))
            {
               return;
            }
