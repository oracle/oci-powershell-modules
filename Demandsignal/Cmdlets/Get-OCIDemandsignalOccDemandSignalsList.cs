...
namespace Oci.DemandsignalService.Cmdlets
{
    ...
    public class GetOCIDemandsignalOccDemandSignalsList : OCIOccDemandSignalCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the OccDemandSignal.")]
