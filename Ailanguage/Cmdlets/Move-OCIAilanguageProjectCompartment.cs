...
{
    [Cmdlet("Move", "OCIAilanguageProjectCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AilanguageService.Responses.ChangeProjectCompartmentResponse) })]
    public class MoveOCIAilanguageProjectCompartment : OCIAIServiceLanguageCmdlet
    {
