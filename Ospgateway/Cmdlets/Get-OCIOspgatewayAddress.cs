...
{
    [Cmdlet("Get", "OCIOspgatewayAddress")]
    [OutputType(new System.Type[] { typeof(Oci.OspgatewayService.Models.Address), typeof(Oci.OspgatewayService.Responses.GetAddressResponse) })]
    public class GetOCIOspgatewayAddress : OCIAddressServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The identifier of the address.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GetAddress(request).GetAwaiter().GetResult();
                WriteOutput(response, response.Address);
        ...
        private GetAddressResponse response;
    }
}
