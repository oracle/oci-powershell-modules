...
{
    public abstract class OCISubscriptionCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new SubscriptionClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
