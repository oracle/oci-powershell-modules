...
{
    [Cmdlet("Invoke", "OCIGenerativeaiinferenceApplyGuardrails")]
    ...
    public class InvokeOCIGenerativeaiinferenceApplyGuardrails : OCIGenerativeAiInferenceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ApplyGuardrailsRequest
                {
                ...
                response = client.ApplyGuardrails(request, completionOption: HttpCompletionOption).GetAwaiter().GetResult();
                WriteOutput(response, response.ApplyGuardrailsResult);
        ...
        private ApplyGuardrailsResponse response;
    }
}
