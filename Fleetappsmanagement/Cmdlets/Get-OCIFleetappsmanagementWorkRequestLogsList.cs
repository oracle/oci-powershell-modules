...
{
    [Cmdlet("Get", "OCIFleetappsmanagementWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.FleetappsmanagementService.Models.WorkRequestLogEntryCollection), typeof(Oci.FleetappsmanagementService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIFleetappsmanagementWorkRequestLogsList : OCIFleetAppsManagementWorkRequestCmdlet
    {
        ...
        public System.Nullable<Oci.FleetappsmanagementService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
