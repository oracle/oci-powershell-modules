...
{
    [Cmdlet("Move", "OCIGenerativeaiDedicatedAiClusterCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.GenerativeaiService.Responses.ChangeDedicatedAiClusterCompartmentResponse) })]
    public class MoveOCIGenerativeaiDedicatedAiClusterCompartment : OCIGenerativeAiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeDedicatedAiClusterCompartmentRequest
                {
                ...
                response = client.ChangeDedicatedAiClusterCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeDedicatedAiClusterCompartmentResponse response;
    }
}
