...
namespace Oci.CoreService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIVirtualNetworkIpsecCpeDeviceConfigContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.CoreService.Responses.GetIpsecCpeDeviceConfigContentResponse) })]
    public class GetOCIVirtualNetworkIpsecCpeDeviceConfigContent : OCIVirtualNetworkCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetIpsecCpeDeviceConfigContentRequest
                {
                    IpscId = IpscId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetIpsecCpeDeviceConfigContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetIpsecCpeDeviceConfigContentResponse response;
