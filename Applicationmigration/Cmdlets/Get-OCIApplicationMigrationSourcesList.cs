...
namespace Oci.ApplicationmigrationService.Cmdlets
{
    ...
    public class GetOCIApplicationMigrationSourcesList : OCIApplicationMigrationCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID on which to query for a source.")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The lifecycle state on which to filter.")]
