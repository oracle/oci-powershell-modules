...
{
    [Cmdlet("Update", "OCIDisasterrecoveryDrPlan")]
...
Example: `ocid1.drplan.oc1..uniqueID`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDrPlanRequest
                {
                ...
                response = client.UpdateDrPlan(request).GetAwaiter().GetResult();
        ...
        private UpdateDrPlanResponse response;
    }
}
