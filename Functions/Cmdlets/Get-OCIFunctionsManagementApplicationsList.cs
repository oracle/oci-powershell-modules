...
{
    [Cmdlet("Get", "OCIFunctionsManagementApplicationsList")]
    ...
    public class GetOCIFunctionsManagementApplicationsList : OCIFunctionsManagementCmdlet
    {
...
Default: 10", ParameterSetName = LimitSet)]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only applications with the specfied OCID.")]
