...
{
    [Cmdlet("Get", "OCIAnalyticsWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.AnalyticsService.Models.WorkRequestSummary), typeof(Oci.AnalyticsService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIAnalyticsWorkRequestsList : OCIAnalyticsCmdlet
    {
        ...
        public System.Collections.Generic.List<Oci.AnalyticsService.Models.WorkRequestStatus> Status { get; set; }
...
Example: `50`", ParameterSetName = LimitSet)]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field used for sorting work request results.")]
        public System.Nullable<Oci.AnalyticsService.Models.WorkRequestSortBy> SortBy { get; set; }
