...
{
    [Cmdlet("Get", "OCIAdmVulnerabilitiesList")]
    [OutputType(new System.Type[] { typeof(Oci.AdmService.Models.VulnerabilityDetailsCollection), typeof(Oci.AdmService.Responses.ListVulnerabilitiesResponse) })]
    public class GetOCIAdmVulnerabilitiesList : OCIApplicationDependencyManagementCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter when set returns only vulnerabilities that are immediately(directly) affecting any artifact, when unset all vulnerabilities are returned.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    response = item;
                    WriteOutput(response, response.VulnerabilityDetailsCollection, true);
                }
