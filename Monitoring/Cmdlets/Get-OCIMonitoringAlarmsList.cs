...
{
    [Cmdlet("Get", "OCIMonitoringAlarmsList")]
    [OutputType(new System.Type[] { typeof(Oci.MonitoringService.Models.AlarmSummary), typeof(Oci.MonitoringService.Responses.ListAlarmsResponse) })]
    public class GetOCIMonitoringAlarmsList : OCIMonitoringCmdlet
    {
...
Example: 500", ParameterSetName = LimitSet)]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only alarms that match the given lifecycle state exactly. When not specified, only alarms in the ACTIVE lifecycle state are listed.")]
        public System.Nullable<Oci.MonitoringService.Models.Alarm.LifecycleStateEnum> LifecycleState { get; set; }
...
Example: `severity`")]
        public System.Nullable<Oci.MonitoringService.Requests.ListAlarmsRequest.SortByEnum> SortBy { get; set; }
...
Example: `ASC`")]
        public System.Nullable<Oci.MonitoringService.Requests.ListAlarmsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListAlarmsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListAlarmsResponse> DefaultRequest(ListAlarmsRequest request) => Enumerable.Repeat(client.ListAlarms(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAlarmsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAlarmsResponse response;
        private delegate IEnumerable<ListAlarmsResponse> RequestDelegate(ListAlarmsRequest request);
