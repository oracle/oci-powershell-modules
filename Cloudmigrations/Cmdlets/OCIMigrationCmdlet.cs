...
{
    public abstract class OCIMigrationCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MigrationClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MigrationClient client;
