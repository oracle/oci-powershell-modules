...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeAddmDbSchemaObjects")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.AddmDbSchemaObjectCollection), typeof(Oci.OpsiService.Responses.SummarizeAddmDbSchemaObjectsResponse) })]
    public class InvokeOCIOpsiSummarizeAddmDbSchemaObjects : OCIOperationsInsightsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"One or more unique Object id (from RDBMS)")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeAddmDbSchemaObjectsRequest
                {
                ...
                response = client.SummarizeAddmDbSchemaObjects(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AddmDbSchemaObjectCollection);
        ...
        private SummarizeAddmDbSchemaObjectsResponse response;
    }
}
