...
{
    [Cmdlet("Get", "OCIDatasafeMaskingPolicy", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.MaskingPolicy), typeof(Oci.DatasafeService.Responses.GetMaskingPolicyResponse) })]
    public class GetOCIDatasafeMaskingPolicy : OCIDataSafeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMaskingPolicyRequest
                {
        ...
        private void HandleOutput(GetMaskingPolicyRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForMaskingPolicy(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetMaskingPolicy(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.MaskingPolicy);
        }

        private GetMaskingPolicyResponse response;
