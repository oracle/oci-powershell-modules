...
{
    [Cmdlet("Backup", "OCIKeymanagementVault")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.Vault), typeof(Oci.KeymanagementService.Responses.BackupVaultResponse) })]
    public class BackupOCIKeymanagementVault : OCIKmsVaultCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"BackupVaultDetails")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new BackupVaultRequest
                {
                    VaultId = VaultId,
                    IfMatch = IfMatch,
                ...
                response = client.BackupVault(request).GetAwaiter().GetResult();
        ...
        private BackupVaultResponse response;
    }
}
