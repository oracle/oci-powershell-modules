...
namespace Oci.OsmanagementhubService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Provides the information used to create the registration profile. This parameter also accepts subtypes <Oci.OsmanagementhubService.Models.CreateUbuntuStandAloneProfileDetails>, <Oci.OsmanagementhubService.Models.CreateGroupProfileDetails>, <Oci.OsmanagementhubService.Models.CreateWindowsStandAloneProfileDetails>, <Oci.OsmanagementhubService.Models.CreateStationProfileDetails>, <Oci.OsmanagementhubService.Models.CreateSoftwareSourceProfileDetails>, <Oci.OsmanagementhubService.Models.CreateLifecycleProfileDetails> of type <Oci.OsmanagementhubService.Models.CreateProfileDetails>.")]
