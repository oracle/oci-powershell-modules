...
{
    [Cmdlet("Get", "OCIDataconnectivityDataEntitiesList")]
    ...
    public class GetOCIDataconnectivityDataEntitiesList : OCIDataConnectivityManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DataconnectivityService.Requests.ListDataEntitiesRequest.SortOrderEnum> SortOrder { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.")]
        public string OpcRequestId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"This parameter can be used to set the api response type to preview.")]
        public System.Nullable<Oci.DataconnectivityService.Requests.ListDataEntitiesRequest.ApiModeEnum> ApiMode { get; set; }
