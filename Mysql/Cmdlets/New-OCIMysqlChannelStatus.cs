...
{
    [Cmdlet("New", "OCIMysqlChannelStatus")]
    [OutputType(new System.Type[] { typeof(Oci.MysqlService.Models.ChannelStatus), typeof(Oci.MysqlService.Responses.GenerateChannelStatusResponse) })]
    public class NewOCIMysqlChannelStatus : OCIChannelsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GenerateChannelStatusRequest
                {
                    ChannelId = ChannelId,
                ...
                response = client.GenerateChannelStatus(request).GetAwaiter().GetResult();
        ...
        private GenerateChannelStatusResponse response;
    }
}
