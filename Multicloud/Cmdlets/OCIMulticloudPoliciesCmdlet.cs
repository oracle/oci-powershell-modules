...
{
    public abstract class OCIMulticloudPoliciesCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MulticloudPoliciesClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MulticloudPoliciesClient client;
