...
{
    [Cmdlet("Get", "OCIDatasafeSqlFirewallPolicy", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.SqlFirewallPolicy), typeof(Oci.DatasafeService.Responses.GetSqlFirewallPolicyResponse) })]
    public class GetOCIDatasafeSqlFirewallPolicy : OCIDataSafeCmdlet
    {
        ...
        public Oci.DatasafeService.Models.SqlFirewallPolicyLifecycleState[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetSqlFirewallPolicyRequest
                {
        ...
        private void HandleOutput(GetSqlFirewallPolicyRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForSqlFirewallPolicy(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetSqlFirewallPolicy(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.SqlFirewallPolicy);
        }

        private GetSqlFirewallPolicyResponse response;
