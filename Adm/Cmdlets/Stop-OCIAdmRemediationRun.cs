...
{
    [Cmdlet("Stop", "OCIAdmRemediationRun")]
    [OutputType(new System.Type[] { typeof(Oci.AdmService.Models.RemediationRun), typeof(Oci.AdmService.Responses.CancelRemediationRunResponse) })]
    public class StopOCIAdmRemediationRun : OCIApplicationDependencyManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelRemediationRunRequest
                {
                ...
                response = client.CancelRemediationRun(request).GetAwaiter().GetResult();
        ...
        private CancelRemediationRunResponse response;
    }
}
