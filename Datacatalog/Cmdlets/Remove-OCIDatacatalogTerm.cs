...
{
    [Cmdlet("Remove", "OCIDatacatalogTerm", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatacatalogService.Responses.DeleteTermResponse) })]
    public class RemoveOCIDatacatalogTerm : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatacatalogTerm", "Remove"))
            {
               return;
            }
