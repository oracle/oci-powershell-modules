...
{
    public abstract class OCIGoldenGateCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new GoldenGateClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected GoldenGateClient client;
