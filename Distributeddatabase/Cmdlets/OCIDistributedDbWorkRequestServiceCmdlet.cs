...
{
    public abstract class OCIDistributedDbWorkRequestServiceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DistributedDbWorkRequestServiceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DistributedDbWorkRequestServiceClient client;
