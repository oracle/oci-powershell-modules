...
{
    [Cmdlet("Get", "OCIDatabasemanagementProxyUsersList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.ProxyUserCollection), typeof(Oci.DatabasemanagementService.Responses.ListProxyUsersResponse) })]
    public class GetOCIDatabasemanagementProxyUsersList : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListProxyUsersRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListProxyUsersRequest
                {
                ...
                {
                    response = item;
                    WriteOutput(response, response.ProxyUserCollection, true);
                }
        ...
        {
            IEnumerable<ListProxyUsersResponse> DefaultRequest(ListProxyUsersRequest request) => Enumerable.Repeat(client.ListProxyUsers(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListProxyUsersResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListProxyUsersResponse response;
        private delegate IEnumerable<ListProxyUsersResponse> RequestDelegate(ListProxyUsersRequest request);
