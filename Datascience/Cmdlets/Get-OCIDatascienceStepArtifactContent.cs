...
namespace Oci.DatascienceService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIDatascienceStepArtifactContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatascienceService.Responses.GetStepArtifactContentResponse) })]
    public class GetOCIDatascienceStepArtifactContent : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetStepArtifactContentRequest
                {
                ...
                response = client.GetStepArtifactContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetStepArtifactContentResponse response;
