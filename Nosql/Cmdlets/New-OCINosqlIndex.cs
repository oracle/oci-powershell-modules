...
{
    [Cmdlet("New", "OCINosqlIndex")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NosqlService.Responses.CreateIndexResponse) })]
    public class NewOCINosqlIndex : OCINosqlCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifications for the new index.")]
