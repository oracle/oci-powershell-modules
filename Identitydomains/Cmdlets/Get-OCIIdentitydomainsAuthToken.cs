...
{
    [Cmdlet("Get", "OCIIdentitydomainsAuthToken")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.AuthToken), typeof(Oci.IdentitydomainsService.Responses.GetAuthTokenResponse) })]
    public class GetOCIIdentitydomainsAuthToken : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GetAuthToken(request).GetAwaiter().GetResult();
        ...
        private GetAuthTokenResponse response;
    }
}
