...
{
    [Cmdlet("Get", "OCIAppmgmtcontrolWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.AppmgmtcontrolService.Models.WorkRequestSummaryCollection), typeof(Oci.AppmgmtcontrolService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIAppmgmtcontrolWorkRequestsList : OCIAppmgmtControlCmdlet
    {
