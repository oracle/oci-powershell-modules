...
{
    [Cmdlet("Invoke", "OCIDatabaseRotateAutonomousDatabaseEncryptionKey", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousDatabase), typeof(Oci.DatabaseService.Responses.RotateAutonomousDatabaseEncryptionKeyResponse) })]
    public class InvokeOCIDatabaseRotateAutonomousDatabaseEncryptionKey : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RotateAutonomousDatabaseEncryptionKeyRequest
                {
        ...
        private void HandleOutput(RotateAutonomousDatabaseEncryptionKeyRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRotateAutonomousDatabaseEncryptionKey(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RotateAutonomousDatabaseEncryptionKey(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousDatabase);
        }

        private RotateAutonomousDatabaseEncryptionKeyResponse response;
