...
{
    [Cmdlet("Move", "OCIEmailDomainCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.EmailService.Responses.ChangeEmailDomainCompartmentResponse) })]
    public class MoveOCIEmailDomainCompartment : OCIEmailCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeEmailDomainCompartmentRequest
                {
                ...
                response = client.ChangeEmailDomainCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeEmailDomainCompartmentResponse response;
    }
}
