...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyOAuth2ClientCredentialsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyOAuth2ClientCredentials), typeof(Oci.IdentitydomainsService.Responses.ListMyOAuth2ClientCredentialsResponse) })]
    public class GetOCIIdentitydomainsMyOAuth2ClientCredentialsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMyOAuth2ClientCredentialsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListMyOAuth2ClientCredentials(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MyOAuth2ClientCredentials);
        ...
        private ListMyOAuth2ClientCredentialsResponse response;
    }
}
