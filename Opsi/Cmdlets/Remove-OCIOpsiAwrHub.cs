...
{
    [Cmdlet("Remove", "OCIOpsiAwrHub", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.DeleteAwrHubResponse) })]
    public class RemoveOCIOpsiAwrHub : OCIOperationsInsightsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOpsiAwrHub", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteAwrHubRequest
                {
                    AwrHubId = AwrHubId,
                    IfMatch = IfMatch,
                ...
                response = client.DeleteAwrHub(request).GetAwaiter().GetResult();
        ...
        private DeleteAwrHubResponse response;
    }
}
