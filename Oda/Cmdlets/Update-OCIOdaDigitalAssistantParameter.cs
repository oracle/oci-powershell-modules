...
{
    [Cmdlet("Update", "OCIOdaDigitalAssistantParameter")]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.DigitalAssistantParameter), typeof(Oci.OdaService.Responses.UpdateDigitalAssistantParameterResponse) })]
    public class UpdateOCIOdaDigitalAssistantParameter : OCIManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The name of a Digital Assistant Parameter.  This is unique with the Digital Assistant.")]
        public string ParameterName { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Property values to update the Digital Assistant Parameter.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDigitalAssistantParameterRequest
                {
                ...
                response = client.UpdateDigitalAssistantParameter(request).GetAwaiter().GetResult();
        ...
        private UpdateDigitalAssistantParameterResponse response;
    }
}
