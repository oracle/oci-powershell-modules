...
{
    [Cmdlet("Move", "OCIResourceschedulerScheduleCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ResourceschedulerService.Responses.ChangeScheduleCompartmentResponse) })]
    public class MoveOCIResourceschedulerScheduleCompartment : OCIScheduleCmdlet
    {
