...
{
    [Cmdlet("Invoke", "OCIDatabaseMigrateVaultKey", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Database), typeof(Oci.DatabaseService.Responses.MigrateVaultKeyResponse) })]
    public class InvokeOCIDatabaseMigrateVaultKey : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new MigrateVaultKeyRequest
                {
        ...
        private void HandleOutput(MigrateVaultKeyRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForMigrateVaultKey(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.MigrateVaultKey(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.Database);
        }

        private MigrateVaultKeyResponse response;
