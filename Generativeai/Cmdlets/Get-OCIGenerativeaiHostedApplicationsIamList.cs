...
{
    [Cmdlet("Get", "OCIGenerativeaiHostedApplicationsIamList")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.HostedApplicationCollection), typeof(Oci.GenerativeaiService.Responses.ListHostedApplicationsIamResponse) })]
    public class GetOCIGenerativeaiHostedApplicationsIamList : OCIGenerativeAiCmdlet
    {
        ...
        public System.Nullable<Oci.GenerativeaiService.Requests.ListHostedApplicationsIamRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListHostedApplicationsIamResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListHostedApplicationsIamResponse> DefaultRequest(ListHostedApplicationsIamRequest request) => Enumerable.Repeat(client.ListHostedApplicationsIam(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListHostedApplicationsIamResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListHostedApplicationsIamResponse response;
        private delegate IEnumerable<ListHostedApplicationsIamResponse> RequestDelegate(ListHostedApplicationsIamRequest request);
