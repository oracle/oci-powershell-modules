...
namespace Oci.OsmanagementhubService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIOsmanagementhubEventContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.OsmanagementhubService.Responses.GetEventContentResponse) })]
    public class GetOCIOsmanagementhubEventContent : OCIEventCmdlet
    {
