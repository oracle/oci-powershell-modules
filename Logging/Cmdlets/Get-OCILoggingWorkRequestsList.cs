...
namespace Oci.LoggingService.Cmdlets
{
    ...
    public class GetOCILoggingWorkRequestsList : OCILoggingManagementCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"<b>Filter</b> results by [OCID](https://docs.oracle.com/iaas/Content/API/Concepts/identifiers.htm). Must be an OCID of the correct type for the resource type.")]
