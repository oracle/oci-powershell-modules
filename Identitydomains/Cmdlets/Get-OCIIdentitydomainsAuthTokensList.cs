...
{
    [Cmdlet("Get", "OCIIdentitydomainsAuthTokensList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.AuthTokens), typeof(Oci.IdentitydomainsService.Responses.ListAuthTokensResponse) })]
    public class GetOCIIdentitydomainsAuthTokensList : OCIIdentityDomainsCmdlet
    {
