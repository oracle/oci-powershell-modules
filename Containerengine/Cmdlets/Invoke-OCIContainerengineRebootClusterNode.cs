...
{
    [Cmdlet("Invoke", "OCIContainerengineRebootClusterNode")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ContainerengineService.Responses.RebootClusterNodeResponse) })]
    public class InvokeOCIContainerengineRebootClusterNode : OCIContainerEngineCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The fields to reboot a node.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RebootClusterNodeRequest
                {
                    ClusterId = ClusterId,
                    NodeId = NodeId,
                ...
                response = client.RebootClusterNode(request).GetAwaiter().GetResult();
        ...
        private RebootClusterNodeResponse response;
    }
}
