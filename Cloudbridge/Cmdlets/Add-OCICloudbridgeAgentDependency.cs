...
{
    [Cmdlet("Add", "OCICloudbridgeAgentDependency")]
    [OutputType(new System.Type[] { typeof(Oci.CloudbridgeService.Models.Environment), typeof(Oci.CloudbridgeService.Responses.AddAgentDependencyResponse) })]
    public class AddOCICloudbridgeAgentDependency : OCIOcbAgentSvcCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddAgentDependencyRequest
                {
                ...
                response = client.AddAgentDependency(request).GetAwaiter().GetResult();
        ...
        private AddAgentDependencyResponse response;
    }
}
