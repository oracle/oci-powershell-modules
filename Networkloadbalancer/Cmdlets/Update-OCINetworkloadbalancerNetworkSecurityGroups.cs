...
{
    [Cmdlet("Update", "OCINetworkloadbalancerNetworkSecurityGroups")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NetworkloadbalancerService.Responses.UpdateNetworkSecurityGroupsResponse) })]
    public class UpdateOCINetworkloadbalancerNetworkSecurityGroups : OCINetworkLoadBalancerCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details for updating the network security groups associated with the specified network load balancer.")]
