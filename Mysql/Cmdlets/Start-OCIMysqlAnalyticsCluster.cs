...
{
    [Cmdlet("Start", "OCIMysqlAnalyticsCluster")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.StartAnalyticsClusterResponse) })]
    public class StartOCIMysqlAnalyticsCluster : OCIDbSystemCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartAnalyticsClusterRequest
                {
                ...
                response = client.StartAnalyticsCluster(request).GetAwaiter().GetResult();
        ...
        private StartAnalyticsClusterResponse response;
    }
}
