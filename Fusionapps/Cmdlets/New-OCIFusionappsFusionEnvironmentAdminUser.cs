...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class NewOCIFusionappsFusionEnvironmentAdminUser : OCIFusionApplicationsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateFusionEnvironmentAdminUserRequest
                {
                ...
                response = client.CreateFusionEnvironmentAdminUser(request).GetAwaiter().GetResult();
        ...
        private CreateFusionEnvironmentAdminUserResponse response;
    }
}
