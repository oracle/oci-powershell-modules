...
{
    [Cmdlet("Move", "OCIStreamAdminStreamPoolCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.StreamingService.Responses.ChangeStreamPoolCompartmentResponse) })]
    public class MoveOCIStreamAdminStreamPoolCompartment : OCIStreamAdminCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The stream pool will be moved into the compartment specified within this entity.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeStreamPoolCompartmentRequest
                {
        ...
        private ChangeStreamPoolCompartmentResponse response;
    }
}
