...
{
    [Cmdlet("Start", "OCIOdaChannel")]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.Channel), typeof(Oci.OdaService.Responses.StartChannelResponse) })]
    public class StartOCIOdaChannel : OCIManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.StartChannel(request).GetAwaiter().GetResult();
