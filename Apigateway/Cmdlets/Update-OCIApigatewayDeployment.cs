...
{
    [Cmdlet("Update", "OCIApigatewayDeployment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApigatewayService.Responses.UpdateDeploymentResponse) })]
    public class UpdateOCIApigatewayDeployment : OCIDeploymentCmdlet
    {
