...
{
    [Cmdlet("Start", "OCILustrefilestorageImportFromObject")]
    [OutputType(new System.Type[] { typeof(Oci.LustrefilestorageService.Models.SyncJob), typeof(Oci.LustrefilestorageService.Responses.StartImportFromObjectResponse) })]
    public class StartOCILustrefilestorageImportFromObject : OCILustreFileStorageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartImportFromObjectRequest
                {
                ...
                response = client.StartImportFromObject(request).GetAwaiter().GetResult();
        ...
        private StartImportFromObjectResponse response;
    }
}
