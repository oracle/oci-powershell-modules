...
{
    [Cmdlet("Get", "OCIPsqlWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PsqlService.Models.WorkRequest), typeof(Oci.PsqlService.Responses.GetWorkRequestResponse) })]
    public class GetOCIPsqlWorkRequest : OCIPostgresqlCmdlet
    {
        ...
        public Oci.PsqlService.Models.OperationStatus[] WaitForStatus { get; set; }
