...
{
    [Cmdlet("Remove", "OCINetworkfirewallNatRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.NetworkfirewallService.Responses.DeleteNatRuleResponse) })]
    public class RemoveOCINetworkfirewallNatRule : OCINetworkFirewallCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCINetworkfirewallNatRule", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteNatRuleRequest
                {
                ...
                response = client.DeleteNatRule(request).GetAwaiter().GetResult();
        ...
        private DeleteNatRuleResponse response;
    }
}
