...
{
    [Cmdlet("DisMount", "OCIComputeVolume", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.DetachVolumeResponse) })]
    public class DisMountOCIComputeVolume : OCIComputeCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the volume attachment.", ParameterSetName = StatusParamSet)]
        ...
        private void HandleOutput(DetachVolumeRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDetachVolume(request, waiterConfig, WaitForStatus).Execute();
                    break;
