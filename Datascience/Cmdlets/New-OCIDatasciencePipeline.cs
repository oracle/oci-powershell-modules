...
{
    [Cmdlet("New", "OCIDatasciencePipeline")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.Pipeline), typeof(Oci.DatascienceService.Responses.CreatePipelineResponse) })]
    public class NewOCIDatasciencePipeline : OCIDataScienceCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new Pipeline.")]
