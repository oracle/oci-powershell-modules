...
{
    [Cmdlet("Edit", "OCIVirtualNetworkIpv4SubnetCidr", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.ModifyIpv4SubnetCidrResponse) })]
    public class EditOCIVirtualNetworkIpv4SubnetCidr : OCIVirtualNetworkCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details object for updating a SUBNET IPv4 prefix.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details object for updating a SUBNET IPv4 prefix.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ModifyIpv4SubnetCidrRequest
                {
                    SubnetId = SubnetId,
        ...
        private void HandleOutput(ModifyIpv4SubnetCidrRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForModifyIpv4SubnetCidr(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ModifyIpv4SubnetCidr(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private ModifyIpv4SubnetCidrResponse response;
