...
{
    [Cmdlet("New", "OCIObjectStorageReplicationPolicy")]
    [OutputType(new System.Type[] { typeof(Oci.ObjectstorageService.Models.ReplicationPolicy), typeof(Oci.ObjectstorageService.Responses.CreateReplicationPolicyResponse) })]
    public class NewOCIObjectStorageReplicationPolicy : OCIObjectStorageCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The replication policy.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateReplicationPolicyRequest
                {
                ...
                response = client.CreateReplicationPolicy(request).GetAwaiter().GetResult();
        ...
        private CreateReplicationPolicyResponse response;
    }
}
