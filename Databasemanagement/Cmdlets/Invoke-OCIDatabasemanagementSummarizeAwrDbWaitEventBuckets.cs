...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementSummarizeAwrDbWaitEventBuckets")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.AwrDbWaitEventBucketCollection), typeof(Oci.DatabasemanagementService.Responses.SummarizeAwrDbWaitEventBucketsResponse) })]
    public class InvokeOCIDatabasemanagementSummarizeAwrDbWaitEventBuckets : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.SummarizeAwrDbWaitEventBucketsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeAwrDbWaitEventBucketsRequest
                {
                ...
                response = client.SummarizeAwrDbWaitEventBuckets(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AwrDbWaitEventBucketCollection);
        ...
        private SummarizeAwrDbWaitEventBucketsResponse response;
    }
}
