...
{
    [Cmdlet("Get", "OCIDevopsProjectsList")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.ProjectCollection), typeof(Oci.DevopsService.Responses.ListProjectsResponse) })]
    public class GetOCIDevopsProjectsList : OCIDevopsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only Projects that matches the given lifecycleState.")]
        public System.Nullable<Oci.DevopsService.Models.Project.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.DevopsService.Requests.ListProjectsRequest.SortByEnum> SortBy { get; set; }
