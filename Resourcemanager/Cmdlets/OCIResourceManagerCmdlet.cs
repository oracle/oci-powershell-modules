...
using Oci.ResourcemanagerService;

namespace Oci.ResourcemanagerService.Cmdlets
{
    public abstract class OCIResourceManagerCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ResourceManagerClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ResourceManagerClient client;
