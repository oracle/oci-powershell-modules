...
{
    public abstract class OCITransferJobCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new TransferJobClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected TransferJobClient client;
