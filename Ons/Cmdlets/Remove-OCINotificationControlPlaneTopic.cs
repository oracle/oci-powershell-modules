...
{
    [Cmdlet("Remove", "OCINotificationControlPlaneTopic", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OnsService.Responses.DeleteTopicResponse) })]
    public class RemoveOCINotificationControlPlaneTopic : OCINotificationControlPlaneCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCINotificationControlPlaneTopic", "Remove"))
            {
               return;
            }
