...
{
    [Cmdlet("Invoke", "OCIDatabaseConfirmKeyStoreDetailsAreCorrect", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.ConfirmKeyStoreDetailsAreCorrectResponse) })]
    public class InvokeOCIDatabaseConfirmKeyStoreDetailsAreCorrect : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ConfirmKeyStoreDetailsAreCorrectRequest
                {
        ...
        private void HandleOutput(ConfirmKeyStoreDetailsAreCorrectRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForConfirmKeyStoreDetailsAreCorrect(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ConfirmKeyStoreDetailsAreCorrect(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private ConfirmKeyStoreDetailsAreCorrectResponse response;
