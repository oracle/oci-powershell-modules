...
{
    public abstract class OCIOcbAgentSvcCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OcbAgentSvcClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OcbAgentSvcClient client;
