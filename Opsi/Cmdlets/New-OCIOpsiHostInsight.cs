...
namespace Oci.OpsiService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the host for which a Host Insight resource will be created in Operations Insights. This parameter also accepts subtype <Oci.OpsiService.Models.CreateMacsManagedExternalHostInsightDetails> of type <Oci.OpsiService.Models.CreateHostInsightDetails>.")]
