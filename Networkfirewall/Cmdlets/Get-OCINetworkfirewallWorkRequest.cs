...
{
    [Cmdlet("Get", "OCINetworkfirewallWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.NetworkfirewallService.Models.WorkRequest), typeof(Oci.NetworkfirewallService.Responses.GetWorkRequestResponse) })]
    public class GetOCINetworkfirewallWorkRequest : OCINetworkFirewallCmdlet
    {
        ...
        public Oci.NetworkfirewallService.Models.OperationStatus[] WaitForStatus { get; set; }
