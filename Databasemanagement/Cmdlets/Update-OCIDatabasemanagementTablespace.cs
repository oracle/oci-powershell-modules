...
{
    [Cmdlet("Update", "OCIDatabasemanagementTablespace")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.Tablespace), typeof(Oci.DatabasemanagementService.Responses.UpdateTablespaceResponse) })]
    public class UpdateOCIDatabasemanagementTablespace : OCIDbManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details required to update a tablespace.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateTablespaceRequest
                {
                ...
                response = client.UpdateTablespace(request).GetAwaiter().GetResult();
        ...
        private UpdateTablespaceResponse response;
    }
}
