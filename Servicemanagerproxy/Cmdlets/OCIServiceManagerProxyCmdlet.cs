...
using Oci.ServicemanagerproxyService;

namespace Oci.ServicemanagerproxyService.Cmdlets
{
    public abstract class OCIServiceManagerProxyCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ServiceManagerProxyClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ServiceManagerProxyClient client;
