...
{
    [Cmdlet("New", "OCIDatacatalogAttributeTag")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.AttributeTag), typeof(Oci.DatacatalogService.Responses.CreateAttributeTagResponse) })]
    public class NewOCIDatacatalogAttributeTag : OCIDataCatalogCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information used to create an entity attribute tag.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateAttributeTagRequest
                {
                    CatalogId = CatalogId,
                ...
                response = client.CreateAttributeTag(request).GetAwaiter().GetResult();
        ...
        private CreateAttributeTagResponse response;
    }
}
