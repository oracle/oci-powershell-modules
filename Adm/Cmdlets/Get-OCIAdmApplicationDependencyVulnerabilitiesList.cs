...
namespace Oci.AdmService.Cmdlets
{
    ...
    public class GetOCIAdmApplicationDependencyVulnerabilitiesList : OCIApplicationDependencyManagementCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field to sort by. Only one sort order may be provided. Default order for gav is ascending where ascending corresponds to alphanumerical order. Default order for nodeId is ascending where ascending corresponds to alphanumerical order.")]
