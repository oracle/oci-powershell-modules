...
{
    public abstract class OCIVaultsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new VaultsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
