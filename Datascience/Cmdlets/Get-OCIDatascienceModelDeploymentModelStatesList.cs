...
{
    [Cmdlet("Get", "OCIDatascienceModelDeploymentModelStatesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.ModelDeploymentModelStateSummary), typeof(Oci.DatascienceService.Responses.ListModelDeploymentModelStatesResponse) })]
    public class GetOCIDatascienceModelDeploymentModelStatesList : OCIDataScienceCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"<b>Filter</b> results by the inference key.")]
        public string InferenceKey { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"<b>Filter</b> results by the model ocid.")]
...
See [List Pagination](https://docs.oracle.com/iaas/Content/General/Concepts/usingapi.htm#nine).")]
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListModelDeploymentModelStatesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListModelDeploymentModelStatesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListModelDeploymentModelStatesRequest
                {
                ...
                IEnumerable<ListModelDeploymentModelStatesResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListModelDeploymentModelStatesResponse> DefaultRequest(ListModelDeploymentModelStatesRequest request) => Enumerable.Repeat(client.ListModelDeploymentModelStates(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListModelDeploymentModelStatesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListModelDeploymentModelStatesResponse response;
        private delegate IEnumerable<ListModelDeploymentModelStatesResponse> RequestDelegate(ListModelDeploymentModelStatesRequest request);
