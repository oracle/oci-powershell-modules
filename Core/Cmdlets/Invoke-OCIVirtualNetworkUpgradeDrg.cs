...
{
    [Cmdlet("Invoke", "OCIVirtualNetworkUpgradeDrg", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.UpgradeDrgResponse) })]
    public class InvokeOCIVirtualNetworkUpgradeDrg : OCIVirtualNetworkCmdlet
    {
        ...
        private void HandleOutput(UpgradeDrgRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpgradeDrg(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpgradeDrg(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private UpgradeDrgResponse response;
