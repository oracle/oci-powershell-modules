...
using Oci.MulticloudService;

namespace Oci.MulticloudService.Cmdlets
{
    public abstract class OCIMulticloudsubscriptionsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MulticloudsubscriptionsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MulticloudsubscriptionsClient client;
