...
{
    [Cmdlet("Move", "OCICertificatesmanagementCertificateAuthorityCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CertificatesmanagementService.Responses.ChangeCertificateAuthorityCompartmentResponse) })]
    public class MoveOCICertificatesmanagementCertificateAuthorityCompartment : OCICertificatesManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeCertificateAuthorityCompartmentRequest
                {
                ...
                response = client.ChangeCertificateAuthorityCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeCertificateAuthorityCompartmentResponse response;
    }
}
