...
{
    [Cmdlet("Remove", "OCIDatascienceProject", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatascienceService.Responses.DeleteProjectResponse) })]
    public class RemoveOCIDatascienceProject : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatascienceProject", "Remove"))
            {
               return;
            }
