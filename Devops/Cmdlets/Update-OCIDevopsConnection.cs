...
namespace Oci.DevopsService.Cmdlets
{
    ...
    public class UpdateOCIDevopsConnection : OCIDevopsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information to be updated. This parameter also accepts subtypes <Oci.DevopsService.Models.UpdateGithubAccessTokenConnectionDetails>, <Oci.DevopsService.Models.UpdateVbsAccessTokenConnectionDetails>, <Oci.DevopsService.Models.UpdateBitbucketServerAccessTokenConnectionDetails>, <Oci.DevopsService.Models.UpdateGitlabAccessTokenConnectionDetails>, <Oci.DevopsService.Models.UpdateBitbucketCloudAppPasswordConnectionDetails>, <Oci.DevopsService.Models.UpdateGitlabServerAccessTokenConnectionDetails> of type <Oci.DevopsService.Models.UpdateConnectionDetails>.")]
