...
namespace Oci.OsmanagementhubService.Cmdlets
{
    ...
    public class MountOCIOsmanagementhubSoftwareSourcesToManagedInstanceGroup : OCIManagedInstanceGroupCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The software source [OCIDs](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to attach to the managed instance group.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AttachSoftwareSourcesToManagedInstanceGroupRequest
                {
        ...
        private AttachSoftwareSourcesToManagedInstanceGroupResponse response;
    }
}
