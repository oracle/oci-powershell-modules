...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchDynamicResourceGroups")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.DynamicResourceGroups), typeof(Oci.IdentitydomainsService.Responses.SearchDynamicResourceGroupsResponse) })]
    public class InvokeOCIIdentitydomainsSearchDynamicResourceGroups : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching DynamicResourceGroups")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchDynamicResourceGroupsRequest
                {
                ...
                response = client.SearchDynamicResourceGroups(request).GetAwaiter().GetResult();
                WriteOutput(response, response.DynamicResourceGroups);
        ...
        private SearchDynamicResourceGroupsResponse response;
    }
}
