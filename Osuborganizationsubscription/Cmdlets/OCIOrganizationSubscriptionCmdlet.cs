...
using Oci.OsuborganizationsubscriptionService;

namespace Oci.OsuborganizationsubscriptionService.Cmdlets
{
    public abstract class OCIOrganizationSubscriptionCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OrganizationSubscriptionClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OrganizationSubscriptionClient client;
