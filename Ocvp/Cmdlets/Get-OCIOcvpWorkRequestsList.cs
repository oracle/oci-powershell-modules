...
namespace Oci.OcvpService.Cmdlets
{
    ...
    public class GetOCIOcvpWorkRequestsList : OCIWorkRequestCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the resource.")]
