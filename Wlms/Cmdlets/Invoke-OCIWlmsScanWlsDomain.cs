...
{
    [Cmdlet("Invoke", "OCIWlmsScanWlsDomain")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WlmsService.Responses.ScanWlsDomainResponse) })]
    public class InvokeOCIWlmsScanWlsDomain : OCIWeblogicManagementServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ScanWlsDomainRequest
                {
                ...
                response = client.ScanWlsDomain(request).GetAwaiter().GetResult();
        ...
        private ScanWlsDomainResponse response;
    }
}
