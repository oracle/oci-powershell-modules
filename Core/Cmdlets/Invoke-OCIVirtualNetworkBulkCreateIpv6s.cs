...
{
    [Cmdlet("Invoke", "OCIVirtualNetworkBulkCreateIpv6s", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.BulkCreateIpv6sResponse) })]
    public class InvokeOCIVirtualNetworkBulkCreateIpv6s : OCIVirtualNetworkCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new BulkCreateIpv6sRequest
                {
        ...
        private void HandleOutput(BulkCreateIpv6sRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForBulkCreateIpv6s(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.BulkCreateIpv6s(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private BulkCreateIpv6sResponse response;
