...
{
    [Cmdlet("Get", "OCISchWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.SchService.Models.WorkRequestLogEntryCollection), typeof(Oci.SchService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCISchWorkRequestLogsList : OCIServiceConnectorCmdlet
    {
