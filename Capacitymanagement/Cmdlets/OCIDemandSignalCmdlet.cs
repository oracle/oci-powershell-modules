...
{
    public abstract class OCIDemandSignalCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DemandSignalClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DemandSignalClient client;
