...
{
    [Cmdlet("Get", "OCIComputeInstanceMaintenanceReboot")]
    ...
    public class GetOCIComputeInstanceMaintenanceReboot : OCIComputeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetInstanceMaintenanceRebootRequest
                {
                    InstanceId = InstanceId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetInstanceMaintenanceReboot(request).GetAwaiter().GetResult();
                WriteOutput(response, response.InstanceMaintenanceReboot);
        ...
        private GetInstanceMaintenanceRebootResponse response;
    }
}
