...
{
    [Cmdlet("Disable", "OCIOpsiAwrHubSource")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.DisableAwrHubSourceResponse) })]
    public class DisableOCIOpsiAwrHubSource : OCIOperationsInsightsCmdlet
    {
...
*Note:* Retry tokens can be invalidated before the 24 hour time limit due to conflicting operations, such as a resource being deleted or purged from the system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableAwrHubSourceRequest
                {
                ...
                response = client.DisableAwrHubSource(request).GetAwaiter().GetResult();
        ...
        private DisableAwrHubSourceResponse response;
    }
}
