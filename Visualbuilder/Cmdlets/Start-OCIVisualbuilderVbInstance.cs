...
{
    [Cmdlet("Start", "OCIVisualbuilderVbInstance")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.VisualbuilderService.Responses.StartVbInstanceResponse) })]
    public class StartOCIVisualbuilderVbInstance : OCIVbInstanceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartVbInstanceRequest
                {
                ...
                response = client.StartVbInstance(request).GetAwaiter().GetResult();
        ...
        private StartVbInstanceResponse response;
    }
}
