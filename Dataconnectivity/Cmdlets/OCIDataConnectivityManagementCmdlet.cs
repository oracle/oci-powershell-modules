...
using Oci.DataconnectivityService;

namespace Oci.DataconnectivityService.Cmdlets
{
    public abstract class OCIDataConnectivityManagementCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DataConnectivityManagementClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DataConnectivityManagementClient client;
