...
using Oci.DblmService;

namespace Oci.DblmService.Cmdlets
{
    public abstract class OCIDbLifeCycleManagementCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DbLifeCycleManagementClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DbLifeCycleManagementClient client;
