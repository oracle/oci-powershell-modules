...
{
    [Cmdlet("Get", "OCIMarketplaceWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.MarketplaceService.Models.WorkRequestCollection), typeof(Oci.MarketplaceService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIMarketplaceWorkRequestsList : OCIMarketplaceCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only resources whose status matches the given OperationStatus.")]
        public System.Nullable<Oci.MarketplaceService.Models.OperationStatus> Status { get; set; }
        ...
        public System.Nullable<Oci.MarketplaceService.Requests.ListWorkRequestsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.MarketplaceService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }
