...
{
    [Cmdlet("Get", "OCIDatabasemanagementDatabaseFleetHaOverviewMetrics")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.DatabaseFleetHaOverviewMetrics), typeof(Oci.DatabasemanagementService.Responses.GetDatabaseFleetHaOverviewMetricsResponse) })]
    public class GetOCIDatabasemanagementDatabaseFleetHaOverviewMetrics : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.GetDatabaseFleetHaOverviewMetricsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetDatabaseFleetHaOverviewMetricsRequest
                {
                ...
                response = client.GetDatabaseFleetHaOverviewMetrics(request).GetAwaiter().GetResult();
                WriteOutput(response, response.DatabaseFleetHaOverviewMetrics);
        ...
        private GetDatabaseFleetHaOverviewMetricsResponse response;
    }
}
