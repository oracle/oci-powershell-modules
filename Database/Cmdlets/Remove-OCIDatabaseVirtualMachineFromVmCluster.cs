...
{
    [Cmdlet("Remove", "OCIDatabaseVirtualMachineFromVmCluster", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.VmCluster), typeof(Oci.DatabaseService.Responses.RemoveVirtualMachineFromVmClusterResponse) })]
    public class RemoveOCIDatabaseVirtualMachineFromVmCluster : OCIDatabaseCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to remove Virtual Machines from the VM cluster.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to remove Virtual Machines from the VM cluster.", ParameterSetName = Default)]
        public RemoveVirtualMachineFromVmClusterDetails RemoveVirtualMachineFromVmClusterDetails { get; set; }

        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The VM cluster [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).", ParameterSetName = StatusParamSet)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveVirtualMachineFromVmClusterRequest
                {
        ...
        private void HandleOutput(RemoveVirtualMachineFromVmClusterRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRemoveVirtualMachineFromVmCluster(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RemoveVirtualMachineFromVmCluster(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.VmCluster);
        }

        private RemoveVirtualMachineFromVmClusterResponse response;
