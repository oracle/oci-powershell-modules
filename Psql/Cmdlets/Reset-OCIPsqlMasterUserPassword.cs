...
{
    [Cmdlet("Reset", "OCIPsqlMasterUserPassword")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.PsqlService.Responses.ResetMasterUserPasswordResponse) })]
    public class ResetOCIPsqlMasterUserPassword : OCIPostgresqlCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ResetMasterUserPasswordRequest
                {
                ...
                response = client.ResetMasterUserPassword(request).GetAwaiter().GetResult();
        ...
        private ResetMasterUserPasswordResponse response;
    }
}
