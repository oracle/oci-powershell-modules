...
{
    [Cmdlet("Get", "OCIVirtualNetworkSubnetsList")]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.Subnet), typeof(Oci.CoreService.Responses.ListSubnetsResponse) })]
    public class GetOCIVirtualNetworkSubnetsList : OCIVirtualNetworkCmdlet
    {
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by availability domain if the scope of the resource type is within a single availability domain. If you call one of these ""List"" operations without specifying an availability domain, the resources are grouped by availability domain, then sorted.")]
        public System.Nullable<Oci.CoreService.Requests.ListSubnetsRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Requests.ListSubnetsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Models.Subnet.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        {
            IEnumerable<ListSubnetsResponse> DefaultRequest(ListSubnetsRequest request) => Enumerable.Repeat(client.ListSubnets(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSubnetsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSubnetsResponse response;
        private delegate IEnumerable<ListSubnetsResponse> RequestDelegate(ListSubnetsRequest request);
