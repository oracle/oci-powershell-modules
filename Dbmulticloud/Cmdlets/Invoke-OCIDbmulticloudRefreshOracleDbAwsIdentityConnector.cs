...
{
    [Cmdlet("Invoke", "OCIDbmulticloudRefreshOracleDbAwsIdentityConnector")]
...
For example, if a resource has been deleted and permanently purged from the system, a retry of the original creation request may be rejected.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RefreshOracleDbAwsIdentityConnectorRequest
                {
                ...
                response = client.RefreshOracleDbAwsIdentityConnector(request).GetAwaiter().GetResult();
        ...
        private RefreshOracleDbAwsIdentityConnectorResponse response;
    }
}
