...
{
    public abstract class OCINetworkValidationCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new NetworkValidationClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected NetworkValidationClient client;
