...
{
    [Cmdlet("Update", "OCIDbmulticloudOracleDbAzureVaultAssociation")]
    ...
    public class UpdateOCIDbmulticloudOracleDbAzureVaultAssociation : OCIOracleDbAzureVaultAssociationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateOracleDbAzureVaultAssociationRequest
                {
                ...
                response = client.UpdateOracleDbAzureVaultAssociation(request).GetAwaiter().GetResult();
        ...
        private UpdateOracleDbAzureVaultAssociationResponse response;
    }
}
