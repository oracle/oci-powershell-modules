...
{
    [Cmdlet("Remove", "OCIContainerengineWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ContainerengineService.Responses.DeleteWorkRequestResponse) })]
    public class RemoveOCIContainerengineWorkRequest : OCIContainerEngineCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIContainerengineWorkRequest", "Remove"))
            {
               return;
            }
