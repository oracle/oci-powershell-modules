...
{
    [Cmdlet("Invoke", "OCIDemandsignalPatchOccDemandSignal")]
    ...
    public class InvokeOCIDemandsignalPatchOccDemandSignal : OCIOccDemandSignalCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.PatchOccDemandSignal(request).GetAwaiter().GetResult();
        ...
        private PatchOccDemandSignalResponse response;
    }
}
