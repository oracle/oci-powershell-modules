...
{
    [Cmdlet("Invoke", "OCIApiaccesscontrolRejectPrivilegedApiRequest")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApiaccesscontrolService.Responses.RejectPrivilegedApiRequestResponse) })]
    public class InvokeOCIApiaccesscontrolRejectPrivilegedApiRequest : OCIPrivilegedApiRequestsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details regarding the rejection of privilegedApi request created by the operator.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RejectPrivilegedApiRequestRequest
                {
                ...
                response = client.RejectPrivilegedApiRequest(request).GetAwaiter().GetResult();
        ...
        private RejectPrivilegedApiRequestResponse response;
    }
}
