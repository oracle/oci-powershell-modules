...
{
    [Cmdlet("Move", "OCIDatascienceNotebookSessionCompartment")]
    ...
    public class MoveOCIDatascienceNotebookSessionCompartment : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeNotebookSessionCompartmentRequest
                {
                ...
                response = client.ChangeNotebookSessionCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeNotebookSessionCompartmentResponse response;
    }
}
