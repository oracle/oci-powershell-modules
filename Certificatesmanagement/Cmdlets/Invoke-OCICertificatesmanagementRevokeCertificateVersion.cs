...
{
    [Cmdlet("Invoke", "OCICertificatesmanagementRevokeCertificateVersion")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CertificatesmanagementService.Responses.RevokeCertificateVersionResponse) })]
    public class InvokeOCICertificatesmanagementRevokeCertificateVersion : OCICertificatesManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details of the request to revoke a certificate version.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RevokeCertificateVersionRequest
                {
                ...
                response = client.RevokeCertificateVersion(request).GetAwaiter().GetResult();
        ...
        private RevokeCertificateVersionResponse response;
    }
}
