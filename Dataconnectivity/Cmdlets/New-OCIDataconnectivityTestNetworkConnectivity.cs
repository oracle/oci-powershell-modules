...
{
    [Cmdlet("New", "OCIDataconnectivityTestNetworkConnectivity")]
    [OutputType(new System.Type[] { typeof(Oci.DataconnectivityService.Models.TestNetworkConnectivity), typeof(Oci.DataconnectivityService.Responses.CreateTestNetworkConnectivityResponse) })]
    public class NewOCIDataconnectivityTestNetworkConnectivity : OCIDataConnectivityManagementCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The registry OCID.")]
        public string RegistryId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request body parameters to execute network validation.")]
        public CreateTestNetworkConnectivityDetails CreateTestNetworkConnectivityDetails { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateTestNetworkConnectivityRequest
                {
                ...
                response = client.CreateTestNetworkConnectivity(request).GetAwaiter().GetResult();
                WriteOutput(response, response.TestNetworkConnectivity);
        ...
        private CreateTestNetworkConnectivityResponse response;
    }
}
