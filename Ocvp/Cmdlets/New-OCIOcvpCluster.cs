...
{
    [Cmdlet("New", "OCIOcvpCluster")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OcvpService.Responses.CreateClusterResponse) })]
    public class NewOCIOcvpCluster : OCIClusterCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the Cluster.")]
