...
{
    [Cmdlet("Remove", "OCIGenerativeaiApiKey", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.GenerativeaiService.Responses.DeleteApiKeyResponse) })]
    public class RemoveOCIGenerativeaiApiKey : OCIGenerativeAiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIGenerativeaiApiKey", "Remove"))
            {
               return;
            }
