...
{
    [Cmdlet("Update", "OCIDbmulticloudOracleDbAzureBlobContainer")]
    ...
    public class UpdateOCIDbmulticloudOracleDbAzureBlobContainer : OCIOracleDBAzureBlobContainerCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateOracleDbAzureBlobContainerRequest
                {
                ...
                response = client.UpdateOracleDbAzureBlobContainer(request).GetAwaiter().GetResult();
        ...
        private UpdateOracleDbAzureBlobContainerResponse response;
    }
}
