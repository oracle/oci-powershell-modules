...
{
    [Cmdlet("Invoke", "OCIDatabaseRotateSslCerts", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.RotateSslCertsResponse) })]
    public class InvokeOCIDatabaseRotateSslCerts : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RotateSslCertsRequest
                {
        ...
        private void HandleOutput(RotateSslCertsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRotateSslCerts(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RotateSslCerts(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private RotateSslCertsResponse response;
