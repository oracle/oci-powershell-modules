...
using Oci.GovernancerulescontrolplaneService;

namespace Oci.GovernancerulescontrolplaneService.Cmdlets
{
    public abstract class OCIGovernanceRuleCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new GovernanceRuleClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected GovernanceRuleClient client;
