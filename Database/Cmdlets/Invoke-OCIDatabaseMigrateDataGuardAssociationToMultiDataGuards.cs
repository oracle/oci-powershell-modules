...
{
    [Cmdlet("Invoke", "OCIDatabaseMigrateDataGuardAssociationToMultiDataGuards", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Database), typeof(Oci.DatabaseService.Responses.MigrateDataGuardAssociationToMultiDataGuardsResponse) })]
    public class InvokeOCIDatabaseMigrateDataGuardAssociationToMultiDataGuards : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new MigrateDataGuardAssociationToMultiDataGuardsRequest
                {
        ...
        private void HandleOutput(MigrateDataGuardAssociationToMultiDataGuardsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForMigrateDataGuardAssociationToMultiDataGuards(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.MigrateDataGuardAssociationToMultiDataGuards(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.Database);
        }

        private MigrateDataGuardAssociationToMultiDataGuardsResponse response;
