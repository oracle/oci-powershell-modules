...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchUserAttributesSettings")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.UserAttributesSettings), typeof(Oci.IdentitydomainsService.Responses.SearchUserAttributesSettingsResponse) })]
    public class InvokeOCIIdentitydomainsSearchUserAttributesSettings : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching UserAttributesSettings")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchUserAttributesSettingsRequest
                {
                ...
                response = client.SearchUserAttributesSettings(request).GetAwaiter().GetResult();
                WriteOutput(response, response.UserAttributesSettings);
        ...
        private SearchUserAttributesSettingsResponse response;
    }
}
