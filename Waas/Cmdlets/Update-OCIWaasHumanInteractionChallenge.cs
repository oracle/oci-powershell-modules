...
{
    [Cmdlet("Update", "OCIWaasHumanInteractionChallenge")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdateHumanInteractionChallengeResponse) })]
    public class UpdateOCIWaasHumanInteractionChallenge : OCIWaasCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The human interaction challenge settings.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateHumanInteractionChallengeRequest
                {
                ...
                response = client.UpdateHumanInteractionChallenge(request).GetAwaiter().GetResult();
        ...
        private UpdateHumanInteractionChallengeResponse response;
    }
}
