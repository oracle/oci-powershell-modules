...
{
    [Cmdlet("Remove", "OCIGenerativeaiagentAgent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GenerativeaiagentService.Responses.DeleteAgentResponse) })]
    public class RemoveOCIGenerativeaiagentAgent : OCIGenerativeAiAgentCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the agent.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIGenerativeaiagentAgent", "Remove"))
            {
               return;
            }
        ...
        private DeleteAgentResponse response;
    }
}
