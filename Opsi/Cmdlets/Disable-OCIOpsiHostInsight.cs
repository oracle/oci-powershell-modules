...
{
    [Cmdlet("Disable", "OCIOpsiHostInsight")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.DisableHostInsightResponse) })]
    public class DisableOCIOpsiHostInsight : OCIOperationsInsightsCmdlet
    {
...
*Note:* Retry tokens can be invalidated before the 24 hour time limit due to conflicting operations, such as a resource being deleted or purged from the system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableHostInsightRequest
                {
                ...
                response = client.DisableHostInsight(request).GetAwaiter().GetResult();
        ...
        private DisableHostInsightResponse response;
    }
}
