...
{
    [Cmdlet("Remove", "OCIArtifactsContainerRepository", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ArtifactsService.Responses.DeleteContainerRepositoryResponse) })]
    public class RemoveOCIArtifactsContainerRepository : OCIArtifactsCmdlet
    {
...
Example: `ocid1.containerrepo.oc1..exampleuniqueID`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIArtifactsContainerRepository", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteContainerRepositoryRequest
                {
        ...
        private DeleteContainerRepositoryResponse response;
    }
}
