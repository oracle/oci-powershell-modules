...
{
    [Cmdlet("Get", "OCIContainerinstancesWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.ContainerinstancesService.Models.WorkRequestErrorCollection), typeof(Oci.ContainerinstancesService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIContainerinstancesWorkRequestErrorsList : OCIContainerInstanceCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field to sort by. You can provide one sort order. Default order for timestamp is descending.")]
        public System.Nullable<Oci.ContainerinstancesService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }
