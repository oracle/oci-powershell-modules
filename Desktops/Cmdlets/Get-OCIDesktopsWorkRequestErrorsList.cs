...
{
    [Cmdlet("Get", "OCIDesktopsWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.DesktopsService.Models.WorkRequestErrorCollection), typeof(Oci.DesktopsService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIDesktopsWorkRequestErrorsList : OCIDesktopServiceCmdlet
    {
        ...
        public System.Nullable<Oci.DesktopsService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A field to indicate the sort order.")]
        public System.Nullable<Oci.DesktopsService.Requests.ListWorkRequestErrorsRequest.SortOrderEnum> SortOrder { get; set; }
