...
{
    [Cmdlet("Get", "OCIDatascienceComputeTargetsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.ComputeTargetSummary), typeof(Oci.DatascienceService.Responses.ListComputeTargetsResponse) })]
    public class GetOCIDatascienceComputeTargetsList : OCIDataScienceCmdlet
    {
        ...
        public System.Nullable<Oci.DatascienceService.Models.ComputeTargetLifecycleState> LifecycleState { get; set; }
...
See [List Pagination](https://docs.oracle.com/iaas/Content/General/Concepts/usingapi.htm#nine).")]
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListComputeTargetsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListComputeTargetsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListComputeTargetsRequest
                {
                ...
                IEnumerable<ListComputeTargetsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListComputeTargetsResponse> DefaultRequest(ListComputeTargetsRequest request) => Enumerable.Repeat(client.ListComputeTargets(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListComputeTargetsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListComputeTargetsResponse response;
        private delegate IEnumerable<ListComputeTargetsResponse> RequestDelegate(ListComputeTargetsRequest request);
