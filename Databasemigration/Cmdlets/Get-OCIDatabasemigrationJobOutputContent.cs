...
namespace Oci.DatabasemigrationService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIDatabasemigrationJobOutputContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatabasemigrationService.Responses.GetJobOutputContentResponse) })]
    public class GetOCIDatabasemigrationJobOutputContent : OCIDatabaseMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetJobOutputContentRequest
                {
                    JobId = JobId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetJobOutputContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetJobOutputContentResponse response;
