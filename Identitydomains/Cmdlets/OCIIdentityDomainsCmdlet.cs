...
{
    public abstract class OCIIdentityDomainsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new IdentityDomainsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected IdentityDomainsClient client;
