...
{
    [Cmdlet("Invoke", "OCICloudguardRequestSecurityScores")]
    [OutputType(new System.Type[] { typeof(Oci.CloudguardService.Models.SecurityScoreAggregationCollection), typeof(Oci.CloudguardService.Responses.RequestSecurityScoresResponse) })]
    public class InvokeOCICloudguardRequestSecurityScores : OCICloudGuardCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RequestSecurityScoresRequest
                {
        ...
        private RequestSecurityScoresResponse response;
    }
}
