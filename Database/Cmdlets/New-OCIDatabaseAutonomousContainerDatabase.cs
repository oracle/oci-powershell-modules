...
{
    [Cmdlet("New", "OCIDatabaseAutonomousContainerDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousContainerDatabase), typeof(Oci.DatabaseService.Responses.CreateAutonomousContainerDatabaseResponse) })]
    public class NewOCIDatabaseAutonomousContainerDatabase : OCIDatabaseCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to create an Autonomous Container Database in a specified Autonomous Exadata Infrastructure or in Autonomous VM Cluster. This parameter also accepts subtypes <Oci.DatabaseService.Models.CreateAutonomousContainerDatabaseFromBackupTimestampDetails>, <Oci.DatabaseService.Models.CreateAutonomousContainerDatabaseDetails>, <Oci.DatabaseService.Models.CreateAutonomousContainerDatabaseFromBackupDetails> of type <Oci.DatabaseService.Models.CreateAutonomousContainerDatabaseBase>.", ParameterSetName = StatusParamSet)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateAutonomousContainerDatabaseRequest
                {
        ...
        private void HandleOutput(CreateAutonomousContainerDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForCreateAutonomousContainerDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.CreateAutonomousContainerDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousContainerDatabase);
        }

        private CreateAutonomousContainerDatabaseResponse response;
