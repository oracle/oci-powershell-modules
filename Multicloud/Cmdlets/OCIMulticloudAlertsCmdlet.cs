...
{
    public abstract class OCIMulticloudAlertsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MulticloudAlertsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MulticloudAlertsClient client;
