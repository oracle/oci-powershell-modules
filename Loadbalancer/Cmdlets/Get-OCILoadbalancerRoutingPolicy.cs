...
{
    [Cmdlet("Get", "OCILoadbalancerRoutingPolicy")]
...
Example: `example-etag`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetRoutingPolicyRequest
                {
                ...
                response = client.GetRoutingPolicy(request).GetAwaiter().GetResult();
                WriteOutput(response, response.RoutingPolicy);
        ...
        private GetRoutingPolicyResponse response;
    }
}
