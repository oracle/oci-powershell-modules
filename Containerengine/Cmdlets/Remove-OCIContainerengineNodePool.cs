...
{
    [Cmdlet("Remove", "OCIContainerengineNodePool", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ContainerengineService.Responses.DeleteNodePoolResponse) })]
    public class RemoveOCIContainerengineNodePool : OCIContainerEngineCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIContainerengineNodePool", "Remove"))
            {
               return;
            }
        ...
        private DeleteNodePoolResponse response;
    }
}
