...
{
    [Cmdlet("Move", "OCIDashboardserviceDashboardGroup")]
    ...
    public class MoveOCIDashboardserviceDashboardGroup : OCIDashboardCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeDashboardGroupRequest
                {
                ...
                response = client.ChangeDashboardGroup(request).GetAwaiter().GetResult();
        ...
        private ChangeDashboardGroupResponse response;
    }
}
