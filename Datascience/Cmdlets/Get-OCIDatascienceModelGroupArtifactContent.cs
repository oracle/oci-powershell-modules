...
namespace Oci.DatascienceService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIDatascienceModelGroupArtifactContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatascienceService.Responses.GetModelGroupArtifactContentResponse) })]
    public class GetOCIDatascienceModelGroupArtifactContent : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetModelGroupArtifactContentRequest
                {
                ...
                response = client.GetModelGroupArtifactContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetModelGroupArtifactContentResponse response;
