...
{
    [Cmdlet("Get", "OCIIdentitydomainsSetting")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Setting), typeof(Oci.IdentitydomainsService.Responses.GetSettingResponse) })]
    public class GetOCIIdentitydomainsSetting : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GetSetting(request).GetAwaiter().GetResult();
        ...
        private GetSettingResponse response;
    }
}
