...
{
    [Cmdlet("Remove", "OCIIotDigitalTwinInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IotService.Responses.DeleteDigitalTwinInstanceResponse) })]
    public class RemoveOCIIotDigitalTwinInstance : OCIIotCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIotDigitalTwinInstance", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDigitalTwinInstanceRequest
                {
                ...
                response = client.DeleteDigitalTwinInstance(request).GetAwaiter().GetResult();
        ...
        private DeleteDigitalTwinInstanceResponse response;
    }
}
