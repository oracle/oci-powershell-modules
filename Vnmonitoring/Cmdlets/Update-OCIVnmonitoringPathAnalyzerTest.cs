...
{
    [Cmdlet("Update", "OCIVnmonitoringPathAnalyzerTest")]
    ...
    public class UpdateOCIVnmonitoringPathAnalyzerTest : OCIVnMonitoringCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdatePathAnalyzerTestRequest
                {
                ...
                response = client.UpdatePathAnalyzerTest(request).GetAwaiter().GetResult();
        ...
        private UpdatePathAnalyzerTestResponse response;
    }
}
