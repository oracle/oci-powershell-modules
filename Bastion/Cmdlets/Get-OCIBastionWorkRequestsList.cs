...
{
    [Cmdlet("Get", "OCIBastionWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.BastionService.Models.WorkRequestSummary), typeof(Oci.BastionService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIBastionWorkRequestsList : OCIBastionCmdlet
    {
