...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchAppRoles")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.AppRoles), typeof(Oci.IdentitydomainsService.Responses.SearchAppRolesResponse) })]
    public class InvokeOCIIdentitydomainsSearchAppRoles : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching AppRoles")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchAppRolesRequest
                {
                ...
                response = client.SearchAppRoles(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AppRoles);
        ...
        private SearchAppRolesResponse response;
    }
}
