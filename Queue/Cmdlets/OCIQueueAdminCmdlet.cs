...
{
    public abstract class OCIQueueAdminCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new QueueAdminClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected QueueAdminClient client;
