...
{
    [Cmdlet("Update", "OCIAianomalydetectionModel")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AianomalydetectionService.Responses.UpdateModelResponse) })]
    public class UpdateOCIAianomalydetectionModel : OCIAnomalyDetectionCmdlet
    {
