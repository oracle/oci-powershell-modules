...
{
    [Cmdlet("Invoke", "OCIPsqlFailoverDbSystem")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.PsqlService.Responses.FailoverDbSystemResponse) })]
    public class InvokeOCIPsqlFailoverDbSystem : OCIPostgresqlCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new FailoverDbSystemRequest
                {
                ...
                response = client.FailoverDbSystem(request).GetAwaiter().GetResult();
        ...
        private FailoverDbSystemResponse response;
    }
}
