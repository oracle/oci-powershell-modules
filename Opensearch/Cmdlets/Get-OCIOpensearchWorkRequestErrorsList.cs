...
{
    [Cmdlet("Get", "OCIOpensearchWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.OpensearchService.Models.WorkRequestErrorCollection), typeof(Oci.OpensearchService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIOpensearchWorkRequestErrorsList : OCIOpensearchClusterCmdlet
    {
