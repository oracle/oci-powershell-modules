...
{
    [Cmdlet("Move", "OCIGenerativeaiPrivateEndpointCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GenerativeaiService.Responses.ChangeGenerativeAiPrivateEndpointCompartmentResponse) })]
    public class MoveOCIGenerativeaiPrivateEndpointCompartment : OCIGenerativeAiCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique id for a Generative AI private endpoint.")]
        public string GenerativeAiPrivateEndpointId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for changing a Generative AI private endpoint's compartment.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeGenerativeAiPrivateEndpointCompartmentRequest
                {
                ...
                response = client.ChangeGenerativeAiPrivateEndpointCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeGenerativeAiPrivateEndpointCompartmentResponse response;
    }
}
