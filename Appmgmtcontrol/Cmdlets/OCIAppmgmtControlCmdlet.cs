...
using Oci.AppmgmtcontrolService;

namespace Oci.AppmgmtcontrolService.Cmdlets
{
    public abstract class OCIAppmgmtControlCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AppmgmtControlClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AppmgmtControlClient client;
