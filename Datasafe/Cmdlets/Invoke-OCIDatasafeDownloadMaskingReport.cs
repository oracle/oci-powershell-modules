...
namespace Oci.DatasafeService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIDatasafeDownloadMaskingReport", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatasafeService.Responses.DownloadMaskingReportResponse) })]
    public class InvokeOCIDatasafeDownloadMaskingReport : OCIDataSafeCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details to download a masking report.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DownloadMaskingReportRequest
                {
                ...
                response = client.DownloadMaskingReport(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private DownloadMaskingReportResponse response;
