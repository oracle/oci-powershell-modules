...
{
    [Cmdlet("Get", "OCINetworkloadbalancerWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.NetworkloadbalancerService.Models.WorkRequestLogEntryCollection), typeof(Oci.NetworkloadbalancerService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCINetworkloadbalancerWorkRequestLogsList : OCINetworkLoadBalancerCmdlet
    {
