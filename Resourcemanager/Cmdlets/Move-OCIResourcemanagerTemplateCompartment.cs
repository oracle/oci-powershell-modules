...
{
    [Cmdlet("Move", "OCIResourcemanagerTemplateCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ResourcemanagerService.Responses.ChangeTemplateCompartmentResponse) })]
    public class MoveOCIResourcemanagerTemplateCompartment : OCIResourceManagerCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details for moving a template to a different compartment.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeTemplateCompartmentRequest
                {
                ...
                response = client.ChangeTemplateCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeTemplateCompartmentResponse response;
    }
}
