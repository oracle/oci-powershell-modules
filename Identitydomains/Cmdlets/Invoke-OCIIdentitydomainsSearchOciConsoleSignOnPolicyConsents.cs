...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchOciConsoleSignOnPolicyConsents")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.OciConsoleSignOnPolicyConsents), typeof(Oci.IdentitydomainsService.Responses.SearchOciConsoleSignOnPolicyConsentsResponse) })]
    public class InvokeOCIIdentitydomainsSearchOciConsoleSignOnPolicyConsents : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching OciConsoleSignOnPolicyConsents")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchOciConsoleSignOnPolicyConsentsRequest
                {
                ...
                response = client.SearchOciConsoleSignOnPolicyConsents(request).GetAwaiter().GetResult();
                WriteOutput(response, response.OciConsoleSignOnPolicyConsents);
        ...
        private SearchOciConsoleSignOnPolicyConsentsResponse response;
    }
}
