...
{
    [Cmdlet("Get", "OCIAianomalydetectionWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.AianomalydetectionService.Models.WorkRequest), typeof(Oci.AianomalydetectionService.Responses.GetWorkRequestResponse) })]
    public class GetOCIAianomalydetectionWorkRequest : OCIAnomalyDetectionCmdlet
    {
        ...
        public Oci.AianomalydetectionService.Models.OperationStatus[] WaitForStatus { get; set; }
