...
{
    [Cmdlet("Remove", "OCIDatascienceMlApplicationImplementation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatascienceService.Responses.DeleteMlApplicationImplementationResponse) })]
    public class RemoveOCIDatascienceMlApplicationImplementation : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatascienceMlApplicationImplementation", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteMlApplicationImplementationRequest
                {
                ...
                response = client.DeleteMlApplicationImplementation(request).GetAwaiter().GetResult();
        ...
        private DeleteMlApplicationImplementationResponse response;
    }
}
