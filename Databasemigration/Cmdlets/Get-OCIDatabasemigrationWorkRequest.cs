...
{
    [Cmdlet("Get", "OCIDatabasemigrationWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemigrationService.Models.WorkRequest), typeof(Oci.DatabasemigrationService.Responses.GetWorkRequestResponse) })]
    public class GetOCIDatabasemigrationWorkRequest : OCIDatabaseMigrationCmdlet
    {
        ...
        public Oci.DatabasemigrationService.Models.OperationStatus[] WaitForStatus { get; set; }
