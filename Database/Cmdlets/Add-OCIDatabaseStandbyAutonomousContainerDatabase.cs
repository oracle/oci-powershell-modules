...
{
    [Cmdlet("Add", "OCIDatabaseStandbyAutonomousContainerDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousContainerDatabase), typeof(Oci.DatabaseService.Responses.AddStandbyAutonomousContainerDatabaseResponse) })]
    public class AddOCIDatabaseStandbyAutonomousContainerDatabase : OCIDatabaseCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to Add Standy Autonomous Container Database Dataguard.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to Add Standy Autonomous Container Database Dataguard.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddStandbyAutonomousContainerDatabaseRequest
                {
        ...
        private void HandleOutput(AddStandbyAutonomousContainerDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForAddStandbyAutonomousContainerDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.AddStandbyAutonomousContainerDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousContainerDatabase);
        }

        private AddStandbyAutonomousContainerDatabaseResponse response;
