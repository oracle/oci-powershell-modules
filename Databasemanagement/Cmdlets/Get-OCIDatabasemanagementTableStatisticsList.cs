...
{
    [Cmdlet("Get", "OCIDatabasemanagementTableStatisticsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.TableStatisticsCollection), typeof(Oci.DatabasemanagementService.Responses.ListTableStatisticsResponse) })]
    public class GetOCIDatabasemanagementTableStatisticsList : OCIDbManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListTableStatisticsRequest
                {
                ...
                response = client.ListTableStatistics(request).GetAwaiter().GetResult();
                WriteOutput(response, response.TableStatisticsCollection);
        ...
        private ListTableStatisticsResponse response;
    }
}
