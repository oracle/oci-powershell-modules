...
{
    [Cmdlet("Update", "OCICapacitymanagementOccCapacityRequest")]
    [OutputType(new System.Type[] { typeof(Oci.CapacitymanagementService.Models.OccCapacityRequest), typeof(Oci.CapacitymanagementService.Responses.UpdateOccCapacityRequestResponse) })]
    public class UpdateOCICapacitymanagementOccCapacityRequest : OCICapacityManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpdateOccCapacityRequest(request).GetAwaiter().GetResult();
        ...
        private UpdateOccCapacityRequestResponse response;
    }
}
