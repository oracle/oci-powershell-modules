...
{
    [Cmdlet("Remove", "OCIMediaservicesStreamDistributionChannelLock")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.StreamDistributionChannel), typeof(Oci.MediaservicesService.Responses.RemoveStreamDistributionChannelLockResponse) })]
    public class RemoveOCIMediaservicesStreamDistributionChannelLock : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveStreamDistributionChannelLockRequest
                {
                ...
                response = client.RemoveStreamDistributionChannelLock(request).GetAwaiter().GetResult();
        ...
        private RemoveStreamDistributionChannelLockResponse response;
    }
}
