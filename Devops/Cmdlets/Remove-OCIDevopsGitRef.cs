...
{
    [Cmdlet("Remove", "OCIDevopsGitRef")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DevopsService.Responses.DeleteGitRefResponse) })]
    public class RemoveOCIDevopsGitRef : OCIDevopsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique repository identifier.")]
        public string RepositoryId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information to delete a reference.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DeleteGitRefRequest
                {
                ...
                response = client.DeleteGitRef(request).GetAwaiter().GetResult();
        ...
        private DeleteGitRefResponse response;
    }
}
