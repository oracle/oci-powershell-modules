...
{
    [Cmdlet("Get", "OCIDbmulticloudOracleDbAzureVault", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DbmulticloudService.Models.OracleDbAzureVault), typeof(Oci.DbmulticloudService.Responses.GetOracleDbAzureVaultResponse) })]
    public class GetOCIDbmulticloudOracleDbAzureVault : OCIOracleDbAzureVaultCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Oracle DB Azure Vault resource.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Oracle DB Azure Vault resource.", ParameterSetName = Default)]
        ...
        public Oci.DbmulticloudService.Models.OracleDbAzureVault.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOracleDbAzureVaultRequest
                {
        ...
        private void HandleOutput(GetOracleDbAzureVaultRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForOracleDbAzureVault(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetOracleDbAzureVault(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.OracleDbAzureVault);
        }

        private GetOracleDbAzureVaultResponse response;
