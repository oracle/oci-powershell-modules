...
{
    [Cmdlet("Move", "OCICloudbridgeDiscoveryScheduleCompartment")]
    ...
    public class MoveOCICloudbridgeDiscoveryScheduleCompartment : OCIDiscoveryCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeDiscoveryScheduleCompartmentRequest
                {
                ...
                response = client.ChangeDiscoveryScheduleCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeDiscoveryScheduleCompartmentResponse response;
    }
}
