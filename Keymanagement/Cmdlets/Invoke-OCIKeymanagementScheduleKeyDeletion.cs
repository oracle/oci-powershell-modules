...
{
    [Cmdlet("Invoke", "OCIKeymanagementScheduleKeyDeletion")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.Key), typeof(Oci.KeymanagementService.Responses.ScheduleKeyDeletionResponse) })]
    public class InvokeOCIKeymanagementScheduleKeyDeletion : OCIKmsManagementCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the key.")]
        public string KeyId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"ScheduleKeyDeletionDetails")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ScheduleKeyDeletion(request).GetAwaiter().GetResult();
        ...
        private ScheduleKeyDeletionResponse response;
    }
}
