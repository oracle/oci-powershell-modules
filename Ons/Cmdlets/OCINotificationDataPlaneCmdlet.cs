...
{
    public abstract class OCINotificationDataPlaneCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new NotificationDataPlaneClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected NotificationDataPlaneClient client;
