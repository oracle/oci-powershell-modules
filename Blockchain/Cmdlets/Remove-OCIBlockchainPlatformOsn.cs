...
{
    [Cmdlet("Remove", "OCIBlockchainPlatformOsn", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCIBlockchainPlatformOsn : OCIBlockchainPlatformCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIBlockchainPlatformOsn", "Remove"))
            {
               return;
            }
