...
{
    [Cmdlet("New", "OCICimsUser")]
    [OutputType(new System.Type[] { typeof(Oci.CimsService.Models.User), typeof(Oci.CimsService.Responses.CreateUserResponse) })]
    public class NewOCICimsUser : OCIUserCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"User information")]
