...
{
    [Cmdlet("Get", "OCIDatabasemanagementMySqlDatabaseConnectorsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.MySqlConnectorCollection), typeof(Oci.DatabasemanagementService.Responses.ListMySqlDatabaseConnectorsResponse) })]
    public class GetOCIDatabasemanagementMySqlDatabaseConnectorsList : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListMySqlDatabaseConnectorsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMySqlDatabaseConnectorsRequest
                {
                ...
                IEnumerable<ListMySqlDatabaseConnectorsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.MySqlConnectorCollection, true);
                }
        ...
        {
            IEnumerable<ListMySqlDatabaseConnectorsResponse> DefaultRequest(ListMySqlDatabaseConnectorsRequest request) => Enumerable.Repeat(client.ListMySqlDatabaseConnectors(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListMySqlDatabaseConnectorsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListMySqlDatabaseConnectorsResponse response;
        private delegate IEnumerable<ListMySqlDatabaseConnectorsResponse> RequestDelegate(ListMySqlDatabaseConnectorsRequest request);
