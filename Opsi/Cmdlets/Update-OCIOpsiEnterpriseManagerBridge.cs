...
{
    [Cmdlet("Update", "OCIOpsiEnterpriseManagerBridge")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.UpdateEnterpriseManagerBridgeResponse) })]
    public class UpdateOCIOpsiEnterpriseManagerBridge : OCIOperationsInsightsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateEnterpriseManagerBridgeRequest
                {
                ...
                response = client.UpdateEnterpriseManagerBridge(request).GetAwaiter().GetResult();
        ...
        private UpdateEnterpriseManagerBridgeResponse response;
    }
}
