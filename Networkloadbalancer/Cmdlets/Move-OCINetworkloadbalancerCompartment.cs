...
{
    [Cmdlet("Move", "OCINetworkloadbalancerCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NetworkloadbalancerService.Responses.ChangeNetworkLoadBalancerCompartmentResponse) })]
    public class MoveOCINetworkloadbalancerCompartment : OCINetworkLoadBalancerCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The configuration details for moving a network load balancer to a different compartment.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeNetworkLoadBalancerCompartmentRequest
                {
                ...
                response = client.ChangeNetworkLoadBalancerCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeNetworkLoadBalancerCompartmentResponse response;
    }
}
