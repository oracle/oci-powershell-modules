...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementSummarizeExternalDbSystemAvailabilityMetrics")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.MetricsAggregationRangeCollection), typeof(Oci.DatabasemanagementService.Responses.SummarizeExternalDbSystemAvailabilityMetricsResponse) })]
    public class InvokeOCIDatabasemanagementSummarizeExternalDbSystemAvailabilityMetrics : OCIDbManagementCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the external DB system.")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The filter used to retrieve metrics for a specific set of component types by passing the desired component types separated by a comma. Note that, by default, the service returns metrics for all DB system component types.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeExternalDbSystemAvailabilityMetricsRequest
                {
                ...
                response = client.SummarizeExternalDbSystemAvailabilityMetrics(request).GetAwaiter().GetResult();
        ...
        private SummarizeExternalDbSystemAvailabilityMetricsResponse response;
    }
}
