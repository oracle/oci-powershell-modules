...
{
    [Cmdlet("Export", "OCIComputeImage", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.Image), typeof(Oci.CoreService.Responses.ExportImageResponse) })]
    public class ExportOCIComputeImage : OCIComputeCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the image.", ParameterSetName = StatusParamSet)]
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the image export. This parameter also accepts subtypes <Oci.CoreService.Models.ExportImageViaObjectStorageUriDetails>, <Oci.CoreService.Models.ExportImageViaObjectStorageTupleDetails> of type <Oci.CoreService.Models.ExportImageDetails>.", ParameterSetName = StatusParamSet)]
        ...
        private ExportImageResponse response;
