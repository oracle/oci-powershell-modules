...
{
    [Cmdlet("New", "OCIDatabaseAutonomousDatabaseSoftwareImage", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousDatabaseSoftwareImage), typeof(Oci.DatabaseService.Responses.CreateAutonomousDatabaseSoftwareImageResponse) })]
    public class NewOCIDatabaseAutonomousDatabaseSoftwareImage : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateAutonomousDatabaseSoftwareImageRequest
                {
        ...
        private void HandleOutput(CreateAutonomousDatabaseSoftwareImageRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForCreateAutonomousDatabaseSoftwareImage(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.CreateAutonomousDatabaseSoftwareImage(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousDatabaseSoftwareImage);
        }

        private CreateAutonomousDatabaseSoftwareImageResponse response;
