...
{
    [Cmdlet("Get", "OCIDatabaseAutonomousDatabaseBackupsList")]
...
**Note:** If you do not include the availability domain filter, the resources are grouped by availability domain, then sorted.")]
        public System.Nullable<Oci.DatabaseService.Requests.ListAutonomousDatabaseBackupsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either ascending (`ASC`) or descending (`DESC`).")]
        public System.Nullable<Oci.DatabaseService.Requests.ListAutonomousDatabaseBackupsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatabaseService.Models.AutonomousDatabaseBackupSummary.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        {
            IEnumerable<ListAutonomousDatabaseBackupsResponse> DefaultRequest(ListAutonomousDatabaseBackupsRequest request) => Enumerable.Repeat(client.ListAutonomousDatabaseBackups(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAutonomousDatabaseBackupsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAutonomousDatabaseBackupsResponse response;
        private delegate IEnumerable<ListAutonomousDatabaseBackupsResponse> RequestDelegate(ListAutonomousDatabaseBackupsRequest request);
