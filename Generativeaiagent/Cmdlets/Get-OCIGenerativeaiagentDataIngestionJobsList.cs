...
namespace Oci.GenerativeaiagentService.Cmdlets
{
    ...
    public class GetOCIGenerativeaiagentDataIngestionJobsList : OCIGenerativeAiAgentCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the data source.")]
