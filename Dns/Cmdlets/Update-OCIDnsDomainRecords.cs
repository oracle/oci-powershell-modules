...
{
    [Cmdlet("Update", "OCIDnsDomainRecords")]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.RecordCollection), typeof(Oci.DnsService.Responses.UpdateDomainRecordsResponse) })]
    public class UpdateOCIDnsDomainRecords : OCIDnsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A full list of records for the domain.")]
...
This parameter is deprecated and should be omitted.")]
        ...
        private UpdateDomainRecordsResponse response;
    }
}
