...
{
    [Cmdlet("Get", "OCIIdentitydomainsApprovalWorkflowAssignmentsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.ApprovalWorkflowAssignments), typeof(Oci.IdentitydomainsService.Responses.ListApprovalWorkflowAssignmentsResponse) })]
    public class GetOCIIdentitydomainsApprovalWorkflowAssignmentsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListApprovalWorkflowAssignmentsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListApprovalWorkflowAssignments(request).GetAwaiter().GetResult();
                WriteOutput(response, response.ApprovalWorkflowAssignments);
        ...
        private ListApprovalWorkflowAssignmentsResponse response;
    }
}
