...
{
    public abstract class OCIRedisIdentityCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new RedisIdentityClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected RedisIdentityClient client;
