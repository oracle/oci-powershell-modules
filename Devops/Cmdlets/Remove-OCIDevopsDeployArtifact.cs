...
{
    [Cmdlet("Remove", "OCIDevopsDeployArtifact", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DevopsService.Responses.DeleteDeployArtifactResponse) })]
    public class RemoveOCIDevopsDeployArtifact : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDevopsDeployArtifact", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDeployArtifactRequest
                {
        ...
        private DeleteDeployArtifactResponse response;
    }
}
