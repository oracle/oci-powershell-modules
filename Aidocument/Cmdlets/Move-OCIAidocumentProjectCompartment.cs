...
{
    [Cmdlet("Move", "OCIAidocumentProjectCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AidocumentService.Responses.ChangeProjectCompartmentResponse) })]
    public class MoveOCIAidocumentProjectCompartment : OCIAIServiceDocumentCmdlet
    {
