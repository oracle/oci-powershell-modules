...
{
    [Cmdlet("Remove", "OCINetworkfirewallApplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.NetworkfirewallService.Responses.DeleteApplicationResponse) })]
    public class RemoveOCINetworkfirewallApplication : OCINetworkFirewallCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCINetworkfirewallApplication", "Remove"))
            {
               return;
            }
