...
{
    [Cmdlet("Get", "OCIAppmgmtcontrolWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.AppmgmtcontrolService.Models.WorkRequest), typeof(Oci.AppmgmtcontrolService.Responses.GetWorkRequestResponse) })]
    public class GetOCIAppmgmtcontrolWorkRequest : OCIAppmgmtControlCmdlet
    {
        ...
        public Oci.AppmgmtcontrolService.Models.OperationStatus[] WaitForStatus { get; set; }
