...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeHostInsightDiskStatistics")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.SummarizeHostInsightsDiskStatisticsCollection), typeof(Oci.OpsiService.Responses.SummarizeHostInsightDiskStatisticsResponse) })]
    public class InvokeOCIOpsiSummarizeHostInsightDiskStatistics : OCIOperationsInsightsCmdlet
    {
        ...
        public System.Nullable<Oci.OpsiService.Requests.SummarizeHostInsightDiskStatisticsRequest.StatisticEnum> Statistic { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeHostInsightDiskStatisticsRequest
                {
                ...
                response = client.SummarizeHostInsightDiskStatistics(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SummarizeHostInsightsDiskStatisticsCollection);
        ...
        private SummarizeHostInsightDiskStatisticsResponse response;
    }
}
