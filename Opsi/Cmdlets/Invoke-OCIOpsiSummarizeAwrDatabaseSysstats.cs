...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeAwrDatabaseSysstats")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.AwrDatabaseSysstatCollection), typeof(Oci.OpsiService.Responses.SummarizeAwrDatabaseSysstatsResponse) })]
    public class InvokeOCIOpsiSummarizeAwrDatabaseSysstats : OCIOperationsInsightsCmdlet
    {
        ...
        public System.Nullable<Oci.OpsiService.Requests.SummarizeAwrDatabaseSysstatsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeAwrDatabaseSysstatsRequest
                {
                    AwrHubId = AwrHubId,
                ...
                response = client.SummarizeAwrDatabaseSysstats(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AwrDatabaseSysstatCollection);
        ...
        private SummarizeAwrDatabaseSysstatsResponse response;
    }
}
