...
{
    [Cmdlet("Update", "OCIPsaPrivateServiceAccess")]
    ...
    public class UpdateOCIPsaPrivateServiceAccess : OCIPrivateServiceAccessCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdatePrivateServiceAccessRequest
                {
                ...
                response = client.UpdatePrivateServiceAccess(request).GetAwaiter().GetResult();
        ...
        private UpdatePrivateServiceAccessResponse response;
    }
}
