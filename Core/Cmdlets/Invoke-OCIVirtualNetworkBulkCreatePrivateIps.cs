...
{
    [Cmdlet("Invoke", "OCIVirtualNetworkBulkCreatePrivateIps", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.BulkCreatePrivateIpsResponse) })]
    public class InvokeOCIVirtualNetworkBulkCreatePrivateIps : OCIVirtualNetworkCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new BulkCreatePrivateIpsRequest
                {
        ...
        private void HandleOutput(BulkCreatePrivateIpsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForBulkCreatePrivateIps(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.BulkCreatePrivateIps(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private BulkCreatePrivateIpsResponse response;
