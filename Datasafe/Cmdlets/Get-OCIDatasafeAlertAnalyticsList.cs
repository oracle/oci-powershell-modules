...
{
    [Cmdlet("Get", "OCIDatasafeAlertAnalyticsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.AlertAnalyticsCollection), typeof(Oci.DatasafeService.Responses.ListAlertAnalyticsResponse) })]
    public class GetOCIDatasafeAlertAnalyticsList : OCIDataSafeCmdlet
    {
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListAlertAnalyticsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListAlertAnalyticsRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListAlertAnalyticsRequest.AccessLevelEnum> AccessLevel { get; set; }
...
**Example:** query=(timeCreated ge '2021-06-04T01-00-26') and (targetNames eq 'target_1') Supported fields: severity status alertType targetIds targetNames operationTime lifecycleState displayName timeCreated timeUpdated")]
        ...
        public System.Collections.Generic.List<Oci.DatasafeService.Requests.ListAlertAnalyticsRequest.SummaryFieldEnum> SummaryField { get; set; }
        ...
        public System.Collections.Generic.List<Oci.DatasafeService.Requests.ListAlertAnalyticsRequest.GroupByEnum> GroupBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAlertAnalyticsRequest
                {
                ...
                IEnumerable<ListAlertAnalyticsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.AlertAnalyticsCollection, true);
                }
        ...
        {
            IEnumerable<ListAlertAnalyticsResponse> DefaultRequest(ListAlertAnalyticsRequest request) => Enumerable.Repeat(client.ListAlertAnalytics(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAlertAnalyticsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAlertAnalyticsResponse response;
        private delegate IEnumerable<ListAlertAnalyticsResponse> RequestDelegate(ListAlertAnalyticsRequest request);
