...
{
    [Cmdlet("Remove", "OCIPsqlConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.PsqlService.Responses.DeleteConfigurationResponse) })]
    public class RemoveOCIPsqlConfiguration : OCIPostgresqlCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIPsqlConfiguration", "Remove"))
            {
               return;
            }
