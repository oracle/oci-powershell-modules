...
{
    [Cmdlet("New", "OCIApmsyntheticsWorker")]
    [OutputType(new System.Type[] { typeof(Oci.ApmsyntheticsService.Models.Worker), typeof(Oci.ApmsyntheticsService.Responses.CreateWorkerResponse) })]
    public class NewOCIApmsyntheticsWorker : OCIApmSyntheticCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The configuration details for registering a worker for an On-premise vantage point.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CreateWorker(request).GetAwaiter().GetResult();
                WriteOutput(response, response.Worker);
        ...
        private CreateWorkerResponse response;
    }
}
