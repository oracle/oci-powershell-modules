...
{
    [Cmdlet("Get", "OCIServicecatalogConfiguration")]
    [OutputType(new System.Type[] { typeof(Oci.ServicecatalogService.Models.Configuration), typeof(Oci.ServicecatalogService.Responses.GetConfigurationResponse) })]
    public class GetOCIServicecatalogConfiguration : OCIServiceCatalogCmdlet
    {
