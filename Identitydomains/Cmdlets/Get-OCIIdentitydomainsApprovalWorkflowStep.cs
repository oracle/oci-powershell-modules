...
{
    [Cmdlet("Get", "OCIIdentitydomainsApprovalWorkflowStep")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.ApprovalWorkflowStep), typeof(Oci.IdentitydomainsService.Responses.GetApprovalWorkflowStepResponse) })]
    public class GetOCIIdentitydomainsApprovalWorkflowStep : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetApprovalWorkflowStepRequest
                {
                ...
                response = client.GetApprovalWorkflowStep(request).GetAwaiter().GetResult();
        ...
        private GetApprovalWorkflowStepResponse response;
    }
}
