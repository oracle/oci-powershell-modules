...
{
    [Cmdlet("New", "OCIDataintegrationPatch")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.Patch), typeof(Oci.DataintegrationService.Responses.CreatePatchResponse) })]
    public class NewOCIDataintegrationPatch : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Detailed needed to create a patch in an application.")]
