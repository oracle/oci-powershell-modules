...
{
    [Cmdlet("DisMount", "OCIOsmanagementManagedInstanceFromManagedInstanceGroup")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OsmanagementService.Responses.DetachManagedInstanceFromManagedInstanceGroupResponse) })]
    public class DisMountOCIOsmanagementManagedInstanceFromManagedInstanceGroup : OCIOsManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DetachManagedInstanceFromManagedInstanceGroupRequest
                {
                ...
                response = client.DetachManagedInstanceFromManagedInstanceGroup(request).GetAwaiter().GetResult();
        ...
        private DetachManagedInstanceFromManagedInstanceGroupResponse response;
    }
}
