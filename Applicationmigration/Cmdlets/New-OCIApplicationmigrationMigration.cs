...
{
    [Cmdlet("New", "OCIApplicationmigrationMigration")]
    [OutputType(new System.Type[] { typeof(Oci.ApplicationmigrationService.Models.Migration), typeof(Oci.ApplicationmigrationService.Responses.CreateMigrationResponse) })]
    public class NewOCIApplicationmigrationMigration : OCIApplicationMigrationCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The properties for creating a migration.")]
