...
{
    [Cmdlet("Get", "OCIIdentityUsersList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentityService.Models.User), typeof(Oci.IdentityService.Responses.ListUsersResponse) })]
    public class GetOCIIdentityUsersList : OCIIdentityCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The id of the identity provider.")]
        public string IdentityProviderId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The id of a user in the identity provider.")]
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by Availability Domain if the scope of the resource type is within a single Availability Domain. If you call one of these ""List"" operations without specifying an Availability Domain, the resources are grouped by Availability Domain, then sorted.")]
        public System.Nullable<Oci.IdentityService.Requests.ListUsersRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.IdentityService.Requests.ListUsersRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.IdentityService.Models.User.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        {
            IEnumerable<ListUsersResponse> DefaultRequest(ListUsersRequest request) => Enumerable.Repeat(client.ListUsers(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListUsersResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListUsersResponse response;
        private delegate IEnumerable<ListUsersResponse> RequestDelegate(ListUsersRequest request);
