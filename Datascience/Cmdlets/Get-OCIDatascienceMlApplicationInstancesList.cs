...
{
    [Cmdlet("Get", "OCIDatascienceMlApplicationInstancesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.MlApplicationInstanceCollection), typeof(Oci.DatascienceService.Responses.ListMlApplicationInstancesResponse) })]
    public class GetOCIDatascienceMlApplicationInstancesList : OCIDataScienceCmdlet
    {
        ...
        public System.Nullable<Oci.DatascienceService.Models.MlApplicationInstance.LifecycleStateEnum> LifecycleState { get; set; }
...
See [List Pagination](https://docs.oracle.com/iaas/Content/General/Concepts/usingapi.htm#nine).")]
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListMlApplicationInstancesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListMlApplicationInstancesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMlApplicationInstancesRequest
                {
                ...
                IEnumerable<ListMlApplicationInstancesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.MlApplicationInstanceCollection, true);
                }
        ...
        {
            IEnumerable<ListMlApplicationInstancesResponse> DefaultRequest(ListMlApplicationInstancesRequest request) => Enumerable.Repeat(client.ListMlApplicationInstances(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListMlApplicationInstancesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListMlApplicationInstancesResponse response;
        private delegate IEnumerable<ListMlApplicationInstancesResponse> RequestDelegate(ListMlApplicationInstancesRequest request);
