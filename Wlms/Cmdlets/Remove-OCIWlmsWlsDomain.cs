...
{
    [Cmdlet("Remove", "OCIWlmsWlsDomain", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.WlmsService.Responses.DeleteWlsDomainResponse) })]
    public class RemoveOCIWlmsWlsDomain : OCIWeblogicManagementServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIWlmsWlsDomain", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteWlsDomainRequest
                {
                ...
                response = client.DeleteWlsDomain(request).GetAwaiter().GetResult();
        ...
        private DeleteWlsDomainResponse response;
    }
}
