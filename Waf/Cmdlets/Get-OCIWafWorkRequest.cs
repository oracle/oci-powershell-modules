...
{
    [Cmdlet("Get", "OCIWafWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.WafService.Models.WorkRequest), typeof(Oci.WafService.Responses.GetWorkRequestResponse) })]
    public class GetOCIWafWorkRequest : OCIWafCmdlet
    {
        ...
        public Oci.WafService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
