...
{
    [Cmdlet("Stop", "OCICloudbridgeWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CloudbridgeService.Responses.CancelWorkRequestResponse) })]
    public class StopOCICloudbridgeWorkRequest : OCICommonCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCICloudbridgeWorkRequest", "Stop"))
            {
               return;
            }
