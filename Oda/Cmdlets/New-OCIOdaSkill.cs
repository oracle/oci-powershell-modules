...
{
    [Cmdlet("New", "OCIOdaSkill")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OdaService.Responses.CreateSkillResponse) })]
    public class NewOCIOdaSkill : OCIManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Property values for creating the Skill. This parameter also accepts subtypes <Oci.OdaService.Models.CloneSkillDetails>, <Oci.OdaService.Models.CreateNewSkillDetails>, <Oci.OdaService.Models.CreateSkillVersionDetails>, <Oci.OdaService.Models.ExtendSkillDetails> of type <Oci.OdaService.Models.CreateSkillDetails>.")]
...
Retry tokens expire after 24 hours, but they can become invalid before then if there are conflicting operations. For example, if an instance was deleted and purged from the system, then the service might reject a retry of the original creation request.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CreateSkill(request).GetAwaiter().GetResult();
        ...
        private CreateSkillResponse response;
    }
}
