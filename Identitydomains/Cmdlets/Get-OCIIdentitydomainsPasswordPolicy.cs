...
{
    [Cmdlet("Get", "OCIIdentitydomainsPasswordPolicy")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.PasswordPolicy), typeof(Oci.IdentitydomainsService.Responses.GetPasswordPolicyResponse) })]
    public class GetOCIIdentitydomainsPasswordPolicy : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetPasswordPolicyRequest
                {
                ...
                response = client.GetPasswordPolicy(request).GetAwaiter().GetResult();
        ...
        private GetPasswordPolicyResponse response;
    }
}
