...
{
    [Cmdlet("Update", "OCIMediaservicesStreamPackagingConfig")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.StreamPackagingConfig), typeof(Oci.MediaservicesService.Responses.UpdateStreamPackagingConfigResponse) })]
    public class UpdateOCIMediaservicesStreamPackagingConfig : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateStreamPackagingConfigRequest
                {
                ...
                response = client.UpdateStreamPackagingConfig(request).GetAwaiter().GetResult();
        ...
        private UpdateStreamPackagingConfigResponse response;
    }
}
