...
{
    [Cmdlet("Remove", "OCIOsmanagementhubSoftwareSource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OsmanagementhubService.Responses.DeleteSoftwareSourceResponse) })]
    public class RemoveOCIOsmanagementhubSoftwareSource : OCISoftwareSourceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOsmanagementhubSoftwareSource", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteSoftwareSourceRequest
                {
        ...
        private DeleteSoftwareSourceResponse response;
    }
}
