...
{
    [Cmdlet("Get", "OCIAidocumentModel", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.AidocumentService.Models.Model), typeof(Oci.AidocumentService.Responses.GetModelResponse) })]
    public class GetOCIAidocumentModel : OCIAIServiceDocumentCmdlet
    {
        ...
        public Oci.AidocumentService.Models.Model.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
