...
{
    [Cmdlet("Invoke", "OCIOperatoraccesscontrolApproveAccessRequest")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OperatoraccesscontrolService.Responses.ApproveAccessRequestResponse) })]
    public class InvokeOCIOperatoraccesscontrolApproveAccessRequest : OCIAccessRequestsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ApproveAccessRequest(request).GetAwaiter().GetResult();
        ...
        private ApproveAccessRequestResponse response;
    }
}
