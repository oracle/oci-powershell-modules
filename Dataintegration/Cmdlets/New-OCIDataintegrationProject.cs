...
{
    [Cmdlet("New", "OCIDataintegrationProject")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.Project), typeof(Oci.DataintegrationService.Responses.CreateProjectResponse) })]
    public class NewOCIDataintegrationProject : OCIDataIntegrationCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The workspace ID.")]
        public string WorkspaceId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details needed to create a project in a workspace.")]
