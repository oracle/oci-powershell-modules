...
{
    [Cmdlet("Remove", "OCIGoldengateConnectionLock")]
    [OutputType(new System.Type[] { typeof(Oci.GoldengateService.Models.Connection), typeof(Oci.GoldengateService.Responses.RemoveConnectionLockResponse) })]
    public class RemoveOCIGoldengateConnectionLock : OCIGoldenGateCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveConnectionLockRequest
                {
                ...
                response = client.RemoveConnectionLock(request).GetAwaiter().GetResult();
        ...
        private RemoveConnectionLockResponse response;
    }
}
