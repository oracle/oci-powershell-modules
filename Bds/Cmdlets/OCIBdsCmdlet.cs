...
using Oci.BdsService;

namespace Oci.BdsService.Cmdlets
{
    public abstract class OCIBdsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new BdsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
