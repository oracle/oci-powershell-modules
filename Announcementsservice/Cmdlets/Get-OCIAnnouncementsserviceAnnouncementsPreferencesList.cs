...
{
    [Cmdlet("Get", "OCIAnnouncementsserviceAnnouncementsPreferencesList")]
    ...
    public class GetOCIAnnouncementsserviceAnnouncementsPreferencesList : OCIAnnouncementsPreferencesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAnnouncementsPreferencesRequest
                {
                ...
                IEnumerable<ListAnnouncementsPreferencesResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListAnnouncementsPreferencesResponse> DefaultRequest(ListAnnouncementsPreferencesRequest request) => Enumerable.Repeat(client.ListAnnouncementsPreferences(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAnnouncementsPreferencesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAnnouncementsPreferencesResponse response;
        private delegate IEnumerable<ListAnnouncementsPreferencesResponse> RequestDelegate(ListAnnouncementsPreferencesRequest request);
