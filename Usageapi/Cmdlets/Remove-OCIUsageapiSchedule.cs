...
{
    [Cmdlet("Remove", "OCIUsageapiSchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.UsageapiService.Responses.DeleteScheduleResponse) })]
    public class RemoveOCIUsageapiSchedule : OCIUsageapiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIUsageapiSchedule", "Remove"))
            {
               return;
            }
