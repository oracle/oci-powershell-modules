...
using Oci.OsubbillingscheduleService;

namespace Oci.OsubbillingscheduleService.Cmdlets
{
    public abstract class OCIBillingScheduleCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new BillingScheduleClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected BillingScheduleClient client;
