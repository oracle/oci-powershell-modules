...
{
    [Cmdlet("Remove", "OCIMediaservicesMediaWorkflowConfigurationLock")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.MediaWorkflowConfiguration), typeof(Oci.MediaservicesService.Responses.RemoveMediaWorkflowConfigurationLockResponse) })]
    public class RemoveOCIMediaservicesMediaWorkflowConfigurationLock : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveMediaWorkflowConfigurationLockRequest
                {
                ...
                response = client.RemoveMediaWorkflowConfigurationLock(request).GetAwaiter().GetResult();
        ...
        private RemoveMediaWorkflowConfigurationLockResponse response;
    }
}
