...
{
    public abstract class OCIOmhubNetworkAnchorCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OmhubNetworkAnchorClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OmhubNetworkAnchorClient client;
