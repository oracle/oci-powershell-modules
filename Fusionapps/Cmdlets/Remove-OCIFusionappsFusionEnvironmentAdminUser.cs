...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class RemoveOCIFusionappsFusionEnvironmentAdminUser : OCIFusionApplicationsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIFusionappsFusionEnvironmentAdminUser", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteFusionEnvironmentAdminUserRequest
                {
                ...
                response = client.DeleteFusionEnvironmentAdminUser(request).GetAwaiter().GetResult();
        ...
        private DeleteFusionEnvironmentAdminUserResponse response;
    }
}
