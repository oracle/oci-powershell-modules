...
{
    [Cmdlet("Remove", "OCIArtifactsGenericArtifact", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
...
Example: `ocid1.genericartifact.oc1..exampleuniqueID`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIArtifactsGenericArtifact", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteGenericArtifactRequest
                {
                ...
                response = client.DeleteGenericArtifact(request).GetAwaiter().GetResult();
        ...
        private DeleteGenericArtifactResponse response;
    }
}
