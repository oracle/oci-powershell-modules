#
# Module manifest for module 'OCI.PSModules.Iot'
#
...
GUID = 'd1ebf640-b0dd-4fdd-8aac-ce44cdab07b5'
...
Description = 'This modules provides Cmdlets for OCI Iot Service'
...
CmdletsToExport = 'Get-OCIIotDigitalTwinAdapter', 'Get-OCIIotDigitalTwinAdaptersList', 
               ...
               'Get-OCIIotDigitalTwinModelsList', 'Get-OCIIotDigitalTwinModelSpec', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'PSEdition_Core','Windows','Linux','macOS','Oracle','OCI','Cloud','OracleCloudInfrastructure','Iot'
