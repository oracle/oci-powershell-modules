...
{
    public abstract class OCIOpensearchClusterBackupCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OpensearchClusterBackupClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OpensearchClusterBackupClient client;
