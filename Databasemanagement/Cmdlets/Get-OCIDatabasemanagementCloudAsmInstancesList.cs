...
namespace Oci.DatabasemanagementService.Cmdlets
{
    ...
    public class GetOCIDatabasemanagementCloudAsmInstancesList : OCIDbManagementCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the cloud ASM.")]
