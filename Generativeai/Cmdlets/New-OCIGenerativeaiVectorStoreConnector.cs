...
{
    [Cmdlet("New", "OCIGenerativeaiVectorStoreConnector")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.VectorStoreConnector), typeof(Oci.GenerativeaiService.Responses.CreateVectorStoreConnectorResponse) })]
    public class NewOCIGenerativeaiVectorStoreConnector : OCIGenerativeAiCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new vectorStoreConnector.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateVectorStoreConnectorRequest
                {
                ...
                response = client.CreateVectorStoreConnector(request).GetAwaiter().GetResult();
        ...
        private CreateVectorStoreConnectorResponse response;
    }
}
