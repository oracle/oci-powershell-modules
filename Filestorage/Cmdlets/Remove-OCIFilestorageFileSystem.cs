...
{
    [Cmdlet("Remove", "OCIFilestorageFileSystem", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.FilestorageService.Responses.DeleteFileSystemResponse) })]
    public class RemoveOCIFilestorageFileSystem : OCIFileStorageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIFilestorageFileSystem", "Remove"))
            {
               return;
            }
        ...
        private DeleteFileSystemResponse response;
    }
}
