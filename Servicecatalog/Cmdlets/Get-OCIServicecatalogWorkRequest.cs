...
{
    [Cmdlet("Get", "OCIServicecatalogWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.ServicecatalogService.Models.WorkRequest), typeof(Oci.ServicecatalogService.Responses.GetWorkRequestResponse) })]
    public class GetOCIServicecatalogWorkRequest : OCIServiceCatalogCmdlet
    {
        ...
        public Oci.ServicecatalogService.Models.OperationStatus[] WaitForStatus { get; set; }
