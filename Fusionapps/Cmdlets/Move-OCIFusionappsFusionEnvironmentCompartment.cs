...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class MoveOCIFusionappsFusionEnvironmentCompartment : OCIFusionApplicationsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details of change compartment request.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeFusionEnvironmentCompartmentRequest
                {
                ...
                response = client.ChangeFusionEnvironmentCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeFusionEnvironmentCompartmentResponse response;
    }
}
