...
{
    [Cmdlet("Get", "OCIIdentitydomainsOAuthClientCertificatesList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.OAuthClientCertificates), typeof(Oci.IdentitydomainsService.Responses.ListOAuthClientCertificatesResponse) })]
    public class GetOCIIdentitydomainsOAuthClientCertificatesList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListOAuthClientCertificatesRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListOAuthClientCertificates(request).GetAwaiter().GetResult();
        ...
        private ListOAuthClientCertificatesResponse response;
    }
}
