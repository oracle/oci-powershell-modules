...
{
    [Cmdlet("Remove", "OCIIdentitydomainsMyDevice", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteMyDeviceResponse) })]
    public class RemoveOCIIdentitydomainsMyDevice : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsMyDevice", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteMyDeviceRequest
                {
                ...
                response = client.DeleteMyDevice(request).GetAwaiter().GetResult();
        ...
        private DeleteMyDeviceResponse response;
    }
}
