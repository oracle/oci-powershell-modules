...
{
    [Cmdlet("Get", "OCIDatasafeSqlFirewallViolationAnalyticsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.SqlFirewallViolationAnalyticsCollection), typeof(Oci.DatasafeService.Responses.ListSqlFirewallViolationAnalyticsResponse) })]
    public class GetOCIDatasafeSqlFirewallViolationAnalyticsList : OCIDataSafeCmdlet
    {
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSqlFirewallViolationAnalyticsRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSqlFirewallViolationAnalyticsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSqlFirewallViolationAnalyticsRequest.SortByEnum> SortBy { get; set; }
...
**Example:** query=(operationTime ge '2021-06-04T01-00-26') and (violationAction eq 'BLOCKED')")]
        ...
        public System.Collections.Generic.List<Oci.DatasafeService.Requests.ListSqlFirewallViolationAnalyticsRequest.SummaryFieldEnum> SummaryField { get; set; }
        ...
        public System.Collections.Generic.List<Oci.DatasafeService.Requests.ListSqlFirewallViolationAnalyticsRequest.GroupByEnum> GroupBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSqlFirewallViolationAnalyticsRequest
                {
                ...
                IEnumerable<ListSqlFirewallViolationAnalyticsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.SqlFirewallViolationAnalyticsCollection, true);
                }
        ...
        {
            IEnumerable<ListSqlFirewallViolationAnalyticsResponse> DefaultRequest(ListSqlFirewallViolationAnalyticsRequest request) => Enumerable.Repeat(client.ListSqlFirewallViolationAnalytics(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSqlFirewallViolationAnalyticsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSqlFirewallViolationAnalyticsResponse response;
        private delegate IEnumerable<ListSqlFirewallViolationAnalyticsResponse> RequestDelegate(ListSqlFirewallViolationAnalyticsRequest request);
