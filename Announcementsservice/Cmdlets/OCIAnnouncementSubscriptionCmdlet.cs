...
using Oci.AnnouncementsService;

namespace Oci.AnnouncementsService.Cmdlets
{
    public abstract class OCIAnnouncementSubscriptionCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AnnouncementSubscriptionClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AnnouncementSubscriptionClient client;
