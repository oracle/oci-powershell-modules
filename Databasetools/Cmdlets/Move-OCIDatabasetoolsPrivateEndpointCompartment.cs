...
{
    [Cmdlet("Move", "OCIDatabasetoolsPrivateEndpointCompartment")]
    ...
    public class MoveOCIDatabasetoolsPrivateEndpointCompartment : OCIDatabaseToolsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to change the compartment of the Database Tools private endpoint.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeDatabaseToolsPrivateEndpointCompartmentRequest
                {
                ...
                response = client.ChangeDatabaseToolsPrivateEndpointCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeDatabaseToolsPrivateEndpointCompartmentResponse response;
    }
}
