...
{
    [Cmdlet("Remove", "OCINosqlIndex", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NosqlService.Responses.DeleteIndexResponse) })]
    public class RemoveOCINosqlIndex : OCINosqlCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The name of a table's index.")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Set as true to select ""if exists"" behavior.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCINosqlIndex", "Remove"))
            {
               return;
            }
