...
{
    [Cmdlet("Invoke", "OCIOsmanagementhubManageModuleStreamsOnManagedInstanceGroup")]
    ...
    public class InvokeOCIOsmanagementhubManageModuleStreamsOnManagedInstanceGroup : OCIManagedInstanceGroupCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ManageModuleStreamsOnManagedInstanceGroupRequest
                {
                ...
                response = client.ManageModuleStreamsOnManagedInstanceGroup(request).GetAwaiter().GetResult();
        ...
        private ManageModuleStreamsOnManagedInstanceGroupResponse response;
    }
}
