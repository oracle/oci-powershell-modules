...
{
    [Cmdlet("Backup", "OCIKeymanagementKey")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.Key), typeof(Oci.KeymanagementService.Responses.BackupKeyResponse) })]
    public class BackupOCIKeymanagementKey : OCIKmsManagementCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"BackupKeyDetails")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.BackupKey(request).GetAwaiter().GetResult();
        ...
        private BackupKeyResponse response;
    }
}
