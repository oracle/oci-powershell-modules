...
{
    [Cmdlet("Remove", "OCIDataconnectivityDataAsset", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataconnectivityService.Responses.DeleteDataAssetResponse) })]
    public class RemoveOCIDataconnectivityDataAsset : OCIDataConnectivityManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataconnectivityDataAsset", "Remove"))
            {
               return;
            }
