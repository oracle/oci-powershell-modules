...
{
    [Cmdlet("Get", "OCIIdentitydomainsSelfRegistrationProfilesList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SelfRegistrationProfiles), typeof(Oci.IdentitydomainsService.Responses.ListSelfRegistrationProfilesResponse) })]
    public class GetOCIIdentitydomainsSelfRegistrationProfilesList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSelfRegistrationProfilesRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListSelfRegistrationProfiles(request).GetAwaiter().GetResult();
        ...
        private ListSelfRegistrationProfilesResponse response;
    }
}
