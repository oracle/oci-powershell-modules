...
{
    [Cmdlet("Update", "OCIQueue")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.QueueService.Responses.UpdateQueueResponse) })]
    public class UpdateOCIQueue : OCIQueueAdminCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpdateQueue(request).GetAwaiter().GetResult();
        ...
        private UpdateQueueResponse response;
    }
}
