...
{
    [Cmdlet("Invoke", "OCIGoldengateUpgradeDeployment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.UpgradeDeploymentResponse) })]
    public class InvokeOCIGoldengateUpgradeDeployment : OCIGoldenGateCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpgradeDeploymentRequest
                {
                ...
                response = client.UpgradeDeployment(request).GetAwaiter().GetResult();
        ...
        private UpgradeDeploymentResponse response;
    }
}
