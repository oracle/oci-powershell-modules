...
{
    [Cmdlet("Get", "OCIResourcemanagerJobDetailedLogContent")]
    [OutputType(new System.Type[] { typeof(string), typeof(Oci.ResourcemanagerService.Responses.GetJobDetailedLogContentResponse) })]
    public class GetOCIResourcemanagerJobDetailedLogContent : OCIResourceManagerCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetJobDetailedLogContentRequest
                {
                    JobId = JobId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetJobDetailedLogContent(request).GetAwaiter().GetResult();
        ...
        private GetJobDetailedLogContentResponse response;
    }
}
