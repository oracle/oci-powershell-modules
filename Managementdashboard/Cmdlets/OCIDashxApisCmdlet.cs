...
{
    public abstract class OCIDashxApisCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            base.ProcessRecord();
            client?.Dispose();
            client = new DashxApisClient(AuthProvider, new Oci.Common.ClientConfiguration
            {
        ...
        protected DashxApisClient client;
