...
using Oci.PsqlService;

namespace Oci.PsqlService.Cmdlets
{
    public abstract class OCIPostgresqlCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new PostgresqlClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
