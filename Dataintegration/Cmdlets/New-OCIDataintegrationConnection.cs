...
namespace Oci.DataintegrationService.Cmdlets
{
    ...
    public class NewOCIDataintegrationConnection : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information needed to create a connection. This parameter also accepts subtypes <Oci.DataintegrationService.Models.CreateConnectionFromMySQL>, <Oci.DataintegrationService.Models.CreateConnectionFromAmazonS3>, <Oci.DataintegrationService.Models.CreateConnectionFromJdbc>, <Oci.DataintegrationService.Models.CreateConnectionFromBICC>, <Oci.DataintegrationService.Models.CreateConnectionFromAtp>, <Oci.DataintegrationService.Models.CreateConnectionFromBIP>, <Oci.DataintegrationService.Models.CreateConnectionFromAdwc>, <Oci.DataintegrationService.Models.CreateConnectionFromOracle>, <Oci.DataintegrationService.Models.CreateConnectionFromObjectStorage> of type <Oci.DataintegrationService.Models.CreateConnectionDetails>.")]
