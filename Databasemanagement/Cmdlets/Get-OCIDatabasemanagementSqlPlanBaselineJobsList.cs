...
{
    [Cmdlet("Get", "OCIDatabasemanagementSqlPlanBaselineJobsList")]
    ...
    public class GetOCIDatabasemanagementSqlPlanBaselineJobsList : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListSqlPlanBaselineJobsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSqlPlanBaselineJobsRequest
                {
                ...
                IEnumerable<ListSqlPlanBaselineJobsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.SqlPlanBaselineJobCollection, true);
                }
        ...
        {
            IEnumerable<ListSqlPlanBaselineJobsResponse> DefaultRequest(ListSqlPlanBaselineJobsRequest request) => Enumerable.Repeat(client.ListSqlPlanBaselineJobs(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSqlPlanBaselineJobsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSqlPlanBaselineJobsResponse response;
        private delegate IEnumerable<ListSqlPlanBaselineJobsResponse> RequestDelegate(ListSqlPlanBaselineJobsRequest request);
