...
{
    [Cmdlet("Get", "OCIApmcontrolplaneWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.ApmcontrolplaneService.Models.WorkRequest), typeof(Oci.ApmcontrolplaneService.Responses.GetWorkRequestResponse) })]
    public class GetOCIApmcontrolplaneWorkRequest : OCIApmDomainCmdlet
    {
        ...
        public Oci.ApmcontrolplaneService.Models.OperationStatus[] WaitForStatus { get; set; }
