#
# Module manifest for module 'OCI.PSModules.Multicloud'
#
...
Description = 'This modules provides Cmdlets for OCI Multicloud Service'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'PSEdition_Core','Windows','Linux','macOS','Oracle','OCI','Cloud','OracleCloudInfrastructure','Multicloud'
