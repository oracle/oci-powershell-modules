...
{
    [Cmdlet("Disable", "OCIOsmanagementhubModuleStreamOnManagedInstanceGroup")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OsmanagementhubService.Responses.DisableModuleStreamOnManagedInstanceGroupResponse) })]
    public class DisableOCIOsmanagementhubModuleStreamOnManagedInstanceGroup : OCIManagedInstanceGroupCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details used to disable modules on the managed instance group.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableModuleStreamOnManagedInstanceGroupRequest
                {
                ...
                response = client.DisableModuleStreamOnManagedInstanceGroup(request).GetAwaiter().GetResult();
        ...
        private DisableModuleStreamOnManagedInstanceGroupResponse response;
    }
}
