...
{
    [Cmdlet("Stop", "OCIResourcemanagerJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ResourcemanagerService.Responses.CancelJobResponse) })]
    public class StopOCIResourcemanagerJob : OCIResourceManagerCmdlet
    {
        ...
        private CancelJobResponse response;
    }
}
