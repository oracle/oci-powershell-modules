...
{
    [Cmdlet("Get", "OCILoadbalancerPathRouteSet")]
    [OutputType(new System.Type[] { typeof(Oci.LoadbalancerService.Models.PathRouteSet), typeof(Oci.LoadbalancerService.Responses.GetPathRouteSetResponse) })]
    public class GetOCILoadbalancerPathRouteSet : OCILoadBalancerCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The name of the path route set to retrieve.
...
Example: `example-etag`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetPathRouteSetRequest
                {
                ...
                response = client.GetPathRouteSet(request).GetAwaiter().GetResult();
                WriteOutput(response, response.PathRouteSet);
        ...
        private GetPathRouteSetResponse response;
    }
}
