...
{
    [Cmdlet("Update", "OCIBdsNodeBackupConfiguration")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.BdsService.Responses.UpdateNodeBackupConfigurationResponse) })]
    public class UpdateOCIBdsNodeBackupConfiguration : OCIBdsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for updating the NodeBackupConfiguration.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateNodeBackupConfigurationRequest
                {
                ...
                response = client.UpdateNodeBackupConfiguration(request).GetAwaiter().GetResult();
        ...
        private UpdateNodeBackupConfigurationResponse response;
    }
}
