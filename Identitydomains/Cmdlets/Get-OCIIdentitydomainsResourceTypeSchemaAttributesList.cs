...
{
    [Cmdlet("Get", "OCIIdentitydomainsResourceTypeSchemaAttributesList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.ResourceTypeSchemaAttributes), typeof(Oci.IdentitydomainsService.Responses.ListResourceTypeSchemaAttributesResponse) })]
    public class GetOCIIdentitydomainsResourceTypeSchemaAttributesList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListResourceTypeSchemaAttributesRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListResourceTypeSchemaAttributes(request).GetAwaiter().GetResult();
        ...
        private ListResourceTypeSchemaAttributesResponse response;
    }
}
