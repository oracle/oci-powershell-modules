...
{
    [Cmdlet("Invoke", "OCINetworkfirewallBulkUploadNatRules")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NetworkfirewallService.Responses.BulkUploadNatRulesResponse) })]
    public class InvokeOCINetworkfirewallBulkUploadNatRules : OCINetworkFirewallCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                BulkUploadNatRulesDetails = System.IO.File.OpenRead(GetAbsoluteFilePath(BulkUploadNatRulesDetailsFromFile));
            }
            

            try
            {
                request = new BulkUploadNatRulesRequest
                {
                ...
                response = client.BulkUploadNatRules(request).GetAwaiter().GetResult();
        ...
        private BulkUploadNatRulesResponse response;
