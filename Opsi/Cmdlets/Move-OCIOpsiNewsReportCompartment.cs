...
{
    [Cmdlet("Move", "OCIOpsiNewsReportCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.ChangeNewsReportCompartmentResponse) })]
    public class MoveOCIOpsiNewsReportCompartment : OCIOperationsInsightsCmdlet
    {
...
*Note:* Retry tokens can be invalidated before the 24 hour time limit due to conflicting operations, such as a resource being deleted or purged from the system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeNewsReportCompartmentRequest
                {
                ...
                response = client.ChangeNewsReportCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeNewsReportCompartmentResponse response;
    }
}
