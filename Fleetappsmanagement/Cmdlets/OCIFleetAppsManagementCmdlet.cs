...
{
    public abstract class OCIFleetAppsManagementCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new FleetAppsManagementClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected FleetAppsManagementClient client;
