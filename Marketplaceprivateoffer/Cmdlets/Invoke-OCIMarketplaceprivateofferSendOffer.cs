...
{
    [Cmdlet("Invoke", "OCIMarketplaceprivateofferSendOffer")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MarketplaceprivateofferService.Responses.SendOfferResponse) })]
    public class InvokeOCIMarketplaceprivateofferSendOffer : OCIOfferCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.SendOffer(request).GetAwaiter().GetResult();
        ...
        private SendOfferResponse response;
    }
}
