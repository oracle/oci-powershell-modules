...
{
    [Cmdlet("Get", "OCIDblmWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.DblmService.Models.WorkRequestSummaryCollection), typeof(Oci.DblmService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIDblmWorkRequestsList : OCIDbLifeCycleManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DblmService.Models.OperationStatus> Status { get; set; }
        ...
        public System.Nullable<Oci.DblmService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }
