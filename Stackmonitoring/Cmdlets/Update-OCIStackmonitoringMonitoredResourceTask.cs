...
{
    [Cmdlet("Update", "OCIStackmonitoringMonitoredResourceTask")]
    ...
    public class UpdateOCIStackmonitoringMonitoredResourceTask : OCIStackMonitoringCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateMonitoredResourceTaskRequest
                {
                ...
                response = client.UpdateMonitoredResourceTask(request).GetAwaiter().GetResult();
        ...
        private UpdateMonitoredResourceTaskResponse response;
    }
}
