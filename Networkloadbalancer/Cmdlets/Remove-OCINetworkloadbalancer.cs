...
{
    [Cmdlet("Remove", "OCINetworkloadbalancer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NetworkloadbalancerService.Responses.DeleteNetworkLoadBalancerResponse) })]
    public class RemoveOCINetworkloadbalancer : OCINetworkLoadBalancerCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCINetworkloadbalancer", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteNetworkLoadBalancerRequest
                {
                ...
                response = client.DeleteNetworkLoadBalancer(request).GetAwaiter().GetResult();
        ...
        private DeleteNetworkLoadBalancerResponse response;
    }
}
