...
{
    [Cmdlet("Remove", "OCIDtsTransferPackage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DtsService.Responses.DeleteTransferPackageResponse) })]
    public class RemoveOCIDtsTransferPackage : OCITransferPackageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDtsTransferPackage", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteTransferPackageRequest
                {
                    Id = Id,
                    TransferPackageLabel = TransferPackageLabel
                };

                response = client.DeleteTransferPackage(request).GetAwaiter().GetResult();
        ...
        private DeleteTransferPackageResponse response;
    }
}
