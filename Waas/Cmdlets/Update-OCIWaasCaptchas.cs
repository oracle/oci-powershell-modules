...
{
    [Cmdlet("Update", "OCIWaasCaptchas")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdateCaptchasResponse) })]
    public class UpdateOCIWaasCaptchas : OCIWaasCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A list of CAPTCHA details.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateCaptchasRequest
                {
                ...
                response = client.UpdateCaptchas(request).GetAwaiter().GetResult();
        ...
        private UpdateCaptchasResponse response;
    }
}
