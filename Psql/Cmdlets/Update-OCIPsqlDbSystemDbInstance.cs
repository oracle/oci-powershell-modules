...
namespace Oci.PsqlService.Cmdlets
{
    ...
    public class UpdateOCIPsqlDbSystemDbInstance : OCIPostgresqlCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A unique identifier for the database instance node.")]
        public string DbInstanceId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Database instance node update parameters.")]
