...
{
    [Cmdlet("Get", "OCIFleetsoftwareupdateWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.FleetsoftwareupdateService.Models.WorkRequestErrorCollection), typeof(Oci.FleetsoftwareupdateService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIFleetsoftwareupdateWorkRequestErrorsList : OCIFleetSoftwareUpdateCmdlet
    {
        ...
        public System.Nullable<Oci.FleetsoftwareupdateService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }
