...
{
    public abstract class OCISoftwareSourceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new SoftwareSourceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected SoftwareSourceClient client;
