...
using Oci.ZprService;

namespace Oci.ZprService.Cmdlets
{
    public abstract class OCIZprCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ZprClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
