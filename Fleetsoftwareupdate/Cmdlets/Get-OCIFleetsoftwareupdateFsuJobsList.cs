...
{
    [Cmdlet("Get", "OCIFleetsoftwareupdateFsuJobsList")]
    [OutputType(new System.Type[] { typeof(Oci.FleetsoftwareupdateService.Models.FsuJobCollection), typeof(Oci.FleetsoftwareupdateService.Responses.ListFsuJobsResponse) })]
    public class GetOCIFleetsoftwareupdateFsuJobsList : OCIFleetSoftwareUpdateCmdlet
    {
        ...
        public System.Nullable<Oci.FleetsoftwareupdateService.Models.JobLifecycleStates> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.FleetsoftwareupdateService.Requests.ListFsuJobsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListFsuJobsRequest
                {
                ...
                IEnumerable<ListFsuJobsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.FsuJobCollection, true);
                }
        ...
        {
            IEnumerable<ListFsuJobsResponse> DefaultRequest(ListFsuJobsRequest request) => Enumerable.Repeat(client.ListFsuJobs(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListFsuJobsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListFsuJobsResponse response;
        private delegate IEnumerable<ListFsuJobsResponse> RequestDelegate(ListFsuJobsRequest request);
