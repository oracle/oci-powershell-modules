...
{
    [Cmdlet("Invoke", "OCIDevopsPatchPullRequest")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.PullRequest), typeof(Oci.DevopsService.Responses.PatchPullRequestResponse) })]
    public class InvokeOCIDevopsPatchPullRequest : OCIDevopsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"unique PullRequest identifier")]
        public string PullRequestId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the PullRequest update.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new PatchPullRequestRequest
                {
                ...
                response = client.PatchPullRequest(request).GetAwaiter().GetResult();
        ...
        private PatchPullRequestResponse response;
    }
}
