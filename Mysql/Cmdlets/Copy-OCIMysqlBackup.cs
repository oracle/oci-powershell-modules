...
{
    [Cmdlet("Copy", "OCIMysqlBackup")]
    [OutputType(new System.Type[] { typeof(Oci.MysqlService.Models.Backup), typeof(Oci.MysqlService.Responses.CopyBackupResponse) })]
    public class CopyOCIMysqlBackup : OCIDbBackupsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details required to copy a given DB system backup to another region.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CopyBackup(request).GetAwaiter().GetResult();
        ...
        private CopyBackupResponse response;
    }
}
