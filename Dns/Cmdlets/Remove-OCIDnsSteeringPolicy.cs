...
{
    [Cmdlet("Remove", "OCIDnsSteeringPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DnsService.Responses.DeleteSteeringPolicyResponse) })]
    public class RemoveOCIDnsSteeringPolicy : OCIDnsCmdlet
    {
        ...
        private void HandleOutput(DeleteSteeringPolicyRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteSteeringPolicy(request, waiterConfig, WaitForStatus).Execute();
                    break;
        ...
        private DeleteSteeringPolicyResponse response;
