...
{
    [Cmdlet("Get", "OCIContainerinstancesWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.ContainerinstancesService.Models.WorkRequest), typeof(Oci.ContainerinstancesService.Responses.GetWorkRequestResponse) })]
    public class GetOCIContainerinstancesWorkRequest : OCIContainerInstanceCmdlet
    {
        ...
        public Oci.ContainerinstancesService.Models.OperationStatus[] WaitForStatus { get; set; }
