...
{
    [Cmdlet("Move", "OCIGenerativeaiImportedModelCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.GenerativeaiService.Responses.ChangeImportedModelCompartmentResponse) })]
    public class MoveOCIGenerativeaiImportedModelCompartment : OCIGenerativeAiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeImportedModelCompartmentRequest
                {
                ...
                response = client.ChangeImportedModelCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeImportedModelCompartmentResponse response;
    }
}
