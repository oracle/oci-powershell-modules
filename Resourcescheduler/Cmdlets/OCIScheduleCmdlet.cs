...
using Oci.ResourceschedulerService;

namespace Oci.ResourceschedulerService.Cmdlets
{
    public abstract class OCIScheduleCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ScheduleClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ScheduleClient client;
