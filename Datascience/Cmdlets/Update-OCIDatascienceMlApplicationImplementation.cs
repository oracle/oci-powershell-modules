...
{
    [Cmdlet("Update", "OCIDatascienceMlApplicationImplementation")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatascienceService.Responses.UpdateMlApplicationImplementationResponse) })]
    public class UpdateOCIDatascienceMlApplicationImplementation : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateMlApplicationImplementationRequest
                {
                ...
                response = client.UpdateMlApplicationImplementation(request).GetAwaiter().GetResult();
        ...
        private UpdateMlApplicationImplementationResponse response;
    }
}
