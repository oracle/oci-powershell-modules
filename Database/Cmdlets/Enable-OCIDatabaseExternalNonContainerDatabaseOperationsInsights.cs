...
{
    [Cmdlet("Enable", "OCIDatabaseExternalNonContainerDatabaseOperationsInsights", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.EnableExternalNonContainerDatabaseOperationsInsightsResponse) })]
    public class EnableOCIDatabaseExternalNonContainerDatabaseOperationsInsights : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details to enable Operations Insights on the external non-container database", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details to enable Operations Insights on the external non-container database", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new EnableExternalNonContainerDatabaseOperationsInsightsRequest
                {
        ...
        private void HandleOutput(EnableExternalNonContainerDatabaseOperationsInsightsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForEnableExternalNonContainerDatabaseOperationsInsights(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.EnableExternalNonContainerDatabaseOperationsInsights(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private EnableExternalNonContainerDatabaseOperationsInsightsResponse response;
