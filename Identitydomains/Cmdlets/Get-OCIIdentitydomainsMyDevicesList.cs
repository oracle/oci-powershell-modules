...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyDevicesList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyDevices), typeof(Oci.IdentitydomainsService.Responses.ListMyDevicesResponse) })]
    public class GetOCIIdentitydomainsMyDevicesList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMyDevicesRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListMyDevices(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MyDevices);
        ...
        private ListMyDevicesResponse response;
    }
}
