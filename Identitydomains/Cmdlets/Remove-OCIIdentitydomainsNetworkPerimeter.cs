...
{
    [Cmdlet("Remove", "OCIIdentitydomainsNetworkPerimeter", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteNetworkPerimeterResponse) })]
    public class RemoveOCIIdentitydomainsNetworkPerimeter : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsNetworkPerimeter", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteNetworkPerimeterRequest
                {
                ...
                response = client.DeleteNetworkPerimeter(request).GetAwaiter().GetResult();
        ...
        private DeleteNetworkPerimeterResponse response;
    }
}
