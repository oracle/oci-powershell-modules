...
using Oci.JmsjavadownloadsService;

namespace Oci.JmsjavadownloadsService.Cmdlets
{
    public abstract class OCIJavaDownloadCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new JavaDownloadClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected JavaDownloadClient client;
