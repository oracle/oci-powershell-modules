...
{
    [Cmdlet("Invoke", "OCIOpsiIngestSqlText")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.IngestSqlTextResponseDetails), typeof(Oci.OpsiService.Responses.IngestSqlTextResponse) })]
    public class InvokeOCIOpsiIngestSqlText : OCIOperationsInsightsCmdlet
    {
...
*Note:* Retry tokens can be invalidated before the 24 hour time limit due to conflicting operations, such as a resource being deleted or purged from the system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new IngestSqlTextRequest
                {
                ...
                response = client.IngestSqlText(request).GetAwaiter().GetResult();
                WriteOutput(response, response.IngestSqlTextResponseDetails);
        ...
        private IngestSqlTextResponse response;
    }
}
