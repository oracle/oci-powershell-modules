...
namespace Oci.CloudbridgeService.Cmdlets
{
    ...
    public class UpdateOCICloudbridgeAssetSource : OCIDiscoveryCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Asset source information to be updated. This parameter also accepts subtypes <Oci.CloudbridgeService.Models.UpdateVmWareAssetSourceDetails>, <Oci.CloudbridgeService.Models.UpdateOlvmAssetSourceDetails>, <Oci.CloudbridgeService.Models.UpdateAwsAssetSourceDetails> of type <Oci.CloudbridgeService.Models.UpdateAssetSourceDetails>.")]
