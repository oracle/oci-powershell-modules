...
{
    [Cmdlet("Move", "OCIApplicationmigrationSourceCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApplicationmigrationService.Responses.ChangeSourceCompartmentResponse) })]
    public class MoveOCIApplicationmigrationSourceCompartment : OCIApplicationMigrationCmdlet
    {
        ...
        public ChangeCompartmentDetails ChangeSourceCompartmentDetails { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeSourceCompartmentRequest
                {
                    SourceId = SourceId,
                ...
                response = client.ChangeSourceCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeSourceCompartmentResponse response;
    }
}
