...
{
    [Cmdlet("Move", "OCICertificatesmanagementCaBundleCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CertificatesmanagementService.Responses.ChangeCaBundleCompartmentResponse) })]
    public class MoveOCICertificatesmanagementCaBundleCompartment : OCICertificatesManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeCaBundleCompartmentRequest
                {
                ...
                response = client.ChangeCaBundleCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeCaBundleCompartmentResponse response;
    }
}
