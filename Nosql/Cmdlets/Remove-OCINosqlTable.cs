...
{
    [Cmdlet("Remove", "OCINosqlTable", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NosqlService.Responses.DeleteTableResponse) })]
    public class RemoveOCINosqlTable : OCINosqlCmdlet
    {
        ...
        private DeleteTableResponse response;
    }
}
