...
{
    [Cmdlet("Update", "OCICloudguardManagedList")]
    ...
    public class UpdateOCICloudguardManagedList : OCICloudGuardCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateManagedListRequest
                {
                ...
                response = client.UpdateManagedList(request).GetAwaiter().GetResult();
        ...
        private UpdateManagedListResponse response;
    }
}
