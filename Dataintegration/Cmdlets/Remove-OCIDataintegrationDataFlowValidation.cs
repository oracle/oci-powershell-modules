...
{
    [Cmdlet("Remove", "OCIDataintegrationDataFlowValidation", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataintegrationService.Responses.DeleteDataFlowValidationResponse) })]
    public class RemoveOCIDataintegrationDataFlowValidation : OCIDataIntegrationCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"DIS workspace id")]
        public string WorkspaceId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"key of the dataflow validation.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataintegrationDataFlowValidation", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDataFlowValidationRequest
                {
                ...
                response = client.DeleteDataFlowValidation(request).GetAwaiter().GetResult();
        ...
        private DeleteDataFlowValidationResponse response;
    }
}
