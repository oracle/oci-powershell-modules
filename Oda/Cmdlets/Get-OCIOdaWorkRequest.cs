...
{
    [Cmdlet("Get", "OCIOdaWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.WorkRequest), typeof(Oci.OdaService.Responses.GetWorkRequestResponse) })]
    public class GetOCIOdaWorkRequest : OCIOdaCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The identifier of the asynchronous work request.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The identifier of the asynchronous work request.", ParameterSetName = Default)]
        public string WorkRequestId { get; set; }

        
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The client request ID for tracing. This value is included in the opc-request-id response header.", ParameterSetName = StatusParamSet)]
        ...
        public Oci.OdaService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
