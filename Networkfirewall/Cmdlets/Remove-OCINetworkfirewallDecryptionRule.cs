...
{
    [Cmdlet("Remove", "OCINetworkfirewallDecryptionRule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.NetworkfirewallService.Responses.DeleteDecryptionRuleResponse) })]
    public class RemoveOCINetworkfirewallDecryptionRule : OCINetworkFirewallCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCINetworkfirewallDecryptionRule", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDecryptionRuleRequest
                {
                ...
                response = client.DeleteDecryptionRule(request).GetAwaiter().GetResult();
        ...
        private DeleteDecryptionRuleResponse response;
    }
}
