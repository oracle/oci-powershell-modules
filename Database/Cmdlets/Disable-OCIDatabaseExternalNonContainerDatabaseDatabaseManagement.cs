...
{
    [Cmdlet("Disable", "OCIDatabaseExternalNonContainerDatabaseDatabaseManagement", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DisableExternalNonContainerDatabaseDatabaseManagementResponse) })]
    public class DisableOCIDatabaseExternalNonContainerDatabaseDatabaseManagement : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableExternalNonContainerDatabaseDatabaseManagementRequest
                {
        ...
        private void HandleOutput(DisableExternalNonContainerDatabaseDatabaseManagementRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDisableExternalNonContainerDatabaseDatabaseManagement(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DisableExternalNonContainerDatabaseDatabaseManagement(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DisableExternalNonContainerDatabaseDatabaseManagementResponse response;
