...
{
    [Cmdlet("Get", "OCIDbmulticloudWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.DbmulticloudService.Models.WorkRequestErrorCollection), typeof(Oci.DbmulticloudService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIDbmulticloudWorkRequestErrorsList : OCIWorkRequestCmdlet
    {
        ...
        public System.Nullable<Oci.DbmulticloudService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }
