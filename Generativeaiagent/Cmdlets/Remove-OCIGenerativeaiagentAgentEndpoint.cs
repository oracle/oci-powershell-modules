...
{
    [Cmdlet("Remove", "OCIGenerativeaiagentAgentEndpoint", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GenerativeaiagentService.Responses.DeleteAgentEndpointResponse) })]
    public class RemoveOCIGenerativeaiagentAgentEndpoint : OCIGenerativeAiAgentCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIGenerativeaiagentAgentEndpoint", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteAgentEndpointRequest
                {
                ...
                response = client.DeleteAgentEndpoint(request).GetAwaiter().GetResult();
        ...
        private DeleteAgentEndpointResponse response;
    }
}
