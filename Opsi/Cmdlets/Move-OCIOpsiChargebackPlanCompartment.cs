...
{
    [Cmdlet("Move", "OCIOpsiChargebackPlanCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.ChangeChargebackPlanCompartmentResponse) })]
    public class MoveOCIOpsiChargebackPlanCompartment : OCIOperationsInsightsCmdlet
    {
...
*Note:* Retry tokens can be invalidated before the 24 hour time limit due to conflicting operations, such as a resource being deleted or purged from the system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeChargebackPlanCompartmentRequest
                {
                ...
                response = client.ChangeChargebackPlanCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeChargebackPlanCompartmentResponse response;
    }
}
