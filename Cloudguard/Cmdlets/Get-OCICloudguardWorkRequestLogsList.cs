...
{
    [Cmdlet("Get", "OCICloudguardWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.CloudguardService.Models.WorkRequestLogEntryCollection), typeof(Oci.CloudguardService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCICloudguardWorkRequestLogsList : OCICloudGuardCmdlet
    {
        ...
        public System.Nullable<Oci.CloudguardService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
