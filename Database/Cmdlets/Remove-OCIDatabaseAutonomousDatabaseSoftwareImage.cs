...
{
    [Cmdlet("Remove", "OCIDatabaseAutonomousDatabaseSoftwareImage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteAutonomousDatabaseSoftwareImageResponse) })]
    public class RemoveOCIDatabaseAutonomousDatabaseSoftwareImage : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseAutonomousDatabaseSoftwareImage", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteAutonomousDatabaseSoftwareImageRequest
                {
        ...
        private void HandleOutput(DeleteAutonomousDatabaseSoftwareImageRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteAutonomousDatabaseSoftwareImage(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteAutonomousDatabaseSoftwareImage(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteAutonomousDatabaseSoftwareImageResponse response;
