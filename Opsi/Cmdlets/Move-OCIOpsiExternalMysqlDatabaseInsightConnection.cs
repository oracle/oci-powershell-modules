...
{
    [Cmdlet("Move", "OCIOpsiExternalMysqlDatabaseInsightConnection")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.ChangeExternalMysqlDatabaseInsightConnectionResponse) })]
    public class MoveOCIOpsiExternalMysqlDatabaseInsightConnection : OCIOperationsInsightsCmdlet
    {
...
*Note:* Retry tokens can be invalidated before the 24 hour time limit due to conflicting operations, such as a resource being deleted or purged from the system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ChangeExternalMysqlDatabaseInsightConnection(request).GetAwaiter().GetResult();
        ...
        private ChangeExternalMysqlDatabaseInsightConnectionResponse response;
    }
}
