...
{
    [Cmdlet("Get", "OCIDatasafeWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.WorkRequest), typeof(Oci.DatasafeService.Responses.GetWorkRequestResponse) })]
    public class GetOCIDatasafeWorkRequest : OCIDataSafeCmdlet
    {
        ...
        public Oci.DatasafeService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
