...
{
    [Cmdlet("Get", "OCIIdentitydomainsCloudGate")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.CloudGate), typeof(Oci.IdentitydomainsService.Responses.GetCloudGateResponse) })]
    public class GetOCIIdentitydomainsCloudGate : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetCloudGateRequest
                {
                ...
                response = client.GetCloudGate(request).GetAwaiter().GetResult();
        ...
        private GetCloudGateResponse response;
    }
}
