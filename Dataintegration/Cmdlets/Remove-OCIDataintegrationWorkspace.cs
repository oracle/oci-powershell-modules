...
{
    [Cmdlet("Remove", "OCIDataintegrationWorkspace", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DataintegrationService.Responses.DeleteWorkspaceResponse) })]
    public class RemoveOCIDataintegrationWorkspace : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataintegrationWorkspace", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteWorkspace(request).GetAwaiter().GetResult();
        ...
        private DeleteWorkspaceResponse response;
    }
}
