...
{
    [Cmdlet("Get", "OCILicensemanagerTopUtilizedProductLicensesList")]
    [OutputType(new System.Type[] { typeof(Oci.LicensemanagerService.Models.TopUtilizedProductLicenseCollection), typeof(Oci.LicensemanagerService.Responses.ListTopUtilizedProductLicensesResponse) })]
    public class GetOCILicensemanagerTopUtilizedProductLicensesList : OCILicenseManagerCmdlet
    {
        ...
        public System.Nullable<Oci.LicensemanagerService.Requests.ListTopUtilizedProductLicensesRequest.SortOrderEnum> SortOrder { get; set; }
...
* **totalLicenseUnitsConsumed:** Sorts by totalLicenseUnitsConsumed of ProductLicense.")]
        public System.Nullable<Oci.LicensemanagerService.Requests.ListTopUtilizedProductLicensesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListTopUtilizedProductLicensesRequest
                {
                ...
                IEnumerable<ListTopUtilizedProductLicensesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.TopUtilizedProductLicenseCollection, true);
                }
        ...
        {
            IEnumerable<ListTopUtilizedProductLicensesResponse> DefaultRequest(ListTopUtilizedProductLicensesRequest request) => Enumerable.Repeat(client.ListTopUtilizedProductLicenses(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListTopUtilizedProductLicensesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListTopUtilizedProductLicensesResponse response;
        private delegate IEnumerable<ListTopUtilizedProductLicensesResponse> RequestDelegate(ListTopUtilizedProductLicensesRequest request);
