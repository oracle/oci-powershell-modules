...
{
    [Cmdlet("New", "OCICertificatesmanagementCertificateAuthority")]
    [OutputType(new System.Type[] { typeof(Oci.CertificatesmanagementService.Models.CertificateAuthority), typeof(Oci.CertificatesmanagementService.Responses.CreateCertificateAuthorityResponse) })]
    public class NewOCICertificatesmanagementCertificateAuthority : OCICertificatesManagementCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details of the request to create a new CA.")]
        ...
        private CreateCertificateAuthorityResponse response;
    }
}
