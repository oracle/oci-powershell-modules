...
{
    [Cmdlet("Get", "OCIDatabasemanagementExternalDbNodesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.ExternalDbNodeCollection), typeof(Oci.DatabasemanagementService.Responses.ListExternalDbNodesResponse) })]
    public class GetOCIDatabasemanagementExternalDbNodesList : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListExternalDbNodesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListExternalDbNodesRequest
                {
                ...
                IEnumerable<ListExternalDbNodesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.ExternalDbNodeCollection, true);
                }
        ...
        {
            IEnumerable<ListExternalDbNodesResponse> DefaultRequest(ListExternalDbNodesRequest request) => Enumerable.Repeat(client.ListExternalDbNodes(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListExternalDbNodesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListExternalDbNodesResponse response;
        private delegate IEnumerable<ListExternalDbNodesResponse> RequestDelegate(ListExternalDbNodesRequest request);
