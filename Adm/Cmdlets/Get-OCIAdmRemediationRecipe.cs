...
{
    [Cmdlet("Get", "OCIAdmRemediationRecipe", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.AdmService.Models.RemediationRecipe), typeof(Oci.AdmService.Responses.GetRemediationRecipeResponse) })]
    public class GetOCIAdmRemediationRecipe : OCIApplicationDependencyManagementCmdlet
    {
        ...
        public Oci.AdmService.Models.RemediationRecipe.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetRemediationRecipeRequest
                {
        ...
        private void HandleOutput(GetRemediationRecipeRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForRemediationRecipe(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetRemediationRecipe(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.RemediationRecipe);
        }

        private GetRemediationRecipeResponse response;
