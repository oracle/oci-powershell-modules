...
{
    public abstract class OCIApmSyntheticCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ApmSyntheticClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ApmSyntheticClient client;
