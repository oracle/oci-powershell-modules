...
{
    [Cmdlet("Remove", "OCIDataintegrationCopyObjectRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataintegrationService.Responses.DeleteCopyObjectRequestResponse) })]
    public class RemoveOCIDataintegrationCopyObjectRequest : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataintegrationCopyObjectRequest", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteCopyObjectRequestRequest
                {
                ...
                response = client.DeleteCopyObjectRequest(request).GetAwaiter().GetResult();
        ...
        private DeleteCopyObjectRequestResponse response;
    }
}
