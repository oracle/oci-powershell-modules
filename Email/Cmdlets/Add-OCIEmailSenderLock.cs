...
{
    [Cmdlet("Add", "OCIEmailSenderLock")]
    [OutputType(new System.Type[] { typeof(Oci.EmailService.Models.Sender), typeof(Oci.EmailService.Responses.AddSenderLockResponse) })]
    public class AddOCIEmailSenderLock : OCIEmailCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddSenderLockRequest
                {
                    SenderId = SenderId,
                ...
                response = client.AddSenderLock(request).GetAwaiter().GetResult();
        ...
        private AddSenderLockResponse response;
    }
}
