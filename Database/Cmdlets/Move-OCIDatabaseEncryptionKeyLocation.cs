...
{
    [Cmdlet("Move", "OCIDatabaseEncryptionKeyLocation", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.ChangeEncryptionKeyLocationResponse) })]
    public class MoveOCIDatabaseEncryptionKeyLocation : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to change the source of the encryption key for the database. This parameter also accepts subtypes <Oci.DatabaseService.Models.ExternalHsmEncryptionDetails>, <Oci.DatabaseService.Models.GoogleCloudProviderEncryptionKeyDetails>, <Oci.DatabaseService.Models.AzureEncryptionKeyDetails>, <Oci.DatabaseService.Models.AwsEncryptionKeyDetails> of type <Oci.DatabaseService.Models.EncryptionKeyLocationDetails>.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to change the source of the encryption key for the database. This parameter also accepts subtypes <Oci.DatabaseService.Models.ExternalHsmEncryptionDetails>, <Oci.DatabaseService.Models.GoogleCloudProviderEncryptionKeyDetails>, <Oci.DatabaseService.Models.AzureEncryptionKeyDetails>, <Oci.DatabaseService.Models.AwsEncryptionKeyDetails> of type <Oci.DatabaseService.Models.EncryptionKeyLocationDetails>.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeEncryptionKeyLocationRequest
                {
        ...
        private void HandleOutput(ChangeEncryptionKeyLocationRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForChangeEncryptionKeyLocation(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ChangeEncryptionKeyLocation(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private ChangeEncryptionKeyLocationResponse response;
