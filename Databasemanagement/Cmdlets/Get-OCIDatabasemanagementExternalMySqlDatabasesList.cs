...
{
    [Cmdlet("Get", "OCIDatabasemanagementExternalMySqlDatabasesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.ExternalMySqlDatabaseCollection), typeof(Oci.DatabasemanagementService.Responses.ListExternalMySqlDatabasesResponse) })]
    public class GetOCIDatabasemanagementExternalMySqlDatabasesList : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListExternalMySqlDatabasesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListExternalMySqlDatabasesRequest
                {
                ...
                IEnumerable<ListExternalMySqlDatabasesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.ExternalMySqlDatabaseCollection, true);
                }
        ...
        {
            IEnumerable<ListExternalMySqlDatabasesResponse> DefaultRequest(ListExternalMySqlDatabasesRequest request) => Enumerable.Repeat(client.ListExternalMySqlDatabases(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListExternalMySqlDatabasesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListExternalMySqlDatabasesResponse response;
        private delegate IEnumerable<ListExternalMySqlDatabasesResponse> RequestDelegate(ListExternalMySqlDatabasesRequest request);
