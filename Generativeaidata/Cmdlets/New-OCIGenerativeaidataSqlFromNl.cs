...
namespace Oci.GenerativeaidataService.Cmdlets
{
    ...
    public class NewOCIGenerativeaidataSqlFromNl : OCIGenerateSqlFromNlJobCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GenerateSqlFromNlRequest
                {
                ...
                response = client.GenerateSqlFromNl(request).GetAwaiter().GetResult();
                WriteOutput(response, response.GenerateSqlFromNlJob);
        ...
        private GenerateSqlFromNlResponse response;
    }
}
