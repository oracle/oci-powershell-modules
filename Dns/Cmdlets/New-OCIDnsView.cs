...
{
    [Cmdlet("New", "OCIDnsView", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.View), typeof(Oci.DnsService.Responses.CreateViewResponse) })]
    public class NewOCIDnsView : OCIDnsCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for creating a new view.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for creating a new view.", ParameterSetName = Default)]
        ...
        private void HandleOutput(CreateViewRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForCreateView(request, waiterConfig, WaitForStatus).Execute();
                    break;
        ...
        private CreateViewResponse response;
