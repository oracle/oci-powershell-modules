...
{
    [Cmdlet("Get", "OCINosqlWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.NosqlService.Models.WorkRequestCollection), typeof(Oci.NosqlService.Responses.ListWorkRequestsResponse) })]
    public class GetOCINosqlWorkRequestsList : OCINosqlCmdlet
    {
