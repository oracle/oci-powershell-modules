...
{
    [Cmdlet("Invoke", "OCIDatasafePatchTargetAlertPolicyAssociation")]
    ...
    public class InvokeOCIDatasafePatchTargetAlertPolicyAssociation : OCIDataSafeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new PatchTargetAlertPolicyAssociationRequest
                {
                ...
                response = client.PatchTargetAlertPolicyAssociation(request).GetAwaiter().GetResult();
        ...
        private PatchTargetAlertPolicyAssociationResponse response;
    }
}
