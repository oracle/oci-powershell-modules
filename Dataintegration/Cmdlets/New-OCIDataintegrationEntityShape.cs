...
namespace Oci.DataintegrationService.Cmdlets
{
    ...
    public class NewOCIDataintegrationEntityShape : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details of the data entity to use to infer the data entity shape. This parameter also accepts subtype <Oci.DataintegrationService.Models.CreateEntityShapeFromFile> of type <Oci.DataintegrationService.Models.CreateEntityShapeDetails>.")]
