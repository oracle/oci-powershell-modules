...
namespace Oci.CoreService.Cmdlets
{
    ...
    public class GetOCIComputeCluster : OCIComputeCmdlet
    {
        ...
        public Oci.CoreService.Models.ComputeCluster.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        private void HandleOutput(GetComputeClusterRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForComputeCluster(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetComputeCluster(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.ComputeCluster);
        }

        private GetComputeClusterResponse response;
