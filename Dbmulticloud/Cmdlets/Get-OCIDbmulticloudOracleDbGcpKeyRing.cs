...
{
    [Cmdlet("Get", "OCIDbmulticloudOracleDbGcpKeyRing", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DbmulticloudService.Models.OracleDbGcpKeyRing), typeof(Oci.DbmulticloudService.Responses.GetOracleDbGcpKeyRingResponse) })]
    public class GetOCIDbmulticloudOracleDbGcpKeyRing : OCIDbMulticloudGCPProviderCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Oracle DB GCP Key-Ring resource.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Oracle DB GCP Key-Ring resource.", ParameterSetName = Default)]
        ...
        public Oci.DbmulticloudService.Models.OracleDbGcpKeyRing.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOracleDbGcpKeyRingRequest
                {
        ...
        private void HandleOutput(GetOracleDbGcpKeyRingRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForOracleDbGcpKeyRing(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetOracleDbGcpKeyRing(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.OracleDbGcpKeyRing);
        }

        private GetOracleDbGcpKeyRingResponse response;
