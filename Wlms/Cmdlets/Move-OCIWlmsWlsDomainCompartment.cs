...
{
    [Cmdlet("Move", "OCIWlmsWlsDomainCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.WlmsService.Responses.ChangeWlsDomainCompartmentResponse) })]
    public class MoveOCIWlmsWlsDomainCompartment : OCIWeblogicManagementServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeWlsDomainCompartmentRequest
                {
                ...
                response = client.ChangeWlsDomainCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeWlsDomainCompartmentResponse response;
    }
}
