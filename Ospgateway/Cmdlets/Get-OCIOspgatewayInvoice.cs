...
{
    [Cmdlet("Get", "OCIOspgatewayInvoice")]
    [OutputType(new System.Type[] { typeof(Oci.OspgatewayService.Models.Invoice), typeof(Oci.OspgatewayService.Responses.GetInvoiceResponse) })]
    public class GetOCIOspgatewayInvoice : OCIInvoiceServiceCmdlet
    {
        ...
        private GetInvoiceResponse response;
    }
}
