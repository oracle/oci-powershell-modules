...
{
    [Cmdlet("Get", "OCIIdentitydomainsAppsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Apps), typeof(Oci.IdentitydomainsService.Responses.ListAppsResponse) })]
    public class GetOCIIdentitydomainsAppsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ListApps(request).GetAwaiter().GetResult();
