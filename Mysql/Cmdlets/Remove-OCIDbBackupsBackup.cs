...
{
    [Cmdlet("Remove", "OCIDbBackupsBackup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.DeleteBackupResponse) })]
    public class RemoveOCIDbBackupsBackup : OCIDbBackupsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDbBackupsBackup", "Remove"))
            {
               return;
            }
