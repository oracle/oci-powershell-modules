...
{
    [Cmdlet("Remove", "OCIFunctionsManagementFunction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.FunctionsService.Responses.DeleteFunctionResponse) })]
    public class RemoveOCIFunctionsManagementFunction : OCIFunctionsManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIFunctionsManagementFunction", "Remove"))
            {
               return;
            }
