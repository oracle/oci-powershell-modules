...
{
    [Cmdlet("New", "OCILoadbalancer")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.LoadbalancerService.Responses.CreateLoadBalancerResponse) })]
    public class NewOCILoadbalancer : OCILoadBalancerCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The configuration details for creating a load balancer.")]
        ...
        private CreateLoadBalancerResponse response;
    }
}
