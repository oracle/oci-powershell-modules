...
{
    [Cmdlet("Stop", "OCINetworkfirewallWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.NetworkfirewallService.Responses.CancelWorkRequestResponse) })]
    public class StopOCINetworkfirewallWorkRequest : OCINetworkFirewallCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCINetworkfirewallWorkRequest", "Stop"))
            {
               return;
            }
