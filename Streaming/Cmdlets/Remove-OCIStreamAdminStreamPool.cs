...
{
    [Cmdlet("Remove", "OCIStreamAdminStreamPool", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.StreamingService.Responses.DeleteStreamPoolResponse) })]
    public class RemoveOCIStreamAdminStreamPool : OCIStreamAdminCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIStreamAdminStreamPool", "Remove"))
            {
               return;
            }
