...
{
    [Cmdlet("Get", "OCIIdentitydomainsSchemasList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Schemas), typeof(Oci.IdentitydomainsService.Responses.ListSchemasResponse) })]
    public class GetOCIIdentitydomainsSchemasList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ListSchemas(request).GetAwaiter().GetResult();
