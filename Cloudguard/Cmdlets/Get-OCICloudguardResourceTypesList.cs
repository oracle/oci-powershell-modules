...
{
    [Cmdlet("Get", "OCICloudguardResourceTypesList")]
    [OutputType(new System.Type[] { typeof(Oci.CloudguardService.Models.ResourceTypeCollection), typeof(Oci.CloudguardService.Responses.ListResourceTypesResponse) })]
    public class GetOCICloudguardResourceTypesList : OCICloudGuardCmdlet
    {
        ...
        public System.Nullable<Oci.CloudguardService.Requests.ListResourceTypesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    response = item;
                    WriteOutput(response, response.ResourceTypeCollection, true);
                }
