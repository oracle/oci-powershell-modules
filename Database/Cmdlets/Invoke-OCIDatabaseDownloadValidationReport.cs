...
namespace Oci.DatabaseService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIDatabaseDownloadValidationReport", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatabaseService.Responses.DownloadValidationReportResponse) })]
    public class InvokeOCIDatabaseDownloadValidationReport : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DownloadValidationReportRequest
                {
                ...
                response = client.DownloadValidationReport(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private DownloadValidationReportResponse response;
