...
namespace Oci.ResourcemanagerService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIResourcemanagerTemplateTfConfig", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.ResourcemanagerService.Responses.GetTemplateTfConfigResponse) })]
    public class GetOCIResourcemanagerTemplateTfConfig : OCIResourceManagerCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetTemplateTfConfigRequest
                {
                    TemplateId = TemplateId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetTemplateTfConfig(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetTemplateTfConfigResponse response;
