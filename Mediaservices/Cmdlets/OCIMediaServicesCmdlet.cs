...
using Oci.MediaservicesService;

namespace Oci.MediaservicesService.Cmdlets
{
    public abstract class OCIMediaServicesCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MediaServicesClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MediaServicesClient client;
