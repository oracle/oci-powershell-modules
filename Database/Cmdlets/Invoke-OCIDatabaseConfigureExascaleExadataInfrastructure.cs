...
{
    [Cmdlet("Invoke", "OCIDatabaseConfigureExascaleExadataInfrastructure", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.ExadataInfrastructure), typeof(Oci.DatabaseService.Responses.ConfigureExascaleExadataInfrastructureResponse) })]
    public class InvokeOCIDatabaseConfigureExascaleExadataInfrastructure : OCIDatabaseCmdlet
    {
        ...
        private void HandleOutput(ConfigureExascaleExadataInfrastructureRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForConfigureExascaleExadataInfrastructure(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ConfigureExascaleExadataInfrastructure(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.ExadataInfrastructure);
        }

        private ConfigureExascaleExadataInfrastructureResponse response;
