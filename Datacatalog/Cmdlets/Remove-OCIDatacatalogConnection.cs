...
{
    [Cmdlet("Remove", "OCIDatacatalogConnection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatacatalogService.Responses.DeleteConnectionResponse) })]
    public class RemoveOCIDatacatalogConnection : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatacatalogConnection", "Remove"))
            {
               return;
            }
