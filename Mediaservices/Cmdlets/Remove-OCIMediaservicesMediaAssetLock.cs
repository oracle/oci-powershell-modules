...
{
    [Cmdlet("Remove", "OCIMediaservicesMediaAssetLock")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.MediaAsset), typeof(Oci.MediaservicesService.Responses.RemoveMediaAssetLockResponse) })]
    public class RemoveOCIMediaservicesMediaAssetLock : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveMediaAssetLockRequest
                {
                ...
                response = client.RemoveMediaAssetLock(request).GetAwaiter().GetResult();
        ...
        private RemoveMediaAssetLockResponse response;
    }
}
