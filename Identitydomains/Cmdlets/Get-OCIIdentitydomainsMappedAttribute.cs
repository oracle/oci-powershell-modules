...
{
    [Cmdlet("Get", "OCIIdentitydomainsMappedAttribute")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MappedAttribute), typeof(Oci.IdentitydomainsService.Responses.GetMappedAttributeResponse) })]
    public class GetOCIIdentitydomainsMappedAttribute : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMappedAttributeRequest
                {
                ...
                response = client.GetMappedAttribute(request).GetAwaiter().GetResult();
        ...
        private GetMappedAttributeResponse response;
    }
}
