...
{
    [Cmdlet("Get", "OCILicensemanagerConfiguration")]
    [OutputType(new System.Type[] { typeof(Oci.LicensemanagerService.Models.Configuration), typeof(Oci.LicensemanagerService.Responses.GetConfigurationResponse) })]
    public class GetOCILicensemanagerConfiguration : OCILicenseManagerCmdlet
    {
