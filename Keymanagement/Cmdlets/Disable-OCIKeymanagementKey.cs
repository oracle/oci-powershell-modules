...
{
    [Cmdlet("Disable", "OCIKeymanagementKey")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.Key), typeof(Oci.KeymanagementService.Responses.DisableKeyResponse) })]
    public class DisableOCIKeymanagementKey : OCIKmsManagementCmdlet
    {
        ...
        private DisableKeyResponse response;
    }
}
