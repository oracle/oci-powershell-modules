...
{
    [Cmdlet("Move", "OCIWaasPolicyCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.WaasService.Responses.ChangeWaasPolicyCompartmentResponse) })]
    public class MoveOCIWaasPolicyCompartment : OCIWaasCmdlet
    {
        ...
        private ChangeWaasPolicyCompartmentResponse response;
    }
}
