...
{
    [Cmdlet("Get", "OCIDbmulticloudOracleDbAzureVaultAssociation", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DbmulticloudService.Models.OracleDbAzureVaultAssociation), typeof(Oci.DbmulticloudService.Responses.GetOracleDbAzureVaultAssociationResponse) })]
    public class GetOCIDbmulticloudOracleDbAzureVaultAssociation : OCIOracleDbAzureVaultAssociationCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Oracle DB Azure Vault Association resource.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Oracle DB Azure Vault Association resource.", ParameterSetName = Default)]
        ...
        public Oci.DbmulticloudService.Models.OracleDbAzureVaultAssociation.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOracleDbAzureVaultAssociationRequest
                {
        ...
        private void HandleOutput(GetOracleDbAzureVaultAssociationRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForOracleDbAzureVaultAssociation(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetOracleDbAzureVaultAssociation(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.OracleDbAzureVaultAssociation);
        }

        private GetOracleDbAzureVaultAssociationResponse response;
