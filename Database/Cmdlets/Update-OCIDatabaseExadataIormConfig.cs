...
{
    [Cmdlet("Update", "OCIDatabaseExadataIormConfig", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.ExadataIormConfig), typeof(Oci.DatabaseService.Responses.UpdateExadataIormConfigResponse) })]
    public class UpdateOCIDatabaseExadataIormConfig : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateExadataIormConfigRequest
                {
        ...
        private void HandleOutput(UpdateExadataIormConfigRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateExadataIormConfig(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpdateExadataIormConfig(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.ExadataIormConfig);
        }

        private UpdateExadataIormConfigResponse response;
