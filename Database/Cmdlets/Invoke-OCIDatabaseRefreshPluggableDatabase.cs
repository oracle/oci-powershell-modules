...
{
    [Cmdlet("Invoke", "OCIDatabaseRefreshPluggableDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.PluggableDatabase), typeof(Oci.DatabaseService.Responses.RefreshPluggableDatabaseResponse) })]
    public class InvokeOCIDatabaseRefreshPluggableDatabase : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RefreshPluggableDatabaseRequest
                {
        ...
        private void HandleOutput(RefreshPluggableDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRefreshPluggableDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RefreshPluggableDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.PluggableDatabase);
        }

        private RefreshPluggableDatabaseResponse response;
