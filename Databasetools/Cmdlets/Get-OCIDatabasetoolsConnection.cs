...
namespace Oci.DatabasetoolsService.Cmdlets
{
    ...
    public class GetOCIDatabasetoolsConnection : OCIDatabaseToolsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of a Database Tools connection.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of a Database Tools connection.", ParameterSetName = Default)]
