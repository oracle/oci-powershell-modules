...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class GetOCIFusionappsDataMaskingActivity : OCIFusionApplicationsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique DataMasking run identifier.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique DataMasking run identifier.", ParameterSetName = Default)]
        ...
        public Oci.FusionappsService.Models.DataMaskingActivity.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetDataMaskingActivityRequest
                {
        ...
        private void HandleOutput(GetDataMaskingActivityRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForDataMaskingActivity(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetDataMaskingActivity(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.DataMaskingActivity);
        }

        private GetDataMaskingActivityResponse response;
