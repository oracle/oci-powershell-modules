...
{
    [Cmdlet("Get", "OCIUsageapiQuery")]
    [OutputType(new System.Type[] { typeof(Oci.UsageapiService.Models.Query), typeof(Oci.UsageapiService.Responses.GetQueryResponse) })]
    public class GetOCIUsageapiQuery : OCIUsageapiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GetQuery(request).GetAwaiter().GetResult();
        ...
        private GetQueryResponse response;
    }
}
