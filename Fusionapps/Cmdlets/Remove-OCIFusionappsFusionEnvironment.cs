...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class RemoveOCIFusionappsFusionEnvironment : OCIFusionApplicationsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIFusionappsFusionEnvironment", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteFusionEnvironmentRequest
                {
                ...
                response = client.DeleteFusionEnvironment(request).GetAwaiter().GetResult();
        ...
        private DeleteFusionEnvironmentResponse response;
    }
}
