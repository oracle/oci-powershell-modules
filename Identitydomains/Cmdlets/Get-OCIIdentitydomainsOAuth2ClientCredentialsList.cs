...
{
    [Cmdlet("Get", "OCIIdentitydomainsOAuth2ClientCredentialsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.OAuth2ClientCredentials), typeof(Oci.IdentitydomainsService.Responses.ListOAuth2ClientCredentialsResponse) })]
    public class GetOCIIdentitydomainsOAuth2ClientCredentialsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListOAuth2ClientCredentialsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListOAuth2ClientCredentials(request).GetAwaiter().GetResult();
        ...
        private ListOAuth2ClientCredentialsResponse response;
    }
}
