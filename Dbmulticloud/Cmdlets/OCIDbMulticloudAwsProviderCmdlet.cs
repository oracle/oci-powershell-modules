...
{
    public abstract class OCIDbMulticloudAwsProviderCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DbMulticloudAwsProviderClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DbMulticloudAwsProviderClient client;
