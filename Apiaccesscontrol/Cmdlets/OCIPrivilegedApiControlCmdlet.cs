...
{
    public abstract class OCIPrivilegedApiControlCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new PrivilegedApiControlClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected PrivilegedApiControlClient client;
