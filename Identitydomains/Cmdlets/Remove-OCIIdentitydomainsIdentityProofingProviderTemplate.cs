...
{
    [Cmdlet("Remove", "OCIIdentitydomainsIdentityProofingProviderTemplate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteIdentityProofingProviderTemplateResponse) })]
    public class RemoveOCIIdentitydomainsIdentityProofingProviderTemplate : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsIdentityProofingProviderTemplate", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteIdentityProofingProviderTemplateRequest
                {
                ...
                response = client.DeleteIdentityProofingProviderTemplate(request).GetAwaiter().GetResult();
        ...
        private DeleteIdentityProofingProviderTemplateResponse response;
    }
}
