...
{
    [Cmdlet("Get", "OCIDatalabelingserviceWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatalabelingService.Models.WorkRequest), typeof(Oci.DatalabelingService.Responses.GetWorkRequestResponse) })]
    public class GetOCIDatalabelingserviceWorkRequest : OCIDataLabelingManagementCmdlet
    {
        ...
        public Oci.DatalabelingService.Models.OperationStatus[] WaitForStatus { get; set; }
