...
{
    [Cmdlet("New", "OCIDashboardserviceDashboard")]
    [OutputType(new System.Type[] { typeof(Oci.DashboardService.Models.Dashboard), typeof(Oci.DashboardService.Responses.CreateDashboardResponse) })]
    public class NewOCIDashboardserviceDashboard : OCIDashboardCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details about the dashboard being created. This parameter also accepts subtype <Oci.DashboardService.Models.CreateV1DashboardDetails> of type <Oci.DashboardService.Models.CreateDashboardDetails>.")]
        ...
        private CreateDashboardResponse response;
    }
}
