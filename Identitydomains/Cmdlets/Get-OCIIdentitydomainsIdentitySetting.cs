...
{
    [Cmdlet("Get", "OCIIdentitydomainsIdentitySetting")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.IdentitySetting), typeof(Oci.IdentitydomainsService.Responses.GetIdentitySettingResponse) })]
    public class GetOCIIdentitydomainsIdentitySetting : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetIdentitySettingRequest
                {
                ...
                response = client.GetIdentitySetting(request).GetAwaiter().GetResult();
        ...
        private GetIdentitySettingResponse response;
    }
}
