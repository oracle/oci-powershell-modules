...
{
    [Cmdlet("Remove", "OCITransferAppliance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DtsService.Responses.DeleteTransferApplianceResponse) })]
    public class RemoveOCITransferAppliance : OCITransferApplianceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCITransferAppliance", "Remove"))
            {
               return;
            }
