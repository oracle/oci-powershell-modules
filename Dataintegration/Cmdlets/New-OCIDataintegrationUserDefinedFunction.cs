...
{
    [Cmdlet("New", "OCIDataintegrationUserDefinedFunction")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.UserDefinedFunction), typeof(Oci.DataintegrationService.Responses.CreateUserDefinedFunctionResponse) })]
    public class NewOCIDataintegrationUserDefinedFunction : OCIDataIntegrationCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The workspace ID.")]
        public string WorkspaceId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details needed to create a new UserDefinedFunction.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CreateUserDefinedFunction(request).GetAwaiter().GetResult();
        ...
        private CreateUserDefinedFunctionResponse response;
    }
}
