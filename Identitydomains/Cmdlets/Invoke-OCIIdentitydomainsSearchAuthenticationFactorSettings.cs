...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchAuthenticationFactorSettings")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.AuthenticationFactorSettings), typeof(Oci.IdentitydomainsService.Responses.SearchAuthenticationFactorSettingsResponse) })]
    public class InvokeOCIIdentitydomainsSearchAuthenticationFactorSettings : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching AuthenticationFactorSettings")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchAuthenticationFactorSettingsRequest
                {
                ...
                response = client.SearchAuthenticationFactorSettings(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AuthenticationFactorSettings);
        ...
        private SearchAuthenticationFactorSettingsResponse response;
    }
}
