...
{
    [Cmdlet("Update", "OCIWaasThreatFeeds")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdateThreatFeedsResponse) })]
    public class UpdateOCIWaasThreatFeeds : OCIWaasCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A list of threat feeds for which to update the actions.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateThreatFeedsRequest
                {
                ...
                response = client.UpdateThreatFeeds(request).GetAwaiter().GetResult();
        ...
        private UpdateThreatFeedsResponse response;
    }
}
