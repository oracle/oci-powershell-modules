...
{
    [Cmdlet("Remove", "OCIContainerengineWorkloadMapping", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ContainerengineService.Responses.DeleteWorkloadMappingResponse) })]
    public class RemoveOCIContainerengineWorkloadMapping : OCIContainerEngineCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIContainerengineWorkloadMapping", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteWorkloadMappingRequest
                {
                    ClusterId = ClusterId,
                ...
                response = client.DeleteWorkloadMapping(request).GetAwaiter().GetResult();
        ...
        private DeleteWorkloadMappingResponse response;
    }
}
