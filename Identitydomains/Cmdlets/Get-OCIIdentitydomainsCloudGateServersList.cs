...
{
    [Cmdlet("Get", "OCIIdentitydomainsCloudGateServersList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.CloudGateServers), typeof(Oci.IdentitydomainsService.Responses.ListCloudGateServersResponse) })]
    public class GetOCIIdentitydomainsCloudGateServersList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListCloudGateServersRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListCloudGateServers(request).GetAwaiter().GetResult();
        ...
        private ListCloudGateServersResponse response;
    }
}
