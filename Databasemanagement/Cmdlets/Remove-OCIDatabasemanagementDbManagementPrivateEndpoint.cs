...
{
    [Cmdlet("Remove", "OCIDatabasemanagementDbManagementPrivateEndpoint", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabasemanagementService.Responses.DeleteDbManagementPrivateEndpointResponse) })]
    public class RemoveOCIDatabasemanagementDbManagementPrivateEndpoint : OCIDbManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabasemanagementDbManagementPrivateEndpoint", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDbManagementPrivateEndpointRequest
                {
        ...
        private DeleteDbManagementPrivateEndpointResponse response;
    }
}
