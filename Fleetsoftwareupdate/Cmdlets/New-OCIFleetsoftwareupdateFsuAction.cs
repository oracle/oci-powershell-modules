...
namespace Oci.FleetsoftwareupdateService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new Exadata Fleet Update Action. This parameter also accepts subtypes <Oci.FleetsoftwareupdateService.Models.CreateRollbackCycleApplyActionDetails>, <Oci.FleetsoftwareupdateService.Models.CreateApplyActionDetails>, <Oci.FleetsoftwareupdateService.Models.CreateStageActionDetails>, <Oci.FleetsoftwareupdateService.Models.CreateRollbackActionDetails>, <Oci.FleetsoftwareupdateService.Models.CreateCleanupActionDetails>, <Oci.FleetsoftwareupdateService.Models.CreatePrecheckActionDetails> of type <Oci.FleetsoftwareupdateService.Models.CreateFsuActionDetails>.")]
