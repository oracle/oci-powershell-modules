...
{
    [Cmdlet("Invoke", "OCIOsmanagementInstallAllWindowsUpdatesOnManagedInstance")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OsmanagementService.Responses.InstallAllWindowsUpdatesOnManagedInstanceResponse) })]
    public class InvokeOCIOsmanagementInstallAllWindowsUpdatesOnManagedInstance : OCIOsManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.InstallAllWindowsUpdatesOnManagedInstance(request).GetAwaiter().GetResult();
        ...
        private InstallAllWindowsUpdatesOnManagedInstanceResponse response;
    }
}
