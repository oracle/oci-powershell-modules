...
{
    [Cmdlet("Enable", "OCIDatabaseExternalPluggableDatabaseOperationsInsights", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.EnableExternalPluggableDatabaseOperationsInsightsResponse) })]
    public class EnableOCIDatabaseExternalPluggableDatabaseOperationsInsights : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details to enable Operations Insights on the external pluggable database", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details to enable Operations Insights on the external pluggable database", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new EnableExternalPluggableDatabaseOperationsInsightsRequest
                {
        ...
        private EnableExternalPluggableDatabaseOperationsInsightsResponse response;
