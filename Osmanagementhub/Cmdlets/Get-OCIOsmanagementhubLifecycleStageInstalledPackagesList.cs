...
{
    [Cmdlet("Get", "OCIOsmanagementhubLifecycleStageInstalledPackagesList")]
    [OutputType(new System.Type[] { typeof(Oci.OsmanagementhubService.Models.InstalledPackageCollection), typeof(Oci.OsmanagementhubService.Responses.ListLifecycleStageInstalledPackagesResponse) })]
    public class GetOCIOsmanagementhubLifecycleStageInstalledPackagesList : OCILifecycleEnvironmentCmdlet
    {
...
Example: `3`")]
        ...
        public System.Nullable<Oci.OsmanagementhubService.Requests.ListLifecycleStageInstalledPackagesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListLifecycleStageInstalledPackagesRequest
                {
                ...
                IEnumerable<ListLifecycleStageInstalledPackagesResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListLifecycleStageInstalledPackagesResponse> DefaultRequest(ListLifecycleStageInstalledPackagesRequest request) => Enumerable.Repeat(client.ListLifecycleStageInstalledPackages(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListLifecycleStageInstalledPackagesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListLifecycleStageInstalledPackagesResponse response;
        private delegate IEnumerable<ListLifecycleStageInstalledPackagesResponse> RequestDelegate(ListLifecycleStageInstalledPackagesRequest request);
