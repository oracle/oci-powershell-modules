...
namespace Oci.DatascienceService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIDatascienceMlApplicationHistoricalPackageContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatascienceService.Responses.GetMlApplicationHistoricalPackageContentResponse) })]
    public class GetOCIDatascienceMlApplicationHistoricalPackageContent : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMlApplicationHistoricalPackageContentRequest
                {
                    MlApplicationImplementationVersionId = MlApplicationImplementationVersionId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetMlApplicationHistoricalPackageContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetMlApplicationHistoricalPackageContentResponse response;
