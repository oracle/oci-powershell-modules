...
{
    [Cmdlet("Update", "OCIDatascienceModelGroupVersionHistory")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.ModelGroupVersionHistory), typeof(Oci.DatascienceService.Responses.UpdateModelGroupVersionHistoryResponse) })]
    public class UpdateOCIDatascienceModelGroupVersionHistory : OCIDataScienceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for updating a modelGroupVersionHistory.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateModelGroupVersionHistoryRequest
                {
                ...
                response = client.UpdateModelGroupVersionHistory(request).GetAwaiter().GetResult();
        ...
        private UpdateModelGroupVersionHistoryResponse response;
    }
}
