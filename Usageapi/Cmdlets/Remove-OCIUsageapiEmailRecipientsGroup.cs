...
{
    [Cmdlet("Remove", "OCIUsageapiEmailRecipientsGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCIUsageapiEmailRecipientsGroup : OCIUsageapiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIUsageapiEmailRecipientsGroup", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteEmailRecipientsGroupRequest
                {
                ...
                response = client.DeleteEmailRecipientsGroup(request).GetAwaiter().GetResult();
        ...
        private DeleteEmailRecipientsGroupResponse response;
    }
}
