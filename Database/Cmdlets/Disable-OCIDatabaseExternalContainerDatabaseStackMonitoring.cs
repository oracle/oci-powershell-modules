...
{
    [Cmdlet("Disable", "OCIDatabaseExternalContainerDatabaseStackMonitoring", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DisableExternalContainerDatabaseStackMonitoringResponse) })]
    public class DisableOCIDatabaseExternalContainerDatabaseStackMonitoring : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableExternalContainerDatabaseStackMonitoringRequest
                {
        ...
        private void HandleOutput(DisableExternalContainerDatabaseStackMonitoringRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDisableExternalContainerDatabaseStackMonitoring(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DisableExternalContainerDatabaseStackMonitoring(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DisableExternalContainerDatabaseStackMonitoringResponse response;
