...
{
    [Cmdlet("Invoke", "OCIDatabaseRotateAutonomousVmClusterOrdsCerts", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.RotateAutonomousVmClusterOrdsCertsResponse) })]
    public class InvokeOCIDatabaseRotateAutonomousVmClusterOrdsCerts : OCIDatabaseCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to rotate the Oracle REST Data Services (ORDS) certificates on Autonomous Exadata VM cluster.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to rotate the Oracle REST Data Services (ORDS) certificates on Autonomous Exadata VM cluster.", ParameterSetName = Default)]
        public RotateAutonomousVmClusterOrdsCertsDetails RotateAutonomousVmClusterOrdsCertsDetails { get; set; }

        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The autonomous VM cluster [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm).", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The autonomous VM cluster [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm).", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RotateAutonomousVmClusterOrdsCertsRequest
                {
        ...
        private void HandleOutput(RotateAutonomousVmClusterOrdsCertsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRotateAutonomousVmClusterOrdsCerts(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RotateAutonomousVmClusterOrdsCerts(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private RotateAutonomousVmClusterOrdsCertsResponse response;
