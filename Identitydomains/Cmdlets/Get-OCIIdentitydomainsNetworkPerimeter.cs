...
{
    [Cmdlet("Get", "OCIIdentitydomainsNetworkPerimeter")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.NetworkPerimeter), typeof(Oci.IdentitydomainsService.Responses.GetNetworkPerimeterResponse) })]
    public class GetOCIIdentitydomainsNetworkPerimeter : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetNetworkPerimeterRequest
                {
                ...
                response = client.GetNetworkPerimeter(request).GetAwaiter().GetResult();
        ...
        private GetNetworkPerimeterResponse response;
    }
}
