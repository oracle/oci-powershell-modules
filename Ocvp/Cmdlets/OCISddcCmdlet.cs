...
{
    public abstract class OCISddcCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new SddcClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
