...
{
    [Cmdlet("Get", "OCICapacitymanagementOccHandoverResourceBlockDetailsList")]
    [OutputType(new System.Type[] { typeof(Oci.CapacitymanagementService.Models.OccHandoverResourceBlockDetailCollection), typeof(Oci.CapacitymanagementService.Responses.ListOccHandoverResourceBlockDetailsResponse) })]
    public class GetOCICapacitymanagementOccHandoverResourceBlockDetailsList : OCICapacityManagementCmdlet
    {
        ...
        public System.Nullable<Oci.CapacitymanagementService.Requests.ListOccHandoverResourceBlockDetailsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListOccHandoverResourceBlockDetailsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListOccHandoverResourceBlockDetailsResponse> DefaultRequest(ListOccHandoverResourceBlockDetailsRequest request) => Enumerable.Repeat(client.ListOccHandoverResourceBlockDetails(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListOccHandoverResourceBlockDetailsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListOccHandoverResourceBlockDetailsResponse response;
        private delegate IEnumerable<ListOccHandoverResourceBlockDetailsResponse> RequestDelegate(ListOccHandoverResourceBlockDetailsRequest request);
