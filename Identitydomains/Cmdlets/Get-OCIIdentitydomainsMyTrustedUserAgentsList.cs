...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyTrustedUserAgentsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyTrustedUserAgents), typeof(Oci.IdentitydomainsService.Responses.ListMyTrustedUserAgentsResponse) })]
    public class GetOCIIdentitydomainsMyTrustedUserAgentsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMyTrustedUserAgentsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListMyTrustedUserAgents(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MyTrustedUserAgents);
        ...
        private ListMyTrustedUserAgentsResponse response;
    }
}
