...
{
    [Cmdlet("Get", "OCIJmsPerformanceTuningAnalysisResultsList")]
    ...
    public class GetOCIJmsPerformanceTuningAnalysisResultsList : OCIJavaManagementServiceCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field to sort performance tuning analysis results. Only one sort order may be provided. Default order for _timeCreated_, and _jreVersion_ is **descending**. Default order for _managedInstanceId_, _jreDistribution_, _jreVendor_ and _osName_ is **ascending**. If no value is specified _timeCreated_ is default.")]
        public System.Nullable<Oci.JmsService.Models.PerformanceTuningAnalysisResultSortBy> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListPerformanceTuningAnalysisResultsRequest
                {
                    FleetId = FleetId,
                ...
                {
                    response = item;
                    WriteOutput(response, response.PerformanceTuningAnalysisResultCollection, true);
                }
        ...
        {
            IEnumerable<ListPerformanceTuningAnalysisResultsResponse> DefaultRequest(ListPerformanceTuningAnalysisResultsRequest request) => Enumerable.Repeat(client.ListPerformanceTuningAnalysisResults(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListPerformanceTuningAnalysisResultsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListPerformanceTuningAnalysisResultsResponse response;
        private delegate IEnumerable<ListPerformanceTuningAnalysisResultsResponse> RequestDelegate(ListPerformanceTuningAnalysisResultsRequest request);
