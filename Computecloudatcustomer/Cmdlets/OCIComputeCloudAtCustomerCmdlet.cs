...
using Oci.ComputecloudatcustomerService;

namespace Oci.ComputecloudatcustomerService.Cmdlets
{
    public abstract class OCIComputeCloudAtCustomerCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ComputeCloudAtCustomerClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ComputeCloudAtCustomerClient client;
