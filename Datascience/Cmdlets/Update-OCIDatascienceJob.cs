...
{
    [Cmdlet("Update", "OCIDatascienceJob")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.Job), typeof(Oci.DatascienceService.Responses.UpdateJobResponse) })]
    public class UpdateOCIDatascienceJob : OCIDataScienceCmdlet
    {
