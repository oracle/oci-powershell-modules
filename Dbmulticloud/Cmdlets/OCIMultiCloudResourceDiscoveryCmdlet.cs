...
{
    public abstract class OCIMultiCloudResourceDiscoveryCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MultiCloudResourceDiscoveryClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MultiCloudResourceDiscoveryClient client;
