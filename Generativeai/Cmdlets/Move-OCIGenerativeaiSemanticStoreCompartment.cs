...
{
    [Cmdlet("Move", "OCIGenerativeaiSemanticStoreCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GenerativeaiService.Responses.ChangeSemanticStoreCompartmentResponse) })]
    public class MoveOCIGenerativeaiSemanticStoreCompartment : OCIGenerativeAiCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the SemanticStore.")]
        public string SemanticStoreId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The SemanticStore information to be updated.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeSemanticStoreCompartmentRequest
                {
                ...
                response = client.ChangeSemanticStoreCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeSemanticStoreCompartmentResponse response;
    }
}
