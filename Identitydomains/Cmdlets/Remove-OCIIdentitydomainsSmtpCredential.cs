...
{
    [Cmdlet("Remove", "OCIIdentitydomainsSmtpCredential", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteSmtpCredentialResponse) })]
    public class RemoveOCIIdentitydomainsSmtpCredential : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsSmtpCredential", "Remove"))
            {
               return;
            }
