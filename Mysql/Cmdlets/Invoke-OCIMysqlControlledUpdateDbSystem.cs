...
{
    [Cmdlet("Invoke", "OCIMysqlControlledUpdateDbSystem")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.ControlledUpdateDbSystemResponse) })]
    public class InvokeOCIMysqlControlledUpdateDbSystem : OCIDbSystemCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Required parameters for the controlled update action.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ControlledUpdateDbSystemRequest
                {
                ...
                response = client.ControlledUpdateDbSystem(request).GetAwaiter().GetResult();
        ...
        private ControlledUpdateDbSystemResponse response;
    }
}
