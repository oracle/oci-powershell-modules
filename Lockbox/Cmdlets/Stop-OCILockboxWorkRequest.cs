...
{
    [Cmdlet("Stop", "OCILockboxWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.LockboxService.Responses.CancelWorkRequestResponse) })]
    public class StopOCILockboxWorkRequest : OCILockboxCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCILockboxWorkRequest", "Stop"))
            {
               return;
            }
