...
{
    [Cmdlet("Disable", "OCIDatabasePluggableDatabaseManagement", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.PluggableDatabase), typeof(Oci.DatabaseService.Responses.DisablePluggableDatabaseManagementResponse) })]
    public class DisableOCIDatabasePluggableDatabaseManagement : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisablePluggableDatabaseManagementRequest
                {
        ...
        private void HandleOutput(DisablePluggableDatabaseManagementRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDisablePluggableDatabaseManagement(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DisablePluggableDatabaseManagement(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.PluggableDatabase);
        }

        private DisablePluggableDatabaseManagementResponse response;
