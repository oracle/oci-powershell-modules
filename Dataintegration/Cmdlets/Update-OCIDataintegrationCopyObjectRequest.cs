...
{
    [Cmdlet("Update", "OCIDataintegrationCopyObjectRequest")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.CopyObjectRequest), typeof(Oci.DataintegrationService.Responses.UpdateCopyObjectRequestResponse) })]
    public class UpdateOCIDataintegrationCopyObjectRequest : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details needed to update the status of a copy object request.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateCopyObjectRequestRequest
                {
                ...
                response = client.UpdateCopyObjectRequest(request).GetAwaiter().GetResult();
        ...
        private UpdateCopyObjectRequestResponse response;
    }
}
