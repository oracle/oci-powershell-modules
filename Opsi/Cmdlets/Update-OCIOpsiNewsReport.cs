...
{
    [Cmdlet("Update", "OCIOpsiNewsReport")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.UpdateNewsReportResponse) })]
    public class UpdateOCIOpsiNewsReport : OCIOperationsInsightsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateNewsReportRequest
                {
                ...
                response = client.UpdateNewsReport(request).GetAwaiter().GetResult();
        ...
        private UpdateNewsReportResponse response;
    }
}
