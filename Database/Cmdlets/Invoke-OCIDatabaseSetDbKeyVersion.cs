...
{
    [Cmdlet("Invoke", "OCIDatabaseSetDbKeyVersion", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Database), typeof(Oci.DatabaseService.Responses.SetDbKeyVersionResponse) })]
    public class InvokeOCIDatabaseSetDbKeyVersion : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SetDbKeyVersionRequest
                {
        ...
        private void HandleOutput(SetDbKeyVersionRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForSetDbKeyVersion(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.SetDbKeyVersion(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.Database);
        }

        private SetDbKeyVersionResponse response;
