...
{
    [Cmdlet("Get", "OCIDatascienceJobShapesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.JobShapeSummary), typeof(Oci.DatascienceService.Responses.ListJobShapesResponse) })]
    public class GetOCIDatascienceJobShapesList : OCIDataScienceCmdlet
    {
...
See [List Pagination](https://docs.oracle.com/iaas/Content/General/Concepts/usingapi.htm#nine).")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListJobShapesRequest
                {
                ...
                IEnumerable<ListJobShapesResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListJobShapesResponse> DefaultRequest(ListJobShapesRequest request) => Enumerable.Repeat(client.ListJobShapes(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListJobShapesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListJobShapesResponse response;
        private delegate IEnumerable<ListJobShapesResponse> RequestDelegate(ListJobShapesRequest request);
