...
{
    [Cmdlet("Remove", "OCIDemandsignalOccDemandSignal", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DemandsignalService.Responses.DeleteOccDemandSignalResponse) })]
    public class RemoveOCIDemandsignalOccDemandSignal : OCIOccDemandSignalCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDemandsignalOccDemandSignal", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteOccDemandSignalRequest
                {
                ...
                response = client.DeleteOccDemandSignal(request).GetAwaiter().GetResult();
        ...
        private DeleteOccDemandSignalResponse response;
    }
}
