...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeHostInsightStorageUsageTrend")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.SummarizeHostInsightStorageUsageTrendAggregationCollection), typeof(Oci.OpsiService.Responses.SummarizeHostInsightStorageUsageTrendResponse) })]
    public class InvokeOCIOpsiSummarizeHostInsightStorageUsageTrend : OCIOperationsInsightsCmdlet
    {
        ...
        public System.Nullable<Oci.OpsiService.Requests.SummarizeHostInsightStorageUsageTrendRequest.StatisticEnum> Statistic { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeHostInsightStorageUsageTrendRequest
                {
                ...
                response = client.SummarizeHostInsightStorageUsageTrend(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SummarizeHostInsightStorageUsageTrendAggregationCollection);
        ...
        private SummarizeHostInsightStorageUsageTrendResponse response;
    }
}
