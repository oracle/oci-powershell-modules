...
{
    [Cmdlet("Get", "OCIGloballydistributeddatabaseWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.GloballydistributeddatabaseService.Models.WorkRequest), typeof(Oci.GloballydistributeddatabaseService.Responses.GetWorkRequestResponse) })]
    public class GetOCIGloballydistributeddatabaseWorkRequest : OCIShardedDatabaseServiceCmdlet
    {
        ...
        public Oci.GloballydistributeddatabaseService.Models.OperationStatus[] WaitForStatus { get; set; }
