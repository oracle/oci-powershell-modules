...
{
    [Cmdlet("Update", "OCICloudguardDetectorRecipe")]
    ...
    public class UpdateOCICloudguardDetectorRecipe : OCICloudGuardCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDetectorRecipeRequest
                {
                ...
                response = client.UpdateDetectorRecipe(request).GetAwaiter().GetResult();
        ...
        private UpdateDetectorRecipeResponse response;
    }
}
