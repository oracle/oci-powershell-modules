...
{
    [Cmdlet("Get", "OCIKeymanagementVaultsList")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.VaultSummary), typeof(Oci.KeymanagementService.Responses.ListVaultsResponse) })]
    public class GetOCIKeymanagementVaultsList : OCIKmsVaultCmdlet
    {
        ...
        public System.Nullable<Oci.KeymanagementService.Requests.ListVaultsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either ascending (`ASC`) or descending (`DESC`).")]
        public System.Nullable<Oci.KeymanagementService.Requests.ListVaultsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListVaultsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListVaultsResponse> DefaultRequest(ListVaultsRequest request) => Enumerable.Repeat(client.ListVaults(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListVaultsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListVaultsResponse response;
        private delegate IEnumerable<ListVaultsResponse> RequestDelegate(ListVaultsRequest request);
