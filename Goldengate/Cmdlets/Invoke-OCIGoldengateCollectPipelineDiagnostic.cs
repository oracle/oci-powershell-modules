...
{
    [Cmdlet("Invoke", "OCIGoldengateCollectPipelineDiagnostic")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.CollectPipelineDiagnosticResponse) })]
    public class InvokeOCIGoldengateCollectPipelineDiagnostic : OCIGoldenGateCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for collecting the diagnostic. It includes the object storage information where the diagnostic will be uploaded.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CollectPipelineDiagnosticRequest
                {
                ...
                response = client.CollectPipelineDiagnostic(request).GetAwaiter().GetResult();
        ...
        private CollectPipelineDiagnosticResponse response;
    }
}
