...
using Oci.AdmService;

namespace Oci.AdmService.Cmdlets
{
    public abstract class OCIApplicationDependencyManagementCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ApplicationDependencyManagementClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ApplicationDependencyManagementClient client;
