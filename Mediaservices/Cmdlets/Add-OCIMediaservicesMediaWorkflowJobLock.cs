...
{
    [Cmdlet("Add", "OCIMediaservicesMediaWorkflowJobLock")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.MediaWorkflowJob), typeof(Oci.MediaservicesService.Responses.AddMediaWorkflowJobLockResponse) })]
    public class AddOCIMediaservicesMediaWorkflowJobLock : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddMediaWorkflowJobLockRequest
                {
                ...
                response = client.AddMediaWorkflowJobLock(request).GetAwaiter().GetResult();
        ...
        private AddMediaWorkflowJobLockResponse response;
    }
}
