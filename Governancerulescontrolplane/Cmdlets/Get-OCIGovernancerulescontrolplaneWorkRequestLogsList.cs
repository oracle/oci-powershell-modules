...
{
    [Cmdlet("Get", "OCIGovernancerulescontrolplaneWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.GovernancerulescontrolplaneService.Models.WorkRequestLogEntryCollection), typeof(Oci.GovernancerulescontrolplaneService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIGovernancerulescontrolplaneWorkRequestLogsList : OCIWorkRequestCmdlet
    {
        ...
        public System.Nullable<Oci.GovernancerulescontrolplaneService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
