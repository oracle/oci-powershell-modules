...
{
    [Cmdlet("Get", "OCIDatabasemanagementManagedMySqlDatabaseConfigurationDataList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.MySqlConfigurationDataCollection), typeof(Oci.DatabasemanagementService.Responses.ListManagedMySqlDatabaseConfigurationDataResponse) })]
    public class GetOCIDatabasemanagementManagedMySqlDatabaseConfigurationDataList : OCIManagedMySqlDatabasesCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListManagedMySqlDatabaseConfigurationDataRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListManagedMySqlDatabaseConfigurationDataResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.MySqlConfigurationDataCollection, true);
                }
        ...
        {
            IEnumerable<ListManagedMySqlDatabaseConfigurationDataResponse> DefaultRequest(ListManagedMySqlDatabaseConfigurationDataRequest request) => Enumerable.Repeat(client.ListManagedMySqlDatabaseConfigurationData(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListManagedMySqlDatabaseConfigurationDataResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListManagedMySqlDatabaseConfigurationDataResponse response;
        private delegate IEnumerable<ListManagedMySqlDatabaseConfigurationDataResponse> RequestDelegate(ListManagedMySqlDatabaseConfigurationDataRequest request);
