...
{
    [Cmdlet("Remove", "OCIIotDigitalTwinModel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IotService.Responses.DeleteDigitalTwinModelResponse) })]
    public class RemoveOCIIotDigitalTwinModel : OCIIotCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIotDigitalTwinModel", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDigitalTwinModelRequest
                {
                ...
                response = client.DeleteDigitalTwinModel(request).GetAwaiter().GetResult();
        ...
        private DeleteDigitalTwinModelResponse response;
    }
}
