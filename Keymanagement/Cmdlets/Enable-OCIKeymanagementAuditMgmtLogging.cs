...
{
    [Cmdlet("Enable", "OCIKeymanagementAuditMgmtLogging")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.EnableAuditMgmtLogging), typeof(Oci.KeymanagementService.Responses.EnableAuditMgmtLoggingResponse) })]
    public class EnableOCIKeymanagementAuditMgmtLogging : OCIKmsHsmClusterCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new EnableAuditMgmtLoggingRequest
                {
                ...
                response = client.EnableAuditMgmtLogging(request).GetAwaiter().GetResult();
                WriteOutput(response, response.EnableAuditMgmtLogging);
        ...
        private EnableAuditMgmtLoggingResponse response;
    }
}
