...
{
    [Cmdlet("Add", "OCIGenerativeaiArtifact")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GenerativeaiService.Responses.AddArtifactResponse) })]
    public class AddOCIGenerativeaiArtifact : OCIGenerativeAiCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new artifact.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddArtifactRequest
                {
                ...
                response = client.AddArtifact(request).GetAwaiter().GetResult();
        ...
        private AddArtifactResponse response;
    }
}
