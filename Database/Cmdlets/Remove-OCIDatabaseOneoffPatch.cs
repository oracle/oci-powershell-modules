...
{
    [Cmdlet("Remove", "OCIDatabaseOneoffPatch", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteOneoffPatchResponse) })]
    public class RemoveOCIDatabaseOneoffPatch : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseOneoffPatch", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteOneoffPatchRequest
                {
        ...
        private void HandleOutput(DeleteOneoffPatchRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteOneoffPatch(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteOneoffPatch(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteOneoffPatchResponse response;
