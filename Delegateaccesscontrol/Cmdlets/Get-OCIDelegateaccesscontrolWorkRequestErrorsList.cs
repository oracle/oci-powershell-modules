...
{
    [Cmdlet("Get", "OCIDelegateaccesscontrolWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.DelegateaccesscontrolService.Models.WorkRequestErrorCollection), typeof(Oci.DelegateaccesscontrolService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIDelegateaccesscontrolWorkRequestErrorsList : OCIWorkRequestCmdlet
    {
        ...
        public System.Nullable<Oci.DelegateaccesscontrolService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }
