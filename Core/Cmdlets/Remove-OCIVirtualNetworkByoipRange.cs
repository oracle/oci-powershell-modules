...
{
    [Cmdlet("Remove", "OCIVirtualNetworkByoipRange", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.DeleteByoipRangeResponse) })]
    public class RemoveOCIVirtualNetworkByoipRange : OCIVirtualNetworkCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIVirtualNetworkByoipRange", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteByoipRangeRequest
                {
        ...
        private void HandleOutput(DeleteByoipRangeRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteByoipRange(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteByoipRange(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteByoipRangeResponse response;
