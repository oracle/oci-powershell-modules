...
{
    [Cmdlet("Get", "OCIKeymanagementPreCoUserCredentials")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.PreCoUserCredentials), typeof(Oci.KeymanagementService.Responses.GetPreCoUserCredentialsResponse) })]
    public class GetOCIKeymanagementPreCoUserCredentials : OCIKmsHsmClusterCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetPreCoUserCredentialsRequest
                {
                ...
                response = client.GetPreCoUserCredentials(request).GetAwaiter().GetResult();
                WriteOutput(response, response.PreCoUserCredentials);
        ...
        private GetPreCoUserCredentialsResponse response;
    }
}
