...
{
    [Cmdlet("Get", "OCIGovernancerulescontrolplaneEnforcedGovernanceRulesList")]
    [OutputType(new System.Type[] { typeof(Oci.GovernancerulescontrolplaneService.Models.EnforcedGovernanceRuleCollection), typeof(Oci.GovernancerulescontrolplaneService.Responses.ListEnforcedGovernanceRulesResponse) })]
    public class GetOCIGovernancerulescontrolplaneEnforcedGovernanceRulesList : OCIGovernanceRuleCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique enforced governance rule identifier.")]
        ...
        public System.Nullable<Oci.GovernancerulescontrolplaneService.Requests.ListEnforcedGovernanceRulesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListEnforcedGovernanceRulesRequest
                {
                ...
                IEnumerable<ListEnforcedGovernanceRulesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.EnforcedGovernanceRuleCollection, true);
                }
        ...
        {
            IEnumerable<ListEnforcedGovernanceRulesResponse> DefaultRequest(ListEnforcedGovernanceRulesRequest request) => Enumerable.Repeat(client.ListEnforcedGovernanceRules(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListEnforcedGovernanceRulesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListEnforcedGovernanceRulesResponse response;
        private delegate IEnumerable<ListEnforcedGovernanceRulesResponse> RequestDelegate(ListEnforcedGovernanceRulesRequest request);
