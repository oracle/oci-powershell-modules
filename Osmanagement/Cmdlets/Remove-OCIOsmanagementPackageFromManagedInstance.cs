...
{
    [Cmdlet("Remove", "OCIOsmanagementPackageFromManagedInstance")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OsmanagementService.Responses.RemovePackageFromManagedInstanceResponse) })]
    public class RemoveOCIOsmanagementPackageFromManagedInstance : OCIOsManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemovePackageFromManagedInstanceRequest
                {
                ...
                response = client.RemovePackageFromManagedInstance(request).GetAwaiter().GetResult();
        ...
        private RemovePackageFromManagedInstanceResponse response;
    }
}
