...
{
    [Cmdlet("Get", "OCIOdaChannel", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.Channel), typeof(Oci.OdaService.Responses.GetChannelResponse) })]
    public class GetOCIOdaChannel : OCIManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique Channel identifier.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique Channel identifier.", ParameterSetName = Default)]
