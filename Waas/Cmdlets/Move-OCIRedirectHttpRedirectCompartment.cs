...
{
    [Cmdlet("Move", "OCIRedirectHttpRedirectCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.WaasService.Responses.ChangeHttpRedirectCompartmentResponse) })]
    public class MoveOCIRedirectHttpRedirectCompartment : OCIRedirectCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeHttpRedirectCompartmentRequest
                {
                ...
                response = client.ChangeHttpRedirectCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeHttpRedirectCompartmentResponse response;
    }
}
