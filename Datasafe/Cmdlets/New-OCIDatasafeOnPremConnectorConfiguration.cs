...
namespace Oci.DatasafeService.Cmdlets
{
     ...
     */
    [Cmdlet("New", "OCIDatasafeOnPremConnectorConfiguration", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatasafeService.Responses.GenerateOnPremConnectorConfigurationResponse) })]
    public class NewOCIDatasafeOnPremConnectorConfiguration : OCIDataSafeCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details used to create and download on-premises connector's configuration.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GenerateOnPremConnectorConfigurationRequest
                {
                ...
                response = client.GenerateOnPremConnectorConfiguration(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GenerateOnPremConnectorConfigurationResponse response;
