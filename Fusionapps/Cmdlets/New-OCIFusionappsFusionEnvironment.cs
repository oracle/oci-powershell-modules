...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class NewOCIFusionappsFusionEnvironment : OCIFusionApplicationsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateFusionEnvironmentRequest
                {
                ...
                response = client.CreateFusionEnvironment(request).GetAwaiter().GetResult();
        ...
        private CreateFusionEnvironmentResponse response;
    }
}
