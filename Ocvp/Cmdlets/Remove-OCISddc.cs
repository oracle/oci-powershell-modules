...
{
    [Cmdlet("Remove", "OCISddc", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCISddc : OCISddcCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCISddc", "Remove"))
            {
               return;
            }
