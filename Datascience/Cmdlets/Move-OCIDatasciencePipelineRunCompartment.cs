...
{
    [Cmdlet("Move", "OCIDatasciencePipelineRunCompartment")]
    ...
    public class MoveOCIDatasciencePipelineRunCompartment : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangePipelineRunCompartmentRequest
                {
                ...
                response = client.ChangePipelineRunCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangePipelineRunCompartmentResponse response;
    }
}
