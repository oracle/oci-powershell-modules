...
{
    [Cmdlet("Update", "OCIWaasWhitelists")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdateWhitelistsResponse) })]
    public class UpdateOCIWaasWhitelists : OCIWaasCmdlet
    {
        ...
        private UpdateWhitelistsResponse response;
    }
}
