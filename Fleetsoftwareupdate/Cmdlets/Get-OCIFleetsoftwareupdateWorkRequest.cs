...
{
    [Cmdlet("Get", "OCIFleetsoftwareupdateWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.FleetsoftwareupdateService.Models.WorkRequest), typeof(Oci.FleetsoftwareupdateService.Responses.GetWorkRequestResponse) })]
    public class GetOCIFleetsoftwareupdateWorkRequest : OCIFleetSoftwareUpdateCmdlet
    {
        ...
        public Oci.FleetsoftwareupdateService.Models.OperationStatus[] WaitForStatus { get; set; }
