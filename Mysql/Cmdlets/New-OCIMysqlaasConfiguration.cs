...
{
    [Cmdlet("New", "OCIMysqlaasConfiguration")]
    [OutputType(new System.Type[] { typeof(Oci.MysqlService.Models.Configuration), typeof(Oci.MysqlService.Responses.CreateConfigurationResponse) })]
    public class NewOCIMysqlaasConfiguration : OCIMysqlaasCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to create a Configuration.")]
