...
{
    [Cmdlet("Remove", "OCIIdentitydomainsMyCustomerSecretKey", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteMyCustomerSecretKeyResponse) })]
    public class RemoveOCIIdentitydomainsMyCustomerSecretKey : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsMyCustomerSecretKey", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteMyCustomerSecretKeyRequest
                {
                ...
                response = client.DeleteMyCustomerSecretKey(request).GetAwaiter().GetResult();
        ...
        private DeleteMyCustomerSecretKeyResponse response;
    }
}
