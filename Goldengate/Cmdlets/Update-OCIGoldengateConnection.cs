...
namespace Oci.GoldengateService.Cmdlets
{
    ...
    public class UpdateOCIGoldengateConnection : OCIGoldenGateCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The new Connection specifications to apply. This parameter also accepts subtypes <Oci.GoldengateService.Models.UpdatePostgresqlConnectionDetails>, <Oci.GoldengateService.Models.UpdateOracleConnectionDetails>, <Oci.GoldengateService.Models.UpdateKafkaSchemaRegistryConnectionDetails>, <Oci.GoldengateService.Models.UpdateOciObjectStorageConnectionDetails>, <Oci.GoldengateService.Models.UpdateMysqlConnectionDetails>, <Oci.GoldengateService.Models.UpdateKafkaConnectionDetails>, <Oci.GoldengateService.Models.UpdateAzureDataLakeStorageConnectionDetails>, <Oci.GoldengateService.Models.UpdateGoldenGateConnectionDetails>, <Oci.GoldengateService.Models.UpdateAzureSynapseConnectionDetails> of type <Oci.GoldengateService.Models.UpdateConnectionDetails>.")]
