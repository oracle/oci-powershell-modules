...
{
    [Cmdlet("Remove", "OCIDatasciencePipelineRun", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatascienceService.Responses.DeletePipelineRunResponse) })]
    public class RemoveOCIDatasciencePipelineRun : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatasciencePipelineRun", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeletePipelineRunRequest
                {
                ...
                response = client.DeletePipelineRun(request).GetAwaiter().GetResult();
        ...
        private DeletePipelineRunResponse response;
    }
}
