...
namespace Oci.DataintegrationService.Cmdlets
{
    ...
    public class NewOCIDataintegrationDataFlowValidation : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information needed to create the data flow validation for the data flow object.")]
