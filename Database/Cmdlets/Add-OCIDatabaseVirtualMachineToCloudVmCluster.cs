...
{
    [Cmdlet("Add", "OCIDatabaseVirtualMachineToCloudVmCluster", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.CloudVmCluster), typeof(Oci.DatabaseService.Responses.AddVirtualMachineToCloudVmClusterResponse) })]
    public class AddOCIDatabaseVirtualMachineToCloudVmCluster : OCIDatabaseCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to add Virtual Machines to the Cloud VM cluster.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to add Virtual Machines to the Cloud VM cluster.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddVirtualMachineToCloudVmClusterRequest
                {
        ...
        private void HandleOutput(AddVirtualMachineToCloudVmClusterRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForAddVirtualMachineToCloudVmCluster(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.AddVirtualMachineToCloudVmCluster(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.CloudVmCluster);
        }

        private AddVirtualMachineToCloudVmClusterResponse response;
