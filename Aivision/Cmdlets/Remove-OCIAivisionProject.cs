...
{
    [Cmdlet("Remove", "OCIAivisionProject", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AivisionService.Responses.DeleteProjectResponse) })]
    public class RemoveOCIAivisionProject : OCIAIServiceVisionCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAivisionProject", "Remove"))
            {
               return;
            }
