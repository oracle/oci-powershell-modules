...
{
    public abstract class OCIOperationsInsightsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OperationsInsightsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OperationsInsightsClient client;
