...
{
    [Cmdlet("Update", "OCIDatabaseConsoleHistory", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.ConsoleHistory), typeof(Oci.DatabaseService.Responses.UpdateConsoleHistoryResponse) })]
    public class UpdateOCIDatabaseConsoleHistory : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the console history.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the console history.", ParameterSetName = Default)]
        public string ConsoleHistoryId { get; set; }

        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to update the specified database node console history.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to update the specified database node console history.", ParameterSetName = Default)]
        ...
        private void HandleOutput(UpdateConsoleHistoryRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateConsoleHistory(request, waiterConfig, WaitForStatus).Execute();
                    break;
        ...
        private UpdateConsoleHistoryResponse response;
