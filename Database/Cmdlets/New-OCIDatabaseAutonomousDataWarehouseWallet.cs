...
namespace Oci.DatabaseService.Cmdlets
{
     ...
     */
    [Cmdlet("New", "OCIDatabaseAutonomousDataWarehouseWallet", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatabaseService.Responses.GenerateAutonomousDataWarehouseWalletResponse) })]
    public class NewOCIDatabaseAutonomousDataWarehouseWallet : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to create a new Autonomous Data Warehouse wallet.")]
        public GenerateAutonomousDataWarehouseWalletDetails GenerateAutonomousDataWarehouseWalletDetails { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GenerateAutonomousDataWarehouseWalletRequest
                {
                ...
                response = client.GenerateAutonomousDataWarehouseWallet(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GenerateAutonomousDataWarehouseWalletResponse response;
