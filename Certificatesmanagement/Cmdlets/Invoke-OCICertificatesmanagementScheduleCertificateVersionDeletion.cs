...
{
    [Cmdlet("Invoke", "OCICertificatesmanagementScheduleCertificateVersionDeletion")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CertificatesmanagementService.Responses.ScheduleCertificateVersionDeletionResponse) })]
    public class InvokeOCICertificatesmanagementScheduleCertificateVersionDeletion : OCICertificatesManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details of the request to delete a certificate version.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ScheduleCertificateVersionDeletionRequest
                {
                ...
                response = client.ScheduleCertificateVersionDeletion(request).GetAwaiter().GetResult();
        ...
        private ScheduleCertificateVersionDeletionResponse response;
    }
}
