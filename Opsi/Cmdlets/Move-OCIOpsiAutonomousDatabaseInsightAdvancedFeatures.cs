...
{
    [Cmdlet("Move", "OCIOpsiAutonomousDatabaseInsightAdvancedFeatures")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.ChangeAutonomousDatabaseInsightAdvancedFeaturesResponse) })]
    public class MoveOCIOpsiAutonomousDatabaseInsightAdvancedFeatures : OCIOperationsInsightsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the advanced features of Autonomous Database in Operations Insights.")]
...
*Note:* Retry tokens can be invalidated before the 24 hour time limit due to conflicting operations, such as a resource being deleted or purged from the system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeAutonomousDatabaseInsightAdvancedFeaturesRequest
                {
                ...
                response = client.ChangeAutonomousDatabaseInsightAdvancedFeatures(request).GetAwaiter().GetResult();
        ...
        private ChangeAutonomousDatabaseInsightAdvancedFeaturesResponse response;
    }
}
