...
{
    [Cmdlet("Get", "OCIDatasafeDiscoveryAnalyticsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.DiscoveryAnalyticsCollection), typeof(Oci.DatasafeService.Responses.ListDiscoveryAnalyticsResponse) })]
    public class GetOCIDatasafeDiscoveryAnalyticsList : OCIDataSafeCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Attribute by which the discovery analytics data should be grouped.")]
        public System.Nullable<Oci.DatasafeService.Requests.ListDiscoveryAnalyticsRequest.GroupByEnum> GroupBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListDiscoveryAnalyticsRequest
                {
                ...
                {
                    response = item;
                    WriteOutput(response, response.DiscoveryAnalyticsCollection, true);
                }
        ...
        {
            IEnumerable<ListDiscoveryAnalyticsResponse> DefaultRequest(ListDiscoveryAnalyticsRequest request) => Enumerable.Repeat(client.ListDiscoveryAnalytics(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListDiscoveryAnalyticsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListDiscoveryAnalyticsResponse response;
        private delegate IEnumerable<ListDiscoveryAnalyticsResponse> RequestDelegate(ListDiscoveryAnalyticsRequest request);
