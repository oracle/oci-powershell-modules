...
{
    [Cmdlet("Stop", "OCICloudguardWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CloudguardService.Responses.CancelWorkRequestResponse) })]
    public class StopOCICloudguardWorkRequest : OCICloudGuardCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCICloudguardWorkRequest", "Stop"))
            {
               return;
            }
