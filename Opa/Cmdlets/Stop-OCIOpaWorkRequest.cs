...
{
    [Cmdlet("Stop", "OCIOpaWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OpaService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIOpaWorkRequest : OCIOpaInstanceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOpaWorkRequest", "Stop"))
            {
               return;
            }
