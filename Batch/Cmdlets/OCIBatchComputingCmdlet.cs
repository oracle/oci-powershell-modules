...
{
    public abstract class OCIBatchComputingCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new BatchComputingClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected BatchComputingClient client;
