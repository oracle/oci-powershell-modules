...
{
    [Cmdlet("Get", "OCIOpensearchWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OpensearchService.Models.WorkRequest), typeof(Oci.OpensearchService.Responses.GetWorkRequestResponse) })]
    public class GetOCIOpensearchWorkRequest : OCIOpensearchClusterCmdlet
    {
        ...
        public Oci.OpensearchService.Models.OperationStatus[] WaitForStatus { get; set; }
