...
{
    [Cmdlet("Get", "OCIManagementagentWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.ManagementagentService.Models.WorkRequest), typeof(Oci.ManagementagentService.Responses.GetWorkRequestResponse) })]
    public class GetOCIManagementagentWorkRequest : OCIManagementAgentCmdlet
    {
        ...
        public Oci.ManagementagentService.Models.OperationStatus[] WaitForStatus { get; set; }
