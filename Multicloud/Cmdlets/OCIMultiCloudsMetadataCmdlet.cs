...
{
    public abstract class OCIMultiCloudsMetadataCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MultiCloudsMetadataClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MultiCloudsMetadataClient client;
