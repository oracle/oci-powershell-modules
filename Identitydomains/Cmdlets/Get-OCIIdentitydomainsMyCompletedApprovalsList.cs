...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyCompletedApprovalsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyCompletedApprovals), typeof(Oci.IdentitydomainsService.Responses.ListMyCompletedApprovalsResponse) })]
    public class GetOCIIdentitydomainsMyCompletedApprovalsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMyCompletedApprovalsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListMyCompletedApprovals(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MyCompletedApprovals);
        ...
        private ListMyCompletedApprovalsResponse response;
    }
}
