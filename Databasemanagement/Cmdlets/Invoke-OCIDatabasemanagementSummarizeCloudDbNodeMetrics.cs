...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementSummarizeCloudDbNodeMetrics")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.MetricsAggregationRangeCollection), typeof(Oci.DatabasemanagementService.Responses.SummarizeCloudDbNodeMetricsResponse) })]
    public class InvokeOCIDatabasemanagementSummarizeCloudDbNodeMetrics : OCIDbManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeCloudDbNodeMetricsRequest
                {
                ...
                response = client.SummarizeCloudDbNodeMetrics(request).GetAwaiter().GetResult();
        ...
        private SummarizeCloudDbNodeMetricsResponse response;
    }
}
