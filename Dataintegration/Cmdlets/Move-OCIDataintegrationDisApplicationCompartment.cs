...
{
    [Cmdlet("Move", "OCIDataintegrationDisApplicationCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DataintegrationService.Responses.ChangeDisApplicationCompartmentResponse) })]
    public class MoveOCIDataintegrationDisApplicationCompartment : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information needed to move a DIS Application to a specified compartment.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeDisApplicationCompartmentRequest
                {
                ...
                response = client.ChangeDisApplicationCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeDisApplicationCompartmentResponse response;
    }
}
