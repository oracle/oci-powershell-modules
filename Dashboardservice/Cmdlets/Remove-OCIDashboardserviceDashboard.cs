...
{
    [Cmdlet("Remove", "OCIDashboardserviceDashboard", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DashboardService.Responses.DeleteDashboardResponse) })]
    public class RemoveOCIDashboardserviceDashboard : OCIDashboardCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDashboardserviceDashboard", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteDashboard(request).GetAwaiter().GetResult();
        ...
        private DeleteDashboardResponse response;
    }
}
