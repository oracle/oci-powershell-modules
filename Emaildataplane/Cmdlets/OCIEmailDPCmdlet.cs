...
using Oci.EmaildataplaneService;

namespace Oci.EmaildataplaneService.Cmdlets
{
    public abstract class OCIEmailDPCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new EmailDPClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected EmailDPClient client;
