...
{
    [Cmdlet("Start", "OCIGoldengatePipeline")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.StartPipelineResponse) })]
    public class StartOCIGoldengatePipeline : OCIGoldenGateCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details to start Pipeline. This parameter also accepts subtype <Oci.GoldengateService.Models.DefaultStartPipelineDetails> of type <Oci.GoldengateService.Models.StartPipelineDetails>.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.StartPipeline(request).GetAwaiter().GetResult();
        ...
        private StartPipelineResponse response;
    }
}
