...
{
    [Cmdlet("Invoke", "OCIDatabaseUnregisterExadbVmClusterPkcs", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.UnregisterExadbVmClusterPkcsResponse) })]
    public class InvokeOCIDatabaseUnregisterExadbVmClusterPkcs : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UnregisterExadbVmClusterPkcsRequest
                {
        ...
        private void HandleOutput(UnregisterExadbVmClusterPkcsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUnregisterExadbVmClusterPkcs(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UnregisterExadbVmClusterPkcs(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private UnregisterExadbVmClusterPkcsResponse response;
