...
{
    [Cmdlet("Get", "OCIServicemeshVirtualServicesList")]
    [OutputType(new System.Type[] { typeof(Oci.ServicemeshService.Models.VirtualServiceCollection), typeof(Oci.ServicemeshService.Responses.ListVirtualServicesResponse) })]
    public class GetOCIServicemeshVirtualServicesList : OCIServiceMeshCmdlet
    {
        ...
        public System.Nullable<Oci.ServicemeshService.Requests.ListVirtualServicesRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.ServicemeshService.Models.VirtualService.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListVirtualServicesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.VirtualServiceCollection, true);
                }
        ...
        {
            IEnumerable<ListVirtualServicesResponse> DefaultRequest(ListVirtualServicesRequest request) => Enumerable.Repeat(client.ListVirtualServices(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListVirtualServicesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListVirtualServicesResponse response;
        private delegate IEnumerable<ListVirtualServicesResponse> RequestDelegate(ListVirtualServicesRequest request);
