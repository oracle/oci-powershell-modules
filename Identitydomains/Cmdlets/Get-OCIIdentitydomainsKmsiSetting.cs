...
{
    [Cmdlet("Get", "OCIIdentitydomainsKmsiSetting")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.KmsiSetting), typeof(Oci.IdentitydomainsService.Responses.GetKmsiSettingResponse) })]
    public class GetOCIIdentitydomainsKmsiSetting : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetKmsiSettingRequest
                {
                ...
                response = client.GetKmsiSetting(request).GetAwaiter().GetResult();
        ...
        private GetKmsiSettingResponse response;
    }
}
