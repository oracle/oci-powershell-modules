...
{
    [Cmdlet("Remove", "OCIIdentitydomainsAuthToken", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteAuthTokenResponse) })]
    public class RemoveOCIIdentitydomainsAuthToken : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsAuthToken", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteAuthToken(request).GetAwaiter().GetResult();
        ...
        private DeleteAuthTokenResponse response;
    }
}
