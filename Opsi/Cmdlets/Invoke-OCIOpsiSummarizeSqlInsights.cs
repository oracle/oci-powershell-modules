...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeSqlInsights")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.SqlInsightAggregationCollection), typeof(Oci.OpsiService.Responses.SummarizeSqlInsightsResponse) })]
    public class InvokeOCIOpsiSummarizeSqlInsights : OCIOperationsInsightsCmdlet
    {
        ...
        public System.Collections.Generic.List<Oci.OpsiService.Requests.SummarizeSqlInsightsRequest.DatabaseTypeEnum> DatabaseType { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeSqlInsightsRequest
                {
                ...
                response = client.SummarizeSqlInsights(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SqlInsightAggregationCollection);
        ...
        private SummarizeSqlInsightsResponse response;
    }
}
