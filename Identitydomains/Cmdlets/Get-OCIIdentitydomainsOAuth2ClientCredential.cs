...
{
    [Cmdlet("Get", "OCIIdentitydomainsOAuth2ClientCredential")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.OAuth2ClientCredential), typeof(Oci.IdentitydomainsService.Responses.GetOAuth2ClientCredentialResponse) })]
    public class GetOCIIdentitydomainsOAuth2ClientCredential : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOAuth2ClientCredentialRequest
                {
                ...
                response = client.GetOAuth2ClientCredential(request).GetAwaiter().GetResult();
        ...
        private GetOAuth2ClientCredentialResponse response;
    }
}
