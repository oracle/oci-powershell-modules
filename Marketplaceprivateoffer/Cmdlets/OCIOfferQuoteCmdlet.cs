...
{
    public abstract class OCIOfferQuoteCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OfferQuoteClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OfferQuoteClient client;
