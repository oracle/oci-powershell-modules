...
{
    [Cmdlet("Get", "OCIMarketplacePackage")]
    [OutputType(new System.Type[] { typeof(Oci.MarketplaceService.Models.ListingPackage), typeof(Oci.MarketplaceService.Responses.GetPackageResponse) })]
    public class GetOCIMarketplacePackage : OCIMarketplaceCmdlet
    {
