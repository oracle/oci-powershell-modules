...
{
    [Cmdlet("Stop", "OCIMysqlBackupDeletion")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.CancelBackupDeletionResponse) })]
    public class StopOCIMysqlBackupDeletion : OCIDbBackupsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelBackupDeletionRequest
                {
                    BackupId = BackupId,
                    IfMatch = IfMatch,
                ...
                response = client.CancelBackupDeletion(request).GetAwaiter().GetResult();
        ...
        private CancelBackupDeletionResponse response;
    }
}
