...
{
    [Cmdlet("Invoke", "OCIDatabaseFailoverAutonomousContainerDatabaseDataguard", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousContainerDatabase), typeof(Oci.DatabaseService.Responses.FailoverAutonomousContainerDatabaseDataguardResponse) })]
    public class InvokeOCIDatabaseFailoverAutonomousContainerDatabaseDataguard : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new FailoverAutonomousContainerDatabaseDataguardRequest
                {
        ...
        private void HandleOutput(FailoverAutonomousContainerDatabaseDataguardRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForFailoverAutonomousContainerDatabaseDataguard(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.FailoverAutonomousContainerDatabaseDataguard(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousContainerDatabase);
        }

        private FailoverAutonomousContainerDatabaseDataguardResponse response;
