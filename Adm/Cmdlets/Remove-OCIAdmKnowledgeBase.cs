...
{
    [Cmdlet("Remove", "OCIAdmKnowledgeBase", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AdmService.Responses.DeleteKnowledgeBaseResponse) })]
    public class RemoveOCIAdmKnowledgeBase : OCIApplicationDependencyManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAdmKnowledgeBase", "Remove"))
            {
               return;
            }
