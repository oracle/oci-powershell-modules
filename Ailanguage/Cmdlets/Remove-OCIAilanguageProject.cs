...
{
    [Cmdlet("Remove", "OCIAilanguageProject", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AilanguageService.Responses.DeleteProjectResponse) })]
    public class RemoveOCIAilanguageProject : OCIAIServiceLanguageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAilanguageProject", "Remove"))
            {
               return;
            }
