...
{
    [Cmdlet("Update", "OCIWaasAccessRules")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdateAccessRulesResponse) })]
    public class UpdateOCIWaasAccessRules : OCIWaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateAccessRulesRequest
                {
                ...
                response = client.UpdateAccessRules(request).GetAwaiter().GetResult();
        ...
        private UpdateAccessRulesResponse response;
    }
}
