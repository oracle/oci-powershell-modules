...
{
    [Cmdlet("DisMount", "OCIRedisOciCacheUsers")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.RedisService.Responses.DetachOciCacheUsersResponse) })]
    public class DisMountOCIRedisOciCacheUsers : OCIRedisClusterCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The parameter details to detach the OCI cache users to the redis cluster.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DetachOciCacheUsersRequest
                {
                ...
                response = client.DetachOciCacheUsers(request).GetAwaiter().GetResult();
        ...
        private DetachOciCacheUsersResponse response;
    }
}
