...
{
    [Cmdlet("Invoke", "OCICloudguardSkipBulkResponderExecution")]
    ...
    public class InvokeOCICloudguardSkipBulkResponderExecution : OCICloudGuardCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SkipBulkResponderExecutionRequest
                {
                    SkipBulkResponderExecutionDetails = SkipBulkResponderExecutionDetails,
                    OpcRequestId = OpcRequestId
                };

                response = client.SkipBulkResponderExecution(request).GetAwaiter().GetResult();
        ...
        private SkipBulkResponderExecutionResponse response;
    }
}
