...
{
    [Cmdlet("New", "OCIGenerativeaiEndpoint")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.Endpoint), typeof(Oci.GenerativeaiService.Responses.CreateEndpointResponse) })]
    public class NewOCIGenerativeaiEndpoint : OCIGenerativeAiCmdlet
    {
