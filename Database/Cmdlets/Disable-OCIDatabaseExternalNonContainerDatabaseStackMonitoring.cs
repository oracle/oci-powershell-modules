...
{
    [Cmdlet("Disable", "OCIDatabaseExternalNonContainerDatabaseStackMonitoring", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DisableExternalNonContainerDatabaseStackMonitoringResponse) })]
    public class DisableOCIDatabaseExternalNonContainerDatabaseStackMonitoring : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableExternalNonContainerDatabaseStackMonitoringRequest
                {
        ...
        private void HandleOutput(DisableExternalNonContainerDatabaseStackMonitoringRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDisableExternalNonContainerDatabaseStackMonitoring(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DisableExternalNonContainerDatabaseStackMonitoring(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DisableExternalNonContainerDatabaseStackMonitoringResponse response;
