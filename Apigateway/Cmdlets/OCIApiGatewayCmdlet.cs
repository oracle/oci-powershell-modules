...
{
    public abstract class OCIApiGatewayCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ApiGatewayClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ApiGatewayClient client;
