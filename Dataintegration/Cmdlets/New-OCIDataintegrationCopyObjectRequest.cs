...
{
    [Cmdlet("New", "OCIDataintegrationCopyObjectRequest")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.CopyObjectRequest), typeof(Oci.DataintegrationService.Responses.CreateCopyObjectRequestResponse) })]
    public class NewOCIDataintegrationCopyObjectRequest : OCIDataIntegrationCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The workspace ID.")]
        public string WorkspaceId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details needed to copy metadata object.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateCopyObjectRequestRequest
                {
                ...
                response = client.CreateCopyObjectRequest(request).GetAwaiter().GetResult();
        ...
        private CreateCopyObjectRequestResponse response;
    }
}
