...
CmdletsToExport = 'Invoke-OCIAivisionAnalyzeDocument', 
               'Invoke-OCIAivisionAnalyzeImage', 'Stop-OCIAivisionDocumentJob', 
               ...
               'Remove-OCIAivisionProject', 'Get-OCIAivisionDocumentJob', 
               'Get-OCIAivisionImageJob', 'Get-OCIAivisionModel', 
               'Get-OCIAivisionProject', 'Get-OCIAivisionWorkRequest', 
               'Get-OCIAivisionModelsList', 'Get-OCIAivisionProjectsList', 
               'Get-OCIAivisionWorkRequestErrorsList', 
               'Get-OCIAivisionWorkRequestLogsList', 
               'Get-OCIAivisionWorkRequestsList', 'Update-OCIAivisionModel', 
               'Update-OCIAivisionProject'
