...
{
    [Cmdlet("Get", "OCIKeymanagementHsmCluster", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.HsmCluster), typeof(Oci.KeymanagementService.Responses.GetHsmClusterResponse) })]
    public class GetOCIKeymanagementHsmCluster : OCIKmsHsmClusterCmdlet
    {
        ...
        public Oci.KeymanagementService.Models.HsmCluster.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetHsmClusterRequest
                {
        ...
        private void HandleOutput(GetHsmClusterRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForHsmCluster(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetHsmCluster(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.HsmCluster);
        }

        private GetHsmClusterResponse response;
