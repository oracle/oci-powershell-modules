...
{
    [Cmdlet("Get", "OCIIdentitydomainsSmtpCredentialsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SmtpCredentials), typeof(Oci.IdentitydomainsService.Responses.ListSmtpCredentialsResponse) })]
    public class GetOCIIdentitydomainsSmtpCredentialsList : OCIIdentityDomainsCmdlet
    {
