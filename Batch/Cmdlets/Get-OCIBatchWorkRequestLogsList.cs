...
{
    [Cmdlet("Get", "OCIBatchWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.BatchService.Models.WorkRequestLogEntryCollection), typeof(Oci.BatchService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIBatchWorkRequestLogsList : OCIBatchComputingCmdlet
    {
