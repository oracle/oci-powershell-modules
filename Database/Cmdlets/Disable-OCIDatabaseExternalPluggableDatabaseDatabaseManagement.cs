...
{
    [Cmdlet("Disable", "OCIDatabaseExternalPluggableDatabaseDatabaseManagement", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DisableExternalPluggableDatabaseDatabaseManagementResponse) })]
    public class DisableOCIDatabaseExternalPluggableDatabaseDatabaseManagement : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableExternalPluggableDatabaseDatabaseManagementRequest
                {
        ...
        private void HandleOutput(DisableExternalPluggableDatabaseDatabaseManagementRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDisableExternalPluggableDatabaseDatabaseManagement(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DisableExternalPluggableDatabaseDatabaseManagement(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DisableExternalPluggableDatabaseDatabaseManagementResponse response;
