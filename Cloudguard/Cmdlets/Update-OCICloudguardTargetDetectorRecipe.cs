...
{
    [Cmdlet("Update", "OCICloudguardTargetDetectorRecipe")]
    [OutputType(new System.Type[] { typeof(Oci.CloudguardService.Models.TargetDetectorRecipe), typeof(Oci.CloudguardService.Responses.UpdateTargetDetectorRecipeResponse) })]
    public class UpdateOCICloudguardTargetDetectorRecipe : OCICloudGuardCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateTargetDetectorRecipeRequest
                {
                    TargetId = TargetId,
                ...
                response = client.UpdateTargetDetectorRecipe(request).GetAwaiter().GetResult();
        ...
        private UpdateTargetDetectorRecipeResponse response;
    }
}
