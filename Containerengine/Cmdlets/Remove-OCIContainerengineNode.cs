...
{
    [Cmdlet("Remove", "OCIContainerengineNode", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ContainerengineService.Responses.DeleteNodeResponse) })]
    public class RemoveOCIContainerengineNode : OCIContainerEngineCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"If the nodepool should be scaled down after the node is deleted.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIContainerengineNode", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteNode(request).GetAwaiter().GetResult();
        ...
        private DeleteNodeResponse response;
    }
}
