...
using Oci.TenantmanagercontrolplaneService;

namespace Oci.TenantmanagercontrolplaneService.Cmdlets
{
    public abstract class OCIRecipientInvitationCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new RecipientInvitationClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected RecipientInvitationClient client;
