...
{
    public abstract class OCIDatabaseToolsRuntimeCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DatabaseToolsRuntimeClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DatabaseToolsRuntimeClient client;
