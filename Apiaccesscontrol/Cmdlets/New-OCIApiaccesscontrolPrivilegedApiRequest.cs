...
{
    [Cmdlet("New", "OCIApiaccesscontrolPrivilegedApiRequest")]
    [OutputType(new System.Type[] { typeof(Oci.ApiaccesscontrolService.Models.PrivilegedApiRequest), typeof(Oci.ApiaccesscontrolService.Responses.CreatePrivilegedApiRequestResponse) })]
    public class NewOCIApiaccesscontrolPrivilegedApiRequest : OCIPrivilegedApiRequestsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new PrivilegedApiRequest.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreatePrivilegedApiRequestRequest
                {
                ...
                response = client.CreatePrivilegedApiRequest(request).GetAwaiter().GetResult();
        ...
        private CreatePrivilegedApiRequestResponse response;
    }
}
