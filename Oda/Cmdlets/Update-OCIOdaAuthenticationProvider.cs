...
{
    [Cmdlet("Update", "OCIOdaAuthenticationProvider")]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.AuthenticationProvider), typeof(Oci.OdaService.Responses.UpdateAuthenticationProviderResponse) })]
    public class UpdateOCIOdaAuthenticationProvider : OCIManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Property values to update the Authentication Provider.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateAuthenticationProviderRequest
                {
                ...
                response = client.UpdateAuthenticationProvider(request).GetAwaiter().GetResult();
        ...
        private UpdateAuthenticationProviderResponse response;
    }
}
