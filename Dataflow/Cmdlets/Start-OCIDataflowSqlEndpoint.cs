...
{
    [Cmdlet("Start", "OCIDataflowSqlEndpoint")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DataflowService.Responses.StartSqlEndpointResponse) })]
    public class StartOCIDataflowSqlEndpoint : OCIDataFlowCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartSqlEndpointRequest
                {
                ...
                response = client.StartSqlEndpoint(request).GetAwaiter().GetResult();
        ...
        private StartSqlEndpointResponse response;
    }
}
