...
{
    [Cmdlet("Get", "OCIBastionSession", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.BastionService.Models.Session), typeof(Oci.BastionService.Responses.GetSessionResponse) })]
    public class GetOCIBastionSession : OCIBastionCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique identifier (OCID) of the session.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique identifier (OCID) of the session.", ParameterSetName = Default)]
        ...
        public Oci.BastionService.Models.SessionLifecycleState[] WaitForLifecycleState { get; set; }
