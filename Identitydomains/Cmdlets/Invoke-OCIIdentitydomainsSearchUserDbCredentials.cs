...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchUserDbCredentials")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.UserDbCredentials), typeof(Oci.IdentitydomainsService.Responses.SearchUserDbCredentialsResponse) })]
    public class InvokeOCIIdentitydomainsSearchUserDbCredentials : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching UserDbCredentials")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchUserDbCredentialsRequest
                {
                ...
                response = client.SearchUserDbCredentials(request).GetAwaiter().GetResult();
                WriteOutput(response, response.UserDbCredentials);
        ...
        private SearchUserDbCredentialsResponse response;
    }
}
