...
{
    [Cmdlet("Remove", "OCIRedisCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.RedisService.Responses.DeleteRedisClusterResponse) })]
    public class RemoveOCIRedisCluster : OCIRedisClusterCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIRedisCluster", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteRedisClusterRequest
                {
                ...
                response = client.DeleteRedisCluster(request).GetAwaiter().GetResult();
        ...
        private DeleteRedisClusterResponse response;
    }
}
