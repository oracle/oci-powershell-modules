...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementFetchSqlTuningSet")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.SqlTuningSet), typeof(Oci.DatabasemanagementService.Responses.FetchSqlTuningSetResponse) })]
    public class InvokeOCIDatabasemanagementFetchSqlTuningSet : OCISqlTuningCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details required to fetch the Sql tuning set details.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new FetchSqlTuningSetRequest
                {
                ...
                response = client.FetchSqlTuningSet(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SqlTuningSet);
        ...
        private FetchSqlTuningSetResponse response;
    }
}
