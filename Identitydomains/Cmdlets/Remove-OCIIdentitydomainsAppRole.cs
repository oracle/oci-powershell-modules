...
{
    [Cmdlet("Remove", "OCIIdentitydomainsAppRole", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteAppRoleResponse) })]
    public class RemoveOCIIdentitydomainsAppRole : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsAppRole", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteAppRoleRequest
                {
                    AppRoleId = AppRoleId,
                ...
                response = client.DeleteAppRole(request).GetAwaiter().GetResult();
        ...
        private DeleteAppRoleResponse response;
    }
}
