...
{
    public abstract class OCIOciCacheEngineOptionsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OciCacheEngineOptionsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OciCacheEngineOptionsClient client;
