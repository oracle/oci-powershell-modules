...
{
    [Cmdlet("New", "OCIDatabaseBackup", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Backup), typeof(Oci.DatabaseService.Responses.CreateBackupResponse) })]
    public class NewOCIDatabaseBackup : OCIDatabaseCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to create a new database backup.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to create a new database backup.", ParameterSetName = Default)]
