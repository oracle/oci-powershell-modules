...
{
    [Cmdlet("Stop", "OCIVaultSecretRotation")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.VaultService.Responses.CancelSecretRotationResponse) })]
    public class StopOCIVaultSecretRotation : OCIVaultsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelSecretRotationRequest
                {
                    SecretId = SecretId,
                    IfMatch = IfMatch,
                ...
                response = client.CancelSecretRotation(request).GetAwaiter().GetResult();
        ...
        private CancelSecretRotationResponse response;
    }
}
