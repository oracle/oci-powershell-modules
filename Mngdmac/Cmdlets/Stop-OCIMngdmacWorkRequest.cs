...
{
    [Cmdlet("Stop", "OCIMngdmacWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.MngdmacService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIMngdmacWorkRequest : OCIMacOrderCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIMngdmacWorkRequest", "Stop"))
            {
               return;
            }
