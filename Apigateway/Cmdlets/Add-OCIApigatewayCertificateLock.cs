...
{
    [Cmdlet("Add", "OCIApigatewayCertificateLock")]
    [OutputType(new System.Type[] { typeof(Oci.ApigatewayService.Models.Certificate), typeof(Oci.ApigatewayService.Responses.AddCertificateLockResponse) })]
    public class AddOCIApigatewayCertificateLock : OCIApiGatewayCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddCertificateLockRequest
                {
                ...
                response = client.AddCertificateLock(request).GetAwaiter().GetResult();
        ...
        private AddCertificateLockResponse response;
    }
}
