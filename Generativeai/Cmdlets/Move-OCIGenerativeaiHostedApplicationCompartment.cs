...
{
    [Cmdlet("Move", "OCIGenerativeaiHostedApplicationCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.GenerativeaiService.Responses.ChangeHostedApplicationCompartmentResponse) })]
    public class MoveOCIGenerativeaiHostedApplicationCompartment : OCIGenerativeAiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeHostedApplicationCompartmentRequest
                {
                ...
                response = client.ChangeHostedApplicationCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeHostedApplicationCompartmentResponse response;
    }
}
