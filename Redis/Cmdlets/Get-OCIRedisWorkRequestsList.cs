...
{
    [Cmdlet("Get", "OCIRedisWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.RedisService.Models.WorkRequestSummaryCollection), typeof(Oci.RedisService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIRedisWorkRequestsList : OCIRedisClusterCmdlet
    {
        ...
        public System.Nullable<Oci.RedisService.Models.OperationStatus> Status { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm#Oracle) of the resource affected by the work request.")]
        ...
        public System.Nullable<Oci.RedisService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }
