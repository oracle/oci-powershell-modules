...
{
    [Cmdlet("Remove", "OCIEmailSenderLock")]
    [OutputType(new System.Type[] { typeof(Oci.EmailService.Models.Sender), typeof(Oci.EmailService.Responses.RemoveSenderLockResponse) })]
    public class RemoveOCIEmailSenderLock : OCIEmailCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveSenderLockRequest
                {
                    SenderId = SenderId,
                ...
                response = client.RemoveSenderLock(request).GetAwaiter().GetResult();
        ...
        private RemoveSenderLockResponse response;
    }
}
