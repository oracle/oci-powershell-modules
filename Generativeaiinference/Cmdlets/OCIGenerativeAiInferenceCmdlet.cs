...
{
    public abstract class OCIGenerativeAiInferenceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new GenerativeAiInferenceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected GenerativeAiInferenceClient client;
