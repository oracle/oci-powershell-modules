...
{
    [Cmdlet("Get", "OCIDatasafeUnifiedAuditPoliciesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.UnifiedAuditPolicyCollection), typeof(Oci.DatasafeService.Responses.ListUnifiedAuditPoliciesResponse) })]
    public class GetOCIDatasafeUnifiedAuditPoliciesList : OCIDataSafeCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The current state of the Unified Audit policy.")]
        public System.Nullable<Oci.DatasafeService.Models.UnifiedAuditPolicyLifecycleState> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListUnifiedAuditPoliciesRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A boolean flag indicating to list seeded unified audit policies. Set this parameter to get list of seeded unified audit policies.")]
...
**Example:** 2016-12-19T16:39:57.600Z")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"An optional filter to return only resources that match the specified OCID of the Unified Audit policy resource.")]
        public string UnifiedAuditPolicyId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either ascending (ASC) or descending (DESC).")]
        public System.Nullable<Oci.DatasafeService.Requests.ListUnifiedAuditPoliciesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListUnifiedAuditPoliciesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListUnifiedAuditPoliciesRequest
                {
                ...
                IEnumerable<ListUnifiedAuditPoliciesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.UnifiedAuditPolicyCollection, true);
                }
        ...
        {
            IEnumerable<ListUnifiedAuditPoliciesResponse> DefaultRequest(ListUnifiedAuditPoliciesRequest request) => Enumerable.Repeat(client.ListUnifiedAuditPolicies(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListUnifiedAuditPoliciesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListUnifiedAuditPoliciesResponse response;
        private delegate IEnumerable<ListUnifiedAuditPoliciesResponse> RequestDelegate(ListUnifiedAuditPoliciesRequest request);
