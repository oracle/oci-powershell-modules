...
{
    [Cmdlet("Update", "OCIAilanguageEndpoint")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AilanguageService.Responses.UpdateEndpointResponse) })]
    public class UpdateOCIAilanguageEndpoint : OCIAIServiceLanguageCmdlet
    {
