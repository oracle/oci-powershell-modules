...
{
    [Cmdlet("Get", "OCIClusterplacementgroupsWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.ClusterplacementgroupsService.Models.WorkRequestLogEntryCollection), typeof(Oci.ClusterplacementgroupsService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIClusterplacementgroupsWorkRequestLogsList : OCIClusterPlacementGroupsCPCmdlet
    {
        ...
        public System.Nullable<Oci.ClusterplacementgroupsService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
