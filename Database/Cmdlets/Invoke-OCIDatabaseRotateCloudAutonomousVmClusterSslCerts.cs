...
{
    [Cmdlet("Invoke", "OCIDatabaseRotateCloudAutonomousVmClusterSslCerts", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.RotateCloudAutonomousVmClusterSslCertsResponse) })]
    public class InvokeOCIDatabaseRotateCloudAutonomousVmClusterSslCerts : OCIDatabaseCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The Cloud VM cluster [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm).", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The Cloud VM cluster [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm).", ParameterSetName = Default)]
        public string CloudAutonomousVmClusterId { get; set; }

        
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to rotate the SSL certificates on Cloud Autonomous Exadata VM cluster.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to rotate the SSL certificates on Cloud Autonomous Exadata VM cluster.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RotateCloudAutonomousVmClusterSslCertsRequest
                {
        ...
        private void HandleOutput(RotateCloudAutonomousVmClusterSslCertsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRotateCloudAutonomousVmClusterSslCerts(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RotateCloudAutonomousVmClusterSslCerts(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private RotateCloudAutonomousVmClusterSslCertsResponse response;
