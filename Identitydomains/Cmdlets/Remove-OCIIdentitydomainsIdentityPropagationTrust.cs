...
{
    [Cmdlet("Remove", "OCIIdentitydomainsIdentityPropagationTrust", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteIdentityPropagationTrustResponse) })]
    public class RemoveOCIIdentitydomainsIdentityPropagationTrust : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsIdentityPropagationTrust", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteIdentityPropagationTrustRequest
                {
                ...
                response = client.DeleteIdentityPropagationTrust(request).GetAwaiter().GetResult();
        ...
        private DeleteIdentityPropagationTrustResponse response;
    }
}
