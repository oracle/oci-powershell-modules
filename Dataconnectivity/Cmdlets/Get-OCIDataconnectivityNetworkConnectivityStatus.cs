...
{
    [Cmdlet("Get", "OCIDataconnectivityNetworkConnectivityStatus")]
    [OutputType(new System.Type[] { typeof(Oci.DataconnectivityService.Models.NetworkConnectivityStatus), typeof(Oci.DataconnectivityService.Responses.GetNetworkConnectivityStatusResponse) })]
    public class GetOCIDataconnectivityNetworkConnectivityStatus : OCIDataConnectivityManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetNetworkConnectivityStatusRequest
                {
                ...
                response = client.GetNetworkConnectivityStatus(request).GetAwaiter().GetResult();
                WriteOutput(response, response.NetworkConnectivityStatus);
        ...
        private GetNetworkConnectivityStatusResponse response;
    }
}
