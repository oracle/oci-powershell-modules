...
{
    [Cmdlet("Update", "OCIDataintegrationSchedule")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.Schedule), typeof(Oci.DataintegrationService.Responses.UpdateScheduleResponse) })]
    public class UpdateOCIDataintegrationSchedule : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request body parameter for Schedule details")]
