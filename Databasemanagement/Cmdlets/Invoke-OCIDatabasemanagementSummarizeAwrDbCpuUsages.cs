...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementSummarizeAwrDbCpuUsages")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.AwrDbCpuUsageCollection), typeof(Oci.DatabasemanagementService.Responses.SummarizeAwrDbCpuUsagesResponse) })]
    public class InvokeOCIDatabasemanagementSummarizeAwrDbCpuUsages : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.SummarizeAwrDbCpuUsagesRequest.SessionTypeEnum> SessionType { get; set; }
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.SummarizeAwrDbCpuUsagesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeAwrDbCpuUsagesRequest
                {
                ...
                response = client.SummarizeAwrDbCpuUsages(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AwrDbCpuUsageCollection);
        ...
        private SummarizeAwrDbCpuUsagesResponse response;
    }
}
