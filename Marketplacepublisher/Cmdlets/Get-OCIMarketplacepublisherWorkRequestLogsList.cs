...
{
    [Cmdlet("Get", "OCIMarketplacepublisherWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.MarketplacepublisherService.Models.WorkRequestLogEntryCollection), typeof(Oci.MarketplacepublisherService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIMarketplacepublisherWorkRequestLogsList : OCIMarketplacePublisherCmdlet
    {
        ...
        public System.Nullable<Oci.MarketplacepublisherService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
