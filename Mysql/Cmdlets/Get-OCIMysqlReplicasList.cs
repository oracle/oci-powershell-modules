...
namespace Oci.MysqlService.Cmdlets
{
    ...
    public class GetOCIMysqlReplicasList : OCIReplicasCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The DB System [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm).")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The read replica [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm).")]
