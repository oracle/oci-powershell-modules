...
{
    [Cmdlet("Invoke", "OCIDatabaseTerminateAutonomousContainerDatabase", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.TerminateAutonomousContainerDatabaseResponse) })]
    public class InvokeOCIDatabaseTerminateAutonomousContainerDatabase : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseTerminateAutonomousContainerDatabase", "Invoke"))
            {
               return;
            }
            ...
            try
            {
                request = new TerminateAutonomousContainerDatabaseRequest
                {
        ...
        private TerminateAutonomousContainerDatabaseResponse response;
