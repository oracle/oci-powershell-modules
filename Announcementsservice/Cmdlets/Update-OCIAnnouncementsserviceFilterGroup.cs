...
{
    [Cmdlet("Update", "OCIAnnouncementsserviceFilterGroup")]
    [OutputType(new System.Type[] { typeof(Oci.AnnouncementsService.Models.FilterGroup), typeof(Oci.AnnouncementsService.Responses.UpdateFilterGroupResponse) })]
    public class UpdateOCIAnnouncementsserviceFilterGroup : OCIAnnouncementSubscriptionCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The filter group information to update.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateFilterGroupRequest
                {
                ...
                response = client.UpdateFilterGroup(request).GetAwaiter().GetResult();
        ...
        private UpdateFilterGroupResponse response;
    }
}
