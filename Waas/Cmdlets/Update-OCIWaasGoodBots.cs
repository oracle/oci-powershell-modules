...
{
    [Cmdlet("Update", "OCIWaasGoodBots")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdateGoodBotsResponse) })]
    public class UpdateOCIWaasGoodBots : OCIWaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateGoodBotsRequest
                {
                ...
                response = client.UpdateGoodBots(request).GetAwaiter().GetResult();
        ...
        private UpdateGoodBotsResponse response;
    }
}
