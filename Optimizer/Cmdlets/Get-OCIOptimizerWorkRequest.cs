...
{
    [Cmdlet("Get", "OCIOptimizerWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OptimizerService.Models.WorkRequest), typeof(Oci.OptimizerService.Responses.GetWorkRequestResponse) })]
    public class GetOCIOptimizerWorkRequest : OCIOptimizerCmdlet
    {
        ...
        public Oci.OptimizerService.Models.OperationStatus[] WaitForStatus { get; set; }
