...
{
    [Cmdlet("Get", "OCIDistributeddatabaseWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.DistributeddatabaseService.Models.WorkRequestLogEntryCollection), typeof(Oci.DistributeddatabaseService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIDistributeddatabaseWorkRequestLogsList : OCIDistributedDbWorkRequestServiceCmdlet
    {
        ...
        public System.Nullable<Oci.DistributeddatabaseService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
