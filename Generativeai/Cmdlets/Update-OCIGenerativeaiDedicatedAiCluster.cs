...
{
    [Cmdlet("Update", "OCIGenerativeaiDedicatedAiCluster")]
    ...
    public class UpdateOCIGenerativeaiDedicatedAiCluster : OCIGenerativeAiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDedicatedAiClusterRequest
                {
                ...
                response = client.UpdateDedicatedAiCluster(request).GetAwaiter().GetResult();
        ...
        private UpdateDedicatedAiClusterResponse response;
    }
}
