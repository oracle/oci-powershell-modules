...
{
    [Cmdlet("New", "OCIDbmulticloudOracleDbAwsKey")]
    [OutputType(new System.Type[] { typeof(Oci.DbmulticloudService.Models.OracleDbAwsKey), typeof(Oci.DbmulticloudService.Responses.CreateOracleDbAwsKeyResponse) })]
    public class NewOCIDbmulticloudOracleDbAwsKey : OCIDbMulticloudAwsProviderCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for to create AWS Key details.")]
...
For example, if a resource has been deleted and permanently purged from the system, a retry of the original creation request may be rejected.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateOracleDbAwsKeyRequest
                {
                ...
                response = client.CreateOracleDbAwsKey(request).GetAwaiter().GetResult();
        ...
        private CreateOracleDbAwsKeyResponse response;
    }
}
