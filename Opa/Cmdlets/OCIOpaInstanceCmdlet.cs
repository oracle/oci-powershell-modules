...
using Oci.OpaService;

namespace Oci.OpaService.Cmdlets
{
    public abstract class OCIOpaInstanceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OpaInstanceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OpaInstanceClient client;
