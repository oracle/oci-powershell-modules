...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyPendingApprovalsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyPendingApprovals), typeof(Oci.IdentitydomainsService.Responses.ListMyPendingApprovalsResponse) })]
    public class GetOCIIdentitydomainsMyPendingApprovalsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMyPendingApprovalsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListMyPendingApprovals(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MyPendingApprovals);
        ...
        private ListMyPendingApprovalsResponse response;
    }
}
