...
{
    [Cmdlet("Update", "OCICloudbridgeAgent")]
    [OutputType(new System.Type[] { typeof(Oci.CloudbridgeService.Models.Agent), typeof(Oci.CloudbridgeService.Responses.UpdateAgentResponse) })]
    public class UpdateOCICloudbridgeAgent : OCIOcbAgentSvcCmdlet
    {
