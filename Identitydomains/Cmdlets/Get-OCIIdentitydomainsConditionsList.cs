...
{
    [Cmdlet("Get", "OCIIdentitydomainsConditionsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Conditions), typeof(Oci.IdentitydomainsService.Responses.ListConditionsResponse) })]
    public class GetOCIIdentitydomainsConditionsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListConditionsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListConditions(request).GetAwaiter().GetResult();
        ...
        private ListConditionsResponse response;
    }
}
