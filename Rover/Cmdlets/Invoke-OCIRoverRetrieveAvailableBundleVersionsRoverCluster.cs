...
{
    [Cmdlet("Invoke", "OCIRoverRetrieveAvailableBundleVersionsRoverCluster")]
    [OutputType(new System.Type[] { typeof(Oci.RoverService.Models.RoverBundleVersion), typeof(Oci.RoverService.Responses.RetrieveAvailableBundleVersionsRoverClusterResponse) })]
    public class InvokeOCIRoverRetrieveAvailableBundleVersionsRoverCluster : OCIRoverBundleCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RetrieveAvailableBundleVersionsRoverClusterRequest
                {
                ...
                response = client.RetrieveAvailableBundleVersionsRoverCluster(request).GetAwaiter().GetResult();
        ...
        private RetrieveAvailableBundleVersionsRoverClusterResponse response;
    }
}
