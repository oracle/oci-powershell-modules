...
{
    [Cmdlet("Remove", "OCIApigatewayGatewayLock")]
    [OutputType(new System.Type[] { typeof(Oci.ApigatewayService.Models.Gateway), typeof(Oci.ApigatewayService.Responses.RemoveGatewayLockResponse) })]
    public class RemoveOCIApigatewayGatewayLock : OCIGatewayCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveGatewayLockRequest
                {
                    GatewayId = GatewayId,
                ...
                response = client.RemoveGatewayLock(request).GetAwaiter().GetResult();
        ...
        private RemoveGatewayLockResponse response;
    }
}
