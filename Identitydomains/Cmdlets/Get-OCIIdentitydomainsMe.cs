...
{
    [Cmdlet("Get", "OCIIdentitydomainsMe")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Me), typeof(Oci.IdentitydomainsService.Responses.GetMeResponse) })]
    public class GetOCIIdentitydomainsMe : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GetMe(request).GetAwaiter().GetResult();
