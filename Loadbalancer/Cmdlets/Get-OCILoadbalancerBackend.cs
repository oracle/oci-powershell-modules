...
{
    [Cmdlet("Get", "OCILoadbalancerBackend")]
    [OutputType(new System.Type[] { typeof(Oci.LoadbalancerService.Models.Backend), typeof(Oci.LoadbalancerService.Responses.GetBackendResponse) })]
    public class GetOCILoadbalancerBackend : OCILoadBalancerCmdlet
    {
...
Example: `example_backend_set`")]
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The IP address and port of the backend server to retrieve.
