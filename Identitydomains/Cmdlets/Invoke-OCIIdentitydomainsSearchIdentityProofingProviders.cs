...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchIdentityProofingProviders")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.IdentityProofingProviders), typeof(Oci.IdentitydomainsService.Responses.SearchIdentityProofingProvidersResponse) })]
    public class InvokeOCIIdentitydomainsSearchIdentityProofingProviders : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching IdentityProofingProviders.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchIdentityProofingProvidersRequest
                {
                ...
                response = client.SearchIdentityProofingProviders(request).GetAwaiter().GetResult();
                WriteOutput(response, response.IdentityProofingProviders);
        ...
        private SearchIdentityProofingProvidersResponse response;
    }
}
