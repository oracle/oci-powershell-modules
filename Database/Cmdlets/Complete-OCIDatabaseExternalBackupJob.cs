...
namespace Oci.DatabaseService.Cmdlets
{
    ...
    public class CompleteOCIDatabaseExternalBackupJob : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The backup [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).", ParameterSetName = StatusParamSet)]
