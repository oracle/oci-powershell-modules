...
{
    [Cmdlet("New", "OCIGenerativeaiProject")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.GenerativeAiProject), typeof(Oci.GenerativeaiService.Responses.CreateGenerativeAiProjectResponse) })]
    public class NewOCIGenerativeaiProject : OCIGenerativeAiCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new generativeAiProject.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateGenerativeAiProjectRequest
                {
                ...
                response = client.CreateGenerativeAiProject(request).GetAwaiter().GetResult();
        ...
        private CreateGenerativeAiProjectResponse response;
    }
}
