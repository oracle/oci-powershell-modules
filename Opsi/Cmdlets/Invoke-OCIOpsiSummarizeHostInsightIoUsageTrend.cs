...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeHostInsightIoUsageTrend")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.SummarizeHostInsightIoUsageTrendAggregationCollection), typeof(Oci.OpsiService.Responses.SummarizeHostInsightIoUsageTrendResponse) })]
    public class InvokeOCIOpsiSummarizeHostInsightIoUsageTrend : OCIOperationsInsightsCmdlet
    {
        ...
        public System.Nullable<Oci.OpsiService.Requests.SummarizeHostInsightIoUsageTrendRequest.StatisticEnum> Statistic { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeHostInsightIoUsageTrendRequest
                {
                ...
                response = client.SummarizeHostInsightIoUsageTrend(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SummarizeHostInsightIoUsageTrendAggregationCollection);
        ...
        private SummarizeHostInsightIoUsageTrendResponse response;
    }
}
