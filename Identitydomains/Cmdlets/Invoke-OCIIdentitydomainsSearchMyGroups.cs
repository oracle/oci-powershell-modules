...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchMyGroups")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyGroups), typeof(Oci.IdentitydomainsService.Responses.SearchMyGroupsResponse) })]
    public class InvokeOCIIdentitydomainsSearchMyGroups : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching MyGroups")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchMyGroupsRequest
                {
                ...
                response = client.SearchMyGroups(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MyGroups);
        ...
        private SearchMyGroupsResponse response;
    }
}
