...
{
    [Cmdlet("Invoke", "OCIDatabaseMountAdvancedClusterFileSystem", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AdvancedClusterFileSystem), typeof(Oci.DatabaseService.Responses.MountAdvancedClusterFileSystemResponse) })]
    public class InvokeOCIDatabaseMountAdvancedClusterFileSystem : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new MountAdvancedClusterFileSystemRequest
                {
        ...
        private void HandleOutput(MountAdvancedClusterFileSystemRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForMountAdvancedClusterFileSystem(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.MountAdvancedClusterFileSystem(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AdvancedClusterFileSystem);
        }

        private MountAdvancedClusterFileSystemResponse response;
