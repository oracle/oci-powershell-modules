...
{
    [Cmdlet("Invoke", "OCIJmsSummarizePluginErrors")]
    ...
    public class InvokeOCIJmsSummarizePluginErrors : OCIJavaManagementServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizePluginErrorsRequest
                {
                ...
                response = client.SummarizePluginErrors(request).GetAwaiter().GetResult();
                WriteOutput(response, response.PluginErrorAggregationCollection);
        ...
        private SummarizePluginErrorsResponse response;
    }
}
