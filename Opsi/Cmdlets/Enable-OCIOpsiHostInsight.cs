...
{
    [Cmdlet("Enable", "OCIOpsiHostInsight")]
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the host to be enabled in Operations Insights. This parameter also accepts subtype <Oci.OpsiService.Models.EnableMacsManagedExternalHostInsightDetails> of type <Oci.OpsiService.Models.EnableHostInsightDetails>.")]
...
*Note:* Retry tokens can be invalidated before the 24 hour time limit due to conflicting operations, such as a resource being deleted or purged from the system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new EnableHostInsightRequest
                {
                ...
                response = client.EnableHostInsight(request).GetAwaiter().GetResult();
        ...
        private EnableHostInsightResponse response;
    }
}
