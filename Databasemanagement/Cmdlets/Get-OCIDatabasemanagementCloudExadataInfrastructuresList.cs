...
{
    [Cmdlet("Get", "OCIDatabasemanagementCloudExadataInfrastructuresList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.CloudExadataInfrastructureCollection), typeof(Oci.DatabasemanagementService.Responses.ListCloudExadataInfrastructuresResponse) })]
    public class GetOCIDatabasemanagementCloudExadataInfrastructuresList : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListCloudExadataInfrastructuresRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    response = item;
                    WriteOutput(response, response.CloudExadataInfrastructureCollection, true);
                }
