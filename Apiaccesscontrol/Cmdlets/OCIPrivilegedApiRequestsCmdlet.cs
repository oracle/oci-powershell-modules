...
{
    public abstract class OCIPrivilegedApiRequestsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new PrivilegedApiRequestsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected PrivilegedApiRequestsClient client;
