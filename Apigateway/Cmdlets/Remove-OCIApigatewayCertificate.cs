...
{
    [Cmdlet("Remove", "OCIApigatewayCertificate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApigatewayService.Responses.DeleteCertificateResponse) })]
    public class RemoveOCIApigatewayCertificate : OCIApiGatewayCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIApigatewayCertificate", "Remove"))
            {
               return;
            }
