...
{
    public abstract class OCIOciCacheUserCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OciCacheUserClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OciCacheUserClient client;
