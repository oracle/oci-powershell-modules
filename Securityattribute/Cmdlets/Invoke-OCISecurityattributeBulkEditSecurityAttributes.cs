...
{
    [Cmdlet("Invoke", "OCISecurityattributeBulkEditSecurityAttributes")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.SecurityattributeService.Responses.BulkEditSecurityAttributesResponse) })]
    public class InvokeOCISecurityattributeBulkEditSecurityAttributes : OCISecurityAttributeCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The request object for bulk editing security attributes on resources in the compartment.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new BulkEditSecurityAttributesRequest
                {
                ...
                response = client.BulkEditSecurityAttributes(request).GetAwaiter().GetResult();
        ...
        private BulkEditSecurityAttributesResponse response;
    }
}
