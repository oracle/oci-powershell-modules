...
{
    [Cmdlet("Get", "OCIWaasAccessRulesList")]
    [OutputType(new System.Type[] { typeof(Oci.WaasService.Models.AccessRule), typeof(Oci.WaasService.Responses.ListAccessRulesResponse) })]
    public class GetOCIWaasAccessRulesList : OCIWaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAccessRulesRequest
                {
                ...
                IEnumerable<ListAccessRulesResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListAccessRulesResponse> DefaultRequest(ListAccessRulesRequest request) => Enumerable.Repeat(client.ListAccessRules(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAccessRulesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAccessRulesResponse response;
        private delegate IEnumerable<ListAccessRulesResponse> RequestDelegate(ListAccessRulesRequest request);
