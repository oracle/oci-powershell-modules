...
{
    [Cmdlet("Get", "OCIIdentityDynamicGroupsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentityService.Models.DynamicGroup), typeof(Oci.IdentityService.Responses.ListDynamicGroupsResponse) })]
    public class GetOCIIdentityDynamicGroupsList : OCIIdentityCmdlet
    {
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by Availability Domain if the scope of the resource type is within a single Availability Domain. If you call one of these ""List"" operations without specifying an Availability Domain, the resources are grouped by Availability Domain, then sorted.")]
        public System.Nullable<Oci.IdentityService.Requests.ListDynamicGroupsRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.IdentityService.Requests.ListDynamicGroupsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.IdentityService.Models.DynamicGroup.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListDynamicGroupsRequest
                {
                ...
                IEnumerable<ListDynamicGroupsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListDynamicGroupsResponse> DefaultRequest(ListDynamicGroupsRequest request) => Enumerable.Repeat(client.ListDynamicGroups(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListDynamicGroupsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListDynamicGroupsResponse response;
        private delegate IEnumerable<ListDynamicGroupsResponse> RequestDelegate(ListDynamicGroupsRequest request);
