...
namespace Oci.DatasafeService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIDatasafeReportContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatasafeService.Responses.GetReportContentResponse) })]
    public class GetOCIDatasafeReportContent : OCIDataSafeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetReportContentRequest
                {
                    ReportId = ReportId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetReportContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetReportContentResponse response;
