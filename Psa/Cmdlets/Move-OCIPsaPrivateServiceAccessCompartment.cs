...
{
    [Cmdlet("Move", "OCIPsaPrivateServiceAccessCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.PsaService.Responses.ChangePrivateServiceAccessCompartmentResponse) })]
    public class MoveOCIPsaPrivateServiceAccessCompartment : OCIPrivateServiceAccessCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangePrivateServiceAccessCompartmentRequest
                {
                ...
                response = client.ChangePrivateServiceAccessCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangePrivateServiceAccessCompartmentResponse response;
    }
}
