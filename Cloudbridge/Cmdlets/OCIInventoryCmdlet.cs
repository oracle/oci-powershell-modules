...
{
    public abstract class OCIInventoryCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new InventoryClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
