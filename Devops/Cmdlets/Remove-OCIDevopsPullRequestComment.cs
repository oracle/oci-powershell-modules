...
{
    [Cmdlet("Remove", "OCIDevopsPullRequestComment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DevopsService.Responses.DeletePullRequestCommentResponse) })]
    public class RemoveOCIDevopsPullRequestComment : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDevopsPullRequestComment", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeletePullRequestComment(request).GetAwaiter().GetResult();
        ...
        private DeletePullRequestCommentResponse response;
    }
}
