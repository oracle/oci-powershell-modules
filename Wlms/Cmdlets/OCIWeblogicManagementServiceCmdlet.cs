...
{
    public abstract class OCIWeblogicManagementServiceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new WeblogicManagementServiceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected WeblogicManagementServiceClient client;
