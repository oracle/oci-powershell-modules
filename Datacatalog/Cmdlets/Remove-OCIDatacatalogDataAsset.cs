...
{
    [Cmdlet("Remove", "OCIDatacatalogDataAsset", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatacatalogService.Responses.DeleteDataAssetResponse) })]
    public class RemoveOCIDatacatalogDataAsset : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatacatalogDataAsset", "Remove"))
            {
               return;
            }
