...
namespace Oci.DevopsService.Cmdlets
{
    ...
    public class UpdateOCIDevopsDeployStage : OCIDevopsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information to be updated. This parameter also accepts subtypes <Oci.DevopsService.Models.UpdateOkeDeployStageDetails>, <Oci.DevopsService.Models.UpdateLoadBalancerTrafficShiftDeployStageDetails>, <Oci.DevopsService.Models.UpdateComputeInstanceGroupDeployStageDetails>, <Oci.DevopsService.Models.UpdateWaitDeployStageDetails>, <Oci.DevopsService.Models.UpdateManualApprovalDeployStageDetails>, <Oci.DevopsService.Models.UpdateFunctionDeployStageDetails>, <Oci.DevopsService.Models.UpdateInvokeFunctionDeployStageDetails> of type <Oci.DevopsService.Models.UpdateDeployStageDetails>.")]
