...
{
    [Cmdlet("Get", "OCIDevopsBuildPipeline", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.BuildPipeline), typeof(Oci.DevopsService.Responses.GetBuildPipelineResponse) })]
    public class GetOCIDevopsBuildPipeline : OCIDevopsCmdlet
    {
        ...
        public Oci.DevopsService.Models.BuildPipeline.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetBuildPipelineRequest
                {
        ...
        private void HandleOutput(GetBuildPipelineRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForBuildPipeline(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetBuildPipeline(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.BuildPipeline);
        }

        private GetBuildPipelineResponse response;
