...
namespace Oci.DataintegrationService.Cmdlets
{
    ...
    public class GetOCIDataintegrationFoldersList : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"This filter parameter can be used to filter by the project or the folder object.")]
