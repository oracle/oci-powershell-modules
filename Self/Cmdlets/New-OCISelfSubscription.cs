...
{
    [Cmdlet("New", "OCISelfSubscription")]
    [OutputType(new System.Type[] { typeof(Oci.SelfService.Models.Subscription), typeof(Oci.SelfService.Responses.CreateSubscriptionResponse) })]
    public class NewOCISelfSubscription : OCISubscriptionCmdlet
    {
