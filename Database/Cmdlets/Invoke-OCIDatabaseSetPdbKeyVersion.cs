...
{
    [Cmdlet("Invoke", "OCIDatabaseSetPdbKeyVersion", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.PluggableDatabase), typeof(Oci.DatabaseService.Responses.SetPdbKeyVersionResponse) })]
    public class InvokeOCIDatabaseSetPdbKeyVersion : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Requests Key Version Update. This parameter also accepts subtype <Oci.DatabaseService.Models.OciProviderSetKeyVersionDetails> of type <Oci.DatabaseService.Models.SetKeyVersionDetails>.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Requests Key Version Update. This parameter also accepts subtype <Oci.DatabaseService.Models.OciProviderSetKeyVersionDetails> of type <Oci.DatabaseService.Models.SetKeyVersionDetails>.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SetPdbKeyVersionRequest
                {
        ...
        private void HandleOutput(SetPdbKeyVersionRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForSetPdbKeyVersion(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.SetPdbKeyVersion(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.PluggableDatabase);
        }

        private SetPdbKeyVersionResponse response;
