...
{
    [Cmdlet("Restore", "OCIKmsManagementKeyFromFile")]
    ...
    public class RestoreOCIKmsManagementKeyFromFile : OCIKmsManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The encrypted backup file to upload to restore the key.", ParameterSetName = FromFileSet)]
