...
{
    [Cmdlet("Remove", "OCIDevopsTrigger", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DevopsService.Responses.DeleteTriggerResponse) })]
    public class RemoveOCIDevopsTrigger : OCIDevopsCmdlet
    {
        ...
        private DeleteTriggerResponse response;
    }
}
