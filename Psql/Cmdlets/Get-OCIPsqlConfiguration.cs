...
{
    [Cmdlet("Get", "OCIPsqlConfiguration", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PsqlService.Models.Configuration), typeof(Oci.PsqlService.Responses.GetConfigurationResponse) })]
    public class GetOCIPsqlConfiguration : OCIPostgresqlCmdlet
    {
        ...
        public Oci.PsqlService.Models.Configuration.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
