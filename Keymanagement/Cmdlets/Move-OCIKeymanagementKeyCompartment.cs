...
{
    [Cmdlet("Move", "OCIKeymanagementKeyCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.KeymanagementService.Responses.ChangeKeyCompartmentResponse) })]
    public class MoveOCIKeymanagementKeyCompartment : OCIKmsManagementCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the key.")]
        public string KeyId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details of change key compartment.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeKeyCompartmentRequest
                {
                    KeyId = KeyId,
                ...
                response = client.ChangeKeyCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeKeyCompartmentResponse response;
    }
}
