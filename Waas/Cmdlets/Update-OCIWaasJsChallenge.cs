...
{
    [Cmdlet("Update", "OCIWaasJsChallenge")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdateJsChallengeResponse) })]
    public class UpdateOCIWaasJsChallenge : OCIWaasCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The JavaScript challenge settings to be updated.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateJsChallengeRequest
                {
                ...
                response = client.UpdateJsChallenge(request).GetAwaiter().GetResult();
        ...
        private UpdateJsChallengeResponse response;
    }
}
