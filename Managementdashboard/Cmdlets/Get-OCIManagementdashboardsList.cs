...
{
    [Cmdlet("Get", "OCIManagementdashboardsList")]
    [OutputType(new System.Type[] { typeof(Oci.ManagementdashboardService.Models.ManagementDashboardCollection), typeof(Oci.ManagementdashboardService.Responses.ListManagementDashboardsResponse) })]
    public class GetOCIManagementdashboardsList : OCIDashxApisCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListManagementDashboardsRequest
                {
        ...
        {
            IEnumerable<ListManagementDashboardsResponse> DefaultRequest(ListManagementDashboardsRequest request) => Enumerable.Repeat(client.ListManagementDashboards(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListManagementDashboardsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListManagementDashboardsResponse response;
        private delegate IEnumerable<ListManagementDashboardsResponse> RequestDelegate(ListManagementDashboardsRequest request);
