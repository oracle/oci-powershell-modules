...
{
    public abstract class OCIOceInstanceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            base.ProcessRecord();
            client?.Dispose();
            client = new OceInstanceClient(AuthProvider, new Oci.Common.ClientConfiguration
            {
        ...
        protected OceInstanceClient client;
