...
{
    public abstract class OCIOperatorControlAssignmentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OperatorControlAssignmentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OperatorControlAssignmentClient client;
