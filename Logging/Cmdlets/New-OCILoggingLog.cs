...
{
    [Cmdlet("New", "OCILoggingLog")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.LoggingService.Responses.CreateLogResponse) })]
    public class NewOCILoggingLog : OCILoggingManagementCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"OCID of a log group to work with.")]
        public string LogGroupId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Log object configuration details.")]
        ...
        private CreateLogResponse response;
    }
}
