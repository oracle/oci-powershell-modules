...
{
    public abstract class OCIOperatorControlCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OperatorControlClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OperatorControlClient client;
