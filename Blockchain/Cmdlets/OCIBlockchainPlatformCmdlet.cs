...
using Oci.BlockchainService;

namespace Oci.BlockchainService.Cmdlets
{
    public abstract class OCIBlockchainPlatformCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new BlockchainPlatformClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected BlockchainPlatformClient client;
