...
{
    [Cmdlet("Stop", "OCIBlockchainPlatform")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.BlockchainService.Responses.StopBlockchainPlatformResponse) })]
    public class StopOCIBlockchainPlatform : OCIBlockchainPlatformCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StopBlockchainPlatformRequest
                {
        ...
        private StopBlockchainPlatformResponse response;
    }
}
