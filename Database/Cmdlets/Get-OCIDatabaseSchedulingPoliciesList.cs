...
{
    [Cmdlet("Get", "OCIDatabaseSchedulingPoliciesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.SchedulingPolicySummary), typeof(Oci.DatabaseService.Responses.ListSchedulingPoliciesResponse) })]
    public class GetOCIDatabaseSchedulingPoliciesList : OCIDatabaseCmdlet
    {
        ...
        public System.Nullable<Oci.DatabaseService.Requests.ListSchedulingPoliciesRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either ascending (`ASC`) or descending (`DESC`).")]
        public System.Nullable<Oci.DatabaseService.Requests.ListSchedulingPoliciesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatabaseService.Models.SchedulingPolicySummary.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        {
            IEnumerable<ListSchedulingPoliciesResponse> DefaultRequest(ListSchedulingPoliciesRequest request) => Enumerable.Repeat(client.ListSchedulingPolicies(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSchedulingPoliciesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSchedulingPoliciesResponse response;
        private delegate IEnumerable<ListSchedulingPoliciesResponse> RequestDelegate(ListSchedulingPoliciesRequest request);
