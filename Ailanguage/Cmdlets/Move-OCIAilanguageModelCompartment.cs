...
{
    [Cmdlet("Move", "OCIAilanguageModelCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AilanguageService.Responses.ChangeModelCompartmentResponse) })]
    public class MoveOCIAilanguageModelCompartment : OCIAIServiceLanguageCmdlet
    {
