...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyAuthToken")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyAuthToken), typeof(Oci.IdentitydomainsService.Responses.GetMyAuthTokenResponse) })]
    public class GetOCIIdentitydomainsMyAuthToken : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMyAuthTokenRequest
                {
                ...
                response = client.GetMyAuthToken(request).GetAwaiter().GetResult();
        ...
        private GetMyAuthTokenResponse response;
    }
}
