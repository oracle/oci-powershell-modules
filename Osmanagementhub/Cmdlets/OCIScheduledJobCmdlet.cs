...
{
    public abstract class OCIScheduledJobCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ScheduledJobClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ScheduledJobClient client;
