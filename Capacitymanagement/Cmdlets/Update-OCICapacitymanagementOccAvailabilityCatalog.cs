...
{
    [Cmdlet("Update", "OCICapacitymanagementOccAvailabilityCatalog")]
    [OutputType(new System.Type[] { typeof(Oci.CapacitymanagementService.Models.OccAvailabilityCatalog), typeof(Oci.CapacitymanagementService.Responses.UpdateOccAvailabilityCatalogResponse) })]
    public class UpdateOCICapacitymanagementOccAvailabilityCatalog : OCICapacityManagementCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to update the properties of the availability catalog.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpdateOccAvailabilityCatalog(request).GetAwaiter().GetResult();
        ...
        private UpdateOccAvailabilityCatalogResponse response;
    }
}
