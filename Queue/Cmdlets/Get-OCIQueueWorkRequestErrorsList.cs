...
{
    [Cmdlet("Get", "OCIQueueWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.QueueService.Models.WorkRequestErrorCollection), typeof(Oci.QueueService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIQueueWorkRequestErrorsList : OCIQueueAdminCmdlet
    {
