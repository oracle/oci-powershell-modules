...
{
    public abstract class OCIDiscoveryCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DiscoveryClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
