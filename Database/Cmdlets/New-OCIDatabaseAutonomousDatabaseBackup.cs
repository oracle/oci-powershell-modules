...
{
    [Cmdlet("New", "OCIDatabaseAutonomousDatabaseBackup", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousDatabaseBackup), typeof(Oci.DatabaseService.Responses.CreateAutonomousDatabaseBackupResponse) })]
    public class NewOCIDatabaseAutonomousDatabaseBackup : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateAutonomousDatabaseBackupRequest
                {
        ...
        private void HandleOutput(CreateAutonomousDatabaseBackupRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForCreateAutonomousDatabaseBackup(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.CreateAutonomousDatabaseBackup(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousDatabaseBackup);
        }

        private CreateAutonomousDatabaseBackupResponse response;
