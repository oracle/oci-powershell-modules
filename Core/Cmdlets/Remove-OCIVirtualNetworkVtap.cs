...
{
    [Cmdlet("Remove", "OCIVirtualNetworkVtap", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.DeleteVtapResponse) })]
    public class RemoveOCIVirtualNetworkVtap : OCIVirtualNetworkCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIVirtualNetworkVtap", "Remove"))
            {
               return;
            }
        ...
        private void HandleOutput(DeleteVtapRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteVtap(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteVtap(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteVtapResponse response;
