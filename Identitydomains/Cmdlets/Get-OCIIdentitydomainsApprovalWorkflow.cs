...
{
    [Cmdlet("Get", "OCIIdentitydomainsApprovalWorkflow")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.ApprovalWorkflow), typeof(Oci.IdentitydomainsService.Responses.GetApprovalWorkflowResponse) })]
    public class GetOCIIdentitydomainsApprovalWorkflow : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetApprovalWorkflowRequest
                {
                ...
                response = client.GetApprovalWorkflow(request).GetAwaiter().GetResult();
        ...
        private GetApprovalWorkflowResponse response;
    }
}
