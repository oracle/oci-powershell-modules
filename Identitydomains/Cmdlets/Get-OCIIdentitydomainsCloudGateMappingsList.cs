...
{
    [Cmdlet("Get", "OCIIdentitydomainsCloudGateMappingsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.CloudGateMappings), typeof(Oci.IdentitydomainsService.Responses.ListCloudGateMappingsResponse) })]
    public class GetOCIIdentitydomainsCloudGateMappingsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListCloudGateMappingsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListCloudGateMappings(request).GetAwaiter().GetResult();
        ...
        private ListCloudGateMappingsResponse response;
    }
}
