...
namespace Oci.DevopsService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new trigger. This parameter also accepts subtypes <Oci.DevopsService.Models.CreateGithubTriggerDetails>, <Oci.DevopsService.Models.CreateVbsTriggerDetails>, <Oci.DevopsService.Models.CreateDevopsCodeRepositoryTriggerDetails>, <Oci.DevopsService.Models.CreateBitbucketCloudTriggerDetails>, <Oci.DevopsService.Models.CreateGitlabServerTriggerDetails>, <Oci.DevopsService.Models.CreateGitlabTriggerDetails>, <Oci.DevopsService.Models.CreateBitbucketServerTriggerDetails> of type <Oci.DevopsService.Models.CreateTriggerDetails>.")]
