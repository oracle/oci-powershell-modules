...
{
    [Cmdlet("Remove", "OCIDatacatalogMetastoreLock")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Metastore), typeof(Oci.DatacatalogService.Responses.RemoveMetastoreLockResponse) })]
    public class RemoveOCIDatacatalogMetastoreLock : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveMetastoreLockRequest
                {
                ...
                response = client.RemoveMetastoreLock(request).GetAwaiter().GetResult();
        ...
        private RemoveMetastoreLockResponse response;
    }
}
