...
{
    [Cmdlet("Get", "OCIDatalabelingserviceDataset", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatalabelingService.Models.Dataset), typeof(Oci.DatalabelingService.Responses.GetDatasetResponse) })]
    public class GetOCIDatalabelingserviceDataset : OCIDataLabelingManagementCmdlet
    {
        ...
        public Oci.DatalabelingService.Models.Dataset.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
