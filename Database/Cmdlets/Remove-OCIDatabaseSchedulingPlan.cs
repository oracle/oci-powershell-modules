...
{
    [Cmdlet("Remove", "OCIDatabaseSchedulingPlan", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteSchedulingPlanResponse) })]
    public class RemoveOCIDatabaseSchedulingPlan : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseSchedulingPlan", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteSchedulingPlanRequest
                {
        ...
        private void HandleOutput(DeleteSchedulingPlanRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteSchedulingPlan(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteSchedulingPlan(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteSchedulingPlanResponse response;
