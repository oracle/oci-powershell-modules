...
{
    [Cmdlet("Restart", "OCIMysqlAnalyticsCluster")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.RestartAnalyticsClusterResponse) })]
    public class RestartOCIMysqlAnalyticsCluster : OCIDbSystemCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RestartAnalyticsClusterRequest
                {
                ...
                response = client.RestartAnalyticsCluster(request).GetAwaiter().GetResult();
        ...
        private RestartAnalyticsClusterResponse response;
    }
}
