...
{
    [Cmdlet("Invoke", "OCIGenerativeaiRenewApiKey")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.ApiKey), typeof(Oci.GenerativeaiService.Responses.RenewApiKeyResponse) })]
    public class InvokeOCIGenerativeaiRenewApiKey : OCIGenerativeAiCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information to be renewed.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RenewApiKeyRequest
                {
                    ApiKeyId = ApiKeyId,
                ...
                response = client.RenewApiKey(request).GetAwaiter().GetResult();
        ...
        private RenewApiKeyResponse response;
    }
}
