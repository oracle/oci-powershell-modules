...
{
    [Cmdlet("Add", "OCIFilestorageFilesystemSnapshotPolicyLock")]
    [OutputType(new System.Type[] { typeof(Oci.FilestorageService.Models.FilesystemSnapshotPolicy), typeof(Oci.FilestorageService.Responses.AddFilesystemSnapshotPolicyLockResponse) })]
    public class AddOCIFilestorageFilesystemSnapshotPolicyLock : OCIFileStorageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddFilesystemSnapshotPolicyLockRequest
                {
                ...
                response = client.AddFilesystemSnapshotPolicyLock(request).GetAwaiter().GetResult();
        ...
        private AddFilesystemSnapshotPolicyLockResponse response;
    }
}
