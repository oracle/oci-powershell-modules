...
{
    [Cmdlet("Get", "OCIServicecatalogAllApplicationsList")]
    [OutputType(new System.Type[] { typeof(Oci.ServicecatalogService.Models.ApplicationCollection), typeof(Oci.ServicecatalogService.Responses.ListAllApplicationsResponse) })]
    public class GetOCIServicecatalogAllApplicationsList : OCIServiceCatalogCmdlet
    {
        ...
        public System.Nullable<Oci.ServicecatalogService.Requests.ListAllApplicationsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAllApplicationsRequest
                {
                ...
                IEnumerable<ListAllApplicationsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListAllApplicationsResponse> DefaultRequest(ListAllApplicationsRequest request) => Enumerable.Repeat(client.ListAllApplications(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAllApplicationsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAllApplicationsResponse response;
        private delegate IEnumerable<ListAllApplicationsResponse> RequestDelegate(ListAllApplicationsRequest request);
