...
{
    [Cmdlet("Get", "OCIIdentitydomainsApprovalWorkflowsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.ApprovalWorkflows), typeof(Oci.IdentitydomainsService.Responses.ListApprovalWorkflowsResponse) })]
    public class GetOCIIdentitydomainsApprovalWorkflowsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListApprovalWorkflowsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListApprovalWorkflows(request).GetAwaiter().GetResult();
                WriteOutput(response, response.ApprovalWorkflows);
        ...
        private ListApprovalWorkflowsResponse response;
    }
}
