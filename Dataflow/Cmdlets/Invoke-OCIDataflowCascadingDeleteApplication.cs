...
{
    [Cmdlet("Invoke", "OCIDataflowCascadingDeleteApplication")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DataflowService.Responses.CascadingDeleteApplicationResponse) })]
    public class InvokeOCIDataflowCascadingDeleteApplication : OCIDataFlowCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CascadingDeleteApplicationRequest
                {
                ...
                response = client.CascadingDeleteApplication(request).GetAwaiter().GetResult();
        ...
        private CascadingDeleteApplicationResponse response;
    }
}
