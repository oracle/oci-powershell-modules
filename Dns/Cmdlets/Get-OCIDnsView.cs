...
{
    [Cmdlet("Get", "OCIDnsView", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.View), typeof(Oci.DnsService.Responses.GetViewResponse) })]
    public class GetOCIDnsView : OCIDnsCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the target view.", ParameterSetName = LifecycleStateParamSet)]
        ...
        public Oci.DnsService.Models.View.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        private GetViewResponse response;
