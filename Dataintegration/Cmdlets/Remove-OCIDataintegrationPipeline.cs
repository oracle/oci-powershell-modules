...
{
    [Cmdlet("Remove", "OCIDataintegrationPipeline", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataintegrationService.Responses.DeletePipelineResponse) })]
    public class RemoveOCIDataintegrationPipeline : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataintegrationPipeline", "Remove"))
            {
               return;
            }
