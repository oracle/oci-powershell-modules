...
{
    [Cmdlet("Remove", "OCIDevopsBuildPipeline", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DevopsService.Responses.DeleteBuildPipelineResponse) })]
    public class RemoveOCIDevopsBuildPipeline : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDevopsBuildPipeline", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteBuildPipelineRequest
                {
                ...
                response = client.DeleteBuildPipeline(request).GetAwaiter().GetResult();
        ...
        private DeleteBuildPipelineResponse response;
    }
}
