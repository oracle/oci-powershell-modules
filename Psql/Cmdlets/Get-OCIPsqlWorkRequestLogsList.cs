...
{
    [Cmdlet("Get", "OCIPsqlWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.PsqlService.Models.WorkRequestLogEntryCollection), typeof(Oci.PsqlService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIPsqlWorkRequestLogsList : OCIPostgresqlCmdlet
    {
        ...
        public System.Nullable<Oci.PsqlService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
