...
{
    [Cmdlet("Update", "OCIDatabaseCloudAutonomousVmCluster", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.CloudAutonomousVmCluster), typeof(Oci.DatabaseService.Responses.UpdateCloudAutonomousVmClusterResponse) })]
    public class UpdateOCIDatabaseCloudAutonomousVmCluster : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to update the attributes of a cloud VM cluster.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to update the attributes of a cloud VM cluster.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateCloudAutonomousVmClusterRequest
                {
        ...
        private void HandleOutput(UpdateCloudAutonomousVmClusterRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateCloudAutonomousVmCluster(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpdateCloudAutonomousVmCluster(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.CloudAutonomousVmCluster);
        }

        private UpdateCloudAutonomousVmClusterResponse response;
