...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchSmtpCredentials")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SmtpCredentials), typeof(Oci.IdentitydomainsService.Responses.SearchSmtpCredentialsResponse) })]
    public class InvokeOCIIdentitydomainsSearchSmtpCredentials : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching SmtpCredentials")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchSmtpCredentialsRequest
                {
                ...
                response = client.SearchSmtpCredentials(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SmtpCredentials);
        ...
        private SearchSmtpCredentialsResponse response;
    }
}
