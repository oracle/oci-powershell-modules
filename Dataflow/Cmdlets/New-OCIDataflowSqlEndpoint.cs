...
{
    [Cmdlet("New", "OCIDataflowSqlEndpoint")]
    [OutputType(new System.Type[] { typeof(Oci.DataflowService.Models.SqlEndpoint), typeof(Oci.DataflowService.Responses.CreateSqlEndpointResponse) })]
    public class NewOCIDataflowSqlEndpoint : OCIDataFlowCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details of the new Sql Endpoint.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateSqlEndpointRequest
                {
                ...
                response = client.CreateSqlEndpoint(request).GetAwaiter().GetResult();
        ...
        private CreateSqlEndpointResponse response;
    }
}
