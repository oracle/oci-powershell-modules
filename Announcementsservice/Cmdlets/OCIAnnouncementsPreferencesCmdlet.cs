...
{
    public abstract class OCIAnnouncementsPreferencesCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AnnouncementsPreferencesClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AnnouncementsPreferencesClient client;
