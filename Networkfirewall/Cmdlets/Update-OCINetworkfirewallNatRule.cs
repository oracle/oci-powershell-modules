...
{
    [Cmdlet("Update", "OCINetworkfirewallNatRule")]
    [OutputType(new System.Type[] { typeof(Oci.NetworkfirewallService.Models.NatRule), typeof(Oci.NetworkfirewallService.Responses.UpdateNatRuleResponse) })]
    public class UpdateOCINetworkfirewallNatRule : OCINetworkFirewallCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateNatRuleRequest
                {
                ...
                response = client.UpdateNatRule(request).GetAwaiter().GetResult();
        ...
        private UpdateNatRuleResponse response;
    }
}
