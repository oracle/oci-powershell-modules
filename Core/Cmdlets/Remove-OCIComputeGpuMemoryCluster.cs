...
{
    [Cmdlet("Remove", "OCIComputeGpuMemoryCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.DeleteComputeGpuMemoryClusterResponse) })]
    public class RemoveOCIComputeGpuMemoryCluster : OCIComputeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIComputeGpuMemoryCluster", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteComputeGpuMemoryClusterRequest
                {
        ...
        private void HandleOutput(DeleteComputeGpuMemoryClusterRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteComputeGpuMemoryCluster(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteComputeGpuMemoryCluster(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteComputeGpuMemoryClusterResponse response;
