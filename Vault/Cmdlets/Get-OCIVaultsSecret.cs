...
{
    [Cmdlet("Get", "OCIVaultsSecret", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.VaultService.Models.Secret), typeof(Oci.VaultService.Responses.GetSecretResponse) })]
    public class GetOCIVaultsSecret : OCIVaultsCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the secret.", ParameterSetName = LifecycleStateParamSet)]
        ...
        public Oci.VaultService.Models.Secret.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        private GetSecretResponse response;
