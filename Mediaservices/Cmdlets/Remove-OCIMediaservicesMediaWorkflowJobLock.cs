...
{
    [Cmdlet("Remove", "OCIMediaservicesMediaWorkflowJobLock")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.MediaWorkflowJob), typeof(Oci.MediaservicesService.Responses.RemoveMediaWorkflowJobLockResponse) })]
    public class RemoveOCIMediaservicesMediaWorkflowJobLock : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveMediaWorkflowJobLockRequest
                {
                ...
                response = client.RemoveMediaWorkflowJobLock(request).GetAwaiter().GetResult();
        ...
        private RemoveMediaWorkflowJobLockResponse response;
    }
}
