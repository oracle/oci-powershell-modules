...
{
    [Cmdlet("Remove", "OCIIdentitydomainsDynamicResourceGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteDynamicResourceGroupResponse) })]
    public class RemoveOCIIdentitydomainsDynamicResourceGroup : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsDynamicResourceGroup", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDynamicResourceGroupRequest
                {
                ...
                response = client.DeleteDynamicResourceGroup(request).GetAwaiter().GetResult();
        ...
        private DeleteDynamicResourceGroupResponse response;
    }
}
