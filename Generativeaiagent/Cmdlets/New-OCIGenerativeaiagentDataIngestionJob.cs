...
{
    [Cmdlet("New", "OCIGenerativeaiagentDataIngestionJob")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiagentService.Models.DataIngestionJob), typeof(Oci.GenerativeaiagentService.Responses.CreateDataIngestionJobResponse) })]
    public class NewOCIGenerativeaiagentDataIngestionJob : OCIGenerativeAiAgentCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new data ingestion job.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateDataIngestionJobRequest
                {
                ...
                response = client.CreateDataIngestionJob(request).GetAwaiter().GetResult();
        ...
        private CreateDataIngestionJobResponse response;
    }
}
