...
{
    [Cmdlet("Get", "OCIVirtualNetworkNetworkSecurityGroupsList")]
    ...
    public class GetOCIVirtualNetworkNetworkSecurityGroupsList : OCIVirtualNetworkCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN.")]
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by availability domain if the scope of the resource type is within a single availability domain. If you call one of these ""List"" operations without specifying an availability domain, the resources are grouped by availability domain, then sorted.")]
        public System.Nullable<Oci.CoreService.Requests.ListNetworkSecurityGroupsRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Requests.ListNetworkSecurityGroupsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Models.NetworkSecurityGroup.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListNetworkSecurityGroupsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListNetworkSecurityGroupsResponse> DefaultRequest(ListNetworkSecurityGroupsRequest request) => Enumerable.Repeat(client.ListNetworkSecurityGroups(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListNetworkSecurityGroupsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListNetworkSecurityGroupsResponse response;
        private delegate IEnumerable<ListNetworkSecurityGroupsResponse> RequestDelegate(ListNetworkSecurityGroupsRequest request);
