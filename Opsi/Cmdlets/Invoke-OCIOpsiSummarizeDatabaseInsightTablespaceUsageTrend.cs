...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeDatabaseInsightTablespaceUsageTrend")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.SummarizeDatabaseInsightTablespaceUsageTrendAggregationCollection), typeof(Oci.OpsiService.Responses.SummarizeDatabaseInsightTablespaceUsageTrendResponse) })]
    public class InvokeOCIOpsiSummarizeDatabaseInsightTablespaceUsageTrend : OCIOperationsInsightsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"[OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the database insight resource.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeDatabaseInsightTablespaceUsageTrendRequest
                {
                ...
                response = client.SummarizeDatabaseInsightTablespaceUsageTrend(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SummarizeDatabaseInsightTablespaceUsageTrendAggregationCollection);
        ...
        private SummarizeDatabaseInsightTablespaceUsageTrendResponse response;
    }
}
