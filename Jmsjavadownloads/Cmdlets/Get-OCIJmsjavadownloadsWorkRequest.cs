...
{
    [Cmdlet("Get", "OCIJmsjavadownloadsWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.JmsjavadownloadsService.Models.WorkRequest), typeof(Oci.JmsjavadownloadsService.Responses.GetWorkRequestResponse) })]
    public class GetOCIJmsjavadownloadsWorkRequest : OCIJavaDownloadCmdlet
    {
        ...
        public Oci.JmsjavadownloadsService.Models.OperationStatus[] WaitForStatus { get; set; }
