...
{
    [Cmdlet("Remove", "OCIDatabasetoolsConnectionLock")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasetoolsService.Models.DatabaseToolsConnection), typeof(Oci.DatabasetoolsService.Responses.RemoveDatabaseToolsConnectionLockResponse) })]
    public class RemoveOCIDatabasetoolsConnectionLock : OCIDatabaseToolsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveDatabaseToolsConnectionLockRequest
                {
                ...
                response = client.RemoveDatabaseToolsConnectionLock(request).GetAwaiter().GetResult();
        ...
        private RemoveDatabaseToolsConnectionLockResponse response;
    }
}
