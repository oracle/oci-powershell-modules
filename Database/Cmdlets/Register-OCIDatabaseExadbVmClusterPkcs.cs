...
{
    [Cmdlet("Register", "OCIDatabaseExadbVmClusterPkcs", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.RegisterExadbVmClusterPkcsResponse) })]
    public class RegisterOCIDatabaseExadbVmClusterPkcs : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RegisterExadbVmClusterPkcsRequest
                {
        ...
        private void HandleOutput(RegisterExadbVmClusterPkcsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRegisterExadbVmClusterPkcs(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RegisterExadbVmClusterPkcs(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private RegisterExadbVmClusterPkcsResponse response;
