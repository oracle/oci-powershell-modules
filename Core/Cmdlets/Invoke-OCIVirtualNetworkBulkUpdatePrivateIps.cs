...
{
    [Cmdlet("Invoke", "OCIVirtualNetworkBulkUpdatePrivateIps", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.BulkUpdatePrivateIpsResponse) })]
    public class InvokeOCIVirtualNetworkBulkUpdatePrivateIps : OCIVirtualNetworkCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new BulkUpdatePrivateIpsRequest
                {
        ...
        private void HandleOutput(BulkUpdatePrivateIpsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForBulkUpdatePrivateIps(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.BulkUpdatePrivateIps(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private BulkUpdatePrivateIpsResponse response;
