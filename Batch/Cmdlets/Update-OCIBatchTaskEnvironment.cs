...
{
    [Cmdlet("Update", "OCIBatchTaskEnvironment")]
    ...
    public class UpdateOCIBatchTaskEnvironment : OCIBatchComputingCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateBatchTaskEnvironmentRequest
                {
                ...
                response = client.UpdateBatchTaskEnvironment(request).GetAwaiter().GetResult();
        ...
        private UpdateBatchTaskEnvironmentResponse response;
    }
}
