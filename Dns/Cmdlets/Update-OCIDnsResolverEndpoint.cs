...
{
    [Cmdlet("Update", "OCIDnsResolverEndpoint", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.ResolverEndpoint), typeof(Oci.DnsService.Responses.UpdateResolverEndpointResponse) })]
    public class UpdateOCIDnsResolverEndpoint : OCIDnsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The name of the target resolver endpoint.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The name of the target resolver endpoint.", ParameterSetName = Default)]
        public string ResolverEndpointName { get; set; }

        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"New data for the resolver endpoint. This parameter also accepts subtype <Oci.DnsService.Models.UpdateResolverVnicEndpointDetails> of type <Oci.DnsService.Models.UpdateResolverEndpointDetails>.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"New data for the resolver endpoint. This parameter also accepts subtype <Oci.DnsService.Models.UpdateResolverVnicEndpointDetails> of type <Oci.DnsService.Models.UpdateResolverEndpointDetails>.", ParameterSetName = Default)]
        ...
        private void HandleOutput(UpdateResolverEndpointRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateResolverEndpoint(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpdateResolverEndpoint(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.ResolverEndpoint);
        }

        private UpdateResolverEndpointResponse response;
