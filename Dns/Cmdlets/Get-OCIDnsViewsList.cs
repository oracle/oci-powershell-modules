...
{
    [Cmdlet("Get", "OCIDnsViewsList")]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.ViewSummary), typeof(Oci.DnsService.Responses.ListViewsResponse) })]
    public class GetOCIDnsViewsList : OCIDnsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field by which to sort views.")]
        public System.Nullable<Oci.DnsService.Requests.ListViewsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The state of a resource.")]
        public System.Nullable<Oci.DnsService.Models.ViewSummary.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListViewsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListViewsResponse> DefaultRequest(ListViewsRequest request) => Enumerable.Repeat(client.ListViews(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListViewsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListViewsResponse response;
        private delegate IEnumerable<ListViewsResponse> RequestDelegate(ListViewsRequest request);
