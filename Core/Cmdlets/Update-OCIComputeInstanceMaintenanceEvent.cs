...
{
    [Cmdlet("Update", "OCIComputeInstanceMaintenanceEvent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.UpdateInstanceMaintenanceEventResponse) })]
    public class UpdateOCIComputeInstanceMaintenanceEvent : OCIComputeCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the instance maintenance event.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the instance maintenance event.", ParameterSetName = Default)]
        public string InstanceMaintenanceEventId { get; set; }

        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Update instance maintenance event due date.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Update instance maintenance event due date.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateInstanceMaintenanceEventRequest
                {
        ...
        private void HandleOutput(UpdateInstanceMaintenanceEventRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateInstanceMaintenanceEvent(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpdateInstanceMaintenanceEvent(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private UpdateInstanceMaintenanceEventResponse response;
