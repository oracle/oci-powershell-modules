...
{
    [Cmdlet("Get", "OCIOceInstanceWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OceService.Models.WorkRequest), typeof(Oci.OceService.Responses.GetWorkRequestResponse) })]
    public class GetOCIOceInstanceWorkRequest : OCIOceInstanceCmdlet
    {
        ...
        public Oci.OceService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
