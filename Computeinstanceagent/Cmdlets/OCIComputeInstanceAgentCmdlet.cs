...
{
    public abstract class OCIComputeInstanceAgentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ComputeInstanceAgentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ComputeInstanceAgentClient client;
