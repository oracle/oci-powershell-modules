...
{
    [Cmdlet("Remove", "OCIDataintegrationTaskSchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataintegrationService.Responses.DeleteTaskScheduleResponse) })]
    public class RemoveOCIDataintegrationTaskSchedule : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataintegrationTaskSchedule", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteTaskScheduleRequest
                {
                ...
                response = client.DeleteTaskSchedule(request).GetAwaiter().GetResult();
        ...
        private DeleteTaskScheduleResponse response;
    }
}
