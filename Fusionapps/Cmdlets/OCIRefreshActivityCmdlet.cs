...
{
    public abstract class OCIRefreshActivityCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new RefreshActivityClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected RefreshActivityClient client;
