...
using Oci.AccessgovernancecpService;

namespace Oci.AccessgovernancecpService.Cmdlets
{
    public abstract class OCIAccessGovernanceCPCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AccessGovernanceCPClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AccessGovernanceCPClient client;
