...
{
    [Cmdlet("Remove", "OCIStreamAdminConnectHarness", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.StreamingService.Responses.DeleteConnectHarnessResponse) })]
    public class RemoveOCIStreamAdminConnectHarness : OCIStreamAdminCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIStreamAdminConnectHarness", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteConnectHarnessRequest
                {
        ...
        private DeleteConnectHarnessResponse response;
    }
}
