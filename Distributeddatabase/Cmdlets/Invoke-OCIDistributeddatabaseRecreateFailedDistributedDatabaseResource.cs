...
{
    [Cmdlet("Invoke", "OCIDistributeddatabaseRecreateFailedDistributedDatabaseResource")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.RecreateFailedDistributedDatabaseResourceResponse) })]
    public class InvokeOCIDistributeddatabaseRecreateFailedDistributedDatabaseResource : OCIDistributedDbServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.RecreateFailedDistributedDatabaseResource(request).GetAwaiter().GetResult();
        ...
        private RecreateFailedDistributedDatabaseResourceResponse response;
    }
}
