...
{
    [Cmdlet("Get", "OCILoganalyticsWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.LoganalyticsService.Models.WorkRequest), typeof(Oci.LoganalyticsService.Responses.GetWorkRequestResponse) })]
    public class GetOCILoganalyticsWorkRequest : OCILogAnalyticsCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The Log Analytics namespace used for the request. The namespace can be obtained by running 'oci os ns get'", ParameterSetName = StatusParamSet)]
        ...
        public Oci.LoganalyticsService.Models.OperationStatus[] WaitForStatus { get; set; }
