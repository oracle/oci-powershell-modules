...
{
    [Cmdlet("Update", "OCICertificatesmanagementCertificate")]
    [OutputType(new System.Type[] { typeof(Oci.CertificatesmanagementService.Models.Certificate), typeof(Oci.CertificatesmanagementService.Responses.UpdateCertificateResponse) })]
    public class UpdateOCICertificatesmanagementCertificate : OCICertificatesManagementCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the certificate.")]
        public string CertificateId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details of the request to update a certificate.")]
