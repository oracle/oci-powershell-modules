...
{
    [Cmdlet("Remove", "OCIIdentitydomainsCloudGate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteCloudGateResponse) })]
    public class RemoveOCIIdentitydomainsCloudGate : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsCloudGate", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteCloudGateRequest
                {
                ...
                response = client.DeleteCloudGate(request).GetAwaiter().GetResult();
        ...
        private DeleteCloudGateResponse response;
    }
}
