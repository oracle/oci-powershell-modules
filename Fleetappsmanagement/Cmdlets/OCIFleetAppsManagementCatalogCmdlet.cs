...
{
    public abstract class OCIFleetAppsManagementCatalogCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new FleetAppsManagementCatalogClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected FleetAppsManagementCatalogClient client;
