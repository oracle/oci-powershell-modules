...
{
    [Cmdlet("Get", "OCICloudbridgeWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.CloudbridgeService.Models.WorkRequestSummaryCollection), typeof(Oci.CloudbridgeService.Responses.ListWorkRequestsResponse) })]
    public class GetOCICloudbridgeWorkRequestsList : OCICommonCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only resources for which the lifecycleState matches the given OperationStatus.")]
        public System.Nullable<Oci.CloudbridgeService.Models.OperationStatus> Status { get; set; }
        ...
        public System.Nullable<Oci.CloudbridgeService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }
