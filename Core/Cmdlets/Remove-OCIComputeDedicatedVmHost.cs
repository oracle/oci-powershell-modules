...
{
    [Cmdlet("Remove", "OCIComputeDedicatedVmHost", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.DeleteDedicatedVmHostResponse) })]
    public class RemoveOCIComputeDedicatedVmHost : OCIComputeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIComputeDedicatedVmHost", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDedicatedVmHostRequest
                {
        ...
        private void HandleOutput(DeleteDedicatedVmHostRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteDedicatedVmHost(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteDedicatedVmHost(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteDedicatedVmHostResponse response;
