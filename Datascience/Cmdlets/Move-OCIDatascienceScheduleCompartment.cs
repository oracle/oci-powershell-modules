...
{
    [Cmdlet("Move", "OCIDatascienceScheduleCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatascienceService.Responses.ChangeScheduleCompartmentResponse) })]
    public class MoveOCIDatascienceScheduleCompartment : OCIDataScienceCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"unique Schedule identifier")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeScheduleCompartmentRequest
                {
                ...
                response = client.ChangeScheduleCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeScheduleCompartmentResponse response;
    }
}
