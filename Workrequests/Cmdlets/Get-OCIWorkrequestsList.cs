...
{
    [Cmdlet("Get", "OCIWorkrequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.WorkrequestsService.Models.WorkRequestSummary), typeof(Oci.WorkrequestsService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIWorkrequestsList : OCIWorkRequestCmdlet
    {
