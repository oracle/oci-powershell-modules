...
{
    [Cmdlet("Update", "OCIApigatewayCertificate")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApigatewayService.Responses.UpdateCertificateResponse) })]
    public class UpdateOCIApigatewayCertificate : OCIApiGatewayCmdlet
    {
