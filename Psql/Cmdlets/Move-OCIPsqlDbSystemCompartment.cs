...
{
    [Cmdlet("Move", "OCIPsqlDbSystemCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.PsqlService.Responses.ChangeDbSystemCompartmentResponse) })]
    public class MoveOCIPsqlDbSystemCompartment : OCIPostgresqlCmdlet
    {
