...
{
    [Cmdlet("Enable", "OCIDatascienceSchedule")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatascienceService.Responses.ActivateScheduleResponse) })]
    public class EnableOCIDatascienceSchedule : OCIDataScienceCmdlet
    {
