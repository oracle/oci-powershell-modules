...
{
    [Cmdlet("Get", "OCIDevopsBuildRunsList")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.BuildRunSummaryCollection), typeof(Oci.DevopsService.Responses.ListBuildRunsResponse) })]
    public class GetOCIDevopsBuildRunsList : OCIDevopsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only build runs that matches the given lifecycle state.")]
        public System.Nullable<Oci.DevopsService.Models.BuildRun.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.DevopsService.Requests.ListBuildRunsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListBuildRunsRequest
                {
                    Id = Id,
                ...
                IEnumerable<ListBuildRunsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.BuildRunSummaryCollection, true);
                }
        ...
        {
            IEnumerable<ListBuildRunsResponse> DefaultRequest(ListBuildRunsRequest request) => Enumerable.Repeat(client.ListBuildRuns(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListBuildRunsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListBuildRunsResponse response;
        private delegate IEnumerable<ListBuildRunsResponse> RequestDelegate(ListBuildRunsRequest request);
