...
{
    [Cmdlet("New", "OCIGenerativeaiPrivateEndpoint")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.GenerativeAiPrivateEndpoint), typeof(Oci.GenerativeaiService.Responses.CreateGenerativeAiPrivateEndpointResponse) })]
    public class NewOCIGenerativeaiPrivateEndpoint : OCIGenerativeAiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateGenerativeAiPrivateEndpointRequest
                {
                ...
                response = client.CreateGenerativeAiPrivateEndpoint(request).GetAwaiter().GetResult();
        ...
        private CreateGenerativeAiPrivateEndpointResponse response;
    }
}
