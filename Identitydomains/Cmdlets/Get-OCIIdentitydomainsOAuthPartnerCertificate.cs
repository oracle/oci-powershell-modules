...
{
    [Cmdlet("Get", "OCIIdentitydomainsOAuthPartnerCertificate")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.OAuthPartnerCertificate), typeof(Oci.IdentitydomainsService.Responses.GetOAuthPartnerCertificateResponse) })]
    public class GetOCIIdentitydomainsOAuthPartnerCertificate : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOAuthPartnerCertificateRequest
                {
                ...
                response = client.GetOAuthPartnerCertificate(request).GetAwaiter().GetResult();
        ...
        private GetOAuthPartnerCertificateResponse response;
    }
}
