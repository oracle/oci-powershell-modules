...
{
    [Cmdlet("Get", "OCIWaasCaptchasList")]
    [OutputType(new System.Type[] { typeof(Oci.WaasService.Models.Captcha), typeof(Oci.WaasService.Responses.ListCaptchasResponse) })]
    public class GetOCIWaasCaptchasList : OCIWaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListCaptchasRequest
                {
                ...
                IEnumerable<ListCaptchasResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListCaptchasResponse> DefaultRequest(ListCaptchasRequest request) => Enumerable.Repeat(client.ListCaptchas(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListCaptchasResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListCaptchasResponse response;
        private delegate IEnumerable<ListCaptchasResponse> RequestDelegate(ListCaptchasRequest request);
