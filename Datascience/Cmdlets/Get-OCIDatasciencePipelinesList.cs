...
{
    [Cmdlet("Get", "OCIDatasciencePipelinesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.PipelineSummary), typeof(Oci.DatascienceService.Responses.ListPipelinesResponse) })]
    public class GetOCIDatasciencePipelinesList : OCIDataScienceCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The current state of the Pipeline.")]
        public System.Nullable<Oci.DatascienceService.Models.PipelineLifecycleState> LifecycleState { get; set; }
...
See [List Pagination](https://docs.oracle.com/iaas/Content/General/Concepts/usingapi.htm#nine).")]
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListPipelinesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListPipelinesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListPipelinesResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListPipelinesResponse> DefaultRequest(ListPipelinesRequest request) => Enumerable.Repeat(client.ListPipelines(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListPipelinesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListPipelinesResponse response;
        private delegate IEnumerable<ListPipelinesResponse> RequestDelegate(ListPipelinesRequest request);
