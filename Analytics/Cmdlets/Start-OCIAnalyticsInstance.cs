...
{
    [Cmdlet("Start", "OCIAnalyticsInstance")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AnalyticsService.Responses.StartAnalyticsInstanceResponse) })]
    public class StartOCIAnalyticsInstance : OCIAnalyticsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartAnalyticsInstanceRequest
                {
                ...
                response = client.StartAnalyticsInstance(request).GetAwaiter().GetResult();
        ...
        private StartAnalyticsInstanceResponse response;
    }
}
