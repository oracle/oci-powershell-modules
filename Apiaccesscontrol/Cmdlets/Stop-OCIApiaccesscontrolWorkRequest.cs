...
{
    [Cmdlet("Stop", "OCIApiaccesscontrolWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ApiaccesscontrolService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIApiaccesscontrolWorkRequest : OCIPrivilegedApiWorkRequestCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIApiaccesscontrolWorkRequest", "Stop"))
            {
               return;
            }
