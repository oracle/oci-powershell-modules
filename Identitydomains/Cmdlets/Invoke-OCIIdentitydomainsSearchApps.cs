...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchApps")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Apps), typeof(Oci.IdentitydomainsService.Responses.SearchAppsResponse) })]
    public class InvokeOCIIdentitydomainsSearchApps : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching Apps")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.SearchApps(request).GetAwaiter().GetResult();
                WriteOutput(response, response.Apps);
        ...
        private SearchAppsResponse response;
    }
}
