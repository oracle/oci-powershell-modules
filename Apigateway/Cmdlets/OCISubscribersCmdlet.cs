...
{
    public abstract class OCISubscribersCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new SubscribersClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected SubscribersClient client;
