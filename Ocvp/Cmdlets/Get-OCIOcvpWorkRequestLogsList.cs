...
{
    [Cmdlet("Get", "OCIOcvpWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.OcvpService.Models.WorkRequestLogEntryCollection), typeof(Oci.OcvpService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIOcvpWorkRequestLogsList : OCIWorkRequestCmdlet
    {
