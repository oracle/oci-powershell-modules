...
{
    [Cmdlet("Get", "OCIOdaInstance", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.OdaInstance), typeof(Oci.OdaService.Responses.GetOdaInstanceResponse) })]
    public class GetOCIOdaInstance : OCIOdaCmdlet
    {
        ...
        public Oci.OdaService.Models.OdaInstance.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOdaInstanceRequest
                {
        ...
        private void HandleOutput(GetOdaInstanceRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForOdaInstance(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetOdaInstance(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.OdaInstance);
        }

        private GetOdaInstanceResponse response;
