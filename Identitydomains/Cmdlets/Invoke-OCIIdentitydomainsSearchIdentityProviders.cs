...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchIdentityProviders")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.IdentityProviders), typeof(Oci.IdentitydomainsService.Responses.SearchIdentityProvidersResponse) })]
    public class InvokeOCIIdentitydomainsSearchIdentityProviders : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching IdentityProviders")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchIdentityProvidersRequest
                {
                ...
                response = client.SearchIdentityProviders(request).GetAwaiter().GetResult();
                WriteOutput(response, response.IdentityProviders);
        ...
        private SearchIdentityProvidersResponse response;
    }
}
