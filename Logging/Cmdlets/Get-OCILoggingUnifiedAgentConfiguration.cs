...
{
    [Cmdlet("Get", "OCILoggingUnifiedAgentConfiguration", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.LoggingService.Models.UnifiedAgentConfiguration), typeof(Oci.LoggingService.Responses.GetUnifiedAgentConfigurationResponse) })]
    public class GetOCILoggingUnifiedAgentConfiguration : OCILoggingManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetUnifiedAgentConfigurationRequest
                {
        ...
        private void HandleOutput(GetUnifiedAgentConfigurationRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForUnifiedAgentConfiguration(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetUnifiedAgentConfiguration(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.UnifiedAgentConfiguration);
        }

        private GetUnifiedAgentConfigurationResponse response;
