...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchIdentitySettings")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.IdentitySettings), typeof(Oci.IdentitydomainsService.Responses.SearchIdentitySettingsResponse) })]
    public class InvokeOCIIdentitydomainsSearchIdentitySettings : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching IdentitySettings")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchIdentitySettingsRequest
                {
                ...
                response = client.SearchIdentitySettings(request).GetAwaiter().GetResult();
        ...
        private SearchIdentitySettingsResponse response;
    }
}
