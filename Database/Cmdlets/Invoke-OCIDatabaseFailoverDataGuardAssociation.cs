...
{
    [Cmdlet("Invoke", "OCIDatabaseFailoverDataGuardAssociation", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.DataGuardAssociation), typeof(Oci.DatabaseService.Responses.FailoverDataGuardAssociationResponse) })]
    public class InvokeOCIDatabaseFailoverDataGuardAssociation : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A request to perform a failover, transitioning a standby database into a primary database.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A request to perform a failover, transitioning a standby database into a primary database.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new FailoverDataGuardAssociationRequest
                {
        ...
        private FailoverDataGuardAssociationResponse response;
