...
{
    [Cmdlet("Remove", "OCIDatacatalogPattern", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatacatalogService.Responses.DeletePatternResponse) })]
    public class RemoveOCIDatacatalogPattern : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatacatalogPattern", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeletePattern(request).GetAwaiter().GetResult();
        ...
        private DeletePatternResponse response;
    }
}
