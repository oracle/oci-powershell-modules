...
{
    [Cmdlet("Get", "OCIOpensearchWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.OpensearchService.Models.WorkRequestCollection), typeof(Oci.OpensearchService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIOpensearchWorkRequestsList : OCIOpensearchClusterCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID of the source resource to list work requests.")]
