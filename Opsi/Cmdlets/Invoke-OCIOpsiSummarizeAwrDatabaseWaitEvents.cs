...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeAwrDatabaseWaitEvents")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.AwrDatabaseWaitEventCollection), typeof(Oci.OpsiService.Responses.SummarizeAwrDatabaseWaitEventsResponse) })]
    public class InvokeOCIOpsiSummarizeAwrDatabaseWaitEvents : OCIOperationsInsightsCmdlet
    {
        ...
        public System.Nullable<Oci.OpsiService.Requests.SummarizeAwrDatabaseWaitEventsRequest.SessionTypeEnum> SessionType { get; set; }
        ...
        public System.Nullable<Oci.OpsiService.Requests.SummarizeAwrDatabaseWaitEventsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeAwrDatabaseWaitEventsRequest
                {
                    AwrHubId = AwrHubId,
                ...
                response = client.SummarizeAwrDatabaseWaitEvents(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AwrDatabaseWaitEventCollection);
        ...
        private SummarizeAwrDatabaseWaitEventsResponse response;
    }
}
