...
{
    [Cmdlet("Get", "OCIRedisWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.RedisService.Models.WorkRequest), typeof(Oci.RedisService.Responses.GetWorkRequestResponse) })]
    public class GetOCIRedisWorkRequest : OCIRedisClusterCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The the asynchronous request ID.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The the asynchronous request ID.", ParameterSetName = Default)]
        ...
        public Oci.RedisService.Models.OperationStatus[] WaitForStatus { get; set; }
