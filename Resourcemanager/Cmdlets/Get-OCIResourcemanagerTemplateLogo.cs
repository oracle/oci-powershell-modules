...
namespace Oci.ResourcemanagerService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIResourcemanagerTemplateLogo", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.ResourcemanagerService.Responses.GetTemplateLogoResponse) })]
    public class GetOCIResourcemanagerTemplateLogo : OCIResourceManagerCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetTemplateLogoRequest
                {
                    TemplateId = TemplateId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetTemplateLogo(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetTemplateLogoResponse response;
