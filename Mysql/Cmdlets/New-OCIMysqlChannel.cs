...
{
    [Cmdlet("New", "OCIMysqlChannel")]
    [OutputType(new System.Type[] { typeof(Oci.MysqlService.Models.Channel), typeof(Oci.MysqlService.Responses.CreateChannelResponse) })]
    public class NewOCIMysqlChannel : OCIChannelsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The parameters of the request to create the Channel.")]
