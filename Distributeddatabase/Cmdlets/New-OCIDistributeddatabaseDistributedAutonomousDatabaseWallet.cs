...
namespace Oci.DistributeddatabaseService.Cmdlets
{
     ...
     */
    [Cmdlet("New", "OCIDistributeddatabaseDistributedAutonomousDatabaseWallet", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DistributeddatabaseService.Responses.GenerateDistributedAutonomousDatabaseWalletResponse) })]
    public class NewOCIDistributeddatabaseDistributedAutonomousDatabaseWallet : OCIDistributedAutonomousDbServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for generating Globally distributed autonomous database wallet.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GenerateDistributedAutonomousDatabaseWalletRequest
                {
                ...
                response = client.GenerateDistributedAutonomousDatabaseWallet(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GenerateDistributedAutonomousDatabaseWalletResponse response;
