...
{
    [Cmdlet("Get", "OCIApmcontrolplaneWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.ApmcontrolplaneService.Models.WorkRequestLogEntry), typeof(Oci.ApmcontrolplaneService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIApmcontrolplaneWorkRequestLogsList : OCIApmDomainCmdlet
    {
