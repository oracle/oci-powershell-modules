...
{
    [Cmdlet("Invoke", "OCIFilestoragePauseFilesystemSnapshotPolicy")]
    [OutputType(new System.Type[] { typeof(Oci.FilestorageService.Models.FilesystemSnapshotPolicy), typeof(Oci.FilestorageService.Responses.PauseFilesystemSnapshotPolicyResponse) })]
    public class InvokeOCIFilestoragePauseFilesystemSnapshotPolicy : OCIFileStorageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new PauseFilesystemSnapshotPolicyRequest
                {
                ...
                response = client.PauseFilesystemSnapshotPolicy(request).GetAwaiter().GetResult();
        ...
        private PauseFilesystemSnapshotPolicyResponse response;
    }
}
