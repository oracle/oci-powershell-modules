...
try {
    ...
    #Create Topic
    Write-Host "New-OCINotificationControlPlaneTopic -CreateTopicDetails $CreateTopicDetails"
    $Topic = New-OCINotificationControlPlaneTopic -CreateTopicDetails $CreateTopicDetails 
    ...
    if ($null -ne $Topic.TopicId) {
        Write-Host "Remove-OCINotificationControlPlaneTopic -TopicId $Topic.TopicId"
        Remove-OCINotificationControlPlaneTopic -TopicId $Topic.TopicId
