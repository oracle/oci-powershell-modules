...
{
    [Cmdlet("Add", "OCIApigatewayUsagePlanLock")]
    [OutputType(new System.Type[] { typeof(Oci.ApigatewayService.Models.UsagePlan), typeof(Oci.ApigatewayService.Responses.AddUsagePlanLockResponse) })]
    public class AddOCIApigatewayUsagePlanLock : OCIUsagePlansCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddUsagePlanLockRequest
                {
                ...
                response = client.AddUsagePlanLock(request).GetAwaiter().GetResult();
        ...
        private AddUsagePlanLockResponse response;
    }
}
