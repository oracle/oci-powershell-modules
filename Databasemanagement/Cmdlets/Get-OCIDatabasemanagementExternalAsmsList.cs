...
{
    [Cmdlet("Get", "OCIDatabasemanagementExternalAsmsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.ExternalAsmCollection), typeof(Oci.DatabasemanagementService.Responses.ListExternalAsmsResponse) })]
    public class GetOCIDatabasemanagementExternalAsmsList : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListExternalAsmsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListExternalAsmsRequest
                {
                ...
                IEnumerable<ListExternalAsmsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.ExternalAsmCollection, true);
                }
        ...
        {
            IEnumerable<ListExternalAsmsResponse> DefaultRequest(ListExternalAsmsRequest request) => Enumerable.Repeat(client.ListExternalAsms(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListExternalAsmsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListExternalAsmsResponse response;
        private delegate IEnumerable<ListExternalAsmsResponse> RequestDelegate(ListExternalAsmsRequest request);
