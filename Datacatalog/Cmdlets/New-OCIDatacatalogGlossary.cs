...
{
    [Cmdlet("New", "OCIDatacatalogGlossary")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Glossary), typeof(Oci.DatacatalogService.Responses.CreateGlossaryResponse) })]
    public class NewOCIDatacatalogGlossary : OCIDataCatalogCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique catalog identifier.")]
        public string CatalogId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information used to create the glossary.")]
        ...
        private CreateGlossaryResponse response;
    }
}
