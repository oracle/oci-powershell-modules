...
{
    [Cmdlet("Remove", "OCIDatacatalogNamespace", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatacatalogService.Responses.DeleteNamespaceResponse) })]
    public class RemoveOCIDatacatalogNamespace : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatacatalogNamespace", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteNamespace(request).GetAwaiter().GetResult();
        ...
        private DeleteNamespaceResponse response;
    }
}
