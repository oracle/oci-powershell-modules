...
{
    [Cmdlet("Move", "OCIGenerativeaiHostedApplicationStorageCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.GenerativeaiService.Responses.ChangeHostedApplicationStorageCompartmentResponse) })]
    public class MoveOCIGenerativeaiHostedApplicationStorageCompartment : OCIGenerativeAiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeHostedApplicationStorageCompartmentRequest
                {
                ...
                response = client.ChangeHostedApplicationStorageCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeHostedApplicationStorageCompartmentResponse response;
    }
}
