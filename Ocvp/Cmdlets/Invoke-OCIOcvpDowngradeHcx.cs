...
{
    [Cmdlet("Invoke", "OCIOcvpDowngradeHcx")]
    ...
    public class InvokeOCIOcvpDowngradeHcx : OCISddcCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DowngradeHcxRequest
                {
                ...
                response = client.DowngradeHcx(request).GetAwaiter().GetResult();
        ...
        private DowngradeHcxResponse response;
    }
}
