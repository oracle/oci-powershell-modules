...
{
    [Cmdlet("Get", "OCIComputeImagesList")]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.Image), typeof(Oci.CoreService.Responses.ListImagesResponse) })]
    public class GetOCIComputeImagesList : OCIComputeCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The image's operating system.

Example: `Oracle Linux`")]
        public string OperatingSystem { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The image's operating system version.
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by availability domain if the scope of the resource type is within a single availability domain. If you call one of these ""List"" operations without specifying an availability domain, the resources are grouped by availability domain, then sorted.")]
        public System.Nullable<Oci.CoreService.Requests.ListImagesRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Requests.ListImagesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Models.Image.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListImagesResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListImagesResponse> DefaultRequest(ListImagesRequest request) => Enumerable.Repeat(client.ListImages(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListImagesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListImagesResponse response;
        private delegate IEnumerable<ListImagesResponse> RequestDelegate(ListImagesRequest request);
