...
{
    public abstract class OCIStackMonitoringCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new StackMonitoringClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected StackMonitoringClient client;
