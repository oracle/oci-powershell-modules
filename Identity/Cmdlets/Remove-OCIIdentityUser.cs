...
{
    [Cmdlet("Remove", "OCIIdentityUser", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentityService.Responses.DeleteUserResponse) })]
    public class RemoveOCIIdentityUser : OCIIdentityCmdlet
    {
