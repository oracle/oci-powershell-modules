...
{
    public abstract class OCIDashboardCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DashboardClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
