...
{
    [Cmdlet("Disable", "OCIOpsiAutonomousDatabaseInsightAdvancedFeatures")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.DisableAutonomousDatabaseInsightAdvancedFeaturesResponse) })]
    public class DisableOCIOpsiAutonomousDatabaseInsightAdvancedFeatures : OCIOperationsInsightsCmdlet
    {
...
*Note:* Retry tokens can be invalidated before the 24 hour time limit due to conflicting operations, such as a resource being deleted or purged from the system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableAutonomousDatabaseInsightAdvancedFeaturesRequest
                {
                ...
                response = client.DisableAutonomousDatabaseInsightAdvancedFeatures(request).GetAwaiter().GetResult();
        ...
        private DisableAutonomousDatabaseInsightAdvancedFeaturesResponse response;
    }
}
