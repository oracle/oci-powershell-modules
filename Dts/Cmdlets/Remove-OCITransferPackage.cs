...
{
    [Cmdlet("Remove", "OCITransferPackage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DtsService.Responses.DeleteTransferPackageResponse) })]
    public class RemoveOCITransferPackage : OCITransferPackageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCITransferPackage", "Remove"))
            {
               return;
            }
