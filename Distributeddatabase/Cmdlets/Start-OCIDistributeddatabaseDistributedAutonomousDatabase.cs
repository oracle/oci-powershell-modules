...
{
    [Cmdlet("Start", "OCIDistributeddatabaseDistributedAutonomousDatabase")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.StartDistributedAutonomousDatabaseResponse) })]
    public class StartOCIDistributeddatabaseDistributedAutonomousDatabase : OCIDistributedAutonomousDbServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartDistributedAutonomousDatabaseRequest
                {
                ...
                response = client.StartDistributedAutonomousDatabase(request).GetAwaiter().GetResult();
        ...
        private StartDistributedAutonomousDatabaseResponse response;
    }
}
