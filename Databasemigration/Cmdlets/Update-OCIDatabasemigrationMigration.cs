...
{
    [Cmdlet("Update", "OCIDatabasemigrationMigration")]
    ...
    public class UpdateOCIDatabasemigrationMigration : OCIDatabaseMigrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Migration properties. This parameter also accepts subtypes <Oci.DatabasemigrationService.Models.UpdateMySqlMigrationDetails>, <Oci.DatabasemigrationService.Models.UpdateOracleMigrationDetails> of type <Oci.DatabasemigrationService.Models.UpdateMigrationDetails>.")]
