...
{
    [Cmdlet("Get", "OCIOpsiAwrDatabaseSnapshotsList")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.AwrDatabaseSnapshotCollection), typeof(Oci.OpsiService.Responses.ListAwrDatabaseSnapshotsResponse) })]
    public class GetOCIOpsiAwrDatabaseSnapshotsList : OCIOperationsInsightsCmdlet
    {
        ...
        public System.Nullable<Oci.OpsiService.Requests.ListAwrDatabaseSnapshotsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAwrDatabaseSnapshotsRequest
                {
                    AwrHubId = AwrHubId,
                ...
                response = client.ListAwrDatabaseSnapshots(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AwrDatabaseSnapshotCollection);
        ...
        private ListAwrDatabaseSnapshotsResponse response;
    }
}
