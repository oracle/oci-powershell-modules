...
GUID = '47ef84d0-f57d-4c44-9de3-9f287028b65c'
...
CmdletsToExport = 'Get-OCIFunctionsManagementApplication', 
               'Get-OCIFunctionsManagementApplicationsList', 
               'Get-OCIFunctionsManagementFunction', 
               'Get-OCIFunctionsManagementFunctionsList', 
               'Invoke-OCIFunctionsInvokeFunction', 
               'Move-OCIFunctionsManagementApplicationCompartment', 
               'New-OCIFunctionsManagementApplication', 
               'New-OCIFunctionsManagementFunction', 
               'Remove-OCIFunctionsManagementApplication', 
               'Remove-OCIFunctionsManagementFunction', 
               'Update-OCIFunctionsManagementApplication', 
               'Update-OCIFunctionsManagementFunction'
