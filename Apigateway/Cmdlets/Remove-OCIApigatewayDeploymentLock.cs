...
{
    [Cmdlet("Remove", "OCIApigatewayDeploymentLock")]
    [OutputType(new System.Type[] { typeof(Oci.ApigatewayService.Models.Deployment), typeof(Oci.ApigatewayService.Responses.RemoveDeploymentLockResponse) })]
    public class RemoveOCIApigatewayDeploymentLock : OCIDeploymentCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ocid of the deployment.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveDeploymentLockRequest
                {
                ...
                response = client.RemoveDeploymentLock(request).GetAwaiter().GetResult();
        ...
        private RemoveDeploymentLockResponse response;
    }
}
