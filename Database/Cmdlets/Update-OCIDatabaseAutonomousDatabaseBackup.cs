...
namespace Oci.DatabaseService.Cmdlets
{
    ...
    public class UpdateOCIDatabaseAutonomousDatabaseBackup : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the Autonomous AI Database backup.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the Autonomous AI Database backup.", ParameterSetName = Default)]
