...
namespace Oci.OsmanagementhubService.Cmdlets
{
    ...
    public class GetOCIOsmanagementhubLifecycleStagesList : OCILifecycleEnvironmentCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the lifecycle stage.")]
