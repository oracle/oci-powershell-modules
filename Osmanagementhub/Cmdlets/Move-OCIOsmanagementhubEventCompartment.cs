...
{
    [Cmdlet("Move", "OCIOsmanagementhubEventCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OsmanagementhubService.Responses.ChangeEventCompartmentResponse) })]
    public class MoveOCIOsmanagementhubEventCompartment : OCIEventCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifies the compartment to move the event to.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeEventCompartmentRequest
                {
                ...
                response = client.ChangeEventCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeEventCompartmentResponse response;
    }
}
