...
{
    [Cmdlet("Invoke", "OCIResourcemanagerDetectStackDrift")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ResourcemanagerService.Responses.DetectStackDriftResponse) })]
    public class InvokeOCIResourcemanagerDetectStackDrift : OCIResourceManagerCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DetectStackDriftRequest
                {
                    StackId = StackId,
                    IfMatch = IfMatch,
        ...
        private DetectStackDriftResponse response;
    }
}
