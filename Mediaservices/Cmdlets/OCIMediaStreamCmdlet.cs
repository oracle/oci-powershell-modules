...
{
    public abstract class OCIMediaStreamCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MediaStreamClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MediaStreamClient client;
