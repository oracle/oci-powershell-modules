...
{
    [Cmdlet("Remove", "OCIMysqlHeatWaveCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.DeleteHeatWaveClusterResponse) })]
    public class RemoveOCIMysqlHeatWaveCluster : OCIDbSystemCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIMysqlHeatWaveCluster", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteHeatWaveClusterRequest
                {
                ...
                response = client.DeleteHeatWaveCluster(request).GetAwaiter().GetResult();
        ...
        private DeleteHeatWaveClusterResponse response;
    }
}
