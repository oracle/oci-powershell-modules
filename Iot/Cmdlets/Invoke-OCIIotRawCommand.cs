...
{
    [Cmdlet("Invoke", "OCIIotRawCommand")]
    ...
    public class InvokeOCIIotRawCommand : OCIIotCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new InvokeRawCommandRequest
                {
                ...
                response = client.InvokeRawCommand(request).GetAwaiter().GetResult();
        ...
        private InvokeRawCommandResponse response;
    }
}
