...
{
    [Cmdlet("Move", "OCIDemandsignalOccDemandSignalCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DemandsignalService.Responses.ChangeOccDemandSignalCompartmentResponse) })]
    public class MoveOCIDemandsignalOccDemandSignalCompartment : OCIOccDemandSignalCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeOccDemandSignalCompartmentRequest
                {
                ...
                response = client.ChangeOccDemandSignalCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeOccDemandSignalCompartmentResponse response;
    }
}
