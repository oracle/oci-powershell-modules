...
{
    [Cmdlet("Get", "OCIMysqlAnalyticsCluster", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.MysqlService.Models.AnalyticsCluster), typeof(Oci.MysqlService.Responses.GetAnalyticsClusterResponse) })]
    public class GetOCIMysqlAnalyticsCluster : OCIDbSystemCmdlet
    {
        ...
        public Oci.MysqlService.Models.AnalyticsCluster.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        private GetAnalyticsClusterResponse response;
