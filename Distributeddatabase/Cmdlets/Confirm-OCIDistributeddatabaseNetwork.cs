...
{
    [Cmdlet("Confirm", "OCIDistributeddatabaseNetwork")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.ValidateDistributedDatabaseNetworkResponse) })]
    public class ConfirmOCIDistributeddatabaseNetwork : OCIDistributedDbServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ValidateDistributedDatabaseNetworkRequest
                {
                ...
                response = client.ValidateDistributedDatabaseNetwork(request).GetAwaiter().GetResult();
        ...
        private ValidateDistributedDatabaseNetworkResponse response;
    }
}
