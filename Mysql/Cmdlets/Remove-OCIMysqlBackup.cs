...
{
    [Cmdlet("Remove", "OCIMysqlBackup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCIMysqlBackup : OCIDbBackupsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIMysqlBackup", "Remove"))
            {
               return;
            }
