...
{
    public abstract class OCIDataplaneCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DataplaneClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DataplaneClient client;
