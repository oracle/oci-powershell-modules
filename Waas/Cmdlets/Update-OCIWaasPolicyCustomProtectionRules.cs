...
{
    [Cmdlet("Update", "OCIWaasPolicyCustomProtectionRules")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdateWaasPolicyCustomProtectionRulesResponse) })]
    public class UpdateOCIWaasPolicyCustomProtectionRules : OCIWaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateWaasPolicyCustomProtectionRulesRequest
                {
                ...
                response = client.UpdateWaasPolicyCustomProtectionRules(request).GetAwaiter().GetResult();
        ...
        private UpdateWaasPolicyCustomProtectionRulesResponse response;
    }
}
