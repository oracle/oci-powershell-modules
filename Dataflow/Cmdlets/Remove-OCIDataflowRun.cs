...
{
    [Cmdlet("Remove", "OCIDataflowRun", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataflowService.Responses.DeleteRunResponse) })]
    public class RemoveOCIDataflowRun : OCIDataFlowCmdlet
    {
        ...
        private DeleteRunResponse response;
    }
}
