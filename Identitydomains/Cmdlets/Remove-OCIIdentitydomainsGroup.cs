...
{
    [Cmdlet("Remove", "OCIIdentitydomainsGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteGroupResponse) })]
    public class RemoveOCIIdentitydomainsGroup : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsGroup", "Remove"))
            {
               return;
            }
