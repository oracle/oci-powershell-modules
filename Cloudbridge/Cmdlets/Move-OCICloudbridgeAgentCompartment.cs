...
{
    [Cmdlet("Move", "OCICloudbridgeAgentCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CloudbridgeService.Responses.ChangeAgentCompartmentResponse) })]
    public class MoveOCICloudbridgeAgentCompartment : OCIOcbAgentSvcCmdlet
    {
