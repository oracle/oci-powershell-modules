...
{
    [Cmdlet("Invoke", "OCIDatabaseRescheduleManagedDbSoftwareUpdate", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Database), typeof(Oci.DatabaseService.Responses.RescheduleManagedDbSoftwareUpdateResponse) })]
    public class InvokeOCIDatabaseRescheduleManagedDbSoftwareUpdate : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RescheduleManagedDbSoftwareUpdateRequest
                {
        ...
        private void HandleOutput(RescheduleManagedDbSoftwareUpdateRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRescheduleManagedDbSoftwareUpdate(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RescheduleManagedDbSoftwareUpdate(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.Database);
        }

        private RescheduleManagedDbSoftwareUpdateResponse response;
