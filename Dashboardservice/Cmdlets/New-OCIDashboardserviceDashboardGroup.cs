...
{
    [Cmdlet("New", "OCIDashboardserviceDashboardGroup")]
    [OutputType(new System.Type[] { typeof(Oci.DashboardService.Models.DashboardGroup), typeof(Oci.DashboardService.Responses.CreateDashboardGroupResponse) })]
    public class NewOCIDashboardserviceDashboardGroup : OCIDashboardGroupCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details about the dashboard group being created.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateDashboardGroupRequest
                {
                ...
                response = client.CreateDashboardGroup(request).GetAwaiter().GetResult();
        ...
        private CreateDashboardGroupResponse response;
    }
}
