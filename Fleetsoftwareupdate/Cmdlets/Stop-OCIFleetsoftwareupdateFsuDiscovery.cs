...
{
    [Cmdlet("Stop", "OCIFleetsoftwareupdateFsuDiscovery")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.FleetsoftwareupdateService.Responses.AbortFsuDiscoveryResponse) })]
    public class StopOCIFleetsoftwareupdateFsuDiscovery : OCIFleetSoftwareUpdateCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AbortFsuDiscoveryRequest
                {
                ...
                response = client.AbortFsuDiscovery(request).GetAwaiter().GetResult();
        ...
        private AbortFsuDiscoveryResponse response;
    }
}
