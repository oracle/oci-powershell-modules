...
{
    [Cmdlet("Get", "OCIDevopsRepoFileLines")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.RepositoryFileLines), typeof(Oci.DevopsService.Responses.GetRepoFileLinesResponse) })]
    public class GetOCIDevopsRepoFileLines : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetRepoFileLinesRequest
                {
                ...
                response = client.GetRepoFileLines(request).GetAwaiter().GetResult();
        ...
        private GetRepoFileLinesResponse response;
    }
}
