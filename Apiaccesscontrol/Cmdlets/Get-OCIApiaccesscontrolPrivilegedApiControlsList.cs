...
{
    [Cmdlet("Get", "OCIApiaccesscontrolPrivilegedApiControlsList")]
    ...
    public class GetOCIApiaccesscontrolPrivilegedApiControlsList : OCIPrivilegedApiControlCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the PrivilegedApiControl.")]
        ...
        public System.Nullable<Oci.ApiaccesscontrolService.Models.PrivilegedApiControl.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.ApiaccesscontrolService.Requests.ListPrivilegedApiControlsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListPrivilegedApiControlsRequest
                {
                ...
                IEnumerable<ListPrivilegedApiControlsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.PrivilegedApiControlCollection, true);
                }
        ...
        {
            IEnumerable<ListPrivilegedApiControlsResponse> DefaultRequest(ListPrivilegedApiControlsRequest request) => Enumerable.Repeat(client.ListPrivilegedApiControls(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListPrivilegedApiControlsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListPrivilegedApiControlsResponse response;
        private delegate IEnumerable<ListPrivilegedApiControlsResponse> RequestDelegate(ListPrivilegedApiControlsRequest request);
