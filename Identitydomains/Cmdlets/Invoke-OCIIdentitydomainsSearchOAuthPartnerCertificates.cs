...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchOAuthPartnerCertificates")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.OAuthPartnerCertificates), typeof(Oci.IdentitydomainsService.Responses.SearchOAuthPartnerCertificatesResponse) })]
    public class InvokeOCIIdentitydomainsSearchOAuthPartnerCertificates : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching OAuthPartnerCertificates")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchOAuthPartnerCertificatesRequest
                {
                ...
                response = client.SearchOAuthPartnerCertificates(request).GetAwaiter().GetResult();
                WriteOutput(response, response.OAuthPartnerCertificates);
        ...
        private SearchOAuthPartnerCertificatesResponse response;
    }
}
