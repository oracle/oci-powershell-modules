...
{
    [Cmdlet("Invoke", "OCINotificationDataPlaneResendSubscriptionConfirmation")]
    ...
    public class InvokeOCINotificationDataPlaneResendSubscriptionConfirmation : OCINotificationDataPlaneCmdlet
    {
