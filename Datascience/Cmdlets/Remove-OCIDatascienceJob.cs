...
{
    [Cmdlet("Remove", "OCIDatascienceJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatascienceService.Responses.DeleteJobResponse) })]
    public class RemoveOCIDatascienceJob : OCIDataScienceCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Delete all JobRuns associated with this job.")]
