...
{
    [Cmdlet("Add", "OCIMediaservicesMediaWorkflowLock")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.MediaWorkflow), typeof(Oci.MediaservicesService.Responses.AddMediaWorkflowLockResponse) })]
    public class AddOCIMediaservicesMediaWorkflowLock : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddMediaWorkflowLockRequest
                {
                ...
                response = client.AddMediaWorkflowLock(request).GetAwaiter().GetResult();
        ...
        private AddMediaWorkflowLockResponse response;
    }
}
