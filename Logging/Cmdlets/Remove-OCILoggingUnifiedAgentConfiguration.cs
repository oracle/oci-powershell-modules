...
{
    [Cmdlet("Remove", "OCILoggingUnifiedAgentConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCILoggingUnifiedAgentConfiguration : OCILoggingManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCILoggingUnifiedAgentConfiguration", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteUnifiedAgentConfigurationRequest
                {
                ...
                response = client.DeleteUnifiedAgentConfiguration(request).GetAwaiter().GetResult();
        ...
        private DeleteUnifiedAgentConfigurationResponse response;
    }
}
