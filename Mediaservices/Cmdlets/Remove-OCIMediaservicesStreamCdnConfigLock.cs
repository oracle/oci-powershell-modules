...
{
    [Cmdlet("Remove", "OCIMediaservicesStreamCdnConfigLock")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.StreamCdnConfig), typeof(Oci.MediaservicesService.Responses.RemoveStreamCdnConfigLockResponse) })]
    public class RemoveOCIMediaservicesStreamCdnConfigLock : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveStreamCdnConfigLockRequest
                {
                ...
                response = client.RemoveStreamCdnConfigLock(request).GetAwaiter().GetResult();
        ...
        private RemoveStreamCdnConfigLockResponse response;
    }
}
