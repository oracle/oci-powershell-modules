...
{
    [Cmdlet("Get", "OCIObjectstorageWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.ObjectstorageService.Models.WorkRequestError), typeof(Oci.ObjectstorageService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIObjectstorageWorkRequestErrorsList : OCIObjectStorageCmdlet
    {
