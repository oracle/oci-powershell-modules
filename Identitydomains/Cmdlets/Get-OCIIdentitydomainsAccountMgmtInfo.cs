...
{
    [Cmdlet("Get", "OCIIdentitydomainsAccountMgmtInfo")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.AccountMgmtInfo), typeof(Oci.IdentitydomainsService.Responses.GetAccountMgmtInfoResponse) })]
    public class GetOCIIdentitydomainsAccountMgmtInfo : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetAccountMgmtInfoRequest
                {
                ...
                response = client.GetAccountMgmtInfo(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AccountMgmtInfo);
        ...
        private GetAccountMgmtInfoResponse response;
    }
}
