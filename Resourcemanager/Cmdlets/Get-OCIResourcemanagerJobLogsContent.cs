...
{
    [Cmdlet("Get", "OCIResourcemanagerJobLogsContent")]
    [OutputType(new System.Type[] { typeof(string), typeof(Oci.ResourcemanagerService.Responses.GetJobLogsContentResponse) })]
    public class GetOCIResourcemanagerJobLogsContent : OCIResourceManagerCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetJobLogsContentRequest
                {
                    JobId = JobId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetJobLogsContent(request).GetAwaiter().GetResult();
        ...
        private GetJobLogsContentResponse response;
    }
}
