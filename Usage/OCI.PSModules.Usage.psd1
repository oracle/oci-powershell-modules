...
CmdletsToExport = 'New-OCIUsageRedeemableUser', 'Remove-OCIUsageRedeemableUser', 
               'Get-OCIUsageProductsList', 'Get-OCIUsageRedeemableUsersList', 
               'Get-OCIUsageRewardsList'
