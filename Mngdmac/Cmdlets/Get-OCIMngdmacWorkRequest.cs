...
{
    [Cmdlet("Get", "OCIMngdmacWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.MngdmacService.Models.WorkRequest), typeof(Oci.MngdmacService.Responses.GetWorkRequestResponse) })]
    public class GetOCIMngdmacWorkRequest : OCIMacOrderCmdlet
    {
        ...
        public Oci.MngdmacService.Models.OperationStatus[] WaitForStatus { get; set; }
