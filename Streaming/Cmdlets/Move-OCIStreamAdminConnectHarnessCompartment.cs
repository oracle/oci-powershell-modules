...
{
    [Cmdlet("Move", "OCIStreamAdminConnectHarnessCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.StreamingService.Responses.ChangeConnectHarnessCompartmentResponse) })]
    public class MoveOCIStreamAdminConnectHarnessCompartment : OCIStreamAdminCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The connect harness will be moved into the compartment specified within this entity.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeConnectHarnessCompartmentRequest
                {
        ...
        private ChangeConnectHarnessCompartmentResponse response;
    }
}
