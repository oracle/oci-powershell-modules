...
{
    [Cmdlet("Get", "OCIAianomalydetectionWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.AianomalydetectionService.Models.WorkRequestLogEntryCollection), typeof(Oci.AianomalydetectionService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIAianomalydetectionWorkRequestLogsList : OCIAnomalyDetectionCmdlet
    {
