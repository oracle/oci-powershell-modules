...
{
    [Cmdlet("Get", "OCIComputeInstancesList")]
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by availability domain if the scope of the resource type is within a single availability domain. If you call one of these ""List"" operations without specifying an availability domain, the resources are grouped by availability domain, then sorted.")]
        public System.Nullable<Oci.CoreService.Requests.ListInstancesRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Requests.ListInstancesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Models.Instance.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        {
            IEnumerable<ListInstancesResponse> DefaultRequest(ListInstancesRequest request) => Enumerable.Repeat(client.ListInstances(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListInstancesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListInstancesResponse response;
        private delegate IEnumerable<ListInstancesResponse> RequestDelegate(ListInstancesRequest request);
