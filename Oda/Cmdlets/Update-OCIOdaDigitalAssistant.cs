...
{
    [Cmdlet("Update", "OCIOdaDigitalAssistant")]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.DigitalAssistant), typeof(Oci.OdaService.Responses.UpdateDigitalAssistantResponse) })]
    public class UpdateOCIOdaDigitalAssistant : OCIManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Property values to update the Digital Assistant.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDigitalAssistantRequest
                {
                ...
                response = client.UpdateDigitalAssistant(request).GetAwaiter().GetResult();
        ...
        private UpdateDigitalAssistantResponse response;
    }
}
