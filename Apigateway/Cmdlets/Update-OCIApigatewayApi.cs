...
{
    [Cmdlet("Update", "OCIApigatewayApi")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApigatewayService.Responses.UpdateApiResponse) })]
    public class UpdateOCIApigatewayApi : OCIApiGatewayCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpdateApi(request).GetAwaiter().GetResult();
