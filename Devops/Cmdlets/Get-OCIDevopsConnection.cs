...
{
    [Cmdlet("Get", "OCIDevopsConnection", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.Connection), typeof(Oci.DevopsService.Responses.GetConnectionResponse) })]
    public class GetOCIDevopsConnection : OCIDevopsCmdlet
    {
        ...
        public Oci.DevopsService.Models.Connection.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
