...
{
    [Cmdlet("Invoke", "OCIKeymanagementDownloadCertificateSigningRequest")]
    [OutputType(new System.Type[] { typeof(string), typeof(Oci.KeymanagementService.Responses.DownloadCertificateSigningRequestResponse) })]
    public class InvokeOCIKeymanagementDownloadCertificateSigningRequest : OCIKmsHsmClusterCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DownloadCertificateSigningRequestRequest
                {
                ...
                response = client.DownloadCertificateSigningRequest(request).GetAwaiter().GetResult();
        ...
        private DownloadCertificateSigningRequestResponse response;
    }
}
