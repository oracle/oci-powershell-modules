...
{
    [Cmdlet("Get", "OCINetworkfirewallMappedSecretsList")]
    [OutputType(new System.Type[] { typeof(Oci.NetworkfirewallService.Models.MappedSecretSummaryCollection), typeof(Oci.NetworkfirewallService.Responses.ListMappedSecretsResponse) })]
    public class GetOCINetworkfirewallMappedSecretsList : OCINetworkFirewallCmdlet
    {
        ...
        public System.Nullable<Oci.NetworkfirewallService.Requests.ListMappedSecretsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMappedSecretsRequest
                {
                ...
                IEnumerable<ListMappedSecretsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.MappedSecretSummaryCollection, true);
                }
        ...
        {
            IEnumerable<ListMappedSecretsResponse> DefaultRequest(ListMappedSecretsRequest request) => Enumerable.Repeat(client.ListMappedSecrets(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListMappedSecretsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListMappedSecretsResponse response;
        private delegate IEnumerable<ListMappedSecretsResponse> RequestDelegate(ListMappedSecretsRequest request);
