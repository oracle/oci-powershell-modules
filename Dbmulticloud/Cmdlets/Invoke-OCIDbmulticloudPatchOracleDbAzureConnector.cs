...
{
    [Cmdlet("Invoke", "OCIDbmulticloudPatchOracleDbAzureConnector")]
    ...
    public class InvokeOCIDbmulticloudPatchOracleDbAzureConnector : OCIOracleDBAzureConnectorCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new PatchOracleDbAzureConnectorRequest
                {
                ...
                response = client.PatchOracleDbAzureConnector(request).GetAwaiter().GetResult();
        ...
        private PatchOracleDbAzureConnectorResponse response;
    }
}
