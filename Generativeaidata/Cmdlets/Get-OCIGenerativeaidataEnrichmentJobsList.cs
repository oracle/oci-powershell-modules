...
namespace Oci.GenerativeaidataService.Cmdlets
{
    ...
    public class GetOCIGenerativeaidataEnrichmentJobsList : OCIListEnrichmentJobsCmdlet
    {
        ...
        public System.Nullable<Oci.GenerativeaidataService.Models.LifecycleState> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.GenerativeaidataService.Requests.ListEnrichmentJobsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either 'ASC' or 'DESC'.")]
        public System.Nullable<Oci.GenerativeaidataService.Models.SortOrders> SortOrder { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListEnrichmentJobsRequest
                {
                ...
                IEnumerable<ListEnrichmentJobsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.EnrichmentJobCollection, true);
                }
        ...
        {
            IEnumerable<ListEnrichmentJobsResponse> DefaultRequest(ListEnrichmentJobsRequest request) => Enumerable.Repeat(client.ListEnrichmentJobs(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListEnrichmentJobsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListEnrichmentJobsResponse response;
        private delegate IEnumerable<ListEnrichmentJobsResponse> RequestDelegate(ListEnrichmentJobsRequest request);
