...
{
    [Cmdlet("Move", "OCINosqlTableCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NosqlService.Responses.ChangeTableCompartmentResponse) })]
    public class MoveOCINosqlTableCompartment : OCINosqlCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifications of the source and target compartments.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeTableCompartmentRequest
                {
                ...
                response = client.ChangeTableCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeTableCompartmentResponse response;
    }
}
