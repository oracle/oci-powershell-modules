...
{
    [Cmdlet("Move", "OCIRoverEntitlementCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.RoverService.Responses.ChangeRoverEntitlementCompartmentResponse) })]
    public class MoveOCIRoverEntitlementCompartment : OCIRoverEntitlementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeRoverEntitlementCompartmentRequest
                {
                ...
                response = client.ChangeRoverEntitlementCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeRoverEntitlementCompartmentResponse response;
    }
}
