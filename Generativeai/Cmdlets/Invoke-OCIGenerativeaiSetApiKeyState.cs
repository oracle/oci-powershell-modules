...
{
    [Cmdlet("Invoke", "OCIGenerativeaiSetApiKeyState")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.ApiKey), typeof(Oci.GenerativeaiService.Responses.SetApiKeyStateResponse) })]
    public class InvokeOCIGenerativeaiSetApiKeyState : OCIGenerativeAiCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information for setting key state.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SetApiKeyStateRequest
                {
                    ApiKeyId = ApiKeyId,
                ...
                response = client.SetApiKeyState(request).GetAwaiter().GetResult();
        ...
        private SetApiKeyStateResponse response;
    }
}
