...
namespace Oci.MarketplaceprivateofferService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIMarketplaceprivateofferQuoteAttachmentContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.MarketplaceprivateofferService.Responses.GetQuoteAttachmentContentResponse) })]
    public class GetOCIMarketplaceprivateofferQuoteAttachmentContent : OCIQuoteAttachmentCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetQuoteAttachmentContentRequest
                {
                ...
                response = client.GetQuoteAttachmentContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetQuoteAttachmentContentResponse response;
