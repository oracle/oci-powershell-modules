...
{
    [Cmdlet("Remove", "OCIDataflowPool", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataflowService.Responses.DeletePoolResponse) })]
    public class RemoveOCIDataflowPool : OCIDataFlowCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataflowPool", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeletePool(request).GetAwaiter().GetResult();
        ...
        private DeletePoolResponse response;
    }
}
