...
{
    [Cmdlet("Get", "OCIOpsiOperationsInsightsWarehouse", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.OperationsInsightsWarehouse), typeof(Oci.OpsiService.Responses.GetOperationsInsightsWarehouseResponse) })]
    public class GetOCIOpsiOperationsInsightsWarehouse : OCIOperationsInsightsCmdlet
    {
        ...
        public Oci.OpsiService.Models.OperationsInsightsWarehouseLifecycleState[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOperationsInsightsWarehouseRequest
                {
        ...
        private void HandleOutput(GetOperationsInsightsWarehouseRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForOperationsInsightsWarehouse(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetOperationsInsightsWarehouse(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.OperationsInsightsWarehouse);
        }

        private GetOperationsInsightsWarehouseResponse response;
