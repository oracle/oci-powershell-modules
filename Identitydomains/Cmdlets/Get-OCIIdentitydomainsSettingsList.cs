...
{
    [Cmdlet("Get", "OCIIdentitydomainsSettingsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Settings), typeof(Oci.IdentitydomainsService.Responses.ListSettingsResponse) })]
    public class GetOCIIdentitydomainsSettingsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ListSettings(request).GetAwaiter().GetResult();
        ...
        private ListSettingsResponse response;
    }
}
