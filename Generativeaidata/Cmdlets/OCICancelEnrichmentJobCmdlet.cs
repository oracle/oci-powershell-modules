...
{
    public abstract class OCICancelEnrichmentJobCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new CancelEnrichmentJobClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected CancelEnrichmentJobClient client;
