...
{
    [Cmdlet("Get", "OCIBlockstorageVolumeGroupReplicasList")]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.VolumeGroupReplica), typeof(Oci.CoreService.Responses.ListVolumeGroupReplicasResponse) })]
    public class GetOCIBlockstorageVolumeGroupReplicasList : OCIBlockstorageCmdlet
    {
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by availability domain if the scope of the resource type is within a single availability domain. If you call one of these ""List"" operations without specifying an availability domain, the resources are grouped by availability domain, then sorted.")]
        public System.Nullable<Oci.CoreService.Requests.ListVolumeGroupReplicasRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Requests.ListVolumeGroupReplicasRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Models.VolumeGroupReplica.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListVolumeGroupReplicasRequest
                {
                ...
                IEnumerable<ListVolumeGroupReplicasResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListVolumeGroupReplicasResponse> DefaultRequest(ListVolumeGroupReplicasRequest request) => Enumerable.Repeat(client.ListVolumeGroupReplicas(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListVolumeGroupReplicasResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListVolumeGroupReplicasResponse response;
        private delegate IEnumerable<ListVolumeGroupReplicasResponse> RequestDelegate(ListVolumeGroupReplicasRequest request);
