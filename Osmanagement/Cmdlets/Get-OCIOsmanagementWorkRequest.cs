...
{
    [Cmdlet("Get", "OCIOsmanagementWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OsmanagementService.Models.WorkRequest), typeof(Oci.OsmanagementService.Responses.GetWorkRequestResponse) })]
    public class GetOCIOsmanagementWorkRequest : OCIOsManagementCmdlet
    {
        ...
        public Oci.OsmanagementService.Models.OperationStatus[] WaitForStatus { get; set; }
