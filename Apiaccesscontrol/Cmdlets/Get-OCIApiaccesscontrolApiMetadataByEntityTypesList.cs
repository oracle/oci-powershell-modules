...
{
    [Cmdlet("Get", "OCIApiaccesscontrolApiMetadataByEntityTypesList")]
    [OutputType(new System.Type[] { typeof(Oci.ApiaccesscontrolService.Models.ApiMetadataByEntityTypeCollection), typeof(Oci.ApiaccesscontrolService.Responses.ListApiMetadataByEntityTypesResponse) })]
    public class GetOCIApiaccesscontrolApiMetadataByEntityTypesList : OCIApiMetadataCmdlet
    {
        ...
        public System.Nullable<Oci.ApiaccesscontrolService.Models.ApiMetadata.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.ApiaccesscontrolService.Requests.ListApiMetadataByEntityTypesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListApiMetadataByEntityTypesRequest
                {
                ...
                IEnumerable<ListApiMetadataByEntityTypesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.ApiMetadataByEntityTypeCollection, true);
                }
        ...
        {
            IEnumerable<ListApiMetadataByEntityTypesResponse> DefaultRequest(ListApiMetadataByEntityTypesRequest request) => Enumerable.Repeat(client.ListApiMetadataByEntityTypes(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListApiMetadataByEntityTypesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListApiMetadataByEntityTypesResponse response;
        private delegate IEnumerable<ListApiMetadataByEntityTypesResponse> RequestDelegate(ListApiMetadataByEntityTypesRequest request);
