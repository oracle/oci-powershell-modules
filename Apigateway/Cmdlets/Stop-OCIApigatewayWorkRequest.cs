...
{
    [Cmdlet("Stop", "OCIApigatewayWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ApigatewayService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIApigatewayWorkRequest : OCIWorkRequestsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIApigatewayWorkRequest", "Stop"))
            {
               return;
            }
