...
{
    [Cmdlet("Move", "OCIApigatewayApiCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApigatewayService.Responses.ChangeApiCompartmentResponse) })]
    public class MoveOCIApigatewayApiCompartment : OCIApiGatewayCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeApiCompartmentRequest
                {
                    ApiId = ApiId,
                ...
                response = client.ChangeApiCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeApiCompartmentResponse response;
    }
}
