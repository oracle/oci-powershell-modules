...
{
    [Cmdlet("Get", "OCIIdentitydomainsIdentityProofingProvider")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.IdentityProofingProvider), typeof(Oci.IdentitydomainsService.Responses.GetIdentityProofingProviderResponse) })]
    public class GetOCIIdentitydomainsIdentityProofingProvider : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetIdentityProofingProviderRequest
                {
                ...
                response = client.GetIdentityProofingProvider(request).GetAwaiter().GetResult();
        ...
        private GetIdentityProofingProviderResponse response;
    }
}
