...
{
    [Cmdlet("Invoke", "OCICertificatesmanagementScheduleCertificateDeletion")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CertificatesmanagementService.Responses.ScheduleCertificateDeletionResponse) })]
    public class InvokeOCICertificatesmanagementScheduleCertificateDeletion : OCICertificatesManagementCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the certificate.")]
        public string CertificateId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details of the request to schedule a certificate deletion. This sets the lifecycle state of the certificate to `PENDING_DELETION` and then deletes it after the specified retention period ends. You can subsequently use `GetCertificate` to determine the current deletion status.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ScheduleCertificateDeletionRequest
                {
                ...
                response = client.ScheduleCertificateDeletion(request).GetAwaiter().GetResult();
        ...
        private ScheduleCertificateDeletionResponse response;
    }
}
