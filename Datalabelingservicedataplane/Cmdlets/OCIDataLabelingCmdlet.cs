...
using Oci.DatalabelingservicedataplaneService;

namespace Oci.DatalabelingservicedataplaneService.Cmdlets
{
    public abstract class OCIDataLabelingCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DataLabelingClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DataLabelingClient client;
