...
{
    [Cmdlet("Update", "OCIDnsSteeringPolicyAttachment", DefaultParameterSetName = Default)]
    ...
    public class UpdateOCIDnsSteeringPolicyAttachment : OCIDnsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the target steering policy attachment.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the target steering policy attachment.", ParameterSetName = Default)]
        public string SteeringPolicyAttachmentId { get; set; }

        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"New data for the steering policy attachment.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"New data for the steering policy attachment.", ParameterSetName = Default)]
        ...
        private void HandleOutput(UpdateSteeringPolicyAttachmentRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateSteeringPolicyAttachment(request, waiterConfig, WaitForStatus).Execute();
                    break;
