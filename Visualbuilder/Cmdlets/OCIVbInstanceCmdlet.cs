...
using Oci.VisualbuilderService;

namespace Oci.VisualbuilderService.Cmdlets
{
    public abstract class OCIVbInstanceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new VbInstanceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected VbInstanceClient client;
