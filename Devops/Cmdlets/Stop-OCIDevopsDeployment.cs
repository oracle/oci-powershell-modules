...
{
    [Cmdlet("Stop", "OCIDevopsDeployment")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.Deployment), typeof(Oci.DevopsService.Responses.CancelDeploymentResponse) })]
    public class StopOCIDevopsDeployment : OCIDevopsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique deployment identifier.")]
        public string DeploymentId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information regarding the deployment to be canceled.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CancelDeployment(request).GetAwaiter().GetResult();
        ...
        private CancelDeploymentResponse response;
    }
}
