...
{
    [Cmdlet("Get", "OCIDatabasetoolsruntimeWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabasetoolsruntimeService.Models.WorkRequest), typeof(Oci.DatabasetoolsruntimeService.Responses.GetWorkRequestResponse) })]
    public class GetOCIDatabasetoolsruntimeWorkRequest : OCIDatabaseToolsRuntimeCmdlet
    {
        ...
        public Oci.DatabasetoolsruntimeService.Models.OperationStatus[] WaitForStatus { get; set; }
