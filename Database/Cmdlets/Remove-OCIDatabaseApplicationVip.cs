...
namespace Oci.DatabaseService.Cmdlets
{
    ...
    public class RemoveOCIDatabaseApplicationVip : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the application virtual IP (VIP) address.", ParameterSetName = StatusParamSet)]
