...
{
    [Cmdlet("Get", "OCIOpaWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OpaService.Models.WorkRequest), typeof(Oci.OpaService.Responses.GetWorkRequestResponse) })]
    public class GetOCIOpaWorkRequest : OCIOpaInstanceCmdlet
    {
        ...
        public Oci.OpaService.Models.OperationStatus[] WaitForStatus { get; set; }
