...
{
    public abstract class OCIGovernanceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new GovernanceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected GovernanceClient client;
