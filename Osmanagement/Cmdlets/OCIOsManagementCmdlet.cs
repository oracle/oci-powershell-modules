...
using Oci.OsmanagementService;

namespace Oci.OsmanagementService.Cmdlets
{
    public abstract class OCIOsManagementCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OsManagementClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OsManagementClient client;
