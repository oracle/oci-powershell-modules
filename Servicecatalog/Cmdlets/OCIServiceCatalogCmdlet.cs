...
using Oci.ServicecatalogService;

namespace Oci.ServicecatalogService.Cmdlets
{
    public abstract class OCIServiceCatalogCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ServiceCatalogClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ServiceCatalogClient client;
