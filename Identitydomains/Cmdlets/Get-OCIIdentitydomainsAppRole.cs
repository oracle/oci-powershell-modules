...
{
    [Cmdlet("Get", "OCIIdentitydomainsAppRole")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.AppRole), typeof(Oci.IdentitydomainsService.Responses.GetAppRoleResponse) })]
    public class GetOCIIdentitydomainsAppRole : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GetAppRole(request).GetAwaiter().GetResult();
        ...
        private GetAppRoleResponse response;
    }
}
