...
{
    [Cmdlet("Enable", "OCIAidataplatformAiFeature")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AidataplatformService.Responses.EnableAiFeatureResponse) })]
    public class EnableOCIAidataplatformAiFeature : OCIAiDataPlatformCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new EnableAiFeatureRequest
                {
                ...
                response = client.EnableAiFeature(request).GetAwaiter().GetResult();
        ...
        private EnableAiFeatureResponse response;
    }
}
