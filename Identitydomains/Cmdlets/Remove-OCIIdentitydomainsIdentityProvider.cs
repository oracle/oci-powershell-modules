...
{
    [Cmdlet("Remove", "OCIIdentitydomainsIdentityProvider", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteIdentityProviderResponse) })]
    public class RemoveOCIIdentitydomainsIdentityProvider : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsIdentityProvider", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteIdentityProvider(request).GetAwaiter().GetResult();
        ...
        private DeleteIdentityProviderResponse response;
    }
}
