...
{
    [Cmdlet("Get", "OCIIdentitydomainsCustomerSecretKeysList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.CustomerSecretKeys), typeof(Oci.IdentitydomainsService.Responses.ListCustomerSecretKeysResponse) })]
    public class GetOCIIdentitydomainsCustomerSecretKeysList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListCustomerSecretKeysRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListCustomerSecretKeys(request).GetAwaiter().GetResult();
        ...
        private ListCustomerSecretKeysResponse response;
    }
}
