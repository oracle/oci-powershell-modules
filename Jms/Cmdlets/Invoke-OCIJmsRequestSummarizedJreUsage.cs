...
{
    [Cmdlet("Invoke", "OCIJmsRequestSummarizedJreUsage")]
    [OutputType(new System.Type[] { typeof(Oci.JmsService.Models.JreUsageCollection), typeof(Oci.JmsService.Responses.RequestSummarizedJreUsageResponse) })]
    public class InvokeOCIJmsRequestSummarizedJreUsage : OCIJavaManagementServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for filtering Java Runtime usage.")]
        public RequestSummarizedJreUsageDetails RequestSummarizedJreUsageDetails { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RequestSummarizedJreUsageRequest
                {
                    FleetId = FleetId,
                ...
                response = client.RequestSummarizedJreUsage(request).GetAwaiter().GetResult();
        ...
        private RequestSummarizedJreUsageResponse response;
    }
}
