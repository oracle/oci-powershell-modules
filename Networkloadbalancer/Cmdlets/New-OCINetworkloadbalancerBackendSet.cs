...
{
    [Cmdlet("New", "OCINetworkloadbalancerBackendSet")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NetworkloadbalancerService.Responses.CreateBackendSetResponse) })]
    public class NewOCINetworkloadbalancerBackendSet : OCINetworkLoadBalancerCmdlet
    {
