...
{
    [Cmdlet("Invoke", "OCIDatabaseRefreshDataGuardHealthStatus", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Database), typeof(Oci.DatabaseService.Responses.RefreshDataGuardHealthStatusResponse) })]
    public class InvokeOCIDatabaseRefreshDataGuardHealthStatus : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RefreshDataGuardHealthStatusRequest
                {
        ...
        private void HandleOutput(RefreshDataGuardHealthStatusRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRefreshDataGuardHealthStatus(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RefreshDataGuardHealthStatus(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.Database);
        }

        private RefreshDataGuardHealthStatusResponse response;
