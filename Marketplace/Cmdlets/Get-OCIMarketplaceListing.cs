...
{
    [Cmdlet("Get", "OCIMarketplaceListing")]
    [OutputType(new System.Type[] { typeof(Oci.MarketplaceService.Models.Listing), typeof(Oci.MarketplaceService.Responses.GetListingResponse) })]
    public class GetOCIMarketplaceListing : OCIMarketplaceCmdlet
    {
