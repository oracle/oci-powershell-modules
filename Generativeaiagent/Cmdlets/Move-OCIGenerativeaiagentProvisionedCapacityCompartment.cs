...
{
    [Cmdlet("Move", "OCIGenerativeaiagentProvisionedCapacityCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GenerativeaiagentService.Responses.ChangeProvisionedCapacityCompartmentResponse) })]
    public class MoveOCIGenerativeaiagentProvisionedCapacityCompartment : OCIGenerativeAiAgentCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the provisioned capacity.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeProvisionedCapacityCompartmentRequest
                {
                    ProvisionedCapacityId = ProvisionedCapacityId,
                    ChangeProvisionedCapacityCompartmentDetails = ChangeProvisionedCapacityCompartmentDetails,
                    IfMatch = IfMatch,
                    OpcRequestId = OpcRequestId,
                    OpcRetryToken = OpcRetryToken
                };

                response = client.ChangeProvisionedCapacityCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeProvisionedCapacityCompartmentResponse response;
    }
}
