...
{
    [Cmdlet("New", "OCIDatabaseSchedulingWindow", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.SchedulingWindow), typeof(Oci.DatabaseService.Responses.CreateSchedulingWindowResponse) })]
    public class NewOCIDatabaseSchedulingWindow : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to create Scheduling Window.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to create Scheduling Window.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateSchedulingWindowRequest
                {
        ...
        private void HandleOutput(CreateSchedulingWindowRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForCreateSchedulingWindow(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.CreateSchedulingWindow(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.SchedulingWindow);
        }

        private CreateSchedulingWindowResponse response;
