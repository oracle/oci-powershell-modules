...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementLoadSqlTuningSet")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.SqlTuningSetAdminActionStatus), typeof(Oci.DatabasemanagementService.Responses.LoadSqlTuningSetResponse) })]
    public class InvokeOCIDatabasemanagementLoadSqlTuningSet : OCISqlTuningCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details required to load Sql statements into the Sql tuning set.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new LoadSqlTuningSetRequest
                {
                ...
                response = client.LoadSqlTuningSet(request).GetAwaiter().GetResult();
        ...
        private LoadSqlTuningSetResponse response;
    }
}
