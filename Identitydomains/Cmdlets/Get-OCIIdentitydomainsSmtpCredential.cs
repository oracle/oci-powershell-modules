...
{
    [Cmdlet("Get", "OCIIdentitydomainsSmtpCredential")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SmtpCredential), typeof(Oci.IdentitydomainsService.Responses.GetSmtpCredentialResponse) })]
    public class GetOCIIdentitydomainsSmtpCredential : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetSmtpCredentialRequest
                {
                ...
                response = client.GetSmtpCredential(request).GetAwaiter().GetResult();
        ...
        private GetSmtpCredentialResponse response;
    }
}
