...
{
    [Cmdlet("Remove", "OCIDevopsPullRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DevopsService.Responses.DeletePullRequestResponse) })]
    public class RemoveOCIDevopsPullRequest : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDevopsPullRequest", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeletePullRequestRequest
                {
                ...
                response = client.DeletePullRequest(request).GetAwaiter().GetResult();
        ...
        private DeletePullRequestResponse response;
    }
}
