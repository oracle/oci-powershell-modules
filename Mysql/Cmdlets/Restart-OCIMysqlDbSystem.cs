...
{
    [Cmdlet("Restart", "OCIMysqlDbSystem")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.RestartDbSystemResponse) })]
    public class RestartOCIMysqlDbSystem : OCIDbSystemCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Optional parameters for the stop portion of the restart action.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RestartDbSystemRequest
                {
                ...
                response = client.RestartDbSystem(request).GetAwaiter().GetResult();
        ...
        private RestartDbSystemResponse response;
    }
}
