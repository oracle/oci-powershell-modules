...
{
    [Cmdlet("Update", "OCIFleetappsmanagementFleetProperty")]
    ...
    public class UpdateOCIFleetappsmanagementFleetProperty : OCIFleetAppsManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Attributes to update a fleet property.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpdateFleetProperty(request).GetAwaiter().GetResult();
        ...
        private UpdateFleetPropertyResponse response;
    }
}
