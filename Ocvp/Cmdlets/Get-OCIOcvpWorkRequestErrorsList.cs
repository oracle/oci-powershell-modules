...
{
    [Cmdlet("Get", "OCIOcvpWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.OcvpService.Models.WorkRequestErrorCollection), typeof(Oci.OcvpService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIOcvpWorkRequestErrorsList : OCIWorkRequestCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the work request.")]
