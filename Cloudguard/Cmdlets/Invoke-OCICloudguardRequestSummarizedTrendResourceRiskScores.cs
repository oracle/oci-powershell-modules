...
{
    [Cmdlet("Invoke", "OCICloudguardRequestSummarizedTrendResourceRiskScores")]
    [OutputType(new System.Type[] { typeof(Oci.CloudguardService.Models.ResourceRiskScoreAggregationCollection), typeof(Oci.CloudguardService.Responses.RequestSummarizedTrendResourceRiskScoresResponse) })]
    public class InvokeOCICloudguardRequestSummarizedTrendResourceRiskScores : OCICloudGuardCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The filter to fetch risk score trend.")]
        ...
        public System.Nullable<Oci.CloudguardService.Requests.RequestSummarizedTrendResourceRiskScoresRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RequestSummarizedTrendResourceRiskScoresRequest
                {
                ...
                response = client.RequestSummarizedTrendResourceRiskScores(request).GetAwaiter().GetResult();
                WriteOutput(response, response.ResourceRiskScoreAggregationCollection);
        ...
        private RequestSummarizedTrendResourceRiskScoresResponse response;
    }
}
