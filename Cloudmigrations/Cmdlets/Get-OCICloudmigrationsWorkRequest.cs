...
{
    [Cmdlet("Get", "OCICloudmigrationsWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.CloudmigrationsService.Models.WorkRequest), typeof(Oci.CloudmigrationsService.Responses.GetWorkRequestResponse) })]
    public class GetOCICloudmigrationsWorkRequest : OCIMigrationCmdlet
    {
        ...
        public Oci.CloudmigrationsService.Models.OperationStatus[] WaitForStatus { get; set; }
