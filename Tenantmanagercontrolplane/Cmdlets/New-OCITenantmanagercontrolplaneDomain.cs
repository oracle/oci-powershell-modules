...
{
    [Cmdlet("New", "OCITenantmanagercontrolplaneDomain")]
    [OutputType(new System.Type[] { typeof(Oci.TenantmanagercontrolplaneService.Models.Domain), typeof(Oci.TenantmanagercontrolplaneService.Responses.CreateDomainResponse) })]
    public class NewOCITenantmanagercontrolplaneDomain : OCIDomainCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for domain creation.")]
