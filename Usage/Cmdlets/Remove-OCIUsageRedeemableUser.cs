...
{
    [Cmdlet("Remove", "OCIUsageRedeemableUser", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCIUsageRedeemableUser : OCIRewardsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIUsageRedeemableUser", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteRedeemableUserRequest
                {
                    EmailId = EmailId,
                    TenancyId = TenancyId,
        ...
        private DeleteRedeemableUserResponse response;
    }
}
