...
{
    [Cmdlet("Remove", "OCISecurityattribute", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.SecurityattributeService.Responses.DeleteSecurityAttributeResponse) })]
    public class RemoveOCISecurityattribute : OCISecurityAttributeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCISecurityattribute", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteSecurityAttributeRequest
                {
                ...
                response = client.DeleteSecurityAttribute(request).GetAwaiter().GetResult();
        ...
        private DeleteSecurityAttributeResponse response;
    }
}
