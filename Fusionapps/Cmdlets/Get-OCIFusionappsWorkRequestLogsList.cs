...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class GetOCIFusionappsWorkRequestLogsList : OCIFusionApplicationsCmdlet
    {
        ...
        public System.Nullable<Oci.FusionappsService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either 'asc' or 'desc'.")]
        public System.Nullable<Oci.FusionappsService.Requests.ListWorkRequestLogsRequest.SortOrderEnum> SortOrder { get; set; }
