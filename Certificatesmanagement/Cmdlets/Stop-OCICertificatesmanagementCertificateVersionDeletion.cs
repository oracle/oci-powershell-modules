...
{
    [Cmdlet("Stop", "OCICertificatesmanagementCertificateVersionDeletion")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CertificatesmanagementService.Responses.CancelCertificateVersionDeletionResponse) })]
    public class StopOCICertificatesmanagementCertificateVersionDeletion : OCICertificatesManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelCertificateVersionDeletionRequest
                {
                ...
                response = client.CancelCertificateVersionDeletion(request).GetAwaiter().GetResult();
        ...
        private CancelCertificateVersionDeletionResponse response;
    }
}
