...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyCompletedApproval")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyCompletedApproval), typeof(Oci.IdentitydomainsService.Responses.GetMyCompletedApprovalResponse) })]
    public class GetOCIIdentitydomainsMyCompletedApproval : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMyCompletedApprovalRequest
                {
                ...
                response = client.GetMyCompletedApproval(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MyCompletedApproval);
        ...
        private GetMyCompletedApprovalResponse response;
    }
}
