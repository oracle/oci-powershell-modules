...
{
    [Cmdlet("Update", "OCIMediaservicesMediaAsset")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.MediaAsset), typeof(Oci.MediaservicesService.Responses.UpdateMediaAssetResponse) })]
    public class UpdateOCIMediaservicesMediaAsset : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateMediaAssetRequest
                {
                ...
                response = client.UpdateMediaAsset(request).GetAwaiter().GetResult();
        ...
        private UpdateMediaAssetResponse response;
    }
}
