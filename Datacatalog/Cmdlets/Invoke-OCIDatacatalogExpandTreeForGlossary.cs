...
{
    [Cmdlet("Invoke", "OCIDatacatalogExpandTreeForGlossary")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.GlossaryTreeElement), typeof(Oci.DatacatalogService.Responses.ExpandTreeForGlossaryResponse) })]
    public class InvokeOCIDatacatalogExpandTreeForGlossary : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ExpandTreeForGlossaryRequest
                {
                    CatalogId = CatalogId,
                ...
                response = client.ExpandTreeForGlossary(request).GetAwaiter().GetResult();
        ...
        private ExpandTreeForGlossaryResponse response;
    }
}
