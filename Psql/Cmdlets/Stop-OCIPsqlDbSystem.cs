...
{
    [Cmdlet("Stop", "OCIPsqlDbSystem")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.PsqlService.Responses.StopDbSystemResponse) })]
    public class StopOCIPsqlDbSystem : OCIPostgresqlCmdlet
    {
