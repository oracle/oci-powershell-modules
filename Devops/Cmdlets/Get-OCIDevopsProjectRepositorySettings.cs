...
{
    [Cmdlet("Get", "OCIDevopsProjectRepositorySettings")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.ProjectRepositorySettings), typeof(Oci.DevopsService.Responses.GetProjectRepositorySettingsResponse) })]
    public class GetOCIDevopsProjectRepositorySettings : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetProjectRepositorySettingsRequest
                {
                    ProjectId = ProjectId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetProjectRepositorySettings(request).GetAwaiter().GetResult();
        ...
        private GetProjectRepositorySettingsResponse response;
    }
}
