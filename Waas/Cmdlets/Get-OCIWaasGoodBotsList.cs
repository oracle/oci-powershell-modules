...
{
    [Cmdlet("Get", "OCIWaasGoodBotsList")]
    [OutputType(new System.Type[] { typeof(Oci.WaasService.Models.GoodBot), typeof(Oci.WaasService.Responses.ListGoodBotsResponse) })]
    public class GetOCIWaasGoodBotsList : OCIWaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListGoodBotsRequest
                {
                ...
                IEnumerable<ListGoodBotsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListGoodBotsResponse> DefaultRequest(ListGoodBotsRequest request) => Enumerable.Repeat(client.ListGoodBots(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListGoodBotsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListGoodBotsResponse response;
        private delegate IEnumerable<ListGoodBotsResponse> RequestDelegate(ListGoodBotsRequest request);
