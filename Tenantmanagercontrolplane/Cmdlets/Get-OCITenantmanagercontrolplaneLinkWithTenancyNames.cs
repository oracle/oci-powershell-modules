...
{
    [Cmdlet("Get", "OCITenantmanagercontrolplaneLinkWithTenancyNames", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.TenantmanagercontrolplaneService.Models.LinkWithTenancyNames), typeof(Oci.TenantmanagercontrolplaneService.Responses.GetLinkWithTenancyNamesResponse) })]
    public class GetOCITenantmanagercontrolplaneLinkWithTenancyNames : OCILinkCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetLinkWithTenancyNamesRequest
                {
                    LinkId = LinkId,
        ...
        private void HandleOutput(GetLinkWithTenancyNamesRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForLinkWithTenancyNames(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetLinkWithTenancyNames(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.LinkWithTenancyNames);
        }

        private GetLinkWithTenancyNamesResponse response;
