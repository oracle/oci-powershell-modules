...
{
    [Cmdlet("Invoke", "OCIMysqlResumeChannel")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.ResumeChannelResponse) })]
    public class InvokeOCIMysqlResumeChannel : OCIChannelsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ResumeChannelRequest
                {
                    ChannelId = ChannelId,
                    IfMatch = IfMatch,
                ...
                response = client.ResumeChannel(request).GetAwaiter().GetResult();
        ...
        private ResumeChannelResponse response;
    }
}
