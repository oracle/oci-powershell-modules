...
{
    [Cmdlet("Move", "OCIDatabasemigrationAgentCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatabasemigrationService.Responses.ChangeAgentCompartmentResponse) })]
    public class MoveOCIDatabasemigrationAgentCompartment : OCIDatabaseMigrationCmdlet
    {
