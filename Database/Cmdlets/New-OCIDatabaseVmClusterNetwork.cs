...
{
    [Cmdlet("New", "OCIDatabaseVmClusterNetwork", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.VmClusterNetwork), typeof(Oci.DatabaseService.Responses.CreateVmClusterNetworkResponse) })]
    public class NewOCIDatabaseVmClusterNetwork : OCIDatabaseCmdlet
    {
        ...
        private void HandleOutput(CreateVmClusterNetworkRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForCreateVmClusterNetwork(request, waiterConfig, WaitForStatus).Execute();
                    break;
