...
{
    [Cmdlet("Remove", "OCIGoldengateDeploymentLock")]
    [OutputType(new System.Type[] { typeof(Oci.GoldengateService.Models.Deployment), typeof(Oci.GoldengateService.Responses.RemoveDeploymentLockResponse) })]
    public class RemoveOCIGoldengateDeploymentLock : OCIGoldenGateCmdlet
    {
