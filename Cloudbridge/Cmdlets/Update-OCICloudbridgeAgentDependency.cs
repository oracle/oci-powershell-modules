...
{
    [Cmdlet("Update", "OCICloudbridgeAgentDependency")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CloudbridgeService.Responses.UpdateAgentDependencyResponse) })]
    public class UpdateOCICloudbridgeAgentDependency : OCIOcbAgentSvcCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateAgentDependencyRequest
                {
                ...
                response = client.UpdateAgentDependency(request).GetAwaiter().GetResult();
        ...
        private UpdateAgentDependencyResponse response;
    }
}
