...
{
    [Cmdlet("Get", "OCIIdentitydomainsGrant")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Grant), typeof(Oci.IdentitydomainsService.Responses.GetGrantResponse) })]
    public class GetOCIIdentitydomainsGrant : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GetGrant(request).GetAwaiter().GetResult();
        ...
        private GetGrantResponse response;
    }
}
