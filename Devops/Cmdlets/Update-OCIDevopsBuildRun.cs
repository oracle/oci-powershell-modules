...
{
    [Cmdlet("Update", "OCIDevopsBuildRun")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.BuildRun), typeof(Oci.DevopsService.Responses.UpdateBuildRunResponse) })]
    public class UpdateOCIDevopsBuildRun : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateBuildRunRequest
                {
                ...
                response = client.UpdateBuildRun(request).GetAwaiter().GetResult();
        ...
        private UpdateBuildRunResponse response;
    }
}
