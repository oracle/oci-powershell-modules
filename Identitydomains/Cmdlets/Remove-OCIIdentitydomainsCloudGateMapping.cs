...
{
    [Cmdlet("Remove", "OCIIdentitydomainsCloudGateMapping", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteCloudGateMappingResponse) })]
    public class RemoveOCIIdentitydomainsCloudGateMapping : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsCloudGateMapping", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteCloudGateMappingRequest
                {
                ...
                response = client.DeleteCloudGateMapping(request).GetAwaiter().GetResult();
        ...
        private DeleteCloudGateMappingResponse response;
    }
}
