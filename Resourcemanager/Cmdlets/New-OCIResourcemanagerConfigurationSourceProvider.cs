...
{
    [Cmdlet("New", "OCIResourcemanagerConfigurationSourceProvider")]
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The properties for creating a ConfigurationSourceProvider. This parameter also accepts subtypes <Oci.ResourcemanagerService.Models.CreateGitlabAccessTokenConfigurationSourceProviderDetails>, <Oci.ResourcemanagerService.Models.CreateBitbucketCloudUsernameAppPasswordConfigurationSourceProviderDetails>, <Oci.ResourcemanagerService.Models.CreateGithubAccessTokenConfigurationSourceProviderDetails>, <Oci.ResourcemanagerService.Models.CreateBitbucketServerAccessTokenConfigurationSourceProviderDetails> of type <Oci.ResourcemanagerService.Models.CreateConfigurationSourceProviderDetails>.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateConfigurationSourceProviderRequest
                {
                ...
                response = client.CreateConfigurationSourceProvider(request).GetAwaiter().GetResult();
        ...
        private CreateConfigurationSourceProviderResponse response;
    }
}
