...
{
    [Cmdlet("Get", "OCIIdentitydomainsSecurityQuestionSetting")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SecurityQuestionSetting), typeof(Oci.IdentitydomainsService.Responses.GetSecurityQuestionSettingResponse) })]
    public class GetOCIIdentitydomainsSecurityQuestionSetting : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetSecurityQuestionSettingRequest
                {
                ...
                response = client.GetSecurityQuestionSetting(request).GetAwaiter().GetResult();
        ...
        private GetSecurityQuestionSettingResponse response;
    }
}
