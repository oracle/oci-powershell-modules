...
{
    [Cmdlet("Remove", "OCIDatacatalogJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatacatalogService.Responses.DeleteJobResponse) })]
    public class RemoveOCIDatacatalogJob : OCIDataCatalogCmdlet
    {
