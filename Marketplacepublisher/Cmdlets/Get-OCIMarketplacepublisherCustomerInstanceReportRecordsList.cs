...
{
    [Cmdlet("Get", "OCIMarketplacepublisherCustomerInstanceReportRecordsList")]
    [OutputType(new System.Type[] { typeof(Oci.MarketplacepublisherService.Models.CustomerInstanceReportRecordCollection), typeof(Oci.MarketplacepublisherService.Responses.ListCustomerInstanceReportRecordsResponse) })]
    public class GetOCIMarketplacepublisherCustomerInstanceReportRecordsList : OCIMarketplacePublisherCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    response = item;
                    WriteOutput(response, response.CustomerInstanceReportRecordCollection, true);
                }
        ...
        {
            IEnumerable<ListCustomerInstanceReportRecordsResponse> DefaultRequest(ListCustomerInstanceReportRecordsRequest request) => Enumerable.Repeat(client.ListCustomerInstanceReportRecords(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListCustomerInstanceReportRecordsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListCustomerInstanceReportRecordsResponse response;
        private delegate IEnumerable<ListCustomerInstanceReportRecordsResponse> RequestDelegate(ListCustomerInstanceReportRecordsRequest request);
