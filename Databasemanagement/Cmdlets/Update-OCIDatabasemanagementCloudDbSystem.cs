...
{
    [Cmdlet("Update", "OCIDatabasemanagementCloudDbSystem")]
    ...
    public class UpdateOCIDatabasemanagementCloudDbSystem : OCIDbManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details required to update a cloud DB system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateCloudDbSystemRequest
                {
                ...
                response = client.UpdateCloudDbSystem(request).GetAwaiter().GetResult();
        ...
        private UpdateCloudDbSystemResponse response;
    }
}
