...
{
    [Cmdlet("Update", "OCIDatabaseDataGuard", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Database), typeof(Oci.DatabaseService.Responses.UpdateDataGuardResponse) })]
    public class UpdateOCIDatabaseDataGuard : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDataGuardRequest
                {
        ...
        private void HandleOutput(UpdateDataGuardRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateDataGuard(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpdateDataGuard(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.Database);
        }

        private UpdateDataGuardResponse response;
