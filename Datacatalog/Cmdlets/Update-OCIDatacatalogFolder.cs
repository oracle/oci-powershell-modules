...
{
    [Cmdlet("Update", "OCIDatacatalogFolder")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Folder), typeof(Oci.DatacatalogService.Responses.UpdateFolderResponse) })]
    public class UpdateOCIDatacatalogFolder : OCIDataCatalogCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information to be updated in the folder.")]
