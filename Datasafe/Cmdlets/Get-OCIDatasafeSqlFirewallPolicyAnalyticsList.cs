...
{
    [Cmdlet("Get", "OCIDatasafeSqlFirewallPolicyAnalyticsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.SqlFirewallPolicyAnalyticsCollection), typeof(Oci.DatasafeService.Responses.ListSqlFirewallPolicyAnalyticsResponse) })]
    public class GetOCIDatasafeSqlFirewallPolicyAnalyticsList : OCIDataSafeCmdlet
    {
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSqlFirewallPolicyAnalyticsRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSqlFirewallPolicyAnalyticsRequest
                {
                ...
                IEnumerable<ListSqlFirewallPolicyAnalyticsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.SqlFirewallPolicyAnalyticsCollection, true);
                }
        ...
        {
            IEnumerable<ListSqlFirewallPolicyAnalyticsResponse> DefaultRequest(ListSqlFirewallPolicyAnalyticsRequest request) => Enumerable.Repeat(client.ListSqlFirewallPolicyAnalytics(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSqlFirewallPolicyAnalyticsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSqlFirewallPolicyAnalyticsResponse response;
        private delegate IEnumerable<ListSqlFirewallPolicyAnalyticsResponse> RequestDelegate(ListSqlFirewallPolicyAnalyticsRequest request);
