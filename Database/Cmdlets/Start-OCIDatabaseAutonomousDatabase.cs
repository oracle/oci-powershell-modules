...
{
    [Cmdlet("Start", "OCIDatabaseAutonomousDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousDatabase), typeof(Oci.DatabaseService.Responses.StartAutonomousDatabaseResponse) })]
    public class StartOCIDatabaseAutonomousDatabase : OCIDatabaseCmdlet
    {
        ...
        private StartAutonomousDatabaseResponse response;
