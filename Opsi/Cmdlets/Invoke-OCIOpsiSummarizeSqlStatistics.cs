...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeSqlStatistics")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.SqlStatisticAggregationCollection), typeof(Oci.OpsiService.Responses.SummarizeSqlStatisticsResponse) })]
    public class InvokeOCIOpsiSummarizeSqlStatistics : OCIOperationsInsightsCmdlet
    {
        ...
        public System.Collections.Generic.List<Oci.OpsiService.Requests.SummarizeSqlStatisticsRequest.DatabaseTypeEnum> DatabaseType { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Optional list of exadata insight resource [OCIDs](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"One or more unique SQL_IDs for a SQL Statement. Example: `6rgjh9bjmy2s7`")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field to use when sorting SQL statistics. Example: databaseTimeInSec")]
        public System.Nullable<Oci.OpsiService.Requests.SummarizeSqlStatisticsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Filter sqls by one or more performance categories.")]
        public System.Collections.Generic.List<Oci.OpsiService.Requests.SummarizeSqlStatisticsRequest.CategoryEnum> Category { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeSqlStatisticsRequest
                {
                ...
                response = client.SummarizeSqlStatistics(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SqlStatisticAggregationCollection);
        ...
        private SummarizeSqlStatisticsResponse response;
    }
}
