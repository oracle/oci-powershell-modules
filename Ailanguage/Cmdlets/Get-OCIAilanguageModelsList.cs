...
{
    [Cmdlet("Get", "OCIAilanguageModelsList")]
    [OutputType(new System.Type[] { typeof(Oci.AilanguageService.Models.ModelCollection), typeof(Oci.AilanguageService.Responses.ListModelsResponse) })]
    public class GetOCIAilanguageModelsList : OCIAIServiceLanguageCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID of the compartment in which to list resources.")]
        public string CompartmentId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"unique model OCID.")]
        ...
        public System.Nullable<Oci.AilanguageService.Models.Model.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.AilanguageService.Requests.ListModelsRequest.SortByEnum> SortBy { get; set; }
