...
{
    public abstract class OCIFleetAppsManagementProvisionCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new FleetAppsManagementProvisionClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected FleetAppsManagementProvisionClient client;
