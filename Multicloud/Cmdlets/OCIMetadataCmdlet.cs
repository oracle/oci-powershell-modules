...
{
    public abstract class OCIMetadataCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MetadataClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
