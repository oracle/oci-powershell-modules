...
{
    [Cmdlet("Get", "OCICloudguardWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.CloudguardService.Models.WorkRequest), typeof(Oci.CloudguardService.Responses.GetWorkRequestResponse) })]
    public class GetOCICloudguardWorkRequest : OCICloudGuardCmdlet
    {
        ...
        public Oci.CloudguardService.Models.OperationStatus[] WaitForStatus { get; set; }
