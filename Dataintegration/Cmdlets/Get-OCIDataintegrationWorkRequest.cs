...
{
    [Cmdlet("Get", "OCIDataintegrationWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.WorkRequest), typeof(Oci.DataintegrationService.Responses.GetWorkRequestResponse) })]
    public class GetOCIDataintegrationWorkRequest : OCIDataIntegrationCmdlet
    {
        ...
        public Oci.DataintegrationService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
