...
{
    [Cmdlet("Get", "OCIVnmonitoringWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.VnmonitoringService.Models.WorkRequest), typeof(Oci.VnmonitoringService.Responses.GetWorkRequestResponse) })]
    public class GetOCIVnmonitoringWorkRequest : OCIVnMonitoringCmdlet
    {
        ...
        public Oci.VnmonitoringService.Models.OperationStatus[] WaitForStatus { get; set; }
