...
{
    [Cmdlet("Stop", "OCIMarketplacepublisherWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.MarketplacepublisherService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIMarketplacepublisherWorkRequest : OCIMarketplacePublisherCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIMarketplacepublisherWorkRequest", "Stop"))
            {
               return;
            }
