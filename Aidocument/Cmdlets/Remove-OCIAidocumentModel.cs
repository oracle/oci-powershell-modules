...
{
    [Cmdlet("Remove", "OCIAidocumentModel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AidocumentService.Responses.DeleteModelResponse) })]
    public class RemoveOCIAidocumentModel : OCIAIServiceDocumentCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAidocumentModel", "Remove"))
            {
               return;
            }
