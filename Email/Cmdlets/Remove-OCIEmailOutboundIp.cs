...
{
    [Cmdlet("Remove", "OCIEmailOutboundIp")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.EmailService.Responses.RemoveEmailOutboundIpResponse) })]
    public class RemoveOCIEmailOutboundIp : OCIEmailCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details to remove IPs from EmailIpPool.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveEmailOutboundIpRequest
                {
                ...
                response = client.RemoveEmailOutboundIp(request).GetAwaiter().GetResult();
        ...
        private RemoveEmailOutboundIpResponse response;
    }
}
