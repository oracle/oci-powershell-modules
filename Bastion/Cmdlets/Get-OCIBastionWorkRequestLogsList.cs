...
{
    [Cmdlet("Get", "OCIBastionWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.BastionService.Models.WorkRequestLogEntry), typeof(Oci.BastionService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIBastionWorkRequestLogsList : OCIBastionCmdlet
    {
