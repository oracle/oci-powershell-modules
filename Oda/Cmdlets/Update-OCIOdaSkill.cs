...
{
    [Cmdlet("Update", "OCIOdaSkill")]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.Skill), typeof(Oci.OdaService.Responses.UpdateSkillResponse) })]
    public class UpdateOCIOdaSkill : OCIManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Property values to update the Skill.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpdateSkill(request).GetAwaiter().GetResult();
        ...
        private UpdateSkillResponse response;
    }
}
