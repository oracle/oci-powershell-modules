...
namespace Oci.MarketplaceprivateofferService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIMarketplaceprivateofferAttachmentContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.MarketplaceprivateofferService.Responses.GetAttachmentContentResponse) })]
    public class GetOCIMarketplaceprivateofferAttachmentContent : OCIAttachmentCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetAttachmentContentRequest
                {
                    OfferId = OfferId,
                ...
                response = client.GetAttachmentContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetAttachmentContentResponse response;
