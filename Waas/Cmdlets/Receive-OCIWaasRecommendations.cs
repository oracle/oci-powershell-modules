...
{
    [Cmdlet("Receive", "OCIWaasRecommendations")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.AcceptRecommendationsResponse) })]
    public class ReceiveOCIWaasRecommendations : OCIWaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AcceptRecommendationsRequest
                {
                ...
                response = client.AcceptRecommendations(request).GetAwaiter().GetResult();
        ...
        private AcceptRecommendationsResponse response;
    }
}
