...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyAppsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyApps), typeof(Oci.IdentitydomainsService.Responses.ListMyAppsResponse) })]
    public class GetOCIIdentitydomainsMyAppsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ListMyApps(request).GetAwaiter().GetResult();
        ...
        private ListMyAppsResponse response;
    }
}
