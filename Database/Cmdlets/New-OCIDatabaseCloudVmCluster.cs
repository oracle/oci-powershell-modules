...
{
    [Cmdlet("New", "OCIDatabaseCloudVmCluster", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.CloudVmCluster), typeof(Oci.DatabaseService.Responses.CreateCloudVmClusterResponse) })]
    public class NewOCIDatabaseCloudVmCluster : OCIDatabaseCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to create a cloud VM cluster. Applies to Exadata Cloud Service instances only. See [The New Exadata Cloud Service Resource Model](https://docs.cloud.oracle.com/iaas/Content/Database/iaas/Content/Database/Concepts/exaflexsystem.htm#exaflexsystem_topic-resource_model) for information on this resource type.", ParameterSetName = StatusParamSet)]
        ...
        private void HandleOutput(CreateCloudVmClusterRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForCreateCloudVmCluster(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.CreateCloudVmCluster(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.CloudVmCluster);
        }

        private CreateCloudVmClusterResponse response;
