...
{
    [Cmdlet("Move", "OCIApigatewayDeploymentCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApigatewayService.Responses.ChangeDeploymentCompartmentResponse) })]
    public class MoveOCIApigatewayDeploymentCompartment : OCIDeploymentCmdlet
    {
