...
{
    [Cmdlet("Invoke", "OCIDnsPatchDomainRecords")]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.RecordCollection), typeof(Oci.DnsService.Responses.PatchDomainRecordsResponse) })]
    public class InvokeOCIDnsPatchDomainRecords : OCIDnsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Operations describing how to modify the collection of records.")]
...
This parameter is deprecated and should be omitted.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new PatchDomainRecordsRequest
                {
                ...
                response = client.PatchDomainRecords(request).GetAwaiter().GetResult();
        ...
        private PatchDomainRecordsResponse response;
    }
}
