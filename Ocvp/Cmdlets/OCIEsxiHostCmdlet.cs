...
{
    public abstract class OCIEsxiHostCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new EsxiHostClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected EsxiHostClient client;
