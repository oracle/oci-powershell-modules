...
namespace Oci.DataintegrationService.Cmdlets
{
    ...
    public class UpdateOCIDataintegrationDataAsset : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information needed to update a data asset. This parameter also accepts subtypes <Oci.DataintegrationService.Models.UpdateDataAssetFromAtp>, <Oci.DataintegrationService.Models.UpdateDataAssetFromAdwc>, <Oci.DataintegrationService.Models.UpdateDataAssetFromJdbc>, <Oci.DataintegrationService.Models.UpdateDataAssetFromObjectStorage>, <Oci.DataintegrationService.Models.UpdateDataAssetFromMySQL>, <Oci.DataintegrationService.Models.UpdateDataAssetFromOracle> of type <Oci.DataintegrationService.Models.UpdateDataAssetDetails>.")]
