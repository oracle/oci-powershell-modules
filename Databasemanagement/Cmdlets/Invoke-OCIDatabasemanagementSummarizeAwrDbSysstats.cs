...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementSummarizeAwrDbSysstats")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.AwrDbSysstatCollection), typeof(Oci.DatabasemanagementService.Responses.SummarizeAwrDbSysstatsResponse) })]
    public class InvokeOCIDatabasemanagementSummarizeAwrDbSysstats : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.SummarizeAwrDbSysstatsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeAwrDbSysstatsRequest
                {
                ...
                response = client.SummarizeAwrDbSysstats(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AwrDbSysstatCollection);
        ...
        private SummarizeAwrDbSysstatsResponse response;
    }
}
