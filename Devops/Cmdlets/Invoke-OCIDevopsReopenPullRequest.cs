...
{
    [Cmdlet("Invoke", "OCIDevopsReopenPullRequest")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.PullRequest), typeof(Oci.DevopsService.Responses.ReopenPullRequestResponse) })]
    public class InvokeOCIDevopsReopenPullRequest : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ReopenPullRequest(request).GetAwaiter().GetResult();
        ...
        private ReopenPullRequestResponse response;
    }
}
