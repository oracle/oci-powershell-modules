...
{
    [Cmdlet("Remove", "OCIDatabaseCloudAutonomousVmCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteCloudAutonomousVmClusterResponse) })]
    public class RemoveOCIDatabaseCloudAutonomousVmCluster : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseCloudAutonomousVmCluster", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteCloudAutonomousVmClusterRequest
                {
        ...
        private void HandleOutput(DeleteCloudAutonomousVmClusterRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteCloudAutonomousVmCluster(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteCloudAutonomousVmCluster(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteCloudAutonomousVmClusterResponse response;
