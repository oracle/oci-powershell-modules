...
{
    [Cmdlet("Remove", "OCIMysqlaasConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.MysqlService.Responses.DeleteConfigurationResponse) })]
    public class RemoveOCIMysqlaasConfiguration : OCIMysqlaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIMysqlaasConfiguration", "Remove"))
            {
               return;
            }
