...
{
    [Cmdlet("Invoke", "OCIOcvpUpgradeHcx")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OcvpService.Responses.UpgradeHcxResponse) })]
    public class InvokeOCIOcvpUpgradeHcx : OCISddcCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpgradeHcx(request).GetAwaiter().GetResult();
        ...
        private UpgradeHcxResponse response;
    }
}
