...
{
    [Cmdlet("Stop", "OCIAivisionImageJob")]
    ...
    public class StopOCIAivisionImageJob : OCIAIServiceVisionCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelImageJobRequest
                {
                ...
                response = client.CancelImageJob(request).GetAwaiter().GetResult();
        ...
        private CancelImageJobResponse response;
    }
}
