...
{
    [Cmdlet("Invoke", "OCIGloballydistributeddatabaseConfigureSharding")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GloballydistributeddatabaseService.Responses.ConfigureShardingResponse) })]
    public class InvokeOCIGloballydistributeddatabaseConfigureSharding : OCIShardedDatabaseServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ConfigureShardingRequest
                {
                ...
                response = client.ConfigureSharding(request).GetAwaiter().GetResult();
        ...
        private ConfigureShardingResponse response;
    }
}
