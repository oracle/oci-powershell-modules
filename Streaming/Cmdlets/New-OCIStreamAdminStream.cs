...
{
    [Cmdlet("New", "OCIStreamAdminStream")]
    [OutputType(new System.Type[] { typeof(Stream), typeof(Oci.StreamingService.Responses.CreateStreamResponse) })]
    public class NewOCIStreamAdminStream : OCIStreamAdminCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The stream to create.")]
