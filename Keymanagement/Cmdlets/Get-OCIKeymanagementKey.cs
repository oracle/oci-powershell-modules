...
{
    [Cmdlet("Get", "OCIKeymanagementKey", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.Key), typeof(Oci.KeymanagementService.Responses.GetKeyResponse) })]
    public class GetOCIKeymanagementKey : OCIKmsManagementCmdlet
    {
        ...
        public Oci.KeymanagementService.Models.Key.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        private GetKeyResponse response;
