...
namespace Oci.OpsiService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the database for which a Database Insight resource will be created in Operations Insights. This parameter also accepts subtypes <Oci.OpsiService.Models.CreateMacsManagedCloudDatabaseInsightDetails>, <Oci.OpsiService.Models.CreateExternalMysqlDatabaseInsightDetails>, <Oci.OpsiService.Models.CreateAutonomousDatabaseInsightDetails>, <Oci.OpsiService.Models.CreateMacsManagedAutonomousDatabaseInsightDetails>, <Oci.OpsiService.Models.CreateMdsMySqlDatabaseInsightDetails>, <Oci.OpsiService.Models.CreateEmManagedExternalDatabaseInsightDetails>, <Oci.OpsiService.Models.CreatePeComanagedDatabaseInsightDetails> of type <Oci.OpsiService.Models.CreateDatabaseInsightDetails>.")]
