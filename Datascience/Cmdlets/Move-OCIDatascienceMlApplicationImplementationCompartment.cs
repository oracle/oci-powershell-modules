...
{
    [Cmdlet("Move", "OCIDatascienceMlApplicationImplementationCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatascienceService.Responses.ChangeMlApplicationImplementationCompartmentResponse) })]
    public class MoveOCIDatascienceMlApplicationImplementationCompartment : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeMlApplicationImplementationCompartmentRequest
                {
                ...
                response = client.ChangeMlApplicationImplementationCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeMlApplicationImplementationCompartmentResponse response;
    }
}
