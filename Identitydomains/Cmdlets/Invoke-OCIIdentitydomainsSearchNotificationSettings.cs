...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchNotificationSettings")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.NotificationSettings), typeof(Oci.IdentitydomainsService.Responses.SearchNotificationSettingsResponse) })]
    public class InvokeOCIIdentitydomainsSearchNotificationSettings : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching NotificationSettings")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchNotificationSettingsRequest
                {
                ...
                response = client.SearchNotificationSettings(request).GetAwaiter().GetResult();
                WriteOutput(response, response.NotificationSettings);
        ...
        private SearchNotificationSettingsResponse response;
    }
}
