...
{
    [Cmdlet("Stop", "OCIKeymanagementKeyVersionDeletion")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.KeyVersion), typeof(Oci.KeymanagementService.Responses.CancelKeyVersionDeletionResponse) })]
    public class StopOCIKeymanagementKeyVersionDeletion : OCIKmsManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelKeyVersionDeletionRequest
                {
                    KeyId = KeyId,
                ...
                response = client.CancelKeyVersionDeletion(request).GetAwaiter().GetResult();
        ...
        private CancelKeyVersionDeletionResponse response;
    }
}
