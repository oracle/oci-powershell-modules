...
namespace Oci.DataintegrationService.Cmdlets
{
    ...
    public class GetOCIDataintegrationConnectionsList : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"This filter parameter can be used to filter by the data asset key of the object.")]
