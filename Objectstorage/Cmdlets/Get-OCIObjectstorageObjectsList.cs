...
{
    [Cmdlet("Get", "OCIObjectstorageObjectsList")]
    [OutputType(new System.Type[] { typeof(Oci.ObjectstorageService.Models.ListObjects), typeof(Oci.ObjectstorageService.Responses.ListObjectsResponse) })]
    public class GetOCIObjectstorageObjectsList : OCIObjectStorageCmdlet
    {
        ...
        public System.Nullable<Oci.ObjectstorageService.Requests.ListObjectsRequest.FieldsEnum> Fields { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListObjectsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListObjectsResponse> DefaultRequest(ListObjectsRequest request) => Enumerable.Repeat(client.ListObjects(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListObjectsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListObjectsResponse response;
        private delegate IEnumerable<ListObjectsResponse> RequestDelegate(ListObjectsRequest request);
