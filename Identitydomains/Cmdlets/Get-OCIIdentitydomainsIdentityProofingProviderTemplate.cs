...
{
    [Cmdlet("Get", "OCIIdentitydomainsIdentityProofingProviderTemplate")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.IdentityProofingProviderTemplate), typeof(Oci.IdentitydomainsService.Responses.GetIdentityProofingProviderTemplateResponse) })]
    public class GetOCIIdentitydomainsIdentityProofingProviderTemplate : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetIdentityProofingProviderTemplateRequest
                {
                ...
                response = client.GetIdentityProofingProviderTemplate(request).GetAwaiter().GetResult();
        ...
        private GetIdentityProofingProviderTemplateResponse response;
    }
}
