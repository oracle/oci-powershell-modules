...
{
    [Cmdlet("New", "OCIDevopsProject")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.Project), typeof(Oci.DevopsService.Responses.CreateProjectResponse) })]
    public class NewOCIDevopsProject : OCIDevopsCmdlet
    {
