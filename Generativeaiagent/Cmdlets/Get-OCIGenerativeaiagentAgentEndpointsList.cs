...
namespace Oci.GenerativeaiagentService.Cmdlets
{
    ...
    public class GetOCIGenerativeaiagentAgentEndpointsList : OCIGenerativeAiAgentCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the agent.")]
