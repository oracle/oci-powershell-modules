...
{
    [Cmdlet("Get", "OCITransferApplianceEntitlement", DefaultParameterSetName = Default)]
    ...
    public class GetOCITransferApplianceEntitlement : OCITransferApplianceEntitlementCmdlet
    {
