...
{
    [Cmdlet("Update", "OCIWaasCachingRules")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdateCachingRulesResponse) })]
    public class UpdateOCIWaasCachingRules : OCIWaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateCachingRulesRequest
                {
                ...
                response = client.UpdateCachingRules(request).GetAwaiter().GetResult();
        ...
        private UpdateCachingRulesResponse response;
    }
}
