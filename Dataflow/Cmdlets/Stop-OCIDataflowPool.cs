...
{
    [Cmdlet("Stop", "OCIDataflowPool")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DataflowService.Responses.StopPoolResponse) })]
    public class StopOCIDataflowPool : OCIDataFlowCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.StopPool(request).GetAwaiter().GetResult();
        ...
        private StopPoolResponse response;
    }
}
