...
{
    [Cmdlet("Remove", "OCIAilanguageJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AilanguageService.Responses.DeleteJobResponse) })]
    public class RemoveOCIAilanguageJob : OCIAIServiceLanguageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAilanguageJob", "Remove"))
            {
               return;
            }
