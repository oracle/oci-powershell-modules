...
{
    [Cmdlet("Move", "OCIVaultsSecretCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.VaultService.Responses.ChangeSecretCompartmentResponse) })]
    public class MoveOCIVaultsSecretCompartment : OCIVaultsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeSecretCompartmentRequest
                {
                    SecretId = SecretId,
                ...
                response = client.ChangeSecretCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeSecretCompartmentResponse response;
    }
}
