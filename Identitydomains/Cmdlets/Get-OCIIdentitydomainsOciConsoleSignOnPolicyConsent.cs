...
{
    [Cmdlet("Get", "OCIIdentitydomainsOciConsoleSignOnPolicyConsent")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.OciConsoleSignOnPolicyConsent), typeof(Oci.IdentitydomainsService.Responses.GetOciConsoleSignOnPolicyConsentResponse) })]
    public class GetOCIIdentitydomainsOciConsoleSignOnPolicyConsent : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOciConsoleSignOnPolicyConsentRequest
                {
                ...
                response = client.GetOciConsoleSignOnPolicyConsent(request).GetAwaiter().GetResult();
                WriteOutput(response, response.OciConsoleSignOnPolicyConsent);
        ...
        private GetOciConsoleSignOnPolicyConsentResponse response;
    }
}
