...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchAccountMgmtInfos")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.AccountMgmtInfos), typeof(Oci.IdentitydomainsService.Responses.SearchAccountMgmtInfosResponse) })]
    public class InvokeOCIIdentitydomainsSearchAccountMgmtInfos : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching AccountMgmtInfos")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchAccountMgmtInfosRequest
                {
                ...
                response = client.SearchAccountMgmtInfos(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AccountMgmtInfos);
        ...
        private SearchAccountMgmtInfosResponse response;
    }
}
