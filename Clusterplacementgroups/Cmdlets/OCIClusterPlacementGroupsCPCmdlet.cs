...
using Oci.ClusterplacementgroupsService;

namespace Oci.ClusterplacementgroupsService.Cmdlets
{
    public abstract class OCIClusterPlacementGroupsCPCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ClusterPlacementGroupsCPClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ClusterPlacementGroupsCPClient client;
