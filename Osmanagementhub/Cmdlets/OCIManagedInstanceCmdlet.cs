...
{
    public abstract class OCIManagedInstanceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ManagedInstanceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ManagedInstanceClient client;
