...
{
    public abstract class OCIByolAllocationCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ByolAllocationClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ByolAllocationClient client;
