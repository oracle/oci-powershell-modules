#
# Module manifest for module 'OCI.PSModules.Distributeddatabase'
#
...
Description = 'This modules provides Cmdlets for OCI Distributeddatabase Service'
...
CmdletsToExport = 
               ...
               'Remove-OCIDistributeddatabasePrivateEndpoint', 
               'Start-OCIDistributeddatabase', 
               'Start-OCIDistributeddatabaseDistributedAutonomousDatabase', 
               'Stop-OCIDistributeddatabase', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'PSEdition_Core','Windows','Linux','macOS','Oracle','OCI','Cloud','OracleCloudInfrastructure','Distributeddatabase'
