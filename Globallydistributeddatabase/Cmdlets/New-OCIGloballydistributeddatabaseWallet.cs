...
namespace Oci.GloballydistributeddatabaseService.Cmdlets
{
     ...
     */
    [Cmdlet("New", "OCIGloballydistributeddatabaseWallet", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.GloballydistributeddatabaseService.Responses.GenerateWalletResponse) })]
    public class NewOCIGloballydistributeddatabaseWallet : OCIShardedDatabaseServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for generating sharded database wallet.")]
        public GenerateWalletDetails GenerateWalletDetails { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GenerateWallet(request).GetAwaiter().GetResult();
                HandleOutput();
