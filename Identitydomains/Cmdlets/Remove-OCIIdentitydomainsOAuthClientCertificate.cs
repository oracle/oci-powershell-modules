...
{
    [Cmdlet("Remove", "OCIIdentitydomainsOAuthClientCertificate", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteOAuthClientCertificateResponse) })]
    public class RemoveOCIIdentitydomainsOAuthClientCertificate : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsOAuthClientCertificate", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteOAuthClientCertificateRequest
                {
                ...
                response = client.DeleteOAuthClientCertificate(request).GetAwaiter().GetResult();
        ...
        private DeleteOAuthClientCertificateResponse response;
    }
}
