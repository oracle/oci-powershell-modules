...
{
    [Cmdlet("New", "OCICloudguardTargetDetectorRecipe")]
    ...
    public class NewOCICloudguardTargetDetectorRecipe : OCICloudGuardCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateTargetDetectorRecipeRequest
                {
                    TargetId = TargetId,
                ...
                response = client.CreateTargetDetectorRecipe(request).GetAwaiter().GetResult();
        ...
        private CreateTargetDetectorRecipeResponse response;
    }
}
