...
{
    public abstract class OCIFleetAppsManagementAdminCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new FleetAppsManagementAdminClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected FleetAppsManagementAdminClient client;
