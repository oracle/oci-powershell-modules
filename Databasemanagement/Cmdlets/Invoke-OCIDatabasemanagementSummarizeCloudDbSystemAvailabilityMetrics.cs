...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementSummarizeCloudDbSystemAvailabilityMetrics")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.MetricsAggregationRangeCollection), typeof(Oci.DatabasemanagementService.Responses.SummarizeCloudDbSystemAvailabilityMetricsResponse) })]
    public class InvokeOCIDatabasemanagementSummarizeCloudDbSystemAvailabilityMetrics : OCIDbManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeCloudDbSystemAvailabilityMetricsRequest
                {
                ...
                response = client.SummarizeCloudDbSystemAvailabilityMetrics(request).GetAwaiter().GetResult();
        ...
        private SummarizeCloudDbSystemAvailabilityMetricsResponse response;
    }
}
