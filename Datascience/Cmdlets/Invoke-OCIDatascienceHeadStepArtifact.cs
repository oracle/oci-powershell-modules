...
{
    [Cmdlet("Invoke", "OCIDatascienceHeadStepArtifact")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatascienceService.Responses.HeadStepArtifactResponse) })]
    public class InvokeOCIDatascienceHeadStepArtifact : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new HeadStepArtifactRequest
                {
                ...
                response = client.HeadStepArtifact(request).GetAwaiter().GetResult();
        ...
        private HeadStepArtifactResponse response;
    }
}
