...
{
    [Cmdlet("Remove", "OCIDatacatalogFolder", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatacatalogService.Responses.DeleteFolderResponse) })]
    public class RemoveOCIDatacatalogFolder : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatacatalogFolder", "Remove"))
            {
               return;
            }
