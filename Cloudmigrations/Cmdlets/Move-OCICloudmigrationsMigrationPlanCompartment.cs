...
{
    [Cmdlet("Move", "OCICloudmigrationsMigrationPlanCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CloudmigrationsService.Responses.ChangeMigrationPlanCompartmentResponse) })]
    public class MoveOCICloudmigrationsMigrationPlanCompartment : OCIMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeMigrationPlanCompartmentRequest
                {
                ...
                response = client.ChangeMigrationPlanCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeMigrationPlanCompartmentResponse response;
    }
}
