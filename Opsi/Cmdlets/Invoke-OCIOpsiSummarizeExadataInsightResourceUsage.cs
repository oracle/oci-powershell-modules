...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeExadataInsightResourceUsage")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.SummarizeExadataInsightResourceUsageCollection), typeof(Oci.OpsiService.Responses.SummarizeExadataInsightResourceUsageResponse) })]
    public class InvokeOCIOpsiSummarizeExadataInsightResourceUsage : OCIOperationsInsightsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The order in which resource usage summary records are listed")]
        public System.Nullable<Oci.OpsiService.Requests.SummarizeExadataInsightResourceUsageRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeExadataInsightResourceUsageRequest
                {
                ...
                response = client.SummarizeExadataInsightResourceUsage(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SummarizeExadataInsightResourceUsageCollection);
        ...
        private SummarizeExadataInsightResourceUsageResponse response;
    }
}
