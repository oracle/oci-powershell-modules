...
{
    [Cmdlet("Get", "OCIWlmsWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.WlmsService.Models.WorkRequestSummaryCollection), typeof(Oci.WlmsService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIWlmsWorkRequestsList : OCIWeblogicManagementServiceCmdlet
    {
        ...
        public System.Nullable<Oci.WlmsService.Models.OperationStatus> Status { get; set; }
        ...
        public System.Nullable<Oci.WlmsService.Requests.ListWorkRequestsRequest.SortOrderEnum> SortOrder { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field to sort by. Default order for `timeAccepted` is descending.")]
        public System.Nullable<Oci.WlmsService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }
