...
{
    [Cmdlet("Get", "OCIVisualbuilderWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.VisualbuilderService.Models.WorkRequestSummaryCollection), typeof(Oci.VisualbuilderService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIVisualbuilderWorkRequestsList : OCIVbInstanceCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The Vb Instance identifier to use to filter results")]
