...
{
    [Cmdlet("Get", "OCIDbmulticloudOracleDbAzureBlobContainer", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DbmulticloudService.Models.OracleDbAzureBlobContainer), typeof(Oci.DbmulticloudService.Responses.GetOracleDbAzureBlobContainerResponse) })]
    public class GetOCIDbmulticloudOracleDbAzureBlobContainer : OCIOracleDBAzureBlobContainerCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Oracle DB Azure Blob Container resource.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Oracle DB Azure Blob Container resource.", ParameterSetName = Default)]
        ...
        public Oci.DbmulticloudService.Models.OracleDbAzureBlobContainer.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOracleDbAzureBlobContainerRequest
                {
        ...
        private void HandleOutput(GetOracleDbAzureBlobContainerRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForOracleDbAzureBlobContainer(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetOracleDbAzureBlobContainer(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.OracleDbAzureBlobContainer);
        }

        private GetOracleDbAzureBlobContainerResponse response;
