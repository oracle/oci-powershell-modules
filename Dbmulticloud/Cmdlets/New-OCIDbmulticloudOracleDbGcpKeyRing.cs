...
{
    [Cmdlet("New", "OCIDbmulticloudOracleDbGcpKeyRing")]
    [OutputType(new System.Type[] { typeof(Oci.DbmulticloudService.Models.OracleDbGcpKeyRing), typeof(Oci.DbmulticloudService.Responses.CreateOracleDbGcpKeyRingResponse) })]
    public class NewOCIDbmulticloudOracleDbGcpKeyRing : OCIDbMulticloudGCPProviderCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for to Create GCP Key Ring Details.")]
...
For example, if a resource has been deleted and permanently purged from the system, a retry of the original creation request may be rejected.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateOracleDbGcpKeyRingRequest
                {
                ...
                response = client.CreateOracleDbGcpKeyRing(request).GetAwaiter().GetResult();
        ...
        private CreateOracleDbGcpKeyRingResponse response;
    }
}
