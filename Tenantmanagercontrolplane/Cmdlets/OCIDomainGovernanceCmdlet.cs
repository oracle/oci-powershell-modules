...
{
    public abstract class OCIDomainGovernanceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DomainGovernanceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DomainGovernanceClient client;
