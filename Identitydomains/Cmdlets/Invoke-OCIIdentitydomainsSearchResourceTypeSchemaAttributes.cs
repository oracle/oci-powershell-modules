...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchResourceTypeSchemaAttributes")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.ResourceTypeSchemaAttributes), typeof(Oci.IdentitydomainsService.Responses.SearchResourceTypeSchemaAttributesResponse) })]
    public class InvokeOCIIdentitydomainsSearchResourceTypeSchemaAttributes : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching ResourceTypeSchemaAttributes")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchResourceTypeSchemaAttributesRequest
                {
                ...
                response = client.SearchResourceTypeSchemaAttributes(request).GetAwaiter().GetResult();
                WriteOutput(response, response.ResourceTypeSchemaAttributes);
        ...
        private SearchResourceTypeSchemaAttributesResponse response;
    }
}
