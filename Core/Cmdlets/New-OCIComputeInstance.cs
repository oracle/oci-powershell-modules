...
{
    [Cmdlet("New", "OCIComputeInstance", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.Instance), typeof(Oci.CoreService.Responses.LaunchInstanceResponse) })]
    public class NewOCIComputeInstance : OCIComputeCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Instance details", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Instance details", ParameterSetName = Default)]
        ...
        private LaunchInstanceResponse response;
