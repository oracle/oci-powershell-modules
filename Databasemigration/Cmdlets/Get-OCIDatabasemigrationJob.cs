...
{
    [Cmdlet("Get", "OCIDatabasemigrationJob", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemigrationService.Models.Job), typeof(Oci.DatabasemigrationService.Responses.GetJobResponse) })]
    public class GetOCIDatabasemigrationJob : OCIDatabaseMigrationCmdlet
    {
        ...
        public Oci.DatabasemigrationService.Models.JobLifecycleStates[] WaitForLifecycleState { get; set; }
