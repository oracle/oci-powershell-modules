...
{
    [Cmdlet("Move", "OCIDatascienceModelGroupVersionHistoryCompartment")]
    ...
    public class MoveOCIDatascienceModelGroupVersionHistoryCompartment : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeModelGroupVersionHistoryCompartmentRequest
                {
                ...
                response = client.ChangeModelGroupVersionHistoryCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeModelGroupVersionHistoryCompartmentResponse response;
    }
}
