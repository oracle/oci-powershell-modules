...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyUserDbCredential")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyUserDbCredential), typeof(Oci.IdentitydomainsService.Responses.GetMyUserDbCredentialResponse) })]
    public class GetOCIIdentitydomainsMyUserDbCredential : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMyUserDbCredentialRequest
                {
                ...
                response = client.GetMyUserDbCredential(request).GetAwaiter().GetResult();
        ...
        private GetMyUserDbCredentialResponse response;
    }
}
