...
namespace Oci.ResourcemanagerService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIResourcemanagerStackTfState", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.ResourcemanagerService.Responses.GetStackTfStateResponse) })]
    public class GetOCIResourcemanagerStackTfState : OCIResourceManagerCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetStackTfStateRequest
                {
                    StackId = StackId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetStackTfState(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetStackTfStateResponse response;
