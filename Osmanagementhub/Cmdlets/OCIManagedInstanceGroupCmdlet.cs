...
{
    public abstract class OCIManagedInstanceGroupCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ManagedInstanceGroupClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ManagedInstanceGroupClient client;
