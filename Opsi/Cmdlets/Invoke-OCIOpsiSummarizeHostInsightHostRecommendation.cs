...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeHostInsightHostRecommendation")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.SummarizeHostInsightHostRecommendationAggregation), typeof(Oci.OpsiService.Responses.SummarizeHostInsightHostRecommendationResponse) })]
    public class InvokeOCIOpsiSummarizeHostInsightHostRecommendation : OCIOperationsInsightsCmdlet
    {
        ...
        public System.Nullable<Oci.OpsiService.Requests.SummarizeHostInsightHostRecommendationRequest.StatisticEnum> Statistic { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeHostInsightHostRecommendationRequest
                {
                ...
                response = client.SummarizeHostInsightHostRecommendation(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SummarizeHostInsightHostRecommendationAggregation);
        ...
        private SummarizeHostInsightHostRecommendationResponse response;
    }
}
