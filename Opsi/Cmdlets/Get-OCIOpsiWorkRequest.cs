...
{
    [Cmdlet("Get", "OCIOpsiWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.WorkRequest), typeof(Oci.OpsiService.Responses.GetWorkRequestResponse) })]
    public class GetOCIOpsiWorkRequest : OCIOperationsInsightsCmdlet
    {
        ...
        public Oci.OpsiService.Models.OperationStatus[] WaitForStatus { get; set; }
