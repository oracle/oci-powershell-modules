...
namespace Oci.StackmonitoringService.Cmdlets
{
     ...
     */
    [Cmdlet("Export", "OCIStackmonitoringMetricExtension", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.StackmonitoringService.Responses.ExportMetricExtensionResponse) })]
    public class ExportOCIStackmonitoringMetricExtension : OCIStackMonitoringCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ExportMetricExtensionRequest
                {
                ...
                response = client.ExportMetricExtension(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private ExportMetricExtensionResponse response;
