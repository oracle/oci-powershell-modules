...
{
    [Cmdlet("Stop", "OCIDistributeddatabaseDistributedAutonomousDatabase")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.StopDistributedAutonomousDatabaseResponse) })]
    public class StopOCIDistributeddatabaseDistributedAutonomousDatabase : OCIDistributedAutonomousDbServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StopDistributedAutonomousDatabaseRequest
                {
                ...
                response = client.StopDistributedAutonomousDatabase(request).GetAwaiter().GetResult();
        ...
        private StopDistributedAutonomousDatabaseResponse response;
    }
}
