...
{
    [Cmdlet("Remove", "OCICapacitymanagementOccmDemandSignal", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CapacitymanagementService.Responses.DeleteOccmDemandSignalResponse) })]
    public class RemoveOCICapacitymanagementOccmDemandSignal : OCIDemandSignalCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCICapacitymanagementOccmDemandSignal", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteOccmDemandSignalRequest
                {
                ...
                response = client.DeleteOccmDemandSignal(request).GetAwaiter().GetResult();
        ...
        private DeleteOccmDemandSignalResponse response;
    }
}
