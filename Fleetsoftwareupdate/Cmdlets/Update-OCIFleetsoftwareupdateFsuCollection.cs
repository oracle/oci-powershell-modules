...
{
    [Cmdlet("Update", "OCIFleetsoftwareupdateFsuCollection")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.FleetsoftwareupdateService.Responses.UpdateFsuCollectionResponse) })]
    public class UpdateOCIFleetsoftwareupdateFsuCollection : OCIFleetSoftwareUpdateCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The Exadata Fleet Update Collection details to be updated.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateFsuCollectionRequest
                {
                ...
                response = client.UpdateFsuCollection(request).GetAwaiter().GetResult();
        ...
        private UpdateFsuCollectionResponse response;
    }
}
