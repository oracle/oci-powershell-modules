...
{
    [Cmdlet("Get", "OCINetworkfirewallAddressListsList")]
    [OutputType(new System.Type[] { typeof(Oci.NetworkfirewallService.Models.AddressListSummaryCollection), typeof(Oci.NetworkfirewallService.Responses.ListAddressListsResponse) })]
    public class GetOCINetworkfirewallAddressListsList : OCINetworkFirewallCmdlet
    {
        ...
        public System.Nullable<Oci.NetworkfirewallService.Requests.ListAddressListsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    response = item;
                    WriteOutput(response, response.AddressListSummaryCollection, true);
                }
