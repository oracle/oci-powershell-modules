...
{
    [Cmdlet("Stop", "OCIGenerativeaiagentWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.GenerativeaiagentService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIGenerativeaiagentWorkRequest : OCIGenerativeAiAgentCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIGenerativeaiagentWorkRequest", "Stop"))
            {
               return;
            }
