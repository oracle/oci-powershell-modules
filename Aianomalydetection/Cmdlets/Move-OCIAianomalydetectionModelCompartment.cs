...
{
    [Cmdlet("Move", "OCIAianomalydetectionModelCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AianomalydetectionService.Responses.ChangeModelCompartmentResponse) })]
    public class MoveOCIAianomalydetectionModelCompartment : OCIAnomalyDetectionCmdlet
    {
