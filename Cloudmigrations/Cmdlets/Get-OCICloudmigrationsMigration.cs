...
{
    [Cmdlet("Get", "OCICloudmigrationsMigration", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.CloudmigrationsService.Models.Migration), typeof(Oci.CloudmigrationsService.Responses.GetMigrationResponse) })]
    public class GetOCICloudmigrationsMigration : OCIMigrationCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique migration identifier", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique migration identifier", ParameterSetName = Default)]
        ...
        public Oci.CloudmigrationsService.Models.Migration.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
