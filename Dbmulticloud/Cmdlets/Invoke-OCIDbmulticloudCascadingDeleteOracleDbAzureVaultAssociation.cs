...
{
    [Cmdlet("Invoke", "OCIDbmulticloudCascadingDeleteOracleDbAzureVaultAssociation")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DbmulticloudService.Responses.CascadingDeleteOracleDbAzureVaultAssociationResponse) })]
    public class InvokeOCIDbmulticloudCascadingDeleteOracleDbAzureVaultAssociation : OCIOracleDbAzureVaultAssociationCmdlet
    {
...
For example, if a resource has been deleted and permanently purged from the system, a retry of the original creation request may be rejected.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CascadingDeleteOracleDbAzureVaultAssociationRequest
                {
                ...
                response = client.CascadingDeleteOracleDbAzureVaultAssociation(request).GetAwaiter().GetResult();
        ...
        private CascadingDeleteOracleDbAzureVaultAssociationResponse response;
    }
}
