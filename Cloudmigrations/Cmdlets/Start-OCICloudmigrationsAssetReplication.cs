...
{
    [Cmdlet("Start", "OCICloudmigrationsAssetReplication")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CloudmigrationsService.Responses.StartAssetReplicationResponse) })]
    public class StartOCICloudmigrationsAssetReplication : OCIMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartAssetReplicationRequest
                {
                ...
                response = client.StartAssetReplication(request).GetAwaiter().GetResult();
        ...
        private StartAssetReplicationResponse response;
    }
}
