...
{
    [Cmdlet("Get", "OCICloudmigrationsMigrationsList")]
    [OutputType(new System.Type[] { typeof(Oci.CloudmigrationsService.Models.MigrationCollection), typeof(Oci.CloudmigrationsService.Responses.ListMigrationsResponse) })]
    public class GetOCICloudmigrationsMigrationsList : OCIMigrationCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only resources where the resource's lifecycle state matches the given lifecycle state.")]
        public System.Nullable<Oci.CloudmigrationsService.Models.Migration.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.CloudmigrationsService.Requests.ListMigrationsRequest.SortByEnum> SortBy { get; set; }
