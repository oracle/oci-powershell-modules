...
using Oci.RecoveryService;

namespace Oci.RecoveryService.Cmdlets
{
    public abstract class OCIDatabaseRecoveryCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DatabaseRecoveryClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DatabaseRecoveryClient client;
