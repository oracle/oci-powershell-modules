...
{
    [Cmdlet("Get", "OCIJmsWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.JmsService.Models.WorkRequest), typeof(Oci.JmsService.Responses.GetWorkRequestResponse) })]
    public class GetOCIJmsWorkRequest : OCIJavaManagementServiceCmdlet
    {
        ...
        public Oci.JmsService.Models.OperationStatus[] WaitForStatus { get; set; }
