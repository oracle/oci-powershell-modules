...
{
    public abstract class OCIPerfhubCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new PerfhubClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected PerfhubClient client;
