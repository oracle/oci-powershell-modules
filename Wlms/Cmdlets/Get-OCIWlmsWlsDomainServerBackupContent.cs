...
{
    [Cmdlet("Get", "OCIWlmsWlsDomainServerBackupContent")]
    [OutputType(new System.Type[] { typeof(Oci.WlmsService.Models.BackupContent), typeof(Oci.WlmsService.Responses.GetWlsDomainServerBackupContentResponse) })]
    public class GetOCIWlmsWlsDomainServerBackupContent : OCIWeblogicManagementServiceCmdlet
    {
...
**Note:** Not an [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).")]
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique identifier of the backup.
...
**Note:** Not an [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetWlsDomainServerBackupContentRequest
                {
                ...
                response = client.GetWlsDomainServerBackupContent(request).GetAwaiter().GetResult();
                WriteOutput(response, response.BackupContent);
        ...
        private GetWlsDomainServerBackupContentResponse response;
    }
}
