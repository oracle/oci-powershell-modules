...
{
    [Cmdlet("Remove", "OCIOsmanagementEventContent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OsmanagementService.Responses.DeleteEventContentResponse) })]
    public class RemoveOCIOsmanagementEventContent : OCIEventCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOsmanagementEventContent", "Remove"))
            {
               return;
            }
