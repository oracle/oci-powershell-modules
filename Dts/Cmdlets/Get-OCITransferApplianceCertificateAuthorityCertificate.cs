...
{
    [Cmdlet("Get", "OCITransferApplianceCertificateAuthorityCertificate")]
    ...
    public class GetOCITransferApplianceCertificateAuthorityCertificate : OCITransferApplianceCmdlet
    {
