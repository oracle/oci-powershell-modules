...
{
    [Cmdlet("Update", "OCIDataintegrationDisApplication")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.DisApplication), typeof(Oci.DataintegrationService.Responses.UpdateDisApplicationResponse) })]
    public class UpdateOCIDataintegrationDisApplication : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDisApplicationRequest
                {
                ...
                response = client.UpdateDisApplication(request).GetAwaiter().GetResult();
        ...
        private UpdateDisApplicationResponse response;
    }
}
