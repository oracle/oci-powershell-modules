...
namespace Oci.DatabaseService.Cmdlets
{
    ...
    public class MoveOCIDatabaseBackupDestinationCompartment : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the backup destination.", ParameterSetName = StatusParamSet)]
