...
{
    [Cmdlet("Get", "OCIOsmanagementhubAvailableSoftwarePackagesList")]
    [OutputType(new System.Type[] { typeof(Oci.OsmanagementhubService.Models.SoftwarePackageCollection), typeof(Oci.OsmanagementhubService.Responses.ListAvailableSoftwarePackagesResponse) })]
    public class GetOCIOsmanagementhubAvailableSoftwarePackagesList : OCISoftwareSourceCmdlet
    {
...
Example: `3`")]
        ...
        public System.Nullable<Oci.OsmanagementhubService.Requests.ListAvailableSoftwarePackagesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAvailableSoftwarePackagesRequest
                {
                ...
                IEnumerable<ListAvailableSoftwarePackagesResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListAvailableSoftwarePackagesResponse> DefaultRequest(ListAvailableSoftwarePackagesRequest request) => Enumerable.Repeat(client.ListAvailableSoftwarePackages(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAvailableSoftwarePackagesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAvailableSoftwarePackagesResponse response;
        private delegate IEnumerable<ListAvailableSoftwarePackagesResponse> RequestDelegate(ListAvailableSoftwarePackagesRequest request);
