...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeAwrDatabaseWaitEventBuckets")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.AwrDatabaseWaitEventBucketCollection), typeof(Oci.OpsiService.Responses.SummarizeAwrDatabaseWaitEventBucketsResponse) })]
    public class InvokeOCIOpsiSummarizeAwrDatabaseWaitEventBuckets : OCIOperationsInsightsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The internal ID of the database. The internal ID of the database is not the [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm). It can be retrieved from the following endpoint: /awrHubs/{awrHubId}/awrDatabases")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The number of buckets within the histogram.")]
        public System.Nullable<int> NumBucket { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The minimum value of the histogram.")]
        public System.Double MinValue { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The maximum value of the histogram.")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The option to sort distribution data.")]
        public System.Nullable<Oci.OpsiService.Requests.SummarizeAwrDatabaseWaitEventBucketsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeAwrDatabaseWaitEventBucketsRequest
                {
                    AwrHubId = AwrHubId,
                ...
                response = client.SummarizeAwrDatabaseWaitEventBuckets(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AwrDatabaseWaitEventBucketCollection);
        ...
        private SummarizeAwrDatabaseWaitEventBucketsResponse response;
    }
}
