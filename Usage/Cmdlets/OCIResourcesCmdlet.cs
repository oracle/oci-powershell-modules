...
{
    public abstract class OCIResourcesCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ResourcesClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ResourcesClient client;
