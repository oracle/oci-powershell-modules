...
{
    [Cmdlet("Get", "OCIAispeechTranscriptionJobsList")]
    [OutputType(new System.Type[] { typeof(Oci.AispeechService.Models.TranscriptionJobCollection), typeof(Oci.AispeechService.Responses.ListTranscriptionJobsResponse) })]
    public class GetOCIAispeechTranscriptionJobsList : OCIAIServiceSpeechCmdlet
    {
        ...
        public System.Nullable<Oci.AispeechService.Models.TranscriptionJob.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.AispeechService.Requests.ListTranscriptionJobsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListTranscriptionJobsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.TranscriptionJobCollection, true);
                }
        ...
        {
            IEnumerable<ListTranscriptionJobsResponse> DefaultRequest(ListTranscriptionJobsRequest request) => Enumerable.Repeat(client.ListTranscriptionJobs(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListTranscriptionJobsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListTranscriptionJobsResponse response;
        private delegate IEnumerable<ListTranscriptionJobsResponse> RequestDelegate(ListTranscriptionJobsRequest request);
