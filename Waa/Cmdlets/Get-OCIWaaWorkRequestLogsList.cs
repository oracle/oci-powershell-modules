...
{
    [Cmdlet("Get", "OCIWaaWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.WaaService.Models.WorkRequestLogEntryCollection), typeof(Oci.WaaService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIWaaWorkRequestLogsList : OCIWorkRequestCmdlet
    {
