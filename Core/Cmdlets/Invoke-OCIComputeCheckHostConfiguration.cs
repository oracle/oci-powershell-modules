...
{
    [Cmdlet("Invoke", "OCIComputeCheckHostConfiguration")]
    ...
    public class InvokeOCIComputeCheckHostConfiguration : OCIComputeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CheckHostConfigurationRequest
                {
                ...
                response = client.CheckHostConfiguration(request).GetAwaiter().GetResult();
        ...
        private CheckHostConfigurationResponse response;
    }
}
