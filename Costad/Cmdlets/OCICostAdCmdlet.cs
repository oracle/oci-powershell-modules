...
using Oci.CostadService;

namespace Oci.CostadService.Cmdlets
{
    public abstract class OCICostAdCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new CostAdClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
