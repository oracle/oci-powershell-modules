...
{
    [Cmdlet("Get", "OCIRedisWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.RedisService.Models.WorkRequestLogEntryCollection), typeof(Oci.RedisService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIRedisWorkRequestLogsList : OCIRedisClusterCmdlet
    {
        ...
        public System.Nullable<Oci.RedisService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
