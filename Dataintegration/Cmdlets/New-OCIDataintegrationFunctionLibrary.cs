...
{
    [Cmdlet("New", "OCIDataintegrationFunctionLibrary")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.FunctionLibrary), typeof(Oci.DataintegrationService.Responses.CreateFunctionLibraryResponse) })]
    public class NewOCIDataintegrationFunctionLibrary : OCIDataIntegrationCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The workspace ID.")]
        public string WorkspaceId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details needed to create a function Library.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateFunctionLibraryRequest
                {
                ...
                response = client.CreateFunctionLibrary(request).GetAwaiter().GetResult();
        ...
        private CreateFunctionLibraryResponse response;
    }
}
