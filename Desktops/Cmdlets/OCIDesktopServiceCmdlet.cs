...
{
    public abstract class OCIDesktopServiceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DesktopServiceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DesktopServiceClient client;
