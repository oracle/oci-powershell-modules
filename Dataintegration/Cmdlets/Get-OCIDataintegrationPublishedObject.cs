...
{
    [Cmdlet("Get", "OCIDataintegrationPublishedObject")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.PublishedObject), typeof(Oci.DataintegrationService.Responses.GetPublishedObjectResponse) })]
    public class GetOCIDataintegrationPublishedObject : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetPublishedObjectRequest
                {
                ...
                response = client.GetPublishedObject(request).GetAwaiter().GetResult();
                WriteOutput(response, response.PublishedObject);
        ...
        private GetPublishedObjectResponse response;
    }
}
