...
{
    [Cmdlet("Add", "OCIOsmanagementPackagesToSoftwareSource")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OsmanagementService.Responses.AddPackagesToSoftwareSourceResponse) })]
    public class AddOCIOsmanagementPackagesToSoftwareSource : OCIOsManagementCmdlet
    {
