...
{
    public abstract class OCIComputeManagementCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            base.ProcessRecord();
            client?.Dispose();
            client = new ComputeManagementClient(AuthProvider, new Oci.Common.ClientConfiguration
            {
        ...
        protected ComputeManagementClient client;
