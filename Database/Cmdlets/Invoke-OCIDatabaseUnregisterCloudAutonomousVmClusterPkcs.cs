...
{
    [Cmdlet("Invoke", "OCIDatabaseUnregisterCloudAutonomousVmClusterPkcs", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.UnregisterCloudAutonomousVmClusterPkcsResponse) })]
    public class InvokeOCIDatabaseUnregisterCloudAutonomousVmClusterPkcs : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details of unregistering PKCS11 driver.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details of unregistering PKCS11 driver.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UnregisterCloudAutonomousVmClusterPkcsRequest
                {
        ...
        private void HandleOutput(UnregisterCloudAutonomousVmClusterPkcsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUnregisterCloudAutonomousVmClusterPkcs(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UnregisterCloudAutonomousVmClusterPkcs(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private UnregisterCloudAutonomousVmClusterPkcsResponse response;
