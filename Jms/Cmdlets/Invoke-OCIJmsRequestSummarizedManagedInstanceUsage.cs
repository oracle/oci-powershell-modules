...
{
    [Cmdlet("Invoke", "OCIJmsRequestSummarizedManagedInstanceUsage")]
    [OutputType(new System.Type[] { typeof(Oci.JmsService.Models.ManagedInstanceUsageCollection), typeof(Oci.JmsService.Responses.RequestSummarizedManagedInstanceUsageResponse) })]
    public class InvokeOCIJmsRequestSummarizedManagedInstanceUsage : OCIJavaManagementServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for filtering managed instance usage.")]
        public RequestSummarizedManagedInstanceUsageDetails RequestSummarizedManagedInstanceUsageDetails { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RequestSummarizedManagedInstanceUsageRequest
                {
                    FleetId = FleetId,
                ...
                response = client.RequestSummarizedManagedInstanceUsage(request).GetAwaiter().GetResult();
        ...
        private RequestSummarizedManagedInstanceUsageResponse response;
    }
}
