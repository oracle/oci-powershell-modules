...
{
    [Cmdlet("New", "OCIDatabasemanagementCloudDbSystemConnector")]
    ...
    public class NewOCIDatabasemanagementCloudDbSystemConnector : OCIDbManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateCloudDbSystemConnectorRequest
                {
                ...
                response = client.CreateCloudDbSystemConnector(request).GetAwaiter().GetResult();
        ...
        private CreateCloudDbSystemConnectorResponse response;
    }
}
