...
namespace Oci.DataccService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIDataccDownloadInfrastructureConfigFile", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DataccService.Responses.DownloadInfrastructureConfigFileResponse) })]
    public class InvokeOCIDataccDownloadInfrastructureConfigFile : OCIBaseinfraCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DownloadInfrastructureConfigFileRequest
                {
                    InfrastructureId = InfrastructureId,
                    OpcRequestId = OpcRequestId
                };

                response = client.DownloadInfrastructureConfigFile(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private DownloadInfrastructureConfigFileResponse response;
