...
{
    public abstract class OCIAIServiceLanguageCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AIServiceLanguageClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AIServiceLanguageClient client;
