...
{
    [Cmdlet("Restart", "OCIDatabaseAutonomousVmClusterOrds", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.RestartAutonomousVmClusterOrdsResponse) })]
    public class RestartOCIDatabaseAutonomousVmClusterOrds : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RestartAutonomousVmClusterOrdsRequest
                {
        ...
        private void HandleOutput(RestartAutonomousVmClusterOrdsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRestartAutonomousVmClusterOrds(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RestartAutonomousVmClusterOrds(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private RestartAutonomousVmClusterOrdsResponse response;
