...
using Oci.ApmtracesService;

namespace Oci.ApmtracesService.Cmdlets
{
    public abstract class OCIScheduledQueryCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ScheduledQueryClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ScheduledQueryClient client;
