...
{
    [Cmdlet("Remove", "OCIDataintegrationConnection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataintegrationService.Responses.DeleteConnectionResponse) })]
    public class RemoveOCIDataintegrationConnection : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataintegrationConnection", "Remove"))
            {
               return;
            }
