...
{
    [Cmdlet("Get", "OCIMarketplacepublisherPublishersList")]
    [OutputType(new System.Type[] { typeof(Oci.MarketplacepublisherService.Models.PublisherCollection), typeof(Oci.MarketplacepublisherService.Responses.ListPublishersResponse) })]
    public class GetOCIMarketplacepublisherPublishersList : OCIMarketplacePublisherCmdlet
    {
        ...
        public System.Nullable<Oci.MarketplacepublisherService.Requests.ListPublishersRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    response = item;
                    WriteOutput(response, response.PublisherCollection, true);
                }
