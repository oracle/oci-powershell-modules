...
{
    [Cmdlet("Remove", "OCIApplianceExportJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DtsService.Responses.DeleteApplianceExportJobResponse) })]
    public class RemoveOCIApplianceExportJob : OCIApplianceExportJobCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIApplianceExportJob", "Remove"))
            {
               return;
            }
