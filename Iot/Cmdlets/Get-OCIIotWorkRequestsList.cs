...
{
    [Cmdlet("Get", "OCIIotWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.IotService.Models.WorkRequestSummaryCollection), typeof(Oci.IotService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIIotWorkRequestsList : OCIIotCmdlet
    {
        ...
        public System.Nullable<Oci.IotService.Models.OperationStatus> Status { get; set; }
        ...
        public System.Nullable<Oci.IotService.Requests.ListWorkRequestsRequest.SortOrderEnum> SortOrder { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field to sort by. Only one sort order can be specified. Default order for `timeAccepted` is descending.")]
        public System.Nullable<Oci.IotService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }
