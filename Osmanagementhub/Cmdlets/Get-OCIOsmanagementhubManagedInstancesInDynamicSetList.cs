...
{
    [Cmdlet("Get", "OCIOsmanagementhubManagedInstancesInDynamicSetList")]
    [OutputType(new System.Type[] { typeof(Oci.OsmanagementhubService.Models.ManagedInstanceCollection), typeof(Oci.OsmanagementhubService.Responses.ListManagedInstancesInDynamicSetResponse) })]
    public class GetOCIOsmanagementhubManagedInstancesInDynamicSetList : OCIDynamicSetCmdlet
    {
...
Example: `3`")]
        ...
        public System.Nullable<Oci.OsmanagementhubService.Requests.ListManagedInstancesInDynamicSetRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListManagedInstancesInDynamicSetRequest
                {
                ...
                IEnumerable<ListManagedInstancesInDynamicSetResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListManagedInstancesInDynamicSetResponse> DefaultRequest(ListManagedInstancesInDynamicSetRequest request) => Enumerable.Repeat(client.ListManagedInstancesInDynamicSet(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListManagedInstancesInDynamicSetResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListManagedInstancesInDynamicSetResponse response;
        private delegate IEnumerable<ListManagedInstancesInDynamicSetResponse> RequestDelegate(ListManagedInstancesInDynamicSetRequest request);
