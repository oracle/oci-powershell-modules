...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyGroupsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyGroups), typeof(Oci.IdentitydomainsService.Responses.ListMyGroupsResponse) })]
    public class GetOCIIdentitydomainsMyGroupsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMyGroupsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListMyGroups(request).GetAwaiter().GetResult();
        ...
        private ListMyGroupsResponse response;
    }
}
