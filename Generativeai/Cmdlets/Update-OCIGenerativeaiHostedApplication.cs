...
{
    [Cmdlet("Update", "OCIGenerativeaiHostedApplication")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GenerativeaiService.Responses.UpdateHostedApplicationResponse) })]
    public class UpdateOCIGenerativeaiHostedApplication : OCIGenerativeAiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateHostedApplicationRequest
                {
                ...
                response = client.UpdateHostedApplication(request).GetAwaiter().GetResult();
        ...
        private UpdateHostedApplicationResponse response;
    }
}
