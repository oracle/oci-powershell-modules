...
{
    [Cmdlet("Invoke", "OCIDnsPatchZoneRecords")]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.RecordCollection), typeof(Oci.DnsService.Responses.PatchZoneRecordsResponse) })]
    public class InvokeOCIDnsPatchZoneRecords : OCIDnsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The operations describing how to modify the collection of records.")]
...
This parameter is deprecated and should be omitted.")]
        ...
        private PatchZoneRecordsResponse response;
    }
}
