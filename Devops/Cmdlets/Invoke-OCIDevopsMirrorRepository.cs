...
{
    [Cmdlet("Invoke", "OCIDevopsMirrorRepository")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DevopsService.Responses.MirrorRepositoryResponse) })]
    public class InvokeOCIDevopsMirrorRepository : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new MirrorRepositoryRequest
                {
                ...
                response = client.MirrorRepository(request).GetAwaiter().GetResult();
        ...
        private MirrorRepositoryResponse response;
    }
}
