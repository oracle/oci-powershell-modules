...
{
    [Cmdlet("Move", "OCIAivisionStreamSourceCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AivisionService.Responses.ChangeStreamSourceCompartmentResponse) })]
    public class MoveOCIAivisionStreamSourceCompartment : OCIAIServiceVisionCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeStreamSourceCompartmentRequest
                {
                ...
                response = client.ChangeStreamSourceCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeStreamSourceCompartmentResponse response;
    }
}
