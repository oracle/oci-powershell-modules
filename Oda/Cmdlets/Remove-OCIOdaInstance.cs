...
{
    [Cmdlet("Remove", "OCIOdaInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OdaService.Responses.DeleteOdaInstanceResponse) })]
    public class RemoveOCIOdaInstance : OCIOdaCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOdaInstance", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteOdaInstance(request).GetAwaiter().GetResult();
        ...
        private DeleteOdaInstanceResponse response;
    }
}
