...
{
    [Cmdlet("Move", "OCIAidocumentModelCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AidocumentService.Responses.ChangeModelCompartmentResponse) })]
    public class MoveOCIAidocumentModelCompartment : OCIAIServiceDocumentCmdlet
    {
