...
{
    [Cmdlet("Get", "OCIWaasProtectionSettings")]
    [OutputType(new System.Type[] { typeof(Oci.WaasService.Models.ProtectionSettings), typeof(Oci.WaasService.Responses.GetProtectionSettingsResponse) })]
    public class GetOCIWaasProtectionSettings : OCIWaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetProtectionSettingsRequest
                {
                    WaasPolicyId = WaasPolicyId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetProtectionSettings(request).GetAwaiter().GetResult();
                WriteOutput(response, response.ProtectionSettings);
        ...
        private GetProtectionSettingsResponse response;
    }
}
