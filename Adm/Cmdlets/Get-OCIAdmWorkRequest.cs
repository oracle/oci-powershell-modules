...
{
    [Cmdlet("Get", "OCIAdmWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.AdmService.Models.WorkRequest), typeof(Oci.AdmService.Responses.GetWorkRequestResponse) })]
    public class GetOCIAdmWorkRequest : OCIApplicationDependencyManagementCmdlet
    {
        ...
        public Oci.AdmService.Models.OperationStatus[] WaitForStatus { get; set; }
