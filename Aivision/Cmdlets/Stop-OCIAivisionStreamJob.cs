...
{
    [Cmdlet("Stop", "OCIAivisionStreamJob")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AivisionService.Responses.StopStreamJobResponse) })]
    public class StopOCIAivisionStreamJob : OCIAIServiceVisionCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StopStreamJobRequest
                {
                ...
                response = client.StopStreamJob(request).GetAwaiter().GetResult();
        ...
        private StopStreamJobResponse response;
    }
}
