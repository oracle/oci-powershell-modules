...
{
    public abstract class OCILifecycleEnvironmentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new LifecycleEnvironmentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected LifecycleEnvironmentClient client;
