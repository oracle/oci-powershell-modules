...
{
    [Cmdlet("New", "OCIGenerativeaiagentDataSource")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiagentService.Models.DataSource), typeof(Oci.GenerativeaiagentService.Responses.CreateDataSourceResponse) })]
    public class NewOCIGenerativeaiagentDataSource : OCIGenerativeAiAgentCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new data source.")]
