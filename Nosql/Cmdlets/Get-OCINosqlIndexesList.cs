...
{
    [Cmdlet("Get", "OCINosqlIndexesList")]
    [OutputType(new System.Type[] { typeof(Oci.NosqlService.Models.IndexCollection), typeof(Oci.NosqlService.Responses.ListIndexesResponse) })]
    public class GetOCINosqlIndexesList : OCINosqlCmdlet
    {
        ...
        public System.Nullable<Oci.NosqlService.Requests.ListIndexesRequest.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.NosqlService.Requests.ListIndexesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.NosqlService.Requests.ListIndexesRequest.SortByEnum> SortBy { get; set; }
        ...
        {
            IEnumerable<ListIndexesResponse> DefaultRequest(ListIndexesRequest request) => Enumerable.Repeat(client.ListIndexes(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListIndexesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListIndexesResponse response;
        private delegate IEnumerable<ListIndexesResponse> RequestDelegate(ListIndexesRequest request);
