...
{
    [Cmdlet("Get", "OCICapacitymanagementOccCapacityRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.CapacitymanagementService.Models.OccCapacityRequestCollection), typeof(Oci.CapacitymanagementService.Responses.ListOccCapacityRequestsResponse) })]
    public class GetOCICapacitymanagementOccCapacityRequestsList : OCICapacityManagementCmdlet
    {
        ...
        public System.Nullable<Oci.CapacitymanagementService.Requests.ListOccCapacityRequestsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListOccCapacityRequestsRequest
                {
                ...
                IEnumerable<ListOccCapacityRequestsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListOccCapacityRequestsResponse> DefaultRequest(ListOccCapacityRequestsRequest request) => Enumerable.Repeat(client.ListOccCapacityRequests(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListOccCapacityRequestsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListOccCapacityRequestsResponse response;
        private delegate IEnumerable<ListOccCapacityRequestsResponse> RequestDelegate(ListOccCapacityRequestsRequest request);
