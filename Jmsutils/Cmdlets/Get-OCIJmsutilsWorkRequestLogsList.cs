...
{
    [Cmdlet("Get", "OCIJmsutilsWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.JmsutilsService.Models.WorkRequestLogEntryCollection), typeof(Oci.JmsutilsService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIJmsutilsWorkRequestLogsList : OCIJmsUtilsCmdlet
    {
        ...
        public System.Nullable<Oci.JmsutilsService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
