...
{
    [Cmdlet("Update", "OCIDevopsRepositoryNotificationPreference")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.RepositoryNotificationPreference), typeof(Oci.DevopsService.Responses.UpdateRepositoryNotificationPreferenceResponse) })]
    public class UpdateOCIDevopsRepositoryNotificationPreference : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateRepositoryNotificationPreferenceRequest
                {
                ...
                response = client.UpdateRepositoryNotificationPreference(request).GetAwaiter().GetResult();
                WriteOutput(response, response.RepositoryNotificationPreference);
        ...
        private UpdateRepositoryNotificationPreferenceResponse response;
    }
}
