...
{
    [Cmdlet("Remove", "OCIFilestorageMountTarget", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.FilestorageService.Responses.DeleteMountTargetResponse) })]
    public class RemoveOCIFilestorageMountTarget : OCIFileStorageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIFilestorageMountTarget", "Remove"))
            {
               return;
            }
        ...
        private DeleteMountTargetResponse response;
    }
}
