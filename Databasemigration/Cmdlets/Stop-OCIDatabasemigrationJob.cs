...
{
    [Cmdlet("Stop", "OCIDatabasemigrationJob")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemigrationService.Models.Job), typeof(Oci.DatabasemigrationService.Responses.AbortJobResponse) })]
    public class StopOCIDatabasemigrationJob : OCIDatabaseMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.AbortJob(request).GetAwaiter().GetResult();
        ...
        private AbortJobResponse response;
    }
}
