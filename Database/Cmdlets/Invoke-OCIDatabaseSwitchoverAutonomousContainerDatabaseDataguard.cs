...
{
    [Cmdlet("Invoke", "OCIDatabaseSwitchoverAutonomousContainerDatabaseDataguard", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousContainerDatabase), typeof(Oci.DatabaseService.Responses.SwitchoverAutonomousContainerDatabaseDataguardResponse) })]
    public class InvokeOCIDatabaseSwitchoverAutonomousContainerDatabaseDataguard : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SwitchoverAutonomousContainerDatabaseDataguardRequest
                {
        ...
        private void HandleOutput(SwitchoverAutonomousContainerDatabaseDataguardRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForSwitchoverAutonomousContainerDatabaseDataguard(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.SwitchoverAutonomousContainerDatabaseDataguard(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousContainerDatabase);
        }

        private SwitchoverAutonomousContainerDatabaseDataguardResponse response;
