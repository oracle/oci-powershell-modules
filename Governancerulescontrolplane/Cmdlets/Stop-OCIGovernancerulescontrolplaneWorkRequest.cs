...
{
    [Cmdlet("Stop", "OCIGovernancerulescontrolplaneWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.GovernancerulescontrolplaneService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIGovernancerulescontrolplaneWorkRequest : OCIWorkRequestCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIGovernancerulescontrolplaneWorkRequest", "Stop"))
            {
               return;
            }
