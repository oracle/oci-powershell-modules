...
{
    [Cmdlet("Remove", "OCIDatabasePluggableDatabase", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeletePluggableDatabaseResponse) })]
    public class RemoveOCIDatabasePluggableDatabase : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabasePluggableDatabase", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeletePluggableDatabaseRequest
                {
        ...
        private void HandleOutput(DeletePluggableDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeletePluggableDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeletePluggableDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeletePluggableDatabaseResponse response;
