...
CmdletsToExport = 'Get-OCIUsageapiQueriesList', 'Get-OCIUsageapiQuery', 
               'Invoke-OCIUsageapiRequestSummarizedConfigurations', 
               'Invoke-OCIUsageapiRequestSummarizedUsages', 'New-OCIUsageapiQuery', 
               'Remove-OCIUsageapiQuery', 'Update-OCIUsageapiQuery'
