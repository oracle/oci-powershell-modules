...
{
    [Cmdlet("Get", "OCIDatascienceModelGroupModelsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.ModelGroupModelSummary), typeof(Oci.DatascienceService.Responses.ListModelGroupModelsResponse) })]
    public class GetOCIDatascienceModelGroupModelsList : OCIDataScienceCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the modelGroup.")]
...
See [List Pagination](https://docs.oracle.com/iaas/Content/General/Concepts/usingapi.htm#nine).")]
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListModelGroupModelsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListModelGroupModelsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListModelGroupModelsRequest
                {
                ...
                IEnumerable<ListModelGroupModelsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListModelGroupModelsResponse> DefaultRequest(ListModelGroupModelsRequest request) => Enumerable.Repeat(client.ListModelGroupModels(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListModelGroupModelsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListModelGroupModelsResponse response;
        private delegate IEnumerable<ListModelGroupModelsResponse> RequestDelegate(ListModelGroupModelsRequest request);
