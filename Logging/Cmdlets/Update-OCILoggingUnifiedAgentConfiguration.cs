...
{
    [Cmdlet("Update", "OCILoggingUnifiedAgentConfiguration")]
    ...
    public class UpdateOCILoggingUnifiedAgentConfiguration : OCILoggingManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateUnifiedAgentConfigurationRequest
                {
                ...
                response = client.UpdateUnifiedAgentConfiguration(request).GetAwaiter().GetResult();
        ...
        private UpdateUnifiedAgentConfigurationResponse response;
    }
}
