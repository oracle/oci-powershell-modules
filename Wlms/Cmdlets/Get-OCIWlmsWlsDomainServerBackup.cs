...
{
    [Cmdlet("Get", "OCIWlmsWlsDomainServerBackup")]
    [OutputType(new System.Type[] { typeof(Oci.WlmsService.Models.Backup), typeof(Oci.WlmsService.Responses.GetWlsDomainServerBackupResponse) })]
    public class GetOCIWlmsWlsDomainServerBackup : OCIWeblogicManagementServiceCmdlet
    {
...
**Note:** Not an [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetWlsDomainServerBackupRequest
                {
                ...
                response = client.GetWlsDomainServerBackup(request).GetAwaiter().GetResult();
        ...
        private GetWlsDomainServerBackupResponse response;
    }
}
