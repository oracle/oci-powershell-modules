...
{
    [Cmdlet("Get", "OCIAivisionWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.AivisionService.Models.WorkRequest), typeof(Oci.AivisionService.Responses.GetWorkRequestResponse) })]
    public class GetOCIAivisionWorkRequest : OCIAIServiceVisionCmdlet
    {
        ...
        public Oci.AivisionService.Models.OperationStatus[] WaitForStatus { get; set; }
