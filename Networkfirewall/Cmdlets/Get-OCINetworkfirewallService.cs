...
{
    [Cmdlet("Get", "OCINetworkfirewallService")]
    [OutputType(new System.Type[] { typeof(Oci.NetworkfirewallService.Models.Service), typeof(Oci.NetworkfirewallService.Responses.GetServiceResponse) })]
    public class GetOCINetworkfirewallService : OCINetworkFirewallCmdlet
    {
