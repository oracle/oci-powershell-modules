...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchConditions")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Conditions), typeof(Oci.IdentitydomainsService.Responses.SearchConditionsResponse) })]
    public class InvokeOCIIdentitydomainsSearchConditions : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching Conditions")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchConditionsRequest
                {
                ...
                response = client.SearchConditions(request).GetAwaiter().GetResult();
                WriteOutput(response, response.Conditions);
        ...
        private SearchConditionsResponse response;
    }
}
