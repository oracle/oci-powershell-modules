...
{
    [Cmdlet("Get", "OCIResourceschedulerWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.ResourceschedulerService.Models.WorkRequestErrorCollection), typeof(Oci.ResourceschedulerService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIResourceschedulerWorkRequestErrorsList : OCIScheduleCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"This is the field to sort by. Only one sort order may be provided. Default order for `timestamp` is descending.")]
        public System.Nullable<Oci.ResourceschedulerService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }
