...
{
    [Cmdlet("Get", "OCIApplicationmigrationWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.ApplicationmigrationService.Models.WorkRequest), typeof(Oci.ApplicationmigrationService.Responses.GetWorkRequestResponse) })]
    public class GetOCIApplicationmigrationWorkRequest : OCIApplicationMigrationCmdlet
    {
        ...
        public Oci.ApplicationmigrationService.Models.OperationStatus[] WaitForStatus { get; set; }
