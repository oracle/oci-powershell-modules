...
{
    [Cmdlet("Remove", "OCIIdentitydomainsMyOAuth2ClientCredential", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteMyOAuth2ClientCredentialResponse) })]
    public class RemoveOCIIdentitydomainsMyOAuth2ClientCredential : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsMyOAuth2ClientCredential", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteMyOAuth2ClientCredentialRequest
                {
                ...
                response = client.DeleteMyOAuth2ClientCredential(request).GetAwaiter().GetResult();
        ...
        private DeleteMyOAuth2ClientCredentialResponse response;
    }
}
