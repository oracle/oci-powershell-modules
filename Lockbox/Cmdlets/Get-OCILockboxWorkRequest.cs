...
{
    [Cmdlet("Get", "OCILockboxWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.LockboxService.Models.WorkRequest), typeof(Oci.LockboxService.Responses.GetWorkRequestResponse) })]
    public class GetOCILockboxWorkRequest : OCILockboxCmdlet
    {
        ...
        public Oci.LockboxService.Models.OperationStatus[] WaitForStatus { get; set; }
