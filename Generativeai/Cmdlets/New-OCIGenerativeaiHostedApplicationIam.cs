...
{
    [Cmdlet("New", "OCIGenerativeaiHostedApplicationIam")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.HostedApplicationIam), typeof(Oci.GenerativeaiService.Responses.CreateHostedApplicationIamResponse) })]
    public class NewOCIGenerativeaiHostedApplicationIam : OCIGenerativeAiCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new hosted application.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateHostedApplicationIamRequest
                {
                ...
                response = client.CreateHostedApplicationIam(request).GetAwaiter().GetResult();
        ...
        private CreateHostedApplicationIamResponse response;
    }
}
