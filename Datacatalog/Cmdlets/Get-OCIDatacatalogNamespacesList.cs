...
{
    [Cmdlet("Get", "OCIDatacatalogNamespacesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.NamespaceCollection), typeof(Oci.DatacatalogService.Responses.ListNamespacesResponse) })]
    public class GetOCIDatacatalogNamespacesList : OCIDataCatalogCmdlet
    {
        ...
        public System.Nullable<Oci.DatacatalogService.Requests.ListNamespacesRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either 'asc' or 'desc'.")]
        public System.Nullable<Oci.DatacatalogService.Requests.ListNamespacesRequest.SortOrderEnum> SortOrder { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifies the fields to return in a namespace summary response.")]
        public System.Collections.Generic.List<Oci.DatacatalogService.Requests.ListNamespacesRequest.FieldsEnum> Fields { get; set; }
        ...
        {
            IEnumerable<ListNamespacesResponse> DefaultRequest(ListNamespacesRequest request) => Enumerable.Repeat(client.ListNamespaces(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListNamespacesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListNamespacesResponse response;
        private delegate IEnumerable<ListNamespacesResponse> RequestDelegate(ListNamespacesRequest request);
