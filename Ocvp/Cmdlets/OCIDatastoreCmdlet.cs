...
{
    public abstract class OCIDatastoreCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DatastoreClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DatastoreClient client;
