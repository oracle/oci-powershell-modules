...
namespace Oci.DatasafeService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIDatasafeDownloadSecurityAssessmentReport", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatasafeService.Responses.DownloadSecurityAssessmentReportResponse) })]
    public class InvokeOCIDatasafeDownloadSecurityAssessmentReport : OCIDataSafeCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details of the report.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DownloadSecurityAssessmentReportRequest
                {
                ...
                response = client.DownloadSecurityAssessmentReport(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private DownloadSecurityAssessmentReportResponse response;
