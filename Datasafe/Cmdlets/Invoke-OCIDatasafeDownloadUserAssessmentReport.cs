...
namespace Oci.DatasafeService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIDatasafeDownloadUserAssessmentReport", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatasafeService.Responses.DownloadUserAssessmentReportResponse) })]
    public class InvokeOCIDatasafeDownloadUserAssessmentReport : OCIDataSafeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DownloadUserAssessmentReportRequest
                {
                ...
                response = client.DownloadUserAssessmentReport(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private DownloadUserAssessmentReportResponse response;
