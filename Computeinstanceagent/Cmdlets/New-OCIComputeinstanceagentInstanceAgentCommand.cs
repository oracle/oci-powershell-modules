...
{
    [Cmdlet("New", "OCIComputeinstanceagentInstanceAgentCommand")]
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Create Instance agent command details")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateInstanceAgentCommandRequest
                {
                ...
                response = client.CreateInstanceAgentCommand(request).GetAwaiter().GetResult();
        ...
        private CreateInstanceAgentCommandResponse response;
    }
}
