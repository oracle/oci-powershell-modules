...
{
    [Cmdlet("Remove", "OCIAnalyticsPrivateAccessChannel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AnalyticsService.Responses.DeletePrivateAccessChannelResponse) })]
    public class RemoveOCIAnalyticsPrivateAccessChannel : OCIAnalyticsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAnalyticsPrivateAccessChannel", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeletePrivateAccessChannelRequest
                {
                ...
                response = client.DeletePrivateAccessChannel(request).GetAwaiter().GetResult();
        ...
        private DeletePrivateAccessChannelResponse response;
    }
}
