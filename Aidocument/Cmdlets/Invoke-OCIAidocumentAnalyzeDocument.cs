...
{
    [Cmdlet("Invoke", "OCIAidocumentAnalyzeDocument")]
    [OutputType(new System.Type[] { typeof(Oci.AidocumentService.Models.AnalyzeDocumentResult), typeof(Oci.AidocumentService.Responses.AnalyzeDocumentResponse) })]
    public class InvokeOCIAidocumentAnalyzeDocument : OCIAIServiceDocumentCmdlet
    {
        ...
        private AnalyzeDocumentResponse response;
    }
}
