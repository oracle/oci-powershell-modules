...
{
    [Cmdlet("Invoke", "OCIOpsiRotateOperationsInsightsWarehouseWallet")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.RotateOperationsInsightsWarehouseWalletResponse) })]
    public class InvokeOCIOpsiRotateOperationsInsightsWarehouseWallet : OCIOperationsInsightsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RotateOperationsInsightsWarehouseWalletRequest
                {
                ...
                response = client.RotateOperationsInsightsWarehouseWallet(request).GetAwaiter().GetResult();
        ...
        private RotateOperationsInsightsWarehouseWalletResponse response;
    }
}
