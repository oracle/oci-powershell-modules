...
{
    [Cmdlet("Get", "OCIGoldengateDeploymentTypesList")]
    [OutputType(new System.Type[] { typeof(Oci.GoldengateService.Models.DeploymentTypeCollection), typeof(Oci.GoldengateService.Responses.ListDeploymentTypesResponse) })]
    public class GetOCIGoldengateDeploymentTypesList : OCIGoldenGateCmdlet
    {
        ...
        public System.Nullable<Oci.GoldengateService.Requests.ListDeploymentTypesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListDeploymentTypesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.DeploymentTypeCollection, true);
                }
        ...
        {
            IEnumerable<ListDeploymentTypesResponse> DefaultRequest(ListDeploymentTypesRequest request) => Enumerable.Repeat(client.ListDeploymentTypes(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListDeploymentTypesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListDeploymentTypesResponse response;
        private delegate IEnumerable<ListDeploymentTypesResponse> RequestDelegate(ListDeploymentTypesRequest request);
