...
{
    [Cmdlet("Get", "OCIIdentitydomainsPolicy")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Policy), typeof(Oci.IdentitydomainsService.Responses.GetPolicyResponse) })]
    public class GetOCIIdentitydomainsPolicy : OCIIdentityDomainsCmdlet
    {
