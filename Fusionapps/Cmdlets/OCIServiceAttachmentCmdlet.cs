...
{
    public abstract class OCIServiceAttachmentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ServiceAttachmentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ServiceAttachmentClient client;
