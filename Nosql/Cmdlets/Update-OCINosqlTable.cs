...
{
    [Cmdlet("Update", "OCINosqlTable")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NosqlService.Responses.UpdateTableResponse) })]
    public class UpdateOCINosqlTable : OCINosqlCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifications for the alteration.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpdateTable(request).GetAwaiter().GetResult();
        ...
        private UpdateTableResponse response;
    }
}
