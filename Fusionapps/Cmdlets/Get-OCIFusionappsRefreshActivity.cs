...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class GetOCIFusionappsRefreshActivity : OCIFusionApplicationsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique identifier (OCID) of the Refresh activity.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique identifier (OCID) of the Refresh activity.", ParameterSetName = Default)]
        ...
        public Oci.FusionappsService.Models.RefreshActivity.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetRefreshActivityRequest
                {
        ...
        private void HandleOutput(GetRefreshActivityRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForRefreshActivity(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetRefreshActivity(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.RefreshActivity);
        }

        private GetRefreshActivityResponse response;
