...
{
    [Cmdlet("Update", "OCIMysqlDbSystem")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.UpdateDbSystemResponse) })]
    public class UpdateOCIMysqlDbSystem : OCIDbSystemCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to update a DB System.")]
