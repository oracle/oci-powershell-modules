...
{
    [Cmdlet("Export", "OCIGoldengateDeploymentWallet")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.ExportDeploymentWalletResponse) })]
    public class ExportOCIGoldengateDeploymentWallet : OCIGoldenGateCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A unique Deployment identifier.")]
        public string DeploymentId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Metadata to export the OGG wallet from deployment. This also includes the OCI vault information where the wallet will be exported to")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ExportDeploymentWalletRequest
                {
                ...
                response = client.ExportDeploymentWallet(request).GetAwaiter().GetResult();
        ...
        private ExportDeploymentWalletResponse response;
    }
}
