...
{
    [Cmdlet("Stop", "OCIRoverWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.RoverService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIRoverWorkRequest : OCIWorkRequestsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIRoverWorkRequest", "Stop"))
            {
               return;
            }
