...
{
    [Cmdlet("Remove", "OCIMysqlReplica", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.DeleteReplicaResponse) })]
    public class RemoveOCIMysqlReplica : OCIReplicasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIMysqlReplica", "Remove"))
            {
               return;
            }
