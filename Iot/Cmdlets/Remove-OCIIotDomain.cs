...
{
    [Cmdlet("Remove", "OCIIotDomain", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.IotService.Responses.DeleteIotDomainResponse) })]
    public class RemoveOCIIotDomain : OCIIotCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIotDomain", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteIotDomainRequest
                {
                ...
                response = client.DeleteIotDomain(request).GetAwaiter().GetResult();
        ...
        private DeleteIotDomainResponse response;
    }
}
