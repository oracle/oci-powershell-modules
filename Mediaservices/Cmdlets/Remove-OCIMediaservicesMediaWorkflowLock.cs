...
{
    [Cmdlet("Remove", "OCIMediaservicesMediaWorkflowLock")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.MediaWorkflow), typeof(Oci.MediaservicesService.Responses.RemoveMediaWorkflowLockResponse) })]
    public class RemoveOCIMediaservicesMediaWorkflowLock : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveMediaWorkflowLockRequest
                {
                ...
                response = client.RemoveMediaWorkflowLock(request).GetAwaiter().GetResult();
        ...
        private RemoveMediaWorkflowLockResponse response;
    }
}
