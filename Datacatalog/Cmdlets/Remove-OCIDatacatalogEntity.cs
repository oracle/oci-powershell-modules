...
{
    [Cmdlet("Remove", "OCIDatacatalogEntity", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatacatalogService.Responses.DeleteEntityResponse) })]
    public class RemoveOCIDatacatalogEntity : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatacatalogEntity", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteEntity(request).GetAwaiter().GetResult();
        ...
        private DeleteEntityResponse response;
    }
}
