...
{
    [Cmdlet("Remove", "OCIOdaPrivateEndpointScanProxy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OdaService.Responses.DeleteOdaPrivateEndpointScanProxyResponse) })]
    public class RemoveOCIOdaPrivateEndpointScanProxy : OCIManagementCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique ODA Private Endpoint Scan Proxy identifier.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOdaPrivateEndpointScanProxy", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteOdaPrivateEndpointScanProxyRequest
                {
                ...
                response = client.DeleteOdaPrivateEndpointScanProxy(request).GetAwaiter().GetResult();
        ...
        private DeleteOdaPrivateEndpointScanProxyResponse response;
    }
}
