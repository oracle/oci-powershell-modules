...
{
    [Cmdlet("New", "OCIGenerativeaiApiKey")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.ApiKey), typeof(Oci.GenerativeaiService.Responses.CreateApiKeyResponse) })]
    public class NewOCIGenerativeaiApiKey : OCIGenerativeAiCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new apiKey.")]
