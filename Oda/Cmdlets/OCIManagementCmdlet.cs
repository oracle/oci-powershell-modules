...
{
    public abstract class OCIManagementCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ManagementClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
