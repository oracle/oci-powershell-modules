...
namespace Oci.ResourcemanagerService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIResourcemanagerJobTfPlan", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.ResourcemanagerService.Responses.GetJobTfPlanResponse) })]
    public class GetOCIResourcemanagerJobTfPlan : OCIResourceManagerCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The output format of the Terraform plan.")]
        public System.Nullable<Oci.ResourcemanagerService.Requests.GetJobTfPlanRequest.TfPlanFormatEnum> TfPlanFormat { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetJobTfPlanRequest
                {
                    JobId = JobId,
                    OpcRequestId = OpcRequestId,
                    TfPlanFormat = TfPlanFormat
                };

                response = client.GetJobTfPlan(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetJobTfPlanResponse response;
