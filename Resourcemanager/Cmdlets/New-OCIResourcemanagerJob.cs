...
{
    [Cmdlet("New", "OCIResourcemanagerJob")]
    [OutputType(new System.Type[] { typeof(Oci.ResourcemanagerService.Models.Job), typeof(Oci.ResourcemanagerService.Responses.CreateJobResponse) })]
    public class NewOCIResourcemanagerJob : OCIResourceManagerCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The properties for a request to create a job.")]
