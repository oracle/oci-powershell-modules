...
{
    [Cmdlet("Get", "OCIDataflowPrivateEndpoint", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DataflowService.Models.PrivateEndpoint), typeof(Oci.DataflowService.Responses.GetPrivateEndpointResponse) })]
    public class GetOCIDataflowPrivateEndpoint : OCIDataFlowCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique ID for a private endpoint.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique ID for a private endpoint.", ParameterSetName = Default)]
        ...
        public Oci.DataflowService.Models.PrivateEndpointLifecycleState[] WaitForLifecycleState { get; set; }
