...
{
    [Cmdlet("Move", "OCIGenerativeaiHostedApplicationIamCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.GenerativeaiService.Responses.ChangeHostedApplicationIamCompartmentResponse) })]
    public class MoveOCIGenerativeaiHostedApplicationIamCompartment : OCIGenerativeAiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ChangeHostedApplicationIamCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeHostedApplicationIamCompartmentResponse response;
    }
}
