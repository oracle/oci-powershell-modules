...
{
    public abstract class OCIDataScienceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DataScienceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DataScienceClient client;
