...
{
    [Cmdlet("Get", "OCIKeymanagementVault", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.Vault), typeof(Oci.KeymanagementService.Responses.GetVaultResponse) })]
    public class GetOCIKeymanagementVault : OCIKmsVaultCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the vault.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the vault.", ParameterSetName = Default)]
        ...
        public Oci.KeymanagementService.Models.Vault.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        private GetVaultResponse response;
