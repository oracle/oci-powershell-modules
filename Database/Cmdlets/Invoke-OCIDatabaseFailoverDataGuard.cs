...
{
    [Cmdlet("Invoke", "OCIDatabaseFailoverDataGuard", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Database), typeof(Oci.DatabaseService.Responses.FailoverDataGuardResponse) })]
    public class InvokeOCIDatabaseFailoverDataGuard : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new FailoverDataGuardRequest
                {
        ...
        private void HandleOutput(FailoverDataGuardRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForFailoverDataGuard(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.FailoverDataGuard(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.Database);
        }

        private FailoverDataGuardResponse response;
