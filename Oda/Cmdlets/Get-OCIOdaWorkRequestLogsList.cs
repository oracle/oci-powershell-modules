...
{
    [Cmdlet("Get", "OCIOdaWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.WorkRequestLogEntry), typeof(Oci.OdaService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIOdaWorkRequestLogsList : OCIOdaCmdlet
    {
...
The default sort order for both `TIMESTAMP` and `MESSAGE` is ascending.")]
        public System.Nullable<Oci.OdaService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.OdaService.Requests.ListWorkRequestLogsRequest.SortOrderEnum> SortOrder { get; set; }
