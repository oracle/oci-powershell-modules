...
{
    [Cmdlet("Remove", "OCIDatabaseBaseccVmCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteBaseccVmClusterResponse) })]
    public class RemoveOCIDatabaseBaseccVmCluster : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseBaseccVmCluster", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteBaseccVmClusterRequest
                {
        ...
        private void HandleOutput(DeleteBaseccVmClusterRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteBaseccVmCluster(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteBaseccVmCluster(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteBaseccVmClusterResponse response;
