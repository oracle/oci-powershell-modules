...
{
    [Cmdlet("Get", "OCIBdsWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.BdsService.Models.WorkRequest), typeof(Oci.BdsService.Responses.GetWorkRequestResponse) })]
    public class GetOCIBdsWorkRequest : OCIBdsCmdlet
    {
        ...
        public Oci.BdsService.Models.OperationStatus[] WaitForStatus { get; set; }
