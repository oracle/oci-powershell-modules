...
namespace Oci.MarketplacepublisherService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIMarketplacepublisherAttachmentContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.MarketplacepublisherService.Responses.GetAttachmentContentResponse) })]
    public class GetOCIMarketplacepublisherAttachmentContent : OCIAttachmentCmdlet
    {
