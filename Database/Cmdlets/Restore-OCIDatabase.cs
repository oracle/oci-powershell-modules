...
{
    [Cmdlet("Restore", "OCIDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Database), typeof(Oci.DatabaseService.Responses.RestoreDatabaseResponse) })]
    public class RestoreOCIDatabase : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to perform database restore.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to perform database restore.", ParameterSetName = Default)]
        ...
        private RestoreDatabaseResponse response;
