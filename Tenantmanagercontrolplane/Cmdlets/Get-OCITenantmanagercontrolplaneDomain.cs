...
{
    [Cmdlet("Get", "OCITenantmanagercontrolplaneDomain", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.TenantmanagercontrolplaneService.Models.Domain), typeof(Oci.TenantmanagercontrolplaneService.Responses.GetDomainResponse) })]
    public class GetOCITenantmanagercontrolplaneDomain : OCIDomainCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The domain OCID.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The domain OCID.", ParameterSetName = Default)]
        ...
        public Oci.TenantmanagercontrolplaneService.Models.Domain.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
