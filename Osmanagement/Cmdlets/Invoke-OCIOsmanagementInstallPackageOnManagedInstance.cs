...
{
    [Cmdlet("Invoke", "OCIOsmanagementInstallPackageOnManagedInstance")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OsmanagementService.Responses.InstallPackageOnManagedInstanceResponse) })]
    public class InvokeOCIOsmanagementInstallPackageOnManagedInstance : OCIOsManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new InstallPackageOnManagedInstanceRequest
                {
                ...
                response = client.InstallPackageOnManagedInstance(request).GetAwaiter().GetResult();
        ...
        private InstallPackageOnManagedInstanceResponse response;
    }
}
