...
{
    [Cmdlet("Update", "OCIDatacatalogCatalog")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Catalog), typeof(Oci.DatacatalogService.Responses.UpdateCatalogResponse) })]
    public class UpdateOCIDatacatalogCatalog : OCIDataCatalogCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique catalog identifier.")]
        public string CatalogId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The data catalog information to be updated.")]
        ...
        private UpdateCatalogResponse response;
    }
}
