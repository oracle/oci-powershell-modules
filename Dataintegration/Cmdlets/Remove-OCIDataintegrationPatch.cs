...
{
    [Cmdlet("Remove", "OCIDataintegrationPatch", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataintegrationService.Responses.DeletePatchResponse) })]
    public class RemoveOCIDataintegrationPatch : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"DIS patch key")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataintegrationPatch", "Remove"))
            {
               return;
            }
