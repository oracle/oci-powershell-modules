...
{
    public abstract class OCIOracleDbAzureKeyCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OracleDbAzureKeyClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OracleDbAzureKeyClient client;
