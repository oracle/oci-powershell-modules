...
namespace Oci.CloudbridgeService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information to be updated. This parameter also accepts subtypes <Oci.CloudbridgeService.Models.CreateAwsEbsAssetDetails>, <Oci.CloudbridgeService.Models.CreateVmwareVmAssetDetails>, <Oci.CloudbridgeService.Models.CreateInventoryAssetDetails>, <Oci.CloudbridgeService.Models.CreateAwsEc2AssetDetails> of type <Oci.CloudbridgeService.Models.CreateAssetDetails>.")]
