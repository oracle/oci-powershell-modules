...
namespace Oci.FleetappsmanagementService.Cmdlets
{
    ...
    public class GetOCIFleetappsmanagementPatchesList : OCIFleetAppsManagementOperationsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"unique Patch identifier")]
        public string Id { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Patch Released Date")]
        ...
        public System.Nullable<Oci.FleetappsmanagementService.Requests.ListPatchesRequest.SortByEnum> SortBy { get; set; }
