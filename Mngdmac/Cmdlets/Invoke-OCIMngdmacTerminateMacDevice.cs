...
{
    [Cmdlet("Invoke", "OCIMngdmacTerminateMacDevice")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MngdmacService.Responses.TerminateMacDeviceResponse) })]
    public class InvokeOCIMngdmacTerminateMacDevice : OCIMacDeviceCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The UUID of the MacDevice.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new TerminateMacDeviceRequest
                {
                ...
                response = client.TerminateMacDevice(request).GetAwaiter().GetResult();
        ...
        private TerminateMacDeviceResponse response;
    }
}
