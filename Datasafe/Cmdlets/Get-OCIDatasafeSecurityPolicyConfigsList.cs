...
{
    [Cmdlet("Get", "OCIDatasafeSecurityPolicyConfigsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.SecurityPolicyConfigCollection), typeof(Oci.DatasafeService.Responses.ListSecurityPolicyConfigsResponse) })]
    public class GetOCIDatasafeSecurityPolicyConfigsList : OCIDataSafeCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"An optional filter to return only resources that match the specified OCID of the security policy configuration resource.")]
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSecurityPolicyConfigsRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The current state of the security policy configuration resource.")]
        public System.Nullable<Oci.DatasafeService.Models.SecurityPolicyConfigLifecycleState> LifecycleState { get; set; }
...
**Example:** 2016-12-19T16:39:57.600Z")]
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSecurityPolicyConfigsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSecurityPolicyConfigsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSecurityPolicyConfigsRequest
                {
                ...
                IEnumerable<ListSecurityPolicyConfigsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.SecurityPolicyConfigCollection, true);
                }
        ...
        {
            IEnumerable<ListSecurityPolicyConfigsResponse> DefaultRequest(ListSecurityPolicyConfigsRequest request) => Enumerable.Repeat(client.ListSecurityPolicyConfigs(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSecurityPolicyConfigsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSecurityPolicyConfigsResponse response;
        private delegate IEnumerable<ListSecurityPolicyConfigsResponse> RequestDelegate(ListSecurityPolicyConfigsRequest request);
