...
{
    [Cmdlet("New", "OCIDatascienceSchedule")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.Schedule), typeof(Oci.DatascienceService.Responses.CreateScheduleResponse) })]
    public class NewOCIDatascienceSchedule : OCIDataScienceCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new Schedule.")]
