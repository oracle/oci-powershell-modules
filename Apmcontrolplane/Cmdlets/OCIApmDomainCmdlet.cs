...
using Oci.ApmcontrolplaneService;

namespace Oci.ApmcontrolplaneService.Cmdlets
{
    public abstract class OCIApmDomainCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ApmDomainClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ApmDomainClient client;
