...
{
    public abstract class OCIKmsVaultCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new KmsVaultClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected KmsVaultClient client;
