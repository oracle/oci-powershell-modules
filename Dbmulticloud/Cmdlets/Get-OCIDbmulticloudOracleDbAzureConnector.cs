...
{
    [Cmdlet("Get", "OCIDbmulticloudOracleDbAzureConnector", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DbmulticloudService.Models.OracleDbAzureConnector), typeof(Oci.DbmulticloudService.Responses.GetOracleDbAzureConnectorResponse) })]
    public class GetOCIDbmulticloudOracleDbAzureConnector : OCIOracleDBAzureConnectorCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Oracle DB Azure Connector resource.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Oracle DB Azure Connector resource.", ParameterSetName = Default)]
        ...
        public Oci.DbmulticloudService.Models.OracleDbAzureConnector.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOracleDbAzureConnectorRequest
                {
        ...
        private void HandleOutput(GetOracleDbAzureConnectorRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForOracleDbAzureConnector(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetOracleDbAzureConnector(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.OracleDbAzureConnector);
        }

        private GetOracleDbAzureConnectorResponse response;
