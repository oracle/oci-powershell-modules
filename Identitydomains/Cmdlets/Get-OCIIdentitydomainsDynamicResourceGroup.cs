...
{
    [Cmdlet("Get", "OCIIdentitydomainsDynamicResourceGroup")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.DynamicResourceGroup), typeof(Oci.IdentitydomainsService.Responses.GetDynamicResourceGroupResponse) })]
    public class GetOCIIdentitydomainsDynamicResourceGroup : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetDynamicResourceGroupRequest
                {
                ...
                response = client.GetDynamicResourceGroup(request).GetAwaiter().GetResult();
        ...
        private GetDynamicResourceGroupResponse response;
    }
}
