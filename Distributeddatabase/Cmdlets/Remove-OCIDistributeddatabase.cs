...
{
    [Cmdlet("Remove", "OCIDistributeddatabase", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.DeleteDistributedDatabaseResponse) })]
    public class RemoveOCIDistributeddatabase : OCIDistributedDbServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDistributeddatabase", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteDistributedDatabase(request).GetAwaiter().GetResult();
        ...
        private DeleteDistributedDatabaseResponse response;
    }
}
