...
{
    [Cmdlet("Get", "OCIWaasCachingRulesList")]
    [OutputType(new System.Type[] { typeof(Oci.WaasService.Models.CachingRuleSummary), typeof(Oci.WaasService.Responses.ListCachingRulesResponse) })]
    public class GetOCIWaasCachingRulesList : OCIWaasCmdlet
    {
        ...
        {
            IEnumerable<ListCachingRulesResponse> DefaultRequest(ListCachingRulesRequest request) => Enumerable.Repeat(client.ListCachingRules(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListCachingRulesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListCachingRulesResponse response;
        private delegate IEnumerable<ListCachingRulesResponse> RequestDelegate(ListCachingRulesRequest request);
