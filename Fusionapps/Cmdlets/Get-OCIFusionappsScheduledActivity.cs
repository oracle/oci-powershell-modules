...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class GetOCIFusionappsScheduledActivity : OCIFusionApplicationsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique ScheduledActivity identifier.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique ScheduledActivity identifier.", ParameterSetName = Default)]
        ...
        public Oci.FusionappsService.Models.ScheduledActivity.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetScheduledActivityRequest
                {
        ...
        private void HandleOutput(GetScheduledActivityRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForScheduledActivity(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetScheduledActivity(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.ScheduledActivity);
        }

        private GetScheduledActivityResponse response;
