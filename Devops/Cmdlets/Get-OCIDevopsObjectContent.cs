...
namespace Oci.DevopsService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIDevopsObjectContent", DefaultParameterSetName = Default)]
    ...
    public class GetOCIDevopsObjectContent : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetObjectContentRequest
                {
                ...
                response = client.GetObjectContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetObjectContentResponse response;
