...
{
    [Cmdlet("Update", "OCIBatchTaskProfile")]
    ...
    public class UpdateOCIBatchTaskProfile : OCIBatchComputingCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateBatchTaskProfileRequest
                {
                ...
                response = client.UpdateBatchTaskProfile(request).GetAwaiter().GetResult();
        ...
        private UpdateBatchTaskProfileResponse response;
    }
}
