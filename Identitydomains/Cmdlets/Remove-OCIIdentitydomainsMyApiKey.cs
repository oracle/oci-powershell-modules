...
{
    [Cmdlet("Remove", "OCIIdentitydomainsMyApiKey", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteMyApiKeyResponse) })]
    public class RemoveOCIIdentitydomainsMyApiKey : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsMyApiKey", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteMyApiKeyRequest
                {
                ...
                response = client.DeleteMyApiKey(request).GetAwaiter().GetResult();
        ...
        private DeleteMyApiKeyResponse response;
    }
}
