...
{
    [Cmdlet("Get", "OCIDifStacksList")]
    [OutputType(new System.Type[] { typeof(Oci.DifService.Models.StackCollection), typeof(Oci.DifService.Responses.ListStacksResponse) })]
    public class GetOCIDifStacksList : OCIStackCmdlet
    {
        ...
        public System.Nullable<Oci.DifService.Models.Stack.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Stack.")]
        ...
        public System.Nullable<Oci.DifService.Requests.ListStacksRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    response = item;
                    WriteOutput(response, response.StackCollection, true);
                }
