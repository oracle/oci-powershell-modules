...
{
    [Cmdlet("Get", "OCIServicemeshWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.ServicemeshService.Models.WorkRequest), typeof(Oci.ServicemeshService.Responses.GetWorkRequestResponse) })]
    public class GetOCIServicemeshWorkRequest : OCIServiceMeshCmdlet
    {
        ...
        public Oci.ServicemeshService.Models.OperationStatus[] WaitForStatus { get; set; }
