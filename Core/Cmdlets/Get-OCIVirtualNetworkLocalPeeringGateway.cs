...
namespace Oci.CoreService.Cmdlets
{
    ...
    public class GetOCIVirtualNetworkLocalPeeringGateway : OCIVirtualNetworkCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the local peering gateway.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the local peering gateway.", ParameterSetName = PeeringStatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the local peering gateway.", ParameterSetName = Default)]
