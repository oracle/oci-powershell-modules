...
{
    [Cmdlet("Remove", "OCIDatabasemanagementManagedDatabaseFromManagedDatabaseGroup")]
    ...
    public class RemoveOCIDatabasemanagementManagedDatabaseFromManagedDatabaseGroup : OCIDbManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveManagedDatabaseFromManagedDatabaseGroupRequest
                {
                ...
                response = client.RemoveManagedDatabaseFromManagedDatabaseGroup(request).GetAwaiter().GetResult();
        ...
        private RemoveManagedDatabaseFromManagedDatabaseGroupResponse response;
    }
}
