...
namespace Oci.DatasafeService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIDatasafeDownloadSensitiveDataModel", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatasafeService.Responses.DownloadSensitiveDataModelResponse) })]
    public class InvokeOCIDatasafeDownloadSensitiveDataModel : OCIDataSafeCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details to download a sensitive data model file.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DownloadSensitiveDataModelRequest
                {
                ...
                response = client.DownloadSensitiveDataModel(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private DownloadSensitiveDataModelResponse response;
