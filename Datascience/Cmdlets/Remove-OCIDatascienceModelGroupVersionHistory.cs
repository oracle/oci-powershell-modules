...
{
    [Cmdlet("Remove", "OCIDatascienceModelGroupVersionHistory", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatascienceService.Responses.DeleteModelGroupVersionHistoryResponse) })]
    public class RemoveOCIDatascienceModelGroupVersionHistory : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatascienceModelGroupVersionHistory", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteModelGroupVersionHistoryRequest
                {
                ...
                response = client.DeleteModelGroupVersionHistory(request).GetAwaiter().GetResult();
        ...
        private DeleteModelGroupVersionHistoryResponse response;
    }
}
