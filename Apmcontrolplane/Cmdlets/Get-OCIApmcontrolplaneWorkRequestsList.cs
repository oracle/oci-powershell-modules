...
{
    [Cmdlet("Get", "OCIApmcontrolplaneWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.ApmcontrolplaneService.Models.WorkRequest), typeof(Oci.ApmcontrolplaneService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIApmcontrolplaneWorkRequestsList : OCIApmDomainCmdlet
    {
