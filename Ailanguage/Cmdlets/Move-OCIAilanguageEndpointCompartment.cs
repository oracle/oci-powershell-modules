...
{
    [Cmdlet("Move", "OCIAilanguageEndpointCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AilanguageService.Responses.ChangeEndpointCompartmentResponse) })]
    public class MoveOCIAilanguageEndpointCompartment : OCIAIServiceLanguageCmdlet
    {
