...
{
    [Cmdlet("New", "OCILoadbalancerSSLCipherSuite")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.LoadbalancerService.Responses.CreateSSLCipherSuiteResponse) })]
    public class NewOCILoadbalancerSSLCipherSuite : OCILoadBalancerCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details of the SSL cipher suite to add.")]
...
Example: `example-etag`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateSSLCipherSuiteRequest
                {
                ...
                response = client.CreateSSLCipherSuite(request).GetAwaiter().GetResult();
        ...
        private CreateSSLCipherSuiteResponse response;
    }
}
