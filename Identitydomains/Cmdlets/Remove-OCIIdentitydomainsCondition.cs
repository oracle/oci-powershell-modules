...
{
    [Cmdlet("Remove", "OCIIdentitydomainsCondition", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteConditionResponse) })]
    public class RemoveOCIIdentitydomainsCondition : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsCondition", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteConditionRequest
                {
                ...
                response = client.DeleteCondition(request).GetAwaiter().GetResult();
        ...
        private DeleteConditionResponse response;
    }
}
