...
{
    [Cmdlet("Get", "OCIAispeechTranscriptionJob", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.AispeechService.Models.TranscriptionJob), typeof(Oci.AispeechService.Responses.GetTranscriptionJobResponse) })]
    public class GetOCIAispeechTranscriptionJob : OCIAIServiceSpeechCmdlet
    {
        ...
        public Oci.AispeechService.Models.TranscriptionJob.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        private GetTranscriptionJobResponse response;
