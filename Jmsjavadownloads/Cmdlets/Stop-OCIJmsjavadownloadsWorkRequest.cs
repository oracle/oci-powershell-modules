...
{
    [Cmdlet("Stop", "OCIJmsjavadownloadsWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.JmsjavadownloadsService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIJmsjavadownloadsWorkRequest : OCIJavaDownloadCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIJmsjavadownloadsWorkRequest", "Stop"))
            {
               return;
            }
