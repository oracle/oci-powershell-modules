...
{
    [Cmdlet("Move", "OCIStackmonitoringConfigCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.StackmonitoringService.Responses.ChangeConfigCompartmentResponse) })]
    public class MoveOCIStackmonitoringConfigCompartment : OCIStackMonitoringCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeConfigCompartmentRequest
                {
                    ConfigId = ConfigId,
                ...
                response = client.ChangeConfigCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeConfigCompartmentResponse response;
    }
}
