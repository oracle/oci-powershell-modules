...
{
    [Cmdlet("Enable", "OCIDatasafeTargetDatabase")]
    ...
    public class EnableOCIDatasafeTargetDatabase : OCIDataSafeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ActivateTargetDatabase(request).GetAwaiter().GetResult();
        ...
        private ActivateTargetDatabaseResponse response;
    }
}
