...
{
    [Cmdlet("Get", "OCIQueueWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.QueueService.Models.WorkRequestSummaryCollection), typeof(Oci.QueueService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIQueueWorkRequestsList : OCIQueueAdminCmdlet
    {
