...
{
    [Cmdlet("Remove", "OCIOsmanagementModuleStreamProfileFromManagedInstance")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OsmanagementService.Responses.RemoveModuleStreamProfileFromManagedInstanceResponse) })]
    public class RemoveOCIOsmanagementModuleStreamProfileFromManagedInstance : OCIOsManagementCmdlet
    {
