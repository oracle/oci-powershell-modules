...
{
    [Cmdlet("Remove", "OCICloudguardTargetDetectorRecipe", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CloudguardService.Responses.DeleteTargetDetectorRecipeResponse) })]
    public class RemoveOCICloudguardTargetDetectorRecipe : OCICloudGuardCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCICloudguardTargetDetectorRecipe", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteTargetDetectorRecipeRequest
                {
                    TargetId = TargetId,
                ...
                response = client.DeleteTargetDetectorRecipe(request).GetAwaiter().GetResult();
        ...
        private DeleteTargetDetectorRecipeResponse response;
    }
}
