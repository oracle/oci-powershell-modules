...
{
    [Cmdlet("New", "OCIMysqlDbSystemStatus")]
    [OutputType(new System.Type[] { typeof(Oci.MysqlService.Models.DbSystemStatus), typeof(Oci.MysqlService.Responses.GenerateDbSystemStatusResponse) })]
    public class NewOCIMysqlDbSystemStatus : OCIDbSystemCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The parameters for selecting the attributes to collect the status of.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GenerateDbSystemStatusRequest
                {
                ...
                response = client.GenerateDbSystemStatus(request).GetAwaiter().GetResult();
        ...
        private GenerateDbSystemStatusResponse response;
    }
}
