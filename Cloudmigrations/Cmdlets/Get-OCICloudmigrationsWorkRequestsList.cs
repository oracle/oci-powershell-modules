...
{
    [Cmdlet("Get", "OCICloudmigrationsWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.CloudmigrationsService.Models.WorkRequestSummaryCollection), typeof(Oci.CloudmigrationsService.Responses.ListWorkRequestsResponse) })]
    public class GetOCICloudmigrationsWorkRequestsList : OCIMigrationCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only resources where the resource's lifecycle state matches the given operation status.")]
        public System.Nullable<Oci.CloudmigrationsService.Models.OperationStatus> Status { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only resources where the resource's lifecycle state matches the given operation type.")]
        public System.Nullable<Oci.CloudmigrationsService.Models.OperationType> OperationType { get; set; }
        ...
        public System.Nullable<Oci.CloudmigrationsService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }
