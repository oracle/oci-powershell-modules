...
{
    [Cmdlet("Get", "OCIEmailIpPoolsList")]
    [OutputType(new System.Type[] { typeof(Oci.EmailService.Models.EmailIpPoolCollection), typeof(Oci.EmailService.Responses.ListEmailIpPoolsResponse) })]
    public class GetOCIEmailIpPoolsList : OCIEmailCmdlet
    {
        ...
        public System.Nullable<Oci.EmailService.Models.EmailIpPool.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifies the attribute with which to sort the Email IpPools.

Default: `TIMECREATED`

* **TIMECREATED:** Sorts by timeCreated.")]
        public System.Nullable<Oci.EmailService.Requests.ListEmailIpPoolsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListEmailIpPoolsRequest
                {
                ...
                IEnumerable<ListEmailIpPoolsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.EmailIpPoolCollection, true);
                }
        ...
        {
            IEnumerable<ListEmailIpPoolsResponse> DefaultRequest(ListEmailIpPoolsRequest request) => Enumerable.Repeat(client.ListEmailIpPools(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListEmailIpPoolsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListEmailIpPoolsResponse response;
        private delegate IEnumerable<ListEmailIpPoolsResponse> RequestDelegate(ListEmailIpPoolsRequest request);
