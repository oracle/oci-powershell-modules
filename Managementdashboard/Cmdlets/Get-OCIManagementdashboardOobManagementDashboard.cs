...
{
    [Cmdlet("Get", "OCIManagementdashboardOobManagementDashboard")]
    [OutputType(new System.Type[] { typeof(Oci.ManagementdashboardService.Models.ManagementDashboard), typeof(Oci.ManagementdashboardService.Responses.GetOobManagementDashboardResponse) })]
    public class GetOCIManagementdashboardOobManagementDashboard : OCIDashxApisCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOobManagementDashboardRequest
                {
                    ManagementDashboardId = ManagementDashboardId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetOobManagementDashboard(request).GetAwaiter().GetResult();
        ...
        private GetOobManagementDashboardResponse response;
    }
}
