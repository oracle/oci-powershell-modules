...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyPendingApproval")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyPendingApproval), typeof(Oci.IdentitydomainsService.Responses.GetMyPendingApprovalResponse) })]
    public class GetOCIIdentitydomainsMyPendingApproval : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMyPendingApprovalRequest
                {
                ...
                response = client.GetMyPendingApproval(request).GetAwaiter().GetResult();
        ...
        private GetMyPendingApprovalResponse response;
    }
}
