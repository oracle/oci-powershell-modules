...
{
    [Cmdlet("Remove", "OCIDatacatalogGlossary", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatacatalogService.Responses.DeleteGlossaryResponse) })]
    public class RemoveOCIDatacatalogGlossary : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatacatalogGlossary", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteGlossary(request).GetAwaiter().GetResult();
        ...
        private DeleteGlossaryResponse response;
    }
}
