...
{
    [Cmdlet("Stop", "OCIDatabaseBackup", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.CancelBackupResponse) })]
    public class StopOCIDatabaseBackup : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelBackupRequest
                {
                    BackupId = BackupId,
                    IfMatch = IfMatch,
        ...
        private void HandleOutput(CancelBackupRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForCancelBackup(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.CancelBackup(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private CancelBackupResponse response;
