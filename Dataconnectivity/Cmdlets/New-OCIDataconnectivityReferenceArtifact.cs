...
{
    [Cmdlet("New", "OCIDataconnectivityReferenceArtifact")]
    [OutputType(new System.Type[] { typeof(Oci.DataconnectivityService.Models.ReferenceInfo), typeof(Oci.DataconnectivityService.Responses.CreateReferenceArtifactResponse) })]
    public class NewOCIDataconnectivityReferenceArtifact : OCIDataConnectivityManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information required to reference a dcms artifact.")]
        public CreateReferenceArtifactDetails CreateReferenceArtifactDetails { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateReferenceArtifactRequest
                {
                ...
                response = client.CreateReferenceArtifact(request).GetAwaiter().GetResult();
                WriteOutput(response, response.ReferenceInfo);
        ...
        private CreateReferenceArtifactResponse response;
    }
}
