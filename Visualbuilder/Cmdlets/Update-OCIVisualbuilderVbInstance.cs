...
{
    [Cmdlet("Update", "OCIVisualbuilderVbInstance")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.VisualbuilderService.Responses.UpdateVbInstanceResponse) })]
    public class UpdateOCIVisualbuilderVbInstance : OCIVbInstanceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateVbInstanceRequest
                {
                ...
                response = client.UpdateVbInstance(request).GetAwaiter().GetResult();
        ...
        private UpdateVbInstanceResponse response;
    }
}
