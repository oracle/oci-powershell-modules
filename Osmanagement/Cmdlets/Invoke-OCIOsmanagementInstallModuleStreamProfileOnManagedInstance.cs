...
{
    [Cmdlet("Invoke", "OCIOsmanagementInstallModuleStreamProfileOnManagedInstance")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OsmanagementService.Responses.InstallModuleStreamProfileOnManagedInstanceResponse) })]
    public class InvokeOCIOsmanagementInstallModuleStreamProfileOnManagedInstance : OCIOsManagementCmdlet
    {
