...
{
    [Cmdlet("Invoke", "OCIDatabaseConvertStandbyAutonomousContainerDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousContainerDatabase), typeof(Oci.DatabaseService.Responses.ConvertStandbyAutonomousContainerDatabaseResponse) })]
    public class InvokeOCIDatabaseConvertStandbyAutonomousContainerDatabase : OCIDatabaseCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to Convert Standby Autonomous Container Database .", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to Convert Standby Autonomous Container Database .", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ConvertStandbyAutonomousContainerDatabaseRequest
                {
        ...
        private void HandleOutput(ConvertStandbyAutonomousContainerDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForConvertStandbyAutonomousContainerDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ConvertStandbyAutonomousContainerDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousContainerDatabase);
        }

        private ConvertStandbyAutonomousContainerDatabaseResponse response;
