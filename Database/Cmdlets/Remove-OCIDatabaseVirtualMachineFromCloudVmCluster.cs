...
{
    [Cmdlet("Remove", "OCIDatabaseVirtualMachineFromCloudVmCluster", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.CloudVmCluster), typeof(Oci.DatabaseService.Responses.RemoveVirtualMachineFromCloudVmClusterResponse) })]
    public class RemoveOCIDatabaseVirtualMachineFromCloudVmCluster : OCIDatabaseCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to remove Virtual Machines from the Cloud VM cluster.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to remove Virtual Machines from the Cloud VM cluster.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveVirtualMachineFromCloudVmClusterRequest
                {
        ...
        private void HandleOutput(RemoveVirtualMachineFromCloudVmClusterRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRemoveVirtualMachineFromCloudVmCluster(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RemoveVirtualMachineFromCloudVmCluster(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.CloudVmCluster);
        }

        private RemoveVirtualMachineFromCloudVmClusterResponse response;
