...
{
    [Cmdlet("New", "OCIOpsiChargebackPlanReport")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.ChargebackPlanReport), typeof(Oci.OpsiService.Responses.CreateChargebackPlanReportResponse) })]
    public class NewOCIOpsiChargebackPlanReport : OCIOperationsInsightsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the chargeback plan report to be created in Ops Insights.")]
...
*Note:* Retry tokens can be invalidated before the 24 hour time limit due to conflicting operations, such as a resource being deleted or purged from the system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateChargebackPlanReportRequest
                {
                ...
                response = client.CreateChargebackPlanReport(request).GetAwaiter().GetResult();
        ...
        private CreateChargebackPlanReportResponse response;
    }
}
