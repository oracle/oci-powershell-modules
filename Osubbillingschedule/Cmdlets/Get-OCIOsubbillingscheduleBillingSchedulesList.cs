...
namespace Oci.OsubbillingscheduleService.Cmdlets
{
    [Cmdlet("Get", "OCIOsubbillingscheduleBillingSchedulesList")]
    [OutputType(new System.Type[] { typeof(Oci.OsubbillingscheduleService.Models.BillingScheduleSummary), typeof(Oci.OsubbillingscheduleService.Responses.ListBillingSchedulesResponse) })]
    public class GetOCIOsubbillingscheduleBillingSchedulesList : OCIBillingScheduleCmdlet
    {
...
Example: '500'", ParameterSetName = LimitSet)]
        ...
        public System.Nullable<Oci.OsubbillingscheduleService.Requests.ListBillingSchedulesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.OsubbillingscheduleService.Requests.ListBillingSchedulesRequest.SortByEnum> SortBy { get; set; }
