...
{
    [Cmdlet("Get", "OCIOsmanagementhubProfileAvailableSoftwareSourcesList")]
    [OutputType(new System.Type[] { typeof(Oci.OsmanagementhubService.Models.AvailableSoftwareSourceCollection), typeof(Oci.OsmanagementhubService.Responses.ListProfileAvailableSoftwareSourcesResponse) })]
    public class GetOCIOsmanagementhubProfileAvailableSoftwareSourcesList : OCIOnboardingCmdlet
    {
...
Example: `3`")]
        ...
        public System.Nullable<Oci.OsmanagementhubService.Requests.ListProfileAvailableSoftwareSourcesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListProfileAvailableSoftwareSourcesRequest
                {
                    ProfileId = ProfileId,
                ...
                IEnumerable<ListProfileAvailableSoftwareSourcesResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListProfileAvailableSoftwareSourcesResponse> DefaultRequest(ListProfileAvailableSoftwareSourcesRequest request) => Enumerable.Repeat(client.ListProfileAvailableSoftwareSources(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListProfileAvailableSoftwareSourcesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListProfileAvailableSoftwareSourcesResponse response;
        private delegate IEnumerable<ListProfileAvailableSoftwareSourcesResponse> RequestDelegate(ListProfileAvailableSoftwareSourcesRequest request);
