...
{
    [Cmdlet("Get", "OCIJmsWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.JmsService.Models.WorkRequestLogEntryCollection), typeof(Oci.JmsService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIJmsWorkRequestLogsList : OCIJavaManagementServiceCmdlet
    {
