...
{
    [Cmdlet("Get", "OCIGenerativeaiModel", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.Model), typeof(Oci.GenerativeaiService.Responses.GetModelResponse) })]
    public class GetOCIGenerativeaiModel : OCIGenerativeAiCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The model OCID", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The model OCID", ParameterSetName = Default)]
        ...
        public Oci.GenerativeaiService.Models.Model.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
