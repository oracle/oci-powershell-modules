...
{
    [Cmdlet("Remove", "OCITransferJob", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DtsService.Responses.DeleteTransferJobResponse) })]
    public class RemoveOCITransferJob : OCITransferJobCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCITransferJob", "Remove"))
            {
               return;
            }
