...
{
    [Cmdlet("Remove", "OCIDatabasetoolsIdentity", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabasetoolsService.Responses.DeleteDatabaseToolsIdentityResponse) })]
    public class RemoveOCIDatabasetoolsIdentity : OCIDatabaseToolsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabasetoolsIdentity", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDatabaseToolsIdentityRequest
                {
                ...
                response = client.DeleteDatabaseToolsIdentity(request).GetAwaiter().GetResult();
        ...
        private DeleteDatabaseToolsIdentityResponse response;
    }
}
