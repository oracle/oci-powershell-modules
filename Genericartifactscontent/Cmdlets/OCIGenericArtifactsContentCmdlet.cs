...
using Oci.GenericartifactscontentService;

namespace Oci.GenericartifactscontentService.Cmdlets
{
    public abstract class OCIGenericArtifactsContentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new GenericArtifactsContentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected GenericArtifactsContentClient client;
