...
{
    public abstract class OCIAddressRuleServiceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AddressRuleServiceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AddressRuleServiceClient client;
