...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeAwrDatabaseSnapshotRanges")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.AwrDatabaseSnapshotRangeCollection), typeof(Oci.OpsiService.Responses.SummarizeAwrDatabaseSnapshotRangesResponse) })]
    public class InvokeOCIOpsiSummarizeAwrDatabaseSnapshotRanges : OCIOperationsInsightsCmdlet
    {
        ...
        public System.Nullable<Oci.OpsiService.Requests.SummarizeAwrDatabaseSnapshotRangesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeAwrDatabaseSnapshotRangesRequest
                {
                    AwrHubId = AwrHubId,
                    Name = Name,
                ...
                response = client.SummarizeAwrDatabaseSnapshotRanges(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AwrDatabaseSnapshotRangeCollection);
        ...
        private SummarizeAwrDatabaseSnapshotRangesResponse response;
    }
}
