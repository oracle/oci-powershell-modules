...
using Oci.DashboardService;

namespace Oci.DashboardService.Cmdlets
{
    public abstract class OCIDashboardGroupCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DashboardGroupClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DashboardGroupClient client;
