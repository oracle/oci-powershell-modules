...
{
    [Cmdlet("Remove", "OCIDnsDomainRecords", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DnsService.Responses.DeleteDomainRecordsResponse) })]
    public class RemoveOCIDnsDomainRecords : OCIDnsCmdlet
    {
...
This parameter is deprecated and should be omitted.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDnsDomainRecords", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDomainRecordsRequest
                {
                ...
                response = client.DeleteDomainRecords(request).GetAwaiter().GetResult();
        ...
        private DeleteDomainRecordsResponse response;
    }
}
