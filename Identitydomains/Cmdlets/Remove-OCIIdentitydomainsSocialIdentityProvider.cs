...
{
    [Cmdlet("Remove", "OCIIdentitydomainsSocialIdentityProvider", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteSocialIdentityProviderResponse) })]
    public class RemoveOCIIdentitydomainsSocialIdentityProvider : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsSocialIdentityProvider", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteSocialIdentityProviderRequest
                {
                ...
                response = client.DeleteSocialIdentityProvider(request).GetAwaiter().GetResult();
        ...
        private DeleteSocialIdentityProviderResponse response;
    }
}
