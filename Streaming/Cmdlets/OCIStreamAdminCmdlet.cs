...
{
    public abstract class OCIStreamAdminCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new StreamAdminClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected StreamAdminClient client;
