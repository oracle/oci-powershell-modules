...
{
    [Cmdlet("Get", "OCIDisasterrecoveryWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.DisasterrecoveryService.Models.WorkRequestSummaryCollection), typeof(Oci.DisasterrecoveryService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIDisasterrecoveryWorkRequestsList : OCIDisasterRecoveryCmdlet
    {
...
Example: `100`", ParameterSetName = LimitSet)]
        ...
        public System.Nullable<Oci.DisasterrecoveryService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }
