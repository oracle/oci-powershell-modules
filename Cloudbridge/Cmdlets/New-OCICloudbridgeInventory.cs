...
{
    [Cmdlet("New", "OCICloudbridgeInventory")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CloudbridgeService.Responses.CreateInventoryResponse) })]
    public class NewOCICloudbridgeInventory : OCIInventoryCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CreateInventory(request).GetAwaiter().GetResult();
        ...
        private CreateInventoryResponse response;
    }
}
