...
{
    [Cmdlet("Update", "OCIWaasWafAddressRateLimiting")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdateWafAddressRateLimitingResponse) })]
    public class UpdateOCIWaasWafAddressRateLimiting : OCIWaasCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The address rate limiting settings.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateWafAddressRateLimitingRequest
                {
                ...
                response = client.UpdateWafAddressRateLimiting(request).GetAwaiter().GetResult();
        ...
        private UpdateWafAddressRateLimitingResponse response;
    }
}
