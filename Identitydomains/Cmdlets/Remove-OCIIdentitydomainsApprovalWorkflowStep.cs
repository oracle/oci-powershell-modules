...
{
    [Cmdlet("Remove", "OCIIdentitydomainsApprovalWorkflowStep", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteApprovalWorkflowStepResponse) })]
    public class RemoveOCIIdentitydomainsApprovalWorkflowStep : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsApprovalWorkflowStep", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteApprovalWorkflowStepRequest
                {
                ...
                response = client.DeleteApprovalWorkflowStep(request).GetAwaiter().GetResult();
        ...
        private DeleteApprovalWorkflowStepResponse response;
    }
}
