...
{
    [Cmdlet("Stop", "OCIAilanguageJob")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AilanguageService.Responses.CancelJobResponse) })]
    public class StopOCIAilanguageJob : OCIAIServiceLanguageCmdlet
    {
