...
namespace Oci.OsmanagementhubService.Cmdlets
{
    ...
    public class GetOCIOsmanagementhubWorkRequestsList : OCIWorkRequestCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the work request.")]
...
Example: `50`", ParameterSetName = LimitSet)]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the schedule job that initiated the work request.")]
        public string InitiatorId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the parent work request.")]
        public string ParentId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return the resources whose parent resources are not the same as the given resource [OCIDs](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return the work requests that are a retry of the given work request [OCIDs](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).")]
        public string RetryOfId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return the work requests that are a rerun of the given work request [OCIDs](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).")]
