...
{
    [Cmdlet("Remove", "OCIStackmonitoringMetricExtension", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.StackmonitoringService.Responses.DeleteMetricExtensionResponse) })]
    public class RemoveOCIStackmonitoringMetricExtension : OCIStackMonitoringCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIStackmonitoringMetricExtension", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteMetricExtensionRequest
                {
                ...
                response = client.DeleteMetricExtension(request).GetAwaiter().GetResult();
        ...
        private DeleteMetricExtensionResponse response;
    }
}
