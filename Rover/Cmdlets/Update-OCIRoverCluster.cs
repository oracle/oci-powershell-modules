...
{
    [Cmdlet("Update", "OCIRoverCluster")]
    [OutputType(new System.Type[] { typeof(Oci.RoverService.Models.RoverCluster), typeof(Oci.RoverService.Responses.UpdateRoverClusterResponse) })]
    public class UpdateOCIRoverCluster : OCIRoverClusterCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateRoverClusterRequest
                {
                ...
                response = client.UpdateRoverCluster(request).GetAwaiter().GetResult();
        ...
        private UpdateRoverClusterResponse response;
    }
}
