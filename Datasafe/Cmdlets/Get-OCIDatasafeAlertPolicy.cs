...
{
    [Cmdlet("Get", "OCIDatasafeAlertPolicy", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.AlertPolicy), typeof(Oci.DatasafeService.Responses.GetAlertPolicyResponse) })]
    public class GetOCIDatasafeAlertPolicy : OCIDataSafeCmdlet
    {
        ...
        private void HandleOutput(GetAlertPolicyRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForAlertPolicy(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetAlertPolicy(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AlertPolicy);
        }

        private GetAlertPolicyResponse response;
