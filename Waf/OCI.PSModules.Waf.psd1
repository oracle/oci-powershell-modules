...
CmdletsToExport = 'Move-OCIWafNetworkAddressListCompartment', 
               ...
               'Get-OCIWafNetworkAddressList', 'Get-OCIWafWebAppFirewall', 
               'Get-OCIWafWebAppFirewallPolicy', 'Get-OCIWafWorkRequest', 
               'Get-OCIWafNetworkAddressListsList', 
               'Get-OCIWafProtectionCapabilitiesList', 
               'Get-OCIWafProtectionCapabilityGroupTagsList', 
               'Get-OCIWafWebAppFirewallPoliciesList', 
               'Get-OCIWafWebAppFirewallsList', 'Get-OCIWafWorkRequestErrorsList', 
