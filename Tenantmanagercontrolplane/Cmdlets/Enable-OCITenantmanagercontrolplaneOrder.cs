...
{
    [Cmdlet("Enable", "OCITenantmanagercontrolplaneOrder")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.TenantmanagercontrolplaneService.Responses.ActivateOrderResponse) })]
    public class EnableOCITenantmanagercontrolplaneOrder : OCIOrdersCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information needed to activate an order in a tenancy.")]
        ...
        private ActivateOrderResponse response;
    }
}
