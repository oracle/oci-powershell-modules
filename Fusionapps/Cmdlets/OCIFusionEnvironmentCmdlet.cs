...
{
    public abstract class OCIFusionEnvironmentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new FusionEnvironmentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected FusionEnvironmentClient client;
