...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class GetOCIFusionappsAdminUsersList : OCIFusionApplicationsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAdminUsersRequest
                {
                    FusionEnvironmentId = FusionEnvironmentId,
                    OpcRequestId = OpcRequestId
                };

                response = client.ListAdminUsers(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AdminUserCollection);
        ...
        private ListAdminUsersResponse response;
    }
}
