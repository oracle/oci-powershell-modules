...
{
    [Cmdlet("Get", "OCIDatasafeSensitiveDataModelsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.SensitiveDataModelCollection), typeof(Oci.DatasafeService.Responses.ListSensitiveDataModelsResponse) })]
    public class GetOCIDatasafeSensitiveDataModelsList : OCIDataSafeCmdlet
    {
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSensitiveDataModelsRequest.AccessLevelEnum> AccessLevel { get; set; }
...
**Example:** 2016-12-19T16:39:57.600Z")]
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSensitiveDataModelsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSensitiveDataModelsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSensitiveDataModelsRequest
                {
                ...
                IEnumerable<ListSensitiveDataModelsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.SensitiveDataModelCollection, true);
                }
        ...
        {
            IEnumerable<ListSensitiveDataModelsResponse> DefaultRequest(ListSensitiveDataModelsRequest request) => Enumerable.Repeat(client.ListSensitiveDataModels(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSensitiveDataModelsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSensitiveDataModelsResponse response;
        private delegate IEnumerable<ListSensitiveDataModelsResponse> RequestDelegate(ListSensitiveDataModelsRequest request);
