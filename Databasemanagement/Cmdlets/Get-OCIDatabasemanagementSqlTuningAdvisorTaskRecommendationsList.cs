...
{
    [Cmdlet("Get", "OCIDatabasemanagementSqlTuningAdvisorTaskRecommendationsList")]
    ...
    public class GetOCIDatabasemanagementSqlTuningAdvisorTaskRecommendationsList : OCISqlTuningCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListSqlTuningAdvisorTaskRecommendationsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSqlTuningAdvisorTaskRecommendationsRequest
                {
                ...
                IEnumerable<ListSqlTuningAdvisorTaskRecommendationsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.SqlTuningAdvisorTaskRecommendationCollection, true);
                }
        ...
        {
            IEnumerable<ListSqlTuningAdvisorTaskRecommendationsResponse> DefaultRequest(ListSqlTuningAdvisorTaskRecommendationsRequest request) => Enumerable.Repeat(client.ListSqlTuningAdvisorTaskRecommendations(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSqlTuningAdvisorTaskRecommendationsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSqlTuningAdvisorTaskRecommendationsResponse response;
        private delegate IEnumerable<ListSqlTuningAdvisorTaskRecommendationsResponse> RequestDelegate(ListSqlTuningAdvisorTaskRecommendationsRequest request);
