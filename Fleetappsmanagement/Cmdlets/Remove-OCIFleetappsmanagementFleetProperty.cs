...
{
    [Cmdlet("Remove", "OCIFleetappsmanagementFleetProperty", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCIFleetappsmanagementFleetProperty : OCIFleetAppsManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIFleetappsmanagementFleetProperty", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteFleetPropertyRequest
                {
                ...
                response = client.DeleteFleetProperty(request).GetAwaiter().GetResult();
        ...
        private DeleteFleetPropertyResponse response;
    }
}
