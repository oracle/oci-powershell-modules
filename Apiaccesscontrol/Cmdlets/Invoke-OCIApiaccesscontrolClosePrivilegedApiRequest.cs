...
{
    [Cmdlet("Invoke", "OCIApiaccesscontrolClosePrivilegedApiRequest")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApiaccesscontrolService.Responses.ClosePrivilegedApiRequestResponse) })]
    public class InvokeOCIApiaccesscontrolClosePrivilegedApiRequest : OCIPrivilegedApiRequestsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details regarding the close of an privilegedApi request created by the operator.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ClosePrivilegedApiRequestRequest
                {
                ...
                response = client.ClosePrivilegedApiRequest(request).GetAwaiter().GetResult();
        ...
        private ClosePrivilegedApiRequestResponse response;
    }
}
