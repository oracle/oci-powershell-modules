...
{
    [Cmdlet("Move", "OCIAivisionStreamGroupCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AivisionService.Responses.ChangeStreamGroupCompartmentResponse) })]
    public class MoveOCIAivisionStreamGroupCompartment : OCIAIServiceVisionCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeStreamGroupCompartmentRequest
                {
                ...
                response = client.ChangeStreamGroupCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeStreamGroupCompartmentResponse response;
    }
}
