...
{
    [Cmdlet("Update", "OCIBdsResourcePrincipalConfiguration")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.BdsService.Responses.UpdateResourcePrincipalConfigurationResponse) })]
    public class UpdateOCIBdsResourcePrincipalConfiguration : OCIBdsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for updating the resourcePrincipalConfiguration.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateResourcePrincipalConfigurationRequest
                {
                ...
                response = client.UpdateResourcePrincipalConfiguration(request).GetAwaiter().GetResult();
        ...
        private UpdateResourcePrincipalConfigurationResponse response;
    }
}
