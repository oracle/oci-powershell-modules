...
{
    [Cmdlet("Remove", "OCIIdentitydomainsSelfRegistrationProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteSelfRegistrationProfileResponse) })]
    public class RemoveOCIIdentitydomainsSelfRegistrationProfile : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsSelfRegistrationProfile", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteSelfRegistrationProfileRequest
                {
                ...
                response = client.DeleteSelfRegistrationProfile(request).GetAwaiter().GetResult();
        ...
        private DeleteSelfRegistrationProfileResponse response;
    }
}
