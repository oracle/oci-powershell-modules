...
{
    [Cmdlet("Update", "OCIResourcemanagerConfigurationSourceProvider")]
    ...
    public class UpdateOCIResourcemanagerConfigurationSourceProvider : OCIResourceManagerCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Updated information provided for the ConfigurationSourceProvider. This parameter also accepts subtypes <Oci.ResourcemanagerService.Models.UpdateBitbucketServerAccessTokenConfigurationSourceProviderDetails>, <Oci.ResourcemanagerService.Models.UpdateGitlabAccessTokenConfigurationSourceProviderDetails>, <Oci.ResourcemanagerService.Models.UpdateBitbucketCloudEmailApiTokenConfigurationSourceProviderDetails>, <Oci.ResourcemanagerService.Models.UpdateGithubAccessTokenConfigurationSourceProviderDetails> of type <Oci.ResourcemanagerService.Models.UpdateConfigurationSourceProviderDetails>.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateConfigurationSourceProviderRequest
                {
                ...
                response = client.UpdateConfigurationSourceProvider(request).GetAwaiter().GetResult();
        ...
        private UpdateConfigurationSourceProviderResponse response;
    }
}
