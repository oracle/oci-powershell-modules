...
{
    [Cmdlet("Get", "OCIDatasafeSensitiveTypesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.SensitiveTypeCollection), typeof(Oci.DatasafeService.Responses.ListSensitiveTypesResponse) })]
    public class GetOCIDatasafeSensitiveTypesList : OCIDataSafeCmdlet
    {
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSensitiveTypesRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return the sensitive type resources based on the value of their source attribute.")]
        public System.Nullable<Oci.DatasafeService.Models.SensitiveTypeSource> SensitiveTypeSource { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return the sensitive type resources based on the value of their entityType attribute.")]
        public System.Nullable<Oci.DatasafeService.Models.SensitiveTypeEntity> EntityType { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only the sensitive types that are children of the sensitive category identified by the specified OCID.")]
        public string ParentCategoryId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only the sensitive types that have the default masking format identified by the specified OCID.")]
...
**Example:** 2016-12-19T16:39:57.600Z")]
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSensitiveTypesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSensitiveTypesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSensitiveTypesRequest
                {
                ...
                {
                    response = item;
                    WriteOutput(response, response.SensitiveTypeCollection, true);
                }
        ...
        {
            IEnumerable<ListSensitiveTypesResponse> DefaultRequest(ListSensitiveTypesRequest request) => Enumerable.Repeat(client.ListSensitiveTypes(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSensitiveTypesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSensitiveTypesResponse response;
        private delegate IEnumerable<ListSensitiveTypesResponse> RequestDelegate(ListSensitiveTypesRequest request);
