...
namespace Oci.DatacatalogService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIDatacatalogSynchronousExportDataAsset", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatacatalogService.Responses.SynchronousExportDataAssetResponse) })]
    public class InvokeOCIDatacatalogSynchronousExportDataAsset : OCIDataCatalogCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details of what needs to be exported.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SynchronousExportDataAssetRequest
                {
                    CatalogId = CatalogId,
                ...
                response = client.SynchronousExportDataAsset(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private SynchronousExportDataAssetResponse response;
