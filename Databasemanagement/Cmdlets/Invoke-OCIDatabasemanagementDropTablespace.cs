...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementDropTablespace")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.TablespaceAdminStatus), typeof(Oci.DatabasemanagementService.Responses.DropTablespaceResponse) })]
    public class InvokeOCIDatabasemanagementDropTablespace : OCIDbManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details required to drop a tablespace.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DropTablespaceRequest
                {
                ...
                response = client.DropTablespace(request).GetAwaiter().GetResult();
        ...
        private DropTablespaceResponse response;
    }
}
