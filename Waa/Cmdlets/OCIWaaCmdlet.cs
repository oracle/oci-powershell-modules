...
using Oci.WaaService;

namespace Oci.WaaService.Cmdlets
{
    public abstract class OCIWaaCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new WaaClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
