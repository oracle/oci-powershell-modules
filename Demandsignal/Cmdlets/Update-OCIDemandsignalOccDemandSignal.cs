...
{
    [Cmdlet("Update", "OCIDemandsignalOccDemandSignal")]
    [OutputType(new System.Type[] { typeof(Oci.DemandsignalService.Models.OccDemandSignal), typeof(Oci.DemandsignalService.Responses.UpdateOccDemandSignalResponse) })]
    public class UpdateOCIDemandsignalOccDemandSignal : OCIOccDemandSignalCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateOccDemandSignalRequest
                {
                ...
                response = client.UpdateOccDemandSignal(request).GetAwaiter().GetResult();
        ...
        private UpdateOccDemandSignalResponse response;
    }
}
