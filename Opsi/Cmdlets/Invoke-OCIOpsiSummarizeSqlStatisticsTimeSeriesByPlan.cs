...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeSqlStatisticsTimeSeriesByPlan")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.SqlStatisticsTimeSeriesByPlanAggregationCollection), typeof(Oci.OpsiService.Responses.SummarizeSqlStatisticsTimeSeriesByPlanResponse) })]
    public class InvokeOCIOpsiSummarizeSqlStatisticsTimeSeriesByPlan : OCIOperationsInsightsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeSqlStatisticsTimeSeriesByPlanRequest
                {
                ...
                response = client.SummarizeSqlStatisticsTimeSeriesByPlan(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SqlStatisticsTimeSeriesByPlanAggregationCollection);
        ...
        private SummarizeSqlStatisticsTimeSeriesByPlanResponse response;
    }
}
