...
{
    [Cmdlet("Move", "OCIOdaPrivateEndpointCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OdaService.Responses.ChangeOdaPrivateEndpointCompartmentResponse) })]
    public class MoveOCIOdaPrivateEndpointCompartment : OCIManagementCmdlet
    {
...
Retry tokens expire after 24 hours, but they can become invalid before then if there are conflicting operations. For example, if an instance was deleted and purged from the system, then the service might reject a retry of the original creation request.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeOdaPrivateEndpointCompartmentRequest
                {
                ...
                response = client.ChangeOdaPrivateEndpointCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeOdaPrivateEndpointCompartmentResponse response;
    }
}
