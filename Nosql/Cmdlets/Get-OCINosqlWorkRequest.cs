...
{
    [Cmdlet("Get", "OCINosqlWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.NosqlService.Models.WorkRequest), typeof(Oci.NosqlService.Responses.GetWorkRequestResponse) })]
    public class GetOCINosqlWorkRequest : OCINosqlCmdlet
    {
        ...
        public Oci.NosqlService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
