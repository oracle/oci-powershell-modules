...
{
    [Cmdlet("Get", "OCIDatabaseOneoffPatchesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.OneoffPatchSummary), typeof(Oci.DatabaseService.Responses.ListOneoffPatchesResponse) })]
    public class GetOCIDatabaseOneoffPatchesList : OCIDatabaseCmdlet
    {
        ...
        public System.Nullable<Oci.DatabaseService.Requests.ListOneoffPatchesRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either ascending (`ASC`) or descending (`DESC`).")]
        public System.Nullable<Oci.DatabaseService.Requests.ListOneoffPatchesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatabaseService.Models.OneoffPatchSummary.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListOneoffPatchesRequest
                {
                ...
                IEnumerable<ListOneoffPatchesResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListOneoffPatchesResponse> DefaultRequest(ListOneoffPatchesRequest request) => Enumerable.Repeat(client.ListOneoffPatches(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListOneoffPatchesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListOneoffPatchesResponse response;
        private delegate IEnumerable<ListOneoffPatchesResponse> RequestDelegate(ListOneoffPatchesRequest request);
