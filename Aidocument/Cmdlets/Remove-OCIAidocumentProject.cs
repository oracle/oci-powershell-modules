...
{
    [Cmdlet("Remove", "OCIAidocumentProject", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AidocumentService.Responses.DeleteProjectResponse) })]
    public class RemoveOCIAidocumentProject : OCIAIServiceDocumentCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAidocumentProject", "Remove"))
            {
               return;
            }
