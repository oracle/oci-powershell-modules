...
{
    [Cmdlet("New", "OCIDataconnectivityRegistry")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DataconnectivityService.Responses.CreateRegistryResponse) })]
    public class NewOCIDataconnectivityRegistry : OCIDataConnectivityManagementCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new Data Connectivity Management Registry.")]
        public CreateRegistryDetails CreateRegistryDetails { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CreateRegistry(request).GetAwaiter().GetResult();
        ...
        private CreateRegistryResponse response;
    }
}
