...
using Oci.AianomalydetectionService;

namespace Oci.AianomalydetectionService.Cmdlets
{
    public abstract class OCIAnomalyDetectionCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AnomalyDetectionClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AnomalyDetectionClient client;
