...
{
    [Cmdlet("Remove", "OCIManagedkafkaKafkaClusterConfigVersion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCIManagedkafkaKafkaClusterConfigVersion : OCIKafkaClusterCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIManagedkafkaKafkaClusterConfigVersion", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteKafkaClusterConfigVersionRequest
                {
                ...
                response = client.DeleteKafkaClusterConfigVersion(request).GetAwaiter().GetResult();
        ...
        private DeleteKafkaClusterConfigVersionResponse response;
    }
}
