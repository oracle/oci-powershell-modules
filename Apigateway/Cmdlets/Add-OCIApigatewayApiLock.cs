...
{
    [Cmdlet("Add", "OCIApigatewayApiLock")]
    [OutputType(new System.Type[] { typeof(Oci.ApigatewayService.Models.Api), typeof(Oci.ApigatewayService.Responses.AddApiLockResponse) })]
    public class AddOCIApigatewayApiLock : OCIApiGatewayCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.AddApiLock(request).GetAwaiter().GetResult();
        ...
        private AddApiLockResponse response;
    }
}
