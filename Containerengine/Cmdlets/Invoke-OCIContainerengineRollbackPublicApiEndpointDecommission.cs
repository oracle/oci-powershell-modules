...
{
    [Cmdlet("Invoke", "OCIContainerengineRollbackPublicApiEndpointDecommission")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ContainerengineService.Responses.RollbackPublicApiEndpointDecommissionResponse) })]
    public class InvokeOCIContainerengineRollbackPublicApiEndpointDecommission : OCIContainerEngineCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RollbackPublicApiEndpointDecommissionRequest
                {
                    ClusterId = ClusterId,
                ...
                response = client.RollbackPublicApiEndpointDecommission(request).GetAwaiter().GetResult();
        ...
        private RollbackPublicApiEndpointDecommissionResponse response;
    }
}
