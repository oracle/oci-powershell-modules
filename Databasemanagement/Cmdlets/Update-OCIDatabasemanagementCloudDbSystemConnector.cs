...
{
    [Cmdlet("Update", "OCIDatabasemanagementCloudDbSystemConnector")]
    ...
    public class UpdateOCIDatabasemanagementCloudDbSystemConnector : OCIDbManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details required to update a cloud connector. This parameter also accepts subtype <Oci.DatabasemanagementService.Models.UpdateCloudDbSystemMacsConnectorDetails> of type <Oci.DatabasemanagementService.Models.UpdateCloudDbSystemConnectorDetails>.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateCloudDbSystemConnectorRequest
                {
                ...
                response = client.UpdateCloudDbSystemConnector(request).GetAwaiter().GetResult();
        ...
        private UpdateCloudDbSystemConnectorResponse response;
    }
}
