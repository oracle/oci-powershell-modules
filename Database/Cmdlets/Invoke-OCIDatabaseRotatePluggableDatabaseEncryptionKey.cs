...
{
    [Cmdlet("Invoke", "OCIDatabaseRotatePluggableDatabaseEncryptionKey", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.RotatePluggableDatabaseEncryptionKeyResponse) })]
    public class InvokeOCIDatabaseRotatePluggableDatabaseEncryptionKey : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RotatePluggableDatabaseEncryptionKeyRequest
                {
        ...
        private void HandleOutput(RotatePluggableDatabaseEncryptionKeyRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRotatePluggableDatabaseEncryptionKey(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RotatePluggableDatabaseEncryptionKey(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private RotatePluggableDatabaseEncryptionKeyResponse response;
