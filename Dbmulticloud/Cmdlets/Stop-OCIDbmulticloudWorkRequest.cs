...
{
    [Cmdlet("Stop", "OCIDbmulticloudWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DbmulticloudService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIDbmulticloudWorkRequest : OCIWorkRequestCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDbmulticloudWorkRequest", "Stop"))
            {
               return;
            }
