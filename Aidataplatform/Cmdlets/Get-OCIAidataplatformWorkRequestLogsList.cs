...
{
    [Cmdlet("Get", "OCIAidataplatformWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.AidataplatformService.Models.WorkRequestLogEntryCollection), typeof(Oci.AidataplatformService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIAidataplatformWorkRequestLogsList : OCIAiDataPlatformCmdlet
    {
        ...
        public System.Nullable<Oci.AidataplatformService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
