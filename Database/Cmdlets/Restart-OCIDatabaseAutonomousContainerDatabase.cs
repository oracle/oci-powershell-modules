...
{
    [Cmdlet("Restart", "OCIDatabaseAutonomousContainerDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousContainerDatabase), typeof(Oci.DatabaseService.Responses.RestartAutonomousContainerDatabaseResponse) })]
    public class RestartOCIDatabaseAutonomousContainerDatabase : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RestartAutonomousContainerDatabaseRequest
                {
        ...
        private void HandleOutput(RestartAutonomousContainerDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRestartAutonomousContainerDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RestartAutonomousContainerDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousContainerDatabase);
        }

        private RestartAutonomousContainerDatabaseResponse response;
