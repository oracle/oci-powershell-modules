...
{
    [Cmdlet("Get", "OCIIdentitydomainsSecurityQuestionSettingsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SecurityQuestionSettings), typeof(Oci.IdentitydomainsService.Responses.ListSecurityQuestionSettingsResponse) })]
    public class GetOCIIdentitydomainsSecurityQuestionSettingsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSecurityQuestionSettingsRequest
                {
                ...
                response = client.ListSecurityQuestionSettings(request).GetAwaiter().GetResult();
        ...
        private ListSecurityQuestionSettingsResponse response;
    }
}
