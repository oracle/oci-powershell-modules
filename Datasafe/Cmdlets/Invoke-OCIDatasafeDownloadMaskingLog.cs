...
namespace Oci.DatasafeService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIDatasafeDownloadMaskingLog", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatasafeService.Responses.DownloadMaskingLogResponse) })]
    public class InvokeOCIDatasafeDownloadMaskingLog : OCIDataSafeCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details to download masking log.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DownloadMaskingLogRequest
                {
                ...
                response = client.DownloadMaskingLog(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private DownloadMaskingLogResponse response;
