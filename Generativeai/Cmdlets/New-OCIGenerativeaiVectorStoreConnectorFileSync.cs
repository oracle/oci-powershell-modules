...
{
    [Cmdlet("New", "OCIGenerativeaiVectorStoreConnectorFileSync")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.VectorStoreConnectorFileSync), typeof(Oci.GenerativeaiService.Responses.CreateVectorStoreConnectorFileSyncResponse) })]
    public class NewOCIGenerativeaiVectorStoreConnectorFileSync : OCIGenerativeAiCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new vectorStoreConnectorFileSync.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateVectorStoreConnectorFileSyncRequest
                {
                ...
                response = client.CreateVectorStoreConnectorFileSync(request).GetAwaiter().GetResult();
        ...
        private CreateVectorStoreConnectorFileSyncResponse response;
    }
}
