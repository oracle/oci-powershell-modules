...
{
    [Cmdlet("Get", "OCIStreamAdminStream", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Stream), typeof(Oci.StreamingService.Responses.GetStreamResponse) })]
    public class GetOCIStreamAdminStream : OCIStreamAdminCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the stream.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the stream.", ParameterSetName = Default)]
        ...
        public Oci.StreamingService.Models.Stream.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        private GetStreamResponse response;
