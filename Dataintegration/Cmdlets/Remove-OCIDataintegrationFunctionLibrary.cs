...
{
    [Cmdlet("Remove", "OCIDataintegrationFunctionLibrary", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataintegrationService.Responses.DeleteFunctionLibraryResponse) })]
    public class RemoveOCIDataintegrationFunctionLibrary : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataintegrationFunctionLibrary", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteFunctionLibraryRequest
                {
                ...
                response = client.DeleteFunctionLibrary(request).GetAwaiter().GetResult();
        ...
        private DeleteFunctionLibraryResponse response;
    }
}
