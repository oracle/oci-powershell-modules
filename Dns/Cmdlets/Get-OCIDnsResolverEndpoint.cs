...
{
    [Cmdlet("Get", "OCIDnsResolverEndpoint", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.ResolverEndpoint), typeof(Oci.DnsService.Responses.GetResolverEndpointResponse) })]
    public class GetOCIDnsResolverEndpoint : OCIDnsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The name of the target resolver endpoint.", ParameterSetName = LifecycleStateParamSet)]
        ...
        public Oci.DnsService.Models.ResolverEndpoint.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        private void HandleOutput(GetResolverEndpointRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForResolverEndpoint(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetResolverEndpoint(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.ResolverEndpoint);
        }

        private GetResolverEndpointResponse response;
