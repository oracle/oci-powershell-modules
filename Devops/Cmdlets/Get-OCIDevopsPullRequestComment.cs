...
{
    [Cmdlet("Get", "OCIDevopsPullRequestComment")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.PullRequestComment), typeof(Oci.DevopsService.Responses.GetPullRequestCommentResponse) })]
    public class GetOCIDevopsPullRequestComment : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GetPullRequestComment(request).GetAwaiter().GetResult();
        ...
        private GetPullRequestCommentResponse response;
    }
}
