...
{
    [Cmdlet("Get", "OCIOsmanagementhubModuleStreamProfilesList")]
    [OutputType(new System.Type[] { typeof(Oci.OsmanagementhubService.Models.ModuleStreamProfileCollection), typeof(Oci.OsmanagementhubService.Responses.ListModuleStreamProfilesResponse) })]
    public class GetOCIOsmanagementhubModuleStreamProfilesList : OCISoftwareSourceCmdlet
    {
...
Example: `3`")]
        ...
        public System.Nullable<Oci.OsmanagementhubService.Requests.ListModuleStreamProfilesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    response = item;
                    WriteOutput(response, response.ModuleStreamProfileCollection, true);
                }
