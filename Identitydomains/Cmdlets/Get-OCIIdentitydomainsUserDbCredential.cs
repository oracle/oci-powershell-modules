...
{
    [Cmdlet("Get", "OCIIdentitydomainsUserDbCredential")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.UserDbCredential), typeof(Oci.IdentitydomainsService.Responses.GetUserDbCredentialResponse) })]
    public class GetOCIIdentitydomainsUserDbCredential : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetUserDbCredentialRequest
                {
                ...
                response = client.GetUserDbCredential(request).GetAwaiter().GetResult();
        ...
        private GetUserDbCredentialResponse response;
    }
}
