...
using Oci.OsubsubscriptionService;

namespace Oci.OsubsubscriptionService.Cmdlets
{
    public abstract class OCICommitmentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new CommitmentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected CommitmentClient client;
