...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchPasswordPolicies")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.PasswordPolicies), typeof(Oci.IdentitydomainsService.Responses.SearchPasswordPoliciesResponse) })]
    public class InvokeOCIIdentitydomainsSearchPasswordPolicies : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching PasswordPolicies")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchPasswordPoliciesRequest
                {
                ...
                response = client.SearchPasswordPolicies(request).GetAwaiter().GetResult();
                WriteOutput(response, response.PasswordPolicies);
        ...
        private SearchPasswordPoliciesResponse response;
    }
}
