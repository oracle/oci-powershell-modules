...
{
    [Cmdlet("New", "OCIGenerativeaiHostedDeployment")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.HostedDeployment), typeof(Oci.GenerativeaiService.Responses.CreateHostedDeploymentResponse) })]
    public class NewOCIGenerativeaiHostedDeployment : OCIGenerativeAiCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new hosted deployment.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateHostedDeploymentRequest
                {
                ...
                response = client.CreateHostedDeployment(request).GetAwaiter().GetResult();
        ...
        private CreateHostedDeploymentResponse response;
    }
}
