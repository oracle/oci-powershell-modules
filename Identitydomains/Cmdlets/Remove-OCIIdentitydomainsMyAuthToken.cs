...
{
    [Cmdlet("Remove", "OCIIdentitydomainsMyAuthToken", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteMyAuthTokenResponse) })]
    public class RemoveOCIIdentitydomainsMyAuthToken : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsMyAuthToken", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteMyAuthTokenRequest
                {
                ...
                response = client.DeleteMyAuthToken(request).GetAwaiter().GetResult();
        ...
        private DeleteMyAuthTokenResponse response;
    }
}
