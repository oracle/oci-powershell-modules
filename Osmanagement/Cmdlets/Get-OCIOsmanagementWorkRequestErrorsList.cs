...
{
    [Cmdlet("Get", "OCIOsmanagementWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.OsmanagementService.Models.WorkRequestError), typeof(Oci.OsmanagementService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIOsmanagementWorkRequestErrorsList : OCIOsManagementCmdlet
    {
        ...
        public System.Nullable<Oci.OsmanagementService.Requests.ListWorkRequestErrorsRequest.SortOrderEnum> SortOrder { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field to sort by. Only one sort order may be provided. Default order for TIMECREATED is descending. Default order for DISPLAYNAME is ascending. If no value is specified TIMECREATED is default.")]
        public System.Nullable<Oci.OsmanagementService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }
