...
{
    [Cmdlet("Disable", "OCIDatabasemanagementExternalMySqlDatabaseManagement")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabasemanagementService.Responses.DisableExternalMySqlDatabaseManagementResponse) })]
    public class DisableOCIDatabasemanagementExternalMySqlDatabaseManagement : OCIDbManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.DisableExternalMySqlDatabaseManagement(request).GetAwaiter().GetResult();
        ...
        private DisableExternalMySqlDatabaseManagementResponse response;
    }
}
