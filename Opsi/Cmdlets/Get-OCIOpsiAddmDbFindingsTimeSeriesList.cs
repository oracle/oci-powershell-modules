...
{
    [Cmdlet("Get", "OCIOpsiAddmDbFindingsTimeSeriesList")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.AddmDbFindingsTimeSeriesCollection), typeof(Oci.OpsiService.Responses.ListAddmDbFindingsTimeSeriesResponse) })]
    public class GetOCIOpsiAddmDbFindingsTimeSeriesList : OCIOperationsInsightsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Field name for sorting the ADDM finding time series summary data")]
        public System.Nullable<Oci.OpsiService.Requests.ListAddmDbFindingsTimeSeriesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAddmDbFindingsTimeSeriesRequest
                {
                ...
                IEnumerable<ListAddmDbFindingsTimeSeriesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.AddmDbFindingsTimeSeriesCollection, true);
                }
        ...
        {
            IEnumerable<ListAddmDbFindingsTimeSeriesResponse> DefaultRequest(ListAddmDbFindingsTimeSeriesRequest request) => Enumerable.Repeat(client.ListAddmDbFindingsTimeSeries(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAddmDbFindingsTimeSeriesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAddmDbFindingsTimeSeriesResponse response;
        private delegate IEnumerable<ListAddmDbFindingsTimeSeriesResponse> RequestDelegate(ListAddmDbFindingsTimeSeriesRequest request);
