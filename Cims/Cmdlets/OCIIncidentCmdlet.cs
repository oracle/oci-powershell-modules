...
{
    public abstract class OCIIncidentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new IncidentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected IncidentClient client;
