...
{
    public abstract class OCIBastionCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new BastionClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected BastionClient client;
