...
{
    [Cmdlet("Get", "OCIGloballydistributeddatabaseWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.GloballydistributeddatabaseService.Models.WorkRequestLogEntryCollection), typeof(Oci.GloballydistributeddatabaseService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIGloballydistributeddatabaseWorkRequestLogsList : OCIShardedDatabaseServiceCmdlet
    {
        ...
        public System.Nullable<Oci.GloballydistributeddatabaseService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
