...
{
    public abstract class OCITransferDeviceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new TransferDeviceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected TransferDeviceClient client;
