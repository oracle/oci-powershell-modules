...
namespace Oci.LoggingingestionService.Cmdlets
{
    ...
    public class WriteOCILoggingingestionLogs : OCILoggingCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Effective timestamp, for when the agent started processing the log segment being sent. An RFC3339 formatted datetime string.")]
