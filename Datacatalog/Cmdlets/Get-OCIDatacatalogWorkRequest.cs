...
{
    [Cmdlet("Get", "OCIDatacatalogWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.WorkRequest), typeof(Oci.DatacatalogService.Responses.GetWorkRequestResponse) })]
    public class GetOCIDatacatalogWorkRequest : OCIDataCatalogCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the asynchronous request.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the asynchronous request.", ParameterSetName = Default)]
        ...
        public Oci.DatacatalogService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
