...
{
    [Cmdlet("Get", "OCIVirtualNetworkNetworkingTopology")]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.NetworkingTopology), typeof(Oci.CoreService.Responses.GetNetworkingTopologyResponse) })]
    public class GetOCIVirtualNetworkNetworkingTopology : OCIVirtualNetworkCmdlet
    {
...
When set to `ANY` permissions are not checked.")]
        public System.Nullable<Oci.CoreService.Requests.GetNetworkingTopologyRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetNetworkingTopologyRequest
                {
                ...
                response = client.GetNetworkingTopology(request).GetAwaiter().GetResult();
                WriteOutput(response, response.NetworkingTopology);
        ...
        private GetNetworkingTopologyResponse response;
    }
}
