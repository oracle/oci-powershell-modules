...
{
    [Cmdlet("Get", "OCIIdentitydomainsSecurityQuestionsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SecurityQuestions), typeof(Oci.IdentitydomainsService.Responses.ListSecurityQuestionsResponse) })]
    public class GetOCIIdentitydomainsSecurityQuestionsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSecurityQuestionsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListSecurityQuestions(request).GetAwaiter().GetResult();
        ...
        private ListSecurityQuestionsResponse response;
    }
}
