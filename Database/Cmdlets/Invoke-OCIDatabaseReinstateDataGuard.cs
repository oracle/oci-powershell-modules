...
{
    [Cmdlet("Invoke", "OCIDatabaseReinstateDataGuard", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Database), typeof(Oci.DatabaseService.Responses.ReinstateDataGuardResponse) })]
    public class InvokeOCIDatabaseReinstateDataGuard : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ReinstateDataGuardRequest
                {
        ...
        private void HandleOutput(ReinstateDataGuardRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForReinstateDataGuard(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ReinstateDataGuard(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.Database);
        }

        private ReinstateDataGuardResponse response;
