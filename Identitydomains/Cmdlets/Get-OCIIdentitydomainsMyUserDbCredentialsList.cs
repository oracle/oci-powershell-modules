...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyUserDbCredentialsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyUserDbCredentials), typeof(Oci.IdentitydomainsService.Responses.ListMyUserDbCredentialsResponse) })]
    public class GetOCIIdentitydomainsMyUserDbCredentialsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMyUserDbCredentialsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListMyUserDbCredentials(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MyUserDbCredentials);
        ...
        private ListMyUserDbCredentialsResponse response;
    }
}
