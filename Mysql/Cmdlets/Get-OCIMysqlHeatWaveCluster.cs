...
{
    [Cmdlet("Get", "OCIMysqlHeatWaveCluster", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.MysqlService.Models.HeatWaveCluster), typeof(Oci.MysqlService.Responses.GetHeatWaveClusterResponse) })]
    public class GetOCIMysqlHeatWaveCluster : OCIDbSystemCmdlet
    {
        ...
        public Oci.MysqlService.Models.HeatWaveCluster.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetHeatWaveClusterRequest
                {
        ...
        private void HandleOutput(GetHeatWaveClusterRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForHeatWaveCluster(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetHeatWaveCluster(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.HeatWaveCluster);
        }

        private GetHeatWaveClusterResponse response;
