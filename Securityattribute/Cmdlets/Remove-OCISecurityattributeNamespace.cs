...
{
    [Cmdlet("Remove", "OCISecurityattributeNamespace", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.SecurityattributeService.Responses.DeleteSecurityAttributeNamespaceResponse) })]
    public class RemoveOCISecurityattributeNamespace : OCISecurityAttributeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCISecurityattributeNamespace", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteSecurityAttributeNamespaceRequest
                {
                ...
                response = client.DeleteSecurityAttributeNamespace(request).GetAwaiter().GetResult();
        ...
        private DeleteSecurityAttributeNamespaceResponse response;
    }
}
