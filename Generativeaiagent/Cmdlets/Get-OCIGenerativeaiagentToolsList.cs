...
{
    [Cmdlet("Get", "OCIGenerativeaiagentToolsList")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiagentService.Models.ToolCollection), typeof(Oci.GenerativeaiagentService.Responses.ListToolsResponse) })]
    public class GetOCIGenerativeaiagentToolsList : OCIGenerativeAiAgentCmdlet
    {
        ...
        public System.Nullable<Oci.GenerativeaiagentService.Models.Tool.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.GenerativeaiagentService.Requests.ListToolsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListToolsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.ToolCollection, true);
                }
        ...
        {
            IEnumerable<ListToolsResponse> DefaultRequest(ListToolsRequest request) => Enumerable.Repeat(client.ListTools(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListToolsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListToolsResponse response;
        private delegate IEnumerable<ListToolsResponse> RequestDelegate(ListToolsRequest request);
