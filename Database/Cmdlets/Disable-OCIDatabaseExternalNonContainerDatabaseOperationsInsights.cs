...
{
    [Cmdlet("Disable", "OCIDatabaseExternalNonContainerDatabaseOperationsInsights", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DisableExternalNonContainerDatabaseOperationsInsightsResponse) })]
    public class DisableOCIDatabaseExternalNonContainerDatabaseOperationsInsights : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableExternalNonContainerDatabaseOperationsInsightsRequest
                {
        ...
        private void HandleOutput(DisableExternalNonContainerDatabaseOperationsInsightsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDisableExternalNonContainerDatabaseOperationsInsights(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DisableExternalNonContainerDatabaseOperationsInsights(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DisableExternalNonContainerDatabaseOperationsInsightsResponse response;
