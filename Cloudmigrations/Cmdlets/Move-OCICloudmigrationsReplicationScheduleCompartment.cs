...
{
    [Cmdlet("Move", "OCICloudmigrationsReplicationScheduleCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CloudmigrationsService.Responses.ChangeReplicationScheduleCompartmentResponse) })]
    public class MoveOCICloudmigrationsReplicationScheduleCompartment : OCIMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeReplicationScheduleCompartmentRequest
                {
                ...
                response = client.ChangeReplicationScheduleCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeReplicationScheduleCompartmentResponse response;
    }
}
