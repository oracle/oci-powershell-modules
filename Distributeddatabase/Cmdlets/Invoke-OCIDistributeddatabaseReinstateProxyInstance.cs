...
{
    [Cmdlet("Invoke", "OCIDistributeddatabaseReinstateProxyInstance")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.ReinstateProxyInstanceResponse) })]
    public class InvokeOCIDistributeddatabaseReinstateProxyInstance : OCIDistributedDbPrivateEndpointServiceCmdlet
    {
