...
{
    [Cmdlet("Get", "OCIKeymanagementWrappingKey", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.WrappingKey), typeof(Oci.KeymanagementService.Responses.GetWrappingKeyResponse) })]
    public class GetOCIKeymanagementWrappingKey : OCIKmsManagementCmdlet
    {
        ...
        public Oci.KeymanagementService.Models.WrappingKey.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetWrappingKeyRequest
                {
        ...
        private void HandleOutput(GetWrappingKeyRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForWrappingKey(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetWrappingKey(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.WrappingKey);
        }

        private GetWrappingKeyResponse response;
