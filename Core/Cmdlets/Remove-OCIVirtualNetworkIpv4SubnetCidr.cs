...
{
    [Cmdlet("Remove", "OCIVirtualNetworkIpv4SubnetCidr", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.RemoveIpv4SubnetCidrResponse) })]
    public class RemoveOCIVirtualNetworkIpv4SubnetCidr : OCIVirtualNetworkCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details object for removing an IPv4 SUBNET prefix.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details object for removing an IPv4 SUBNET prefix.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveIpv4SubnetCidrRequest
                {
                    SubnetId = SubnetId,
        ...
        private void HandleOutput(RemoveIpv4SubnetCidrRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRemoveIpv4SubnetCidr(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RemoveIpv4SubnetCidr(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private RemoveIpv4SubnetCidrResponse response;
