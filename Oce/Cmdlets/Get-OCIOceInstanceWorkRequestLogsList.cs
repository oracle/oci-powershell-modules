...
{
    [Cmdlet("Get", "OCIOceInstanceWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.OceService.Models.WorkRequestLogEntry), typeof(Oci.OceService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIOceInstanceWorkRequestLogsList : OCIOceInstanceCmdlet
    {
