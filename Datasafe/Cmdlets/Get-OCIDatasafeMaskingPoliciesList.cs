...
{
    [Cmdlet("Get", "OCIDatasafeMaskingPoliciesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.MaskingPolicyCollection), typeof(Oci.DatasafeService.Responses.ListMaskingPoliciesResponse) })]
    public class GetOCIDatasafeMaskingPoliciesList : OCIDataSafeCmdlet
    {
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListMaskingPoliciesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListMaskingPoliciesRequest.SortByEnum> SortBy { get; set; }
...
**Example:** 2016-12-19T16:39:57.600Z")]
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListMaskingPoliciesRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMaskingPoliciesRequest
                {
                ...
                IEnumerable<ListMaskingPoliciesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.MaskingPolicyCollection, true);
                }
        ...
        {
            IEnumerable<ListMaskingPoliciesResponse> DefaultRequest(ListMaskingPoliciesRequest request) => Enumerable.Repeat(client.ListMaskingPolicies(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListMaskingPoliciesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListMaskingPoliciesResponse response;
        private delegate IEnumerable<ListMaskingPoliciesResponse> RequestDelegate(ListMaskingPoliciesRequest request);
