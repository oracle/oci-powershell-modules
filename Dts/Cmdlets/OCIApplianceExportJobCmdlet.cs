...
{
    public abstract class OCIApplianceExportJobCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ApplianceExportJobClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ApplianceExportJobClient client;
