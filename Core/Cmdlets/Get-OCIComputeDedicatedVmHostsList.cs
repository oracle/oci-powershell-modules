...
{
    [Cmdlet("Get", "OCIComputeDedicatedVmHostsList")]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.DedicatedVmHostSummary), typeof(Oci.CoreService.Responses.ListDedicatedVmHostsResponse) })]
    public class GetOCIComputeDedicatedVmHostsList : OCIComputeCmdlet
    {
...
Example: `Uocm:PHX-AD-1`")]
        ...
        public System.Nullable<Oci.CoreService.Requests.ListDedicatedVmHostsRequest.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The name for the instance's shape.")]
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by availability domain if the scope of the resource type is within a single availability domain. If you call one of these ""List"" operations without specifying an availability domain, the resources are grouped by availability domain, then sorted.")]
        public System.Nullable<Oci.CoreService.Requests.ListDedicatedVmHostsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListDedicatedVmHostsRequest
                {
        ...
        {
            IEnumerable<ListDedicatedVmHostsResponse> DefaultRequest(ListDedicatedVmHostsRequest request) => Enumerable.Repeat(client.ListDedicatedVmHosts(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListDedicatedVmHostsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListDedicatedVmHostsResponse response;
        private delegate IEnumerable<ListDedicatedVmHostsResponse> RequestDelegate(ListDedicatedVmHostsRequest request);
