...
{
    [Cmdlet("New", "OCIDataflowPool")]
    [OutputType(new System.Type[] { typeof(Oci.DataflowService.Models.Pool), typeof(Oci.DataflowService.Responses.CreatePoolResponse) })]
    public class NewOCIDataflowPool : OCIDataFlowCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The parameter required to create a pool.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CreatePool(request).GetAwaiter().GetResult();
        ...
        private CreatePoolResponse response;
    }
}
