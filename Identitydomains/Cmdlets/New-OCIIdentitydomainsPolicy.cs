...
{
    [Cmdlet("New", "OCIIdentitydomainsPolicy")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Policy), typeof(Oci.IdentitydomainsService.Responses.CreatePolicyResponse) })]
    public class NewOCIIdentitydomainsPolicy : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Policy schema.
