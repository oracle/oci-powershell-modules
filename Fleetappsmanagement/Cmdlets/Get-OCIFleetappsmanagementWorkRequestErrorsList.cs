...
{
    [Cmdlet("Get", "OCIFleetappsmanagementWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.FleetappsmanagementService.Models.WorkRequestErrorCollection), typeof(Oci.FleetappsmanagementService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIFleetappsmanagementWorkRequestErrorsList : OCIFleetAppsManagementWorkRequestCmdlet
    {
        ...
        public System.Nullable<Oci.FleetappsmanagementService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }
