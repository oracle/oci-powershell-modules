...
{
    [Cmdlet("Update", "OCILoganalyticsIngestTimeRule")]
    ...
    public class UpdateOCILoganalyticsIngestTimeRule : OCILogAnalyticsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateIngestTimeRuleRequest
                {
                ...
                response = client.UpdateIngestTimeRule(request).GetAwaiter().GetResult();
        ...
        private UpdateIngestTimeRuleResponse response;
    }
}
