...
{
    [Cmdlet("Get", "OCIDatasafeProfileAnalyticsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.ProfileAggregation), typeof(Oci.DatasafeService.Responses.ListProfileAnalyticsResponse) })]
    public class GetOCIDatasafeProfileAnalyticsList : OCIDataSafeCmdlet
    {
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListProfileAnalyticsRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListProfileAnalyticsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either ascending (ASC) or descending (DESC).")]
        public System.Nullable<Oci.DatasafeService.Requests.ListProfileAnalyticsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListProfileAnalyticsRequest
                {
                ...
                IEnumerable<ListProfileAnalyticsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListProfileAnalyticsResponse> DefaultRequest(ListProfileAnalyticsRequest request) => Enumerable.Repeat(client.ListProfileAnalytics(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListProfileAnalyticsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListProfileAnalyticsResponse response;
        private delegate IEnumerable<ListProfileAnalyticsResponse> RequestDelegate(ListProfileAnalyticsRequest request);
