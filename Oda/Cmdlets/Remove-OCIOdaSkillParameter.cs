...
{
    [Cmdlet("Remove", "OCIOdaSkillParameter", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OdaService.Responses.DeleteSkillParameterResponse) })]
    public class RemoveOCIOdaSkillParameter : OCIManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOdaSkillParameter", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteSkillParameterRequest
                {
                ...
                response = client.DeleteSkillParameter(request).GetAwaiter().GetResult();
        ...
        private DeleteSkillParameterResponse response;
    }
}
