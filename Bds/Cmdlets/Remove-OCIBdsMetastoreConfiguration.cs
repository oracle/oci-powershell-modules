...
{
    [Cmdlet("Remove", "OCIBdsMetastoreConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.BdsService.Responses.DeleteBdsMetastoreConfigurationResponse) })]
    public class RemoveOCIBdsMetastoreConfiguration : OCIBdsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIBdsMetastoreConfiguration", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteBdsMetastoreConfigurationRequest
                {
        ...
        private DeleteBdsMetastoreConfigurationResponse response;
    }
}
