...
{
    [Cmdlet("Remove", "OCICloudbridgeAgent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CloudbridgeService.Responses.DeleteAgentResponse) })]
    public class RemoveOCICloudbridgeAgent : OCIOcbAgentSvcCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCICloudbridgeAgent", "Remove"))
            {
               return;
            }
