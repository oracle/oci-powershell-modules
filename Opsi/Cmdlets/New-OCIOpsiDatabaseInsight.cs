...
namespace Oci.OpsiService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the database for which a Database Insight resource will be created in Operations Insights. This parameter also accepts subtype <Oci.OpsiService.Models.CreateEmManagedExternalDatabaseInsightDetails> of type <Oci.OpsiService.Models.CreateDatabaseInsightDetails>.")]
