...
{
    public abstract class OCIAttributesCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AttributesClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AttributesClient client;
