...
{
    [Cmdlet("Get", "OCIPsqlShapesList")]
    [OutputType(new System.Type[] { typeof(Oci.PsqlService.Models.ShapeCollection), typeof(Oci.PsqlService.Responses.ListShapesResponse) })]
    public class GetOCIPsqlShapesList : OCIPostgresqlCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return the feature by the shape name.")]
        ...
        public System.Nullable<Oci.PsqlService.Requests.ListShapesRequest.SortByEnum> SortBy { get; set; }
