...
{
    [Cmdlet("Get", "OCIBlockchainPlatformWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.BlockchainService.Models.WorkRequest), typeof(Oci.BlockchainService.Responses.GetWorkRequestResponse) })]
    public class GetOCIBlockchainPlatformWorkRequest : OCIBlockchainPlatformCmdlet
    {
        ...
        public Oci.BlockchainService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
