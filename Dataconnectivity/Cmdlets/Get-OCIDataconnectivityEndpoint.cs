...
{
    [Cmdlet("Get", "OCIDataconnectivityEndpoint", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DataconnectivityService.Models.Endpoint), typeof(Oci.DataconnectivityService.Responses.GetEndpointResponse) })]
    public class GetOCIDataconnectivityEndpoint : OCIDataConnectivityManagementCmdlet
    {
        ...
        public Oci.DataconnectivityService.Models.Endpoint.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
