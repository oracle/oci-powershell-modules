...
CmdletsToExport = 'Get-OCIOpsiDatabaseInsightsList', 'Get-OCIOpsiSqlPlansList', 
               'Get-OCIOpsiSqlSearchesList', 'Get-OCIOpsiSqlTextsList', 
               'Invoke-OCIOpsiIngestSqlBucket', 'Invoke-OCIOpsiIngestSqlPlanLines', 
