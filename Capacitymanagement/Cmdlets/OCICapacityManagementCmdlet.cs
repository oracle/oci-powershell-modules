...
{
    public abstract class OCICapacityManagementCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new CapacityManagementClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected CapacityManagementClient client;
