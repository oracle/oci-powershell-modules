...
{
    [Cmdlet("Remove", "OCIIdentitydomainsGrant", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteGrantResponse) })]
    public class RemoveOCIIdentitydomainsGrant : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsGrant", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteGrant(request).GetAwaiter().GetResult();
        ...
        private DeleteGrantResponse response;
    }
}
