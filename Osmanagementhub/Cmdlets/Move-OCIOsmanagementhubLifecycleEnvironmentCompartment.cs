...
{
    [Cmdlet("Move", "OCIOsmanagementhubLifecycleEnvironmentCompartment")]
    ...
    public class MoveOCIOsmanagementhubLifecycleEnvironmentCompartment : OCILifecycleEnvironmentCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeLifecycleEnvironmentCompartmentRequest
                {
                ...
                response = client.ChangeLifecycleEnvironmentCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeLifecycleEnvironmentCompartmentResponse response;
    }
}
