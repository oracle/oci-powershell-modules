...
{
    [Cmdlet("Get", "OCIWaasJsChallenge")]
    [OutputType(new System.Type[] { typeof(Oci.WaasService.Models.JsChallenge), typeof(Oci.WaasService.Responses.GetJsChallengeResponse) })]
    public class GetOCIWaasJsChallenge : OCIWaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetJsChallengeRequest
                {
                    WaasPolicyId = WaasPolicyId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetJsChallenge(request).GetAwaiter().GetResult();
                WriteOutput(response, response.JsChallenge);
        ...
        private GetJsChallengeResponse response;
    }
}
