...
{
    [Cmdlet("Get", "OCIDatacatalogConnection", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Connection), typeof(Oci.DatacatalogService.Responses.GetConnectionResponse) })]
    public class GetOCIDatacatalogConnection : OCIDataCatalogCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique connection key.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique connection key.", ParameterSetName = Default)]
        public string ConnectionKey { get; set; }

        
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifies the fields to return in a connection response.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifies the fields to return in a connection response.", ParameterSetName = Default)]
        public System.Collections.Generic.List<Oci.DatacatalogService.Requests.GetConnectionRequest.FieldsEnum> Fields { get; set; }
