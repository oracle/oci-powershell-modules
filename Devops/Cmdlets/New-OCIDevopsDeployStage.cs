...
namespace Oci.DevopsService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new DeployStage. This parameter also accepts subtypes <Oci.DevopsService.Models.CreateManualApprovalDeployStageDetails>, <Oci.DevopsService.Models.CreateWaitDeployStageDetails>, <Oci.DevopsService.Models.CreateOkeDeployStageDetails>, <Oci.DevopsService.Models.CreateLoadBalancerTrafficShiftDeployStageDetails>, <Oci.DevopsService.Models.CreateComputeInstanceGroupDeployStageDetails>, <Oci.DevopsService.Models.CreateInvokeFunctionDeployStageDetails>, <Oci.DevopsService.Models.CreateFunctionDeployStageDetails> of type <Oci.DevopsService.Models.CreateDeployStageDetails>.")]
