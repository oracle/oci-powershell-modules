...
{
    [Cmdlet("Get", "OCIDisasterrecoveryWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DisasterrecoveryService.Models.WorkRequest), typeof(Oci.DisasterrecoveryService.Responses.GetWorkRequestResponse) })]
    public class GetOCIDisasterrecoveryWorkRequest : OCIDisasterRecoveryCmdlet
    {
...
Example: `ocid1.workrequest.oc1..uniqueID`", ParameterSetName = Default)]
        ...
        public Oci.DisasterrecoveryService.Models.OperationStatus[] WaitForStatus { get; set; }
