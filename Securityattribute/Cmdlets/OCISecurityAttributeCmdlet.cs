...
{
    public abstract class OCISecurityAttributeCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new SecurityAttributeClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected SecurityAttributeClient client;
