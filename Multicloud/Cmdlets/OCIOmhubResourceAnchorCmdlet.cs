...
{
    public abstract class OCIOmhubResourceAnchorCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OmhubResourceAnchorClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OmhubResourceAnchorClient client;
