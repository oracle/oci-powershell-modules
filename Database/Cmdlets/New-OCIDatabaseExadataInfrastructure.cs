...
{
    [Cmdlet("New", "OCIDatabaseExadataInfrastructure", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.ExadataInfrastructure), typeof(Oci.DatabaseService.Responses.CreateExadataInfrastructureResponse) })]
    public class NewOCIDatabaseExadataInfrastructure : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateExadataInfrastructureRequest
                {
        ...
        private void HandleOutput(CreateExadataInfrastructureRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForCreateExadataInfrastructure(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.CreateExadataInfrastructure(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.ExadataInfrastructure);
        }

        private CreateExadataInfrastructureResponse response;
