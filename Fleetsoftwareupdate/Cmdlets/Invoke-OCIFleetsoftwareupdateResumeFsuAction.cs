...
{
    [Cmdlet("Invoke", "OCIFleetsoftwareupdateResumeFsuAction")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.FleetsoftwareupdateService.Responses.ResumeFsuActionResponse) })]
    public class InvokeOCIFleetsoftwareupdateResumeFsuAction : OCIFleetSoftwareUpdateCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ResumeFsuActionRequest
                {
                ...
                response = client.ResumeFsuAction(request).GetAwaiter().GetResult();
        ...
        private ResumeFsuActionResponse response;
    }
}
