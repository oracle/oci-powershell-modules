...
namespace Oci.CoreService.Cmdlets
{
    ...
    public class RemoveOCIVirtualNetworkByoipRange : OCIVirtualNetworkCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the Byoip Range object.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the Byoip Range object.", ParameterSetName = Default)]
