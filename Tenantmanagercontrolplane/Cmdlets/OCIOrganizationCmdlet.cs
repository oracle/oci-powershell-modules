...
{
    public abstract class OCIOrganizationCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OrganizationClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OrganizationClient client;
