...
using Oci.AidataplatformService;

namespace Oci.AidataplatformService.Cmdlets
{
    public abstract class OCIAiDataPlatformCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AiDataPlatformClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AiDataPlatformClient client;
