...
{
    [Cmdlet("Get", "OCILockboxAccessRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.LockboxService.Models.AccessRequestCollection), typeof(Oci.LockboxService.Responses.ListAccessRequestsResponse) })]
    public class GetOCILockboxAccessRequestsList : OCILockboxCmdlet
    {
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The client request ID for tracing.")]
        public string OpcRequestId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique identifier (OCID) of the associated lockbox.")]
