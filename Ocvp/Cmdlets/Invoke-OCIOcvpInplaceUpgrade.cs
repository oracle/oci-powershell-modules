...
{
    [Cmdlet("Invoke", "OCIOcvpInplaceUpgrade")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OcvpService.Responses.InplaceUpgradeResponse) })]
    public class InvokeOCIOcvpInplaceUpgrade : OCIEsxiHostCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.InplaceUpgrade(request).GetAwaiter().GetResult();
        ...
        private InplaceUpgradeResponse response;
    }
}
