...
{
    [Cmdlet("Write", "OCIDatacatalogCredentials")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Connection), typeof(Oci.DatacatalogService.Responses.UploadCredentialsResponse) })]
    public class WriteOCIDatacatalogCredentials : OCIDataCatalogCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information used to upload the credentials file and metadata for updating this connection.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UploadCredentialsRequest
                {
                    CatalogId = CatalogId,
                ...
                response = client.UploadCredentials(request).GetAwaiter().GetResult();
        ...
        private UploadCredentialsResponse response;
    }
}
