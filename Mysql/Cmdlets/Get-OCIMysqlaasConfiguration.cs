...
{
    [Cmdlet("Get", "OCIMysqlaasConfiguration", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.MysqlService.Models.Configuration), typeof(Oci.MysqlService.Responses.GetConfigurationResponse) })]
    public class GetOCIMysqlaasConfiguration : OCIMysqlaasCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the Configuration.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the Configuration.", ParameterSetName = Default)]
        ...
        public Oci.MysqlService.Models.Configuration.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
