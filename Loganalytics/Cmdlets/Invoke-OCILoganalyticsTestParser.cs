...
namespace Oci.LoganalyticsService.Cmdlets
{
    ...
    public class InvokeOCILoganalyticsTestParser : OCILogAnalyticsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The scope used when testing a parser.")]
        public System.Nullable<Oci.LoganalyticsService.Requests.TestParserRequest.ScopeEnum> Scope { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The module to test.  A value of 'ParserFunctionTest' will result in testing of the parser functions.")]
