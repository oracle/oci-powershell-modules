...
{
    [Cmdlet("Update", "OCIWaasDeviceFingerprintChallenge")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdateDeviceFingerprintChallengeResponse) })]
    public class UpdateOCIWaasDeviceFingerprintChallenge : OCIWaasCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The device fingerprint challenge settings to be updated.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDeviceFingerprintChallengeRequest
                {
                ...
                response = client.UpdateDeviceFingerprintChallenge(request).GetAwaiter().GetResult();
        ...
        private UpdateDeviceFingerprintChallengeResponse response;
    }
}
