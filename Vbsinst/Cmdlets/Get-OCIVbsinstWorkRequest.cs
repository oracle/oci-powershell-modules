...
{
    [Cmdlet("Get", "OCIVbsinstWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.VbsinstService.Models.WorkRequest), typeof(Oci.VbsinstService.Responses.GetWorkRequestResponse) })]
    public class GetOCIVbsinstWorkRequest : OCIVbsInstanceCmdlet
    {
        ...
        public Oci.VbsinstService.Models.OperationStatus[] WaitForStatus { get; set; }
