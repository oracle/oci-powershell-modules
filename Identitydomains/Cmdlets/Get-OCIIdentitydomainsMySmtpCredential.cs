...
{
    [Cmdlet("Get", "OCIIdentitydomainsMySmtpCredential")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MySmtpCredential), typeof(Oci.IdentitydomainsService.Responses.GetMySmtpCredentialResponse) })]
    public class GetOCIIdentitydomainsMySmtpCredential : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMySmtpCredentialRequest
                {
                ...
                response = client.GetMySmtpCredential(request).GetAwaiter().GetResult();
        ...
        private GetMySmtpCredentialResponse response;
    }
}
