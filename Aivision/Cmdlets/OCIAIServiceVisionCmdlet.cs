...
{
    public abstract class OCIAIServiceVisionCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AIServiceVisionClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AIServiceVisionClient client;
