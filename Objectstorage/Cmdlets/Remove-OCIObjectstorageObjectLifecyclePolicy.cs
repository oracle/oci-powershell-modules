...
{
    [Cmdlet("Remove", "OCIObjectstorageObjectLifecyclePolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ObjectstorageService.Responses.DeleteObjectLifecyclePolicyResponse) })]
    public class RemoveOCIObjectstorageObjectLifecyclePolicy : OCIObjectStorageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIObjectstorageObjectLifecyclePolicy", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteObjectLifecyclePolicyRequest
                {
                ...
                response = client.DeleteObjectLifecyclePolicy(request).GetAwaiter().GetResult();
        ...
        private DeleteObjectLifecyclePolicyResponse response;
    }
}
