...
using Oci.ApplicationmigrationService;

namespace Oci.ApplicationmigrationService.Cmdlets
{
    public abstract class OCIApplicationMigrationCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            base.ProcessRecord();
            client?.Dispose();
            client = new ApplicationMigrationClient(AuthProvider, new Oci.Common.ClientConfiguration
            {
        ...
        protected ApplicationMigrationClient client;
