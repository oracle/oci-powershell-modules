...
{
    [Cmdlet("Update", "OCIWaasProtectionRules")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdateProtectionRulesResponse) })]
    public class UpdateOCIWaasProtectionRules : OCIWaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateProtectionRulesRequest
                {
                ...
                response = client.UpdateProtectionRules(request).GetAwaiter().GetResult();
        ...
        private UpdateProtectionRulesResponse response;
    }
}
