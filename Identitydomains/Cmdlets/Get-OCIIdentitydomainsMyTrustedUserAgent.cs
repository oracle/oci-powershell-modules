...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyTrustedUserAgent")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyTrustedUserAgent), typeof(Oci.IdentitydomainsService.Responses.GetMyTrustedUserAgentResponse) })]
    public class GetOCIIdentitydomainsMyTrustedUserAgent : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMyTrustedUserAgentRequest
                {
                ...
                response = client.GetMyTrustedUserAgent(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MyTrustedUserAgent);
        ...
        private GetMyTrustedUserAgentResponse response;
    }
}
