...
{
    [Cmdlet("Get", "OCIIdentitydomainsIdentityPropagationTrust")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.IdentityPropagationTrust), typeof(Oci.IdentitydomainsService.Responses.GetIdentityPropagationTrustResponse) })]
    public class GetOCIIdentitydomainsIdentityPropagationTrust : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetIdentityPropagationTrustRequest
                {
                ...
                response = client.GetIdentityPropagationTrust(request).GetAwaiter().GetResult();
        ...
        private GetIdentityPropagationTrustResponse response;
    }
}
