...
{
    public abstract class OCIDataSafeCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DataSafeClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DataSafeClient client;
