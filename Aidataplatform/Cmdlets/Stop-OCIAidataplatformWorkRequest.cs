...
{
    [Cmdlet("Stop", "OCIAidataplatformWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AidataplatformService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIAidataplatformWorkRequest : OCIAiDataPlatformCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAidataplatformWorkRequest", "Stop"))
            {
               return;
            }
