...
{
    [Cmdlet("Invoke", "OCIVirtualNetworkBulkDeleteIpv6s", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.BulkDeleteIpv6sResponse) })]
    public class InvokeOCIVirtualNetworkBulkDeleteIpv6s : OCIVirtualNetworkCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new BulkDeleteIpv6sRequest
                {
        ...
        private void HandleOutput(BulkDeleteIpv6sRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForBulkDeleteIpv6s(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.BulkDeleteIpv6s(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private BulkDeleteIpv6sResponse response;
