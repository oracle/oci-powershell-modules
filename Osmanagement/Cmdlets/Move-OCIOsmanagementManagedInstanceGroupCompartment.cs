...
{
    [Cmdlet("Move", "OCIOsmanagementManagedInstanceGroupCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OsmanagementService.Responses.ChangeManagedInstanceGroupCompartmentResponse) })]
    public class MoveOCIOsmanagementManagedInstanceGroupCompartment : OCIOsManagementCmdlet
    {
