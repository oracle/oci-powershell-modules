...
{
    [Cmdlet("Remove", "OCIGenerativeaiModel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GenerativeaiService.Responses.DeleteModelResponse) })]
    public class RemoveOCIGenerativeaiModel : OCIGenerativeAiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIGenerativeaiModel", "Remove"))
            {
               return;
            }
