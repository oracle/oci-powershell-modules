...
using Oci.ManagedkafkaService;

namespace Oci.ManagedkafkaService.Cmdlets
{
    public abstract class OCIKafkaClusterCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new KafkaClusterClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected KafkaClusterClient client;
