...
{
    [Cmdlet("Remove", "OCINetworkfirewallUrlList", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.NetworkfirewallService.Responses.DeleteUrlListResponse) })]
    public class RemoveOCINetworkfirewallUrlList : OCINetworkFirewallCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCINetworkfirewallUrlList", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteUrlList(request).GetAwaiter().GetResult();
        ...
        private DeleteUrlListResponse response;
    }
}
