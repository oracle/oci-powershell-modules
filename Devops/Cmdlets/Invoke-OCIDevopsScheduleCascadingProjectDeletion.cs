...
{
    [Cmdlet("Invoke", "OCIDevopsScheduleCascadingProjectDeletion")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DevopsService.Responses.ScheduleCascadingProjectDeletionResponse) })]
    public class InvokeOCIDevopsScheduleCascadingProjectDeletion : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ScheduleCascadingProjectDeletionRequest
                {
                    ProjectId = ProjectId,
                    IfMatch = IfMatch,
                ...
                response = client.ScheduleCascadingProjectDeletion(request).GetAwaiter().GetResult();
        ...
        private ScheduleCascadingProjectDeletionResponse response;
    }
}
