...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchPolicies")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Policies), typeof(Oci.IdentitydomainsService.Responses.SearchPoliciesResponse) })]
    public class InvokeOCIIdentitydomainsSearchPolicies : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching Policies")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchPoliciesRequest
                {
                ...
                response = client.SearchPolicies(request).GetAwaiter().GetResult();
                WriteOutput(response, response.Policies);
        ...
        private SearchPoliciesResponse response;
    }
}
