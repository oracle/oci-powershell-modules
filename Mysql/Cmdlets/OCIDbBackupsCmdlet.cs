...
{
    public abstract class OCIDbBackupsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DbBackupsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DbBackupsClient client;
