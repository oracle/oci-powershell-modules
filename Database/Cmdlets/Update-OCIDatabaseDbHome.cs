...
{
    [Cmdlet("Update", "OCIDatabaseDbHome", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.DbHome), typeof(Oci.DatabaseService.Responses.UpdateDbHomeResponse) })]
    public class UpdateOCIDatabaseDbHome : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDbHomeRequest
                {
                    DbHomeId = DbHomeId,
        ...
        private void HandleOutput(UpdateDbHomeRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateDbHome(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpdateDbHome(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.DbHome);
        }

        private UpdateDbHomeResponse response;
