...
{
    [Cmdlet("Remove", "OCIFunctionsManagementApplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.FunctionsService.Responses.DeleteApplicationResponse) })]
    public class RemoveOCIFunctionsManagementApplication : OCIFunctionsManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIFunctionsManagementApplication", "Remove"))
            {
               return;
            }
