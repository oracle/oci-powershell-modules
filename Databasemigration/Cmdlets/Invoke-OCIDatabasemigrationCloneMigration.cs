...
{
    [Cmdlet("Invoke", "OCIDatabasemigrationCloneMigration")]
    ...
    public class InvokeOCIDatabasemigrationCloneMigration : OCIDatabaseMigrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Clone Migration properties. This parameter also accepts subtypes <Oci.DatabasemigrationService.Models.OracleCloneMigrationDetails>, <Oci.DatabasemigrationService.Models.MySqlCloneMigrationDetails> of type <Oci.DatabasemigrationService.Models.CloneMigrationDetails>.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CloneMigrationRequest
                {
                ...
                response = client.CloneMigration(request).GetAwaiter().GetResult();
        ...
        private CloneMigrationResponse response;
    }
}
