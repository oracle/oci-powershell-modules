...
{
    [Cmdlet("Move", "OCIIotDomainCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.IotService.Responses.ChangeIotDomainCompartmentResponse) })]
    public class MoveOCIIotDomainCompartment : OCIIotCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for changing the IoT domain compartment.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeIotDomainCompartmentRequest
                {
                ...
                response = client.ChangeIotDomainCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeIotDomainCompartmentResponse response;
    }
}
