...
{
    [Cmdlet("Remove", "OCIZprPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ZprService.Responses.DeleteZprPolicyResponse) })]
    public class RemoveOCIZprPolicy : OCIZprCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ZprPolicy.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIZprPolicy", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteZprPolicyRequest
                {
                ...
                response = client.DeleteZprPolicy(request).GetAwaiter().GetResult();
        ...
        private DeleteZprPolicyResponse response;
    }
}
