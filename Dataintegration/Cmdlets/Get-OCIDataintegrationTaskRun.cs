...
{
    [Cmdlet("Get", "OCIDataintegrationTaskRun")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.TaskRun), typeof(Oci.DataintegrationService.Responses.GetTaskRunResponse) })]
    public class GetOCIDataintegrationTaskRun : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GetTaskRun(request).GetAwaiter().GetResult();
        ...
        private GetTaskRunResponse response;
    }
}
