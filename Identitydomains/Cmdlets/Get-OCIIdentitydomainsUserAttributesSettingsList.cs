...
{
    [Cmdlet("Get", "OCIIdentitydomainsUserAttributesSettingsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.UserAttributesSettings), typeof(Oci.IdentitydomainsService.Responses.ListUserAttributesSettingsResponse) })]
    public class GetOCIIdentitydomainsUserAttributesSettingsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListUserAttributesSettingsRequest
                {
                ...
                response = client.ListUserAttributesSettings(request).GetAwaiter().GetResult();
        ...
        private ListUserAttributesSettingsResponse response;
    }
}
