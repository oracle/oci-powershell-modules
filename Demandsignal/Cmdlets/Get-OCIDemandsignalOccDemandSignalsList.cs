...
{
    [Cmdlet("Get", "OCIDemandsignalOccDemandSignalsList")]
    [OutputType(new System.Type[] { typeof(Oci.DemandsignalService.Models.OccDemandSignalCollection), typeof(Oci.DemandsignalService.Responses.ListOccDemandSignalsResponse) })]
    public class GetOCIDemandsignalOccDemandSignalsList : OCIOccDemandSignalCmdlet
    {
        ...
        public System.Nullable<Oci.DemandsignalService.Models.OccDemandSignal.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the OccDemandSignal.")]
        ...
        public System.Nullable<Oci.DemandsignalService.Requests.ListOccDemandSignalsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListOccDemandSignalsRequest
                {
                ...
                IEnumerable<ListOccDemandSignalsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.OccDemandSignalCollection, true);
                }
        ...
        {
            IEnumerable<ListOccDemandSignalsResponse> DefaultRequest(ListOccDemandSignalsRequest request) => Enumerable.Repeat(client.ListOccDemandSignals(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListOccDemandSignalsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListOccDemandSignalsResponse response;
        private delegate IEnumerable<ListOccDemandSignalsResponse> RequestDelegate(ListOccDemandSignalsRequest request);
