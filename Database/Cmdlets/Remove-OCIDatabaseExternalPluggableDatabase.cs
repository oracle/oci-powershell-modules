...
{
    [Cmdlet("Remove", "OCIDatabaseExternalPluggableDatabase", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteExternalPluggableDatabaseResponse) })]
    public class RemoveOCIDatabaseExternalPluggableDatabase : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseExternalPluggableDatabase", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteExternalPluggableDatabaseRequest
                {
        ...
        private void HandleOutput(DeleteExternalPluggableDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteExternalPluggableDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteExternalPluggableDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteExternalPluggableDatabaseResponse response;
