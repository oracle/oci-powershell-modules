...
{
    [Cmdlet("Start", "OCIContainerenginePublicApiEndpointDecommission")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ContainerengineService.Responses.StartPublicApiEndpointDecommissionResponse) })]
    public class StartOCIContainerenginePublicApiEndpointDecommission : OCIContainerEngineCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartPublicApiEndpointDecommissionRequest
                {
                    ClusterId = ClusterId,
                ...
                response = client.StartPublicApiEndpointDecommission(request).GetAwaiter().GetResult();
        ...
        private StartPublicApiEndpointDecommissionResponse response;
    }
}
