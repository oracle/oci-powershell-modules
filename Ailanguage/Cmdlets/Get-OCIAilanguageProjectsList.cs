...
{
    [Cmdlet("Get", "OCIAilanguageProjectsList")]
    [OutputType(new System.Type[] { typeof(Oci.AilanguageService.Models.ProjectCollection), typeof(Oci.AilanguageService.Responses.ListProjectsResponse) })]
    public class GetOCIAilanguageProjectsList : OCIAIServiceLanguageCmdlet
    {
        ...
        public System.Nullable<Oci.AilanguageService.Models.Project.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.AilanguageService.Requests.ListProjectsRequest.SortByEnum> SortBy { get; set; }
