...
{
    [Cmdlet("Remove", "OCIJmsutilsPerformanceTuningAnalysis", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCIJmsutilsPerformanceTuningAnalysis : OCIJmsUtilsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIJmsutilsPerformanceTuningAnalysis", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeletePerformanceTuningAnalysisRequest
                {
                ...
                response = client.DeletePerformanceTuningAnalysis(request).GetAwaiter().GetResult();
        ...
        private DeletePerformanceTuningAnalysisResponse response;
    }
}
