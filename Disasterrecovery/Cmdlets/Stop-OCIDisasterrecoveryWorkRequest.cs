...
{
    [Cmdlet("Stop", "OCIDisasterrecoveryWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DisasterrecoveryService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIDisasterrecoveryWorkRequest : OCIDisasterRecoveryCmdlet
    {
...
Example: `ocid1.workrequest.oc1.phx.exampleocid`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDisasterrecoveryWorkRequest", "Stop"))
            {
               return;
            }
