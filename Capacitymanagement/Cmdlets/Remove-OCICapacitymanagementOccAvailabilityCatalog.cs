...
{
    [Cmdlet("Remove", "OCICapacitymanagementOccAvailabilityCatalog", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CapacitymanagementService.Responses.DeleteOccAvailabilityCatalogResponse) })]
    public class RemoveOCICapacitymanagementOccAvailabilityCatalog : OCICapacityManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCICapacitymanagementOccAvailabilityCatalog", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteOccAvailabilityCatalogRequest
                {
                ...
                response = client.DeleteOccAvailabilityCatalog(request).GetAwaiter().GetResult();
        ...
        private DeleteOccAvailabilityCatalogResponse response;
    }
}
