...
{
    public abstract class OCIReplicasCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ReplicasClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ReplicasClient client;
