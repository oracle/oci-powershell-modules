...
{
    [Cmdlet("Add", "OCIVirtualNetworkIpv4SubnetCidr", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.AddIpv4SubnetCidrResponse) })]
    public class AddOCIVirtualNetworkIpv4SubnetCidr : OCIVirtualNetworkCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details object for adding an IPv4 prefix to a subnet.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details object for adding an IPv4 prefix to a subnet.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddIpv4SubnetCidrRequest
                {
                    SubnetId = SubnetId,
        ...
        private void HandleOutput(AddIpv4SubnetCidrRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForAddIpv4SubnetCidr(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.AddIpv4SubnetCidr(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private AddIpv4SubnetCidrResponse response;
