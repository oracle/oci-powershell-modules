...
{
    [Cmdlet("Update", "OCICapacitymanagementInternalOccCapacityRequest")]
    [OutputType(new System.Type[] { typeof(Oci.CapacitymanagementService.Models.OccCapacityRequest), typeof(Oci.CapacitymanagementService.Responses.UpdateInternalOccCapacityRequestResponse) })]
    public class UpdateOCICapacitymanagementInternalOccCapacityRequest : OCICapacityManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateInternalOccCapacityRequestRequest
                {
                ...
                response = client.UpdateInternalOccCapacityRequest(request).GetAwaiter().GetResult();
        ...
        private UpdateInternalOccCapacityRequestResponse response;
    }
}
