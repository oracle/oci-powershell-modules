...
{
    [Cmdlet("Get", "OCIRoverWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.RoverService.Models.WorkRequest), typeof(Oci.RoverService.Responses.GetWorkRequestResponse) })]
    public class GetOCIRoverWorkRequest : OCIWorkRequestsCmdlet
    {
        ...
        public Oci.RoverService.Models.WorkRequestOperationStatus[] WaitForStatus { get; set; }
