...
{
    [Cmdlet("Invoke", "OCIDbmulticloudRefreshOracleDbAzureConnector")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DbmulticloudService.Responses.RefreshOracleDbAzureConnectorResponse) })]
    public class InvokeOCIDbmulticloudRefreshOracleDbAzureConnector : OCIOracleDBAzureConnectorCmdlet
    {
...
For example, if a resource has been deleted and permanently purged from the system, a retry of the original creation request may be rejected.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RefreshOracleDbAzureConnectorRequest
                {
                ...
                response = client.RefreshOracleDbAzureConnector(request).GetAwaiter().GetResult();
        ...
        private RefreshOracleDbAzureConnectorResponse response;
    }
}
