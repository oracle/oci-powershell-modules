...
{
    [Cmdlet("Invoke", "OCIDatabaseCheckExternalDatabaseConnectorConnectionStatus", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.CheckExternalDatabaseConnectorConnectionStatusResponse) })]
    public class InvokeOCIDatabaseCheckExternalDatabaseConnectorConnectionStatus : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CheckExternalDatabaseConnectorConnectionStatusRequest
                {
        ...
        private void HandleOutput(CheckExternalDatabaseConnectorConnectionStatusRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForCheckExternalDatabaseConnectorConnectionStatus(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.CheckExternalDatabaseConnectorConnectionStatus(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private CheckExternalDatabaseConnectorConnectionStatusResponse response;
