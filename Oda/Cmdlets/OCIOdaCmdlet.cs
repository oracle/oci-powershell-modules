...
{
    public abstract class OCIOdaCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OdaClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
