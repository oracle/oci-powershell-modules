...
{
    [Cmdlet("Remove", "OCIGenerativeaiDedicatedAiCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GenerativeaiService.Responses.DeleteDedicatedAiClusterResponse) })]
    public class RemoveOCIGenerativeaiDedicatedAiCluster : OCIGenerativeAiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIGenerativeaiDedicatedAiCluster", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDedicatedAiClusterRequest
                {
                ...
                response = client.DeleteDedicatedAiCluster(request).GetAwaiter().GetResult();
        ...
        private DeleteDedicatedAiClusterResponse response;
    }
}
