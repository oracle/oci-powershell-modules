...
{
    [Cmdlet("Remove", "OCIDatabaseExecutionAction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteExecutionActionResponse) })]
    public class RemoveOCIDatabaseExecutionAction : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseExecutionAction", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteExecutionActionRequest
                {
        ...
        private void HandleOutput(DeleteExecutionActionRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteExecutionAction(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteExecutionAction(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteExecutionActionResponse response;
