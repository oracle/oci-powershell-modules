...
{
    [Cmdlet("New", "OCIDevopsPullRequest")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.PullRequest), typeof(Oci.DevopsService.Responses.CreatePullRequestResponse) })]
    public class NewOCIDevopsPullRequest : OCIDevopsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new PullRequest.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CreatePullRequest(request).GetAwaiter().GetResult();
        ...
        private CreatePullRequestResponse response;
    }
}
