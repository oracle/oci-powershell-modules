...
{
    [Cmdlet("Write", "OCIKeymanagementPartitionCertificates")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.KeymanagementService.Responses.UploadPartitionCertificatesResponse) })]
    public class WriteOCIKeymanagementPartitionCertificates : OCIKmsHsmClusterCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"To upload partition certificates.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UploadPartitionCertificatesRequest
                {
                ...
                response = client.UploadPartitionCertificates(request).GetAwaiter().GetResult();
        ...
        private UploadPartitionCertificatesResponse response;
    }
}
