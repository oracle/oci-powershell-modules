...
{
    [Cmdlet("Remove", "OCIIdentitydomainsPasswordPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeletePasswordPolicyResponse) })]
    public class RemoveOCIIdentitydomainsPasswordPolicy : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsPasswordPolicy", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeletePasswordPolicyRequest
                {
                ...
                response = client.DeletePasswordPolicy(request).GetAwaiter().GetResult();
        ...
        private DeletePasswordPolicyResponse response;
    }
}
