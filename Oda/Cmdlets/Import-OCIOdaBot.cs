...
{
    [Cmdlet("Import", "OCIOdaBot")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OdaService.Responses.ImportBotResponse) })]
    public class ImportOCIOdaBot : OCIManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Properties for where in Object Storage to import the Bot archive from.")]
...
Retry tokens expire after 24 hours, but they can become invalid before then if there are conflicting operations. For example, if an instance was deleted and purged from the system, then the service might reject a retry of the original creation request.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ImportBot(request).GetAwaiter().GetResult();
        ...
        private ImportBotResponse response;
    }
}
