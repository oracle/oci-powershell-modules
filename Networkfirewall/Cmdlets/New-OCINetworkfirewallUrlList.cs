...
{
    [Cmdlet("New", "OCINetworkfirewallUrlList")]
    [OutputType(new System.Type[] { typeof(Oci.NetworkfirewallService.Models.UrlList), typeof(Oci.NetworkfirewallService.Responses.CreateUrlListResponse) })]
    public class NewOCINetworkfirewallUrlList : OCINetworkFirewallCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CreateUrlList(request).GetAwaiter().GetResult();
        ...
        private CreateUrlListResponse response;
    }
}
