...
{
    [Cmdlet("Update", "OCIAidocumentModel")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AidocumentService.Responses.UpdateModelResponse) })]
    public class UpdateOCIAidocumentModel : OCIAIServiceDocumentCmdlet
    {
