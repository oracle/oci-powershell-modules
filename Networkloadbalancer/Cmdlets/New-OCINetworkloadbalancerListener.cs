...
{
    [Cmdlet("New", "OCINetworkloadbalancerListener")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NetworkloadbalancerService.Responses.CreateListenerResponse) })]
    public class NewOCINetworkloadbalancerListener : OCINetworkLoadBalancerCmdlet
    {
