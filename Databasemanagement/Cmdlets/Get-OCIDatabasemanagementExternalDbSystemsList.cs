...
{
    [Cmdlet("Get", "OCIDatabasemanagementExternalDbSystemsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.ExternalDbSystemCollection), typeof(Oci.DatabasemanagementService.Responses.ListExternalDbSystemsResponse) })]
    public class GetOCIDatabasemanagementExternalDbSystemsList : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListExternalDbSystemsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListExternalDbSystemsRequest
                {
                ...
                IEnumerable<ListExternalDbSystemsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.ExternalDbSystemCollection, true);
                }
        ...
        {
            IEnumerable<ListExternalDbSystemsResponse> DefaultRequest(ListExternalDbSystemsRequest request) => Enumerable.Repeat(client.ListExternalDbSystems(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListExternalDbSystemsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListExternalDbSystemsResponse response;
        private delegate IEnumerable<ListExternalDbSystemsResponse> RequestDelegate(ListExternalDbSystemsRequest request);
