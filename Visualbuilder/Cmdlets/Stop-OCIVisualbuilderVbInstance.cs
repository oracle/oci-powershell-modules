...
{
    [Cmdlet("Stop", "OCIVisualbuilderVbInstance")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.VisualbuilderService.Responses.StopVbInstanceResponse) })]
    public class StopOCIVisualbuilderVbInstance : OCIVbInstanceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StopVbInstanceRequest
                {
                ...
                response = client.StopVbInstance(request).GetAwaiter().GetResult();
        ...
        private StopVbInstanceResponse response;
    }
}
