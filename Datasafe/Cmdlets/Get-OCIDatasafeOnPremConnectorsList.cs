...
{
    [Cmdlet("Get", "OCIDatasafeOnPremConnectorsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.OnPremConnectorSummary), typeof(Oci.DatasafeService.Responses.ListOnPremConnectorsResponse) })]
    public class GetOCIDatasafeOnPremConnectorsList : OCIDataSafeCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only the on-premises connector that matches the specified id.")]
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListOnPremConnectorsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListOnPremConnectorsRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListOnPremConnectorsRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListOnPremConnectorsRequest
                {
                ...
                IEnumerable<ListOnPremConnectorsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListOnPremConnectorsResponse> DefaultRequest(ListOnPremConnectorsRequest request) => Enumerable.Repeat(client.ListOnPremConnectors(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListOnPremConnectorsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListOnPremConnectorsResponse response;
        private delegate IEnumerable<ListOnPremConnectorsResponse> RequestDelegate(ListOnPremConnectorsRequest request);
