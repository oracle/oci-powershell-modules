...
{
    [Cmdlet("Update", "OCIDatasafePrivateEndpoint")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatasafeService.Responses.UpdateDataSafePrivateEndpointResponse) })]
    public class UpdateOCIDatasafePrivateEndpoint : OCIDataSafeCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details used to update a Data Safe private endpoint.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDataSafePrivateEndpointRequest
                {
        ...
        private UpdateDataSafePrivateEndpointResponse response;
    }
}
