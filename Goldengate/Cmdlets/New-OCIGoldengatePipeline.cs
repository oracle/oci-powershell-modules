...
{
    [Cmdlet("New", "OCIGoldengatePipeline")]
    [OutputType(new System.Type[] { typeof(Oci.GoldengateService.Models.Pipeline), typeof(Oci.GoldengateService.Responses.CreatePipelineResponse) })]
    public class NewOCIGoldengatePipeline : OCIGoldenGateCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specification of the pipeline to create. This parameter also accepts subtype <Oci.GoldengateService.Models.CreateZeroEtlPipelineDetails> of type <Oci.GoldengateService.Models.CreatePipelineDetails>.")]
        ...
        private CreatePipelineResponse response;
    }
}
