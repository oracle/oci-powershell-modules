...
{
    [Cmdlet("Get", "OCIWlmsWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.WlmsService.Models.WorkRequestLogEntryCollection), typeof(Oci.WlmsService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIWlmsWorkRequestLogsList : OCIWeblogicManagementServiceCmdlet
    {
        ...
        public System.Nullable<Oci.WlmsService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order is either 'ASC' or 'DESC'.")]
        public System.Nullable<Oci.WlmsService.Requests.ListWorkRequestLogsRequest.SortOrderEnum> SortOrder { get; set; }
