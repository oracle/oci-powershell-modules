...
{
    [Cmdlet("Start", "OCIGoldengateDeployment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.StartDeploymentResponse) })]
    public class StartOCIGoldengateDeployment : OCIGoldenGateCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A unique Deployment identifier.")]
        public string DeploymentId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A placeholder for any additional metadata to describe the deployment start. This parameter also accepts subtype <Oci.GoldengateService.Models.DefaultStartDeploymentDetails> of type <Oci.GoldengateService.Models.StartDeploymentDetails>.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.StartDeployment(request).GetAwaiter().GetResult();
        ...
        private StartDeploymentResponse response;
    }
}
