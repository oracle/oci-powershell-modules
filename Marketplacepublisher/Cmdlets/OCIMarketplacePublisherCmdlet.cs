...
using Oci.MarketplacepublisherService;

namespace Oci.MarketplacepublisherService.Cmdlets
{
    public abstract class OCIMarketplacePublisherCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MarketplacePublisherClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MarketplacePublisherClient client;
