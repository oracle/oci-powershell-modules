...
{
    public abstract class OCIOracleDbAzureVaultCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OracleDbAzureVaultClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OracleDbAzureVaultClient client;
