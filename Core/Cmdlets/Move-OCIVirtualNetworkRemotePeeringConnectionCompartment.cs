...
{
    [Cmdlet("Move", "OCIVirtualNetworkRemotePeeringConnectionCompartment")]
    ...
    public class MoveOCIVirtualNetworkRemotePeeringConnectionCompartment : OCIVirtualNetworkCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeRemotePeeringConnectionCompartmentRequest
                {
                ...
                response = client.ChangeRemotePeeringConnectionCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeRemotePeeringConnectionCompartmentResponse response;
    }
}
