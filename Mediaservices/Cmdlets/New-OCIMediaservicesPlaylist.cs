...
namespace Oci.MediaservicesService.Cmdlets
{
     ...
     */
    [Cmdlet("New", "OCIMediaservicesPlaylist", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.MediaservicesService.Responses.GeneratePlaylistResponse) })]
    public class NewOCIMediaservicesPlaylist : OCIMediaStreamCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique Stream Packaging Configuration identifier.")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Streaming session authentication token.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GeneratePlaylistRequest
                {
                ...
                response = client.GeneratePlaylist(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GeneratePlaylistResponse response;
