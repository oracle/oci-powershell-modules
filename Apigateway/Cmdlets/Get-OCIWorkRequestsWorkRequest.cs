...
namespace Oci.ApigatewayService.Cmdlets
{
    ...
    [OutputType(new System.Type[] { typeof(Oci.ApigatewayService.Models.WorkRequest), typeof(Oci.ApigatewayService.Responses.GetWorkRequestResponse) })]
    public class GetOCIWorkRequestsWorkRequest : OCIWorkRequestsCmdlet
    {
        ...
        public Oci.ApigatewayService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
