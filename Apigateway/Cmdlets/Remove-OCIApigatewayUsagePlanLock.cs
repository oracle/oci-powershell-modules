...
{
    [Cmdlet("Remove", "OCIApigatewayUsagePlanLock")]
    [OutputType(new System.Type[] { typeof(Oci.ApigatewayService.Models.UsagePlan), typeof(Oci.ApigatewayService.Responses.RemoveUsagePlanLockResponse) })]
    public class RemoveOCIApigatewayUsagePlanLock : OCIUsagePlansCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveUsagePlanLockRequest
                {
                ...
                response = client.RemoveUsagePlanLock(request).GetAwaiter().GetResult();
        ...
        private RemoveUsagePlanLockResponse response;
    }
}
