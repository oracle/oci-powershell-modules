...
{
    [Cmdlet("Get", "OCIDistributeddatabaseWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DistributeddatabaseService.Models.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.GetWorkRequestResponse) })]
    public class GetOCIDistributeddatabaseWorkRequest : OCIDistributedDbWorkRequestServiceCmdlet
    {
        ...
        public Oci.DistributeddatabaseService.Models.OperationStatus[] WaitForStatus { get; set; }
