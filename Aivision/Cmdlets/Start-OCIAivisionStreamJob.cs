...
{
    [Cmdlet("Start", "OCIAivisionStreamJob")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AivisionService.Responses.StartStreamJobResponse) })]
    public class StartOCIAivisionStreamJob : OCIAIServiceVisionCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartStreamJobRequest
                {
                ...
                response = client.StartStreamJob(request).GetAwaiter().GetResult();
        ...
        private StartStreamJobResponse response;
    }
}
