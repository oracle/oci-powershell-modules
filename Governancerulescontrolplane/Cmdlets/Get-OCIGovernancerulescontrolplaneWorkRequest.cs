...
{
    [Cmdlet("Get", "OCIGovernancerulescontrolplaneWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.GovernancerulescontrolplaneService.Models.WorkRequest), typeof(Oci.GovernancerulescontrolplaneService.Responses.GetWorkRequestResponse) })]
    public class GetOCIGovernancerulescontrolplaneWorkRequest : OCIWorkRequestCmdlet
    {
        ...
        public Oci.GovernancerulescontrolplaneService.Models.OperationStatus[] WaitForStatus { get; set; }
