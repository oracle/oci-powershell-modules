...
{
    [Cmdlet("Get", "OCIIdentitydomainsUsersList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Users), typeof(Oci.IdentitydomainsService.Responses.ListUsersResponse) })]
    public class GetOCIIdentitydomainsUsersList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ListUsers(request).GetAwaiter().GetResult();
