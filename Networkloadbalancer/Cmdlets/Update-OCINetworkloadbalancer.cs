...
{
    [Cmdlet("Update", "OCINetworkloadbalancer")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NetworkloadbalancerService.Responses.UpdateNetworkLoadBalancerResponse) })]
    public class UpdateOCINetworkloadbalancer : OCINetworkLoadBalancerCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateNetworkLoadBalancerRequest
                {
                ...
                response = client.UpdateNetworkLoadBalancer(request).GetAwaiter().GetResult();
        ...
        private UpdateNetworkLoadBalancerResponse response;
    }
}
