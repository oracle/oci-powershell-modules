...
{
    [Cmdlet("Get", "OCIGenerativeaiagentWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiagentService.Models.WorkRequest), typeof(Oci.GenerativeaiagentService.Responses.GetWorkRequestResponse) })]
    public class GetOCIGenerativeaiagentWorkRequest : OCIGenerativeAiAgentCmdlet
    {
        ...
        public Oci.GenerativeaiagentService.Models.OperationStatus[] WaitForStatus { get; set; }
