...
{
    [Cmdlet("New", "OCINosqlReplica")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NosqlService.Responses.CreateReplicaResponse) })]
    public class NewOCINosqlReplica : OCINosqlCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifications for the new replica")]
