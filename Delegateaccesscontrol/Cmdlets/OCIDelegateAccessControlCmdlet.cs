...
using Oci.DelegateaccesscontrolService;

namespace Oci.DelegateaccesscontrolService.Cmdlets
{
    public abstract class OCIDelegateAccessControlCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DelegateAccessControlClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DelegateAccessControlClient client;
