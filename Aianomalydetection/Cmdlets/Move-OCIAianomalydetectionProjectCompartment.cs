...
{
    [Cmdlet("Move", "OCIAianomalydetectionProjectCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AianomalydetectionService.Responses.ChangeProjectCompartmentResponse) })]
    public class MoveOCIAianomalydetectionProjectCompartment : OCIAnomalyDetectionCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the Project.")]
        public string ProjectId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details to change the compartment of the project.")]
