...
GUID = 'db2be13c-96b7-4eca-b2f4-813938178f5b'
...
CmdletsToExport = 'Get-OCIDataFlowApplication', 'Get-OCIDataFlowApplicationsList', 
               'Get-OCIDataFlowRun', 'Get-OCIDataFlowRunLog', 
               'Get-OCIDataFlowRunLogsList', 'Get-OCIDataFlowRunsList', 
               'Move-OCIDataFlowApplicationCompartment', 
               'Move-OCIDataFlowRunCompartment', 'New-OCIDataFlowApplication', 
               'New-OCIDataFlowRun', 'Remove-OCIDataFlowApplication', 
               'Remove-OCIDataFlowRun', 'Update-OCIDataFlowApplication', 
