...
{
    [Cmdlet("Remove", "OCIMysqlAnalyticsCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.DeleteAnalyticsClusterResponse) })]
    public class RemoveOCIMysqlAnalyticsCluster : OCIDbSystemCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIMysqlAnalyticsCluster", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteAnalyticsClusterRequest
                {
                ...
                response = client.DeleteAnalyticsCluster(request).GetAwaiter().GetResult();
        ...
        private DeleteAnalyticsClusterResponse response;
    }
}
