...
{
    [Cmdlet("Remove", "OCIManagementagentWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ManagementagentService.Responses.DeleteWorkRequestResponse) })]
    public class RemoveOCIManagementagentWorkRequest : OCIManagementAgentCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIManagementagentWorkRequest", "Remove"))
            {
               return;
            }
