...
{
    [Cmdlet("Update", "OCIDnsResolverEndpoint")]
    ...
    public class UpdateOCIDnsResolverEndpoint : OCIDnsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"New data for the resolver endpoint. This parameter also accepts subtype <Oci.DnsService.Models.UpdateResolverVnicEndpointDetails> of type <Oci.DnsService.Models.UpdateResolverEndpointDetails>.")]
