...
{
    [Cmdlet("Get", "OCIIdentitydomainsIdentityProvidersList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.IdentityProviders), typeof(Oci.IdentitydomainsService.Responses.ListIdentityProvidersResponse) })]
    public class GetOCIIdentitydomainsIdentityProvidersList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ListIdentityProviders(request).GetAwaiter().GetResult();
