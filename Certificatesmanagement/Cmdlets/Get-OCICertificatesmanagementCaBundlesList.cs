...
{
    [Cmdlet("Get", "OCICertificatesmanagementCaBundlesList")]
    [OutputType(new System.Type[] { typeof(Oci.CertificatesmanagementService.Models.CaBundleCollection), typeof(Oci.CertificatesmanagementService.Responses.ListCaBundlesResponse) })]
    public class GetOCICertificatesmanagementCaBundlesList : OCICertificatesManagementCmdlet
    {
        ...
        public System.Nullable<Oci.CertificatesmanagementService.Requests.ListCaBundlesRequest.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.CertificatesmanagementService.Requests.ListCaBundlesRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either ascending (`ASC`) or descending (`DESC`).")]
        public System.Nullable<Oci.CertificatesmanagementService.Requests.ListCaBundlesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the CA bundle.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListCaBundlesRequest
                {
                ...
                IEnumerable<ListCaBundlesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.CaBundleCollection, true);
                }
        ...
        {
            IEnumerable<ListCaBundlesResponse> DefaultRequest(ListCaBundlesRequest request) => Enumerable.Repeat(client.ListCaBundles(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListCaBundlesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListCaBundlesResponse response;
        private delegate IEnumerable<ListCaBundlesResponse> RequestDelegate(ListCaBundlesRequest request);
