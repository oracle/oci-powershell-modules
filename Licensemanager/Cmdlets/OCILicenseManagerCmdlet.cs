...
using Oci.LicensemanagerService;

namespace Oci.LicensemanagerService.Cmdlets
{
    public abstract class OCILicenseManagerCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new LicenseManagerClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected LicenseManagerClient client;
