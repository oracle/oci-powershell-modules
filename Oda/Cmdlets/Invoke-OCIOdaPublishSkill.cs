...
{
    [Cmdlet("Invoke", "OCIOdaPublishSkill")]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.Skill), typeof(Oci.OdaService.Responses.PublishSkillResponse) })]
    public class InvokeOCIOdaPublishSkill : OCIManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new PublishSkillRequest
                {
        ...
        private PublishSkillResponse response;
    }
}
