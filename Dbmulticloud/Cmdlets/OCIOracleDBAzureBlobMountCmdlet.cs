...
{
    public abstract class OCIOracleDBAzureBlobMountCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OracleDBAzureBlobMountClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OracleDBAzureBlobMountClient client;
