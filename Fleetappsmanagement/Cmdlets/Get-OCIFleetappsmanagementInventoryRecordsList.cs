...
{
    [Cmdlet("Get", "OCIFleetappsmanagementInventoryRecordsList")]
    [OutputType(new System.Type[] { typeof(Oci.FleetappsmanagementService.Models.InventoryRecordCollection), typeof(Oci.FleetappsmanagementService.Responses.ListInventoryRecordsResponse) })]
    public class GetOCIFleetappsmanagementInventoryRecordsList : OCIFleetAppsManagementOperationsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListInventoryRecordsRequest
                {
                ...
                {
                    response = item;
                    WriteOutput(response, response.InventoryRecordCollection, true);
                }
        ...
        {
            IEnumerable<ListInventoryRecordsResponse> DefaultRequest(ListInventoryRecordsRequest request) => Enumerable.Repeat(client.ListInventoryRecords(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListInventoryRecordsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListInventoryRecordsResponse response;
        private delegate IEnumerable<ListInventoryRecordsResponse> RequestDelegate(ListInventoryRecordsRequest request);
