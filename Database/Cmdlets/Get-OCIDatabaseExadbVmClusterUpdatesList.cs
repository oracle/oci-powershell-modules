...
{
    [Cmdlet("Get", "OCIDatabaseExadbVmClusterUpdatesList")]
    ...
    public class GetOCIDatabaseExadbVmClusterUpdatesList : OCIDatabaseCmdlet
    {
        ...
        public System.Nullable<Oci.DatabaseService.Requests.ListExadbVmClusterUpdatesRequest.UpdateTypeEnum> UpdateType { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only resources that match the given update version exactly.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListExadbVmClusterUpdatesRequest
                {
                ...
                IEnumerable<ListExadbVmClusterUpdatesResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListExadbVmClusterUpdatesResponse> DefaultRequest(ListExadbVmClusterUpdatesRequest request) => Enumerable.Repeat(client.ListExadbVmClusterUpdates(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListExadbVmClusterUpdatesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListExadbVmClusterUpdatesResponse response;
        private delegate IEnumerable<ListExadbVmClusterUpdatesResponse> RequestDelegate(ListExadbVmClusterUpdatesRequest request);
