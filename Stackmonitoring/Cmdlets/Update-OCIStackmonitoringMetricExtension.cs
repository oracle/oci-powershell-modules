...
{
    [Cmdlet("Update", "OCIStackmonitoringMetricExtension")]
    [OutputType(new System.Type[] { typeof(Oci.StackmonitoringService.Models.MetricExtension), typeof(Oci.StackmonitoringService.Responses.UpdateMetricExtensionResponse) })]
    public class UpdateOCIStackmonitoringMetricExtension : OCIStackMonitoringCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateMetricExtensionRequest
                {
                ...
                response = client.UpdateMetricExtension(request).GetAwaiter().GetResult();
        ...
        private UpdateMetricExtensionResponse response;
    }
}
