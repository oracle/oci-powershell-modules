...
{
    [Cmdlet("Get", "OCIWaasWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.WaasService.Models.WorkRequestSummary), typeof(Oci.WaasService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIWaasWorkRequestsList : OCIWaasCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the policy.")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The value by which work requests are sorted in a paginated 'List' call. If unspecified, defaults to `timeAccepted`.")]
        public System.Nullable<Oci.WaasService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.WaasService.Requests.ListWorkRequestsRequest.SortOrderEnum> SortOrder { get; set; }
