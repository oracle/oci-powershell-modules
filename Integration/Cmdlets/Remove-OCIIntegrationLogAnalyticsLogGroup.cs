...
{
    [Cmdlet("Remove", "OCIIntegrationLogAnalyticsLogGroup")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.IntegrationService.Responses.RemoveLogAnalyticsLogGroupResponse) })]
    public class RemoveOCIIntegrationLogAnalyticsLogGroup : OCIIntegrationInstanceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.RemoveLogAnalyticsLogGroup(request).GetAwaiter().GetResult();
        ...
        private RemoveLogAnalyticsLogGroupResponse response;
    }
}
