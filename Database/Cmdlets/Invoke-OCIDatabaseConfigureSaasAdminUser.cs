...
{
    [Cmdlet("Invoke", "OCIDatabaseConfigureSaasAdminUser", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousDatabase), typeof(Oci.DatabaseService.Responses.ConfigureSaasAdminUserResponse) })]
    public class InvokeOCIDatabaseConfigureSaasAdminUser : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ConfigureSaasAdminUserRequest
                {
        ...
        private void HandleOutput(ConfigureSaasAdminUserRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForConfigureSaasAdminUser(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ConfigureSaasAdminUser(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousDatabase);
        }

        private ConfigureSaasAdminUserResponse response;
