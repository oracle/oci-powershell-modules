...
{
    [Cmdlet("Get", "OCIDnsSteeringPolicyAttachment", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.SteeringPolicyAttachment), typeof(Oci.DnsService.Responses.GetSteeringPolicyAttachmentResponse) })]
    public class GetOCIDnsSteeringPolicyAttachment : OCIDnsCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the target steering policy attachment.", ParameterSetName = LifecycleStateParamSet)]
        ...
        public Oci.DnsService.Models.SteeringPolicyAttachment.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        private GetSteeringPolicyAttachmentResponse response;
