...
{
    [Cmdlet("New", "OCIDifStack")]
    [OutputType(new System.Type[] { typeof(Oci.DifService.Models.Stack), typeof(Oci.DifService.Responses.CreateStackResponse) })]
    public class NewOCIDifStack : OCIStackCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new Stack.")]
