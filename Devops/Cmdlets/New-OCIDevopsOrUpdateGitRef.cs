...
{
    [Cmdlet("New", "OCIDevopsOrUpdateGitRef")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.RepositoryRef), typeof(Oci.DevopsService.Responses.CreateOrUpdateGitRefResponse) })]
    public class NewOCIDevopsOrUpdateGitRef : OCIDevopsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique repository identifier.")]
        public string RepositoryId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information to create a reference with the type specified in the query. This parameter also accepts subtypes <Oci.DevopsService.Models.CreateOrUpdateGitBranchDetails>, <Oci.DevopsService.Models.CreateOrUpdateGitTagDetails> of type <Oci.DevopsService.Models.CreateOrUpdateGitRefDetails>.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateOrUpdateGitRefRequest
                {
                ...
                response = client.CreateOrUpdateGitRef(request).GetAwaiter().GetResult();
        ...
        private CreateOrUpdateGitRefResponse response;
    }
}
