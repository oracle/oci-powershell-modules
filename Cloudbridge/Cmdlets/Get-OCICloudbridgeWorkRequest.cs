...
{
    [Cmdlet("Get", "OCICloudbridgeWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.CloudbridgeService.Models.WorkRequest), typeof(Oci.CloudbridgeService.Responses.GetWorkRequestResponse) })]
    public class GetOCICloudbridgeWorkRequest : OCICommonCmdlet
    {
        ...
        public Oci.CloudbridgeService.Models.OperationStatus[] WaitForStatus { get; set; }
