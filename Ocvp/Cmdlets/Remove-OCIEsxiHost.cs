...
{
    [Cmdlet("Remove", "OCIEsxiHost", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OcvpService.Responses.DeleteEsxiHostResponse) })]
    public class RemoveOCIEsxiHost : OCIEsxiHostCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIEsxiHost", "Remove"))
            {
               return;
            }
        ...
        private DeleteEsxiHostResponse response;
    }
}
