...
{
    [Cmdlet("Get", "OCIIdentitydomainsDynamicResourceGroupsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.DynamicResourceGroups), typeof(Oci.IdentitydomainsService.Responses.ListDynamicResourceGroupsResponse) })]
    public class GetOCIIdentitydomainsDynamicResourceGroupsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListDynamicResourceGroupsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListDynamicResourceGroups(request).GetAwaiter().GetResult();
        ...
        private ListDynamicResourceGroupsResponse response;
    }
}
