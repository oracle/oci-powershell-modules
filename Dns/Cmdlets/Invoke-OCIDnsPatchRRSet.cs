...
{
    [Cmdlet("Invoke", "OCIDnsPatchRRSet")]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.RecordCollection), typeof(Oci.DnsService.Responses.PatchRRSetResponse) })]
    public class InvokeOCIDnsPatchRRSet : OCIDnsCmdlet
    {
...
This parameter is deprecated and should be omitted.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.PatchRRSet(request).GetAwaiter().GetResult();
        ...
        private PatchRRSetResponse response;
    }
}
