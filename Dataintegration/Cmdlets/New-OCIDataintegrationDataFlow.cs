...
{
    [Cmdlet("New", "OCIDataintegrationDataFlow")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.DataFlow), typeof(Oci.DataintegrationService.Responses.CreateDataFlowResponse) })]
    public class NewOCIDataintegrationDataFlow : OCIDataIntegrationCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The workspace ID.")]
        public string WorkspaceId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details needed to create a new data flow.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateDataFlowRequest
                {
                ...
                response = client.CreateDataFlow(request).GetAwaiter().GetResult();
        ...
        private CreateDataFlowResponse response;
    }
}
