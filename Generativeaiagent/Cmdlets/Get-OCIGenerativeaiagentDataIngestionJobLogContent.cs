...
namespace Oci.GenerativeaiagentService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIGenerativeaiagentDataIngestionJobLogContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.GenerativeaiagentService.Responses.GetDataIngestionJobLogContentResponse) })]
    public class GetOCIGenerativeaiagentDataIngestionJobLogContent : OCIGenerativeAiAgentCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetDataIngestionJobLogContentRequest
                {
                    DataIngestionJobId = DataIngestionJobId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetDataIngestionJobLogContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetDataIngestionJobLogContentResponse response;
