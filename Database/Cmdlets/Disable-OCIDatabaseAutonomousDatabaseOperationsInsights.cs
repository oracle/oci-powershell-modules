...
{
    [Cmdlet("Disable", "OCIDatabaseAutonomousDatabaseOperationsInsights", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DisableAutonomousDatabaseOperationsInsightsResponse) })]
    public class DisableOCIDatabaseAutonomousDatabaseOperationsInsights : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableAutonomousDatabaseOperationsInsightsRequest
                {
        ...
        private void HandleOutput(DisableAutonomousDatabaseOperationsInsightsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDisableAutonomousDatabaseOperationsInsights(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DisableAutonomousDatabaseOperationsInsights(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DisableAutonomousDatabaseOperationsInsightsResponse response;
