...
{
    [Cmdlet("New", "OCIGenerativeaiImportedModel")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.ImportedModel), typeof(Oci.GenerativeaiService.Responses.CreateImportedModelResponse) })]
    public class NewOCIGenerativeaiImportedModel : OCIGenerativeAiCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for importing a model.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateImportedModelRequest
                {
                ...
                response = client.CreateImportedModel(request).GetAwaiter().GetResult();
        ...
        private CreateImportedModelResponse response;
    }
}
