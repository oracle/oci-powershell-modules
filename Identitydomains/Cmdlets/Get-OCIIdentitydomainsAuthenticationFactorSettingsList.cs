...
{
    [Cmdlet("Get", "OCIIdentitydomainsAuthenticationFactorSettingsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.AuthenticationFactorSettings), typeof(Oci.IdentitydomainsService.Responses.ListAuthenticationFactorSettingsResponse) })]
    public class GetOCIIdentitydomainsAuthenticationFactorSettingsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAuthenticationFactorSettingsRequest
                {
                ...
                response = client.ListAuthenticationFactorSettings(request).GetAwaiter().GetResult();
        ...
        private ListAuthenticationFactorSettingsResponse response;
    }
}
