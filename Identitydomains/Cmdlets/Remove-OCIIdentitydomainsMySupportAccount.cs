...
{
    [Cmdlet("Remove", "OCIIdentitydomainsMySupportAccount", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteMySupportAccountResponse) })]
    public class RemoveOCIIdentitydomainsMySupportAccount : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsMySupportAccount", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteMySupportAccountRequest
                {
                ...
                response = client.DeleteMySupportAccount(request).GetAwaiter().GetResult();
        ...
        private DeleteMySupportAccountResponse response;
    }
}
