...
{
    [Cmdlet("Get", "OCIMarketplaceWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.MarketplaceService.Models.WorkRequest), typeof(Oci.MarketplaceService.Responses.GetWorkRequestResponse) })]
    public class GetOCIMarketplaceWorkRequest : OCIMarketplaceCmdlet
    {
        ...
        public Oci.MarketplaceService.Models.OperationStatus[] WaitForStatus { get; set; }
