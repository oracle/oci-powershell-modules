...
{
    [Cmdlet("Get", "OCIVisualbuilderWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.VisualbuilderService.Models.WorkRequestLogEntryCollection), typeof(Oci.VisualbuilderService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIVisualbuilderWorkRequestLogsList : OCIVbInstanceCmdlet
    {
