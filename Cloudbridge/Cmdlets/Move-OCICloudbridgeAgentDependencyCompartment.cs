...
{
    [Cmdlet("Move", "OCICloudbridgeAgentDependencyCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CloudbridgeService.Responses.ChangeAgentDependencyCompartmentResponse) })]
    public class MoveOCICloudbridgeAgentDependencyCompartment : OCIOcbAgentSvcCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A unique AgentDependency identifier.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeAgentDependencyCompartmentRequest
                {
                ...
                response = client.ChangeAgentDependencyCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeAgentDependencyCompartmentResponse response;
    }
}
