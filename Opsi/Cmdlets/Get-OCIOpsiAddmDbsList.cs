...
{
    [Cmdlet("Get", "OCIOpsiAddmDbsList")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.AddmDbCollection), typeof(Oci.OpsiService.Responses.ListAddmDbsResponse) })]
    public class GetOCIOpsiAddmDbsList : OCIOperationsInsightsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Field name for sorting ADDM database data")]
        public System.Nullable<Oci.OpsiService.Requests.ListAddmDbsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAddmDbsRequest
                {
                ...
                IEnumerable<ListAddmDbsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.AddmDbCollection, true);
                }
        ...
        {
            IEnumerable<ListAddmDbsResponse> DefaultRequest(ListAddmDbsRequest request) => Enumerable.Repeat(client.ListAddmDbs(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAddmDbsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAddmDbsResponse response;
        private delegate IEnumerable<ListAddmDbsResponse> RequestDelegate(ListAddmDbsRequest request);
