...
{
    public abstract class OCIDbSystemCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DbSystemClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DbSystemClient client;
