...
{
    [Cmdlet("Enable", "OCIKeymanagementKey")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.Key), typeof(Oci.KeymanagementService.Responses.EnableKeyResponse) })]
    public class EnableOCIKeymanagementKey : OCIKmsManagementCmdlet
    {
        ...
        private EnableKeyResponse response;
    }
}
