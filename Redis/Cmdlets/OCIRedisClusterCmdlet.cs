...
{
    public abstract class OCIRedisClusterCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new RedisClusterClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
