...
{
    [Cmdlet("Update", "OCIOdaChannel")]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.Channel), typeof(Oci.OdaService.Responses.UpdateChannelResponse) })]
    public class UpdateOCIOdaChannel : OCIManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Property values to update the Channel. This parameter also accepts subtypes <Oci.OdaService.Models.UpdateOsvcChannelDetails>, <Oci.OdaService.Models.UpdateOSSChannelDetails>, <Oci.OdaService.Models.UpdateAndroidChannelDetails>, <Oci.OdaService.Models.UpdateMSTeamsChannelDetails>, <Oci.OdaService.Models.UpdateAppEventChannelDetails>, <Oci.OdaService.Models.UpdateWebChannelDetails>, <Oci.OdaService.Models.UpdateIosChannelDetails>, <Oci.OdaService.Models.UpdateSlackChannelDetails>, <Oci.OdaService.Models.UpdateServiceCloudChannelDetails>, <Oci.OdaService.Models.UpdateTwilioChannelDetails>, <Oci.OdaService.Models.UpdateWebhookChannelDetails>, <Oci.OdaService.Models.UpdateApplicationChannelDetails>, <Oci.OdaService.Models.UpdateFacebookChannelDetails>, <Oci.OdaService.Models.UpdateCortanaChannelDetails> of type <Oci.OdaService.Models.UpdateChannelDetails>.")]
        ...
        private UpdateChannelResponse response;
    }
}
