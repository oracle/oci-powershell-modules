...
{
    [Cmdlet("Remove", "OCIIdentitydomainsIdentityProofingProvider", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteIdentityProofingProviderResponse) })]
    public class RemoveOCIIdentitydomainsIdentityProofingProvider : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsIdentityProofingProvider", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteIdentityProofingProviderRequest
                {
                ...
                response = client.DeleteIdentityProofingProvider(request).GetAwaiter().GetResult();
        ...
        private DeleteIdentityProofingProviderResponse response;
    }
}
