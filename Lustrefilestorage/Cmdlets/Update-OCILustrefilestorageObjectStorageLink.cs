...
{
    [Cmdlet("Update", "OCILustrefilestorageObjectStorageLink")]
    ...
    public class UpdateOCILustrefilestorageObjectStorageLink : OCILustreFileStorageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateObjectStorageLinkRequest
                {
                ...
                response = client.UpdateObjectStorageLink(request).GetAwaiter().GetResult();
        ...
        private UpdateObjectStorageLinkResponse response;
    }
}
