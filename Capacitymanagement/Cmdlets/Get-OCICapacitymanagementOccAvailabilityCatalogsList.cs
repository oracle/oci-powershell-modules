...
{
    [Cmdlet("Get", "OCICapacitymanagementOccAvailabilityCatalogsList")]
    [OutputType(new System.Type[] { typeof(Oci.CapacitymanagementService.Models.OccAvailabilityCatalogCollection), typeof(Oci.CapacitymanagementService.Responses.ListOccAvailabilityCatalogsResponse) })]
    public class GetOCICapacitymanagementOccAvailabilityCatalogsList : OCICapacityManagementCmdlet
    {
        ...
        public System.Nullable<Oci.CapacitymanagementService.Requests.ListOccAvailabilityCatalogsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListOccAvailabilityCatalogsRequest
                {
                ...
                IEnumerable<ListOccAvailabilityCatalogsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListOccAvailabilityCatalogsResponse> DefaultRequest(ListOccAvailabilityCatalogsRequest request) => Enumerable.Repeat(client.ListOccAvailabilityCatalogs(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListOccAvailabilityCatalogsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListOccAvailabilityCatalogsResponse response;
        private delegate IEnumerable<ListOccAvailabilityCatalogsResponse> RequestDelegate(ListOccAvailabilityCatalogsRequest request);
