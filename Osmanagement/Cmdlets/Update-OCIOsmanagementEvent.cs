...
{
    [Cmdlet("Update", "OCIOsmanagementEvent")]
    [OutputType(new System.Type[] { typeof(Oci.OsmanagementService.Models.Event), typeof(Oci.OsmanagementService.Responses.UpdateEventResponse) })]
    public class UpdateOCIOsmanagementEvent : OCIEventCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details about the event to update")]
        ...
        private UpdateEventResponse response;
    }
}
