...
{
    [Cmdlet("Get", "OCIMarketplacepublisherWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.MarketplacepublisherService.Models.WorkRequestErrorCollection), typeof(Oci.MarketplacepublisherService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIMarketplacepublisherWorkRequestErrorsList : OCIMarketplacePublisherCmdlet
    {
        ...
        public System.Nullable<Oci.MarketplacepublisherService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }
