...
{
    public abstract class OCIAttachmentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AttachmentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AttachmentClient client;
