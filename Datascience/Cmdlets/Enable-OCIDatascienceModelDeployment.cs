...
{
    [Cmdlet("Enable", "OCIDatascienceModelDeployment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatascienceService.Responses.ActivateModelDeploymentResponse) })]
    public class EnableOCIDatascienceModelDeployment : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ActivateModelDeploymentRequest
                {
                ...
                response = client.ActivateModelDeployment(request).GetAwaiter().GetResult();
        ...
        private ActivateModelDeploymentResponse response;
    }
}
