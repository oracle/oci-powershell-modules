...
{
    [Cmdlet("Remove", "OCICapacitymanagementOccCustomerGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CapacitymanagementService.Responses.DeleteOccCustomerGroupResponse) })]
    public class RemoveOCICapacitymanagementOccCustomerGroup : OCICapacityManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCICapacitymanagementOccCustomerGroup", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteOccCustomerGroupRequest
                {
                ...
                response = client.DeleteOccCustomerGroup(request).GetAwaiter().GetResult();
        ...
        private DeleteOccCustomerGroupResponse response;
    }
}
