...
{
    [Cmdlet("Restore", "OCIKeymanagementVaultFromFile")]
    ...
    public class RestoreOCIKeymanagementVaultFromFile : OCIKmsVaultCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Use this parameter to provide the file location from where the input stream to be read. The encrypted backup file to upload to restore the vault.", ParameterSetName = FromFileSet)]
