...
{
    [Cmdlet("Update", "OCIMediaservicesMediaWorkflow")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.MediaWorkflow), typeof(Oci.MediaservicesService.Responses.UpdateMediaWorkflowResponse) })]
    public class UpdateOCIMediaservicesMediaWorkflow : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateMediaWorkflowRequest
                {
                ...
                response = client.UpdateMediaWorkflow(request).GetAwaiter().GetResult();
        ...
        private UpdateMediaWorkflowResponse response;
    }
}
