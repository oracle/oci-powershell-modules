...
namespace Oci.GloballydistributeddatabaseService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIGloballydistributeddatabaseDownloadGsmCertificateSigningRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.GloballydistributeddatabaseService.Responses.DownloadGsmCertificateSigningRequestResponse) })]
    public class InvokeOCIGloballydistributeddatabaseDownloadGsmCertificateSigningRequest : OCIShardedDatabaseServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DownloadGsmCertificateSigningRequestRequest
                {
                ...
                response = client.DownloadGsmCertificateSigningRequest(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private DownloadGsmCertificateSigningRequestResponse response;
