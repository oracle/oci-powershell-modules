...
{
    [Cmdlet("Get", "OCILoganalyticsLogSetsList")]
    [OutputType(new System.Type[] { typeof(Oci.LoganalyticsService.Models.LogSetCollection), typeof(Oci.LoganalyticsService.Responses.ListLogSetsResponse) })]
    public class GetOCILoganalyticsLogSetsList : OCILogAnalyticsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListLogSetsRequest
                {
                ...
                WriteOutput(response, response.LogSetCollection);
        ...
        private ListLogSetsResponse response;
    }
}
