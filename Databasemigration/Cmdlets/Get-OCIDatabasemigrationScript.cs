...
namespace Oci.DatabasemigrationService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIDatabasemigrationScript", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatabasemigrationService.Responses.GetScriptResponse) })]
    public class GetOCIDatabasemigrationScript : OCIDatabaseMigrationCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID of the script to download.")]
        public System.Nullable<Oci.DatabasemigrationService.Models.ScriptIds> ScriptId { get; set; }
