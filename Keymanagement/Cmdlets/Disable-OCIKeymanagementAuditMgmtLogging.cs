...
{
    [Cmdlet("Disable", "OCIKeymanagementAuditMgmtLogging")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.KeymanagementService.Responses.DisableAuditMgmtLoggingResponse) })]
    public class DisableOCIKeymanagementAuditMgmtLogging : OCIKmsHsmClusterCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableAuditMgmtLoggingRequest
                {
                ...
                response = client.DisableAuditMgmtLogging(request).GetAwaiter().GetResult();
        ...
        private DisableAuditMgmtLoggingResponse response;
    }
}
