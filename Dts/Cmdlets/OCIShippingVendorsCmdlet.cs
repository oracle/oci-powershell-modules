...
{
    public abstract class OCIShippingVendorsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ShippingVendorsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ShippingVendorsClient client;
