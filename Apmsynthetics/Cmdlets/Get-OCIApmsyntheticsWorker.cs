...
{
    [Cmdlet("Get", "OCIApmsyntheticsWorker")]
    [OutputType(new System.Type[] { typeof(Oci.ApmsyntheticsService.Models.Worker), typeof(Oci.ApmsyntheticsService.Responses.GetWorkerResponse) })]
    public class GetOCIApmsyntheticsWorker : OCIApmSyntheticCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GetWorker(request).GetAwaiter().GetResult();
        ...
        private GetWorkerResponse response;
    }
}
