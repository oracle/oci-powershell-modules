...
{
    [Cmdlet("Remove", "OCIIdentitydomainsMySmtpCredential", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteMySmtpCredentialResponse) })]
    public class RemoveOCIIdentitydomainsMySmtpCredential : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsMySmtpCredential", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteMySmtpCredentialRequest
                {
                ...
                response = client.DeleteMySmtpCredential(request).GetAwaiter().GetResult();
        ...
        private DeleteMySmtpCredentialResponse response;
    }
}
