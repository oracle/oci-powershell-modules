...
{
    [Cmdlet("Invoke", "OCIDevopsDeclinePullRequest")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.PullRequest), typeof(Oci.DevopsService.Responses.DeclinePullRequestResponse) })]
    public class InvokeOCIDevopsDeclinePullRequest : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DeclinePullRequestRequest
                {
                ...
                response = client.DeclinePullRequest(request).GetAwaiter().GetResult();
        ...
        private DeclinePullRequestResponse response;
    }
}
