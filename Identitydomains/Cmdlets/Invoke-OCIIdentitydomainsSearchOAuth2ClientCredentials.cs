...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchOAuth2ClientCredentials")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.OAuth2ClientCredentials), typeof(Oci.IdentitydomainsService.Responses.SearchOAuth2ClientCredentialsResponse) })]
    public class InvokeOCIIdentitydomainsSearchOAuth2ClientCredentials : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching OAuth2ClientCredentials")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchOAuth2ClientCredentialsRequest
                {
                ...
                response = client.SearchOAuth2ClientCredentials(request).GetAwaiter().GetResult();
                WriteOutput(response, response.OAuth2ClientCredentials);
        ...
        private SearchOAuth2ClientCredentialsResponse response;
    }
}
