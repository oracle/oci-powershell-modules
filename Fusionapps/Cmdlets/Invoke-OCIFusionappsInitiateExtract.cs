...
{
    [Cmdlet("Invoke", "OCIFusionappsInitiateExtract")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.FusionappsService.Responses.InitiateExtractResponse) })]
    public class InvokeOCIFusionappsInitiateExtract : OCIFusionApplicationsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new InitiateExtractRequest
                {
                    FusionEnvironmentId = FusionEnvironmentId,
                    OpcRequestId = OpcRequestId
                };

                response = client.InitiateExtract(request).GetAwaiter().GetResult();
        ...
        private InitiateExtractResponse response;
    }
}
