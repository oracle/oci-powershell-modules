...
{
    [Cmdlet("Move", "OCICloudbridgeAssetCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CloudbridgeService.Responses.ChangeAssetCompartmentResponse) })]
    public class MoveOCICloudbridgeAssetCompartment : OCIInventoryCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeAssetCompartmentRequest
                {
                    AssetId = AssetId,
                ...
                response = client.ChangeAssetCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeAssetCompartmentResponse response;
    }
}
