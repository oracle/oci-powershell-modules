...
{
    [Cmdlet("Remove", "OCIDataintegrationApplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataintegrationService.Responses.DeleteApplicationResponse) })]
    public class RemoveOCIDataintegrationApplication : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataintegrationApplication", "Remove"))
            {
               return;
            }
