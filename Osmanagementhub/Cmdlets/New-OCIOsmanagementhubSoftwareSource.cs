...
{
    [Cmdlet("New", "OCIOsmanagementhubSoftwareSource")]
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new software source. This parameter also accepts subtypes <Oci.OsmanagementhubService.Models.CreateCustomSoftwareSourceDetails>, <Oci.OsmanagementhubService.Models.CreateVendorSoftwareSourceDetails>, <Oci.OsmanagementhubService.Models.CreatePrivateSoftwareSourceDetails>, <Oci.OsmanagementhubService.Models.CreateVersionedCustomSoftwareSourceDetails>, <Oci.OsmanagementhubService.Models.CreateThirdPartySoftwareSourceDetails> of type <Oci.OsmanagementhubService.Models.CreateSoftwareSourceDetails>.")]
