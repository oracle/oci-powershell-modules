...
{
    [Cmdlet("Get", "OCIApiaccesscontrolWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.ApiaccesscontrolService.Models.WorkRequest), typeof(Oci.ApiaccesscontrolService.Responses.GetWorkRequestResponse) })]
    public class GetOCIApiaccesscontrolWorkRequest : OCIPrivilegedApiWorkRequestCmdlet
    {
        ...
        public Oci.ApiaccesscontrolService.Models.OperationStatus[] WaitForStatus { get; set; }
