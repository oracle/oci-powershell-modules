...
{
    [Cmdlet("Get", "OCIDatascienceMlApplicationImplementationVersionsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.MlApplicationImplementationVersionCollection), typeof(Oci.DatascienceService.Responses.ListMlApplicationImplementationVersionsResponse) })]
    public class GetOCIDatascienceMlApplicationImplementationVersionsList : OCIDataScienceCmdlet
    {
        ...
        public System.Nullable<Oci.DatascienceService.Models.MlApplicationImplementationVersion.LifecycleStateEnum> LifecycleState { get; set; }
...
See [List Pagination](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/usingapi.htm#nine).")]
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListMlApplicationImplementationVersionsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListMlApplicationImplementationVersionsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMlApplicationImplementationVersionsRequest
                {
                ...
                IEnumerable<ListMlApplicationImplementationVersionsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.MlApplicationImplementationVersionCollection, true);
                }
        ...
        {
            IEnumerable<ListMlApplicationImplementationVersionsResponse> DefaultRequest(ListMlApplicationImplementationVersionsRequest request) => Enumerable.Repeat(client.ListMlApplicationImplementationVersions(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListMlApplicationImplementationVersionsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListMlApplicationImplementationVersionsResponse response;
        private delegate IEnumerable<ListMlApplicationImplementationVersionsResponse> RequestDelegate(ListMlApplicationImplementationVersionsRequest request);
