...
namespace Oci.DatabaseService.Cmdlets
{
    ...
    public class GetOCIDatabaseExadataInfrastructuresList : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"If provided, the specified fields will be excluded in the response.")]
        public System.Collections.Generic.List<Oci.DatabaseService.Requests.ListExadataInfrastructuresRequest.ExcludedFieldsEnum> ExcludedFields { get; set; }
