...
{
    public abstract class OCIRatecardCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new RatecardClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected RatecardClient client;
