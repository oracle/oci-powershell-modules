...
{
    public abstract class OCIOpensearchClusterPipelineCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OpensearchClusterPipelineClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OpensearchClusterPipelineClient client;
