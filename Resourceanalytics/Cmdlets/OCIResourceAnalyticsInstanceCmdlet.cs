...
using Oci.ResourceanalyticsService;

namespace Oci.ResourceanalyticsService.Cmdlets
{
    public abstract class OCIResourceAnalyticsInstanceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ResourceAnalyticsInstanceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ResourceAnalyticsInstanceClient client;
