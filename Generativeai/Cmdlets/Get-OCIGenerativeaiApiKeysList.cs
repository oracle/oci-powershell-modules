...
{
    [Cmdlet("Get", "OCIGenerativeaiApiKeysList")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.ApiKeyCollection), typeof(Oci.GenerativeaiService.Responses.ListApiKeysResponse) })]
    public class GetOCIGenerativeaiApiKeysList : OCIGenerativeAiCmdlet
    {
        ...
        public System.Nullable<Oci.GenerativeaiService.Models.ApiKey.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the APIKey.")]
        ...
        public System.Nullable<Oci.GenerativeaiService.Requests.ListApiKeysRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListApiKeysResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.ApiKeyCollection, true);
                }
        ...
        {
            IEnumerable<ListApiKeysResponse> DefaultRequest(ListApiKeysRequest request) => Enumerable.Repeat(client.ListApiKeys(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListApiKeysResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListApiKeysResponse response;
        private delegate IEnumerable<ListApiKeysResponse> RequestDelegate(ListApiKeysRequest request);
