...
{
    [Cmdlet("Get", "OCIServicemeshVirtualDeploymentsList")]
    [OutputType(new System.Type[] { typeof(Oci.ServicemeshService.Models.VirtualDeploymentCollection), typeof(Oci.ServicemeshService.Responses.ListVirtualDeploymentsResponse) })]
    public class GetOCIServicemeshVirtualDeploymentsList : OCIServiceMeshCmdlet
    {
        ...
        public System.Nullable<Oci.ServicemeshService.Requests.ListVirtualDeploymentsRequest.SortByEnum> SortBy { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique VirtualDeployment identifier.")]
        ...
        public System.Nullable<Oci.ServicemeshService.Models.VirtualDeployment.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListVirtualDeploymentsRequest
                {
                ...
                IEnumerable<ListVirtualDeploymentsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.VirtualDeploymentCollection, true);
                }
        ...
        {
            IEnumerable<ListVirtualDeploymentsResponse> DefaultRequest(ListVirtualDeploymentsRequest request) => Enumerable.Repeat(client.ListVirtualDeployments(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListVirtualDeploymentsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListVirtualDeploymentsResponse response;
        private delegate IEnumerable<ListVirtualDeploymentsResponse> RequestDelegate(ListVirtualDeploymentsRequest request);
