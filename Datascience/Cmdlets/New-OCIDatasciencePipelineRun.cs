...
{
    [Cmdlet("New", "OCIDatasciencePipelineRun")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.PipelineRun), typeof(Oci.DatascienceService.Responses.CreatePipelineRunResponse) })]
    public class NewOCIDatasciencePipelineRun : OCIDataScienceCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new PipelineRun.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreatePipelineRunRequest
                {
        ...
        private CreatePipelineRunResponse response;
    }
}
