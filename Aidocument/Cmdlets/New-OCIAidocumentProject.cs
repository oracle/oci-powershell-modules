...
{
    [Cmdlet("New", "OCIAidocumentProject")]
    [OutputType(new System.Type[] { typeof(Oci.AidocumentService.Models.Project), typeof(Oci.AidocumentService.Responses.CreateProjectResponse) })]
    public class NewOCIAidocumentProject : OCIAIServiceDocumentCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The new Project's details.")]
