...
{
    [Cmdlet("Get", "OCIOsmanagementhubManagementStationsList")]
    [OutputType(new System.Type[] { typeof(Oci.OsmanagementhubService.Models.ManagementStationCollection), typeof(Oci.OsmanagementhubService.Responses.ListManagementStationsResponse) })]
    public class GetOCIOsmanagementhubManagementStationsList : OCIManagementStationCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter that returns information for management stations in the specified state.")]
        public System.Nullable<Oci.OsmanagementhubService.Models.ManagementStation.LifecycleStateEnum> LifecycleState { get; set; }
...
Example: `3`")]
        ...
        public System.Nullable<Oci.OsmanagementhubService.Requests.ListManagementStationsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.")]
        public string OpcRequestId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management station. A filter that returns information about the specified management station.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListManagementStationsRequest
                {
                ...
                {
                    response = item;
                    WriteOutput(response, response.ManagementStationCollection, true);
                }
        ...
        {
            IEnumerable<ListManagementStationsResponse> DefaultRequest(ListManagementStationsRequest request) => Enumerable.Repeat(client.ListManagementStations(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListManagementStationsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListManagementStationsResponse response;
        private delegate IEnumerable<ListManagementStationsResponse> RequestDelegate(ListManagementStationsRequest request);
