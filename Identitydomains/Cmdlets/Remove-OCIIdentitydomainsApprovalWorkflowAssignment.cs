...
{
    [Cmdlet("Remove", "OCIIdentitydomainsApprovalWorkflowAssignment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteApprovalWorkflowAssignmentResponse) })]
    public class RemoveOCIIdentitydomainsApprovalWorkflowAssignment : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsApprovalWorkflowAssignment", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteApprovalWorkflowAssignmentRequest
                {
                ...
                response = client.DeleteApprovalWorkflowAssignment(request).GetAwaiter().GetResult();
        ...
        private DeleteApprovalWorkflowAssignmentResponse response;
    }
}
