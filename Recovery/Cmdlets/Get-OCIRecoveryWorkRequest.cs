...
{
    [Cmdlet("Get", "OCIRecoveryWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.RecoveryService.Models.WorkRequest), typeof(Oci.RecoveryService.Responses.GetWorkRequestResponse) })]
    public class GetOCIRecoveryWorkRequest : OCIDatabaseRecoveryCmdlet
    {
        ...
        public Oci.RecoveryService.Models.OperationStatus[] WaitForStatus { get; set; }
