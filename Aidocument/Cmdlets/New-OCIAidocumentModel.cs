...
{
    [Cmdlet("New", "OCIAidocumentModel")]
    [OutputType(new System.Type[] { typeof(Oci.AidocumentService.Models.Model), typeof(Oci.AidocumentService.Responses.CreateModelResponse) })]
    public class NewOCIAidocumentModel : OCIAIServiceDocumentCmdlet
    {
