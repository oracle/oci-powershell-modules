...
{
    [Cmdlet("Get", "OCIIdentitydomainsPasswordPoliciesList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.PasswordPolicies), typeof(Oci.IdentitydomainsService.Responses.ListPasswordPoliciesResponse) })]
    public class GetOCIIdentitydomainsPasswordPoliciesList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListPasswordPoliciesRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListPasswordPolicies(request).GetAwaiter().GetResult();
        ...
        private ListPasswordPoliciesResponse response;
    }
}
