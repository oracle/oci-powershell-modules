...
{
    [Cmdlet("Stop", "OCIFleetsoftwareupdateFsuAction")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.FleetsoftwareupdateService.Responses.CancelFsuActionResponse) })]
    public class StopOCIFleetsoftwareupdateFsuAction : OCIFleetSoftwareUpdateCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelFsuActionRequest
                {
                ...
                response = client.CancelFsuAction(request).GetAwaiter().GetResult();
        ...
        private CancelFsuActionResponse response;
    }
}
