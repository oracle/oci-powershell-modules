...
namespace Oci.DatascienceService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIDatascienceModelDefinedMetadatumArtifactContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatascienceService.Responses.GetModelDefinedMetadatumArtifactContentResponse) })]
    public class GetOCIDatascienceModelDefinedMetadatumArtifactContent : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetModelDefinedMetadatumArtifactContentRequest
                {
                    ModelId = ModelId,
                ...
                response = client.GetModelDefinedMetadatumArtifactContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetModelDefinedMetadatumArtifactContentResponse response;
