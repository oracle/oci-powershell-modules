...
{
    [Cmdlet("Move", "OCIDatabasemanagementDbManagementPrivateEndpointCompartment")]
    ...
    public class MoveOCIDatabasemanagementDbManagementPrivateEndpointCompartment : OCIDbManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeDbManagementPrivateEndpointCompartmentRequest
                {
                ...
                response = client.ChangeDbManagementPrivateEndpointCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeDbManagementPrivateEndpointCompartmentResponse response;
    }
}
