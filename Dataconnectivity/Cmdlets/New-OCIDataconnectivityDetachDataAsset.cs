...
{
    [Cmdlet("New", "OCIDataconnectivityDetachDataAsset")]
    [OutputType(new System.Type[] { typeof(Oci.DataconnectivityService.Models.DetachDataAssetInfo), typeof(Oci.DataconnectivityService.Responses.CreateDetachDataAssetResponse) })]
    public class NewOCIDataconnectivityDetachDataAsset : OCIDataConnectivityManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request body parameters to detach data asset to an private endpoint")]
        public CreateDetachDataAssetDetails CreateDetachDataAssetDetails { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateDetachDataAssetRequest
                {
        ...
        private CreateDetachDataAssetResponse response;
    }
}
