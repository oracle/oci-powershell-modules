...
{
    [Cmdlet("Get", "OCIIdentitydomainsOAuthClientCertificate")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.OAuthClientCertificate), typeof(Oci.IdentitydomainsService.Responses.GetOAuthClientCertificateResponse) })]
    public class GetOCIIdentitydomainsOAuthClientCertificate : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOAuthClientCertificateRequest
                {
                ...
                response = client.GetOAuthClientCertificate(request).GetAwaiter().GetResult();
        ...
        private GetOAuthClientCertificateResponse response;
    }
}
