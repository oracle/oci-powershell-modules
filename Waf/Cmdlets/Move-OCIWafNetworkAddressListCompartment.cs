...
{
    [Cmdlet("Move", "OCIWafNetworkAddressListCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WafService.Responses.ChangeNetworkAddressListCompartmentResponse) })]
    public class MoveOCIWafNetworkAddressListCompartment : OCIWafCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeNetworkAddressListCompartmentRequest
                {
                ...
                response = client.ChangeNetworkAddressListCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeNetworkAddressListCompartmentResponse response;
    }
}
