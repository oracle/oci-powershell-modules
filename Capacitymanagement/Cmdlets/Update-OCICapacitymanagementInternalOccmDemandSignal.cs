...
{
    [Cmdlet("Update", "OCICapacitymanagementInternalOccmDemandSignal")]
    [OutputType(new System.Type[] { typeof(Oci.CapacitymanagementService.Models.InternalOccmDemandSignal), typeof(Oci.CapacitymanagementService.Responses.UpdateInternalOccmDemandSignalResponse) })]
    public class UpdateOCICapacitymanagementInternalOccmDemandSignal : OCIInternalDemandSignalCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The request details for this PUT API to update the metadata for a given demand signal resource.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateInternalOccmDemandSignalRequest
                {
                ...
                response = client.UpdateInternalOccmDemandSignal(request).GetAwaiter().GetResult();
        ...
        private UpdateInternalOccmDemandSignalResponse response;
    }
}
