...
namespace Oci.DatabaseService.Cmdlets
{
    ...
    public class UpdateOCIDatabaseAutonomousDatabaseWallet : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to update the properties of an Autonomous Database wallet.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to update the properties of an Autonomous Database wallet.", ParameterSetName = Default)]
