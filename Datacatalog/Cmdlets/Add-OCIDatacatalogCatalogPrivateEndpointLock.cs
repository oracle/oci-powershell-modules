...
{
    [Cmdlet("Add", "OCIDatacatalogCatalogPrivateEndpointLock")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.CatalogPrivateEndpoint), typeof(Oci.DatacatalogService.Responses.AddCatalogPrivateEndpointLockResponse) })]
    public class AddOCIDatacatalogCatalogPrivateEndpointLock : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddCatalogPrivateEndpointLockRequest
                {
                ...
                response = client.AddCatalogPrivateEndpointLock(request).GetAwaiter().GetResult();
        ...
        private AddCatalogPrivateEndpointLockResponse response;
    }
}
