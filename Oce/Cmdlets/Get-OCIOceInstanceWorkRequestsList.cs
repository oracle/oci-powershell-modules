...
{
    [Cmdlet("Get", "OCIOceInstanceWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.OceService.Models.WorkRequest), typeof(Oci.OceService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIOceInstanceWorkRequestsList : OCIOceInstanceCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID of the compartment in which to list resources.")]
        public string CompartmentId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The resource Identifier for which to list resources.")]
