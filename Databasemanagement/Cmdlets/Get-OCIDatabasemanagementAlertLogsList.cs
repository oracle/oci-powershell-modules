...
{
    [Cmdlet("Get", "OCIDatabasemanagementAlertLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.AlertLogCollection), typeof(Oci.DatabasemanagementService.Responses.ListAlertLogsResponse) })]
    public class GetOCIDatabasemanagementAlertLogsList : OCIDiagnosabilityCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListAlertLogsRequest.LevelFilterEnum> LevelFilter { get; set; }
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListAlertLogsRequest.TypeFilterEnum> TypeFilter { get; set; }
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListAlertLogsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAlertLogsRequest
                {
                ...
                IEnumerable<ListAlertLogsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.AlertLogCollection, true);
                }
        ...
        {
            IEnumerable<ListAlertLogsResponse> DefaultRequest(ListAlertLogsRequest request) => Enumerable.Repeat(client.ListAlertLogs(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAlertLogsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAlertLogsResponse response;
        private delegate IEnumerable<ListAlertLogsResponse> RequestDelegate(ListAlertLogsRequest request);
