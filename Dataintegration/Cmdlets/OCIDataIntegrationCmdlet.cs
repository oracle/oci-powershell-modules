...
{
    public abstract class OCIDataIntegrationCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DataIntegrationClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DataIntegrationClient client;
