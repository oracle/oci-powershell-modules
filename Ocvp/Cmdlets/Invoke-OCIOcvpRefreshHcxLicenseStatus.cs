...
{
    [Cmdlet("Invoke", "OCIOcvpRefreshHcxLicenseStatus")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OcvpService.Responses.RefreshHcxLicenseStatusResponse) })]
    public class InvokeOCIOcvpRefreshHcxLicenseStatus : OCISddcCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RefreshHcxLicenseStatusRequest
                {
                    SddcId = SddcId,
                ...
                response = client.RefreshHcxLicenseStatus(request).GetAwaiter().GetResult();
        ...
        private RefreshHcxLicenseStatusResponse response;
    }
}
