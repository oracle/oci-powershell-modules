...
{
    [Cmdlet("Update", "OCIJmsFleet")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.JmsService.Responses.UpdateFleetResponse) })]
    public class UpdateOCIJmsFleet : OCIJavaManagementServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The new details for the Fleet.")]
