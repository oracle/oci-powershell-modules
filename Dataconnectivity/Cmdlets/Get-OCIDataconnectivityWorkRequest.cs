...
{
    [Cmdlet("Get", "OCIDataconnectivityWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DataconnectivityService.Models.WorkRequest), typeof(Oci.DataconnectivityService.Responses.GetWorkRequestResponse) })]
    public class GetOCIDataconnectivityWorkRequest : OCIDataConnectivityManagementCmdlet
    {
        ...
        public Oci.DataconnectivityService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
