...
{
    [Cmdlet("Get", "OCIDatabasemanagementAsmPropertiesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.AsmPropertyCollection), typeof(Oci.DatabasemanagementService.Responses.ListAsmPropertiesResponse) })]
    public class GetOCIDatabasemanagementAsmPropertiesList : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListAsmPropertiesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAsmPropertiesRequest
                {
                ...
                IEnumerable<ListAsmPropertiesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.AsmPropertyCollection, true);
                }
        ...
        {
            IEnumerable<ListAsmPropertiesResponse> DefaultRequest(ListAsmPropertiesRequest request) => Enumerable.Repeat(client.ListAsmProperties(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAsmPropertiesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAsmPropertiesResponse response;
        private delegate IEnumerable<ListAsmPropertiesResponse> RequestDelegate(ListAsmPropertiesRequest request);
