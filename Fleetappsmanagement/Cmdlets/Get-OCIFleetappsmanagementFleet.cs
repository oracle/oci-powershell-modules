...
{
    [Cmdlet("Get", "OCIFleetappsmanagementFleet", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.FleetappsmanagementService.Models.Fleet), typeof(Oci.FleetappsmanagementService.Responses.GetFleetResponse) })]
    public class GetOCIFleetappsmanagementFleet : OCIFleetAppsManagementCmdlet
    {
        ...
        public Oci.FleetappsmanagementService.Models.Fleet.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
