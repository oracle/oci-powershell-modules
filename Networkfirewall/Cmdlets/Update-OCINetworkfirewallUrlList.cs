...
{
    [Cmdlet("Update", "OCINetworkfirewallUrlList")]
    [OutputType(new System.Type[] { typeof(Oci.NetworkfirewallService.Models.UrlList), typeof(Oci.NetworkfirewallService.Responses.UpdateUrlListResponse) })]
    public class UpdateOCINetworkfirewallUrlList : OCINetworkFirewallCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpdateUrlList(request).GetAwaiter().GetResult();
        ...
        private UpdateUrlListResponse response;
    }
}
