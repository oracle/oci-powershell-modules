...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementSummarizeCloudAsmMetrics")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.MetricsAggregationRangeCollection), typeof(Oci.DatabasemanagementService.Responses.SummarizeCloudAsmMetricsResponse) })]
    public class InvokeOCIDatabasemanagementSummarizeCloudAsmMetrics : OCIDbManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeCloudAsmMetricsRequest
                {
                ...
                response = client.SummarizeCloudAsmMetrics(request).GetAwaiter().GetResult();
        ...
        private SummarizeCloudAsmMetricsResponse response;
    }
}
