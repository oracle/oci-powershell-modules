...
namespace Oci.GoldengateService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specification of the Connection to create. This parameter also accepts subtypes <Oci.GoldengateService.Models.CreatePostgresqlConnectionDetails>, <Oci.GoldengateService.Models.CreateKafkaSchemaRegistryConnectionDetails>, <Oci.GoldengateService.Models.CreateAzureSynapseConnectionDetails>, <Oci.GoldengateService.Models.CreateAzureDataLakeStorageConnectionDetails>, <Oci.GoldengateService.Models.CreateMysqlConnectionDetails>, <Oci.GoldengateService.Models.CreateOciObjectStorageConnectionDetails>, <Oci.GoldengateService.Models.CreateKafkaConnectionDetails>, <Oci.GoldengateService.Models.CreateOracleConnectionDetails>, <Oci.GoldengateService.Models.CreateGoldenGateConnectionDetails> of type <Oci.GoldengateService.Models.CreateConnectionDetails>.")]
