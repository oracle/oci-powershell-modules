...
{
    [Cmdlet("Update", "OCIFleetappsmanagementCatalogItem")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.FleetappsmanagementService.Responses.UpdateCatalogItemResponse) })]
    public class UpdateOCIFleetappsmanagementCatalogItem : OCIFleetAppsManagementCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpdateCatalogItem(request).GetAwaiter().GetResult();
        ...
        private UpdateCatalogItemResponse response;
    }
}
