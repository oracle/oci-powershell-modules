...
{
    [Cmdlet("New", "OCIGenerativeaiagentAgentEndpoint")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiagentService.Models.AgentEndpoint), typeof(Oci.GenerativeaiagentService.Responses.CreateAgentEndpointResponse) })]
    public class NewOCIGenerativeaiagentAgentEndpoint : OCIGenerativeAiAgentCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new endpoint.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateAgentEndpointRequest
                {
                ...
                response = client.CreateAgentEndpoint(request).GetAwaiter().GetResult();
        ...
        private CreateAgentEndpointResponse response;
    }
}
