...
{
    [Cmdlet("Update", "OCILoggingLog")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.LoggingService.Responses.UpdateLogResponse) })]
    public class UpdateOCILoggingLog : OCILoggingManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Log config parameters to update.")]
        ...
        private UpdateLogResponse response;
    }
}
