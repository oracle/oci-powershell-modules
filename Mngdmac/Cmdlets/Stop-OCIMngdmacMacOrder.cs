...
{
    [Cmdlet("Stop", "OCIMngdmacMacOrder")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MngdmacService.Responses.CancelMacOrderResponse) })]
    public class StopOCIMngdmacMacOrder : OCIMacOrderCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information to cancel a MacOrder.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelMacOrderRequest
                {
                ...
                response = client.CancelMacOrder(request).GetAwaiter().GetResult();
        ...
        private CancelMacOrderResponse response;
    }
}
