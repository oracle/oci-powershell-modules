...
{
    [Cmdlet("New", "OCIDnsSteeringPolicyAttachment", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.SteeringPolicyAttachment), typeof(Oci.DnsService.Responses.CreateSteeringPolicyAttachmentResponse) })]
    public class NewOCIDnsSteeringPolicyAttachment : OCIDnsCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for creating a new steering policy attachment.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for creating a new steering policy attachment.", ParameterSetName = Default)]
        ...
        private void HandleOutput(CreateSteeringPolicyAttachmentRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForCreateSteeringPolicyAttachment(request, waiterConfig, WaitForStatus).Execute();
                    break;
        ...
        private CreateSteeringPolicyAttachmentResponse response;
