...
{
    [Cmdlet("Disable", "OCIDatabaseExternalContainerDatabaseDatabaseManagement", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DisableExternalContainerDatabaseDatabaseManagementResponse) })]
    public class DisableOCIDatabaseExternalContainerDatabaseDatabaseManagement : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableExternalContainerDatabaseDatabaseManagementRequest
                {
        ...
        private void HandleOutput(DisableExternalContainerDatabaseDatabaseManagementRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDisableExternalContainerDatabaseDatabaseManagement(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DisableExternalContainerDatabaseDatabaseManagement(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DisableExternalContainerDatabaseDatabaseManagementResponse response;
