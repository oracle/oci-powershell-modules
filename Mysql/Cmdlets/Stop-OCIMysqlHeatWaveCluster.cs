...
{
    [Cmdlet("Stop", "OCIMysqlHeatWaveCluster")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.StopHeatWaveClusterResponse) })]
    public class StopOCIMysqlHeatWaveCluster : OCIDbSystemCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StopHeatWaveClusterRequest
                {
                ...
                response = client.StopHeatWaveCluster(request).GetAwaiter().GetResult();
        ...
        private StopHeatWaveClusterResponse response;
    }
}
