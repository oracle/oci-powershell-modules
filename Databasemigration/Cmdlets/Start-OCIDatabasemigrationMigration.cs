...
{
    [Cmdlet("Start", "OCIDatabasemigrationMigration")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemigrationService.Models.Job), typeof(Oci.DatabasemigrationService.Responses.StartMigrationResponse) })]
    public class StartOCIDatabasemigrationMigration : OCIDatabaseMigrationCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Start Migration Job properties.")]
        ...
        private StartMigrationResponse response;
    }
}
