...
{
    public abstract class OCIAccessRequestsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AccessRequestsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AccessRequestsClient client;
