...
namespace Oci.GenerativeaiService.Cmdlets
{
    ...
    public class GetOCIGenerativeaiApiKeysList : OCIGenerativeAiCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the APIKey.")]
