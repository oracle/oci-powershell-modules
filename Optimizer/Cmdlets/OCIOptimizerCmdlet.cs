...
using Oci.OptimizerService;

namespace Oci.OptimizerService.Cmdlets
{
    public abstract class OCIOptimizerCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OptimizerClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OptimizerClient client;
