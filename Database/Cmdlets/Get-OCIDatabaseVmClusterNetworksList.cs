...
{
    [Cmdlet("Get", "OCIDatabaseVmClusterNetworksList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.VmClusterNetworkSummary), typeof(Oci.DatabaseService.Responses.ListVmClusterNetworksResponse) })]
    public class GetOCIDatabaseVmClusterNetworksList : OCIDatabaseCmdlet
    {
        ...
        public System.Nullable<Oci.DatabaseService.Requests.ListVmClusterNetworksRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either ascending (`ASC`) or descending (`DESC`).")]
        public System.Nullable<Oci.DatabaseService.Requests.ListVmClusterNetworksRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatabaseService.Models.VmClusterNetworkSummary.LifecycleStateEnum> LifecycleState { get; set; }
