...
{
    [Cmdlet("Invoke", "OCIKeymanagementInitiateAuditLogging")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.AuditLogging), typeof(Oci.KeymanagementService.Responses.InitiateAuditLoggingResponse) })]
    public class InvokeOCIKeymanagementInitiateAuditLogging : OCIKmsHsmClusterCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new InitiateAuditLoggingRequest
                {
                ...
                response = client.InitiateAuditLogging(request).GetAwaiter().GetResult();
        ...
        private InitiateAuditLoggingResponse response;
    }
}
