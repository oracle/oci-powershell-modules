...
Example: `example_backend_set`")]
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The name of the backend server to retrieve. This is specified as <ip>:<port>, or as <ip> <OCID>:<port>.
