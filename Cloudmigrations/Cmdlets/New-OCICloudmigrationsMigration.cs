...
{
    [Cmdlet("New", "OCICloudmigrationsMigration")]
    [OutputType(new System.Type[] { typeof(Oci.CloudmigrationsService.Models.Migration), typeof(Oci.CloudmigrationsService.Responses.CreateMigrationResponse) })]
    public class NewOCICloudmigrationsMigration : OCIMigrationCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new migration.")]
