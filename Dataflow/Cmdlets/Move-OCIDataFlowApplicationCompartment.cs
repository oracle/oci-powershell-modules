...
{
    [Cmdlet("Move", "OCIDataFlowApplicationCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataflowService.Responses.ChangeApplicationCompartmentResponse) })]
    public class MoveOCIDataFlowApplicationCompartment : OCIDataFlowCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique ID for an application.")]
        public string ApplicationId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for changing an application's compartment.")]
        ...
        private ChangeApplicationCompartmentResponse response;
    }
}
