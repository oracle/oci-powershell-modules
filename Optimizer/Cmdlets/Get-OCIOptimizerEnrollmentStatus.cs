...
{
    [Cmdlet("Get", "OCIOptimizerEnrollmentStatus", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OptimizerService.Models.EnrollmentStatus), typeof(Oci.OptimizerService.Responses.GetEnrollmentStatusResponse) })]
    public class GetOCIOptimizerEnrollmentStatus : OCIOptimizerCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique OCID associated with the enrollment status.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique OCID associated with the enrollment status.", ParameterSetName = Default)]
        ...
        private GetEnrollmentStatusResponse response;
