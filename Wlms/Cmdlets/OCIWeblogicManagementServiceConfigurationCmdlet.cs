...
using Oci.WlmsService;

namespace Oci.WlmsService.Cmdlets
{
    public abstract class OCIWeblogicManagementServiceConfigurationCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new WeblogicManagementServiceConfigurationClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected WeblogicManagementServiceConfigurationClient client;
