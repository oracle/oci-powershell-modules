...
{
    [Cmdlet("Invoke", "OCICloudmigrationsRefreshMigrationAsset")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CloudmigrationsService.Responses.RefreshMigrationAssetResponse) })]
    public class InvokeOCICloudmigrationsRefreshMigrationAsset : OCIMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RefreshMigrationAssetRequest
                {
                ...
                response = client.RefreshMigrationAsset(request).GetAwaiter().GetResult();
        ...
        private RefreshMigrationAssetResponse response;
    }
}
