...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchCloudGates")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.CloudGates), typeof(Oci.IdentitydomainsService.Responses.SearchCloudGatesResponse) })]
    public class InvokeOCIIdentitydomainsSearchCloudGates : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching CloudGates")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchCloudGatesRequest
                {
                ...
                response = client.SearchCloudGates(request).GetAwaiter().GetResult();
                WriteOutput(response, response.CloudGates);
        ...
        private SearchCloudGatesResponse response;
    }
}
