...
{
    public abstract class OCIGetEnrichmentJobCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new GetEnrichmentJobClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected GetEnrichmentJobClient client;
