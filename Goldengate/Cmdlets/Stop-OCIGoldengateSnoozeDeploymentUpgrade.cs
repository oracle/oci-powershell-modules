...
{
    [Cmdlet("Stop", "OCIGoldengateSnoozeDeploymentUpgrade")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.GoldengateService.Responses.CancelSnoozeDeploymentUpgradeResponse) })]
    public class StopOCIGoldengateSnoozeDeploymentUpgrade : OCIGoldenGateCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A placeholder for any additional metadata to describe the cancel snooze of deployment upgrade. This parameter also accepts subtype <Oci.GoldengateService.Models.DefaultCancelSnoozeDeploymentUpgradeDetails> of type <Oci.GoldengateService.Models.CancelSnoozeDeploymentUpgradeDetails>.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelSnoozeDeploymentUpgradeRequest
                {
                ...
                response = client.CancelSnoozeDeploymentUpgrade(request).GetAwaiter().GetResult();
        ...
        private CancelSnoozeDeploymentUpgradeResponse response;
    }
}
