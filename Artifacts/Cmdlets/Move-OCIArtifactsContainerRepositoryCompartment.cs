...
{
    [Cmdlet("Move", "OCIArtifactsContainerRepositoryCompartment")]
...
Example: `ocid1.containerrepo.oc1..exampleuniqueID`")]
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Change container repository compartment details.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeContainerRepositoryCompartmentRequest
                {
                ...
                response = client.ChangeContainerRepositoryCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeContainerRepositoryCompartmentResponse response;
    }
}
