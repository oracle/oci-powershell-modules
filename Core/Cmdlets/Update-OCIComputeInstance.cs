...
{
    [Cmdlet("Update", "OCIComputeInstance", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.Instance), typeof(Oci.CoreService.Responses.UpdateInstanceResponse) })]
    public class UpdateOCIComputeInstance : OCIComputeCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Update instance fields", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Update instance fields", ParameterSetName = Default)]
        ...
        private UpdateInstanceResponse response;
