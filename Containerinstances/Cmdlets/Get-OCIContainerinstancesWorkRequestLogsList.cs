...
{
    [Cmdlet("Get", "OCIContainerinstancesWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.ContainerinstancesService.Models.WorkRequestLogEntryCollection), typeof(Oci.ContainerinstancesService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIContainerinstancesWorkRequestLogsList : OCIContainerInstanceCmdlet
    {
        ...
        public System.Nullable<Oci.ContainerinstancesService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
