...
{
    [Cmdlet("Get", "OCIDataFlowWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DataflowService.Models.WorkRequest), typeof(Oci.DataflowService.Responses.GetWorkRequestResponse) })]
    public class GetOCIDataFlowWorkRequest : OCIDataFlowCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique ID for a work request.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique ID for a work request.", ParameterSetName = Default)]
        ...
        public Oci.DataflowService.Models.WorkRequestStatus[] WaitForStatus { get; set; }
