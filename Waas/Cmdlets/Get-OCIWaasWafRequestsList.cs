...
{
    [Cmdlet("Get", "OCIWaasWafRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.WaasService.Models.WafRequest), typeof(Oci.WaasService.Responses.ListWafRequestsResponse) })]
    public class GetOCIWaasWafRequestsList : OCIWaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListWafRequestsRequest
                {
                ...
                IEnumerable<ListWafRequestsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListWafRequestsResponse> DefaultRequest(ListWafRequestsRequest request) => Enumerable.Repeat(client.ListWafRequests(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListWafRequestsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListWafRequestsResponse response;
        private delegate IEnumerable<ListWafRequestsResponse> RequestDelegate(ListWafRequestsRequest request);
