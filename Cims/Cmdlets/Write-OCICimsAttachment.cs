...
{
    [Cmdlet("Write", "OCICimsAttachment")]
    [OutputType(new System.Type[] { typeof(Oci.CimsService.Models.Incident), typeof(Oci.CimsService.Responses.PutAttachmentResponse) })]
    public class WriteOCICimsAttachment : OCIIncidentCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"File to be uploaded as attachment to the Service Request.", ParameterSetName = FromStreamSet)]
        public System.IO.Stream PutAttachmentDetails { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Use this parameter to provide the file location from where the input stream to be read. File to be uploaded as attachment to the Service Request.", ParameterSetName = FromFileSet)]
        public String PutAttachmentDetailsFromFile { get; set; }
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The name of the file to attach to the support request. Avoid entering confidential information.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                PutAttachmentDetails = System.IO.File.OpenRead(GetAbsoluteFilePath(PutAttachmentDetailsFromFile));
            }
            

            try
            {
                request = new PutAttachmentRequest
                {
                    PutAttachmentDetails = PutAttachmentDetails,
                ...
                response = client.PutAttachment(request).GetAwaiter().GetResult();
        ...
        private PutAttachmentResponse response;
