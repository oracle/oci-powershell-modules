...
{
    [Cmdlet("Get", "OCIIdentitydomainsAccountRecoverySettingsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.AccountRecoverySettings), typeof(Oci.IdentitydomainsService.Responses.ListAccountRecoverySettingsResponse) })]
    public class GetOCIIdentitydomainsAccountRecoverySettingsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ListAccountRecoverySettings(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AccountRecoverySettings);
        ...
        private ListAccountRecoverySettingsResponse response;
    }
}
