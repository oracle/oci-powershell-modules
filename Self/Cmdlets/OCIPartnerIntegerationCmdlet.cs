...
{
    public abstract class OCIPartnerIntegerationCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new PartnerIntegerationClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected PartnerIntegerationClient client;
