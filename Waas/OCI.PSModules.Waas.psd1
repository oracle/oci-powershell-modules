...
GUID = 'f7b9f098-60ec-4b23-b1dc-c577f3acc658'
...
CmdletsToExport = 'Get-OCIRedirectHttpRedirect', 'Get-OCIRedirectHttpRedirectsList', 
               'Get-OCIWaasAccessRulesList', 'Get-OCIWaasAddressList', 
               ...
               'Invoke-OCIWaasPurgeCache', 
               'Move-OCIRedirectHttpRedirectCompartment', 
               'Move-OCIWaasAddressListCompartment', 
               'Move-OCIWaasCertificateCompartment', 
               'Move-OCIWaasCustomProtectionRuleCompartment', 
               'Move-OCIWaasPolicyCompartment', 'New-OCIRedirectHttpRedirect', 
               'New-OCIWaasAddressList', 'New-OCIWaasCertificate', 
               'New-OCIWaasCustomProtectionRule', 'New-OCIWaasPolicy', 
               'Receive-OCIWaasRecommendations', 'Remove-OCIRedirectHttpRedirect', 
               'Remove-OCIWaasAddressList', 'Remove-OCIWaasCertificate', 
               'Remove-OCIWaasCustomProtectionRule', 'Remove-OCIWaasPolicy', 
               'Stop-OCIWaasWorkRequest', 'Update-OCIRedirectHttpRedirect', 
               'Update-OCIWaasAccessRules', 'Update-OCIWaasAddressList', 
               'Update-OCIWaasCachingRules', 'Update-OCIWaasCaptchas', 
               'Update-OCIWaasCertificate', 'Update-OCIWaasCustomProtectionRule', 
               'Update-OCIWaasDeviceFingerprintChallenge', 
               'Update-OCIWaasGoodBots', 'Update-OCIWaasHumanInteractionChallenge', 
