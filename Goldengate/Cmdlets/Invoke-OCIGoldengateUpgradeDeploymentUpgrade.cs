...
namespace Oci.GoldengateService.Cmdlets
{
    ...
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.UpgradeDeploymentUpgradeResponse) })]
    public class InvokeOCIGoldengateUpgradeDeploymentUpgrade : OCIGoldenGateCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A placeholder for any additional metadata to describe the deployment upgrade. This parameter also accepts subtype <Oci.GoldengateService.Models.DefaultUpgradeDeploymentUpgradeDetails> of type <Oci.GoldengateService.Models.UpgradeDeploymentUpgradeDetails>.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpgradeDeploymentUpgradeRequest
                {
                ...
                response = client.UpgradeDeploymentUpgrade(request).GetAwaiter().GetResult();
        ...
        private UpgradeDeploymentUpgradeResponse response;
    }
}
