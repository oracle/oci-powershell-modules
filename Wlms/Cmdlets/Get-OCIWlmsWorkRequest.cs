...
{
    [Cmdlet("Get", "OCIWlmsWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.WlmsService.Models.WorkRequest), typeof(Oci.WlmsService.Responses.GetWorkRequestResponse) })]
    public class GetOCIWlmsWorkRequest : OCIWeblogicManagementServiceCmdlet
    {
        ...
        public Oci.WlmsService.Models.OperationStatus[] WaitForStatus { get; set; }
