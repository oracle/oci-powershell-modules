...
{
    [Cmdlet("Get", "OCIQueueWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.QueueService.Models.WorkRequest), typeof(Oci.QueueService.Responses.GetWorkRequestResponse) })]
    public class GetOCIQueueWorkRequest : OCIQueueAdminCmdlet
    {
        ...
        public Oci.QueueService.Models.OperationStatus[] WaitForStatus { get; set; }
