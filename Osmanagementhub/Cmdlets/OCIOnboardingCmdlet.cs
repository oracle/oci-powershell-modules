...
{
    public abstract class OCIOnboardingCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OnboardingClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OnboardingClient client;
