...
{
    [Cmdlet("Move", "OCIDnsZoneCompartment", DefaultParameterSetName = Default)]
    ...
    public class MoveOCIDnsZoneCompartment : OCIDnsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for moving a zone into a different compartment.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for moving a zone into a different compartment.", ParameterSetName = Default)]
        ...
        private void HandleOutput(ChangeZoneCompartmentRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForChangeZoneCompartment(request, waiterConfig, WaitForStatus).Execute();
                    break;
        ...
        private ChangeZoneCompartmentResponse response;
