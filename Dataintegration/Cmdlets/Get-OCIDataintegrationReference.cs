...
{
    [Cmdlet("Get", "OCIDataintegrationReference")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.Reference), typeof(Oci.DataintegrationService.Responses.GetReferenceResponse) })]
    public class GetOCIDataintegrationReference : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GetReference(request).GetAwaiter().GetResult();
        ...
        private GetReferenceResponse response;
    }
}
