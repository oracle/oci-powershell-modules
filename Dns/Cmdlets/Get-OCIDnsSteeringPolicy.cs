...
{
    [Cmdlet("Get", "OCIDnsSteeringPolicy", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.SteeringPolicy), typeof(Oci.DnsService.Responses.GetSteeringPolicyResponse) })]
    public class GetOCIDnsSteeringPolicy : OCIDnsCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the target steering policy.", ParameterSetName = LifecycleStateParamSet)]
        ...
        public Oci.DnsService.Models.SteeringPolicy.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetSteeringPolicyRequest
                {
        ...
        private void HandleOutput(GetSteeringPolicyRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForSteeringPolicy(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetSteeringPolicy(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.SteeringPolicy);
        }

        private GetSteeringPolicyResponse response;
