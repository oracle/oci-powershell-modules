...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyCustomerSecretKey")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyCustomerSecretKey), typeof(Oci.IdentitydomainsService.Responses.GetMyCustomerSecretKeyResponse) })]
    public class GetOCIIdentitydomainsMyCustomerSecretKey : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMyCustomerSecretKeyRequest
                {
                ...
                response = client.GetMyCustomerSecretKey(request).GetAwaiter().GetResult();
        ...
        private GetMyCustomerSecretKeyResponse response;
    }
}
