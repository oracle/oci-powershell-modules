...
{
    [Cmdlet("Stop", "OCIAdmWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AdmService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIAdmWorkRequest : OCIApplicationDependencyManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAdmWorkRequest", "Stop"))
            {
               return;
            }
