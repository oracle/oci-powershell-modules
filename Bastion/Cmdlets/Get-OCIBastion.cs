...
{
    [Cmdlet("Get", "OCIBastion", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.BastionService.Models.Bastion), typeof(Oci.BastionService.Responses.GetBastionResponse) })]
    public class GetOCIBastion : OCIBastionCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique identifier (OCID) of the bastion.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique identifier (OCID) of the bastion.", ParameterSetName = Default)]
        ...
        public Oci.BastionService.Models.BastionLifecycleState[] WaitForLifecycleState { get; set; }
        ...
        private GetBastionResponse response;
