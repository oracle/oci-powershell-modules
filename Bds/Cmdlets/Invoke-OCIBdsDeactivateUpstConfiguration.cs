...
{
    [Cmdlet("Invoke", "OCIBdsDeactivateUpstConfiguration")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.BdsService.Responses.DeactivateUpstConfigurationResponse) })]
    public class InvokeOCIBdsDeactivateUpstConfiguration : OCIBdsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for deactivating the UPST config")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.DeactivateUpstConfiguration(request).GetAwaiter().GetResult();
        ...
        private DeactivateUpstConfigurationResponse response;
    }
}
