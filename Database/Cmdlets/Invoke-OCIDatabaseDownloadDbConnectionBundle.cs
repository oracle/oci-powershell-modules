...
namespace Oci.DatabaseService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIDatabaseDownloadDbConnectionBundle", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatabaseService.Responses.DownloadDbConnectionBundleResponse) })]
    public class InvokeOCIDatabaseDownloadDbConnectionBundle : OCIDatabaseCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the database connection bundle.")]
        public string DbConnectionBundleId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to download a database connection bundle.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DownloadDbConnectionBundleRequest
                {
                ...
                response = client.DownloadDbConnectionBundle(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private DownloadDbConnectionBundleResponse response;
