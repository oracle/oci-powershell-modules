...
{
    [Cmdlet("Update", "OCIGenerativeaiagentTool")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GenerativeaiagentService.Responses.UpdateToolResponse) })]
    public class UpdateOCIGenerativeaiagentTool : OCIGenerativeAiAgentCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpdateTool(request).GetAwaiter().GetResult();
        ...
        private UpdateToolResponse response;
    }
}
