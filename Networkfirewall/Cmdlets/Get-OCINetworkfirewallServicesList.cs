...
{
    [Cmdlet("Get", "OCINetworkfirewallServicesList")]
    [OutputType(new System.Type[] { typeof(Oci.NetworkfirewallService.Models.ServiceSummaryCollection), typeof(Oci.NetworkfirewallService.Responses.ListServicesResponse) })]
    public class GetOCINetworkfirewallServicesList : OCINetworkFirewallCmdlet
    {
        ...
        public System.Nullable<Oci.NetworkfirewallService.Requests.ListServicesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    response = item;
                    WriteOutput(response, response.ServiceSummaryCollection, true);
                }
