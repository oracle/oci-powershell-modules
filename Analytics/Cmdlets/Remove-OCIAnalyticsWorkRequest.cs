...
{
    [Cmdlet("Remove", "OCIAnalyticsWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AnalyticsService.Responses.DeleteWorkRequestResponse) })]
    public class RemoveOCIAnalyticsWorkRequest : OCIAnalyticsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAnalyticsWorkRequest", "Remove"))
            {
               return;
            }
