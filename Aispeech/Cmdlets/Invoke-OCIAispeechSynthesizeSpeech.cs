...
namespace Oci.AispeechService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIAispeechSynthesizeSpeech", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.AispeechService.Responses.SynthesizeSpeechResponse) })]
    public class InvokeOCIAispeechSynthesizeSpeech : OCIAIServiceSpeechCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The request to be sent to the TTS service to get required inference audio.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.SynthesizeSpeech(request).GetAwaiter().GetResult();
                HandleOutput();
