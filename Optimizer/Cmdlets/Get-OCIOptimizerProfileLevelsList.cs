...
{
    [Cmdlet("Get", "OCIOptimizerProfileLevelsList")]
    [OutputType(new System.Type[] { typeof(Oci.OptimizerService.Models.ProfileLevelCollection), typeof(Oci.OptimizerService.Responses.ListProfileLevelsResponse) })]
    public class GetOCIOptimizerProfileLevelsList : OCIOptimizerCmdlet
    {
...
Can only be set to true when performing ListCompartments on the tenancy (root compartment).")]
        ...
        public System.Nullable<Oci.OptimizerService.Requests.ListProfileLevelsRequest.SortByEnum> SortBy { get; set; }
        ...
        {
            IEnumerable<ListProfileLevelsResponse> DefaultRequest(ListProfileLevelsRequest request) => Enumerable.Repeat(client.ListProfileLevels(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListProfileLevelsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListProfileLevelsResponse response;
        private delegate IEnumerable<ListProfileLevelsResponse> RequestDelegate(ListProfileLevelsRequest request);
