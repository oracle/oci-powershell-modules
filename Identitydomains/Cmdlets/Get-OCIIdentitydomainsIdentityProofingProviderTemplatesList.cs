...
{
    [Cmdlet("Get", "OCIIdentitydomainsIdentityProofingProviderTemplatesList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.IdentityProofingProviderTemplates), typeof(Oci.IdentitydomainsService.Responses.ListIdentityProofingProviderTemplatesResponse) })]
    public class GetOCIIdentitydomainsIdentityProofingProviderTemplatesList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListIdentityProofingProviderTemplatesRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListIdentityProofingProviderTemplates(request).GetAwaiter().GetResult();
                WriteOutput(response, response.IdentityProofingProviderTemplates);
        ...
        private ListIdentityProofingProviderTemplatesResponse response;
    }
}
