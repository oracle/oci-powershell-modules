...
using Oci.IntegrationService;

namespace Oci.IntegrationService.Cmdlets
{
    public abstract class OCIIntegrationInstanceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new IntegrationInstanceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected IntegrationInstanceClient client;
