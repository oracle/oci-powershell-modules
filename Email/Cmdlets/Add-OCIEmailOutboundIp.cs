...
{
    [Cmdlet("Add", "OCIEmailOutboundIp")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.EmailService.Responses.AddEmailOutboundIpResponse) })]
    public class AddOCIEmailOutboundIp : OCIEmailCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details to add IPs to EmailIpPool.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddEmailOutboundIpRequest
                {
                ...
                response = client.AddEmailOutboundIp(request).GetAwaiter().GetResult();
        ...
        private AddEmailOutboundIpResponse response;
    }
}
