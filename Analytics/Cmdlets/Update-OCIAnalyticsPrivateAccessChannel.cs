...
{
    [Cmdlet("Update", "OCIAnalyticsPrivateAccessChannel")]
    ...
    public class UpdateOCIAnalyticsPrivateAccessChannel : OCIAnalyticsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdatePrivateAccessChannelRequest
                {
                ...
                response = client.UpdatePrivateAccessChannel(request).GetAwaiter().GetResult();
        ...
        private UpdatePrivateAccessChannelResponse response;
    }
}
