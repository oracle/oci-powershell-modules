...
using Oci.ApiplatformService;

namespace Oci.ApiplatformService.Cmdlets
{
    public abstract class OCIApiPlatformCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ApiPlatformClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
