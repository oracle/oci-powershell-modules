...
{
    [Cmdlet("Move", "OCIGenerativeaiModelCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.GenerativeaiService.Responses.ChangeModelCompartmentResponse) })]
    public class MoveOCIGenerativeaiModelCompartment : OCIGenerativeAiCmdlet
    {
