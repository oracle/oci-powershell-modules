...
{
    [Cmdlet("Invoke", "OCIDistributeddatabaseConfigureDistributedAutonomousDatabaseSharding")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.ConfigureDistributedAutonomousDatabaseShardingResponse) })]
    public class InvokeOCIDistributeddatabaseConfigureDistributedAutonomousDatabaseSharding : OCIDistributedAutonomousDbServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ConfigureDistributedAutonomousDatabaseSharding(request).GetAwaiter().GetResult();
        ...
        private ConfigureDistributedAutonomousDatabaseShardingResponse response;
    }
}
