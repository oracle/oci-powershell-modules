...
{
    [Cmdlet("Invoke", "OCIOsmanagementhubRefreshSoftwareOnManagedInstanceGroup")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OsmanagementhubService.Responses.RefreshSoftwareOnManagedInstanceGroupResponse) })]
    public class InvokeOCIOsmanagementhubRefreshSoftwareOnManagedInstanceGroup : OCIManagedInstanceGroupCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.RefreshSoftwareOnManagedInstanceGroup(request).GetAwaiter().GetResult();
        ...
        private RefreshSoftwareOnManagedInstanceGroupResponse response;
    }
}
