...
{
    [Cmdlet("Remove", "OCINetworkloadbalancerListener", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NetworkloadbalancerService.Responses.DeleteListenerResponse) })]
    public class RemoveOCINetworkloadbalancerListener : OCINetworkLoadBalancerCmdlet
    {
...
Example: `example_listener`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCINetworkloadbalancerListener", "Remove"))
            {
               return;
            }
