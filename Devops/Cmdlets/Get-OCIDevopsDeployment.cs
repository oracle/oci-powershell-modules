...
{
    [Cmdlet("Get", "OCIDevopsDeployment", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.Deployment), typeof(Oci.DevopsService.Responses.GetDeploymentResponse) })]
    public class GetOCIDevopsDeployment : OCIDevopsCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique deployment identifier.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique deployment identifier.", ParameterSetName = Default)]
        ...
        public Oci.DevopsService.Models.Deployment.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
