...
{
    [Cmdlet("Get", "OCIIdentitydomainsBrandingSetting")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.BrandingSetting), typeof(Oci.IdentitydomainsService.Responses.GetBrandingSettingResponse) })]
    public class GetOCIIdentitydomainsBrandingSetting : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetBrandingSettingRequest
                {
                ...
                response = client.GetBrandingSetting(request).GetAwaiter().GetResult();
                WriteOutput(response, response.BrandingSetting);
        ...
        private GetBrandingSettingResponse response;
    }
}
