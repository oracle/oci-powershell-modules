...
{
    [Cmdlet("Complete", "OCIContainerengineCredentialRotation")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ContainerengineService.Responses.CompleteCredentialRotationResponse) })]
    public class CompleteOCIContainerengineCredentialRotation : OCIContainerEngineCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CompleteCredentialRotationRequest
                {
                    ClusterId = ClusterId,
                ...
                response = client.CompleteCredentialRotation(request).GetAwaiter().GetResult();
        ...
        private CompleteCredentialRotationResponse response;
    }
}
