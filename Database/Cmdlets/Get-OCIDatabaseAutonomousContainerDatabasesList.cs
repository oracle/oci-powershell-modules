...
{
    [Cmdlet("Get", "OCIDatabaseAutonomousContainerDatabasesList")]
    ...
    public class GetOCIDatabaseAutonomousContainerDatabasesList : OCIDatabaseCmdlet
    {
        ...
        public System.Nullable<Oci.DatabaseService.Models.AutonomousContainerDatabaseSummary.InfrastructureTypeEnum> InfrastructureType { get; set; }
...
**Note:** If you do not include the availability domain filter, the resources are grouped by availability domain, then sorted.")]
        public System.Nullable<Oci.DatabaseService.Requests.ListAutonomousContainerDatabasesRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either ascending (`ASC`) or descending (`DESC`).")]
        public System.Nullable<Oci.DatabaseService.Requests.ListAutonomousContainerDatabasesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatabaseService.Models.AutonomousContainerDatabaseSummary.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAutonomousContainerDatabasesRequest
                {
        ...
        {
            IEnumerable<ListAutonomousContainerDatabasesResponse> DefaultRequest(ListAutonomousContainerDatabasesRequest request) => Enumerable.Repeat(client.ListAutonomousContainerDatabases(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAutonomousContainerDatabasesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAutonomousContainerDatabasesResponse response;
        private delegate IEnumerable<ListAutonomousContainerDatabasesResponse> RequestDelegate(ListAutonomousContainerDatabasesRequest request);
