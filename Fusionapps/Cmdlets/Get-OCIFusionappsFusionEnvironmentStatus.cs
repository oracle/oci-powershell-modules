...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class GetOCIFusionappsFusionEnvironmentStatus : OCIFusionApplicationsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetFusionEnvironmentStatusRequest
                {
                    FusionEnvironmentId = FusionEnvironmentId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetFusionEnvironmentStatus(request).GetAwaiter().GetResult();
                WriteOutput(response, response.FusionEnvironmentStatus);
        ...
        private GetFusionEnvironmentStatusResponse response;
    }
}
