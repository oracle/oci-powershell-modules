...
{
    [Cmdlet("Get", "OCIDatasafeSecurityPoliciesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.SecurityPolicyCollection), typeof(Oci.DatasafeService.Responses.ListSecurityPoliciesResponse) })]
    public class GetOCIDatasafeSecurityPoliciesList : OCIDataSafeCmdlet
    {
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSecurityPoliciesRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSecurityPoliciesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSecurityPoliciesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListSecurityPoliciesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.SecurityPolicyCollection, true);
                }
        ...
        {
            IEnumerable<ListSecurityPoliciesResponse> DefaultRequest(ListSecurityPoliciesRequest request) => Enumerable.Repeat(client.ListSecurityPolicies(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSecurityPoliciesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSecurityPoliciesResponse response;
        private delegate IEnumerable<ListSecurityPoliciesResponse> RequestDelegate(ListSecurityPoliciesRequest request);
