...
{
    [Cmdlet("Get", "OCIOsmanagementhubProfileVersion")]
    ...
    public class GetOCIOsmanagementhubProfileVersion : OCIOnboardingCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetProfileVersionRequest
                {
                    ProfileId = ProfileId,
                ...
                response = client.GetProfileVersion(request).GetAwaiter().GetResult();
                WriteOutput(response, response.ProfileVersion);
        ...
        private GetProfileVersionResponse response;
    }
}
