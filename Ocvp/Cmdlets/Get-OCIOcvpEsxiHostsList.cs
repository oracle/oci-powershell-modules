...
{
    [Cmdlet("Get", "OCIOcvpEsxiHostsList")]
    [OutputType(new System.Type[] { typeof(Oci.OcvpService.Models.EsxiHostCollection), typeof(Oci.OcvpService.Responses.ListEsxiHostsResponse) })]
    public class GetOCIOcvpEsxiHostsList : OCIEsxiHostCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the Compute instance.")]
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by availability domain if the scope of the resource type is within a single availability domain. If you call one of these ""List"" operations without specifying an availability domain, the resources are grouped by availability domain, then sorted.")]
        public System.Nullable<Oci.OcvpService.Requests.ListEsxiHostsRequest.SortByEnum> SortBy { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment as optional parameter.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListEsxiHostsRequest
                {
                    SddcId = SddcId,
                    ClusterId = ClusterId,
                ...
                {
                    response = item;
                    WriteOutput(response, response.EsxiHostCollection, true);
                }
        ...
        {
            IEnumerable<ListEsxiHostsResponse> DefaultRequest(ListEsxiHostsRequest request) => Enumerable.Repeat(client.ListEsxiHosts(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListEsxiHostsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListEsxiHostsResponse response;
        private delegate IEnumerable<ListEsxiHostsResponse> RequestDelegate(ListEsxiHostsRequest request);
