...
{
    [Cmdlet("Get", "OCIDatabasemanagementCloudDbSystemsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.CloudDbSystemCollection), typeof(Oci.DatabasemanagementService.Responses.ListCloudDbSystemsResponse) })]
    public class GetOCIDatabasemanagementCloudDbSystemsList : OCIDbManagementCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the dbaas parent infrastructure of the cloud DB system.")]
        public string DbaasParentInfrastructureId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return cloud DB systems of the specified deployment type.")]
        public System.Nullable<Oci.DatabasemanagementService.Models.CloudDbSystemDeploymentType> DeploymentType { get; set; }
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListCloudDbSystemsRequest.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListCloudDbSystemsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListCloudDbSystemsRequest
                {
                ...
                IEnumerable<ListCloudDbSystemsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.CloudDbSystemCollection, true);
                }
        ...
        {
            IEnumerable<ListCloudDbSystemsResponse> DefaultRequest(ListCloudDbSystemsRequest request) => Enumerable.Repeat(client.ListCloudDbSystems(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListCloudDbSystemsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListCloudDbSystemsResponse response;
        private delegate IEnumerable<ListCloudDbSystemsResponse> RequestDelegate(ListCloudDbSystemsRequest request);
