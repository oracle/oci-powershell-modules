...
{
    [Cmdlet("Invoke", "OCIDatabaseEditAutonomousContainerDatabaseDataguard", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousContainerDatabase), typeof(Oci.DatabaseService.Responses.EditAutonomousContainerDatabaseDataguardResponse) })]
    public class InvokeOCIDatabaseEditAutonomousContainerDatabaseDataguard : OCIDatabaseCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request Edit Autonomous Container Database Dataguard.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request Edit Autonomous Container Database Dataguard.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new EditAutonomousContainerDatabaseDataguardRequest
                {
        ...
        private void HandleOutput(EditAutonomousContainerDatabaseDataguardRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForEditAutonomousContainerDatabaseDataguard(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.EditAutonomousContainerDatabaseDataguard(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousContainerDatabase);
        }

        private EditAutonomousContainerDatabaseDataguardResponse response;
