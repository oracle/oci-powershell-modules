...
{
    [Cmdlet("Get", "OCIBastionWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.BastionService.Models.WorkRequestError), typeof(Oci.BastionService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIBastionWorkRequestErrorsList : OCIBastionCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique identifier (OCID) of the asynchronous request.")]
