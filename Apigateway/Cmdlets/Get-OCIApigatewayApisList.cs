...
{
    [Cmdlet("Get", "OCIApigatewayApisList")]
    [OutputType(new System.Type[] { typeof(Oci.ApigatewayService.Models.ApiCollection), typeof(Oci.ApigatewayService.Responses.ListApisResponse) })]
    public class GetOCIApigatewayApisList : OCIApiGatewayCmdlet
    {
...
Example: `ACTIVE`")]
        public System.Nullable<Oci.ApigatewayService.Models.ApiSummary.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.ApigatewayService.Requests.ListApisRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.ApigatewayService.Requests.ListApisRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListApisResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListApisResponse> DefaultRequest(ListApisRequest request) => Enumerable.Repeat(client.ListApis(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListApisResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListApisResponse response;
        private delegate IEnumerable<ListApisResponse> RequestDelegate(ListApisRequest request);
