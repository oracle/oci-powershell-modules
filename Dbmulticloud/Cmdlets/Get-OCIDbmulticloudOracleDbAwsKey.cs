...
namespace Oci.DbmulticloudService.Cmdlets
{
    ...
    public class GetOCIDbmulticloudOracleDbAwsKey : OCIDbMulticloudAwsProviderCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the Oracle DB AWS Key resource.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the Oracle DB AWS Key resource.", ParameterSetName = Default)]
