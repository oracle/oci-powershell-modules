...
{
    public abstract class OCIDistributedDbPrivateEndpointServiceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DistributedDbPrivateEndpointServiceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DistributedDbPrivateEndpointServiceClient client;
