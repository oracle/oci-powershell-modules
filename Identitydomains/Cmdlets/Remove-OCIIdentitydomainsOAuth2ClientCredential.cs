...
{
    [Cmdlet("Remove", "OCIIdentitydomainsOAuth2ClientCredential", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteOAuth2ClientCredentialResponse) })]
    public class RemoveOCIIdentitydomainsOAuth2ClientCredential : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsOAuth2ClientCredential", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteOAuth2ClientCredentialRequest
                {
                ...
                response = client.DeleteOAuth2ClientCredential(request).GetAwaiter().GetResult();
        ...
        private DeleteOAuth2ClientCredentialResponse response;
    }
}
