...
{
    [Cmdlet("Get", "OCIDataintegrationRuntimePipeline")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.RuntimePipeline), typeof(Oci.DataintegrationService.Responses.GetRuntimePipelineResponse) })]
    public class GetOCIDataintegrationRuntimePipeline : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetRuntimePipelineRequest
                {
                ...
                response = client.GetRuntimePipeline(request).GetAwaiter().GetResult();
                WriteOutput(response, response.RuntimePipeline);
        ...
        private GetRuntimePipelineResponse response;
    }
}
