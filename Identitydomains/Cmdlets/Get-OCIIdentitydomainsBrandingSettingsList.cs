...
{
    [Cmdlet("Get", "OCIIdentitydomainsBrandingSettingsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.BrandingSettings), typeof(Oci.IdentitydomainsService.Responses.ListBrandingSettingsResponse) })]
    public class GetOCIIdentitydomainsBrandingSettingsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListBrandingSettingsRequest
                {
                ...
                response = client.ListBrandingSettings(request).GetAwaiter().GetResult();
                WriteOutput(response, response.BrandingSettings);
        ...
        private ListBrandingSettingsResponse response;
    }
}
