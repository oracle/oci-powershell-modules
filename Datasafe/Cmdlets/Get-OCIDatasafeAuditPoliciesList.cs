...
{
    [Cmdlet("Get", "OCIDatasafeAuditPoliciesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.AuditPolicyCollection), typeof(Oci.DatasafeService.Responses.ListAuditPoliciesResponse) })]
    public class GetOCIDatasafeAuditPoliciesList : OCIDataSafeCmdlet
    {
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListAuditPoliciesRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"An optional filter to return only resources that match the specified id.")]
        public string AuditPolicyId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either ascending (ASC) or descending (DESC).")]
        public System.Nullable<Oci.DatasafeService.Requests.ListAuditPoliciesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListAuditPoliciesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAuditPoliciesRequest
                {
                ...
                IEnumerable<ListAuditPoliciesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.AuditPolicyCollection, true);
                }
        ...
        {
            IEnumerable<ListAuditPoliciesResponse> DefaultRequest(ListAuditPoliciesRequest request) => Enumerable.Repeat(client.ListAuditPolicies(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAuditPoliciesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAuditPoliciesResponse response;
        private delegate IEnumerable<ListAuditPoliciesResponse> RequestDelegate(ListAuditPoliciesRequest request);
