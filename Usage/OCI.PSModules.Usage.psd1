...
CmdletsToExport = 'Get-OCIUsageProductsList', 'Get-OCIUsageRedeemableUsersList', 
               'Get-OCIUsageRedemptionsList', 'Get-OCIUsageRewardsList', 
               'New-OCIUsageRedeemableUser', 'Remove-OCIUsageRedeemableUser'
