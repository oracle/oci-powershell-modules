...
{
    [Cmdlet("Get", "OCIStackmonitoringWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.StackmonitoringService.Models.WorkRequest), typeof(Oci.StackmonitoringService.Responses.GetWorkRequestResponse) })]
    public class GetOCIStackmonitoringWorkRequest : OCIStackMonitoringCmdlet
    {
        ...
        public Oci.StackmonitoringService.Models.OperationStatus[] WaitForStatus { get; set; }
