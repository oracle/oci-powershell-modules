...
{
    public abstract class OCIDistributedAutonomousDbServiceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DistributedAutonomousDbServiceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DistributedAutonomousDbServiceClient client;
