...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyRequest")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyRequest), typeof(Oci.IdentitydomainsService.Responses.GetMyRequestResponse) })]
    public class GetOCIIdentitydomainsMyRequest : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMyRequestRequest
                {
                ...
                response = client.GetMyRequest(request).GetAwaiter().GetResult();
        ...
        private GetMyRequestResponse response;
    }
}
