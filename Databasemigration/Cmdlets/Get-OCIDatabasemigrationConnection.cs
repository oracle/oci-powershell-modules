...
{
    [Cmdlet("Get", "OCIDatabasemigrationConnection", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemigrationService.Models.Connection), typeof(Oci.DatabasemigrationService.Responses.GetConnectionResponse) })]
    public class GetOCIDatabasemigrationConnection : OCIDatabaseMigrationCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the database connection.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the database connection.", ParameterSetName = Default)]
        ...
        public Oci.DatabasemigrationService.Models.Connection.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
