...
{
    [Cmdlet("Remove", "OCICapacitymanagementOccCapacityRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CapacitymanagementService.Responses.DeleteOccCapacityRequestResponse) })]
    public class RemoveOCICapacitymanagementOccCapacityRequest : OCICapacityManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCICapacitymanagementOccCapacityRequest", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteOccCapacityRequestRequest
                {
                ...
                response = client.DeleteOccCapacityRequest(request).GetAwaiter().GetResult();
        ...
        private DeleteOccCapacityRequestResponse response;
    }
}
