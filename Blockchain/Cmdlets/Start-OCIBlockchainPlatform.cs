...
{
    [Cmdlet("Start", "OCIBlockchainPlatform")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.BlockchainService.Responses.StartBlockchainPlatformResponse) })]
    public class StartOCIBlockchainPlatform : OCIBlockchainPlatformCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartBlockchainPlatformRequest
                {
                ...
                response = client.StartBlockchainPlatform(request).GetAwaiter().GetResult();
        ...
        private StartBlockchainPlatformResponse response;
    }
}
