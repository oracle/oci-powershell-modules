...
{
    [Cmdlet("New", "OCIMysqlAnalyticsClusterMemoryEstimate")]
    [OutputType(new System.Type[] { typeof(Oci.MysqlService.Models.AnalyticsClusterMemoryEstimate), typeof(Oci.MysqlService.Responses.GenerateAnalyticsClusterMemoryEstimateResponse) })]
    public class NewOCIMysqlAnalyticsClusterMemoryEstimate : OCIDbSystemCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GenerateAnalyticsClusterMemoryEstimateRequest
                {
                ...
                response = client.GenerateAnalyticsClusterMemoryEstimate(request).GetAwaiter().GetResult();
        ...
        private GenerateAnalyticsClusterMemoryEstimateResponse response;
    }
}
