...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyApiKeysList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyApiKeys), typeof(Oci.IdentitydomainsService.Responses.ListMyApiKeysResponse) })]
    public class GetOCIIdentitydomainsMyApiKeysList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMyApiKeysRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListMyApiKeys(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MyApiKeys);
        ...
        private ListMyApiKeysResponse response;
    }
}
