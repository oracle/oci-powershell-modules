...
namespace Oci.MarketplacepublisherService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIMarketplacepublisherListingRevisionIconContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.MarketplacepublisherService.Responses.GetListingRevisionIconContentResponse) })]
    public class GetOCIMarketplacepublisherListingRevisionIconContent : OCIMarketplacePublisherCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetListingRevisionIconContentRequest
                {
                    ListingRevisionId = ListingRevisionId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetListingRevisionIconContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetListingRevisionIconContentResponse response;
