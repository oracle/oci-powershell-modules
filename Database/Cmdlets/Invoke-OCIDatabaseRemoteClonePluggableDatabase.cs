...
{
    [Cmdlet("Invoke", "OCIDatabaseRemoteClonePluggableDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.PluggableDatabase), typeof(Oci.DatabaseService.Responses.RemoteClonePluggableDatabaseResponse) })]
    public class InvokeOCIDatabaseRemoteClonePluggableDatabase : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoteClonePluggableDatabaseRequest
                {
        ...
        private void HandleOutput(RemoteClonePluggableDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRemoteClonePluggableDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RemoteClonePluggableDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.PluggableDatabase);
        }

        private RemoteClonePluggableDatabaseResponse response;
