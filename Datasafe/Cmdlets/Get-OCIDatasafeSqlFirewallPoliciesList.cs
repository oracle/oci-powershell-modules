...
{
    [Cmdlet("Get", "OCIDatasafeSqlFirewallPoliciesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.SqlFirewallPolicyCollection), typeof(Oci.DatasafeService.Responses.ListSqlFirewallPoliciesResponse) })]
    public class GetOCIDatasafeSqlFirewallPoliciesList : OCIDataSafeCmdlet
    {
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSqlFirewallPoliciesRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"An optional filter to return only resources that match the specified violation action.")]
        public System.Nullable<Oci.DatasafeService.Requests.ListSqlFirewallPoliciesRequest.ViolationActionEnum> ViolationAction { get; set; }
...
**Example:** 2016-12-19T16:39:57.600Z")]
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSqlFirewallPoliciesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSqlFirewallPoliciesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSqlFirewallPoliciesRequest
                {
                ...
                IEnumerable<ListSqlFirewallPoliciesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.SqlFirewallPolicyCollection, true);
                }
        ...
        {
            IEnumerable<ListSqlFirewallPoliciesResponse> DefaultRequest(ListSqlFirewallPoliciesRequest request) => Enumerable.Repeat(client.ListSqlFirewallPolicies(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSqlFirewallPoliciesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSqlFirewallPoliciesResponse response;
        private delegate IEnumerable<ListSqlFirewallPoliciesResponse> RequestDelegate(ListSqlFirewallPoliciesRequest request);
