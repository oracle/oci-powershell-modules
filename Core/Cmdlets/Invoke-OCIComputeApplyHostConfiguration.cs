...
{
    [Cmdlet("Invoke", "OCIComputeApplyHostConfiguration", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.ComputeHost), typeof(Oci.CoreService.Responses.ApplyHostConfigurationResponse) })]
    public class InvokeOCIComputeApplyHostConfiguration : OCIComputeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ApplyHostConfigurationRequest
                {
        ...
        private void HandleOutput(ApplyHostConfigurationRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForApplyHostConfiguration(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ApplyHostConfiguration(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.ComputeHost);
        }

        private ApplyHostConfigurationResponse response;
