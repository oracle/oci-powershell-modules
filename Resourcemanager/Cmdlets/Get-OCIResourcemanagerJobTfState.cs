...
namespace Oci.ResourcemanagerService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIResourcemanagerJobTfState", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.ResourcemanagerService.Responses.GetJobTfStateResponse) })]
    public class GetOCIResourcemanagerJobTfState : OCIResourceManagerCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetJobTfStateRequest
                {
                    JobId = JobId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetJobTfState(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetJobTfStateResponse response;
