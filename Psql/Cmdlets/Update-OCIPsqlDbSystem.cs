...
{
    [Cmdlet("Update", "OCIPsqlDbSystem")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.PsqlService.Responses.UpdateDbSystemResponse) })]
    public class UpdateOCIPsqlDbSystem : OCIPostgresqlCmdlet
    {
