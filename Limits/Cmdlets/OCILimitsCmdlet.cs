...
{
    public abstract class OCILimitsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            base.ProcessRecord();
            client?.Dispose();
            client = new LimitsClient(AuthProvider, new Oci.Common.ClientConfiguration
            {
