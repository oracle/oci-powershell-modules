...
{
    [Cmdlet("Remove", "OCIStackmonitoringConfig", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.StackmonitoringService.Responses.DeleteConfigResponse) })]
    public class RemoveOCIStackmonitoringConfig : OCIStackMonitoringCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIStackmonitoringConfig", "Remove"))
            {
               return;
            }
        ...
        private DeleteConfigResponse response;
    }
}
