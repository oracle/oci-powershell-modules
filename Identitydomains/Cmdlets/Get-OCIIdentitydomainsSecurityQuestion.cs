...
{
    [Cmdlet("Get", "OCIIdentitydomainsSecurityQuestion")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SecurityQuestion), typeof(Oci.IdentitydomainsService.Responses.GetSecurityQuestionResponse) })]
    public class GetOCIIdentitydomainsSecurityQuestion : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetSecurityQuestionRequest
                {
                ...
                response = client.GetSecurityQuestion(request).GetAwaiter().GetResult();
        ...
        private GetSecurityQuestionResponse response;
    }
}
