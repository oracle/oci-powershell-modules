...
{
    [Cmdlet("New", "OCILoadbalancerRoutingPolicy")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.LoadbalancerService.Responses.CreateRoutingPolicyResponse) })]
    public class NewOCILoadbalancerRoutingPolicy : OCILoadBalancerCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details of the routing policy rules to add.")]
        public CreateRoutingPolicyDetails CreateRoutingPolicyDetails { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the load balancer to add the routing policy rule list to.")]
...
Example: `example-etag`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateRoutingPolicyRequest
                {
                ...
                response = client.CreateRoutingPolicy(request).GetAwaiter().GetResult();
        ...
        private CreateRoutingPolicyResponse response;
    }
}
