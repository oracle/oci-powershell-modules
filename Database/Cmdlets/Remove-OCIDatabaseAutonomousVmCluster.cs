...
{
    [Cmdlet("Remove", "OCIDatabaseAutonomousVmCluster", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteAutonomousVmClusterResponse) })]
    public class RemoveOCIDatabaseAutonomousVmCluster : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseAutonomousVmCluster", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteAutonomousVmClusterRequest
                {
        ...
        private void HandleOutput(DeleteAutonomousVmClusterRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteAutonomousVmCluster(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteAutonomousVmCluster(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteAutonomousVmClusterResponse response;
