...
{
    public abstract class OCIWorkRequestsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new WorkRequestsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected WorkRequestsClient client;
