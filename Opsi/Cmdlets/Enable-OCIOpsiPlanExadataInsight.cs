...
{
    [Cmdlet("Enable", "OCIOpsiPlanExadataInsight")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.EnablePlanExadataInsightResponse) })]
    public class EnableOCIOpsiPlanExadataInsight : OCIOperationsInsightsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the Exadata system to be enabled in Operations Insights.")]
...
*Note:* Retry tokens can be invalidated before the 24 hour time limit due to conflicting operations, such as a resource being deleted or purged from the system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new EnablePlanExadataInsightRequest
                {
                ...
                response = client.EnablePlanExadataInsight(request).GetAwaiter().GetResult();
        ...
        private EnablePlanExadataInsightResponse response;
    }
}
