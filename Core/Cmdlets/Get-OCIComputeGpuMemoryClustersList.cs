...
{
    [Cmdlet("Get", "OCIComputeGpuMemoryClustersList")]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.ComputeGpuMemoryClusterCollection), typeof(Oci.CoreService.Responses.ListComputeGpuMemoryClustersResponse) })]
    public class GetOCIComputeGpuMemoryClustersList : OCIComputeCmdlet
    {
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by availability domain if the scope of the resource type is within a single availability domain. If you call one of these ""List"" operations without specifying an availability domain, the resources are grouped by availability domain, then sorted.")]
        public System.Nullable<Oci.CoreService.Requests.ListComputeGpuMemoryClustersRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Requests.ListComputeGpuMemoryClustersRequest.SortOrderEnum> SortOrder { get; set; }
...
Example: `50`", ParameterSetName = LimitSet)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListComputeGpuMemoryClustersRequest
                {
                ...
                IEnumerable<ListComputeGpuMemoryClustersResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.ComputeGpuMemoryClusterCollection, true);
                }
        ...
        {
            IEnumerable<ListComputeGpuMemoryClustersResponse> DefaultRequest(ListComputeGpuMemoryClustersRequest request) => Enumerable.Repeat(client.ListComputeGpuMemoryClusters(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListComputeGpuMemoryClustersResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListComputeGpuMemoryClustersResponse response;
        private delegate IEnumerable<ListComputeGpuMemoryClustersResponse> RequestDelegate(ListComputeGpuMemoryClustersRequest request);
