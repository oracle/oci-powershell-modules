...
{
    [Cmdlet("Get", "OCIApiplatformWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.ApiplatformService.Models.WorkRequest), typeof(Oci.ApiplatformService.Responses.GetWorkRequestResponse) })]
    public class GetOCIApiplatformWorkRequest : OCIApiPlatformCmdlet
    {
        ...
        public Oci.ApiplatformService.Models.OperationStatus[] WaitForStatus { get; set; }
