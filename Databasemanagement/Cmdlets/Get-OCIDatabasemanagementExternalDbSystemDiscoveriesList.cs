...
{
    [Cmdlet("Get", "OCIDatabasemanagementExternalDbSystemDiscoveriesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.ExternalDbSystemDiscoveryCollection), typeof(Oci.DatabasemanagementService.Responses.ListExternalDbSystemDiscoveriesResponse) })]
    public class GetOCIDatabasemanagementExternalDbSystemDiscoveriesList : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListExternalDbSystemDiscoveriesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListExternalDbSystemDiscoveriesRequest
                {
                ...
                IEnumerable<ListExternalDbSystemDiscoveriesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.ExternalDbSystemDiscoveryCollection, true);
                }
        ...
        {
            IEnumerable<ListExternalDbSystemDiscoveriesResponse> DefaultRequest(ListExternalDbSystemDiscoveriesRequest request) => Enumerable.Repeat(client.ListExternalDbSystemDiscoveries(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListExternalDbSystemDiscoveriesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListExternalDbSystemDiscoveriesResponse response;
        private delegate IEnumerable<ListExternalDbSystemDiscoveriesResponse> RequestDelegate(ListExternalDbSystemDiscoveriesRequest request);
