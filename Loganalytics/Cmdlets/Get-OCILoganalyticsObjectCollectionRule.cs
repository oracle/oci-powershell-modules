...
namespace Oci.LoganalyticsService.Cmdlets
{
    ...
    public class GetOCILoganalyticsObjectCollectionRule : OCILogAnalyticsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The Log Analytics Object Collection Rule [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The Log Analytics Object Collection Rule [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).", ParameterSetName = Default)]
