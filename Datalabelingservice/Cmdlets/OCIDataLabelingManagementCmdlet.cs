...
using Oci.DatalabelingService;

namespace Oci.DatalabelingService.Cmdlets
{
    public abstract class OCIDataLabelingManagementCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DataLabelingManagementClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DataLabelingManagementClient client;
