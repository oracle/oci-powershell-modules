...
{
    [Cmdlet("Get", "OCIIntegrationInstanceWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.IntegrationService.Models.WorkRequest), typeof(Oci.IntegrationService.Responses.GetWorkRequestResponse) })]
    public class GetOCIIntegrationInstanceWorkRequest : OCIIntegrationInstanceCmdlet
    {
        ...
        public Oci.IntegrationService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
