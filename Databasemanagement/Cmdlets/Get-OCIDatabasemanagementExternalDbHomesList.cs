...
{
    [Cmdlet("Get", "OCIDatabasemanagementExternalDbHomesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.ExternalDbHomeCollection), typeof(Oci.DatabasemanagementService.Responses.ListExternalDbHomesResponse) })]
    public class GetOCIDatabasemanagementExternalDbHomesList : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListExternalDbHomesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListExternalDbHomesRequest
                {
                ...
                IEnumerable<ListExternalDbHomesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.ExternalDbHomeCollection, true);
                }
        ...
        {
            IEnumerable<ListExternalDbHomesResponse> DefaultRequest(ListExternalDbHomesRequest request) => Enumerable.Repeat(client.ListExternalDbHomes(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListExternalDbHomesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListExternalDbHomesResponse response;
        private delegate IEnumerable<ListExternalDbHomesResponse> RequestDelegate(ListExternalDbHomesRequest request);
