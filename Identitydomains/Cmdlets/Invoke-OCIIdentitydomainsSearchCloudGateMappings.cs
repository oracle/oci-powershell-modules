...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchCloudGateMappings")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.CloudGateMappings), typeof(Oci.IdentitydomainsService.Responses.SearchCloudGateMappingsResponse) })]
    public class InvokeOCIIdentitydomainsSearchCloudGateMappings : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching CloudGateMappings")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchCloudGateMappingsRequest
                {
                ...
                response = client.SearchCloudGateMappings(request).GetAwaiter().GetResult();
                WriteOutput(response, response.CloudGateMappings);
        ...
        private SearchCloudGateMappingsResponse response;
    }
}
