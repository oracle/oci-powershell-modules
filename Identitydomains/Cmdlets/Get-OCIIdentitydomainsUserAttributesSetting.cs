...
{
    [Cmdlet("Get", "OCIIdentitydomainsUserAttributesSetting")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.UserAttributesSetting), typeof(Oci.IdentitydomainsService.Responses.GetUserAttributesSettingResponse) })]
    public class GetOCIIdentitydomainsUserAttributesSetting : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetUserAttributesSettingRequest
                {
                ...
                response = client.GetUserAttributesSetting(request).GetAwaiter().GetResult();
        ...
        private GetUserAttributesSettingResponse response;
    }
}
