...
{
    [Cmdlet("Remove", "OCIMediaservicesStreamPackagingConfigLock")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.StreamPackagingConfig), typeof(Oci.MediaservicesService.Responses.RemoveStreamPackagingConfigLockResponse) })]
    public class RemoveOCIMediaservicesStreamPackagingConfigLock : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveStreamPackagingConfigLockRequest
                {
                ...
                response = client.RemoveStreamPackagingConfigLock(request).GetAwaiter().GetResult();
        ...
        private RemoveStreamPackagingConfigLockResponse response;
    }
}
