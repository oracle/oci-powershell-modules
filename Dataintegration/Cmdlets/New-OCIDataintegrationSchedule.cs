...
{
    [Cmdlet("New", "OCIDataintegrationSchedule")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.Schedule), typeof(Oci.DataintegrationService.Responses.CreateScheduleResponse) })]
    public class NewOCIDataintegrationSchedule : OCIDataIntegrationCmdlet
    {
