...
{
    [Cmdlet("Remove", "OCIOptimizerProfile", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OptimizerService.Responses.DeleteProfileResponse) })]
    public class RemoveOCIOptimizerProfile : OCIOptimizerCmdlet
    {
