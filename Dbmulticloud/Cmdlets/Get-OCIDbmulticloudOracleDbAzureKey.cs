...
namespace Oci.DbmulticloudService.Cmdlets
{
    ...
    public class GetOCIDbmulticloudOracleDbAzureKey : OCIOracleDbAzureKeyCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the Oracle DB Azure Vault Key resource.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the Oracle DB Azure Vault Key resource.", ParameterSetName = Default)]
