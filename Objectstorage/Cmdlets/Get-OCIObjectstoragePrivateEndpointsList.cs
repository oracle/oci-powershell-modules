...
{
    [Cmdlet("Get", "OCIObjectstoragePrivateEndpointsList")]
    [OutputType(new System.Type[] { typeof(Oci.ObjectstorageService.Models.PrivateEndpointSummary), typeof(Oci.ObjectstorageService.Responses.ListPrivateEndpointsResponse) })]
    public class GetOCIObjectstoragePrivateEndpointsList : OCIObjectStorageCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"PrivateEndpoint summary in list of PrivateEndpoints includes the 'namespace', 'name', 'compartmentId', 'createdBy', 'timeCreated', 'timeModified' and 'etag' fields. This parameter can also include 'tags' (freeformTags and definedTags). The only supported value of this parameter is 'tags' for now. Example 'tags'.")]
        public System.Collections.Generic.List<Oci.ObjectstorageService.Requests.ListPrivateEndpointsRequest.FieldsEnum> Fields { get; set; }
        ...
        public System.Nullable<Oci.ObjectstorageService.Models.PrivateEndpoint.LifecycleStateEnum> LifecycleState { get; set; }
