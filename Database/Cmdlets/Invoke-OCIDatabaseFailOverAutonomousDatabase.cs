...
{
    [Cmdlet("Invoke", "OCIDatabaseFailOverAutonomousDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousDatabase), typeof(Oci.DatabaseService.Responses.FailOverAutonomousDatabaseResponse) })]
    public class InvokeOCIDatabaseFailOverAutonomousDatabase : OCIDatabaseCmdlet
    {
        ...
        private void HandleOutput(FailOverAutonomousDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForFailOverAutonomousDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.FailOverAutonomousDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousDatabase);
        }

        private FailOverAutonomousDatabaseResponse response;
