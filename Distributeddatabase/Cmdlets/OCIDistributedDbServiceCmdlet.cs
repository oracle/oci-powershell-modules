...
{
    public abstract class OCIDistributedDbServiceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DistributedDbServiceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DistributedDbServiceClient client;
