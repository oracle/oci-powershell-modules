...
{
    [Cmdlet("Invoke", "OCIPsqlSwitchOver")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.PsqlService.Responses.SwitchOverResponse) })]
    public class InvokeOCIPsqlSwitchOver : OCIPostgresqlCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Switchover the primary and replica role parameters.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.SwitchOver(request).GetAwaiter().GetResult();
        ...
        private SwitchOverResponse response;
    }
}
