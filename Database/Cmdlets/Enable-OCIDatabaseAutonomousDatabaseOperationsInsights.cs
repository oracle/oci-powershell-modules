...
{
    [Cmdlet("Enable", "OCIDatabaseAutonomousDatabaseOperationsInsights", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.EnableAutonomousDatabaseOperationsInsightsResponse) })]
    public class EnableOCIDatabaseAutonomousDatabaseOperationsInsights : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new EnableAutonomousDatabaseOperationsInsightsRequest
                {
        ...
        private void HandleOutput(EnableAutonomousDatabaseOperationsInsightsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForEnableAutonomousDatabaseOperationsInsights(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.EnableAutonomousDatabaseOperationsInsights(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private EnableAutonomousDatabaseOperationsInsightsResponse response;
