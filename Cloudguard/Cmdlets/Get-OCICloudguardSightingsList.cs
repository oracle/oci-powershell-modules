...
{
    [Cmdlet("Get", "OCICloudguardSightingsList")]
    [OutputType(new System.Type[] { typeof(Oci.CloudguardService.Models.SightingCollection), typeof(Oci.CloudguardService.Responses.ListSightingsResponse) })]
    public class GetOCICloudguardSightingsList : OCICloudGuardCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID of the compartment in which to list resources.")]
        public string CompartmentId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"OCID of the problem.")]
        public string ProblemId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"OCID of the resource profile.")]
        ...
        public System.Nullable<Oci.CloudguardService.Requests.ListSightingsRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        public System.Nullable<Oci.CloudguardService.Requests.ListSightingsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSightingsRequest
                {
                ...
                IEnumerable<ListSightingsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.SightingCollection, true);
                }
        ...
        {
            IEnumerable<ListSightingsResponse> DefaultRequest(ListSightingsRequest request) => Enumerable.Repeat(client.ListSightings(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSightingsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSightingsResponse response;
        private delegate IEnumerable<ListSightingsResponse> RequestDelegate(ListSightingsRequest request);
