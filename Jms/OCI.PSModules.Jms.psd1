...
CmdletsToExport = 'Get-OCIJmsFleet', 'Get-OCIJmsFleetAgentConfiguration', 
               'Get-OCIJmsFleetsList', 'Get-OCIJmsWorkRequest', 
               'Get-OCIJmsWorkRequestErrorsList', 'Get-OCIJmsWorkRequestLogsList', 
               'Get-OCIJmsWorkRequestsList', 
               'Invoke-OCIJmsRequestSummarizedApplicationUsage', 
               'Invoke-OCIJmsRequestSummarizedInstallationUsage', 
               'Invoke-OCIJmsRequestSummarizedJreUsage', 
               'Invoke-OCIJmsRequestSummarizedManagedInstanceUsage', 
               ...
               'Move-OCIJmsFleetCompartment', 'New-OCIJmsFleet', 
               'Remove-OCIJmsFleet', 'Update-OCIJmsFleet', 
