...
{
    [Cmdlet("Get", "OCIIdentitydomainsIdentityProvider")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.IdentityProvider), typeof(Oci.IdentitydomainsService.Responses.GetIdentityProviderResponse) })]
    public class GetOCIIdentitydomainsIdentityProvider : OCIIdentityDomainsCmdlet
    {
