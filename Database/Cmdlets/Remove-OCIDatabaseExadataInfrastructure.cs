...
{
    [Cmdlet("Remove", "OCIDatabaseExadataInfrastructure", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteExadataInfrastructureResponse) })]
    public class RemoveOCIDatabaseExadataInfrastructure : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseExadataInfrastructure", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteExadataInfrastructureRequest
                {
        ...
        private void HandleOutput(DeleteExadataInfrastructureRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteExadataInfrastructure(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteExadataInfrastructure(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteExadataInfrastructureResponse response;
