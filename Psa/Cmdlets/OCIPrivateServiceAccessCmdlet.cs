...
using Oci.PsaService;

namespace Oci.PsaService.Cmdlets
{
    public abstract class OCIPrivateServiceAccessCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new PrivateServiceAccessClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected PrivateServiceAccessClient client;
