...
{
    [Cmdlet("New", "OCIGenerativeaiagentTool")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiagentService.Models.Tool), typeof(Oci.GenerativeaiagentService.Responses.CreateToolResponse) })]
    public class NewOCIGenerativeaiagentTool : OCIGenerativeAiAgentCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new tool.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CreateTool(request).GetAwaiter().GetResult();
        ...
        private CreateToolResponse response;
    }
}
