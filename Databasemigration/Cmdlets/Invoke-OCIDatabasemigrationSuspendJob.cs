...
{
    [Cmdlet("Invoke", "OCIDatabasemigrationSuspendJob")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemigrationService.Models.Job), typeof(Oci.DatabasemigrationService.Responses.SuspendJobResponse) })]
    public class InvokeOCIDatabasemigrationSuspendJob : OCIDatabaseMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.SuspendJob(request).GetAwaiter().GetResult();
        ...
        private SuspendJobResponse response;
    }
}
