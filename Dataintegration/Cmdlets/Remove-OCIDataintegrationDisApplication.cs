...
{
    [Cmdlet("Remove", "OCIDataintegrationDisApplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataintegrationService.Responses.DeleteDisApplicationResponse) })]
    public class RemoveOCIDataintegrationDisApplication : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataintegrationDisApplication", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDisApplicationRequest
                {
                ...
                response = client.DeleteDisApplication(request).GetAwaiter().GetResult();
        ...
        private DeleteDisApplicationResponse response;
    }
}
