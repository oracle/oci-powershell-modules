...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyDevice")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyDevice), typeof(Oci.IdentitydomainsService.Responses.GetMyDeviceResponse) })]
    public class GetOCIIdentitydomainsMyDevice : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMyDeviceRequest
                {
                ...
                response = client.GetMyDevice(request).GetAwaiter().GetResult();
        ...
        private GetMyDeviceResponse response;
    }
}
