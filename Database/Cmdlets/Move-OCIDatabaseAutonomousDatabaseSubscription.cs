...
{
    [Cmdlet("Move", "OCIDatabaseAutonomousDatabaseSubscription", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.ChangeAutonomousDatabaseSubscriptionResponse) })]
    public class MoveOCIDatabaseAutonomousDatabaseSubscription : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeAutonomousDatabaseSubscriptionRequest
                {
        ...
        private void HandleOutput(ChangeAutonomousDatabaseSubscriptionRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForChangeAutonomousDatabaseSubscription(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ChangeAutonomousDatabaseSubscription(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private ChangeAutonomousDatabaseSubscriptionResponse response;
