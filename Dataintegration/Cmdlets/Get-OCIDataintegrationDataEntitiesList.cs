...
{
    [Cmdlet("Get", "OCIDataintegrationDataEntitiesList")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.DataEntitySummaryCollection), typeof(Oci.DataintegrationService.Responses.ListDataEntitiesResponse) })]
    public class GetOCIDataintegrationDataEntitiesList : OCIDataIntegrationCmdlet
    {
        ...
        public System.Nullable<Oci.DataintegrationService.Requests.ListDataEntitiesRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.DataintegrationService.Requests.ListDataEntitiesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    response = item;
                    WriteOutput(response, response.DataEntitySummaryCollection, true);
                }
        ...
        {
            IEnumerable<ListDataEntitiesResponse> DefaultRequest(ListDataEntitiesRequest request) => Enumerable.Repeat(client.ListDataEntities(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListDataEntitiesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListDataEntitiesResponse response;
        private delegate IEnumerable<ListDataEntitiesResponse> RequestDelegate(ListDataEntitiesRequest request);
