...
{
    [Cmdlet("Get", "OCIManagementagentWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.ManagementagentService.Models.WorkRequestLogEntry), typeof(Oci.ManagementagentService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIManagementagentWorkRequestLogsList : OCIManagementAgentCmdlet
    {
        ...
        public System.Nullable<Oci.ManagementagentService.Requests.ListWorkRequestLogsRequest.SortOrderEnum> SortOrder { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field to sort by. Only one sort order may")]
        public System.Nullable<Oci.ManagementagentService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
