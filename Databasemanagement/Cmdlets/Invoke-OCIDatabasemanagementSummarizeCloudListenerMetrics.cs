...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementSummarizeCloudListenerMetrics")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.MetricsAggregationRangeCollection), typeof(Oci.DatabasemanagementService.Responses.SummarizeCloudListenerMetricsResponse) })]
    public class InvokeOCIDatabasemanagementSummarizeCloudListenerMetrics : OCIDbManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeCloudListenerMetricsRequest
                {
                ...
                response = client.SummarizeCloudListenerMetrics(request).GetAwaiter().GetResult();
        ...
        private SummarizeCloudListenerMetricsResponse response;
    }
}
