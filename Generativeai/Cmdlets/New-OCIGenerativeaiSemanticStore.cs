...
{
    [Cmdlet("New", "OCIGenerativeaiSemanticStore")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.SemanticStore), typeof(Oci.GenerativeaiService.Responses.CreateSemanticStoreResponse) })]
    public class NewOCIGenerativeaiSemanticStore : OCIGenerativeAiCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new SemanticStore.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateSemanticStoreRequest
                {
                ...
                response = client.CreateSemanticStore(request).GetAwaiter().GetResult();
        ...
        private CreateSemanticStoreResponse response;
    }
}
