...
GUID = '62ea1357-a7ac-4999-9277-461937af1fad'
...
CmdletsToExport = 'Get-OCIDeployment', 'Get-OCIDeploymentsList', 'Get-OCIGateway', 
               'Get-OCIGatewaysList', 'Get-OCIWorkRequestsList', 
               'Get-OCIWorkRequestsWorkRequest', 
               'Get-OCIWorkRequestsWorkRequestErrorsList', 
               'Get-OCIWorkRequestsWorkRequestLogsList', 
               'Move-OCIDeploymentCompartment', 'Move-OCIGatewayCompartment', 
               'New-OCIDeployment', 'New-OCIGateway', 'Remove-OCIDeployment', 
               'Remove-OCIGateway', 'Stop-OCIWorkRequestsWorkRequest', 
               'Update-OCIDeployment', 'Update-OCIGateway'
