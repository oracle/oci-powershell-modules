...
namespace Oci.OcvpService.Cmdlets
{
    ...
    public class GetOCIOcvpDatastoreClustersList : OCIDatastoreClusterCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the Datastore Cluster.")]
        public string DatastoreClusterId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the SDDC Cluster.")]
