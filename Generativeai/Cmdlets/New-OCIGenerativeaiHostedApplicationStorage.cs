...
{
    [Cmdlet("New", "OCIGenerativeaiHostedApplicationStorage")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.HostedApplicationStorage), typeof(Oci.GenerativeaiService.Responses.CreateHostedApplicationStorageResponse) })]
    public class NewOCIGenerativeaiHostedApplicationStorage : OCIGenerativeAiCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new hosted application storage.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateHostedApplicationStorageRequest
                {
                ...
                response = client.CreateHostedApplicationStorage(request).GetAwaiter().GetResult();
        ...
        private CreateHostedApplicationStorageResponse response;
    }
}
