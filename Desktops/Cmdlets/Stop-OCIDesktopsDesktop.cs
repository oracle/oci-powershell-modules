...
{
    [Cmdlet("Stop", "OCIDesktopsDesktop")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DesktopsService.Responses.StopDesktopResponse) })]
    public class StopOCIDesktopsDesktop : OCIDesktopServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StopDesktopRequest
                {
                    DesktopId = DesktopId,
        ...
        private StopDesktopResponse response;
    }
}
