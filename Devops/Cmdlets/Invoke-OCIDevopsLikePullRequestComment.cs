...
{
    [Cmdlet("Invoke", "OCIDevopsLikePullRequestComment")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.PullRequestComment), typeof(Oci.DevopsService.Responses.LikePullRequestCommentResponse) })]
    public class InvokeOCIDevopsLikePullRequestComment : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.LikePullRequestComment(request).GetAwaiter().GetResult();
        ...
        private LikePullRequestCommentResponse response;
    }
}
