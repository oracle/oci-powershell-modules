...
using Oci.LockboxService;

namespace Oci.LockboxService.Cmdlets
{
    public abstract class OCILockboxCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new LockboxClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected LockboxClient client;
