...
{
    [Cmdlet("Remove", "OCIIdentitydomainsUserDbCredential", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteUserDbCredentialResponse) })]
    public class RemoveOCIIdentitydomainsUserDbCredential : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsUserDbCredential", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteUserDbCredentialRequest
                {
                ...
                response = client.DeleteUserDbCredential(request).GetAwaiter().GetResult();
        ...
        private DeleteUserDbCredentialResponse response;
    }
}
