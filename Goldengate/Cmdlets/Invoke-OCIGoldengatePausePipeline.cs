...
{
    [Cmdlet("Invoke", "OCIGoldengatePausePipeline")]
    ...
    public class InvokeOCIGoldengatePausePipeline : OCIGoldenGateCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new PausePipelineRequest
                {
                ...
                response = client.PausePipeline(request).GetAwaiter().GetResult();
        ...
        private PausePipelineResponse response;
    }
}
