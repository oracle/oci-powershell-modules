...
{
    [Cmdlet("Get", "OCILoadbalancerHealth")]
    [OutputType(new System.Type[] { typeof(Oci.LoadbalancerService.Models.LoadBalancerHealth), typeof(Oci.LoadbalancerService.Responses.GetLoadBalancerHealthResponse) })]
    public class GetOCILoadbalancerHealth : OCILoadBalancerCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the load balancer to return health status for.")]
...
Example: `example-etag`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetLoadBalancerHealthRequest
                {
                ...
                response = client.GetLoadBalancerHealth(request).GetAwaiter().GetResult();
                WriteOutput(response, response.LoadBalancerHealth);
        ...
        private GetLoadBalancerHealthResponse response;
    }
}
