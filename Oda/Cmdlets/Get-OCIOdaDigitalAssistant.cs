...
{
    [Cmdlet("Get", "OCIOdaDigitalAssistant", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.DigitalAssistant), typeof(Oci.OdaService.Responses.GetDigitalAssistantResponse) })]
    public class GetOCIOdaDigitalAssistant : OCIManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetDigitalAssistantRequest
                {
        ...
        private void HandleOutput(GetDigitalAssistantRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForDigitalAssistant(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetDigitalAssistant(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.DigitalAssistant);
        }

        private GetDigitalAssistantResponse response;
