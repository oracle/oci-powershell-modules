...
{
    public abstract class OCIWafCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new WafClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
