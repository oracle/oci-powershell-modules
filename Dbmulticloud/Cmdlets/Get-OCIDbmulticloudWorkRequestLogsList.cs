...
{
    [Cmdlet("Get", "OCIDbmulticloudWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.DbmulticloudService.Models.WorkRequestLogEntryCollection), typeof(Oci.DbmulticloudService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIDbmulticloudWorkRequestLogsList : OCIWorkRequestCmdlet
    {
        ...
        public System.Nullable<Oci.DbmulticloudService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
