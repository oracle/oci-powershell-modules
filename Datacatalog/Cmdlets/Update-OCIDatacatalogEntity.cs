...
{
    [Cmdlet("Update", "OCIDatacatalogEntity")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Entity), typeof(Oci.DatacatalogService.Responses.UpdateEntityResponse) })]
    public class UpdateOCIDatacatalogEntity : OCIDataCatalogCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information to be updated in the data entity.")]
        ...
        private UpdateEntityResponse response;
    }
}
