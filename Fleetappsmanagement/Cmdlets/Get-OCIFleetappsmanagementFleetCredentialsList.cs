...
{
    [Cmdlet("Get", "OCIFleetappsmanagementFleetCredentialsList")]
    ...
    public class GetOCIFleetappsmanagementFleetCredentialsList : OCIFleetAppsManagementCmdlet
    {
        ...
        public System.Nullable<Oci.FleetappsmanagementService.Requests.ListFleetCredentialsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListFleetCredentialsRequest
                {
                    FleetId = FleetId,
                ...
                IEnumerable<ListFleetCredentialsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.FleetCredentialCollection, true);
                }
        ...
        {
            IEnumerable<ListFleetCredentialsResponse> DefaultRequest(ListFleetCredentialsRequest request) => Enumerable.Repeat(client.ListFleetCredentials(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListFleetCredentialsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListFleetCredentialsResponse response;
        private delegate IEnumerable<ListFleetCredentialsResponse> RequestDelegate(ListFleetCredentialsRequest request);
