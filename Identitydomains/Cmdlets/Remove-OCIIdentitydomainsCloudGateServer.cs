...
{
    [Cmdlet("Remove", "OCIIdentitydomainsCloudGateServer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteCloudGateServerResponse) })]
    public class RemoveOCIIdentitydomainsCloudGateServer : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsCloudGateServer", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteCloudGateServerRequest
                {
                ...
                response = client.DeleteCloudGateServer(request).GetAwaiter().GetResult();
        ...
        private DeleteCloudGateServerResponse response;
    }
}
