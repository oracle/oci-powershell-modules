...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyRequests), typeof(Oci.IdentitydomainsService.Responses.ListMyRequestsResponse) })]
    public class GetOCIIdentitydomainsMyRequestsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMyRequestsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListMyRequests(request).GetAwaiter().GetResult();
        ...
        private ListMyRequestsResponse response;
    }
}
