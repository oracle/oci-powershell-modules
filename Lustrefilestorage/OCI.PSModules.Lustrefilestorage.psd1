#
# Module manifest for module 'OCI.PSModules.Lustrefilestorage'
#
...
GUID = 'e584d0e6-ae6a-43b6-9f1f-6aa5ad0691ad'
...
Description = 'This modules provides Cmdlets for OCI Lustrefilestorage Service'
...
CmdletsToExport = 
               'Get-OCILustrefilestorageAvailableMaintenanceScheduleStartTimesList', 
               'Get-OCILustrefilestorageAvailableOverrideMaintenanceStartTimesList', 
               'Get-OCILustrefilestorageLustreFileSystem', 
               ...
               'Invoke-OCILustrefilestorageOverrideMaintenance', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'PSEdition_Core','Windows','Linux','macOS','Oracle','OCI','Cloud','OracleCloudInfrastructure','Lustrefilestorage'
