...
{
    [Cmdlet("Remove", "OCIKeymanagementVaultReplica")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.KeymanagementService.Responses.DeleteVaultReplicaResponse) })]
    public class RemoveOCIKeymanagementVaultReplica : OCIKmsVaultCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the vault.")]
        public string VaultId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"DeleteVaultReplicaDetails")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DeleteVaultReplicaRequest
                {
                    VaultId = VaultId,
                ...
                response = client.DeleteVaultReplica(request).GetAwaiter().GetResult();
        ...
        private DeleteVaultReplicaResponse response;
    }
}
