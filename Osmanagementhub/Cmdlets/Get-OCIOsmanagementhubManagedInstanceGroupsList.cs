...
{
    [Cmdlet("Get", "OCIOsmanagementhubManagedInstanceGroupsList")]
    [OutputType(new System.Type[] { typeof(Oci.OsmanagementhubService.Models.ManagedInstanceGroupCollection), typeof(Oci.OsmanagementhubService.Responses.ListManagedInstanceGroupsResponse) })]
    public class GetOCIOsmanagementhubManagedInstanceGroupsList : OCIManagedInstanceGroupCmdlet
    {
...
Example: `3`")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only managed instance groups that are in the specified state.")]
        public System.Nullable<Oci.OsmanagementhubService.Models.ManagedInstanceGroup.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.OsmanagementhubService.Requests.ListManagedInstanceGroupsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListManagedInstanceGroupsRequest
                {
                ...
                IEnumerable<ListManagedInstanceGroupsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.ManagedInstanceGroupCollection, true);
                }
        ...
        {
            IEnumerable<ListManagedInstanceGroupsResponse> DefaultRequest(ListManagedInstanceGroupsRequest request) => Enumerable.Repeat(client.ListManagedInstanceGroups(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListManagedInstanceGroupsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListManagedInstanceGroupsResponse response;
        private delegate IEnumerable<ListManagedInstanceGroupsResponse> RequestDelegate(ListManagedInstanceGroupsRequest request);
