...
{
    [Cmdlet("Get", "OCIStackmonitoringDiscoveryJob", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.StackmonitoringService.Models.DiscoveryJob), typeof(Oci.StackmonitoringService.Responses.GetDiscoveryJobResponse) })]
    public class GetOCIStackmonitoringDiscoveryJob : OCIStackMonitoringCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The Discovery Job ID", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The Discovery Job ID", ParameterSetName = Default)]
