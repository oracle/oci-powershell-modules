...
using Oci.DbmulticloudService;

namespace Oci.DbmulticloudService.Cmdlets
{
    public abstract class OCIOracleDbAzureVaultAssociationCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OracleDbAzureVaultAssociationClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OracleDbAzureVaultAssociationClient client;
