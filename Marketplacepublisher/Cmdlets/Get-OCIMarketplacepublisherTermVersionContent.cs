...
namespace Oci.MarketplacepublisherService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIMarketplacepublisherTermVersionContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.MarketplacepublisherService.Responses.GetTermVersionContentResponse) })]
    public class GetOCIMarketplacepublisherTermVersionContent : OCIMarketplacePublisherCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetTermVersionContentRequest
                {
                    TermVersionId = TermVersionId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetTermVersionContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetTermVersionContentResponse response;
