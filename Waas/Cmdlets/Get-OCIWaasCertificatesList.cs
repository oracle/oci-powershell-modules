...
{
    [Cmdlet("Get", "OCIWaasCertificatesList")]
    [OutputType(new System.Type[] { typeof(Oci.WaasService.Models.CertificateSummary), typeof(Oci.WaasService.Responses.ListCertificatesResponse) })]
    public class GetOCIWaasCertificatesList : OCIWaasCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The value by which certificate summaries are sorted in a paginated 'List' call. If unspecified, defaults to `timeCreated`.")]
        public System.Nullable<Oci.WaasService.Requests.ListCertificatesRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.WaasService.Requests.ListCertificatesRequest.SortOrderEnum> SortOrder { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Filter certificates using a list of certificates OCIDs.")]
        public System.Collections.Generic.List<string> Id { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Filter certificates using a list of display names.")]
        public System.Collections.Generic.List<string> DisplayName { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Filter certificates using a list of lifecycle states.")]
        public System.Collections.Generic.List<Oci.WaasService.Models.LifecycleStates> LifecycleState { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter that matches certificates created on or after the specified date-time.")]
        public System.Nullable<System.DateTime> TimeCreatedGreaterThanOrEqualTo { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter that matches certificates created before the specified date-time.")]
