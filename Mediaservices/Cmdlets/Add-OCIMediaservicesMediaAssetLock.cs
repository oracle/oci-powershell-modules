...
{
    [Cmdlet("Add", "OCIMediaservicesMediaAssetLock")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.MediaAsset), typeof(Oci.MediaservicesService.Responses.AddMediaAssetLockResponse) })]
    public class AddOCIMediaservicesMediaAssetLock : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddMediaAssetLockRequest
                {
                ...
                response = client.AddMediaAssetLock(request).GetAwaiter().GetResult();
        ...
        private AddMediaAssetLockResponse response;
    }
}
