...
{
    [Cmdlet("Update", "OCIDatabaseAutonomousDatabaseRegionalWallet", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.UpdateAutonomousDatabaseRegionalWalletResponse) })]
    public class UpdateOCIDatabaseAutonomousDatabaseRegionalWallet : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateAutonomousDatabaseRegionalWalletRequest
                {
        ...
        private void HandleOutput(UpdateAutonomousDatabaseRegionalWalletRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateAutonomousDatabaseRegionalWallet(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpdateAutonomousDatabaseRegionalWallet(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private UpdateAutonomousDatabaseRegionalWalletResponse response;
