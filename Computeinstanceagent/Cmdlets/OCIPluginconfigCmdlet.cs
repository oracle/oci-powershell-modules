...
{
    public abstract class OCIPluginconfigCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new PluginconfigClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected PluginconfigClient client;
