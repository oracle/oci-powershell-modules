...
{
    [Cmdlet("Add", "OCIApigatewayDeploymentLock")]
    [OutputType(new System.Type[] { typeof(Oci.ApigatewayService.Models.Deployment), typeof(Oci.ApigatewayService.Responses.AddDeploymentLockResponse) })]
    public class AddOCIApigatewayDeploymentLock : OCIDeploymentCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddDeploymentLockRequest
                {
                ...
                response = client.AddDeploymentLock(request).GetAwaiter().GetResult();
        ...
        private AddDeploymentLockResponse response;
    }
}
