...
{
    [Cmdlet("Get", "OCIDatabasemanagementPeerDatabaseMetrics")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.PeerDatabaseMetrics), typeof(Oci.DatabasemanagementService.Responses.GetPeerDatabaseMetricsResponse) })]
    public class GetOCIDatabasemanagementPeerDatabaseMetrics : OCIDbManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetPeerDatabaseMetricsRequest
                {
                ...
                response = client.GetPeerDatabaseMetrics(request).GetAwaiter().GetResult();
                WriteOutput(response, response.PeerDatabaseMetrics);
        ...
        private GetPeerDatabaseMetricsResponse response;
    }
}
