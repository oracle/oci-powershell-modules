...
{
    [Cmdlet("Get", "OCIDatasafeDiscoveryJobsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.DiscoveryJobCollection), typeof(Oci.DatasafeService.Responses.ListDiscoveryJobsResponse) })]
    public class GetOCIDatasafeDiscoveryJobsList : OCIDataSafeCmdlet
    {
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListDiscoveryJobsRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only the resources that match the specified discovery job OCID.")]
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListDiscoveryJobsRequest.SortOrderEnum> SortOrder { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field to sort by. You can specify only one sorting parameter (sortOrder). The default order for timeFinished is descending. The default order for displayName is ascending.")]
        public System.Nullable<Oci.DatasafeService.Requests.ListDiscoveryJobsRequest.SortByEnum> SortBy { get; set; }
