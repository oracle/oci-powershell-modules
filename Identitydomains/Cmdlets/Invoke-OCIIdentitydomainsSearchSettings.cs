...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchSettings")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Settings), typeof(Oci.IdentitydomainsService.Responses.SearchSettingsResponse) })]
    public class InvokeOCIIdentitydomainsSearchSettings : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching Settings")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.SearchSettings(request).GetAwaiter().GetResult();
                WriteOutput(response, response.Settings);
        ...
        private SearchSettingsResponse response;
    }
}
