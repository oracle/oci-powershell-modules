...
{
    [Cmdlet("Remove", "OCIIdentitydomainsMyTrustedUserAgent", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteMyTrustedUserAgentResponse) })]
    public class RemoveOCIIdentitydomainsMyTrustedUserAgent : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsMyTrustedUserAgent", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteMyTrustedUserAgentRequest
                {
                ...
                response = client.DeleteMyTrustedUserAgent(request).GetAwaiter().GetResult();
        ...
        private DeleteMyTrustedUserAgentResponse response;
    }
}
