...
{
    public abstract class OCIOciCacheConfigSetCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OciCacheConfigSetClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OciCacheConfigSetClient client;
