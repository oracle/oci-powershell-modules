...
{
    [Cmdlet("Get", "OCIOsmanagementhubManagedInstanceGroupManagedInstancesList")]
    [OutputType(new System.Type[] { typeof(Oci.OsmanagementhubService.Models.ManagedInstanceCollection), typeof(Oci.OsmanagementhubService.Responses.ListManagedInstanceGroupManagedInstancesResponse) })]
    public class GetOCIOsmanagementhubManagedInstanceGroupManagedInstancesList : OCIManagedInstanceGroupCmdlet
    {
...
Example: `3`")]
        ...
        public System.Nullable<Oci.OsmanagementhubService.Requests.ListManagedInstanceGroupManagedInstancesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListManagedInstanceGroupManagedInstancesRequest
                {
                ...
                IEnumerable<ListManagedInstanceGroupManagedInstancesResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListManagedInstanceGroupManagedInstancesResponse> DefaultRequest(ListManagedInstanceGroupManagedInstancesRequest request) => Enumerable.Repeat(client.ListManagedInstanceGroupManagedInstances(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListManagedInstanceGroupManagedInstancesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListManagedInstanceGroupManagedInstancesResponse response;
        private delegate IEnumerable<ListManagedInstanceGroupManagedInstancesResponse> RequestDelegate(ListManagedInstanceGroupManagedInstancesRequest request);
