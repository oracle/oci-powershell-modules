...
{
    [Cmdlet("Stop", "OCICloudmigrationsWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CloudmigrationsService.Responses.CancelWorkRequestResponse) })]
    public class StopOCICloudmigrationsWorkRequest : OCIMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCICloudmigrationsWorkRequest", "Stop"))
            {
               return;
            }
