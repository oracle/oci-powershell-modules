...
{
    [Cmdlet("Get", "OCIIdentitydomainsAppRolesList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.AppRoles), typeof(Oci.IdentitydomainsService.Responses.ListAppRolesResponse) })]
    public class GetOCIIdentitydomainsAppRolesList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAppRolesRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListAppRoles(request).GetAwaiter().GetResult();
        ...
        private ListAppRolesResponse response;
    }
}
