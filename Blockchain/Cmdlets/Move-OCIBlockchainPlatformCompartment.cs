...
{
    [Cmdlet("Move", "OCIBlockchainPlatformCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.BlockchainService.Responses.ChangeBlockchainPlatformCompartmentResponse) })]
    public class MoveOCIBlockchainPlatformCompartment : OCIBlockchainPlatformCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeBlockchainPlatformCompartmentRequest
                {
                ...
                response = client.ChangeBlockchainPlatformCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeBlockchainPlatformCompartmentResponse response;
    }
}
