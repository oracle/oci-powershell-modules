...
{
    [Cmdlet("Invoke", "OCIGenerativeaiinferenceRerankText")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiinferenceService.Models.RerankTextResult), typeof(Oci.GenerativeaiinferenceService.Responses.RerankTextResponse) })]
    public class InvokeOCIGenerativeaiinferenceRerankText : OCIGenerativeAiInferenceCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details required for the rerank request.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.RerankText(request, completionOption: HttpCompletionOption).GetAwaiter().GetResult();
                WriteOutput(response, response.RerankTextResult);
        ...
        private RerankTextResponse response;
    }
}
