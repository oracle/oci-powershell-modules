...
{
    [Cmdlet("Get", "OCIIdentitydomainsNotificationSettingsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.NotificationSettings), typeof(Oci.IdentitydomainsService.Responses.ListNotificationSettingsResponse) })]
    public class GetOCIIdentitydomainsNotificationSettingsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListNotificationSettingsRequest
                {
                ...
                response = client.ListNotificationSettings(request).GetAwaiter().GetResult();
        ...
        private ListNotificationSettingsResponse response;
    }
}
