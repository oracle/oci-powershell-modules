...
{
    [Cmdlet("Move", "OCIStackmonitoringMetricExtensionCompartment")]
    ...
    public class MoveOCIStackmonitoringMetricExtensionCompartment : OCIStackMonitoringCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeMetricExtensionCompartmentRequest
                {
                ...
                response = client.ChangeMetricExtensionCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeMetricExtensionCompartmentResponse response;
    }
}
