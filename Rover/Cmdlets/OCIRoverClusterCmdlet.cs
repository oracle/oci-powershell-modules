...
{
    public abstract class OCIRoverClusterCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new RoverClusterClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected RoverClusterClient client;
