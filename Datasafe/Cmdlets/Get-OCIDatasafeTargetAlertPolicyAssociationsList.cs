...
{
    [Cmdlet("Get", "OCIDatasafeTargetAlertPolicyAssociationsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.TargetAlertPolicyAssociationCollection), typeof(Oci.DatasafeService.Responses.ListTargetAlertPolicyAssociationsResponse) })]
    public class GetOCIDatasafeTargetAlertPolicyAssociationsList : OCIDataSafeCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only items related to a specific target-alert policy association ID.")]
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListTargetAlertPolicyAssociationsRequest.SortOrderEnum> SortOrder { get; set; }
...
**Example:** 2016-12-19T16:39:57.600Z")]
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListTargetAlertPolicyAssociationsRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListTargetAlertPolicyAssociationsRequest
                {
                ...
                IEnumerable<ListTargetAlertPolicyAssociationsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.TargetAlertPolicyAssociationCollection, true);
                }
        ...
        {
            IEnumerable<ListTargetAlertPolicyAssociationsResponse> DefaultRequest(ListTargetAlertPolicyAssociationsRequest request) => Enumerable.Repeat(client.ListTargetAlertPolicyAssociations(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListTargetAlertPolicyAssociationsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListTargetAlertPolicyAssociationsResponse response;
        private delegate IEnumerable<ListTargetAlertPolicyAssociationsResponse> RequestDelegate(ListTargetAlertPolicyAssociationsRequest request);
