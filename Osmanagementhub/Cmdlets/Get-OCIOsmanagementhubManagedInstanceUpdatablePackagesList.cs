...
{
    [Cmdlet("Get", "OCIOsmanagementhubManagedInstanceUpdatablePackagesList")]
    [OutputType(new System.Type[] { typeof(Oci.OsmanagementhubService.Models.UpdatablePackageCollection), typeof(Oci.OsmanagementhubService.Responses.ListManagedInstanceUpdatablePackagesResponse) })]
    public class GetOCIOsmanagementhubManagedInstanceUpdatablePackagesList : OCIManagedInstanceCmdlet
    {
...
Example: `3`")]
        ...
        public System.Nullable<Oci.OsmanagementhubService.Requests.ListManagedInstanceUpdatablePackagesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListManagedInstanceUpdatablePackagesRequest
                {
                ...
                IEnumerable<ListManagedInstanceUpdatablePackagesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.UpdatablePackageCollection, true);
                }
        ...
        {
            IEnumerable<ListManagedInstanceUpdatablePackagesResponse> DefaultRequest(ListManagedInstanceUpdatablePackagesRequest request) => Enumerable.Repeat(client.ListManagedInstanceUpdatablePackages(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListManagedInstanceUpdatablePackagesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListManagedInstanceUpdatablePackagesResponse response;
        private delegate IEnumerable<ListManagedInstanceUpdatablePackagesResponse> RequestDelegate(ListManagedInstanceUpdatablePackagesRequest request);
