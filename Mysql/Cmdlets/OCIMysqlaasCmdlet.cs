...
{
    public abstract class OCIMysqlaasCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MysqlaasClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MysqlaasClient client;
