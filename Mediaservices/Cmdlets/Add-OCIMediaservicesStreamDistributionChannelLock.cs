...
{
    [Cmdlet("Add", "OCIMediaservicesStreamDistributionChannelLock")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.StreamDistributionChannel), typeof(Oci.MediaservicesService.Responses.AddStreamDistributionChannelLockResponse) })]
    public class AddOCIMediaservicesStreamDistributionChannelLock : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddStreamDistributionChannelLockRequest
                {
                ...
                response = client.AddStreamDistributionChannelLock(request).GetAwaiter().GetResult();
        ...
        private AddStreamDistributionChannelLockResponse response;
    }
}
