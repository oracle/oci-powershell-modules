...
{
    [Cmdlet("Move", "OCIGoldengateDeploymentSubscription")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.ChangeDeploymentSubscriptionResponse) })]
    public class MoveOCIGoldengateDeploymentSubscription : OCIGoldenGateCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Associate a GoldenGate deployment with a different subscription.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeDeploymentSubscriptionRequest
                {
                ...
                response = client.ChangeDeploymentSubscription(request).GetAwaiter().GetResult();
        ...
        private ChangeDeploymentSubscriptionResponse response;
    }
}
