...
{
    [Cmdlet("Get", "OCIAidocumentWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.AidocumentService.Models.WorkRequest), typeof(Oci.AidocumentService.Responses.GetWorkRequestResponse) })]
    public class GetOCIAidocumentWorkRequest : OCIAIServiceDocumentCmdlet
    {
        ...
        public Oci.AidocumentService.Models.OperationStatus[] WaitForStatus { get; set; }
