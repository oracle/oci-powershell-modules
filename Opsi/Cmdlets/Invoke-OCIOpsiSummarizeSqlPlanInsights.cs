...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeSqlPlanInsights")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.SqlPlanInsightAggregationCollection), typeof(Oci.OpsiService.Responses.SummarizeSqlPlanInsightsResponse) })]
    public class InvokeOCIOpsiSummarizeSqlPlanInsights : OCIOperationsInsightsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeSqlPlanInsightsRequest
                {
                ...
                response = client.SummarizeSqlPlanInsights(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SqlPlanInsightAggregationCollection);
        ...
        private SummarizeSqlPlanInsightsResponse response;
    }
}
