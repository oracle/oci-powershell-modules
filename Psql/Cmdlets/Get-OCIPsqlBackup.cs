...
{
    [Cmdlet("Get", "OCIPsqlBackup", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PsqlService.Models.Backup), typeof(Oci.PsqlService.Responses.GetBackupResponse) })]
    public class GetOCIPsqlBackup : OCIPostgresqlCmdlet
    {
        ...
        public Oci.PsqlService.Models.Backup.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
