...
{
    [Cmdlet("Get", "OCIDatacatalogNamespace", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Namespace), typeof(Oci.DatacatalogService.Responses.GetNamespaceResponse) })]
    public class GetOCIDatacatalogNamespace : OCIDataCatalogCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifies the fields to return in a namespace response.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifies the fields to return in a namespace response.", ParameterSetName = Default)]
        public System.Collections.Generic.List<Oci.DatacatalogService.Requests.GetNamespaceRequest.FieldsEnum> Fields { get; set; }
