...
{
    [Cmdlet("Update", "OCIDatabaseAutonomousDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousDatabase), typeof(Oci.DatabaseService.Responses.UpdateAutonomousDatabaseResponse) })]
    public class UpdateOCIDatabaseAutonomousDatabase : OCIDatabaseCmdlet
    {
        ...
        private void HandleOutput(UpdateAutonomousDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateAutonomousDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpdateAutonomousDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousDatabase);
        }

        private UpdateAutonomousDatabaseResponse response;
