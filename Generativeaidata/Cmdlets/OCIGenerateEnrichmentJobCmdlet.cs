...
using Oci.GenerativeaidataService;

namespace Oci.GenerativeaidataService.Cmdlets
{
    public abstract class OCIGenerateEnrichmentJobCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new GenerateEnrichmentJobClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected GenerateEnrichmentJobClient client;
