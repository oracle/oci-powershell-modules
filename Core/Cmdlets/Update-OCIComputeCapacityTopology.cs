...
{
    [Cmdlet("Update", "OCIComputeCapacityTopology", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.UpdateComputeCapacityTopologyResponse) })]
    public class UpdateOCIComputeCapacityTopology : OCIComputeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateComputeCapacityTopologyRequest
                {
        ...
        private void HandleOutput(UpdateComputeCapacityTopologyRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateComputeCapacityTopology(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpdateComputeCapacityTopology(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private UpdateComputeCapacityTopologyResponse response;
