...
{
    [Cmdlet("Disable", "OCIDatabaseExternalPluggableDatabaseStackMonitoring", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DisableExternalPluggableDatabaseStackMonitoringResponse) })]
    public class DisableOCIDatabaseExternalPluggableDatabaseStackMonitoring : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableExternalPluggableDatabaseStackMonitoringRequest
                {
        ...
        private void HandleOutput(DisableExternalPluggableDatabaseStackMonitoringRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDisableExternalPluggableDatabaseStackMonitoring(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DisableExternalPluggableDatabaseStackMonitoring(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DisableExternalPluggableDatabaseStackMonitoringResponse response;
