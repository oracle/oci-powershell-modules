...
{
    [Cmdlet("Get", "OCIOsmanagementhubSoftwareSourcesList")]
    ...
    public class GetOCIOsmanagementhubSoftwareSourcesList : OCISoftwareSourceCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the software source.")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A multi filter to return resources that do not contains the given display names.")]
