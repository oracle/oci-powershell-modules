...
{
    [Cmdlet("Get", "OCILockboxWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.LockboxService.Models.WorkRequestLogEntryCollection), typeof(Oci.LockboxService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCILockboxWorkRequestLogsList : OCILockboxCmdlet
    {
        ...
        public System.Nullable<Oci.LockboxService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
