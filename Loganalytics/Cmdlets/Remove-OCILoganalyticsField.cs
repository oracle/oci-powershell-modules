...
{
    [Cmdlet("Remove", "OCILoganalyticsField", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCILoganalyticsField : OCILogAnalyticsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCILoganalyticsField", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteField(request).GetAwaiter().GetResult();
        ...
        private DeleteFieldResponse response;
    }
}
