...
{
    public abstract class OCINetworkLoadBalancerCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new NetworkLoadBalancerClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected NetworkLoadBalancerClient client;
