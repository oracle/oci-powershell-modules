...
namespace Oci.OpsiService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the database to be enabled in Operations Insights. This parameter also accepts subtypes <Oci.OpsiService.Models.EnableEmManagedExternalDatabaseInsightDetails>, <Oci.OpsiService.Models.EnableMdsMySqlDatabaseInsightDetails>, <Oci.OpsiService.Models.EnableExternalMysqlDatabaseInsightDetails>, <Oci.OpsiService.Models.EnableAutonomousDatabaseInsightDetails>, <Oci.OpsiService.Models.EnableMacsManagedCloudDatabaseInsightDetails>, <Oci.OpsiService.Models.EnablePeComanagedDatabaseInsightDetails> of type <Oci.OpsiService.Models.EnableDatabaseInsightDetails>.")]
