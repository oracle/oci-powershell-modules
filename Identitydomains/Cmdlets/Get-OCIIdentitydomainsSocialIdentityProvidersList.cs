...
{
    [Cmdlet("Get", "OCIIdentitydomainsSocialIdentityProvidersList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SocialIdentityProviders), typeof(Oci.IdentitydomainsService.Responses.ListSocialIdentityProvidersResponse) })]
    public class GetOCIIdentitydomainsSocialIdentityProvidersList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSocialIdentityProvidersRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListSocialIdentityProviders(request).GetAwaiter().GetResult();
        ...
        private ListSocialIdentityProvidersResponse response;
    }
}
