...
{
    [Cmdlet("Remove", "OCILoggingLog", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.LoggingService.Responses.DeleteLogResponse) })]
    public class RemoveOCILoggingLog : OCILoggingManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCILoggingLog", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteLog(request).GetAwaiter().GetResult();
        ...
        private DeleteLogResponse response;
    }
}
