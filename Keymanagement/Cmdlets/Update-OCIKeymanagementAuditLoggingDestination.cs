...
{
    [Cmdlet("Update", "OCIKeymanagementAuditLoggingDestination")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.AuditLogging), typeof(Oci.KeymanagementService.Responses.UpdateAuditLoggingDestinationResponse) })]
    public class UpdateOCIKeymanagementAuditLoggingDestination : OCIKmsHsmClusterCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information need to make changes for management audit logs.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateAuditLoggingDestinationRequest
                {
                ...
                response = client.UpdateAuditLoggingDestination(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AuditLogging);
        ...
        private UpdateAuditLoggingDestinationResponse response;
    }
}
