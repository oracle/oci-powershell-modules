...
{
    [Cmdlet("Move", "OCIResourcemanagerConfigurationSourceProviderCompartment")]
    ...
    public class MoveOCIResourcemanagerConfigurationSourceProviderCompartment : OCIResourceManagerCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeConfigurationSourceProviderCompartmentRequest
                {
                ...
                response = client.ChangeConfigurationSourceProviderCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeConfigurationSourceProviderCompartmentResponse response;
    }
}
