...
using Oci.HealthchecksService;

namespace Oci.HealthchecksService.Cmdlets
{
    public abstract class OCIHealthChecksCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new HealthChecksClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected HealthChecksClient client;
