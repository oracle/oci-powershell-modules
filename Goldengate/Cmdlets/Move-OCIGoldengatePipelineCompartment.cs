...
{
    [Cmdlet("Move", "OCIGoldengatePipelineCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.ChangePipelineCompartmentResponse) })]
    public class MoveOCIGoldengatePipelineCompartment : OCIGoldenGateCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Properties to change the compartment of a Pipeline.")]
