...
{
    [Cmdlet("Remove", "OCIMonitoringAlarm", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.MonitoringService.Responses.DeleteAlarmResponse) })]
    public class RemoveOCIMonitoringAlarm : OCIMonitoringCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIMonitoringAlarm", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteAlarm(request).GetAwaiter().GetResult();
        ...
        private DeleteAlarmResponse response;
    }
}
