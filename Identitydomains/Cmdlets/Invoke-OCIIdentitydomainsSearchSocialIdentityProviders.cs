...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchSocialIdentityProviders")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SocialIdentityProviders), typeof(Oci.IdentitydomainsService.Responses.SearchSocialIdentityProvidersResponse) })]
    public class InvokeOCIIdentitydomainsSearchSocialIdentityProviders : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching SocialIdentityProviders")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchSocialIdentityProvidersRequest
                {
                ...
                response = client.SearchSocialIdentityProviders(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SocialIdentityProviders);
        ...
        private SearchSocialIdentityProvidersResponse response;
    }
}
