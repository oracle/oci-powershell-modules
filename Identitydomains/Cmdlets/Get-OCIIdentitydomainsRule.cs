...
{
    [Cmdlet("Get", "OCIIdentitydomainsRule")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Rule), typeof(Oci.IdentitydomainsService.Responses.GetRuleResponse) })]
    public class GetOCIIdentitydomainsRule : OCIIdentityDomainsCmdlet
    {
