...
{
    [Cmdlet("New", "OCIManagementdashboardManagementSavedSearch")]
    ...
    public class NewOCIManagementdashboardManagementSavedSearch : OCIDashxApisCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateManagementSavedSearchRequest
                {
                ...
                response = client.CreateManagementSavedSearch(request).GetAwaiter().GetResult();
        ...
        private CreateManagementSavedSearchResponse response;
    }
}
