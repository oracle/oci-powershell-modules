...
{
    [Cmdlet("Update", "OCIFunctionsManagementFunction")]
    ...
    public class UpdateOCIFunctionsManagementFunction : OCIFunctionsManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpdateFunction(request).GetAwaiter().GetResult();
        ...
        private UpdateFunctionResponse response;
    }
}
