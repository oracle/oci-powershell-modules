...
{
    [Cmdlet("Get", "OCIIdentitydomainsCloudGateServer")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.CloudGateServer), typeof(Oci.IdentitydomainsService.Responses.GetCloudGateServerResponse) })]
    public class GetOCIIdentitydomainsCloudGateServer : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetCloudGateServerRequest
                {
                ...
                response = client.GetCloudGateServer(request).GetAwaiter().GetResult();
        ...
        private GetCloudGateServerResponse response;
    }
}
