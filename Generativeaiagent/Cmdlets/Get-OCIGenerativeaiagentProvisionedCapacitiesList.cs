...
namespace Oci.GenerativeaiagentService.Cmdlets
{
    ...
    public class GetOCIGenerativeaiagentProvisionedCapacitiesList : OCIGenerativeAiAgentCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the provisioned capacity.")]
