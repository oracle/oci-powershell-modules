...
{
    [Cmdlet("Get", "OCIObjectstorageWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.ObjectstorageService.Models.WorkRequestSummary), typeof(Oci.ObjectstorageService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIObjectstorageWorkRequestsList : OCIObjectStorageCmdlet
    {
