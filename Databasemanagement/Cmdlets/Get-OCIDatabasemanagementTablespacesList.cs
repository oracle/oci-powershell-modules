...
{
    [Cmdlet("Get", "OCIDatabasemanagementTablespacesList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.TablespaceCollection), typeof(Oci.DatabasemanagementService.Responses.ListTablespacesResponse) })]
    public class GetOCIDatabasemanagementTablespacesList : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.ListTablespacesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListTablespacesRequest
                {
                ...
                {
                    response = item;
                    WriteOutput(response, response.TablespaceCollection, true);
                }
        ...
        {
            IEnumerable<ListTablespacesResponse> DefaultRequest(ListTablespacesRequest request) => Enumerable.Repeat(client.ListTablespaces(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListTablespacesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListTablespacesResponse response;
        private delegate IEnumerable<ListTablespacesResponse> RequestDelegate(ListTablespacesRequest request);
