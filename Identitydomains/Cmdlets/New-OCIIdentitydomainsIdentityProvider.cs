...
{
    [Cmdlet("New", "OCIIdentitydomainsIdentityProvider")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.IdentityProvider), typeof(Oci.IdentitydomainsService.Responses.CreateIdentityProviderResponse) })]
    public class NewOCIIdentitydomainsIdentityProvider : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"IdentityProvider schema.
