...
namespace Oci.DatabaseService.Cmdlets
{
    ...
    public class GetOCIDatabaseKeyStore : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the key store.", ParameterSetName = LifecycleStateParamSet)]
