...
{
    [Cmdlet("Remove", "OCIFunctionsApplication", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.FunctionsService.Responses.DeleteApplicationResponse) })]
    public class RemoveOCIFunctionsApplication : OCIFunctionsManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIFunctionsApplication", "Remove"))
            {
               return;
            }
