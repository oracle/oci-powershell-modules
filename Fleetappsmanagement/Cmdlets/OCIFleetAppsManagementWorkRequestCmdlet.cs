...
{
    public abstract class OCIFleetAppsManagementWorkRequestCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new FleetAppsManagementWorkRequestClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected FleetAppsManagementWorkRequestClient client;
