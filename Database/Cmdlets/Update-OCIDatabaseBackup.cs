...
{
    [Cmdlet("Update", "OCIDatabaseBackup", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Backup), typeof(Oci.DatabaseService.Responses.UpdateBackupResponse) })]
    public class UpdateOCIDatabaseBackup : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to update the properties of a Backup.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to update the properties of a Backup.", ParameterSetName = Default)]
        ...
        private void HandleOutput(UpdateBackupRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateBackup(request, waiterConfig, WaitForStatus).Execute();
                    break;
