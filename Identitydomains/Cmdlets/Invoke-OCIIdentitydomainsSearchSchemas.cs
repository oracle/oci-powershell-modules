...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchSchemas")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Schemas), typeof(Oci.IdentitydomainsService.Responses.SearchSchemasResponse) })]
    public class InvokeOCIIdentitydomainsSearchSchemas : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching Schemas")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchSchemasRequest
                {
                ...
                response = client.SearchSchemas(request).GetAwaiter().GetResult();
                WriteOutput(response, response.Schemas);
        ...
        private SearchSchemasResponse response;
    }
}
