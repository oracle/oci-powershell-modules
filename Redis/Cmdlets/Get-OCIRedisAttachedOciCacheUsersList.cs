...
{
    [Cmdlet("Get", "OCIRedisAttachedOciCacheUsersList")]
    ...
    public class GetOCIRedisAttachedOciCacheUsersList : OCIRedisClusterCmdlet
    {
        ...
        public System.Nullable<Oci.RedisService.Requests.ListAttachedOciCacheUsersRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAttachedOciCacheUsersRequest
                {
                ...
                IEnumerable<ListAttachedOciCacheUsersResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListAttachedOciCacheUsersResponse> DefaultRequest(ListAttachedOciCacheUsersRequest request) => Enumerable.Repeat(client.ListAttachedOciCacheUsers(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListAttachedOciCacheUsersResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListAttachedOciCacheUsersResponse response;
        private delegate IEnumerable<ListAttachedOciCacheUsersResponse> RequestDelegate(ListAttachedOciCacheUsersRequest request);
