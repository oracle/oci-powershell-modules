...
{
    [Cmdlet("Remove", "OCIIdentitydomainsApp", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteAppResponse) })]
    public class RemoveOCIIdentitydomainsApp : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsApp", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteApp(request).GetAwaiter().GetResult();
        ...
        private DeleteAppResponse response;
    }
}
