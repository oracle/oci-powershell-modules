...
{
    public abstract class OCITenancyAttachmentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new TenancyAttachmentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected TenancyAttachmentClient client;
