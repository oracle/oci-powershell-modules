...
{
    [Cmdlet("Invoke", "OCIDatabaseUnmountAdvancedClusterFileSystem", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AdvancedClusterFileSystem), typeof(Oci.DatabaseService.Responses.UnmountAdvancedClusterFileSystemResponse) })]
    public class InvokeOCIDatabaseUnmountAdvancedClusterFileSystem : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UnmountAdvancedClusterFileSystemRequest
                {
        ...
        private void HandleOutput(UnmountAdvancedClusterFileSystemRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUnmountAdvancedClusterFileSystem(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UnmountAdvancedClusterFileSystem(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AdvancedClusterFileSystem);
        }

        private UnmountAdvancedClusterFileSystemResponse response;
