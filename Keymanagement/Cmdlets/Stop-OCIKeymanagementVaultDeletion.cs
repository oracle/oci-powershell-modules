...
{
    [Cmdlet("Stop", "OCIKeymanagementVaultDeletion")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.Vault), typeof(Oci.KeymanagementService.Responses.CancelVaultDeletionResponse) })]
    public class StopOCIKeymanagementVaultDeletion : OCIKmsVaultCmdlet
    {
        ...
        private CancelVaultDeletionResponse response;
    }
}
