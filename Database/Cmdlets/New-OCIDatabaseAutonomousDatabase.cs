...
namespace Oci.DatabaseService.Cmdlets
{
    ...
    public class NewOCIDatabaseAutonomousDatabase : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to create a new Autonomous AI Database. This parameter also accepts subtypes <Oci.DatabaseService.Models.UndeleteAutonomousDatabaseDetails>, <Oci.DatabaseService.Models.CreateAutonomousDatabaseCloneDetails>, <Oci.DatabaseService.Models.CreateRefreshableAutonomousDatabaseCloneDetails>, <Oci.DatabaseService.Models.CreateAutonomousDatabaseFromBackupDetails>, <Oci.DatabaseService.Models.CreateCrossRegionDisasterRecoveryDetails>, <Oci.DatabaseService.Models.CreateAutonomousDatabaseFromBackupTimestampDetails>, <Oci.DatabaseService.Models.CreateCrossTenancyDisasterRecoveryDetails>, <Oci.DatabaseService.Models.CreateCrossRegionAutonomousDatabaseDataGuardDetails>, <Oci.DatabaseService.Models.CreateAutonomousDatabaseDetails> of type <Oci.DatabaseService.Models.CreateAutonomousDatabaseBase>.", ParameterSetName = StatusParamSet)]
