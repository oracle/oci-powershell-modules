...
{
    [Cmdlet("Stop", "OCIServicemeshWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ServicemeshService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIServicemeshWorkRequest : OCIServiceMeshCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIServicemeshWorkRequest", "Stop"))
            {
               return;
            }
