...
{
    [Cmdlet("Get", "OCIJmsLibraryManagedInstanceUsageList")]
    ...
    public class GetOCIJmsLibraryManagedInstanceUsageList : OCIJavaManagementServiceCmdlet
    {
        ...
        public System.Nullable<Oci.JmsService.Models.LibraryManagedInstanceSortBy> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListLibraryManagedInstanceUsageRequest
                {
                    FleetId = FleetId,
                ...
                IEnumerable<ListLibraryManagedInstanceUsageResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.LibraryManagedInstanceUsageCollection, true);
                }
        ...
        {
            IEnumerable<ListLibraryManagedInstanceUsageResponse> DefaultRequest(ListLibraryManagedInstanceUsageRequest request) => Enumerable.Repeat(client.ListLibraryManagedInstanceUsage(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListLibraryManagedInstanceUsageResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListLibraryManagedInstanceUsageResponse response;
        private delegate IEnumerable<ListLibraryManagedInstanceUsageResponse> RequestDelegate(ListLibraryManagedInstanceUsageRequest request);
