...
{
    [Cmdlet("New", "OCINetworkfirewallDecryptionRule")]
    [OutputType(new System.Type[] { typeof(Oci.NetworkfirewallService.Models.DecryptionRule), typeof(Oci.NetworkfirewallService.Responses.CreateDecryptionRuleResponse) })]
    public class NewOCINetworkfirewallDecryptionRule : OCINetworkFirewallCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateDecryptionRuleRequest
                {
                ...
                response = client.CreateDecryptionRule(request).GetAwaiter().GetResult();
        ...
        private CreateDecryptionRuleResponse response;
    }
}
