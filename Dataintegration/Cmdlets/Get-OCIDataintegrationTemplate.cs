...
{
    [Cmdlet("Get", "OCIDataintegrationTemplate", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.Template), typeof(Oci.DataintegrationService.Responses.GetTemplateResponse) })]
    public class GetOCIDataintegrationTemplate : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the template.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the template.", ParameterSetName = Default)]
        ...
        public Oci.DataintegrationService.Models.Template.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
