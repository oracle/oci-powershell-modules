...
{
    public abstract class OCIShardedDatabaseServiceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ShardedDatabaseServiceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ShardedDatabaseServiceClient client;
