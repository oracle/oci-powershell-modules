...
namespace Oci.DistributeddatabaseService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIDistributeddatabaseDownloadDistributedDatabaseGsmCertificateSigningRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DistributeddatabaseService.Responses.DownloadDistributedDatabaseGsmCertificateSigningRequestResponse) })]
    public class InvokeOCIDistributeddatabaseDownloadDistributedDatabaseGsmCertificateSigningRequest : OCIDistributedDbServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DownloadDistributedDatabaseGsmCertificateSigningRequestRequest
                {
                ...
                response = client.DownloadDistributedDatabaseGsmCertificateSigningRequest(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private DownloadDistributedDatabaseGsmCertificateSigningRequestResponse response;
