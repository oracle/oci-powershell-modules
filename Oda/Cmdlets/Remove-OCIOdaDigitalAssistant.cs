...
{
    [Cmdlet("Remove", "OCIOdaDigitalAssistant", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OdaService.Responses.DeleteDigitalAssistantResponse) })]
    public class RemoveOCIOdaDigitalAssistant : OCIManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOdaDigitalAssistant", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDigitalAssistantRequest
                {
                ...
                response = client.DeleteDigitalAssistant(request).GetAwaiter().GetResult();
        ...
        private DeleteDigitalAssistantResponse response;
    }
}
