...
{
    [Cmdlet("DisMount", "OCITransferPackageDevicesFromTransferPackage")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DtsService.Responses.DetachDevicesFromTransferPackageResponse) })]
    public class DisMountOCITransferPackageDevicesFromTransferPackage : OCITransferPackageCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Labels of Transfer Devices to detach")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DetachDevicesFromTransferPackageRequest
                {
                    Id = Id,
                ...
                response = client.DetachDevicesFromTransferPackage(request).GetAwaiter().GetResult();
        ...
        private DetachDevicesFromTransferPackageResponse response;
    }
}
