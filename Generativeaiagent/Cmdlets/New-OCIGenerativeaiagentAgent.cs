...
{
    [Cmdlet("New", "OCIGenerativeaiagentAgent")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiagentService.Models.Agent), typeof(Oci.GenerativeaiagentService.Responses.CreateAgentResponse) })]
    public class NewOCIGenerativeaiagentAgent : OCIGenerativeAiAgentCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new agent.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CreateAgent(request).GetAwaiter().GetResult();
        ...
        private CreateAgentResponse response;
    }
}
