...
{
    [Cmdlet("Update", "OCINetworkloadbalancerBackendSet")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NetworkloadbalancerService.Responses.UpdateBackendSetResponse) })]
    public class UpdateOCINetworkloadbalancerBackendSet : OCINetworkLoadBalancerCmdlet
    {
