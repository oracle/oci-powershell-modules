...
{
    [Cmdlet("Remove", "OCIApigatewaySdk", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApigatewayService.Responses.DeleteSdkResponse) })]
    public class RemoveOCIApigatewaySdk : OCIApiGatewayCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIApigatewaySdk", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteSdk(request).GetAwaiter().GetResult();
        ...
        private DeleteSdkResponse response;
    }
}
