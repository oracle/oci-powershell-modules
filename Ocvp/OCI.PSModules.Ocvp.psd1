...
GUID = '6a5976be-ed09-45ea-809d-df741799c16e'
...
CmdletsToExport = 'Get-OCIEsxiHost', 'Get-OCIEsxiHostsList', 'Get-OCISddc', 
               'Get-OCISddcsList', 
               'Get-OCISddcSupportedVmwareSoftwareVersionsList', 
               'Get-OCIWorkRequest', 'Get-OCIWorkRequestErrorsList', 
               'Get-OCIWorkRequestLogsList', 'Get-OCIWorkRequestsList', 
               'Move-OCISddcCompartment', 'New-OCIEsxiHost', 'New-OCISddc', 
               'Remove-OCIEsxiHost', 'Remove-OCISddc', 'Update-OCIEsxiHost', 
               'Update-OCISddc'
