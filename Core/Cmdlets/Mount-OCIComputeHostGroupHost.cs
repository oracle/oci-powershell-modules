...
{
    [Cmdlet("Mount", "OCIComputeHostGroupHost", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.ComputeHost), typeof(Oci.CoreService.Responses.AttachComputeHostGroupHostResponse) })]
    public class MountOCIComputeHostGroupHost : OCIComputeCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host.", ParameterSetName = Default)]
        public string ComputeHostId { get; set; }

        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host group.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host group.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AttachComputeHostGroupHostRequest
                {
        ...
        private void HandleOutput(AttachComputeHostGroupHostRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForAttachComputeHostGroupHost(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.AttachComputeHostGroupHost(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.ComputeHost);
        }

        private AttachComputeHostGroupHostResponse response;
