...
{
    public abstract class OCIRewardsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new RewardsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected RewardsClient client;
