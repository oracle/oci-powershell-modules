...
{
    [Cmdlet("Start", "OCIDistributeddatabase")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.StartDistributedDatabaseResponse) })]
    public class StartOCIDistributeddatabase : OCIDistributedDbServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartDistributedDatabaseRequest
                {
                ...
                response = client.StartDistributedDatabase(request).GetAwaiter().GetResult();
        ...
        private StartDistributedDatabaseResponse response;
    }
}
