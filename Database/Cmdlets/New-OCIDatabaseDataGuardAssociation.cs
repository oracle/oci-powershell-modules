...
namespace Oci.DatabaseService.Cmdlets
{
    ...
    public class NewOCIDatabaseDataGuardAssociation : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A request to create a Data Guard association. This parameter also accepts subtypes <Oci.DatabaseService.Models.CreateDataGuardAssociationWithNewDbSystemDetails>, <Oci.DatabaseService.Models.CreateDataGuardAssociationToExistingVmClusterDetails>, <Oci.DatabaseService.Models.CreateDataGuardAssociationToExistingDbSystemDetails> of type <Oci.DatabaseService.Models.CreateDataGuardAssociationDetails>.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A request to create a Data Guard association. This parameter also accepts subtypes <Oci.DatabaseService.Models.CreateDataGuardAssociationWithNewDbSystemDetails>, <Oci.DatabaseService.Models.CreateDataGuardAssociationToExistingVmClusterDetails>, <Oci.DatabaseService.Models.CreateDataGuardAssociationToExistingDbSystemDetails> of type <Oci.DatabaseService.Models.CreateDataGuardAssociationDetails>.", ParameterSetName = Default)]
