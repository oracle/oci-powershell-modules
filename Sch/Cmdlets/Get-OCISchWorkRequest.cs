...
{
    [Cmdlet("Get", "OCISchWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.SchService.Models.WorkRequest), typeof(Oci.SchService.Responses.GetWorkRequestResponse) })]
    public class GetOCISchWorkRequest : OCIServiceConnectorCmdlet
    {
        ...
        public Oci.SchService.Models.OperationStatus[] WaitForStatus { get; set; }
