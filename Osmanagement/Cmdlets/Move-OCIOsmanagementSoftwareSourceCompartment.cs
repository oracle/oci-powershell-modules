...
{
    [Cmdlet("Move", "OCIOsmanagementSoftwareSourceCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OsmanagementService.Responses.ChangeSoftwareSourceCompartmentResponse) })]
    public class MoveOCIOsmanagementSoftwareSourceCompartment : OCIOsManagementCmdlet
    {
