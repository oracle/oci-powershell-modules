...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyAuthTokensList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyAuthTokens), typeof(Oci.IdentitydomainsService.Responses.ListMyAuthTokensResponse) })]
    public class GetOCIIdentitydomainsMyAuthTokensList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMyAuthTokensRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListMyAuthTokens(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MyAuthTokens);
        ...
        private ListMyAuthTokensResponse response;
    }
}
