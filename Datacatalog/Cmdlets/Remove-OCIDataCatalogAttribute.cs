...
{
    [Cmdlet("Remove", "OCIDataCatalogAttribute", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatacatalogService.Responses.DeleteAttributeResponse) })]
    public class RemoveOCIDataCatalogAttribute : OCIDataCatalogCmdlet
    {
        ...
        private DeleteAttributeResponse response;
    }
}
