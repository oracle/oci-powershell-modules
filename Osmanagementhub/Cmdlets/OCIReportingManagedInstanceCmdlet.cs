...
{
    public abstract class OCIReportingManagedInstanceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ReportingManagedInstanceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ReportingManagedInstanceClient client;
