...
{
    [Cmdlet("Remove", "OCIMysqlDbSystem", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.DeleteDbSystemResponse) })]
    public class RemoveOCIMysqlDbSystem : OCIDbSystemCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIMysqlDbSystem", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteDbSystem(request).GetAwaiter().GetResult();
        ...
        private DeleteDbSystemResponse response;
    }
}
