...
{
    [Cmdlet("Remove", "OCIApmsyntheticsWorker", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ApmsyntheticsService.Responses.DeleteWorkerResponse) })]
    public class RemoveOCIApmsyntheticsWorker : OCIApmSyntheticCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the On-premise vantage point worker.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIApmsyntheticsWorker", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteWorker(request).GetAwaiter().GetResult();
        ...
        private DeleteWorkerResponse response;
    }
}
