...
{
    [Cmdlet("Update", "OCIDnsView", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DnsService.Models.View), typeof(Oci.DnsService.Responses.UpdateViewResponse) })]
    public class UpdateOCIDnsView : OCIDnsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"New data for the view.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"New data for the view.", ParameterSetName = Default)]
        ...
        private void HandleOutput(UpdateViewRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateView(request, waiterConfig, WaitForStatus).Execute();
                    break;
        ...
        private UpdateViewResponse response;
