...
{
    [Cmdlet("Start", "OCIGloballydistributeddatabaseShardedDatabase")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GloballydistributeddatabaseService.Responses.StartShardedDatabaseResponse) })]
    public class StartOCIGloballydistributeddatabaseShardedDatabase : OCIShardedDatabaseServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartShardedDatabaseRequest
                {
                ...
                response = client.StartShardedDatabase(request).GetAwaiter().GetResult();
        ...
        private StartShardedDatabaseResponse response;
    }
}
