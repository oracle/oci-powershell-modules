...
{
    [Cmdlet("Remove", "OCIDatacatalogAttributeTag", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatacatalogService.Responses.DeleteAttributeTagResponse) })]
    public class RemoveOCIDatacatalogAttributeTag : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatacatalogAttributeTag", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteAttributeTagRequest
                {
                    CatalogId = CatalogId,
        ...
        private DeleteAttributeTagResponse response;
    }
}
