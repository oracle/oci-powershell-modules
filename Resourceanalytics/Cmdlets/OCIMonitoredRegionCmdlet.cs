...
{
    public abstract class OCIMonitoredRegionCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MonitoredRegionClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MonitoredRegionClient client;
