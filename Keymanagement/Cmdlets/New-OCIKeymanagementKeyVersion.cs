...
{
    [Cmdlet("New", "OCIKeymanagementKeyVersion")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.KeyVersion), typeof(Oci.KeymanagementService.Responses.CreateKeyVersionResponse) })]
    public class NewOCIKeymanagementKeyVersion : OCIKmsManagementCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"CreateKeyMetadataDetails")]
        ...
        private CreateKeyVersionResponse response;
    }
}
