...
{
    [Cmdlet("Restart", "OCIMysqlHeatWaveCluster")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.RestartHeatWaveClusterResponse) })]
    public class RestartOCIMysqlHeatWaveCluster : OCIDbSystemCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RestartHeatWaveClusterRequest
                {
                ...
                response = client.RestartHeatWaveCluster(request).GetAwaiter().GetResult();
        ...
        private RestartHeatWaveClusterResponse response;
    }
}
