...
{
    [Cmdlet("Update", "OCIDataintegrationTaskSchedule")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.TaskSchedule), typeof(Oci.DataintegrationService.Responses.UpdateTaskScheduleResponse) })]
    public class UpdateOCIDataintegrationTaskSchedule : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request body parameter for TaskSchedule details")]
