...
{
    [Cmdlet("Invoke", "OCIGoldengateSwitchoverDeploymentPeer")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.SwitchoverDeploymentPeerResponse) })]
    public class InvokeOCIGoldengateSwitchoverDeploymentPeer : OCIGoldenGateCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A unique Deployment identifier.")]
        public string DeploymentId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Metadata to switchover a deployment to a peer")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SwitchoverDeploymentPeerRequest
                {
                ...
                response = client.SwitchoverDeploymentPeer(request).GetAwaiter().GetResult();
        ...
        private SwitchoverDeploymentPeerResponse response;
    }
}
