...
{
    [Cmdlet("New", "OCIAilanguageModel")]
    [OutputType(new System.Type[] { typeof(Oci.AilanguageService.Models.Model), typeof(Oci.AilanguageService.Responses.CreateModelResponse) })]
    public class NewOCIAilanguageModel : OCIAIServiceLanguageCmdlet
    {
