...
{
    [Cmdlet("Move", "OCIRecoveryProtectedDatabaseSubscription")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.RecoveryService.Responses.ChangeProtectedDatabaseSubscriptionResponse) })]
    public class MoveOCIRecoveryProtectedDatabaseSubscription : OCIDatabaseRecoveryCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeProtectedDatabaseSubscriptionRequest
                {
                ...
                response = client.ChangeProtectedDatabaseSubscription(request).GetAwaiter().GetResult();
        ...
        private ChangeProtectedDatabaseSubscriptionResponse response;
    }
}
