...
{
    public abstract class OCIOracleDBAzureBlobContainerCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OracleDBAzureBlobContainerClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OracleDBAzureBlobContainerClient client;
