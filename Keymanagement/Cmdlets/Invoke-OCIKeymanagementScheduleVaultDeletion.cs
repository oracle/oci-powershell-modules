...
{
    [Cmdlet("Invoke", "OCIKeymanagementScheduleVaultDeletion")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.Vault), typeof(Oci.KeymanagementService.Responses.ScheduleVaultDeletionResponse) })]
    public class InvokeOCIKeymanagementScheduleVaultDeletion : OCIKmsVaultCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the vault.")]
        public string VaultId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"ScheduleVaultDeletionDetails")]
        ...
        private ScheduleVaultDeletionResponse response;
    }
}
