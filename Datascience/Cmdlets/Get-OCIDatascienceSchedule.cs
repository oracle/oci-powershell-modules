...
{
    [Cmdlet("Get", "OCIDatascienceSchedule", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.Schedule), typeof(Oci.DatascienceService.Responses.GetScheduleResponse) })]
    public class GetOCIDatascienceSchedule : OCIDataScienceCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"unique Schedule identifier", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"unique Schedule identifier", ParameterSetName = Default)]
        ...
        public Oci.DatascienceService.Models.ScheduleLifecycleState[] WaitForLifecycleState { get; set; }
