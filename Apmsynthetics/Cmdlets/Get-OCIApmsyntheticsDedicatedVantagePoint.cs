...
{
    [Cmdlet("Get", "OCIApmsyntheticsDedicatedVantagePoint")]
    [OutputType(new System.Type[] { typeof(Oci.ApmsyntheticsService.Models.DedicatedVantagePoint), typeof(Oci.ApmsyntheticsService.Responses.GetDedicatedVantagePointResponse) })]
    public class GetOCIApmsyntheticsDedicatedVantagePoint : OCIApmSyntheticCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetDedicatedVantagePointRequest
                {
        ...
        private GetDedicatedVantagePointResponse response;
    }
}
