...
{
    [Cmdlet("Disable", "OCIDatabaseExternalPluggableDatabaseOperationsInsights", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DisableExternalPluggableDatabaseOperationsInsightsResponse) })]
    public class DisableOCIDatabaseExternalPluggableDatabaseOperationsInsights : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableExternalPluggableDatabaseOperationsInsightsRequest
                {
        ...
        private void HandleOutput(DisableExternalPluggableDatabaseOperationsInsightsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDisableExternalPluggableDatabaseOperationsInsights(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DisableExternalPluggableDatabaseOperationsInsights(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DisableExternalPluggableDatabaseOperationsInsightsResponse response;
