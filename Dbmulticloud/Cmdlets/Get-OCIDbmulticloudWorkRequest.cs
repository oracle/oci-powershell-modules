...
{
    [Cmdlet("Get", "OCIDbmulticloudWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DbmulticloudService.Models.WorkRequest), typeof(Oci.DbmulticloudService.Responses.GetWorkRequestResponse) })]
    public class GetOCIDbmulticloudWorkRequest : OCIWorkRequestCmdlet
    {
        ...
        public Oci.DbmulticloudService.Models.OperationStatus[] WaitForStatus { get; set; }
