...
{
    [Cmdlet("Start", "OCIDataintegrationWorkspace")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DataintegrationService.Responses.StartWorkspaceResponse) })]
    public class StartOCIDataintegrationWorkspace : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartWorkspaceRequest
                {
                ...
                response = client.StartWorkspace(request).GetAwaiter().GetResult();
        ...
        private StartWorkspaceResponse response;
    }
}
