...
{
    [Cmdlet("Start", "OCICloudmigrationsMigrationReplication")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CloudmigrationsService.Responses.StartMigrationReplicationResponse) })]
    public class StartOCICloudmigrationsMigrationReplication : OCIMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartMigrationReplicationRequest
                {
                ...
                response = client.StartMigrationReplication(request).GetAwaiter().GetResult();
        ...
        private StartMigrationReplicationResponse response;
    }
}
