...
namespace Oci.DataintegrationService.Cmdlets
{
    ...
    public class UpdateOCIDataintegrationConnection : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information needed to update a connection. This parameter also accepts subtypes <Oci.DataintegrationService.Models.UpdateConnectionFromLake>, <Oci.DataintegrationService.Models.UpdateConnectionFromJdbc>, <Oci.DataintegrationService.Models.UpdateConnectionFromObjectStorage>, <Oci.DataintegrationService.Models.UpdateConnectionFromBICC>, <Oci.DataintegrationService.Models.UpdateConnectionFromRestNoAuth>, <Oci.DataintegrationService.Models.UpdateConnectionFromAmazonS3>, <Oci.DataintegrationService.Models.UpdateConnectionFromAtp>, <Oci.DataintegrationService.Models.UpdateConnectionFromRestBasicAuth>, <Oci.DataintegrationService.Models.UpdateConnectionFromOracle>, <Oci.DataintegrationService.Models.UpdateConnectionFromAdwc>, <Oci.DataintegrationService.Models.UpdateConnectionFromBIP>, <Oci.DataintegrationService.Models.UpdateConnectionFromMySQL> of type <Oci.DataintegrationService.Models.UpdateConnectionDetails>.")]
