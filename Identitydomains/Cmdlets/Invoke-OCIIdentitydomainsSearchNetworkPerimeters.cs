...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchNetworkPerimeters")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.NetworkPerimeters), typeof(Oci.IdentitydomainsService.Responses.SearchNetworkPerimetersResponse) })]
    public class InvokeOCIIdentitydomainsSearchNetworkPerimeters : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching NetworkPerimeters")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchNetworkPerimetersRequest
                {
                ...
                response = client.SearchNetworkPerimeters(request).GetAwaiter().GetResult();
        ...
        private SearchNetworkPerimetersResponse response;
    }
}
