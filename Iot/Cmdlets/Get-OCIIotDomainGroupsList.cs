...
{
    [Cmdlet("Get", "OCIIotDomainGroupsList")]
    [OutputType(new System.Type[] { typeof(Oci.IotService.Models.IotDomainGroupCollection), typeof(Oci.IotService.Responses.ListIotDomainGroupsResponse) })]
    public class GetOCIIotDomainGroupsList : OCIIotCmdlet
    {
        ...
        public System.Nullable<Oci.IotService.Requests.ListIotDomainGroupsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.IotService.Requests.ListIotDomainGroupsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListIotDomainGroupsRequest
                {
                ...
                IEnumerable<ListIotDomainGroupsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.IotDomainGroupCollection, true);
                }
        ...
        {
            IEnumerable<ListIotDomainGroupsResponse> DefaultRequest(ListIotDomainGroupsRequest request) => Enumerable.Repeat(client.ListIotDomainGroups(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListIotDomainGroupsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListIotDomainGroupsResponse response;
        private delegate IEnumerable<ListIotDomainGroupsResponse> RequestDelegate(ListIotDomainGroupsRequest request);
