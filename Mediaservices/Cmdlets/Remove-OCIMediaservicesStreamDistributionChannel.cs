...
{
    [Cmdlet("Remove", "OCIMediaservicesStreamDistributionChannel", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.MediaservicesService.Responses.DeleteStreamDistributionChannelResponse) })]
    public class RemoveOCIMediaservicesStreamDistributionChannel : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIMediaservicesStreamDistributionChannel", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteStreamDistributionChannelRequest
                {
                ...
                response = client.DeleteStreamDistributionChannel(request).GetAwaiter().GetResult();
        ...
        private DeleteStreamDistributionChannelResponse response;
    }
}
