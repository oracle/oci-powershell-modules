...
{
    [Cmdlet("Get", "OCINetworkloadbalancersProtocolsList")]
    [OutputType(new System.Type[] { typeof(Oci.NetworkloadbalancerService.Models.NetworkLoadBalancersProtocolCollection), typeof(Oci.NetworkloadbalancerService.Responses.ListNetworkLoadBalancersProtocolsResponse) })]
    public class GetOCINetworkloadbalancersProtocolsList : OCINetworkLoadBalancerCmdlet
    {
        ...
        public System.Nullable<Oci.NetworkloadbalancerService.Requests.ListNetworkLoadBalancersProtocolsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListNetworkLoadBalancersProtocolsRequest
                {
                ...
                IEnumerable<ListNetworkLoadBalancersProtocolsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.NetworkLoadBalancersProtocolCollection, true);
                }
        ...
        {
            IEnumerable<ListNetworkLoadBalancersProtocolsResponse> DefaultRequest(ListNetworkLoadBalancersProtocolsRequest request) => Enumerable.Repeat(client.ListNetworkLoadBalancersProtocols(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListNetworkLoadBalancersProtocolsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListNetworkLoadBalancersProtocolsResponse response;
        private delegate IEnumerable<ListNetworkLoadBalancersProtocolsResponse> RequestDelegate(ListNetworkLoadBalancersProtocolsRequest request);
