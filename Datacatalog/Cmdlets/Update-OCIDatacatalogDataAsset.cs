...
{
    [Cmdlet("Update", "OCIDatacatalogDataAsset")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.DataAsset), typeof(Oci.DatacatalogService.Responses.UpdateDataAssetResponse) })]
    public class UpdateOCIDatacatalogDataAsset : OCIDataCatalogCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information to be updated in the data asset.")]
