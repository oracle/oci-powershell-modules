...
{
    [Cmdlet("New", "OCIGenerativeaiModel")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.Model), typeof(Oci.GenerativeaiService.Responses.CreateModelResponse) })]
    public class NewOCIGenerativeaiModel : OCIGenerativeAiCmdlet
    {
