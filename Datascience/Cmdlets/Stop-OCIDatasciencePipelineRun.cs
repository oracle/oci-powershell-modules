...
{
    [Cmdlet("Stop", "OCIDatasciencePipelineRun")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatascienceService.Responses.CancelPipelineRunResponse) })]
    public class StopOCIDatasciencePipelineRun : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelPipelineRunRequest
                {
        ...
        private CancelPipelineRunResponse response;
    }
}
