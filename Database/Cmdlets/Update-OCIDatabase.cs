...
{
    [Cmdlet("Update", "OCIDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Database), typeof(Oci.DatabaseService.Responses.UpdateDatabaseResponse) })]
    public class UpdateOCIDatabase : OCIDatabaseCmdlet
    {
        ...
        private void HandleOutput(UpdateDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpdateDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.Database);
        }

        private UpdateDatabaseResponse response;
