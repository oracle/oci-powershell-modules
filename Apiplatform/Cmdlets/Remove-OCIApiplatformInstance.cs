...
{
    [Cmdlet("Remove", "OCIApiplatformInstance", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.ApiplatformService.Responses.DeleteApiPlatformInstanceResponse) })]
    public class RemoveOCIApiplatformInstance : OCIApiPlatformCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIApiplatformInstance", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteApiPlatformInstanceRequest
                {
                ...
                response = client.DeleteApiPlatformInstance(request).GetAwaiter().GetResult();
        ...
        private DeleteApiPlatformInstanceResponse response;
    }
}
