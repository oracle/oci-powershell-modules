...
{
    [Cmdlet("Get", "OCIIdentitydomainsCustomerSecretKey")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.CustomerSecretKey), typeof(Oci.IdentitydomainsService.Responses.GetCustomerSecretKeyResponse) })]
    public class GetOCIIdentitydomainsCustomerSecretKey : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetCustomerSecretKeyRequest
                {
                ...
                response = client.GetCustomerSecretKey(request).GetAwaiter().GetResult();
        ...
        private GetCustomerSecretKeyResponse response;
    }
}
