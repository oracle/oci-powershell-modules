...
{
    [Cmdlet("Stop", "OCILustrefilestorageImportFromObject")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.LustrefilestorageService.Responses.StopImportFromObjectResponse) })]
    public class StopOCILustrefilestorageImportFromObject : OCILustreFileStorageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StopImportFromObjectRequest
                {
                ...
                response = client.StopImportFromObject(request).GetAwaiter().GetResult();
        ...
        private StopImportFromObjectResponse response;
    }
}
