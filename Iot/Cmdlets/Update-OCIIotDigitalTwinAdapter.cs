...
{
    [Cmdlet("Update", "OCIIotDigitalTwinAdapter")]
    ...
    public class UpdateOCIIotDigitalTwinAdapter : OCIIotCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDigitalTwinAdapterRequest
                {
                ...
                response = client.UpdateDigitalTwinAdapter(request).GetAwaiter().GetResult();
        ...
        private UpdateDigitalTwinAdapterResponse response;
    }
}
