...
{
    [Cmdlet("Move", "OCISecurityattributeNamespaceCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.SecurityattributeService.Responses.ChangeSecurityAttributeNamespaceCompartmentResponse) })]
    public class MoveOCISecurityattributeNamespaceCompartment : OCISecurityAttributeCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request object for changing the compartment of a security attribute namespace.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeSecurityAttributeNamespaceCompartmentRequest
                {
                ...
                response = client.ChangeSecurityAttributeNamespaceCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeSecurityAttributeNamespaceCompartmentResponse response;
    }
}
