...
namespace Oci.ResourcemanagerService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIResourcemanagerJobTfConfig", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.ResourcemanagerService.Responses.GetJobTfConfigResponse) })]
    public class GetOCIResourcemanagerJobTfConfig : OCIResourceManagerCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetJobTfConfigRequest
                {
                    JobId = JobId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetJobTfConfig(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetJobTfConfigResponse response;
