...
{
    [Cmdlet("New", "OCIDemandsignalOccMetricAlarm")]
    [OutputType(new System.Type[] { typeof(Oci.DemandsignalService.Models.OccMetricAlarm), typeof(Oci.DemandsignalService.Responses.CreateOccMetricAlarmResponse) })]
    public class NewOCIDemandsignalOccMetricAlarm : OCIOccMetricAlarmCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details for creating a new OccMetricAlarm.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateOccMetricAlarmRequest
                {
                ...
                response = client.CreateOccMetricAlarm(request).GetAwaiter().GetResult();
        ...
        private CreateOccMetricAlarmResponse response;
    }
}
