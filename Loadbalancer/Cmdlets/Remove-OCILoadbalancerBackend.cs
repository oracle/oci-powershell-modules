...
{
    [Cmdlet("Remove", "OCILoadbalancerBackend", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.LoadbalancerService.Responses.DeleteBackendResponse) })]
    public class RemoveOCILoadbalancerBackend : OCILoadBalancerCmdlet
    {
...
Example: `example_backend_set`")]
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The IP address and port of the backend server to remove.
...
Example: `example-etag`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCILoadbalancerBackend", "Remove"))
            {
               return;
            }
