...
{
    [Cmdlet("Get", "OCIDevopsDeploymentsList")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.DeploymentCollection), typeof(Oci.DevopsService.Responses.ListDeploymentsResponse) })]
    public class GetOCIDevopsDeploymentsList : OCIDevopsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only Deployments that matches the given lifecycleState.")]
        public System.Nullable<Oci.DevopsService.Models.Deployment.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.DevopsService.Requests.ListDeploymentsRequest.SortByEnum> SortBy { get; set; }
