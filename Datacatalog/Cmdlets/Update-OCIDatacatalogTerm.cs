...
{
    [Cmdlet("Update", "OCIDatacatalogTerm")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Term), typeof(Oci.DatacatalogService.Responses.UpdateTermResponse) })]
    public class UpdateOCIDatacatalogTerm : OCIDataCatalogCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information to be updated in the term.")]
