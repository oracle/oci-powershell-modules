...
{
    [Cmdlet("Get", "OCIDevopsProject", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.Project), typeof(Oci.DevopsService.Responses.GetProjectResponse) })]
    public class GetOCIDevopsProject : OCIDevopsCmdlet
    {
        ...
        public Oci.DevopsService.Models.Project.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
