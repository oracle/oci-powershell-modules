...
{
    [Cmdlet("New", "OCIDataCatalogDataAsset")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.DataAsset), typeof(Oci.DatacatalogService.Responses.CreateDataAssetResponse) })]
    public class NewOCIDataCatalogDataAsset : OCIDataCatalogCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique catalog identifier.")]
        public string CatalogId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information used to create the data asset.")]
