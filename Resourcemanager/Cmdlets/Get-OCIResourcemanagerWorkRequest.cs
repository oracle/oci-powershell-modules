...
{
    [Cmdlet("Get", "OCIResourcemanagerWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.ResourcemanagerService.Models.WorkRequest), typeof(Oci.ResourcemanagerService.Responses.GetWorkRequestResponse) })]
    public class GetOCIResourcemanagerWorkRequest : OCIResourceManagerCmdlet
    {
        ...
        public Oci.ResourcemanagerService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
