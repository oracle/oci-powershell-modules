...
{
    public abstract class OCIRoverBundleCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new RoverBundleClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected RoverBundleClient client;
