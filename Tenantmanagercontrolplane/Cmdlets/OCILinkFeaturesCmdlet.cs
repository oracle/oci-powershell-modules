...
{
    public abstract class OCILinkFeaturesCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new LinkFeaturesClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected LinkFeaturesClient client;
