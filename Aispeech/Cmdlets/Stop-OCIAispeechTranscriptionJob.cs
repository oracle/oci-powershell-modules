...
{
    [Cmdlet("Stop", "OCIAispeechTranscriptionJob")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AispeechService.Responses.CancelTranscriptionJobResponse) })]
    public class StopOCIAispeechTranscriptionJob : OCIAIServiceSpeechCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelTranscriptionJobRequest
                {
                ...
                response = client.CancelTranscriptionJob(request).GetAwaiter().GetResult();
        ...
        private CancelTranscriptionJobResponse response;
    }
}
