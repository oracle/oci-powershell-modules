...
{
    [Cmdlet("Stop", "OCICertificatesmanagementCertificateAuthorityDeletion")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CertificatesmanagementService.Responses.CancelCertificateAuthorityDeletionResponse) })]
    public class StopOCICertificatesmanagementCertificateAuthorityDeletion : OCICertificatesManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelCertificateAuthorityDeletionRequest
                {
                ...
                response = client.CancelCertificateAuthorityDeletion(request).GetAwaiter().GetResult();
        ...
        private CancelCertificateAuthorityDeletionResponse response;
    }
}
