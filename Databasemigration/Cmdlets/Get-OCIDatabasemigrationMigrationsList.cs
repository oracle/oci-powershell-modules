...
namespace Oci.DatabasemigrationService.Cmdlets
{
    ...
    public class GetOCIDatabasemigrationMigrationsList : OCIDatabaseMigrationCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The lifecycle state of the Migration.")]
        public System.Nullable<Oci.DatabasemigrationService.Models.MigrationLifecycleStates> LifecycleState { get; set; }
