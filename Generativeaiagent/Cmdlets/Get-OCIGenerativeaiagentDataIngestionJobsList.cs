...
{
    [Cmdlet("Get", "OCIGenerativeaiagentDataIngestionJobsList")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiagentService.Models.DataIngestionJobCollection), typeof(Oci.GenerativeaiagentService.Responses.ListDataIngestionJobsResponse) })]
    public class GetOCIGenerativeaiagentDataIngestionJobsList : OCIGenerativeAiAgentCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the data source.")]
        ...
        public System.Nullable<Oci.GenerativeaiagentService.Models.DataIngestionJob.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.GenerativeaiagentService.Requests.ListDataIngestionJobsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListDataIngestionJobsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.DataIngestionJobCollection, true);
                }
        ...
        {
            IEnumerable<ListDataIngestionJobsResponse> DefaultRequest(ListDataIngestionJobsRequest request) => Enumerable.Repeat(client.ListDataIngestionJobs(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListDataIngestionJobsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListDataIngestionJobsResponse response;
        private delegate IEnumerable<ListDataIngestionJobsResponse> RequestDelegate(ListDataIngestionJobsRequest request);
