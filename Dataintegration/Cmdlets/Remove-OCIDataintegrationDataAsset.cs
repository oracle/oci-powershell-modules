...
{
    [Cmdlet("Remove", "OCIDataintegrationDataAsset", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataintegrationService.Responses.DeleteDataAssetResponse) })]
    public class RemoveOCIDataintegrationDataAsset : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataintegrationDataAsset", "Remove"))
            {
               return;
            }
