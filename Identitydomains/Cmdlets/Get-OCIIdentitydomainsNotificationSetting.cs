...
{
    [Cmdlet("Get", "OCIIdentitydomainsNotificationSetting")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.NotificationSetting), typeof(Oci.IdentitydomainsService.Responses.GetNotificationSettingResponse) })]
    public class GetOCIIdentitydomainsNotificationSetting : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.GetNotificationSetting(request).GetAwaiter().GetResult();
        ...
        private GetNotificationSettingResponse response;
    }
}
