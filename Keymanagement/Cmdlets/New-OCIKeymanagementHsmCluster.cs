...
{
    [Cmdlet("New", "OCIKeymanagementHsmCluster")]
    [OutputType(new System.Type[] { typeof(Oci.KeymanagementService.Models.HsmCluster), typeof(Oci.KeymanagementService.Responses.CreateHsmClusterResponse) })]
    public class NewOCIKeymanagementHsmCluster : OCIKmsHsmClusterCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new HsmCluster resource")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateHsmClusterRequest
                {
                ...
                response = client.CreateHsmCluster(request).GetAwaiter().GetResult();
        ...
        private CreateHsmClusterResponse response;
    }
}
