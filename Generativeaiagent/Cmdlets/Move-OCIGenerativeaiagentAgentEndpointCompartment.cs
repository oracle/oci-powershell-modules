...
{
    [Cmdlet("Move", "OCIGenerativeaiagentAgentEndpointCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GenerativeaiagentService.Responses.ChangeAgentEndpointCompartmentResponse) })]
    public class MoveOCIGenerativeaiagentAgentEndpointCompartment : OCIGenerativeAiAgentCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeAgentEndpointCompartmentRequest
                {
                ...
                response = client.ChangeAgentEndpointCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeAgentEndpointCompartmentResponse response;
    }
}
