...
{
    [Cmdlet("Remove", "OCICapacitymanagementOccCustomer", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CapacitymanagementService.Responses.DeleteOccCustomerResponse) })]
    public class RemoveOCICapacitymanagementOccCustomer : OCICapacityManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCICapacitymanagementOccCustomer", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteOccCustomerRequest
                {
                ...
                response = client.DeleteOccCustomer(request).GetAwaiter().GetResult();
        ...
        private DeleteOccCustomerResponse response;
    }
}
