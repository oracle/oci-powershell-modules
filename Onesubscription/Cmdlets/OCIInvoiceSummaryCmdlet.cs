...
{
    public abstract class OCIInvoiceSummaryCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new InvoiceSummaryClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected InvoiceSummaryClient client;
