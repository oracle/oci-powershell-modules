...
namespace Oci.CloudmigrationsService.Cmdlets
{
     ...
     */
    [Cmdlet("Export", "OCICloudmigrationsMigrationPlan", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.CloudmigrationsService.Responses.ExportMigrationPlanResponse) })]
    public class ExportOCICloudmigrationsMigrationPlan : OCIMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ExportMigrationPlanRequest
                {
                    MigrationPlanId = MigrationPlanId,
                    OpcRequestId = OpcRequestId
                };

                response = client.ExportMigrationPlan(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private ExportMigrationPlanResponse response;
