...
{
    [Cmdlet("Invoke", "OCIJmsRequestSummarizedApplicationUsage")]
    [OutputType(new System.Type[] { typeof(Oci.JmsService.Models.ApplicationUsageCollection), typeof(Oci.JmsService.Responses.RequestSummarizedApplicationUsageResponse) })]
    public class InvokeOCIJmsRequestSummarizedApplicationUsage : OCIJavaManagementServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for filtering application usage.")]
        public RequestSummarizedApplicationUsageDetails RequestSummarizedApplicationUsageDetails { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RequestSummarizedApplicationUsageRequest
                {
                    FleetId = FleetId,
                ...
                response = client.RequestSummarizedApplicationUsage(request).GetAwaiter().GetResult();
        ...
        private RequestSummarizedApplicationUsageResponse response;
    }
}
