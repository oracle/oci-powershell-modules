...
{
    [Cmdlet("Remove", "OCIOpsiConfiguration", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.DeleteOpsiConfigurationResponse) })]
    public class RemoveOCIOpsiConfiguration : OCIOperationsInsightsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOpsiConfiguration", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteOpsiConfigurationRequest
                {
                ...
                response = client.DeleteOpsiConfiguration(request).GetAwaiter().GetResult();
        ...
        private DeleteOpsiConfigurationResponse response;
    }
}
