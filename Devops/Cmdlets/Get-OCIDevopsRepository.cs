...
{
    [Cmdlet("Get", "OCIDevopsRepository", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.Repository), typeof(Oci.DevopsService.Responses.GetRepositoryResponse) })]
    public class GetOCIDevopsRepository : OCIDevopsCmdlet
    {
        ...
        public Oci.DevopsService.Models.Repository.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
