...
{
    [Cmdlet("Invoke", "OCIAnalyticsSetFeatureBundle")]
    ...
    public class InvokeOCIAnalyticsSetFeatureBundle : OCIAnalyticsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SetFeatureBundleRequest
                {
                ...
                response = client.SetFeatureBundle(request).GetAwaiter().GetResult();
        ...
        private SetFeatureBundleResponse response;
    }
}
