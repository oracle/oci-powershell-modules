...
{
    [Cmdlet("Update", "OCIComputeHostGroup", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.ComputeHostGroup), typeof(Oci.CoreService.Responses.UpdateComputeHostGroupResponse) })]
    public class UpdateOCIComputeHostGroup : OCIComputeCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host group.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host group.", ParameterSetName = Default)]
        public string ComputeHostGroupId { get; set; }

        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Update compute host group details.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Update compute host group details.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateComputeHostGroupRequest
                {
        ...
        private void HandleOutput(UpdateComputeHostGroupRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateComputeHostGroup(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpdateComputeHostGroup(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.ComputeHostGroup);
        }

        private UpdateComputeHostGroupResponse response;
