...
{
    [Cmdlet("Get", "OCIDatacatalogFolder", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Folder), typeof(Oci.DatacatalogService.Responses.GetFolderResponse) })]
    public class GetOCIDatacatalogFolder : OCIDataCatalogCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifies the fields to return in a folder response.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifies the fields to return in a folder response.", ParameterSetName = Default)]
        public System.Collections.Generic.List<Oci.DatacatalogService.Requests.GetFolderRequest.FieldsEnum> Fields { get; set; }
