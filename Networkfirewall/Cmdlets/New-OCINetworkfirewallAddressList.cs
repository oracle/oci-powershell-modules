...
{
    [Cmdlet("New", "OCINetworkfirewallAddressList")]
    [OutputType(new System.Type[] { typeof(Oci.NetworkfirewallService.Models.AddressList), typeof(Oci.NetworkfirewallService.Responses.CreateAddressListResponse) })]
    public class NewOCINetworkfirewallAddressList : OCINetworkFirewallCmdlet
    {
