...
{
    [Cmdlet("Add", "OCIOcvpBlockVolumeToDatastore")]
    ...
    public class AddOCIOcvpBlockVolumeToDatastore : OCIDatastoreCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddBlockVolumeToDatastoreRequest
                {
                ...
                response = client.AddBlockVolumeToDatastore(request).GetAwaiter().GetResult();
        ...
        private AddBlockVolumeToDatastoreResponse response;
    }
}
