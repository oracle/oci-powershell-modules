...
using Oci.IotService;

namespace Oci.IotService.Cmdlets
{
    public abstract class OCIIotCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new IotClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
