...
{
    [Cmdlet("Get", "OCIIdentitydomainsMySupportAccount")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MySupportAccount), typeof(Oci.IdentitydomainsService.Responses.GetMySupportAccountResponse) })]
    public class GetOCIIdentitydomainsMySupportAccount : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMySupportAccountRequest
                {
                ...
                response = client.GetMySupportAccount(request).GetAwaiter().GetResult();
        ...
        private GetMySupportAccountResponse response;
    }
}
