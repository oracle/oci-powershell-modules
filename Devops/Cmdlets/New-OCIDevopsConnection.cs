...
namespace Oci.DevopsService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new connection. This parameter also accepts subtypes <Oci.DevopsService.Models.CreateGithubAccessTokenConnectionDetails>, <Oci.DevopsService.Models.CreateGitlabAccessTokenConnectionDetails> of type <Oci.DevopsService.Models.CreateConnectionDetails>.")]
