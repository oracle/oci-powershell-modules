...
{
    [Cmdlet("Stop", "OCICertificatesmanagementCertificateAuthorityVersionDeletion")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CertificatesmanagementService.Responses.CancelCertificateAuthorityVersionDeletionResponse) })]
    public class StopOCICertificatesmanagementCertificateAuthorityVersionDeletion : OCICertificatesManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelCertificateAuthorityVersionDeletionRequest
                {
                ...
                response = client.CancelCertificateAuthorityVersionDeletion(request).GetAwaiter().GetResult();
        ...
        private CancelCertificateAuthorityVersionDeletionResponse response;
    }
}
