...
{
    public abstract class OCIOpensearchClusterCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OpensearchClusterClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OpensearchClusterClient client;
