...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class RemoveOCIFusionappsFusionEnvironmentFamily : OCIFusionApplicationsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIFusionappsFusionEnvironmentFamily", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteFusionEnvironmentFamilyRequest
                {
                ...
                response = client.DeleteFusionEnvironmentFamily(request).GetAwaiter().GetResult();
        ...
        private DeleteFusionEnvironmentFamilyResponse response;
    }
}
