...
{
    [Cmdlet("Invoke", "OCIDatabaseCascadingDeleteSchedulingPlan", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.CascadingDeleteSchedulingPlanResponse) })]
    public class InvokeOCIDatabaseCascadingDeleteSchedulingPlan : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CascadingDeleteSchedulingPlanRequest
                {
        ...
        private void HandleOutput(CascadingDeleteSchedulingPlanRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForCascadingDeleteSchedulingPlan(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.CascadingDeleteSchedulingPlan(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private CascadingDeleteSchedulingPlanResponse response;
