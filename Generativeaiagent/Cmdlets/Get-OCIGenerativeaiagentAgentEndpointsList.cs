...
{
    [Cmdlet("Get", "OCIGenerativeaiagentAgentEndpointsList")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiagentService.Models.AgentEndpointCollection), typeof(Oci.GenerativeaiagentService.Responses.ListAgentEndpointsResponse) })]
    public class GetOCIGenerativeaiagentAgentEndpointsList : OCIGenerativeAiAgentCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the agent.")]
        ...
        public System.Nullable<Oci.GenerativeaiagentService.Models.AgentEndpoint.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.GenerativeaiagentService.Requests.ListAgentEndpointsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAgentEndpointsRequest
                {
                ...
                IEnumerable<ListAgentEndpointsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.AgentEndpointCollection, true);
                }
        ...
        {
            IEnumerable<ListAgentEndpointsResponse> DefaultRequest(ListAgentEndpointsRequest request) => Enumerable.Repeat(client.ListAgentEndpoints(request).GetAwaiter().GetResult(), 1);
        ...
        private ListAgentEndpointsResponse response;
        private delegate IEnumerable<ListAgentEndpointsResponse> RequestDelegate(ListAgentEndpointsRequest request);
