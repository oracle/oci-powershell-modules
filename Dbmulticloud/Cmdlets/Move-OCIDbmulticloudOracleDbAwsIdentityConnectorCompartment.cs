...
{
    [Cmdlet("Move", "OCIDbmulticloudOracleDbAwsIdentityConnectorCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DbmulticloudService.Responses.ChangeOracleDbAwsIdentityConnectorCompartmentResponse) })]
    public class MoveOCIDbmulticloudOracleDbAwsIdentityConnectorCompartment : OCIDbMulticloudAwsProviderCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Moves the Oracle DB AWS Identity COnnector resource into a different compartment.")]
...
For example, if a resource has been deleted and permanently purged from the system, a retry of the original creation request may be rejected.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeOracleDbAwsIdentityConnectorCompartmentRequest
                {
                ...
                response = client.ChangeOracleDbAwsIdentityConnectorCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeOracleDbAwsIdentityConnectorCompartmentResponse response;
    }
}
