...
{
    [Cmdlet("New", "OCIDataconnectivityConnection")]
    [OutputType(new System.Type[] { typeof(Oci.DataconnectivityService.Models.Connection), typeof(Oci.DataconnectivityService.Responses.CreateConnectionResponse) })]
    public class NewOCIDataconnectivityConnection : OCIDataConnectivityManagementCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The registry OCID.")]
        public string RegistryId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The information required to create a connection.")]
