...
{
    public abstract class OCIDisasterRecoveryCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DisasterRecoveryClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DisasterRecoveryClient client;
