...
{
    [Cmdlet("Restore", "OCIGoldengateDeployment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.RestoreDeploymentResponse) })]
    public class RestoreOCIGoldengateDeployment : OCIGoldenGateCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A placeholder for any additional metadata to describe the deployment restore. This parameter also accepts subtype <Oci.GoldengateService.Models.DefaultRestoreDeploymentDetails> of type <Oci.GoldengateService.Models.RestoreDeploymentDetails>.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RestoreDeploymentRequest
                {
                ...
                response = client.RestoreDeployment(request).GetAwaiter().GetResult();
        ...
        private RestoreDeploymentResponse response;
    }
}
