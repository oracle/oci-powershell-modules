...
{
    [Cmdlet("Remove", "OCIApigatewayCertificateLock")]
    [OutputType(new System.Type[] { typeof(Oci.ApigatewayService.Models.Certificate), typeof(Oci.ApigatewayService.Responses.RemoveCertificateLockResponse) })]
    public class RemoveOCIApigatewayCertificateLock : OCIApiGatewayCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveCertificateLockRequest
                {
                ...
                response = client.RemoveCertificateLock(request).GetAwaiter().GetResult();
        ...
        private RemoveCertificateLockResponse response;
    }
}
