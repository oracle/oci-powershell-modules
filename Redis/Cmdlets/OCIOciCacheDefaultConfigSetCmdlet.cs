...
using Oci.RedisService;

namespace Oci.RedisService.Cmdlets
{
    public abstract class OCIOciCacheDefaultConfigSetCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OciCacheDefaultConfigSetClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OciCacheDefaultConfigSetClient client;
