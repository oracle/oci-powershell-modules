...
{
    [Cmdlet("Get", "OCIDblmWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DblmService.Models.WorkRequest), typeof(Oci.DblmService.Responses.GetWorkRequestResponse) })]
    public class GetOCIDblmWorkRequest : OCIDbLifeCycleManagementCmdlet
    {
        ...
        public Oci.DblmService.Models.OperationStatus[] WaitForStatus { get; set; }
