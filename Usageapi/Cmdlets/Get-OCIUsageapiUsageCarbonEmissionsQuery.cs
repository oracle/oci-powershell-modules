...
{
    [Cmdlet("Get", "OCIUsageapiUsageCarbonEmissionsQuery")]
    [OutputType(new System.Type[] { typeof(Oci.UsageapiService.Models.UsageCarbonEmissionsQuery), typeof(Oci.UsageapiService.Responses.GetUsageCarbonEmissionsQueryResponse) })]
    public class GetOCIUsageapiUsageCarbonEmissionsQuery : OCIUsageapiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetUsageCarbonEmissionsQueryRequest
                {
                    UsageCarbonEmissionsQueryId = UsageCarbonEmissionsQueryId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetUsageCarbonEmissionsQuery(request).GetAwaiter().GetResult();
        ...
        private GetUsageCarbonEmissionsQueryResponse response;
    }
}
