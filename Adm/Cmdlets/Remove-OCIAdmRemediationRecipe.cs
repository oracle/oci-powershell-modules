...
{
    [Cmdlet("Remove", "OCIAdmRemediationRecipe", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCIAdmRemediationRecipe : OCIApplicationDependencyManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAdmRemediationRecipe", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteRemediationRecipeRequest
                {
                ...
                response = client.DeleteRemediationRecipe(request).GetAwaiter().GetResult();
        ...
        private DeleteRemediationRecipeResponse response;
    }
}
