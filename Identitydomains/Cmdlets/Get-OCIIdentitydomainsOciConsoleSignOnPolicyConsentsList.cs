...
{
    [Cmdlet("Get", "OCIIdentitydomainsOciConsoleSignOnPolicyConsentsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.OciConsoleSignOnPolicyConsents), typeof(Oci.IdentitydomainsService.Responses.ListOciConsoleSignOnPolicyConsentsResponse) })]
    public class GetOCIIdentitydomainsOciConsoleSignOnPolicyConsentsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListOciConsoleSignOnPolicyConsentsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListOciConsoleSignOnPolicyConsents(request).GetAwaiter().GetResult();
        ...
        private ListOciConsoleSignOnPolicyConsentsResponse response;
    }
}
