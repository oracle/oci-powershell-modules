...
{
    [Cmdlet("New", "OCIDataintegrationTaskSchedule")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.TaskSchedule), typeof(Oci.DataintegrationService.Responses.CreateTaskScheduleResponse) })]
    public class NewOCIDataintegrationTaskSchedule : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateTaskScheduleRequest
                {
                ...
                response = client.CreateTaskSchedule(request).GetAwaiter().GetResult();
        ...
        private CreateTaskScheduleResponse response;
    }
}
