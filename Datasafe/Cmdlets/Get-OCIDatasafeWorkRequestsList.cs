...
namespace Oci.DatasafeService.Cmdlets
{
    ...
    public class GetOCIDatasafeWorkRequestsList : OCIDataSafeCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field used for sorting. Only one sorting parameter can be specified. The default order is descending.")]
        public System.Nullable<Oci.DatasafeService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sorting order for the work requests, either ascending (ASC) or descending (DESC).")]
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListWorkRequestsRequest.AccessLevelEnum> AccessLevel { get; set; }
