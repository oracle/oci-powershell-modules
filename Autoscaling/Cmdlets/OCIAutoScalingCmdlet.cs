...
using Oci.AutoscalingService;

namespace Oci.AutoscalingService.Cmdlets
{
    public abstract class OCIAutoScalingCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AutoScalingClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AutoScalingClient client;
