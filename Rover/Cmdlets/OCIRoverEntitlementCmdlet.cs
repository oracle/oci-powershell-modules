...
{
    public abstract class OCIRoverEntitlementCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new RoverEntitlementClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected RoverEntitlementClient client;
