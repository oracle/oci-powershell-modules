...
{
    [Cmdlet("Remove", "OCIDatabaseConsoleHistory", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteConsoleHistoryResponse) })]
    public class RemoveOCIDatabaseConsoleHistory : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseConsoleHistory", "Remove"))
            {
               return;
            }
        ...
        private void HandleOutput(DeleteConsoleHistoryRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteConsoleHistory(request, waiterConfig, WaitForStatus).Execute();
                    break;
        ...
        private DeleteConsoleHistoryResponse response;
