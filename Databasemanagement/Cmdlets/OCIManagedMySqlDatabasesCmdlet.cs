...
using Oci.DatabasemanagementService;

namespace Oci.DatabasemanagementService.Cmdlets
{
    public abstract class OCIManagedMySqlDatabasesCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ManagedMySqlDatabasesClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ManagedMySqlDatabasesClient client;
