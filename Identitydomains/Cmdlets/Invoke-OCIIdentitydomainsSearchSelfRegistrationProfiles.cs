...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchSelfRegistrationProfiles")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SelfRegistrationProfiles), typeof(Oci.IdentitydomainsService.Responses.SearchSelfRegistrationProfilesResponse) })]
    public class InvokeOCIIdentitydomainsSearchSelfRegistrationProfiles : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching SelfRegistrationProfiles")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchSelfRegistrationProfilesRequest
                {
                ...
                response = client.SearchSelfRegistrationProfiles(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SelfRegistrationProfiles);
        ...
        private SearchSelfRegistrationProfilesResponse response;
    }
}
