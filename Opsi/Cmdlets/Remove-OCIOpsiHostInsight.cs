...
{
    [Cmdlet("Remove", "OCIOpsiHostInsight", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.DeleteHostInsightResponse) })]
    public class RemoveOCIOpsiHostInsight : OCIOperationsInsightsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOpsiHostInsight", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteHostInsightRequest
                {
                ...
                response = client.DeleteHostInsight(request).GetAwaiter().GetResult();
        ...
        private DeleteHostInsightResponse response;
    }
}
