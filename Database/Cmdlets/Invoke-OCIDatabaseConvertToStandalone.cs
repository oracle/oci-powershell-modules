...
{
    [Cmdlet("Invoke", "OCIDatabaseConvertToStandalone", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Database), typeof(Oci.DatabaseService.Responses.ConvertToStandaloneResponse) })]
    public class InvokeOCIDatabaseConvertToStandalone : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ConvertToStandaloneRequest
                {
        ...
        private void HandleOutput(ConvertToStandaloneRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForConvertToStandalone(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ConvertToStandalone(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.Database);
        }

        private ConvertToStandaloneResponse response;
