...
{
    [Cmdlet("Get", "OCIApplicationmigrationWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.ApplicationmigrationService.Models.WorkRequestLogEntry), typeof(Oci.ApplicationmigrationService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIApplicationmigrationWorkRequestLogsList : OCIApplicationMigrationCmdlet
    {
