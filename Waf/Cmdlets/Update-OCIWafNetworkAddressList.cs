...
{
    [Cmdlet("Update", "OCIWafNetworkAddressList")]
    ...
    public class UpdateOCIWafNetworkAddressList : OCIWafCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateNetworkAddressListRequest
                {
                ...
                response = client.UpdateNetworkAddressList(request).GetAwaiter().GetResult();
        ...
        private UpdateNetworkAddressListResponse response;
    }
}
