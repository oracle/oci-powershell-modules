...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class UpdateOCIFusionappsFusionEnvironment : OCIFusionApplicationsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateFusionEnvironmentRequest
                {
                ...
                response = client.UpdateFusionEnvironment(request).GetAwaiter().GetResult();
        ...
        private UpdateFusionEnvironmentResponse response;
    }
}
