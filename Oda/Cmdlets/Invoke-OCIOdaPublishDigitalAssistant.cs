...
{
    [Cmdlet("Invoke", "OCIOdaPublishDigitalAssistant")]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.DigitalAssistant), typeof(Oci.OdaService.Responses.PublishDigitalAssistantResponse) })]
    public class InvokeOCIOdaPublishDigitalAssistant : OCIManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new PublishDigitalAssistantRequest
                {
                ...
                response = client.PublishDigitalAssistant(request).GetAwaiter().GetResult();
        ...
        private PublishDigitalAssistantResponse response;
    }
}
