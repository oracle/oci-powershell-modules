...
{
    [Cmdlet("Get", "OCIIdentitydomainsKmsiSettingsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.KmsiSettings), typeof(Oci.IdentitydomainsService.Responses.ListKmsiSettingsResponse) })]
    public class GetOCIIdentitydomainsKmsiSettingsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListKmsiSettingsRequest
                {
                ...
                response = client.ListKmsiSettings(request).GetAwaiter().GetResult();
        ...
        private ListKmsiSettingsResponse response;
    }
}
