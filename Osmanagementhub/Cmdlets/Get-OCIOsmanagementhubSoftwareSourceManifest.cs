...
namespace Oci.OsmanagementhubService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIOsmanagementhubSoftwareSourceManifest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.OsmanagementhubService.Responses.GetSoftwareSourceManifestResponse) })]
    public class GetOCIOsmanagementhubSoftwareSourceManifest : OCISoftwareSourceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetSoftwareSourceManifestRequest
                {
                    SoftwareSourceId = SoftwareSourceId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetSoftwareSourceManifest(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetSoftwareSourceManifestResponse response;
