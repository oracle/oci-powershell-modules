...
namespace Oci.DatasafeService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIDatasafeDownloadDiscoveryReport", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatasafeService.Responses.DownloadDiscoveryReportResponse) })]
    public class InvokeOCIDatasafeDownloadDiscoveryReport : OCIDataSafeCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details to download a discovery report.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DownloadDiscoveryReportRequest
                {
                ...
                response = client.DownloadDiscoveryReport(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private DownloadDiscoveryReportResponse response;
