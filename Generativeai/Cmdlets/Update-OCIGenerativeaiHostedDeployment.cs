...
{
    [Cmdlet("Update", "OCIGenerativeaiHostedDeployment")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.HostedDeployment), typeof(Oci.GenerativeaiService.Responses.UpdateHostedDeploymentResponse) })]
    public class UpdateOCIGenerativeaiHostedDeployment : OCIGenerativeAiCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"update hosted deployment.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateHostedDeploymentRequest
                {
                ...
                response = client.UpdateHostedDeployment(request).GetAwaiter().GetResult();
        ...
        private UpdateHostedDeploymentResponse response;
    }
}
