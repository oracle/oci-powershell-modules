...
{
    [Cmdlet("Invoke", "OCIBdsForceRefreshResourcePrincipal")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.BdsService.Responses.ForceRefreshResourcePrincipalResponse) })]
    public class InvokeOCIBdsForceRefreshResourcePrincipal : OCIBdsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details of refreshing resource principal session token")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ForceRefreshResourcePrincipalRequest
                {
                ...
                response = client.ForceRefreshResourcePrincipal(request).GetAwaiter().GetResult();
        ...
        private ForceRefreshResourcePrincipalResponse response;
    }
}
