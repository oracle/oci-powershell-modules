...
{
    [Cmdlet("Remove", "OCIDatascienceModelDeployment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatascienceService.Responses.DeleteModelDeploymentResponse) })]
    public class RemoveOCIDatascienceModelDeployment : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatascienceModelDeployment", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteModelDeploymentRequest
                {
                ...
                response = client.DeleteModelDeployment(request).GetAwaiter().GetResult();
        ...
        private DeleteModelDeploymentResponse response;
    }
}
