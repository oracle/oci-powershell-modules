...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementSummarizeAwrDbParameterChanges")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.AwrDbParameterChangeCollection), typeof(Oci.DatabasemanagementService.Responses.SummarizeAwrDbParameterChangesResponse) })]
    public class InvokeOCIDatabasemanagementSummarizeAwrDbParameterChanges : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.SummarizeAwrDbParameterChangesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeAwrDbParameterChangesRequest
                {
                ...
                response = client.SummarizeAwrDbParameterChanges(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AwrDbParameterChangeCollection);
        ...
        private SummarizeAwrDbParameterChangesResponse response;
    }
}
