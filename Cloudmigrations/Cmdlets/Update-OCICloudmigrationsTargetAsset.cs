...
{
    [Cmdlet("Update", "OCICloudmigrationsTargetAsset")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CloudmigrationsService.Responses.UpdateTargetAssetResponse) })]
    public class UpdateOCICloudmigrationsTargetAsset : OCIMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateTargetAssetRequest
                {
                ...
                response = client.UpdateTargetAsset(request).GetAwaiter().GetResult();
        ...
        private UpdateTargetAssetResponse response;
    }
}
