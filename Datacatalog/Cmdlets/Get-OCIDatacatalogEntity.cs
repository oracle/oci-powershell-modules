...
{
    [Cmdlet("Get", "OCIDatacatalogEntity", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Entity), typeof(Oci.DatacatalogService.Responses.GetEntityResponse) })]
    public class GetOCIDatacatalogEntity : OCIDataCatalogCmdlet
    {
        ...
        private GetEntityResponse response;
