...
{
    public abstract class OCIAIServiceSpeechCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AIServiceSpeechClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AIServiceSpeechClient client;
