...
{
    [Cmdlet("Get", "OCIWaaWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.WaaService.Models.WorkRequest), typeof(Oci.WaaService.Responses.GetWorkRequestResponse) })]
    public class GetOCIWaaWorkRequest : OCIWorkRequestCmdlet
    {
        ...
        public Oci.WaaService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
