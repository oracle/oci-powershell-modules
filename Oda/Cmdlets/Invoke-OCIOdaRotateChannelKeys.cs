...
{
    [Cmdlet("Invoke", "OCIOdaRotateChannelKeys")]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.CreateChannelResult), typeof(Oci.OdaService.Responses.RotateChannelKeysResponse) })]
    public class InvokeOCIOdaRotateChannelKeys : OCIManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RotateChannelKeysRequest
                {
                ...
                response = client.RotateChannelKeys(request).GetAwaiter().GetResult();
        ...
        private RotateChannelKeysResponse response;
    }
}
