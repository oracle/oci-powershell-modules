...
{
    [Cmdlet("Remove", "OCIFilestorageSnapshot", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.FilestorageService.Responses.DeleteSnapshotResponse) })]
    public class RemoveOCIFilestorageSnapshot : OCIFileStorageCmdlet
    {
        ...
        private DeleteSnapshotResponse response;
    }
}
