...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementSummarizeManagedMySqlDatabaseAvailabilityMetrics")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.MetricsAggregationRangeCollection), typeof(Oci.DatabasemanagementService.Responses.SummarizeManagedMySqlDatabaseAvailabilityMetricsResponse) })]
    public class InvokeOCIDatabasemanagementSummarizeManagedMySqlDatabaseAvailabilityMetrics : OCIManagedMySqlDatabasesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeManagedMySqlDatabaseAvailabilityMetricsRequest
                {
                ...
                response = client.SummarizeManagedMySqlDatabaseAvailabilityMetrics(request).GetAwaiter().GetResult();
        ...
        private SummarizeManagedMySqlDatabaseAvailabilityMetricsResponse response;
    }
}
