...
{
    public abstract class OCIMacOrderCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MacOrderClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MacOrderClient client;
