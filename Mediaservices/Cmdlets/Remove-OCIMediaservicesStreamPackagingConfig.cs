...
{
    [Cmdlet("Remove", "OCIMediaservicesStreamPackagingConfig", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.MediaservicesService.Responses.DeleteStreamPackagingConfigResponse) })]
    public class RemoveOCIMediaservicesStreamPackagingConfig : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIMediaservicesStreamPackagingConfig", "Remove"))
            {
               return;
            }
            ...
            try
            {
                ...
                response = client.DeleteStreamPackagingConfig(request).GetAwaiter().GetResult();
        ...
        private DeleteStreamPackagingConfigResponse response;
    }
}
