...
namespace Oci.GenerativeaidataService.Cmdlets
{
    ...
    public class StopOCIGenerativeaidataEnrichmentJob : OCICancelEnrichmentJobCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the enrichment job")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelEnrichmentJobRequest
                {
        ...
        private CancelEnrichmentJobResponse response;
    }
}
