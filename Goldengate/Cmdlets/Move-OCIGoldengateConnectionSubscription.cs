...
{
    [Cmdlet("Move", "OCIGoldengateConnectionSubscription")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.ChangeConnectionSubscriptionResponse) })]
    public class MoveOCIGoldengateConnectionSubscription : OCIGoldenGateCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Associate a GoldenGate connection with a different subscription.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeConnectionSubscriptionRequest
                {
                ...
                response = client.ChangeConnectionSubscription(request).GetAwaiter().GetResult();
        ...
        private ChangeConnectionSubscriptionResponse response;
    }
}
