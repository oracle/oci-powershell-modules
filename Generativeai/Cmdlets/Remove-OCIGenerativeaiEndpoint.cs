...
{
    [Cmdlet("Remove", "OCIGenerativeaiEndpoint", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GenerativeaiService.Responses.DeleteEndpointResponse) })]
    public class RemoveOCIGenerativeaiEndpoint : OCIGenerativeAiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIGenerativeaiEndpoint", "Remove"))
            {
               return;
            }
