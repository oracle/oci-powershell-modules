...
namespace Oci.DistributeddatabaseService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIDistributeddatabaseDownloadDistributedAutonomousDatabaseGsmCertificateSigningRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DistributeddatabaseService.Responses.DownloadDistributedAutonomousDatabaseGsmCertificateSigningRequestResponse) })]
    public class InvokeOCIDistributeddatabaseDownloadDistributedAutonomousDatabaseGsmCertificateSigningRequest : OCIDistributedAutonomousDbServiceCmdlet
    {
        ...
        {
            base.ProcessRecord();
            DownloadDistributedAutonomousDatabaseGsmCertificateSigningRequestRequest request;

            try
            {
                request = new DownloadDistributedAutonomousDatabaseGsmCertificateSigningRequestRequest
                {
                ...
                response = client.DownloadDistributedAutonomousDatabaseGsmCertificateSigningRequest(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private DownloadDistributedAutonomousDatabaseGsmCertificateSigningRequestResponse response;
