...
{
    [Cmdlet("Move", "OCIDataflowSqlEndpointCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DataflowService.Responses.ChangeSqlEndpointCompartmentResponse) })]
    public class MoveOCIDataflowSqlEndpointCompartment : OCIDataFlowCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details to change the compartment of the Sql Endpoint.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeSqlEndpointCompartmentRequest
                {
                ...
                response = client.ChangeSqlEndpointCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeSqlEndpointCompartmentResponse response;
    }
}
