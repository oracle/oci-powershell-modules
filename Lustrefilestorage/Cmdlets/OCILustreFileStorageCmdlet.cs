...
using Oci.LustrefilestorageService;

namespace Oci.LustrefilestorageService.Cmdlets
{
    public abstract class OCILustreFileStorageCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new LustreFileStorageClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected LustreFileStorageClient client;
