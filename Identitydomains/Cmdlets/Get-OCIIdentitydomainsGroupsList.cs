...
{
    [Cmdlet("Get", "OCIIdentitydomainsGroupsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Groups), typeof(Oci.IdentitydomainsService.Responses.ListGroupsResponse) })]
    public class GetOCIIdentitydomainsGroupsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ListGroups(request).GetAwaiter().GetResult();
