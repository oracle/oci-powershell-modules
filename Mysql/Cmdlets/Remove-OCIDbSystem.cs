...
{
    [Cmdlet("Remove", "OCIDbSystem", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCIDbSystem : OCIDbSystemCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDbSystem", "Remove"))
            {
               return;
            }
