...
{
    [Cmdlet("Get", "OCIDevopsRepositorySettings")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.RepositorySettings), typeof(Oci.DevopsService.Responses.GetRepositorySettingsResponse) })]
    public class GetOCIDevopsRepositorySettings : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetRepositorySettingsRequest
                {
                    RepositoryId = RepositoryId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetRepositorySettings(request).GetAwaiter().GetResult();
        ...
        private GetRepositorySettingsResponse response;
    }
}
