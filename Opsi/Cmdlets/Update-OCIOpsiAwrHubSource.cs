...
{
    [Cmdlet("Update", "OCIOpsiAwrHubSource")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.UpdateAwrHubSourceResponse) })]
    public class UpdateOCIOpsiAwrHubSource : OCIOperationsInsightsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateAwrHubSourceRequest
                {
                ...
                response = client.UpdateAwrHubSource(request).GetAwaiter().GetResult();
        ...
        private UpdateAwrHubSourceResponse response;
    }
}
