...
{
    [Cmdlet("Update", "OCIVirtualNetworkByoasn")]
    ...
    public class UpdateOCIVirtualNetworkByoasn : OCIVirtualNetworkCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateByoasnRequest
                {
                    ByoasnId = ByoasnId,
                ...
                response = client.UpdateByoasn(request).GetAwaiter().GetResult();
        ...
        private UpdateByoasnResponse response;
    }
}
