...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchUsers")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Users), typeof(Oci.IdentitydomainsService.Responses.SearchUsersResponse) })]
    public class InvokeOCIIdentitydomainsSearchUsers : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching Users")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.SearchUsers(request).GetAwaiter().GetResult();
                WriteOutput(response, response.Users);
        ...
        private SearchUsersResponse response;
    }
}
