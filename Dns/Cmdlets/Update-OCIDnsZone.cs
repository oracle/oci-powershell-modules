...
{
    [Cmdlet("Update", "OCIDnsZone", DefaultParameterSetName = Default)]
    ...
    public class UpdateOCIDnsZone : OCIDnsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"New data for the zone.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"New data for the zone.", ParameterSetName = Default)]
...
This parameter is deprecated and should be omitted.", ParameterSetName = Default)]
        ...
        private void HandleOutput(UpdateZoneRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateZone(request, waiterConfig, WaitForStatus).Execute();
                    break;
