...
{
    public abstract class OCIDiagnosabilityCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DiagnosabilityClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DiagnosabilityClient client;
