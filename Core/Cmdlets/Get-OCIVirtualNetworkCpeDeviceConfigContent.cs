...
namespace Oci.CoreService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIVirtualNetworkCpeDeviceConfigContent", DefaultParameterSetName = Default)]
    ...
    public class GetOCIVirtualNetworkCpeDeviceConfigContent : OCIVirtualNetworkCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetCpeDeviceConfigContentRequest
                {
                    CpeId = CpeId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetCpeDeviceConfigContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetCpeDeviceConfigContentResponse response;
