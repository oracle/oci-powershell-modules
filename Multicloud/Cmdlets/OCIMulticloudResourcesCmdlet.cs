...
{
    public abstract class OCIMulticloudResourcesCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new MulticloudResourcesClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected MulticloudResourcesClient client;
