...
{
    [Cmdlet("Get", "OCIStreamAdminStreamsList")]
    [OutputType(new System.Type[] { typeof(Oci.StreamingService.Models.StreamSummary), typeof(Oci.StreamingService.Responses.ListStreamsResponse) })]
    public class GetOCIStreamAdminStreamsList : OCIStreamAdminCmdlet
    {
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the compartment. Is exclusive with the `streamPoolId` parameter. One of them is required.")]
        public string CompartmentId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the stream pool. Is exclusive with the `compartmentId` parameter. One of them is required.")]
        ...
        public System.Nullable<Oci.StreamingService.Requests.ListStreamsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either 'asc' or 'desc'.")]
        public System.Nullable<Oci.StreamingService.Requests.ListStreamsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.StreamingService.Models.Stream.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        {
            IEnumerable<ListStreamsResponse> DefaultRequest(ListStreamsRequest request) => Enumerable.Repeat(client.ListStreams(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListStreamsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListStreamsResponse response;
        private delegate IEnumerable<ListStreamsResponse> RequestDelegate(ListStreamsRequest request);
