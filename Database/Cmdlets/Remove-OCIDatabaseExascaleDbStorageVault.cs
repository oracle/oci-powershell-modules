...
{
    [Cmdlet("Remove", "OCIDatabaseExascaleDbStorageVault", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteExascaleDbStorageVaultResponse) })]
    public class RemoveOCIDatabaseExascaleDbStorageVault : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseExascaleDbStorageVault", "Remove"))
            {
               return;
            }
        ...
        private void HandleOutput(DeleteExascaleDbStorageVaultRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteExascaleDbStorageVault(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteExascaleDbStorageVault(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteExascaleDbStorageVaultResponse response;
