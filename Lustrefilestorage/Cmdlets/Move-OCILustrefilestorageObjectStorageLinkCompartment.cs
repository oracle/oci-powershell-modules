...
{
    [Cmdlet("Move", "OCILustrefilestorageObjectStorageLinkCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.LustrefilestorageService.Models.ObjectStorageLink), typeof(Oci.LustrefilestorageService.Responses.ChangeObjectStorageLinkCompartmentResponse) })]
    public class MoveOCILustrefilestorageObjectStorageLinkCompartment : OCILustreFileStorageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeObjectStorageLinkCompartmentRequest
                {
                ...
                response = client.ChangeObjectStorageLinkCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeObjectStorageLinkCompartmentResponse response;
    }
}
