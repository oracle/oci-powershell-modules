...
{
    [Cmdlet("Get", "OCITenantmanagercontrolplaneSubscription", DefaultParameterSetName = Default)]
    ...
    public class GetOCITenantmanagercontrolplaneSubscription : OCISubscriptionCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"OCID of the subscription.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"OCID of the subscription.", ParameterSetName = Default)]
