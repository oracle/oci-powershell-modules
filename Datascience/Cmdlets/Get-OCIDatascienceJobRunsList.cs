...
{
    [Cmdlet("Get", "OCIDatascienceJobRunsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.JobRunSummary), typeof(Oci.DatascienceService.Responses.ListJobRunsResponse) })]
    public class GetOCIDatascienceJobRunsList : OCIDataScienceCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the job.")]
...
See [List Pagination](https://docs.oracle.com/iaas/Content/General/Concepts/usingapi.htm#nine).")]
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListJobRunsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListJobRunsRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.DatascienceService.Models.JobRunLifecycleState> LifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListJobRunsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListJobRunsResponse> DefaultRequest(ListJobRunsRequest request) => Enumerable.Repeat(client.ListJobRuns(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListJobRunsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListJobRunsResponse response;
        private delegate IEnumerable<ListJobRunsResponse> RequestDelegate(ListJobRunsRequest request);
