...
{
    [Cmdlet("Remove", "OCIComputeHostGroup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    ...
    public class RemoveOCIComputeHostGroup : OCIComputeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIComputeHostGroup", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteComputeHostGroupRequest
                {
                ...
                response = client.DeleteComputeHostGroup(request).GetAwaiter().GetResult();
        ...
        private DeleteComputeHostGroupResponse response;
    }
}
