...
{
    [Cmdlet("New", "OCILoadbalancerHostname")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.LoadbalancerService.Responses.CreateHostnameResponse) })]
    public class NewOCILoadbalancerHostname : OCILoadBalancerCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details of the hostname resource to add to the specified load balancer.")]
        public CreateHostnameDetails CreateHostnameDetails { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the load balancer to add the hostname to.")]
...
Example: `example-etag`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateHostnameRequest
                {
                ...
                response = client.CreateHostname(request).GetAwaiter().GetResult();
        ...
        private CreateHostnameResponse response;
    }
}
