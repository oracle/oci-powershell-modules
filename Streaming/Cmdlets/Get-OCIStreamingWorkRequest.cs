...
{
    [Cmdlet("Get", "OCIStreamingWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.StreamingService.Models.WorkRequest), typeof(Oci.StreamingService.Responses.GetWorkRequestResponse) })]
    public class GetOCIStreamingWorkRequest : OCIStreamAdminCmdlet
    {
        ...
        public Oci.StreamingService.Models.OperationStatus[] WaitForStatus { get; set; }
