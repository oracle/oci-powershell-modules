...
{
    [Cmdlet("Get", "OCIOpsiAwrDatabasesList")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.AwrDatabaseCollection), typeof(Oci.OpsiService.Responses.ListAwrDatabasesResponse) })]
    public class GetOCIOpsiAwrDatabasesList : OCIOperationsInsightsCmdlet
    {
        ...
        public System.Nullable<Oci.OpsiService.Requests.ListAwrDatabasesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListAwrDatabasesRequest
                {
                    AwrHubId = AwrHubId,
                    Name = Name,
                ...
                response = client.ListAwrDatabases(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AwrDatabaseCollection);
        ...
        private ListAwrDatabasesResponse response;
    }
}
