...
namespace Oci.DatalabelingservicedataplaneService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIDatalabelingservicedataplaneRecordContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatalabelingservicedataplaneService.Responses.GetRecordContentResponse) })]
    public class GetOCIDatalabelingservicedataplaneRecordContent : OCIDataLabelingCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetRecordContentRequest
                {
                    RecordId = RecordId,
                ...
                response = client.GetRecordContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetRecordContentResponse response;
