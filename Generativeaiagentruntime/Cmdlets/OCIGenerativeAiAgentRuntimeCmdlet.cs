...
{
    public abstract class OCIGenerativeAiAgentRuntimeCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new GenerativeAiAgentRuntimeClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected GenerativeAiAgentRuntimeClient client;
