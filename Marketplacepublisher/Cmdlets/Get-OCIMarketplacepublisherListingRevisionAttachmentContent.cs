...
namespace Oci.MarketplacepublisherService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIMarketplacepublisherListingRevisionAttachmentContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.MarketplacepublisherService.Responses.GetListingRevisionAttachmentContentResponse) })]
    public class GetOCIMarketplacepublisherListingRevisionAttachmentContent : OCIMarketplacePublisherCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetListingRevisionAttachmentContentRequest
                {
                    ListingRevisionAttachmentId = ListingRevisionAttachmentId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetListingRevisionAttachmentContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetListingRevisionAttachmentContentResponse response;
