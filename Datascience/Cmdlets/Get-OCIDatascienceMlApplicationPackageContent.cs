...
namespace Oci.DatascienceService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIDatascienceMlApplicationPackageContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DatascienceService.Responses.GetMlApplicationPackageContentResponse) })]
    public class GetOCIDatascienceMlApplicationPackageContent : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMlApplicationPackageContentRequest
                {
                    MlApplicationImplementationId = MlApplicationImplementationId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetMlApplicationPackageContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetMlApplicationPackageContentResponse response;
