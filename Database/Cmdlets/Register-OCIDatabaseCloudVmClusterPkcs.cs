...
{
    [Cmdlet("Register", "OCIDatabaseCloudVmClusterPkcs", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.RegisterCloudVmClusterPkcsResponse) })]
    public class RegisterOCIDatabaseCloudVmClusterPkcs : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RegisterCloudVmClusterPkcsRequest
                {
        ...
        private void HandleOutput(RegisterCloudVmClusterPkcsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRegisterCloudVmClusterPkcs(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RegisterCloudVmClusterPkcs(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private RegisterCloudVmClusterPkcsResponse response;
