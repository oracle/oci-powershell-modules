...
{
    public abstract class OCINetworkFirewallCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new NetworkFirewallClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected NetworkFirewallClient client;
