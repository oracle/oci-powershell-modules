...
{
    [Cmdlet("Get", "OCIIdentitydomainsUserDbCredentialsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.UserDbCredentials), typeof(Oci.IdentitydomainsService.Responses.ListUserDbCredentialsResponse) })]
    public class GetOCIIdentitydomainsUserDbCredentialsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListUserDbCredentialsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListUserDbCredentials(request).GetAwaiter().GetResult();
        ...
        private ListUserDbCredentialsResponse response;
    }
}
