...
{
    [Cmdlet("Update", "OCIDevopsBuildPipeline")]
    ...
    public class UpdateOCIDevopsBuildPipeline : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateBuildPipelineRequest
                {
                ...
                response = client.UpdateBuildPipeline(request).GetAwaiter().GetResult();
        ...
        private UpdateBuildPipelineResponse response;
    }
}
