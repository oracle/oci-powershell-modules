...
{
    [Cmdlet("Update", "OCIMngdmacMacOrder")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MngdmacService.Responses.UpdateMacOrderResponse) })]
    public class UpdateOCIMngdmacMacOrder : OCIMacOrderCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateMacOrderRequest
                {
                ...
                response = client.UpdateMacOrder(request).GetAwaiter().GetResult();
        ...
        private UpdateMacOrderResponse response;
    }
}
