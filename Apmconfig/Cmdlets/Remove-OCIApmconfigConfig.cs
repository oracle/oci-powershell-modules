...
{
    [Cmdlet("Remove", "OCIApmconfigConfig", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ApmconfigService.Responses.DeleteConfigResponse) })]
    public class RemoveOCIApmconfigConfig : OCIConfigCmdlet
    {
