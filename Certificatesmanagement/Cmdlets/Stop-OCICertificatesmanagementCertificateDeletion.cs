...
{
    [Cmdlet("Stop", "OCICertificatesmanagementCertificateDeletion")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CertificatesmanagementService.Responses.CancelCertificateDeletionResponse) })]
    public class StopOCICertificatesmanagementCertificateDeletion : OCICertificatesManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CancelCertificateDeletionRequest
                {
                ...
                response = client.CancelCertificateDeletion(request).GetAwaiter().GetResult();
        ...
        private CancelCertificateDeletionResponse response;
    }
}
