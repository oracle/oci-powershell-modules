...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchMappedAttributes")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MappedAttributes), typeof(Oci.IdentitydomainsService.Responses.SearchMappedAttributesResponse) })]
    public class InvokeOCIIdentitydomainsSearchMappedAttributes : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching MappedAttributes")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchMappedAttributesRequest
                {
                ...
                response = client.SearchMappedAttributes(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MappedAttributes);
        ...
        private SearchMappedAttributesResponse response;
    }
}
