...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementSummarizeAwrDbMetrics")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.AwrDbMetricCollection), typeof(Oci.DatabasemanagementService.Responses.SummarizeAwrDbMetricsResponse) })]
    public class InvokeOCIDatabasemanagementSummarizeAwrDbMetrics : OCIDbManagementCmdlet
    {
        ...
        public System.Nullable<Oci.DatabasemanagementService.Requests.SummarizeAwrDbMetricsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeAwrDbMetricsRequest
                {
                ...
                response = client.SummarizeAwrDbMetrics(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AwrDbMetricCollection);
        ...
        private SummarizeAwrDbMetricsResponse response;
    }
}
