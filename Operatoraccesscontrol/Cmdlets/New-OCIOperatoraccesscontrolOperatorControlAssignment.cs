...
namespace Oci.OperatoraccesscontrolService.Cmdlets
{
    ...
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OperatoraccesscontrolService.Responses.CreateOperatorControlAssignmentResponse) })]
