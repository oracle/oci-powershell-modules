...
{
    [Cmdlet("Remove", "OCIComputecloudatcustomerCccInfrastructure", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ComputecloudatcustomerService.Responses.DeleteCccInfrastructureResponse) })]
    public class RemoveOCIComputecloudatcustomerCccInfrastructure : OCIComputeCloudAtCustomerCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIComputecloudatcustomerCccInfrastructure", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteCccInfrastructureRequest
                {
                ...
                response = client.DeleteCccInfrastructure(request).GetAwaiter().GetResult();
        ...
        private DeleteCccInfrastructureResponse response;
    }
}
