...
{
    [Cmdlet("Remove", "OCIDevopsPullRequestAttachment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DevopsService.Responses.DeletePullRequestAttachmentResponse) })]
    public class RemoveOCIDevopsPullRequestAttachment : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDevopsPullRequestAttachment", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeletePullRequestAttachmentRequest
                {
                ...
                response = client.DeletePullRequestAttachment(request).GetAwaiter().GetResult();
        ...
        private DeletePullRequestAttachmentResponse response;
    }
}
