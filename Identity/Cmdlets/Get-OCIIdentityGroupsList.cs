...
{
    [Cmdlet("Get", "OCIIdentityGroupsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentityService.Models.Group), typeof(Oci.IdentityService.Responses.ListGroupsResponse) })]
    public class GetOCIIdentityGroupsList : OCIIdentityCmdlet
    {
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by Availability Domain if the scope of the resource type is within a single Availability Domain. If you call one of these ""List"" operations without specifying an Availability Domain, the resources are grouped by Availability Domain, then sorted.")]
        public System.Nullable<Oci.IdentityService.Requests.ListGroupsRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.IdentityService.Requests.ListGroupsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.IdentityService.Models.Group.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                IEnumerable<ListGroupsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListGroupsResponse> DefaultRequest(ListGroupsRequest request) => Enumerable.Repeat(client.ListGroups(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListGroupsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListGroupsResponse response;
        private delegate IEnumerable<ListGroupsResponse> RequestDelegate(ListGroupsRequest request);
