...
{
    [Cmdlet("Start", "OCILustrefilestorageExportToObject")]
    [OutputType(new System.Type[] { typeof(Oci.LustrefilestorageService.Models.SyncJob), typeof(Oci.LustrefilestorageService.Responses.StartExportToObjectResponse) })]
    public class StartOCILustrefilestorageExportToObject : OCILustreFileStorageCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartExportToObjectRequest
                {
                ...
                response = client.StartExportToObject(request).GetAwaiter().GetResult();
        ...
        private StartExportToObjectResponse response;
    }
}
