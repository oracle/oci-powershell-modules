...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyCustomerSecretKeysList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyCustomerSecretKeys), typeof(Oci.IdentitydomainsService.Responses.ListMyCustomerSecretKeysResponse) })]
    public class GetOCIIdentitydomainsMyCustomerSecretKeysList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMyCustomerSecretKeysRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListMyCustomerSecretKeys(request).GetAwaiter().GetResult();
                WriteOutput(response, response.MyCustomerSecretKeys);
        ...
        private ListMyCustomerSecretKeysResponse response;
    }
}
