...
{
    [Cmdlet("Remove", "OCIIotDigitalTwinRelationship", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IotService.Responses.DeleteDigitalTwinRelationshipResponse) })]
    public class RemoveOCIIotDigitalTwinRelationship : OCIIotCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIotDigitalTwinRelationship", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDigitalTwinRelationshipRequest
                {
                ...
                response = client.DeleteDigitalTwinRelationship(request).GetAwaiter().GetResult();
        ...
        private DeleteDigitalTwinRelationshipResponse response;
    }
}
