...
{
    public abstract class OCIEkmCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new EkmClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
