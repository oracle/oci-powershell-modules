...
{
    [Cmdlet("Export", "OCIMysqlBackup")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.ExportBackupResponse) })]
    public class ExportOCIMysqlBackup : OCIDbBackupsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the Backup")]
        public string BackupId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details required to export a given DB system backup to an Object Storage bucket.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ExportBackup(request).GetAwaiter().GetResult();
        ...
        private ExportBackupResponse response;
    }
}
