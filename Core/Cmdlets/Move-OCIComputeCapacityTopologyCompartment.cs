...
{
    [Cmdlet("Move", "OCIComputeCapacityTopologyCompartment", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.ChangeComputeCapacityTopologyCompartmentResponse) })]
    public class MoveOCIComputeCapacityTopologyCompartment : OCIComputeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeComputeCapacityTopologyCompartmentRequest
                {
        ...
        private void HandleOutput(ChangeComputeCapacityTopologyCompartmentRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForChangeComputeCapacityTopologyCompartment(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ChangeComputeCapacityTopologyCompartment(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private ChangeComputeCapacityTopologyCompartmentResponse response;
