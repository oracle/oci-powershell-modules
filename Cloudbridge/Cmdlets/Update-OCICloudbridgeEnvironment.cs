...
{
    [Cmdlet("Update", "OCICloudbridgeEnvironment")]
    [OutputType(new System.Type[] { typeof(Oci.CloudbridgeService.Models.Environment), typeof(Oci.CloudbridgeService.Responses.UpdateEnvironmentResponse) })]
    public class UpdateOCICloudbridgeEnvironment : OCIOcbAgentSvcCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpdateEnvironment(request).GetAwaiter().GetResult();
        ...
        private UpdateEnvironmentResponse response;
    }
}
