...
{
    [Cmdlet("Get", "OCIDatacatalogPatternsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.PatternCollection), typeof(Oci.DatacatalogService.Responses.ListPatternsResponse) })]
    public class GetOCIDatacatalogPatternsList : OCIDataCatalogCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Specifies the fields to return in a pattern summary response.")]
        public System.Collections.Generic.List<Oci.DatacatalogService.Requests.ListPatternsRequest.FieldsEnum> Fields { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field to sort by. Only one sort order may be provided. Default order for TIMECREATED is descending. Default order for DISPLAYNAME is ascending. If no value is specified TIMECREATED is default.")]
        public System.Nullable<Oci.DatacatalogService.Requests.ListPatternsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either 'asc' or 'desc'.")]
        public System.Nullable<Oci.DatacatalogService.Requests.ListPatternsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListPatternsRequest
                {
                    CatalogId = CatalogId,
                ...
                IEnumerable<ListPatternsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.PatternCollection, true);
                }
        ...
        {
            IEnumerable<ListPatternsResponse> DefaultRequest(ListPatternsRequest request) => Enumerable.Repeat(client.ListPatterns(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListPatternsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListPatternsResponse response;
        private delegate IEnumerable<ListPatternsResponse> RequestDelegate(ListPatternsRequest request);
