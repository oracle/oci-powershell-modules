...
{
    [Cmdlet("Get", "OCIIdentitydomainsIdentityProofingProvidersList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.IdentityProofingProviders), typeof(Oci.IdentitydomainsService.Responses.ListIdentityProofingProvidersResponse) })]
    public class GetOCIIdentitydomainsIdentityProofingProvidersList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListIdentityProofingProvidersRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListIdentityProofingProviders(request).GetAwaiter().GetResult();
        ...
        private ListIdentityProofingProvidersResponse response;
    }
}
