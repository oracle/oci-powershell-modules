...
{
    [Cmdlet("Get", "OCIIdentitydomainsRulesList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Rules), typeof(Oci.IdentitydomainsService.Responses.ListRulesResponse) })]
    public class GetOCIIdentitydomainsRulesList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ListRules(request).GetAwaiter().GetResult();
