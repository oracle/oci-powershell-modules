...
{
    [Cmdlet("New", "OCIDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.Database), typeof(Oci.DatabaseService.Responses.CreateDatabaseResponse) })]
    public class NewOCIDatabase : OCIDatabaseCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to create a new database. This parameter also accepts subtypes <Oci.DatabaseService.Models.CreateNewDatabaseDetails>, <Oci.DatabaseService.Models.CreateStandByDatabaseDetails>, <Oci.DatabaseService.Models.CreateDatabaseFromDatabase>, <Oci.DatabaseService.Models.CreateDatabaseFromBackup> of type <Oci.DatabaseService.Models.CreateDatabaseBase>.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to create a new database. This parameter also accepts subtypes <Oci.DatabaseService.Models.CreateNewDatabaseDetails>, <Oci.DatabaseService.Models.CreateStandByDatabaseDetails>, <Oci.DatabaseService.Models.CreateDatabaseFromDatabase>, <Oci.DatabaseService.Models.CreateDatabaseFromBackup> of type <Oci.DatabaseService.Models.CreateDatabaseBase>.", ParameterSetName = Default)]
        ...
        private void HandleOutput(CreateDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForCreateDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.CreateDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.Database);
        }

        private CreateDatabaseResponse response;
