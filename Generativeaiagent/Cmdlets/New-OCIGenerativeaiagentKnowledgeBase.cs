...
{
    [Cmdlet("New", "OCIGenerativeaiagentKnowledgeBase")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiagentService.Models.KnowledgeBase), typeof(Oci.GenerativeaiagentService.Responses.CreateKnowledgeBaseResponse) })]
    public class NewOCIGenerativeaiagentKnowledgeBase : OCIGenerativeAiAgentCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new knowledge base.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CreateKnowledgeBase(request).GetAwaiter().GetResult();
        ...
        private CreateKnowledgeBaseResponse response;
    }
}
