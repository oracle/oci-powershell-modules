...
namespace Oci.GoldengateService.Cmdlets
{
    ...
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.RollbackDeploymentUpgradeResponse) })]
    public class InvokeOCIGoldengateRollbackDeploymentUpgrade : OCIGoldenGateCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A placeholder for any additional metadata to describe the deployment rollback. This parameter also accepts subtype <Oci.GoldengateService.Models.DefaultRollbackDeploymentUpgradeDetails> of type <Oci.GoldengateService.Models.RollbackDeploymentUpgradeDetails>.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RollbackDeploymentUpgradeRequest
                {
        ...
        private RollbackDeploymentUpgradeResponse response;
    }
}
