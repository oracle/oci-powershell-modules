...
{
    [Cmdlet("Get", "OCIVirtualNetworkByoipRangesList")]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.ByoipRangeCollection), typeof(Oci.CoreService.Responses.ListByoipRangesResponse) })]
    public class GetOCIVirtualNetworkByoipRangesList : OCIVirtualNetworkCmdlet
    {
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by availability domain if the scope of the resource type is within a single availability domain. If you call one of these ""List"" operations without specifying an availability domain, the resources are grouped by availability domain, then sorted.")]
        public System.Nullable<Oci.CoreService.Requests.ListByoipRangesRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Requests.ListByoipRangesRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListByoipRangesRequest
                {
                ...
                IEnumerable<ListByoipRangesResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.ByoipRangeCollection, true);
                }
        ...
        {
            IEnumerable<ListByoipRangesResponse> DefaultRequest(ListByoipRangesRequest request) => Enumerable.Repeat(client.ListByoipRanges(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListByoipRangesResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListByoipRangesResponse response;
        private delegate IEnumerable<ListByoipRangesResponse> RequestDelegate(ListByoipRangesRequest request);
