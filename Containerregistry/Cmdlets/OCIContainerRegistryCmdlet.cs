...
using Oci.ContainerregistryService;

namespace Oci.ContainerregistryService.Cmdlets
{
    public abstract class OCIContainerRegistryCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ContainerRegistryClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
