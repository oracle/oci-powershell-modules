...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchApiKeys")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.ApiKeys), typeof(Oci.IdentitydomainsService.Responses.SearchApiKeysResponse) })]
    public class InvokeOCIIdentitydomainsSearchApiKeys : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching ApiKeys")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchApiKeysRequest
                {
                ...
                response = client.SearchApiKeys(request).GetAwaiter().GetResult();
                WriteOutput(response, response.ApiKeys);
        ...
        private SearchApiKeysResponse response;
    }
}
