...
using Oci.DemandsignalService;

namespace Oci.DemandsignalService.Cmdlets
{
    public abstract class OCIOccDemandSignalCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OccDemandSignalClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OccDemandSignalClient client;
