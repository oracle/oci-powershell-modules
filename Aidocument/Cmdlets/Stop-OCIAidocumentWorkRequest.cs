...
{
    [Cmdlet("Stop", "OCIAidocumentWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AidocumentService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIAidocumentWorkRequest : OCIAIServiceDocumentCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAidocumentWorkRequest", "Stop"))
            {
               return;
            }
