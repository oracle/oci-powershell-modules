...
{
    [Cmdlet("Get", "OCIVisualbuilderWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.VisualbuilderService.Models.WorkRequest), typeof(Oci.VisualbuilderService.Responses.GetWorkRequestResponse) })]
    public class GetOCIVisualbuilderWorkRequest : OCIVbInstanceCmdlet
    {
        ...
        public Oci.VisualbuilderService.Models.WorkRequest.StatusEnum[] WaitForStatus { get; set; }
