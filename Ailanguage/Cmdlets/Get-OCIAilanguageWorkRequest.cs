...
{
    [Cmdlet("Get", "OCIAilanguageWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.AilanguageService.Models.WorkRequest), typeof(Oci.AilanguageService.Responses.GetWorkRequestResponse) })]
    public class GetOCIAilanguageWorkRequest : OCIAIServiceLanguageCmdlet
    {
        ...
        public Oci.AilanguageService.Models.OperationStatus[] WaitForStatus { get; set; }
