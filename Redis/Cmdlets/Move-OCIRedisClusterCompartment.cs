...
{
    [Cmdlet("Move", "OCIRedisClusterCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.RedisService.Responses.ChangeRedisClusterCompartmentResponse) })]
    public class MoveOCIRedisClusterCompartment : OCIRedisClusterCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeRedisClusterCompartmentRequest
                {
                ...
                response = client.ChangeRedisClusterCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeRedisClusterCompartmentResponse response;
    }
}
