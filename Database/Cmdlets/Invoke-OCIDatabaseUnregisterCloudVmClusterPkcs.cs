...
{
    [Cmdlet("Invoke", "OCIDatabaseUnregisterCloudVmClusterPkcs", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.UnregisterCloudVmClusterPkcsResponse) })]
    public class InvokeOCIDatabaseUnregisterCloudVmClusterPkcs : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UnregisterCloudVmClusterPkcsRequest
                {
        ...
        private void HandleOutput(UnregisterCloudVmClusterPkcsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUnregisterCloudVmClusterPkcs(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UnregisterCloudVmClusterPkcs(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private UnregisterCloudVmClusterPkcsResponse response;
