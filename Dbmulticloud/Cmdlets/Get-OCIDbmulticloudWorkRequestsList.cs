...
{
    [Cmdlet("Get", "OCIDbmulticloudWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.DbmulticloudService.Models.WorkRequestSummaryCollection), typeof(Oci.DbmulticloudService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIDbmulticloudWorkRequestsList : OCIWorkRequestCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only work requests with the given OperationStatus.")]
        public System.Nullable<Oci.DbmulticloudService.Models.OperationStatus> Status { get; set; }
        ...
        public System.Nullable<Oci.DbmulticloudService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }
