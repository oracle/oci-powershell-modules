...
{
    [Cmdlet("Add", "OCIDatacatalogCatalogLock")]
    [OutputType(new System.Type[] { typeof(Oci.DatacatalogService.Models.Catalog), typeof(Oci.DatacatalogService.Responses.AddCatalogLockResponse) })]
    public class AddOCIDatacatalogCatalogLock : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddCatalogLockRequest
                {
                    CatalogId = CatalogId,
                ...
                response = client.AddCatalogLock(request).GetAwaiter().GetResult();
        ...
        private AddCatalogLockResponse response;
    }
}
