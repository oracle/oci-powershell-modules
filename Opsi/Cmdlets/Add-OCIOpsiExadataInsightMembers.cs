...
namespace Oci.OpsiService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the members (e.g. databases and hosts) of an Exadata system to be added in Operations Insights. This parameter also accepts subtypes <Oci.OpsiService.Models.AddPeComanagedExadataInsightMembersDetails>, <Oci.OpsiService.Models.AddEmManagedExternalExadataInsightMembersDetails>, <Oci.OpsiService.Models.AddMacsManagedCloudExadataInsightMembersDetails> of type <Oci.OpsiService.Models.AddExadataInsightMembersDetails>.")]
