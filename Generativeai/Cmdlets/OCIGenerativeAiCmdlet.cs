...
using Oci.GenerativeaiService;

namespace Oci.GenerativeaiService.Cmdlets
{
    public abstract class OCIGenerativeAiCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new GenerativeAiClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected GenerativeAiClient client;
