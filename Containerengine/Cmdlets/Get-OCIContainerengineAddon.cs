...
{
    [Cmdlet("Get", "OCIContainerengineAddon", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.ContainerengineService.Models.Addon), typeof(Oci.ContainerengineService.Responses.GetAddonResponse) })]
    public class GetOCIContainerengineAddon : OCIContainerEngineCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The name of the addon.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The name of the addon.", ParameterSetName = Default)]
        ...
        public Oci.ContainerengineService.Models.AddonLifecycleState[] WaitForLifecycleState { get; set; }
        ...
        private void HandleOutput(GetAddonRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForAddon(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetAddon(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.Addon);
        }

        private GetAddonResponse response;
