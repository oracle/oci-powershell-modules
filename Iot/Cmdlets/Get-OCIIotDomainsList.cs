...
{
    [Cmdlet("Get", "OCIIotDomainsList")]
    [OutputType(new System.Type[] { typeof(Oci.IotService.Models.IotDomainCollection), typeof(Oci.IotService.Responses.ListIotDomainsResponse) })]
    public class GetOCIIotDomainsList : OCIIotCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Filter resources that match the specified [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IoT domain group.")]
        ...
        public System.Nullable<Oci.IotService.Models.IotDomain.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.IotService.Requests.ListIotDomainsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.IotService.Requests.ListIotDomainsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListIotDomainsRequest
                {
                ...
                IEnumerable<ListIotDomainsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.IotDomainCollection, true);
                }
        ...
        {
            IEnumerable<ListIotDomainsResponse> DefaultRequest(ListIotDomainsRequest request) => Enumerable.Repeat(client.ListIotDomains(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListIotDomainsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListIotDomainsResponse response;
        private delegate IEnumerable<ListIotDomainsResponse> RequestDelegate(ListIotDomainsRequest request);
