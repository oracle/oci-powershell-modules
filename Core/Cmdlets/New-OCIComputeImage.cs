...
{
    [Cmdlet("New", "OCIComputeImage", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.Image), typeof(Oci.CoreService.Responses.CreateImageResponse) })]
    public class NewOCIComputeImage : OCIComputeCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Image creation details", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Image creation details", ParameterSetName = Default)]
        ...
        private CreateImageResponse response;
