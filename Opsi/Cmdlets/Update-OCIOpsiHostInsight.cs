...
namespace Oci.OpsiService.Cmdlets
{
    ...
    public class UpdateOCIOpsiHostInsight : OCIOperationsInsightsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The configuration to be updated. This parameter also accepts subtype <Oci.OpsiService.Models.UpdateMacsManagedExternalHostInsightDetails> of type <Oci.OpsiService.Models.UpdateHostInsightDetails>.")]
