...
namespace Oci.FusionappsService.Cmdlets
{
    ...
    public class GetOCIFusionappsWorkRequestErrorsList : OCIFusionApplicationsCmdlet
    {
        ...
        public System.Nullable<Oci.FusionappsService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either 'asc' or 'desc'.")]
        public System.Nullable<Oci.FusionappsService.Requests.ListWorkRequestErrorsRequest.SortOrderEnum> SortOrder { get; set; }
