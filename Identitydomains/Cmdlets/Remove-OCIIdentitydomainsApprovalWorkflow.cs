...
{
    [Cmdlet("Remove", "OCIIdentitydomainsApprovalWorkflow", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteApprovalWorkflowResponse) })]
    public class RemoveOCIIdentitydomainsApprovalWorkflow : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsApprovalWorkflow", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteApprovalWorkflowRequest
                {
                ...
                response = client.DeleteApprovalWorkflow(request).GetAwaiter().GetResult();
        ...
        private DeleteApprovalWorkflowResponse response;
    }
}
