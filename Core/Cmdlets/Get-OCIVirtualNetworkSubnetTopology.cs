...
{
    [Cmdlet("Get", "OCIVirtualNetworkSubnetTopology")]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.SubnetTopology), typeof(Oci.CoreService.Responses.GetSubnetTopologyResponse) })]
    public class GetOCIVirtualNetworkSubnetTopology : OCIVirtualNetworkCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet.")]
...
When set to `ANY` permissions are not checked.")]
        public System.Nullable<Oci.CoreService.Requests.GetSubnetTopologyRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetSubnetTopologyRequest
                {
                ...
                response = client.GetSubnetTopology(request).GetAwaiter().GetResult();
                WriteOutput(response, response.SubnetTopology);
        ...
        private GetSubnetTopologyResponse response;
    }
}
