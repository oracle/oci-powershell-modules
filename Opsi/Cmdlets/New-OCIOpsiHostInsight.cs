...
namespace Oci.OpsiService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the host for which a Host Insight resource will be created in Ops Insights. This parameter also accepts subtypes <Oci.OpsiService.Models.CreateMacsManagedCloudHostInsightDetails>, <Oci.OpsiService.Models.CreateMacsManagedExternalHostInsightDetails>, <Oci.OpsiService.Models.CreateEmManagedExternalHostInsightDetails> of type <Oci.OpsiService.Models.CreateHostInsightDetails>.")]
