...
{
    [Cmdlet("Get", "OCIIdentitydomainsAuthenticationFactorSetting")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.AuthenticationFactorSetting), typeof(Oci.IdentitydomainsService.Responses.GetAuthenticationFactorSettingResponse) })]
    public class GetOCIIdentitydomainsAuthenticationFactorSetting : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetAuthenticationFactorSettingRequest
                {
                ...
                response = client.GetAuthenticationFactorSetting(request).GetAwaiter().GetResult();
        ...
        private GetAuthenticationFactorSettingResponse response;
    }
}
