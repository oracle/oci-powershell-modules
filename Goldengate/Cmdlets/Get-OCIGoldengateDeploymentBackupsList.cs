...
{
    [Cmdlet("Get", "OCIGoldengateDeploymentBackupsList")]
    [OutputType(new System.Type[] { typeof(Oci.GoldengateService.Models.DeploymentBackupCollection), typeof(Oci.GoldengateService.Responses.ListDeploymentBackupsResponse) })]
    public class GetOCIGoldengateDeploymentBackupsList : OCIGoldenGateCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only the deployment backups having the 'lifecycleState' given.")]
        public System.Nullable<Oci.GoldengateService.Models.DeploymentBackup.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        public System.Nullable<Oci.GoldengateService.Requests.ListDeploymentBackupsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListDeploymentBackupsRequest
                {
                ...
                IEnumerable<ListDeploymentBackupsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.DeploymentBackupCollection, true);
                }
        ...
        {
            IEnumerable<ListDeploymentBackupsResponse> DefaultRequest(ListDeploymentBackupsRequest request) => Enumerable.Repeat(client.ListDeploymentBackups(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListDeploymentBackupsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListDeploymentBackupsResponse response;
        private delegate IEnumerable<ListDeploymentBackupsResponse> RequestDelegate(ListDeploymentBackupsRequest request);
