...
{
    [Cmdlet("Remove", "OCIDatabaseAutonomousDatabaseBackup", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteAutonomousDatabaseBackupResponse) })]
    public class RemoveOCIDatabaseAutonomousDatabaseBackup : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseAutonomousDatabaseBackup", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteAutonomousDatabaseBackupRequest
                {
        ...
        private void HandleOutput(DeleteAutonomousDatabaseBackupRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteAutonomousDatabaseBackup(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteAutonomousDatabaseBackup(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteAutonomousDatabaseBackupResponse response;
