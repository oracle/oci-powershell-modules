...
namespace Oci.EmwarehouseService.Cmdlets
{
    ...
    public class GetOCIEmwarehouse : OCIEmWarehouseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"unique EmWarehouse identifier", ParameterSetName = Default)]
        ...
        public Oci.EmwarehouseService.Models.EmWarehouse.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetEmWarehouseRequest
                {
        ...
        private void HandleOutput(GetEmWarehouseRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForEmWarehouse(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetEmWarehouse(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.EmWarehouse);
        }

        private GetEmWarehouseResponse response;
