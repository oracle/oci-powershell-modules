...
{
    [Cmdlet("Move", "OCICloudbridgeEnvironmentCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CloudbridgeService.Responses.ChangeEnvironmentCompartmentResponse) })]
    public class MoveOCICloudbridgeEnvironmentCompartment : OCIOcbAgentSvcCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeEnvironmentCompartmentRequest
                {
                ...
                response = client.ChangeEnvironmentCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeEnvironmentCompartmentResponse response;
    }
}
