...
{
    public abstract class OCIApiMetadataCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ApiMetadataClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ApiMetadataClient client;
