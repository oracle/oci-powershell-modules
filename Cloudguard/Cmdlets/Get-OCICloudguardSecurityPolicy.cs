...
{
    [Cmdlet("Get", "OCICloudguardSecurityPolicy", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.CloudguardService.Models.SecurityPolicy), typeof(Oci.CloudguardService.Responses.GetSecurityPolicyResponse) })]
