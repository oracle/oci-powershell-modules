...
{
    [Cmdlet("Start", "OCIMysqlDbSystem")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.StartDbSystemResponse) })]
    public class StartOCIMysqlDbSystem : OCIDbSystemCmdlet
    {
