...
{
    [Cmdlet("New", "OCIGoldengateDisasterRecoveryPrecheckReport")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GoldengateService.Responses.GenerateDisasterRecoveryPrecheckReportResponse) })]
    public class NewOCIGoldengateDisasterRecoveryPrecheckReport : OCIGoldenGateCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A unique Deployment identifier.")]
        public string DeploymentId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for the DR precheck report generation request.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GenerateDisasterRecoveryPrecheckReportRequest
                {
                ...
                response = client.GenerateDisasterRecoveryPrecheckReport(request).GetAwaiter().GetResult();
        ...
        private GenerateDisasterRecoveryPrecheckReportResponse response;
    }
}
