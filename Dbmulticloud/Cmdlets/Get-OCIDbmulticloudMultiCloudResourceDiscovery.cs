...
{
    [Cmdlet("Get", "OCIDbmulticloudMultiCloudResourceDiscovery", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DbmulticloudService.Models.MultiCloudResourceDiscovery), typeof(Oci.DbmulticloudService.Responses.GetMultiCloudResourceDiscoveryResponse) })]
    public class GetOCIDbmulticloudMultiCloudResourceDiscovery : OCIMultiCloudResourceDiscoveryCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Multi Cloud Discovery Resource.", ParameterSetName = LifecycleStateParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Multi Cloud Discovery Resource.", ParameterSetName = Default)]
        ...
        public Oci.DbmulticloudService.Models.MultiCloudResourceDiscovery.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMultiCloudResourceDiscoveryRequest
                {
        ...
        private void HandleOutput(GetMultiCloudResourceDiscoveryRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForMultiCloudResourceDiscovery(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetMultiCloudResourceDiscovery(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.MultiCloudResourceDiscovery);
        }

        private GetMultiCloudResourceDiscoveryResponse response;
