...
{
    [Cmdlet("Restart", "OCIDatabaseCloudAutonomousVmClusterOrds", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.RestartCloudAutonomousVmClusterOrdsResponse) })]
    public class RestartOCIDatabaseCloudAutonomousVmClusterOrds : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RestartCloudAutonomousVmClusterOrdsRequest
                {
        ...
        private void HandleOutput(RestartCloudAutonomousVmClusterOrdsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRestartCloudAutonomousVmClusterOrds(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RestartCloudAutonomousVmClusterOrds(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private RestartCloudAutonomousVmClusterOrdsResponse response;
