...
{
    [Cmdlet("Add", "OCIEmailReturnPathLock")]
    [OutputType(new System.Type[] { typeof(Oci.EmailService.Models.EmailReturnPath), typeof(Oci.EmailService.Responses.AddReturnPathLockResponse) })]
    public class AddOCIEmailReturnPathLock : OCIEmailCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddReturnPathLockRequest
                {
                ...
                response = client.AddReturnPathLock(request).GetAwaiter().GetResult();
        ...
        private AddReturnPathLockResponse response;
    }
}
