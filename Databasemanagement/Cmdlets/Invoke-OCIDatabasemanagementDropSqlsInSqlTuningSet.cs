...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementDropSqlsInSqlTuningSet")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.SqlTuningSetAdminActionStatus), typeof(Oci.DatabasemanagementService.Responses.DropSqlsInSqlTuningSetResponse) })]
    public class InvokeOCIDatabasemanagementDropSqlsInSqlTuningSet : OCISqlTuningCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Drops the selected list of Sql statements from the current Sql tuning set.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DropSqlsInSqlTuningSetRequest
                {
                ...
                response = client.DropSqlsInSqlTuningSet(request).GetAwaiter().GetResult();
        ...
        private DropSqlsInSqlTuningSetResponse response;
    }
}
