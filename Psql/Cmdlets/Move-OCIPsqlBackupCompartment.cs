...
{
    [Cmdlet("Move", "OCIPsqlBackupCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.PsqlService.Responses.ChangeBackupCompartmentResponse) })]
    public class MoveOCIPsqlBackupCompartment : OCIPostgresqlCmdlet
    {
