...
{
    [Cmdlet("Enable", "OCIOsmanagementModuleStreamOnManagedInstance")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OsmanagementService.Responses.EnableModuleStreamOnManagedInstanceResponse) })]
    public class EnableOCIOsmanagementModuleStreamOnManagedInstance : OCIOsManagementCmdlet
    {
