...
{
    [Cmdlet("Restore", "OCIDatabaseAutonomousDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousDatabase), typeof(Oci.DatabaseService.Responses.RestoreAutonomousDatabaseResponse) })]
    public class RestoreOCIDatabaseAutonomousDatabase : OCIDatabaseCmdlet
    {
        ...
        private void HandleOutput(RestoreAutonomousDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRestoreAutonomousDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RestoreAutonomousDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousDatabase);
        }

        private RestoreAutonomousDatabaseResponse response;
