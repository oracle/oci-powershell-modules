...
{
    [Cmdlet("Remove", "OCIDatabaseScheduledAction", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteScheduledActionResponse) })]
    public class RemoveOCIDatabaseScheduledAction : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseScheduledAction", "Remove"))
            {
               return;
            }
        ...
        private void HandleOutput(DeleteScheduledActionRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteScheduledAction(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteScheduledAction(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteScheduledActionResponse response;
