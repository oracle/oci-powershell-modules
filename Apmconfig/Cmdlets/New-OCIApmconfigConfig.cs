...
namespace Oci.ApmconfigService.Cmdlets
{
    ...
    public class NewOCIApmconfigConfig : OCIConfigCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The configuration details of the new item. This parameter also accepts subtypes <Oci.ApmconfigService.Models.CreateSpanFilterDetails>, <Oci.ApmconfigService.Models.CreateMetricGroupDetails>, <Oci.ApmconfigService.Models.CreateAgentConfigDetails>, <Oci.ApmconfigService.Models.CreateOptionsDetails>, <Oci.ApmconfigService.Models.CreateMacsApmExtensionDetails>, <Oci.ApmconfigService.Models.CreateApdexRulesDetails> of type <Oci.ApmconfigService.Models.CreateConfigDetails>.")]
