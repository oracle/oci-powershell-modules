...
{
    [Cmdlet("Move", "OCIComputeHostCompartment", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.ChangeComputeHostCompartmentResponse) })]
    public class MoveOCIComputeHostCompartment : OCIComputeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeComputeHostCompartmentRequest
                {
        ...
        private void HandleOutput(ChangeComputeHostCompartmentRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForChangeComputeHostCompartment(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ChangeComputeHostCompartment(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private ChangeComputeHostCompartmentResponse response;
