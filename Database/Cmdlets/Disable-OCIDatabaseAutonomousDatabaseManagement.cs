...
{
    [Cmdlet("Disable", "OCIDatabaseAutonomousDatabaseManagement", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DisableAutonomousDatabaseManagementResponse) })]
    public class DisableOCIDatabaseAutonomousDatabaseManagement : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableAutonomousDatabaseManagementRequest
                {
        ...
        private void HandleOutput(DisableAutonomousDatabaseManagementRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDisableAutonomousDatabaseManagement(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DisableAutonomousDatabaseManagement(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DisableAutonomousDatabaseManagementResponse response;
