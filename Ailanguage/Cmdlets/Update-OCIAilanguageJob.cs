...
{
    [Cmdlet("Update", "OCIAilanguageJob")]
    [OutputType(new System.Type[] { typeof(Oci.AilanguageService.Models.Job), typeof(Oci.AilanguageService.Responses.UpdateJobResponse) })]
    public class UpdateOCIAilanguageJob : OCIAIServiceLanguageCmdlet
    {
