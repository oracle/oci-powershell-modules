...
{
    [Cmdlet("New", "OCIDataconnectivityAttachDataAsset")]
    [OutputType(new System.Type[] { typeof(Oci.DataconnectivityService.Models.AttachDataAssetInfo), typeof(Oci.DataconnectivityService.Responses.CreateAttachDataAssetResponse) })]
    public class NewOCIDataconnectivityAttachDataAsset : OCIDataConnectivityManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request body parameters to attach data asset to an private endpoint")]
        public CreateAttachDataAssetDetails CreateAttachDataAssetDetails { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateAttachDataAssetRequest
                {
                ...
                response = client.CreateAttachDataAsset(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AttachDataAssetInfo);
        ...
        private CreateAttachDataAssetResponse response;
    }
}
