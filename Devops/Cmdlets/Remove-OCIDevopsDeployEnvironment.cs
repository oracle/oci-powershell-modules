...
{
    [Cmdlet("Remove", "OCIDevopsDeployEnvironment", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DevopsService.Responses.DeleteDeployEnvironmentResponse) })]
    public class RemoveOCIDevopsDeployEnvironment : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDevopsDeployEnvironment", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDeployEnvironmentRequest
                {
                ...
                response = client.DeleteDeployEnvironment(request).GetAwaiter().GetResult();
        ...
        private DeleteDeployEnvironmentResponse response;
    }
}
