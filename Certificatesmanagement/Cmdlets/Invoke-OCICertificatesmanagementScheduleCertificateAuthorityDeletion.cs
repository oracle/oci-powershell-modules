...
{
    [Cmdlet("Invoke", "OCICertificatesmanagementScheduleCertificateAuthorityDeletion")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CertificatesmanagementService.Responses.ScheduleCertificateAuthorityDeletionResponse) })]
    public class InvokeOCICertificatesmanagementScheduleCertificateAuthorityDeletion : OCICertificatesManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details of the request to schedule the deletion of a CA.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ScheduleCertificateAuthorityDeletionRequest
                {
                ...
                response = client.ScheduleCertificateAuthorityDeletion(request).GetAwaiter().GetResult();
        ...
        private ScheduleCertificateAuthorityDeletionResponse response;
    }
}
