...
{
    [Cmdlet("Get", "OCIDatabaseGiVersionsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.GiVersionSummary), typeof(Oci.DatabaseService.Responses.ListGiVersionsResponse) })]
    public class GetOCIDatabaseGiVersionsList : OCIDatabaseCmdlet
    {
        ...
        public System.Nullable<Oci.DatabaseService.Requests.ListGiVersionsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        {
            IEnumerable<ListGiVersionsResponse> DefaultRequest(ListGiVersionsRequest request) => Enumerable.Repeat(client.ListGiVersions(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListGiVersionsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListGiVersionsResponse response;
        private delegate IEnumerable<ListGiVersionsResponse> RequestDelegate(ListGiVersionsRequest request);
