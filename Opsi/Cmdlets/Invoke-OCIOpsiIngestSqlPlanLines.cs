...
{
    [Cmdlet("Invoke", "OCIOpsiIngestSqlPlanLines")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.IngestSqlPlanLinesResponseDetails), typeof(Oci.OpsiService.Responses.IngestSqlPlanLinesResponse) })]
    public class InvokeOCIOpsiIngestSqlPlanLines : OCIOperationsInsightsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Collection of SQL plan line objects for a particular database.")]
...
*Note:* Retry tokens can be invalidated before the 24 hour time limit due to conflicting operations, such as a resource being deleted or purged from the system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new IngestSqlPlanLinesRequest
                {
                ...
                response = client.IngestSqlPlanLines(request).GetAwaiter().GetResult();
                WriteOutput(response, response.IngestSqlPlanLinesResponseDetails);
        ...
        private IngestSqlPlanLinesResponse response;
    }
}
