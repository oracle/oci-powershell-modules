...
{
    [Cmdlet("Remove", "OCIDatacatalogCustomProperty", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatacatalogService.Responses.DeleteCustomPropertyResponse) })]
    public class RemoveOCIDatacatalogCustomProperty : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatacatalogCustomProperty", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteCustomPropertyRequest
                {
                    CatalogId = CatalogId,
                ...
                response = client.DeleteCustomProperty(request).GetAwaiter().GetResult();
        ...
        private DeleteCustomPropertyResponse response;
    }
}
