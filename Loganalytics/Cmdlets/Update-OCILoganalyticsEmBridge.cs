...
{
    [Cmdlet("Update", "OCILoganalyticsEmBridge")]
    ...
    public class UpdateOCILoganalyticsEmBridge : OCILogAnalyticsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateLogAnalyticsEmBridgeRequest
                {
                ...
                response = client.UpdateLogAnalyticsEmBridge(request).GetAwaiter().GetResult();
        ...
        private UpdateLogAnalyticsEmBridgeResponse response;
    }
}
