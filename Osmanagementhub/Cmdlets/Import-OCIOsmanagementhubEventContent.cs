...
{
    [Cmdlet("Import", "OCIOsmanagementhubEventContent")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OsmanagementhubService.Responses.ImportEventContentResponse) })]
    public class ImportOCIOsmanagementhubEventContent : OCIEventCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ImportEventContentRequest
                {
                    EventId = EventId,
                ...
                response = client.ImportEventContent(request).GetAwaiter().GetResult();
        ...
        private ImportEventContentResponse response;
    }
}
