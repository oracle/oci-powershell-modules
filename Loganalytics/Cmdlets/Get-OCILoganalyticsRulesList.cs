...
{
    [Cmdlet("Get", "OCILoganalyticsRulesList")]
    [OutputType(new System.Type[] { typeof(Oci.LoganalyticsService.Models.RuleSummaryCollection), typeof(Oci.LoganalyticsService.Responses.ListRulesResponse) })]
    public class GetOCILoganalyticsRulesList : OCILogAnalyticsCmdlet
    {
        ...
        public System.Nullable<Oci.LoganalyticsService.Requests.ListRulesRequest.SortOrderEnum> SortOrder { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field to sort by. Only one sort order may be provided. Default order for timeCreated is descending. Default order for displayName is ascending. If no value is specified timeCreated is default.")]
        public System.Nullable<Oci.LoganalyticsService.Requests.ListRulesRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    response = item;
                    WriteOutput(response, response.RuleSummaryCollection, true);
                }
