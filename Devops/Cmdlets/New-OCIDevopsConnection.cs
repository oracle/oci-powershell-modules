...
namespace Oci.DevopsService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new connection. This parameter also accepts subtypes <Oci.DevopsService.Models.CreateGitlabServerAccessTokenConnectionDetails>, <Oci.DevopsService.Models.CreateBitbucketServerAccessTokenConnectionDetails>, <Oci.DevopsService.Models.CreateGithubAccessTokenConnectionDetails>, <Oci.DevopsService.Models.CreateBitbucketCloudAppPasswordConnectionDetails>, <Oci.DevopsService.Models.CreateGitlabAccessTokenConnectionDetails> of type <Oci.DevopsService.Models.CreateConnectionDetails>.")]
