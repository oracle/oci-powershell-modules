...
{
    [Cmdlet("New", "OCIResourcemanagerTemplate")]
    [OutputType(new System.Type[] { typeof(Oci.ResourcemanagerService.Models.Template), typeof(Oci.ResourcemanagerService.Responses.CreateTemplateResponse) })]
    public class NewOCIResourcemanagerTemplate : OCIResourceManagerCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The configuration details for creating a template.")]
        ...
        private CreateTemplateResponse response;
    }
}
