...
namespace Oci.CoreService.Cmdlets
{
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The service's [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).")]
