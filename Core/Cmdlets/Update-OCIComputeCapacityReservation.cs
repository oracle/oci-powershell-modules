...
{
    [Cmdlet("Update", "OCIComputeCapacityReservation", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.UpdateComputeCapacityReservationResponse) })]
    public class UpdateOCIComputeCapacityReservation : OCIComputeCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Update compute capacity reservation details.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Update compute capacity reservation details.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateComputeCapacityReservationRequest
                {
        ...
        private void HandleOutput(UpdateComputeCapacityReservationRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateComputeCapacityReservation(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpdateComputeCapacityReservation(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private UpdateComputeCapacityReservationResponse response;
