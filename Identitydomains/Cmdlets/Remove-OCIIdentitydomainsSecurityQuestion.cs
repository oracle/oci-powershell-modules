...
{
    [Cmdlet("Remove", "OCIIdentitydomainsSecurityQuestion", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeleteSecurityQuestionResponse) })]
    public class RemoveOCIIdentitydomainsSecurityQuestion : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsSecurityQuestion", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteSecurityQuestionRequest
                {
                ...
                response = client.DeleteSecurityQuestion(request).GetAwaiter().GetResult();
        ...
        private DeleteSecurityQuestionResponse response;
    }
}
