...
{
    [Cmdlet("Remove", "OCIIdentitydomainsPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.IdentitydomainsService.Responses.DeletePolicyResponse) })]
    public class RemoveOCIIdentitydomainsPolicy : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIIdentitydomainsPolicy", "Remove"))
            {
               return;
            }
        ...
        private DeletePolicyResponse response;
    }
}
