...
{
    [Cmdlet("Remove", "OCIGoldengateDeploymentBackupLock")]
    [OutputType(new System.Type[] { typeof(Oci.GoldengateService.Models.DeploymentBackup), typeof(Oci.GoldengateService.Responses.RemoveDeploymentBackupLockResponse) })]
    public class RemoveOCIGoldengateDeploymentBackupLock : OCIGoldenGateCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveDeploymentBackupLockRequest
                {
                ...
                response = client.RemoveDeploymentBackupLock(request).GetAwaiter().GetResult();
        ...
        private RemoveDeploymentBackupLockResponse response;
    }
}
