...
{
    [Cmdlet("Get", "OCICloudguardDetector", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.CloudguardService.Models.Detector), typeof(Oci.CloudguardService.Responses.GetDetectorResponse) })]
    public class GetOCICloudguardDetector : OCICloudGuardCmdlet
    {
        ...
        private GetDetectorResponse response;
