...
{
    [Cmdlet("Get", "OCIVirtualNetworkVcnsList")]
    [OutputType(new System.Type[] { typeof(Oci.CoreService.Models.Vcn), typeof(Oci.CoreService.Responses.ListVcnsResponse) })]
    public class GetOCIVirtualNetworkVcnsList : OCIVirtualNetworkCmdlet
    {
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by availability domain if the scope of the resource type is within a single availability domain. If you call one of these ""List"" operations without specifying an availability domain, the resources are grouped by availability domain, then sorted.")]
        public System.Nullable<Oci.CoreService.Requests.ListVcnsRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Requests.ListVcnsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.CoreService.Models.Vcn.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        {
            IEnumerable<ListVcnsResponse> DefaultRequest(ListVcnsRequest request) => Enumerable.Repeat(client.ListVcns(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListVcnsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListVcnsResponse response;
        private delegate IEnumerable<ListVcnsResponse> RequestDelegate(ListVcnsRequest request);
