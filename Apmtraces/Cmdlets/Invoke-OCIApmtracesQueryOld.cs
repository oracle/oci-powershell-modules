...
{
    [Cmdlet("Invoke", "OCIApmtracesQueryOld")]
    [OutputType(new System.Type[] { typeof(Oci.ApmtracesService.Models.QueryResultResponse), typeof(Oci.ApmtracesService.Responses.QueryOldResponse) })]
    public class InvokeOCIApmtracesQueryOld : OCIQueryCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.QueryOld(request).GetAwaiter().GetResult();
        ...
        private QueryOldResponse response;
    }
}
