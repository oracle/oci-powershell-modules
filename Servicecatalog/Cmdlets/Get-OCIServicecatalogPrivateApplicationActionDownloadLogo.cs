...
namespace Oci.ServicecatalogService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIServicecatalogPrivateApplicationActionDownloadLogo", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.ServicecatalogService.Responses.GetPrivateApplicationActionDownloadLogoResponse) })]
    public class GetOCIServicecatalogPrivateApplicationActionDownloadLogo : OCIServiceCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetPrivateApplicationActionDownloadLogoRequest
                {
                    PrivateApplicationId = PrivateApplicationId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetPrivateApplicationActionDownloadLogo(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetPrivateApplicationActionDownloadLogoResponse response;
