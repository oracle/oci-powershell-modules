...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchRules")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Rules), typeof(Oci.IdentitydomainsService.Responses.SearchRulesResponse) })]
    public class InvokeOCIIdentitydomainsSearchRules : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching Rules")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchRulesRequest
                {
                ...
                response = client.SearchRules(request).GetAwaiter().GetResult();
                WriteOutput(response, response.Rules);
        ...
        private SearchRulesResponse response;
    }
}
