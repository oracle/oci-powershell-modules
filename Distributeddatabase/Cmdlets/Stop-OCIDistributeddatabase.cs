...
{
    [Cmdlet("Stop", "OCIDistributeddatabase")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.StopDistributedDatabaseResponse) })]
    public class StopOCIDistributeddatabase : OCIDistributedDbServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StopDistributedDatabaseRequest
                {
                ...
                response = client.StopDistributedDatabase(request).GetAwaiter().GetResult();
        ...
        private StopDistributedDatabaseResponse response;
    }
}
