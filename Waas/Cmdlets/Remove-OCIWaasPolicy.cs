...
{
    [Cmdlet("Remove", "OCIWaasPolicy", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.DeleteWaasPolicyResponse) })]
    public class RemoveOCIWaasPolicy : OCIWaasCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIWaasPolicy", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteWaasPolicyRequest
                {
        ...
        private DeleteWaasPolicyResponse response;
    }
}
