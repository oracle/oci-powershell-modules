...
{
    [Cmdlet("Get", "OCIDatabaseSchedulingWindowsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.SchedulingWindowSummary), typeof(Oci.DatabaseService.Responses.ListSchedulingWindowsResponse) })]
    public class GetOCIDatabaseSchedulingWindowsList : OCIDatabaseCmdlet
    {
        ...
        public System.Nullable<Oci.DatabaseService.Requests.ListSchedulingWindowsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, either ascending (`ASC`) or descending (`DESC`).")]
        public System.Nullable<Oci.DatabaseService.Requests.ListSchedulingWindowsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatabaseService.Models.SchedulingWindowSummary.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSchedulingWindowsRequest
                {
                ...
                IEnumerable<ListSchedulingWindowsResponse> responses = GetRequestDelegate().Invoke(request);
        ...
        {
            IEnumerable<ListSchedulingWindowsResponse> DefaultRequest(ListSchedulingWindowsRequest request) => Enumerable.Repeat(client.ListSchedulingWindows(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSchedulingWindowsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSchedulingWindowsResponse response;
        private delegate IEnumerable<ListSchedulingWindowsResponse> RequestDelegate(ListSchedulingWindowsRequest request);
