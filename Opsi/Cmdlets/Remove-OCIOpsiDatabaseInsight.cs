...
{
    [Cmdlet("Remove", "OCIOpsiDatabaseInsight", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.DeleteDatabaseInsightResponse) })]
    public class RemoveOCIOpsiDatabaseInsight : OCIOperationsInsightsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOpsiDatabaseInsight", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDatabaseInsightRequest
                {
                ...
                response = client.DeleteDatabaseInsight(request).GetAwaiter().GetResult();
        ...
        private DeleteDatabaseInsightResponse response;
    }
}
