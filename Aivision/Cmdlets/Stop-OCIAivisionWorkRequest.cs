...
{
    [Cmdlet("Stop", "OCIAivisionWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.AivisionService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIAivisionWorkRequest : OCIAIServiceVisionCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIAivisionWorkRequest", "Stop"))
            {
               return;
            }
