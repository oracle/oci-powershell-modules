...
{
    [Cmdlet("Get", "OCIIdentitydomainsGrantsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Grants), typeof(Oci.IdentitydomainsService.Responses.ListGrantsResponse) })]
    public class GetOCIIdentitydomainsGrantsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ListGrants(request).GetAwaiter().GetResult();
