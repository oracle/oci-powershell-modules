...
{
    [Cmdlet("Get", "OCIOpensearchWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.OpensearchService.Models.WorkRequestLogEntryCollection), typeof(Oci.OpensearchService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIOpensearchWorkRequestLogsList : OCIOpensearchClusterCmdlet
    {
