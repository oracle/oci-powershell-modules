...
{
    [Cmdlet("Get", "OCIDataconnectivityConnectionValidation")]
    [OutputType(new System.Type[] { typeof(Oci.DataconnectivityService.Models.ConnectionValidation), typeof(Oci.DataconnectivityService.Responses.GetConnectionValidationResponse) })]
    public class GetOCIDataconnectivityConnectionValidation : OCIDataConnectivityManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetConnectionValidationRequest
                {
                ...
                response = client.GetConnectionValidation(request).GetAwaiter().GetResult();
        ...
        private GetConnectionValidationResponse response;
    }
}
