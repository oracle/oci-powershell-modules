...
namespace Oci.DistributeddatabaseService.Cmdlets
{
     ...
     */
    [Cmdlet("New", "OCIDistributeddatabaseWallet", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DistributeddatabaseService.Responses.GenerateDistributedDatabaseWalletResponse) })]
    public class NewOCIDistributeddatabaseWallet : OCIDistributedDbServiceCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for generating Globally distributed database wallet.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GenerateDistributedDatabaseWalletRequest
                {
                ...
                response = client.GenerateDistributedDatabaseWallet(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GenerateDistributedDatabaseWalletResponse response;
