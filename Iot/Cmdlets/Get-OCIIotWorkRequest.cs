...
{
    [Cmdlet("Get", "OCIIotWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.IotService.Models.WorkRequest), typeof(Oci.IotService.Responses.GetWorkRequestResponse) })]
    public class GetOCIIotWorkRequest : OCIIotCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, provide the request ID.", ParameterSetName = StatusParamSet)]
        ...
        public Oci.IotService.Models.OperationStatus[] WaitForStatus { get; set; }
