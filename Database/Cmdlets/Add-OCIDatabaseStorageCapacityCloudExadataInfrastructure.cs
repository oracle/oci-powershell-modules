...
{
    [Cmdlet("Add", "OCIDatabaseStorageCapacityCloudExadataInfrastructure", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.CloudExadataInfrastructure), typeof(Oci.DatabaseService.Responses.AddStorageCapacityCloudExadataInfrastructureResponse) })]
    public class AddOCIDatabaseStorageCapacityCloudExadataInfrastructure : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddStorageCapacityCloudExadataInfrastructureRequest
                {
        ...
        private void HandleOutput(AddStorageCapacityCloudExadataInfrastructureRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForAddStorageCapacityCloudExadataInfrastructure(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.AddStorageCapacityCloudExadataInfrastructure(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.CloudExadataInfrastructure);
        }

        private AddStorageCapacityCloudExadataInfrastructureResponse response;
