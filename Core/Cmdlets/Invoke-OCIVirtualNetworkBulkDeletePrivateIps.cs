...
{
    [Cmdlet("Invoke", "OCIVirtualNetworkBulkDeletePrivateIps", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.BulkDeletePrivateIpsResponse) })]
    public class InvokeOCIVirtualNetworkBulkDeletePrivateIps : OCIVirtualNetworkCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new BulkDeletePrivateIpsRequest
                {
        ...
        private void HandleOutput(BulkDeletePrivateIpsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForBulkDeletePrivateIps(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.BulkDeletePrivateIps(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private BulkDeletePrivateIpsResponse response;
