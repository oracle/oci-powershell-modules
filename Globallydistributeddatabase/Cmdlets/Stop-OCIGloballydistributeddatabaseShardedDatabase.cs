...
{
    [Cmdlet("Stop", "OCIGloballydistributeddatabaseShardedDatabase")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GloballydistributeddatabaseService.Responses.StopShardedDatabaseResponse) })]
    public class StopOCIGloballydistributeddatabaseShardedDatabase : OCIShardedDatabaseServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StopShardedDatabaseRequest
                {
                ...
                response = client.StopShardedDatabase(request).GetAwaiter().GetResult();
        ...
        private StopShardedDatabaseResponse response;
    }
}
