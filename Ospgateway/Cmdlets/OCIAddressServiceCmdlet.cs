...
{
    public abstract class OCIAddressServiceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new AddressServiceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected AddressServiceClient client;
