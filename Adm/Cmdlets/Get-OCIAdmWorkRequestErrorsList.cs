...
{
    [Cmdlet("Get", "OCIAdmWorkRequestErrorsList")]
    ...
    public class GetOCIAdmWorkRequestErrorsList : OCIApplicationDependencyManagementCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field used to sort WorkRequests. Only one sort order is allowed. Default order for _timeAccepted_ is **descending**.")]
        public System.Nullable<Oci.AdmService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }
