...
{
    [Cmdlet("Get", "OCIApmsyntheticsOnPremiseVantagePoint")]
    [OutputType(new System.Type[] { typeof(Oci.ApmsyntheticsService.Models.OnPremiseVantagePoint), typeof(Oci.ApmsyntheticsService.Responses.GetOnPremiseVantagePointResponse) })]
    public class GetOCIApmsyntheticsOnPremiseVantagePoint : OCIApmSyntheticCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOnPremiseVantagePointRequest
                {
                ...
                response = client.GetOnPremiseVantagePoint(request).GetAwaiter().GetResult();
        ...
        private GetOnPremiseVantagePointResponse response;
    }
}
