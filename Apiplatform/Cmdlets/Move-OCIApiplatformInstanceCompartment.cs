...
{
    [Cmdlet("Move", "OCIApiplatformInstanceCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ApiplatformService.Responses.ChangeApiPlatformInstanceCompartmentResponse) })]
    public class MoveOCIApiplatformInstanceCompartment : OCIApiPlatformCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeApiPlatformInstanceCompartmentRequest
                {
                ...
                response = client.ChangeApiPlatformInstanceCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeApiPlatformInstanceCompartmentResponse response;
    }
}
