...
namespace Oci.CoreService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIVirtualNetworkTunnelCpeDeviceConfigContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.CoreService.Responses.GetTunnelCpeDeviceConfigContentResponse) })]
    public class GetOCIVirtualNetworkTunnelCpeDeviceConfigContent : OCIVirtualNetworkCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetTunnelCpeDeviceConfigContentRequest
                {
                    IpscId = IpscId,
                    TunnelId = TunnelId,
                ...
                response = client.GetTunnelCpeDeviceConfigContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetTunnelCpeDeviceConfigContentResponse response;
