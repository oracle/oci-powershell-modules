...
{
    public abstract class OCIDatabaseCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DatabaseClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
