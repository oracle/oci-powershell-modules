...
{
    [Cmdlet("Remove", "OCIOdaSkill", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OdaService.Responses.DeleteSkillResponse) })]
    public class RemoveOCIOdaSkill : OCIManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOdaSkill", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteSkillRequest
                {
                ...
                response = client.DeleteSkill(request).GetAwaiter().GetResult();
        ...
        private DeleteSkillResponse response;
    }
}
