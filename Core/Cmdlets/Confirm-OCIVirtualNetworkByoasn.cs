...
{
    [Cmdlet("Confirm", "OCIVirtualNetworkByoasn", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.ValidateByoasnResponse) })]
    public class ConfirmOCIVirtualNetworkByoasn : OCIVirtualNetworkCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `Byoasn` resource.", ParameterSetName = StatusParamSet)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ValidateByoasnRequest
                {
                    ByoasnId = ByoasnId,
        ...
        private void HandleOutput(ValidateByoasnRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForValidateByoasn(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ValidateByoasn(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private ValidateByoasnResponse response;
