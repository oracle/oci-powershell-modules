...
{
    [Cmdlet("Reset", "OCIMysqlChannel")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.ResetChannelResponse) })]
    public class ResetOCIMysqlChannel : OCIChannelsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ResetChannelRequest
                {
                    ChannelId = ChannelId,
                    IfMatch = IfMatch,
                ...
                response = client.ResetChannel(request).GetAwaiter().GetResult();
        ...
        private ResetChannelResponse response;
    }
}
