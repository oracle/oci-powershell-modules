...
{
    [Cmdlet("Get", "OCIIdentitydomainsAccountRecoverySetting")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.AccountRecoverySetting), typeof(Oci.IdentitydomainsService.Responses.GetAccountRecoverySettingResponse) })]
    public class GetOCIIdentitydomainsAccountRecoverySetting : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetAccountRecoverySettingRequest
                {
                ...
                response = client.GetAccountRecoverySetting(request).GetAwaiter().GetResult();
        ...
        private GetAccountRecoverySettingResponse response;
    }
}
