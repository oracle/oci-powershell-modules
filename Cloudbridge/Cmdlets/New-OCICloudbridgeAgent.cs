...
{
    [Cmdlet("New", "OCICloudbridgeAgent")]
    [OutputType(new System.Type[] { typeof(Oci.CloudbridgeService.Models.Agent), typeof(Oci.CloudbridgeService.Responses.CreateAgentResponse) })]
    public class NewOCICloudbridgeAgent : OCIOcbAgentSvcCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details of the new Agent.")]
