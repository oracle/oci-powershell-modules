...
{
    [Cmdlet("Get", "OCIResourceschedulerWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.ResourceschedulerService.Models.WorkRequestSummaryCollection), typeof(Oci.ResourceschedulerService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIResourceschedulerWorkRequestsList : OCIScheduleCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"This is the [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the asynchronous work request.")]
        public string WorkRequestId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"This is a filter to return only the resources that match the given lifecycle state.")]
        public System.Nullable<Oci.ResourceschedulerService.Models.OperationStatus> Status { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"This is the [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the resource affected by the work request.")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"This is the field to sort by. Only one sort order may be provided. Default order for `timeAccepted` is descending.")]
        public System.Nullable<Oci.ResourceschedulerService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"This is the [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the schedule.")]
