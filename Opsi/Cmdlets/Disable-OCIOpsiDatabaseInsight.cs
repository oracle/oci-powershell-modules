...
{
    [Cmdlet("Disable", "OCIOpsiDatabaseInsight")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.DisableDatabaseInsightResponse) })]
    public class DisableOCIOpsiDatabaseInsight : OCIOperationsInsightsCmdlet
    {
...
*Note:* Retry tokens can be invalidated before the 24 hour time limit due to conflicting operations, such as a resource being deleted or purged from the system.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DisableDatabaseInsightRequest
                {
                ...
                response = client.DisableDatabaseInsight(request).GetAwaiter().GetResult();
        ...
        private DisableDatabaseInsightResponse response;
    }
}
