...
{
    [Cmdlet("Get", "OCIOdaPrivateEndpoint", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.OdaPrivateEndpoint), typeof(Oci.OdaService.Responses.GetOdaPrivateEndpointResponse) })]
    public class GetOCIOdaPrivateEndpoint : OCIManagementCmdlet
    {
        ...
        public Oci.OdaService.Models.OdaPrivateEndpoint.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetOdaPrivateEndpointRequest
                {
        ...
        private void HandleOutput(GetOdaPrivateEndpointRequest request)
        {
            ...
            { 
                case LifecycleStateParamSet:
                    response = client.Waiters.ForOdaPrivateEndpoint(request, waiterConfig, WaitForLifecycleState).Execute();
                    break;

                case Default:
                    response = client.GetOdaPrivateEndpoint(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.OdaPrivateEndpoint);
        }

        private GetOdaPrivateEndpointResponse response;
