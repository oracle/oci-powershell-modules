...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchGroups")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Groups), typeof(Oci.IdentitydomainsService.Responses.SearchGroupsResponse) })]
    public class InvokeOCIIdentitydomainsSearchGroups : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching Groups")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.SearchGroups(request).GetAwaiter().GetResult();
                WriteOutput(response, response.Groups);
        ...
        private SearchGroupsResponse response;
    }
}
