...
{
    [Cmdlet("Update", "OCIAidocumentProject")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AidocumentService.Responses.UpdateProjectResponse) })]
    public class UpdateOCIAidocumentProject : OCIAIServiceDocumentCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"A unique project identifier.")]
        public string ProjectId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The project metadata to be updated.")]
