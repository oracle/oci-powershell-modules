...
{
    [Cmdlet("Add", "OCIMediaservicesStreamCdnConfigLock")]
    [OutputType(new System.Type[] { typeof(Oci.MediaservicesService.Models.StreamCdnConfig), typeof(Oci.MediaservicesService.Responses.AddStreamCdnConfigLockResponse) })]
    public class AddOCIMediaservicesStreamCdnConfigLock : OCIMediaServicesCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddStreamCdnConfigLockRequest
                {
                ...
                response = client.AddStreamCdnConfigLock(request).GetAwaiter().GetResult();
        ...
        private AddStreamCdnConfigLockResponse response;
    }
}
