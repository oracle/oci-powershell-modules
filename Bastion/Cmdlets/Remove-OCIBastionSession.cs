...
{
    [Cmdlet("Remove", "OCIBastionSession", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.BastionService.Responses.DeleteSessionResponse) })]
    public class RemoveOCIBastionSession : OCIBastionCmdlet
    {
