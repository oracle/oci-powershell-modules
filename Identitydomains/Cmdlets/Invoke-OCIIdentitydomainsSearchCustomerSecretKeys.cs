...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchCustomerSecretKeys")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.CustomerSecretKeys), typeof(Oci.IdentitydomainsService.Responses.SearchCustomerSecretKeysResponse) })]
    public class InvokeOCIIdentitydomainsSearchCustomerSecretKeys : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching CustomerSecretKeys")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchCustomerSecretKeysRequest
                {
                ...
                response = client.SearchCustomerSecretKeys(request).GetAwaiter().GetResult();
                WriteOutput(response, response.CustomerSecretKeys);
        ...
        private SearchCustomerSecretKeysResponse response;
    }
}
