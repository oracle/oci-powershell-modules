...
{
    [Cmdlet("Stop", "OCIMysqlAnalyticsCluster")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.MysqlService.Responses.StopAnalyticsClusterResponse) })]
    public class StopOCIMysqlAnalyticsCluster : OCIDbSystemCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StopAnalyticsClusterRequest
                {
                ...
                response = client.StopAnalyticsCluster(request).GetAwaiter().GetResult();
        ...
        private StopAnalyticsClusterResponse response;
    }
}
