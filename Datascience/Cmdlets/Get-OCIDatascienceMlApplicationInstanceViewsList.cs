...
{
    [Cmdlet("Get", "OCIDatascienceMlApplicationInstanceViewsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.MlApplicationInstanceViewCollection), typeof(Oci.DatascienceService.Responses.ListMlApplicationInstanceViewsResponse) })]
    public class GetOCIDatascienceMlApplicationInstanceViewsList : OCIDataScienceCmdlet
    {
...
See [List Pagination](https://docs.oracle.com/iaas/Content/General/Concepts/usingapi.htm#nine).")]
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListMlApplicationInstanceViewsRequest.SortOrderEnum> SortOrder { get; set; }
        ...
        public System.Nullable<Oci.DatascienceService.Requests.ListMlApplicationInstanceViewsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListMlApplicationInstanceViewsRequest
                {
                ...
                IEnumerable<ListMlApplicationInstanceViewsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.MlApplicationInstanceViewCollection, true);
                }
        ...
        {
            IEnumerable<ListMlApplicationInstanceViewsResponse> DefaultRequest(ListMlApplicationInstanceViewsRequest request) => Enumerable.Repeat(client.ListMlApplicationInstanceViews(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListMlApplicationInstanceViewsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListMlApplicationInstanceViewsResponse response;
        private delegate IEnumerable<ListMlApplicationInstanceViewsResponse> RequestDelegate(ListMlApplicationInstanceViewsRequest request);
