...
{
    [Cmdlet("Get", "OCIGoldengateWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.GoldengateService.Models.WorkRequest), typeof(Oci.GoldengateService.Responses.GetWorkRequestResponse) })]
    public class GetOCIGoldengateWorkRequest : OCIGoldenGateCmdlet
    {
        ...
        public Oci.GoldengateService.Models.OperationStatus[] WaitForStatus { get; set; }
