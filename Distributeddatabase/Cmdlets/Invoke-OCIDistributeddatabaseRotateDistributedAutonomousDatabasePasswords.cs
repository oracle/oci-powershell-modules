...
{
    [Cmdlet("Invoke", "OCIDistributeddatabaseRotateDistributedAutonomousDatabasePasswords")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.RotateDistributedAutonomousDatabasePasswordsResponse) })]
    public class InvokeOCIDistributeddatabaseRotateDistributedAutonomousDatabasePasswords : OCIDistributedAutonomousDbServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.RotateDistributedAutonomousDatabasePasswords(request).GetAwaiter().GetResult();
        ...
        private RotateDistributedAutonomousDatabasePasswordsResponse response;
    }
}
