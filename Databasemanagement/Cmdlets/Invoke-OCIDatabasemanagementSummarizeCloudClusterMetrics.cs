...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementSummarizeCloudClusterMetrics")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.MetricsAggregationRangeCollection), typeof(Oci.DatabasemanagementService.Responses.SummarizeCloudClusterMetricsResponse) })]
    public class InvokeOCIDatabasemanagementSummarizeCloudClusterMetrics : OCIDbManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeCloudClusterMetricsRequest
                {
                ...
                response = client.SummarizeCloudClusterMetrics(request).GetAwaiter().GetResult();
        ...
        private SummarizeCloudClusterMetricsResponse response;
    }
}
