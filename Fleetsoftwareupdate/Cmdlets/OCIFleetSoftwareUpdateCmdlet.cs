...
{
    public abstract class OCIFleetSoftwareUpdateCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new FleetSoftwareUpdateClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected FleetSoftwareUpdateClient client;
