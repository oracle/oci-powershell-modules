...
{
    [Cmdlet("Move", "OCICloudmigrationsMigrationCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CloudmigrationsService.Responses.ChangeMigrationCompartmentResponse) })]
    public class MoveOCICloudmigrationsMigrationCompartment : OCIMigrationCmdlet
    {
