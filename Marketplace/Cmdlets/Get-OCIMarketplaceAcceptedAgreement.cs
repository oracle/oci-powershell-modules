...
{
    [Cmdlet("Get", "OCIMarketplaceAcceptedAgreement")]
    [OutputType(new System.Type[] { typeof(Oci.MarketplaceService.Models.AcceptedAgreement), typeof(Oci.MarketplaceService.Responses.GetAcceptedAgreementResponse) })]
    public class GetOCIMarketplaceAcceptedAgreement : OCIMarketplaceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetAcceptedAgreementRequest
                {
                    AcceptedAgreementId = AcceptedAgreementId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetAcceptedAgreement(request).GetAwaiter().GetResult();
        ...
        private GetAcceptedAgreementResponse response;
    }
}
