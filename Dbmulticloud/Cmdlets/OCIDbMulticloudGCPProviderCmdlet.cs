...
{
    public abstract class OCIDbMulticloudGCPProviderCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DbMulticloudGCPProviderClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DbMulticloudGCPProviderClient client;
