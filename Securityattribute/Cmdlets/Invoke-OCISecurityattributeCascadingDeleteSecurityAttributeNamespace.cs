...
{
    [Cmdlet("Invoke", "OCISecurityattributeCascadingDeleteSecurityAttributeNamespace")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.SecurityattributeService.Responses.CascadingDeleteSecurityAttributeNamespaceResponse) })]
    public class InvokeOCISecurityattributeCascadingDeleteSecurityAttributeNamespace : OCISecurityAttributeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CascadingDeleteSecurityAttributeNamespaceRequest
                {
                ...
                response = client.CascadingDeleteSecurityAttributeNamespace(request).GetAwaiter().GetResult();
        ...
        private CascadingDeleteSecurityAttributeNamespaceResponse response;
    }
}
