...
{
    [Cmdlet("Get", "OCIIdentitydomainsSelfRegistrationProfile")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SelfRegistrationProfile), typeof(Oci.IdentitydomainsService.Responses.GetSelfRegistrationProfileResponse) })]
    public class GetOCIIdentitydomainsSelfRegistrationProfile : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetSelfRegistrationProfileRequest
                {
                ...
                response = client.GetSelfRegistrationProfile(request).GetAwaiter().GetResult();
        ...
        private GetSelfRegistrationProfileResponse response;
    }
}
