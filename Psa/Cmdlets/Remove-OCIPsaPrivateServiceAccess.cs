...
{
    [Cmdlet("Remove", "OCIPsaPrivateServiceAccess", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.PsaService.Responses.DeletePrivateServiceAccessResponse) })]
    public class RemoveOCIPsaPrivateServiceAccess : OCIPrivateServiceAccessCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIPsaPrivateServiceAccess", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeletePrivateServiceAccessRequest
                {
                ...
                response = client.DeletePrivateServiceAccess(request).GetAwaiter().GetResult();
        ...
        private DeletePrivateServiceAccessResponse response;
    }
}
