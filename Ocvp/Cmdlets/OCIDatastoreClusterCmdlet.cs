...
{
    public abstract class OCIDatastoreClusterCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DatastoreClusterClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DatastoreClusterClient client;
