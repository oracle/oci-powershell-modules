...
{
    public abstract class OCIVnMonitoringCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new VnMonitoringClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected VnMonitoringClient client;
