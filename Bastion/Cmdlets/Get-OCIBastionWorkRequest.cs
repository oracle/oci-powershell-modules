...
{
    [Cmdlet("Get", "OCIBastionWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.BastionService.Models.WorkRequest), typeof(Oci.BastionService.Responses.GetWorkRequestResponse) })]
    public class GetOCIBastionWorkRequest : OCIBastionCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique identifier (OCID) of the asynchronous request.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The unique identifier (OCID) of the asynchronous request.", ParameterSetName = Default)]
        ...
        public Oci.BastionService.Models.OperationStatus[] WaitForStatus { get; set; }
