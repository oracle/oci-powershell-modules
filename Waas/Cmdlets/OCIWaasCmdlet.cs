...
{
    public abstract class OCIWaasCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new WaasClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
