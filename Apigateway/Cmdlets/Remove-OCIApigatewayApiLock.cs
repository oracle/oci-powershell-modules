...
{
    [Cmdlet("Remove", "OCIApigatewayApiLock")]
    [OutputType(new System.Type[] { typeof(Oci.ApigatewayService.Models.Api), typeof(Oci.ApigatewayService.Responses.RemoveApiLockResponse) })]
    public class RemoveOCIApigatewayApiLock : OCIApiGatewayCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveApiLockRequest
                {
                    ApiId = ApiId,
                ...
                response = client.RemoveApiLock(request).GetAwaiter().GetResult();
        ...
        private RemoveApiLockResponse response;
    }
}
