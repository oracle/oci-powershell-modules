...
{
    [Cmdlet("Get", "OCIDisasterrecoveryWorkRequestLogsList")]
    [OutputType(new System.Type[] { typeof(Oci.DisasterrecoveryService.Models.WorkRequestLogEntryCollection), typeof(Oci.DisasterrecoveryService.Responses.ListWorkRequestLogsResponse) })]
    public class GetOCIDisasterrecoveryWorkRequestLogsList : OCIDisasterRecoveryCmdlet
    {
...
Example: `100`", ParameterSetName = LimitSet)]
        ...
        public System.Nullable<Oci.DisasterrecoveryService.Requests.ListWorkRequestLogsRequest.SortByEnum> SortBy { get; set; }
