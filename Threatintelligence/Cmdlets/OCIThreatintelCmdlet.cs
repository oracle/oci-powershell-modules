...
{
    public abstract class OCIThreatintelCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ThreatintelClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ThreatintelClient client;
