...
{
    [Cmdlet("Update", "OCIUsageapiUsageCarbonEmissionsQuery")]
    [OutputType(new System.Type[] { typeof(Oci.UsageapiService.Models.UsageCarbonEmissionsQuery), typeof(Oci.UsageapiService.Responses.UpdateUsageCarbonEmissionsQueryResponse) })]
    public class UpdateOCIUsageapiUsageCarbonEmissionsQuery : OCIUsageapiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateUsageCarbonEmissionsQueryRequest
                {
                ...
                response = client.UpdateUsageCarbonEmissionsQuery(request).GetAwaiter().GetResult();
        ...
        private UpdateUsageCarbonEmissionsQueryResponse response;
    }
}
