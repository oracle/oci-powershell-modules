...
{
    [Cmdlet("DisMount", "OCIComputeHostGroupHost", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.CoreService.Responses.DetachComputeHostGroupHostResponse) })]
    public class DisMountOCIComputeHostGroupHost : OCIComputeCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DetachComputeHostGroupHostRequest
                {
        ...
        private void HandleOutput(DetachComputeHostGroupHostRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDetachComputeHostGroupHost(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DetachComputeHostGroupHost(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DetachComputeHostGroupHostResponse response;
