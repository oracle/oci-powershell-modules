...
{
    [Cmdlet("Remove", "OCIDatabaseDbnodeSnapshot", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteDbnodeSnapshotResponse) })]
    public class RemoveOCIDatabaseDbnodeSnapshot : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseDbnodeSnapshot", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDbnodeSnapshotRequest
                {
        ...
        private void HandleOutput(DeleteDbnodeSnapshotRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteDbnodeSnapshot(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteDbnodeSnapshot(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteDbnodeSnapshotResponse response;
