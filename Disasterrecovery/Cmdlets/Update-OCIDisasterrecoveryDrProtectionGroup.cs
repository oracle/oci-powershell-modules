...
{
    [Cmdlet("Update", "OCIDisasterrecoveryDrProtectionGroup")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DisasterrecoveryService.Responses.UpdateDrProtectionGroupResponse) })]
    public class UpdateOCIDisasterrecoveryDrProtectionGroup : OCIDisasterRecoveryCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for updating the the DR protection group.")]
...
Example: `ocid1.drprotectiongroup.oc1..uniqueID`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateDrProtectionGroupRequest
                {
                ...
                response = client.UpdateDrProtectionGroup(request).GetAwaiter().GetResult();
        ...
        private UpdateDrProtectionGroupResponse response;
    }
}
