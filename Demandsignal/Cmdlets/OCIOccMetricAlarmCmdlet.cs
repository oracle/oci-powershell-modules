...
{
    public abstract class OCIOccMetricAlarmCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OccMetricAlarmClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OccMetricAlarmClient client;
