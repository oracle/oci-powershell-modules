...
{
    [Cmdlet("Update", "OCIPsqlBackup")]
    [OutputType(new System.Type[] { typeof(Oci.PsqlService.Models.Backup), typeof(Oci.PsqlService.Responses.UpdateBackupResponse) })]
    public class UpdateOCIPsqlBackup : OCIPostgresqlCmdlet
    {
