...
{
    [Cmdlet("Update", "OCIOdaTranslator")]
    [OutputType(new System.Type[] { typeof(Oci.OdaService.Models.Translator), typeof(Oci.OdaService.Responses.UpdateTranslatorResponse) })]
    public class UpdateOCIOdaTranslator : OCIManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Property values to update the Translator.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateTranslatorRequest
                {
                ...
                response = client.UpdateTranslator(request).GetAwaiter().GetResult();
        ...
        private UpdateTranslatorResponse response;
    }
}
