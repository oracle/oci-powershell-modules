...
{
    [Cmdlet("New", "OCIUsageapiSchedule")]
    [OutputType(new System.Type[] { typeof(Oci.UsageapiService.Models.Schedule), typeof(Oci.UsageapiService.Responses.CreateScheduleResponse) })]
    public class NewOCIUsageapiSchedule : OCIUsageapiCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"New schedule details.")]
