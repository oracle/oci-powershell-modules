...
{
    [Cmdlet("Get", "OCIUsageapiSchedulesList")]
    [OutputType(new System.Type[] { typeof(Oci.UsageapiService.Models.ScheduleCollection), typeof(Oci.UsageapiService.Responses.ListSchedulesResponse) })]
    public class GetOCIUsageapiSchedulesList : OCIUsageapiCmdlet
    {
        ...
        public System.Nullable<Oci.UsageapiService.Requests.ListSchedulesRequest.SortByEnum> SortBy { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The sort order to use, whether 'asc' or 'desc'.")]
        public System.Nullable<Oci.UsageapiService.Requests.ListSchedulesRequest.SortOrderEnum> SortOrder { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The query parameter for filtering by name.")]
