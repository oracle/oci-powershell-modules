...
{
    [Cmdlet("Get", "OCIIdentitydomainsPoliciesList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Policies), typeof(Oci.IdentitydomainsService.Responses.ListPoliciesResponse) })]
    public class GetOCIIdentitydomainsPoliciesList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.ListPolicies(request).GetAwaiter().GetResult();
