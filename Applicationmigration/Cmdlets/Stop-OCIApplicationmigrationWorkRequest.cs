...
{
    [Cmdlet("Stop", "OCIApplicationmigrationWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.ApplicationmigrationService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIApplicationmigrationWorkRequest : OCIApplicationMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIApplicationmigrationWorkRequest", "Stop"))
            {
               return;
            }
