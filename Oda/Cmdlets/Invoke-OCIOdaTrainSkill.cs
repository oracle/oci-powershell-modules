...
{
    [Cmdlet("Invoke", "OCIOdaTrainSkill")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OdaService.Responses.TrainSkillResponse) })]
    public class InvokeOCIOdaTrainSkill : OCIManagementCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Metadata for training a skill.")]
...
Retry tokens expire after 24 hours, but they can become invalid before then if there are conflicting operations. For example, if an instance was deleted and purged from the system, then the service might reject a retry of the original creation request.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.TrainSkill(request).GetAwaiter().GetResult();
        ...
        private TrainSkillResponse response;
    }
}
