...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeAwrDatabaseMetrics")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.AwrDatabaseMetricCollection), typeof(Oci.OpsiService.Responses.SummarizeAwrDatabaseMetricsResponse) })]
    public class InvokeOCIOpsiSummarizeAwrDatabaseMetrics : OCIOperationsInsightsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The required multiple value query parameter to filter the entity name.")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The option to sort the AWR time series summary data.")]
        public System.Nullable<Oci.OpsiService.Requests.SummarizeAwrDatabaseMetricsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeAwrDatabaseMetricsRequest
                {
                    AwrHubId = AwrHubId,
                ...
                response = client.SummarizeAwrDatabaseMetrics(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AwrDatabaseMetricCollection);
        ...
        private SummarizeAwrDatabaseMetricsResponse response;
    }
}
