...
{
    [Cmdlet("Update", "OCIDatabaseAutonomousContainerDatabaseDataguardAssociation", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousContainerDatabaseDataguardAssociation), typeof(Oci.DatabaseService.Responses.UpdateAutonomousContainerDatabaseDataguardAssociationResponse) })]
    public class UpdateOCIDatabaseAutonomousContainerDatabaseDataguardAssociation : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateAutonomousContainerDatabaseDataguardAssociationRequest
                {
        ...
        private void HandleOutput(UpdateAutonomousContainerDatabaseDataguardAssociationRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForUpdateAutonomousContainerDatabaseDataguardAssociation(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.UpdateAutonomousContainerDatabaseDataguardAssociation(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousContainerDatabaseDataguardAssociation);
        }

        private UpdateAutonomousContainerDatabaseDataguardAssociationResponse response;
