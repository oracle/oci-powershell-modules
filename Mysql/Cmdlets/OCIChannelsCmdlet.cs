...
{
    public abstract class OCIChannelsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ChannelsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ChannelsClient client;
