...
{
    [Cmdlet("Remove", "OCINetworkloadbalancerBackendSet", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.NetworkloadbalancerService.Responses.DeleteBackendSetResponse) })]
    public class RemoveOCINetworkloadbalancerBackendSet : OCINetworkLoadBalancerCmdlet
    {
...
Example: `example_backend_set`")]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCINetworkloadbalancerBackendSet", "Remove"))
            {
               return;
            }
