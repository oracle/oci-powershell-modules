...
{
    [Cmdlet("Start", "OCIOdaInstance")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OdaService.Responses.StartOdaInstanceResponse) })]
    public class StartOCIOdaInstance : OCIOdaCmdlet
    {
...
Retry tokens expire after 24 hours, but they can become invalid before then if there are conflicting operations. For example, if an instance was deleted and purged from the system, then the service might reject a retry of the original creation request.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new StartOdaInstanceRequest
                {
                ...
                response = client.StartOdaInstance(request).GetAwaiter().GetResult();
        ...
        private StartOdaInstanceResponse response;
    }
}
