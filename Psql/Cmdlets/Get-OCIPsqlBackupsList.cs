...
namespace Oci.PsqlService.Cmdlets
{
    ...
    public class GetOCIPsqlBackupsList : OCIPostgresqlCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The start date for getting  backups. An RFC3339 formatted datetime string")]
        public System.Nullable<System.DateTime> TimeStarted { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The End date for getting  backups. An RFC3339 formatted datetime string.")]
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"unique Backup identifier")]
        public string BackupId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"unique DbSystem identifier")]
