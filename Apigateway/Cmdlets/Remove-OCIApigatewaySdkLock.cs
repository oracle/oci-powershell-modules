...
{
    [Cmdlet("Remove", "OCIApigatewaySdkLock")]
    [OutputType(new System.Type[] { typeof(Oci.ApigatewayService.Models.Sdk), typeof(Oci.ApigatewayService.Responses.RemoveSdkLockResponse) })]
    public class RemoveOCIApigatewaySdkLock : OCIApiGatewayCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveSdkLockRequest
                {
                    SdkId = SdkId,
                ...
                response = client.RemoveSdkLock(request).GetAwaiter().GetResult();
        ...
        private RemoveSdkLockResponse response;
    }
}
