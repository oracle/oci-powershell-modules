...
{
    [Cmdlet("Get", "OCIManagementagentWorkRequestErrorsList")]
    [OutputType(new System.Type[] { typeof(Oci.ManagementagentService.Models.WorkRequestError), typeof(Oci.ManagementagentService.Responses.ListWorkRequestErrorsResponse) })]
    public class GetOCIManagementagentWorkRequestErrorsList : OCIManagementAgentCmdlet
    {
        ...
        public System.Nullable<Oci.ManagementagentService.Requests.ListWorkRequestErrorsRequest.SortOrderEnum> SortOrder { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field to sort by. Only one sort order may")]
        public System.Nullable<Oci.ManagementagentService.Requests.ListWorkRequestErrorsRequest.SortByEnum> SortBy { get; set; }
