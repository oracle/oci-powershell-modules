...
using Oci.DataflowService;

namespace Oci.DataflowService.Cmdlets
{
    public abstract class OCIDataFlowCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DataFlowClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
