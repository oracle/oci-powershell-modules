...
{
    [Cmdlet("Remove", "OCIOpsiAwrHubSource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OpsiService.Responses.DeleteAwrHubSourceResponse) })]
    public class RemoveOCIOpsiAwrHubSource : OCIOperationsInsightsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOpsiAwrHubSource", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteAwrHubSourceRequest
                {
                ...
                response = client.DeleteAwrHubSource(request).GetAwaiter().GetResult();
        ...
        private DeleteAwrHubSourceResponse response;
    }
}
