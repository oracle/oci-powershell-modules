...
{
    [Cmdlet("New", "OCIDistributeddatabaseGsmCertificateSigningRequest")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.GenerateDistributedDatabaseGsmCertificateSigningRequestResponse) })]
    public class NewOCIDistributeddatabaseGsmCertificateSigningRequest : OCIDistributedDbServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GenerateDistributedDatabaseGsmCertificateSigningRequestRequest
                {
                ...
                response = client.GenerateDistributedDatabaseGsmCertificateSigningRequest(request).GetAwaiter().GetResult();
        ...
        private GenerateDistributedDatabaseGsmCertificateSigningRequestResponse response;
    }
}
