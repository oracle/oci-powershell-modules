...
{
    [Cmdlet("Move", "OCIDnsResolverCompartment")]
    ...
    public class MoveOCIDnsResolverCompartment : OCIDnsCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for moving a resolver, along with its protected default view and endpoints, into a different compartment.")]
