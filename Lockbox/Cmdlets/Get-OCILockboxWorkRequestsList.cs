...
{
    [Cmdlet("Get", "OCILockboxWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.LockboxService.Models.WorkRequestSummaryCollection), typeof(Oci.LockboxService.Responses.ListWorkRequestsResponse) })]
    public class GetOCILockboxWorkRequestsList : OCILockboxCmdlet
    {
        ...
        public System.Nullable<Oci.LockboxService.Models.OperationStatus> Status { get; set; }
        ...
        public System.Nullable<Oci.LockboxService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }
