...
{
    [Cmdlet("New", "OCIGenerativeaiHostedApplication")]
    [OutputType(new System.Type[] { typeof(Oci.GenerativeaiService.Models.HostedApplication), typeof(Oci.GenerativeaiService.Responses.CreateHostedApplicationResponse) })]
    public class NewOCIGenerativeaiHostedApplication : OCIGenerativeAiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateHostedApplicationRequest
                {
                ...
                response = client.CreateHostedApplication(request).GetAwaiter().GetResult();
        ...
        private CreateHostedApplicationResponse response;
    }
}
