...
{
    public abstract class OCIOracleDBAzureConnectorCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OracleDBAzureConnectorClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OracleDBAzureConnectorClient client;
