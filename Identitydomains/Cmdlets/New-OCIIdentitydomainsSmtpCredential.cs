...
{
    [Cmdlet("New", "OCIIdentitydomainsSmtpCredential")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SmtpCredential), typeof(Oci.IdentitydomainsService.Responses.CreateSmtpCredentialResponse) })]
    public class NewOCIIdentitydomainsSmtpCredential : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"SmtpCredential schema.
