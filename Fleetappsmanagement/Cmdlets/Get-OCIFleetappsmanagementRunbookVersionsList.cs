...
{
    [Cmdlet("Get", "OCIFleetappsmanagementRunbookVersionsList")]
    [OutputType(new System.Type[] { typeof(Oci.FleetappsmanagementService.Models.RunbookVersionCollection), typeof(Oci.FleetappsmanagementService.Responses.ListRunbookVersionsResponse) })]
    public class GetOCIFleetappsmanagementRunbookVersionsList : OCIFleetAppsManagementRunbooksCmdlet
    {
        ...
        public System.Nullable<Oci.FleetappsmanagementService.Models.RunbookVersion.LifecycleStateEnum> LifecycleState { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return runbook versions whose identifier matches the given identifier.")]
        ...
        public System.Nullable<Oci.FleetappsmanagementService.Models.SortBy> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListRunbookVersionsRequest
                {
                ...
                IEnumerable<ListRunbookVersionsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.RunbookVersionCollection, true);
                }
        ...
        {
            IEnumerable<ListRunbookVersionsResponse> DefaultRequest(ListRunbookVersionsRequest request) => Enumerable.Repeat(client.ListRunbookVersions(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListRunbookVersionsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListRunbookVersionsResponse response;
        private delegate IEnumerable<ListRunbookVersionsResponse> RequestDelegate(ListRunbookVersionsRequest request);
