...
using Oci.LimitsincreaseService;

namespace Oci.LimitsincreaseService.Cmdlets
{
    public abstract class OCILimitsIncreaseCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new LimitsIncreaseClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected LimitsIncreaseClient client;
