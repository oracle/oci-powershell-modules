...
{
    [Cmdlet("Add", "OCIEmailDomainLock")]
    [OutputType(new System.Type[] { typeof(Oci.EmailService.Models.EmailDomain), typeof(Oci.EmailService.Responses.AddEmailDomainLockResponse) })]
    public class AddOCIEmailDomainLock : OCIEmailCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new AddEmailDomainLockRequest
                {
                ...
                response = client.AddEmailDomainLock(request).GetAwaiter().GetResult();
        ...
        private AddEmailDomainLockResponse response;
    }
}
