...
{
    [Cmdlet("Invoke", "OCIOpsiSummarizeAddmDbFindings")]
    [OutputType(new System.Type[] { typeof(Oci.OpsiService.Models.AddmDbFindingAggregationCollection), typeof(Oci.OpsiService.Responses.SummarizeAddmDbFindingsResponse) })]
    public class InvokeOCIOpsiSummarizeAddmDbFindings : OCIOperationsInsightsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Field name for sorting the ADDM finding summary data")]
        public System.Nullable<Oci.OpsiService.Requests.SummarizeAddmDbFindingsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeAddmDbFindingsRequest
                {
                ...
                response = client.SummarizeAddmDbFindings(request).GetAwaiter().GetResult();
                WriteOutput(response, response.AddmDbFindingAggregationCollection);
        ...
        private SummarizeAddmDbFindingsResponse response;
    }
}
