...
{
    [Cmdlet("Remove", "OCIOsmanagementSoftwareSource", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.OsmanagementService.Responses.DeleteSoftwareSourceResponse) })]
    public class RemoveOCIOsmanagementSoftwareSource : OCIOsManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOsmanagementSoftwareSource", "Remove"))
            {
               return;
            }
