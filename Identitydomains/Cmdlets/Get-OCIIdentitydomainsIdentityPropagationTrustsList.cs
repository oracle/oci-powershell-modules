...
{
    [Cmdlet("Get", "OCIIdentitydomainsIdentityPropagationTrustsList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.IdentityPropagationTrusts), typeof(Oci.IdentitydomainsService.Responses.ListIdentityPropagationTrustsResponse) })]
    public class GetOCIIdentitydomainsIdentityPropagationTrustsList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListIdentityPropagationTrustsRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListIdentityPropagationTrusts(request).GetAwaiter().GetResult();
                WriteOutput(response, response.IdentityPropagationTrusts);
        ...
        private ListIdentityPropagationTrustsResponse response;
    }
}
