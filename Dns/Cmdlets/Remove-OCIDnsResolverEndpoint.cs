...
{
    [Cmdlet("Remove", "OCIDnsResolverEndpoint", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    ...
    public class RemoveOCIDnsResolverEndpoint : OCIDnsCmdlet
    {
        ...
        private void HandleOutput(DeleteResolverEndpointRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteResolverEndpoint(request, waiterConfig, WaitForStatus).Execute();
                    break;
