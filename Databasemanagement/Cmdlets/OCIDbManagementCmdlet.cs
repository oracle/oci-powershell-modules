...
{
    public abstract class OCIDbManagementCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DbManagementClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DbManagementClient client;
