...
{
    [Cmdlet("Update", "OCIWaasPolicyConfig")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdatePolicyConfigResponse) })]
    public class UpdateOCIWaasPolicyConfig : OCIWaasCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The new configuration to apply to a WAAS policy.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdatePolicyConfigRequest
                {
                ...
                response = client.UpdatePolicyConfig(request).GetAwaiter().GetResult();
        ...
        private UpdatePolicyConfigResponse response;
    }
}
