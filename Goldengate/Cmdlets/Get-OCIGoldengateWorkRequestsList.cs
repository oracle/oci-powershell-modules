...
namespace Oci.GoldengateService.Cmdlets
{
    ...
    public class GetOCIGoldengateWorkRequestsList : OCIGoldenGateCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.oracle.com/Content/General/Concepts/identifiers.htm) of the resource in which to list resources.")]
