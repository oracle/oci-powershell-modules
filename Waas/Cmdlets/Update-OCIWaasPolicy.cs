...
{
    [Cmdlet("Update", "OCIWaasPolicy")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.WaasService.Responses.UpdateWaasPolicyResponse) })]
    public class UpdateOCIWaasPolicy : OCIWaasCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details of the WAAS policy to update.")]
        ...
        private UpdateWaasPolicyResponse response;
    }
}
