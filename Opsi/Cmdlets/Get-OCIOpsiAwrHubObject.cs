...
namespace Oci.OpsiService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIOpsiAwrHubObject", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.OpsiService.Responses.GetAwrHubObjectResponse) })]
    public class GetOCIOpsiAwrHubObject : OCIOperationsInsightsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetAwrHubObjectRequest
                {
                ...
                response = client.GetAwrHubObject(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetAwrHubObjectResponse response;
