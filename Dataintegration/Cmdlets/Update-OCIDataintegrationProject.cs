...
{
    [Cmdlet("Update", "OCIDataintegrationProject")]
    [OutputType(new System.Type[] { typeof(Oci.DataintegrationService.Models.Project), typeof(Oci.DataintegrationService.Responses.UpdateProjectResponse) })]
    public class UpdateOCIDataintegrationProject : OCIDataIntegrationCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details needed to update a project.")]
