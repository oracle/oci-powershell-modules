...
{
    [Cmdlet("Move", "OCIDistributeddatabaseCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.ChangeDistributedDatabaseCompartmentResponse) })]
    public class MoveOCIDistributeddatabaseCompartment : OCIDistributedDbServiceCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to move the Globally distributed database to a different compartment.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeDistributedDatabaseCompartmentRequest
                {
                ...
                response = client.ChangeDistributedDatabaseCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeDistributedDatabaseCompartmentResponse response;
    }
}
