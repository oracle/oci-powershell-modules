...
{
    [Cmdlet("Update", "OCIAilanguageProject")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.AilanguageService.Responses.UpdateProjectResponse) })]
    public class UpdateOCIAilanguageProject : OCIAIServiceLanguageCmdlet
    {
