...
using Oci.SchService;

namespace Oci.SchService.Cmdlets
{
    public abstract class OCIConnectorPluginsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ConnectorPluginsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ConnectorPluginsClient client;
