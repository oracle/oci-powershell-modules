...
namespace Oci.GenerativeaidataService.Cmdlets
{
    ...
    public class NewOCIGenerativeaidataEnrichmentJob : OCIGenerateEnrichmentJobCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GenerateEnrichmentJobRequest
                {
                ...
                response = client.GenerateEnrichmentJob(request).GetAwaiter().GetResult();
        ...
        private GenerateEnrichmentJobResponse response;
    }
}
