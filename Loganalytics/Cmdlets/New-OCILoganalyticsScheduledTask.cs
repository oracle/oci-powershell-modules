...
{
    [Cmdlet("New", "OCILoganalyticsScheduledTask")]
    ...
    public class NewOCILoganalyticsScheduledTask : OCILogAnalyticsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateScheduledTaskRequest
                {
                ...
                response = client.CreateScheduledTask(request).GetAwaiter().GetResult();
        ...
        private CreateScheduledTaskResponse response;
    }
}
