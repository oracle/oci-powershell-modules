...
{
    [Cmdlet("Remove", "OCICloudbridgeDiscoverySchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.CloudbridgeService.Responses.DeleteDiscoveryScheduleResponse) })]
    public class RemoveOCICloudbridgeDiscoverySchedule : OCIDiscoveryCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCICloudbridgeDiscoverySchedule", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteDiscoveryScheduleRequest
                {
                ...
                response = client.DeleteDiscoverySchedule(request).GetAwaiter().GetResult();
        ...
        private DeleteDiscoveryScheduleResponse response;
    }
}
