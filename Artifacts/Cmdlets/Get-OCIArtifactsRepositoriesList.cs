...
{
    [Cmdlet("Get", "OCIArtifactsRepositoriesList")]
    [OutputType(new System.Type[] { typeof(Oci.ArtifactsService.Models.RepositoryCollection), typeof(Oci.ArtifactsService.Responses.ListRepositoriesResponse) })]
    public class GetOCIArtifactsRepositoriesList : OCIArtifactsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return resources that match the isImmutable value.")]
...
**Note:** In general, some ""List"" operations (for example, `ListInstances`) let you optionally filter by availability domain if the scope of the resource type is within a single availability domain. If you call one of these ""List"" operations without specifying an availability domain, the resources are grouped by availability domain, then sorted.")]
        public System.Nullable<Oci.ArtifactsService.Requests.ListRepositoriesRequest.SortByEnum> SortBy { get; set; }
        ...
        public System.Nullable<Oci.ArtifactsService.Requests.ListRepositoriesRequest.SortOrderEnum> SortOrder { get; set; }
