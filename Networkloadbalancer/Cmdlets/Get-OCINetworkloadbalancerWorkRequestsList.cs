...
{
    [Cmdlet("Get", "OCINetworkloadbalancerWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.NetworkloadbalancerService.Models.WorkRequestCollection), typeof(Oci.NetworkloadbalancerService.Responses.ListWorkRequestsResponse) })]
    public class GetOCINetworkloadbalancerWorkRequestsList : OCINetworkLoadBalancerCmdlet
    {
