...
{
    [Cmdlet("Invoke", "OCIAdmDeactivateRemediationRecipe")]
    ...
    public class InvokeOCIAdmDeactivateRemediationRecipe : OCIApplicationDependencyManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DeactivateRemediationRecipeRequest
                {
                ...
                response = client.DeactivateRemediationRecipe(request).GetAwaiter().GetResult();
        ...
        private DeactivateRemediationRecipeResponse response;
    }
}
