...
{
    [Cmdlet("Remove", "OCIDevopsConnection", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DevopsService.Responses.DeleteConnectionResponse) })]
    public class RemoveOCIDevopsConnection : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDevopsConnection", "Remove"))
            {
               return;
            }
