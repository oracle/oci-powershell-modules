...
{
    public abstract class OCIServiceMeshCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ServiceMeshClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ServiceMeshClient client;
