...
{
    public abstract class OCIDatabaseMigrationCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new DatabaseMigrationClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected DatabaseMigrationClient client;
