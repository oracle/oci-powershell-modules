...
{
    [Cmdlet("New", "OCIDatasciencePrivateEndpoint")]
    [OutputType(new System.Type[] { typeof(Oci.DatascienceService.Models.DataSciencePrivateEndpoint), typeof(Oci.DatascienceService.Responses.CreateDataSciencePrivateEndpointResponse) })]
    public class NewOCIDatasciencePrivateEndpoint : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreateDataSciencePrivateEndpointRequest
                {
                ...
                response = client.CreateDataSciencePrivateEndpoint(request).GetAwaiter().GetResult();
        ...
        private CreateDataSciencePrivateEndpointResponse response;
    }
}
