...
{
    [Cmdlet("New", "OCIDnsSteeringPolicyAttachment")]
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for creating a new steering policy attachment.")]
