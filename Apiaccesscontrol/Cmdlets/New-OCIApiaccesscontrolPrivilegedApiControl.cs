...
{
    [Cmdlet("New", "OCIApiaccesscontrolPrivilegedApiControl")]
    [OutputType(new System.Type[] { typeof(Oci.ApiaccesscontrolService.Models.PrivilegedApiControl), typeof(Oci.ApiaccesscontrolService.Responses.CreatePrivilegedApiControlResponse) })]
    public class NewOCIApiaccesscontrolPrivilegedApiControl : OCIPrivilegedApiControlCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new PrivilegedApiControl.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new CreatePrivilegedApiControlRequest
                {
                ...
                response = client.CreatePrivilegedApiControl(request).GetAwaiter().GetResult();
        ...
        private CreatePrivilegedApiControlResponse response;
    }
}
