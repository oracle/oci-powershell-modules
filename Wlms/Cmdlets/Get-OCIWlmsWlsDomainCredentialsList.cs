...
{
    [Cmdlet("Get", "OCIWlmsWlsDomainCredentialsList")]
    ...
    public class GetOCIWlmsWlsDomainCredentialsList : OCIWeblogicManagementServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListWlsDomainCredentialsRequest
                {
                ...
                response = client.ListWlsDomainCredentials(request).GetAwaiter().GetResult();
                WriteOutput(response, response.WlsDomainCredentialCollection);
        ...
        private ListWlsDomainCredentialsResponse response;
    }
}
