...
{
    [Cmdlet("Get", "OCIOsmanagementhubWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.OsmanagementhubService.Models.WorkRequest), typeof(Oci.OsmanagementhubService.Responses.GetWorkRequestResponse) })]
    public class GetOCIOsmanagementhubWorkRequest : OCIWorkRequestCmdlet
    {
        ...
        public Oci.OsmanagementhubService.Models.OperationStatus[] WaitForStatus { get; set; }
