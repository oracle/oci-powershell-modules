...
using Oci.JmsutilsService;

namespace Oci.JmsutilsService.Cmdlets
{
    public abstract class OCIJmsUtilsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new JmsUtilsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected JmsUtilsClient client;
