...
{
    public abstract class OCIRoverNodeCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new RoverNodeClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected RoverNodeClient client;
