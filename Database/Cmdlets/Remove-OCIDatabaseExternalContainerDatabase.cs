...
{
    [Cmdlet("Remove", "OCIDatabaseExternalContainerDatabase", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.DeleteExternalContainerDatabaseResponse) })]
    public class RemoveOCIDatabaseExternalContainerDatabase : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatabaseExternalContainerDatabase", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteExternalContainerDatabaseRequest
                {
        ...
        private void HandleOutput(DeleteExternalContainerDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteExternalContainerDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.DeleteExternalContainerDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private DeleteExternalContainerDatabaseResponse response;
