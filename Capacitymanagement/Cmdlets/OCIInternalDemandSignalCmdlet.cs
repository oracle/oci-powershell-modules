...
{
    public abstract class OCIInternalDemandSignalCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new InternalDemandSignalClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected InternalDemandSignalClient client;
