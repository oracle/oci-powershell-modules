...
{
    [Cmdlet("Get", "OCIPsqlConfigurationsList")]
    [OutputType(new System.Type[] { typeof(Oci.PsqlService.Models.ConfigurationCollection), typeof(Oci.PsqlService.Responses.ListConfigurationsResponse) })]
    public class GetOCIPsqlConfigurationsList : OCIPostgresqlCmdlet
    {
        ...
        public System.Nullable<Oci.PsqlService.Requests.ListConfigurationsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    response = item;
                    WriteOutput(response, response.ConfigurationCollection, true);
                }
