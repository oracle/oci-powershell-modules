...
{
    [Cmdlet("Add", "OCIGoldengateDeploymentLock")]
    [OutputType(new System.Type[] { typeof(Oci.GoldengateService.Models.Deployment), typeof(Oci.GoldengateService.Responses.AddDeploymentLockResponse) })]
    public class AddOCIGoldengateDeploymentLock : OCIGoldenGateCmdlet
    {
