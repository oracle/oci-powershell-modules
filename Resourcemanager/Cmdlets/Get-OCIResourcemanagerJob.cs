...
{
    [Cmdlet("Get", "OCIResourcemanagerJob", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.ResourcemanagerService.Models.Job), typeof(Oci.ResourcemanagerService.Responses.GetJobResponse) })]
    public class GetOCIResourcemanagerJob : OCIResourceManagerCmdlet
    {
        ...
        public Oci.ResourcemanagerService.Models.Job.LifecycleStateEnum[] WaitForLifecycleState { get; set; }
