...
{
    [Cmdlet("Get", "OCIServicemeshWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.ServicemeshService.Models.WorkRequestCollection), typeof(Oci.ServicemeshService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIServicemeshWorkRequestsList : OCIServiceMeshCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return work requests that match the given resourceId.")]
        public string ResourceId { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"A filter to return only resources that match the operation status given.")]
        public System.Nullable<Oci.ServicemeshService.Models.OperationStatus> OperationStatus { get; set; }
        ...
        public System.Nullable<Oci.ServicemeshService.Requests.ListWorkRequestsRequest.SortByEnum> SortBy { get; set; }
