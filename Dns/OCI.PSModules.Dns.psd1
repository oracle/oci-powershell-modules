...
GUID = 'd9e16898-206b-4c79-8c25-cfa141901675'
...
CmdletsToExport = 'Get-OCIDnsDomainRecords', 'Get-OCIDnsRRSet', 
               ...
               'Get-OCIDnsTsigKeysList', 'Get-OCIDnsZone', 'Get-OCIDnsZoneRecords', 
               'Get-OCIDnsZonesList', 'Invoke-OCIDnsPatchDomainRecords', 
               'Invoke-OCIDnsPatchRRSet', 'Invoke-OCIDnsPatchZoneRecords', 
               'Move-OCIDnsSteeringPolicyCompartment', 
               'Move-OCIDnsTsigKeyCompartment', 'Move-OCIDnsZoneCompartment', 
               'New-OCIDnsSteeringPolicy', 'New-OCIDnsSteeringPolicyAttachment', 
               'New-OCIDnsTsigKey', 'New-OCIDnsZone', 'Remove-OCIDnsDomainRecords', 
               'Remove-OCIDnsRRSet', 'Remove-OCIDnsSteeringPolicy', 
               'Remove-OCIDnsSteeringPolicyAttachment', 'Remove-OCIDnsTsigKey', 
               'Remove-OCIDnsZone', 'Update-OCIDnsDomainRecords', 
               'Update-OCIDnsRRSet', 'Update-OCIDnsSteeringPolicy', 
               'Update-OCIDnsSteeringPolicyAttachment', 'Update-OCIDnsTsigKey', 
               'Update-OCIDnsZone', 'Update-OCIDnsZoneRecords'
