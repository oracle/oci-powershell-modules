...
{
    [Cmdlet("Move", "OCILoggingUnifiedAgentConfigurationCompartment")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.LoggingService.Responses.ChangeUnifiedAgentConfigurationCompartmentResponse) })]
    public class MoveOCILoggingUnifiedAgentConfigurationCompartment : OCILoggingManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeUnifiedAgentConfigurationCompartmentRequest
                {
                ...
                response = client.ChangeUnifiedAgentConfigurationCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeUnifiedAgentConfigurationCompartmentResponse response;
    }
}
