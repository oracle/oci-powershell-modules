...
{
    [Cmdlet("Enable", "OCIAdmRemediationRecipe")]
    ...
    public class EnableOCIAdmRemediationRecipe : OCIApplicationDependencyManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ActivateRemediationRecipeRequest
                {
                ...
                response = client.ActivateRemediationRecipe(request).GetAwaiter().GetResult();
        ...
        private ActivateRemediationRecipeResponse response;
    }
}
