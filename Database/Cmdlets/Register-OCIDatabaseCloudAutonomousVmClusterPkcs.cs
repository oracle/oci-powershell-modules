...
{
    [Cmdlet("Register", "OCIDatabaseCloudAutonomousVmClusterPkcs", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.RegisterCloudAutonomousVmClusterPkcsResponse) })]
    public class RegisterOCIDatabaseCloudAutonomousVmClusterPkcs : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details of registering PKCS11 driver.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details of registering PKCS11 driver.", ParameterSetName = Default)]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RegisterCloudAutonomousVmClusterPkcsRequest
                {
        ...
        private void HandleOutput(RegisterCloudAutonomousVmClusterPkcsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRegisterCloudAutonomousVmClusterPkcs(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RegisterCloudAutonomousVmClusterPkcs(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private RegisterCloudAutonomousVmClusterPkcsResponse response;
