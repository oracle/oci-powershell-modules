...
{
    [Cmdlet("Get", "OCIIdentitydomainsUser")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.User), typeof(Oci.IdentitydomainsService.Responses.GetUserResponse) })]
    public class GetOCIIdentitydomainsUser : OCIIdentityDomainsCmdlet
    {
