...
{
    [Cmdlet("Remove", "OCIDevopsProtectedBranch")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DevopsService.Responses.DeleteProtectedBranchResponse) })]
    public class RemoveOCIDevopsProtectedBranch : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DeleteProtectedBranchRequest
                {
                ...
                response = client.DeleteProtectedBranch(request).GetAwaiter().GetResult();
        ...
        private DeleteProtectedBranchResponse response;
    }
}
