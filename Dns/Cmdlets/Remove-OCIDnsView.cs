...
{
    [Cmdlet("Remove", "OCIDnsView", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High, DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DnsService.Responses.DeleteViewResponse) })]
    public class RemoveOCIDnsView : OCIDnsCmdlet
    {
        ...
        private void HandleOutput(DeleteViewRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForDeleteView(request, waiterConfig, WaitForStatus).Execute();
                    break;
        ...
        private DeleteViewResponse response;
