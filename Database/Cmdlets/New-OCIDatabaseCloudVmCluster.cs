...
namespace Oci.DatabaseService.Cmdlets
{
    ...
    public class NewOCIDatabaseCloudVmCluster : OCIDatabaseCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to create a cloud VM cluster.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request to create a cloud VM cluster.", ParameterSetName = Default)]
