...
{
    [Cmdlet("Get", "OCIIdentitydomainsOAuthPartnerCertificatesList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.OAuthPartnerCertificates), typeof(Oci.IdentitydomainsService.Responses.ListOAuthPartnerCertificatesResponse) })]
    public class GetOCIIdentitydomainsOAuthPartnerCertificatesList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListOAuthPartnerCertificatesRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListOAuthPartnerCertificates(request).GetAwaiter().GetResult();
        ...
        private ListOAuthPartnerCertificatesResponse response;
    }
}
