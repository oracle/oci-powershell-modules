...
namespace Oci.GoldengateService.Cmdlets
{
    ...
    public class UpdateOCIGoldengateConnection : OCIGoldenGateCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The new Connection specifications to apply. This parameter also accepts subtypes <Oci.GoldengateService.Models.UpdateOracleConnectionDetails>, <Oci.GoldengateService.Models.UpdateOciObjectStorageConnectionDetails>, <Oci.GoldengateService.Models.UpdateMysqlConnectionDetails>, <Oci.GoldengateService.Models.UpdateKafkaConnectionDetails>, <Oci.GoldengateService.Models.UpdateGoldenGateConnectionDetails> of type <Oci.GoldengateService.Models.UpdateConnectionDetails>.")]
