...
using Oci.ManagementagentService;

namespace Oci.ManagementagentService.Cmdlets
{
    public abstract class OCIManagementAgentCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new ManagementAgentClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected ManagementAgentClient client;
