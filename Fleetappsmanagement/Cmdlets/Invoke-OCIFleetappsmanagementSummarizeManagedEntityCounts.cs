...
{
    [Cmdlet("Invoke", "OCIFleetappsmanagementSummarizeManagedEntityCounts")]
    [OutputType(new System.Type[] { typeof(Oci.FleetappsmanagementService.Models.ManagedEntityAggregationCollection), typeof(Oci.FleetappsmanagementService.Responses.SummarizeManagedEntityCountsResponse) })]
    public class InvokeOCIFleetappsmanagementSummarizeManagedEntityCounts : OCIFleetAppsManagementOperationsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SummarizeManagedEntityCountsRequest
                {
                ...
                response = client.SummarizeManagedEntityCounts(request).GetAwaiter().GetResult();
                WriteOutput(response, response.ManagedEntityAggregationCollection);
        ...
        private SummarizeManagedEntityCountsResponse response;
    }
}
