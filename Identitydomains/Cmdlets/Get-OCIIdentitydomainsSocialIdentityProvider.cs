...
{
    [Cmdlet("Get", "OCIIdentitydomainsSocialIdentityProvider")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.SocialIdentityProvider), typeof(Oci.IdentitydomainsService.Responses.GetSocialIdentityProviderResponse) })]
    public class GetOCIIdentitydomainsSocialIdentityProvider : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetSocialIdentityProviderRequest
                {
                ...
                response = client.GetSocialIdentityProvider(request).GetAwaiter().GetResult();
        ...
        private GetSocialIdentityProviderResponse response;
    }
}
