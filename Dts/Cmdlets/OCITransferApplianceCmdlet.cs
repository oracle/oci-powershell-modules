...
{
    public abstract class OCITransferApplianceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new TransferApplianceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected TransferApplianceClient client;
