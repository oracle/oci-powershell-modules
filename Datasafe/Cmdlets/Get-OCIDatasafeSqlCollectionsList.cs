...
{
    [Cmdlet("Get", "OCIDatasafeSqlCollectionsList")]
    [OutputType(new System.Type[] { typeof(Oci.DatasafeService.Models.SqlCollectionCollection), typeof(Oci.DatasafeService.Responses.ListSqlCollectionsResponse) })]
    public class GetOCIDatasafeSqlCollectionsList : OCIDataSafeCmdlet
    {
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSqlCollectionsRequest.AccessLevelEnum> AccessLevel { get; set; }
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"An optional filter to return only resources that match the specified OCID of the SQL collection resource.")]
...
**Example:** 2016-12-19T16:39:57.600Z")]
        ...
        public System.Nullable<Oci.DatasafeService.Requests.ListSqlCollectionsRequest.SortOrderEnum> SortOrder { get; set; }

        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The field used for sorting. Only one sorting parameter order (sortOrder) can be specified. The DISPLAYNAME sort order is case sensitive.")]
        public System.Nullable<Oci.DatasafeService.Requests.ListSqlCollectionsRequest.SortByEnum> SortBy { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListSqlCollectionsRequest
                {
                ...
                IEnumerable<ListSqlCollectionsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.SqlCollectionCollection, true);
                }
        ...
        {
            IEnumerable<ListSqlCollectionsResponse> DefaultRequest(ListSqlCollectionsRequest request) => Enumerable.Repeat(client.ListSqlCollections(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListSqlCollectionsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListSqlCollectionsResponse response;
        private delegate IEnumerable<ListSqlCollectionsResponse> RequestDelegate(ListSqlCollectionsRequest request);
