...
{
    [Cmdlet("Invoke", "OCIDistributeddatabaseConfigureDistributedDatabaseSharding")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DistributeddatabaseService.Responses.ConfigureDistributedDatabaseShardingResponse) })]
    public class InvokeOCIDistributeddatabaseConfigureDistributedDatabaseSharding : OCIDistributedDbServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ConfigureDistributedDatabaseShardingRequest
                {
                ...
                response = client.ConfigureDistributedDatabaseSharding(request).GetAwaiter().GetResult();
        ...
        private ConfigureDistributedDatabaseShardingResponse response;
    }
}
