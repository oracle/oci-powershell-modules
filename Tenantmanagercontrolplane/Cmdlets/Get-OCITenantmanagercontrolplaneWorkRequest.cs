...
{
    [Cmdlet("Get", "OCITenantmanagercontrolplaneWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.TenantmanagercontrolplaneService.Models.WorkRequest), typeof(Oci.TenantmanagercontrolplaneService.Responses.GetWorkRequestResponse) })]
    public class GetOCITenantmanagercontrolplaneWorkRequest : OCIWorkRequestCmdlet
    {
        ...
        public Oci.TenantmanagercontrolplaneService.Models.OperationStatus[] WaitForStatus { get; set; }
