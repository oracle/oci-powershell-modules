...
using Oci.VbsinstService;

namespace Oci.VbsinstService.Cmdlets
{
    public abstract class OCIVbsInstanceCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new VbsInstanceClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected VbsInstanceClient client;
