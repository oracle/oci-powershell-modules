...
{
    [Cmdlet("Remove", "OCIDataintegrationApplicationDetailedDescription", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataintegrationService.Responses.DeleteApplicationDetailedDescriptionResponse) })]
    public class RemoveOCIDataintegrationApplicationDetailedDescription : OCIDataIntegrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDataintegrationApplicationDetailedDescription", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteApplicationDetailedDescriptionRequest
                {
                ...
                response = client.DeleteApplicationDetailedDescription(request).GetAwaiter().GetResult();
        ...
        private DeleteApplicationDetailedDescriptionResponse response;
    }
}
