...
{
    [Cmdlet("Remove", "OCIOsmanagementhubModuleStreamProfileFromManagedInstanceGroup")]
    ...
    public class RemoveOCIOsmanagementhubModuleStreamProfileFromManagedInstanceGroup : OCIManagedInstanceGroupCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for profiles to remove from the managed instance group.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RemoveModuleStreamProfileFromManagedInstanceGroupRequest
                {
                ...
                response = client.RemoveModuleStreamProfileFromManagedInstanceGroup(request).GetAwaiter().GetResult();
        ...
        private RemoveModuleStreamProfileFromManagedInstanceGroupResponse response;
    }
}
