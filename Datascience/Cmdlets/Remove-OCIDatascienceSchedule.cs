...
{
    [Cmdlet("Remove", "OCIDatascienceSchedule", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatascienceService.Responses.DeleteScheduleResponse) })]
    public class RemoveOCIDatascienceSchedule : OCIDataScienceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatascienceSchedule", "Remove"))
            {
               return;
            }
