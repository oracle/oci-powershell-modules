...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchCloudGateServers")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.CloudGateServers), typeof(Oci.IdentitydomainsService.Responses.SearchCloudGateServersResponse) })]
    public class InvokeOCIIdentitydomainsSearchCloudGateServers : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching CloudGateServers")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchCloudGateServersRequest
                {
                ...
                response = client.SearchCloudGateServers(request).GetAwaiter().GetResult();
                WriteOutput(response, response.CloudGateServers);
        ...
        private SearchCloudGateServersResponse response;
    }
}
