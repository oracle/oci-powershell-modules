...
{
    [Cmdlet("Update", "OCIApmsyntheticsWorker")]
    [OutputType(new System.Type[] { typeof(Oci.ApmsyntheticsService.Models.Worker), typeof(Oci.ApmsyntheticsService.Responses.UpdateWorkerResponse) })]
    public class UpdateOCIApmsyntheticsWorker : OCIApmSyntheticCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.UpdateWorker(request).GetAwaiter().GetResult();
        ...
        private UpdateWorkerResponse response;
    }
}
