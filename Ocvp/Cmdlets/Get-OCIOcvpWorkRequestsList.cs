...
{
    [Cmdlet("Get", "OCIOcvpWorkRequestsList")]
    [OutputType(new System.Type[] { typeof(Oci.OcvpService.Models.WorkRequestCollection), typeof(Oci.OcvpService.Responses.ListWorkRequestsResponse) })]
    public class GetOCIOcvpWorkRequestsList : OCIWorkRequestCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the resource.")]
