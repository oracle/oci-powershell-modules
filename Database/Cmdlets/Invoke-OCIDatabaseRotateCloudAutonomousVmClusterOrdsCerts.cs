...
{
    [Cmdlet("Invoke", "OCIDatabaseRotateCloudAutonomousVmClusterOrdsCerts", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DatabaseService.Responses.RotateCloudAutonomousVmClusterOrdsCertsResponse) })]
    public class InvokeOCIDatabaseRotateCloudAutonomousVmClusterOrdsCerts : OCIDatabaseCmdlet
    {
        ...
        private void HandleOutput(RotateCloudAutonomousVmClusterOrdsCertsRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForRotateCloudAutonomousVmClusterOrdsCerts(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.RotateCloudAutonomousVmClusterOrdsCerts(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, CreateWorkRequestObject(response.OpcWorkRequestId));
        }

        private RotateCloudAutonomousVmClusterOrdsCertsResponse response;
