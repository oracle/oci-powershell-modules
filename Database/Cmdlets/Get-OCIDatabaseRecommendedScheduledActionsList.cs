...
{
    [Cmdlet("Get", "OCIDatabaseRecommendedScheduledActionsList")]
    ...
    public class GetOCIDatabaseRecommendedScheduledActionsList : OCIDatabaseCmdlet
    {
        ...
        public System.Nullable<Oci.DatabaseService.Requests.ListRecommendedScheduledActionsRequest.PlanIntentEnum> PlanIntent { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListRecommendedScheduledActionsRequest
                {
                ...
                IEnumerable<ListRecommendedScheduledActionsResponse> responses = GetRequestDelegate().Invoke(request);
                foreach (var item in responses)
                {
                    response = item;
                    WriteOutput(response, response.RecommendedScheduledActionsCollection, true);
                }
        ...
        {
            IEnumerable<ListRecommendedScheduledActionsResponse> DefaultRequest(ListRecommendedScheduledActionsRequest request) => Enumerable.Repeat(client.ListRecommendedScheduledActions(request).GetAwaiter().GetResult(), 1);
            if (ParameterSetName.Equals(AllPageSet))
            {
                return req => client.Paginators.ListRecommendedScheduledActionsResponseEnumerator(req);
            }
            return DefaultRequest;
        }

        private ListRecommendedScheduledActionsResponse response;
        private delegate IEnumerable<ListRecommendedScheduledActionsResponse> RequestDelegate(ListRecommendedScheduledActionsRequest request);
