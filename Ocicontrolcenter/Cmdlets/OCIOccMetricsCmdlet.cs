...
using Oci.OcicontrolcenterService;

namespace Oci.OcicontrolcenterService.Cmdlets
{
    public abstract class OCIOccMetricsCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OccMetricsClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OccMetricsClient client;
