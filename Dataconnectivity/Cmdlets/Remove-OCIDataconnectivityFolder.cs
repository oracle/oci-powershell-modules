...
{
    [Cmdlet("Remove", "OCIDataconnectivityFolder", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DataconnectivityService.Responses.DeleteFolderResponse) })]
    public class RemoveOCIDataconnectivityFolder : OCIDataConnectivityManagementCmdlet
    {
