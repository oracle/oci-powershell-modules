...
{
    [Cmdlet("Stop", "OCIDesktopsWorkRequest", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DesktopsService.Responses.CancelWorkRequestResponse) })]
    public class StopOCIDesktopsWorkRequest : OCIDesktopServiceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDesktopsWorkRequest", "Stop"))
            {
               return;
            }
