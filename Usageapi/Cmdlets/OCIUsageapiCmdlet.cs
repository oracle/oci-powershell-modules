...
{
    public abstract class OCIUsageapiCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new UsageapiClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected UsageapiClient client;
