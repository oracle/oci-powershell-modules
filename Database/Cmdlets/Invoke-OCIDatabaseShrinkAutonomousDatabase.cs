...
{
    [Cmdlet("Invoke", "OCIDatabaseShrinkAutonomousDatabase", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DatabaseService.Models.AutonomousDatabase), typeof(Oci.DatabaseService.Responses.ShrinkAutonomousDatabaseResponse) })]
    public class InvokeOCIDatabaseShrinkAutonomousDatabase : OCIDatabaseCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ShrinkAutonomousDatabaseRequest
                {
        ...
        private void HandleOutput(ShrinkAutonomousDatabaseRequest request)
        {
            ...
            { 
                case StatusParamSet:
                    response = client.Waiters.ForShrinkAutonomousDatabase(request, waiterConfig, WaitForStatus).Execute();
                    break;

                case Default:
                    response = client.ShrinkAutonomousDatabase(request).GetAwaiter().GetResult();
                    break;
            }
            WriteOutput(response, response.AutonomousDatabase);
        }

        private ShrinkAutonomousDatabaseResponse response;
