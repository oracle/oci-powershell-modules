...
{
    public abstract class OCISenderInvitationCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new SenderInvitationClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected SenderInvitationClient client;
