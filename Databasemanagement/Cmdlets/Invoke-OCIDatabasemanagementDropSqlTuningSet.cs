...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementDropSqlTuningSet")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.SqlTuningSetAdminActionStatus), typeof(Oci.DatabasemanagementService.Responses.DropSqlTuningSetResponse) })]
    public class InvokeOCIDatabasemanagementDropSqlTuningSet : OCISqlTuningCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details required to drop a Sql tuning set.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DropSqlTuningSetRequest
                {
                ...
                response = client.DropSqlTuningSet(request).GetAwaiter().GetResult();
        ...
        private DropSqlTuningSetResponse response;
    }
}
