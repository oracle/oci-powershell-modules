...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchOAuthClientCertificates")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.OAuthClientCertificates), typeof(Oci.IdentitydomainsService.Responses.SearchOAuthClientCertificatesResponse) })]
    public class InvokeOCIIdentitydomainsSearchOAuthClientCertificates : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching OAuthClientCertificates")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SearchOAuthClientCertificatesRequest
                {
                ...
                response = client.SearchOAuthClientCertificates(request).GetAwaiter().GetResult();
                WriteOutput(response, response.OAuthClientCertificates);
        ...
        private SearchOAuthClientCertificatesResponse response;
    }
}
