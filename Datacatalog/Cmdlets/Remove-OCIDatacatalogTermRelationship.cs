...
{
    [Cmdlet("Remove", "OCIDatacatalogTermRelationship", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatacatalogService.Responses.DeleteTermRelationshipResponse) })]
    public class RemoveOCIDatacatalogTermRelationship : OCIDataCatalogCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDatacatalogTermRelationship", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteTermRelationshipRequest
                {
                    CatalogId = CatalogId,
                ...
                response = client.DeleteTermRelationship(request).GetAwaiter().GetResult();
        ...
        private DeleteTermRelationshipResponse response;
    }
}
