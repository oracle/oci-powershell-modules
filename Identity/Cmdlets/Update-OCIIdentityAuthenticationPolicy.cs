...
{
    [Cmdlet("Update", "OCIIdentityAuthenticationPolicy")]
    [OutputType(new System.Type[] { typeof(Oci.IdentityService.Models.AuthenticationPolicy), typeof(Oci.IdentityService.Responses.UpdateAuthenticationPolicyResponse) })]
    public class UpdateOCIIdentityAuthenticationPolicy : OCIIdentityCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The OCID of the compartment.")]
        public string CompartmentId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Request object for updating the authentication policy.")]
        ...
        private UpdateAuthenticationPolicyResponse response;
    }
}
