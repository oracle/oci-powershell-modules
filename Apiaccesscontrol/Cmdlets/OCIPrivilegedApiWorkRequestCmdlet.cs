...
using Oci.ApiaccesscontrolService;

namespace Oci.ApiaccesscontrolService.Cmdlets
{
    public abstract class OCIPrivilegedApiWorkRequestCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new PrivilegedApiWorkRequestClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected PrivilegedApiWorkRequestClient client;
