...
namespace Oci.JmsjavadownloadsService.Cmdlets
{
     ...
     */
    [Cmdlet("Get", "OCIJmsjavadownloadsJavaDownloadReportContent", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.JmsjavadownloadsService.Responses.GetJavaDownloadReportContentResponse) })]
    public class GetOCIJmsjavadownloadsJavaDownloadReportContent : OCIJavaDownloadCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetJavaDownloadReportContentRequest
                {
                    JavaDownloadReportId = JavaDownloadReportId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetJavaDownloadReportContent(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private GetJavaDownloadReportContentResponse response;
