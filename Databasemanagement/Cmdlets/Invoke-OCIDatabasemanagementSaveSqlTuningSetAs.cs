...
{
    [Cmdlet("Invoke", "OCIDatabasemanagementSaveSqlTuningSetAs")]
    [OutputType(new System.Type[] { typeof(Oci.DatabasemanagementService.Models.SqlTuningSetAdminActionStatus), typeof(Oci.DatabasemanagementService.Responses.SaveSqlTuningSetAsResponse) })]
    public class InvokeOCIDatabasemanagementSaveSqlTuningSetAs : OCISqlTuningCmdlet
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The details required to save a Sql tuning set into another Sql tuning set.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new SaveSqlTuningSetAsRequest
                {
                ...
                response = client.SaveSqlTuningSetAs(request).GetAwaiter().GetResult();
        ...
        private SaveSqlTuningSetAsResponse response;
    }
}
