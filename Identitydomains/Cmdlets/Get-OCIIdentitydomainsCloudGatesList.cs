...
{
    [Cmdlet("Get", "OCIIdentitydomainsCloudGatesList")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.CloudGates), typeof(Oci.IdentitydomainsService.Responses.ListCloudGatesResponse) })]
    public class GetOCIIdentitydomainsCloudGatesList : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ListCloudGatesRequest
                {
                    Filter = Filter,
                    SortBy = SortBy,
                    SortOrder = SortOrder,
                ...
                response = client.ListCloudGates(request).GetAwaiter().GetResult();
        ...
        private ListCloudGatesResponse response;
    }
}
