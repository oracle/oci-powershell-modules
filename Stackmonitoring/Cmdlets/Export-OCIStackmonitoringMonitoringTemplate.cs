...
namespace Oci.StackmonitoringService.Cmdlets
{
     ...
     */
    [Cmdlet("Export", "OCIStackmonitoringMonitoringTemplate", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.StackmonitoringService.Responses.ExportMonitoringTemplateResponse) })]
    public class ExportOCIStackmonitoringMonitoringTemplate : OCIStackMonitoringCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ExportMonitoringTemplateRequest
                {
                ...
                response = client.ExportMonitoringTemplate(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private ExportMonitoringTemplateResponse response;
