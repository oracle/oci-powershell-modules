...
{
    [Cmdlet("Get", "OCIDevopsWorkRequest", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.WorkRequest), typeof(Oci.DevopsService.Responses.GetWorkRequestResponse) })]
    public class GetOCIDevopsWorkRequest : OCIDevopsCmdlet
    {
        
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID of the asynchronous work request.", ParameterSetName = StatusParamSet)]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID of the asynchronous work request.", ParameterSetName = Default)]
        ...
        public Oci.DevopsService.Models.OperationStatus[] WaitForStatus { get; set; }
