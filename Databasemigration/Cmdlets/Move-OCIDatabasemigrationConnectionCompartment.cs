...
{
    [Cmdlet("Move", "OCIDatabasemigrationConnectionCompartment")]
    [OutputType(new System.Type[] { typeof(void), typeof(Oci.DatabasemigrationService.Responses.ChangeConnectionCompartmentResponse) })]
    public class MoveOCIDatabasemigrationConnectionCompartment : OCIDatabaseMigrationCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ChangeConnectionCompartmentRequest
                {
                ...
                response = client.ChangeConnectionCompartment(request).GetAwaiter().GetResult();
        ...
        private ChangeConnectionCompartmentResponse response;
    }
}
