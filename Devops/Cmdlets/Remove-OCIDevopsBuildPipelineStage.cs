...
{
    [Cmdlet("Remove", "OCIDevopsBuildPipelineStage", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.DevopsService.Responses.DeleteBuildPipelineStageResponse) })]
    public class RemoveOCIDevopsBuildPipelineStage : OCIDevopsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIDevopsBuildPipelineStage", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteBuildPipelineStageRequest
                {
                ...
                response = client.DeleteBuildPipelineStage(request).GetAwaiter().GetResult();
        ...
        private DeleteBuildPipelineStageResponse response;
    }
}
