...
{
    [Cmdlet("Invoke", "OCIDevopsReviewPullRequest")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.PullRequest), typeof(Oci.DevopsService.Responses.ReviewPullRequestResponse) })]
    public class InvokeOCIDevopsReviewPullRequest : OCIDevopsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"unique PullRequest identifier")]
        public string PullRequestId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details to submit a review.")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new ReviewPullRequestRequest
                {
                ...
                response = client.ReviewPullRequest(request).GetAwaiter().GetResult();
        ...
        private ReviewPullRequestResponse response;
    }
}
