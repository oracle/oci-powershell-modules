...
{
    [Cmdlet("Get", "OCIIdentitydomainsMyApiKey")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.MyApiKey), typeof(Oci.IdentitydomainsService.Responses.GetMyApiKeyResponse) })]
    public class GetOCIIdentitydomainsMyApiKey : OCIIdentityDomainsCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetMyApiKeyRequest
                {
                ...
                response = client.GetMyApiKey(request).GetAwaiter().GetResult();
        ...
        private GetMyApiKeyResponse response;
    }
}
