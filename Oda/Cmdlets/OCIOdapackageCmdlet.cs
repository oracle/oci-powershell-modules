...
{
    public abstract class OCIOdapackageCmdlet : Oci.PSModules.Common.Cmdlets.OCICmdlet
    { 
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                client = new OdapackageClient(AuthProvider, new Oci.Common.ClientConfiguration
                {
        ...
        protected OdapackageClient client;
