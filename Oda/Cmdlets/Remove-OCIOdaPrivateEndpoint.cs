...
{
    [Cmdlet("Remove", "OCIOdaPrivateEndpoint", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OdaService.Responses.DeleteOdaPrivateEndpointResponse) })]
    public class RemoveOCIOdaPrivateEndpoint : OCIManagementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ConfirmDelete("OCIOdaPrivateEndpoint", "Remove"))
            {
               return;
            }
            ...
            try
            {
                request = new DeleteOdaPrivateEndpointRequest
                {
                ...
                response = client.DeleteOdaPrivateEndpoint(request).GetAwaiter().GetResult();
        ...
        private DeleteOdaPrivateEndpointResponse response;
    }
}
