...
{
    [Cmdlet("Invoke", "OCIIdentitydomainsSearchGrants")]
    [OutputType(new System.Type[] { typeof(Oci.IdentitydomainsService.Models.Grants), typeof(Oci.IdentitydomainsService.Responses.SearchGrantsResponse) })]
    public class InvokeOCIIdentitydomainsSearchGrants : OCIIdentityDomainsCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = @"Parameters for searching Grants")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.SearchGrants(request).GetAwaiter().GetResult();
                WriteOutput(response, response.Grants);
        ...
        private SearchGrantsResponse response;
    }
}
