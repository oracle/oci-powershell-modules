...
{
    [Cmdlet("Invoke", "OCIGovernancerulescontrolplaneRetryGovernanceRule")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.GovernancerulescontrolplaneService.Responses.RetryGovernanceRuleResponse) })]
    public class InvokeOCIGovernancerulescontrolplaneRetryGovernanceRule : OCIGovernanceRuleCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new RetryGovernanceRuleRequest
                {
                ...
                response = client.RetryGovernanceRule(request).GetAwaiter().GetResult();
        ...
        private RetryGovernanceRuleResponse response;
    }
}
