...
namespace Oci.DataccService.Cmdlets
{
     ...
     */
    [Cmdlet("Invoke", "OCIDataccDownloadInfrastructureValidationScript", DefaultParameterSetName = Default)]
    [OutputType(new System.Type[] { typeof(System.IO.Stream), typeof(void), typeof(Oci.DataccService.Responses.DownloadInfrastructureValidationScriptResponse) })]
    public class InvokeOCIDataccDownloadInfrastructureValidationScript : OCIBaseinfraCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new DownloadInfrastructureValidationScriptRequest
                {
                    InfrastructureId = InfrastructureId,
                    OpcRequestId = OpcRequestId
                };

                response = client.DownloadInfrastructureValidationScript(request).GetAwaiter().GetResult();
                HandleOutput();
        ...
        private DownloadInfrastructureValidationScriptResponse response;
