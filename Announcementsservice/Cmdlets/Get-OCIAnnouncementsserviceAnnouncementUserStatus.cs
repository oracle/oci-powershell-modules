...
{
    [Cmdlet("Get", "OCIAnnouncementsserviceAnnouncementUserStatus")]
    [OutputType(new System.Type[] { typeof(Oci.AnnouncementsService.Models.AnnouncementUserStatusDetails), typeof(Oci.AnnouncementsService.Responses.GetAnnouncementUserStatusResponse) })]
    public class GetOCIAnnouncementsserviceAnnouncementUserStatus : OCIAnnouncementCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new GetAnnouncementUserStatusRequest
                {
                    AnnouncementId = AnnouncementId,
                    OpcRequestId = OpcRequestId
                };

                response = client.GetAnnouncementUserStatus(request).GetAwaiter().GetResult();
        ...
        private GetAnnouncementUserStatusResponse response;
    }
}
