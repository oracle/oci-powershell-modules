...
{
    [Cmdlet("Update", "OCIOceInstance")]
    [OutputType(new System.Type[] { typeof(Oci.PSModules.Common.Cmdlets.WorkRequest), typeof(Oci.OceService.Responses.UpdateOceInstanceResponse) })]
    public class UpdateOCIOceInstance : OCIOceInstanceCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                request = new UpdateOceInstanceRequest
                {
                ...
                response = client.UpdateOceInstance(request).GetAwaiter().GetResult();
        ...
        private UpdateOceInstanceResponse response;
    }
}
