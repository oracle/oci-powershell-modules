...
{
    [Cmdlet("New", "OCIDevopsOrUpdateProtectedBranch")]
    [OutputType(new System.Type[] { typeof(Oci.DevopsService.Models.ProtectedBranch), typeof(Oci.DevopsService.Responses.CreateOrUpdateProtectedBranchResponse) })]
    public class NewOCIDevopsOrUpdateProtectedBranch : OCIDevopsCmdlet
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Unique repository identifier.")]
        public string RepositoryId { get; set; }

        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for a protected branch")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                response = client.CreateOrUpdateProtectedBranch(request).GetAwaiter().GetResult();
                WriteOutput(response, response.ProtectedBranch);
        ...
        private CreateOrUpdateProtectedBranchResponse response;
    }
}
