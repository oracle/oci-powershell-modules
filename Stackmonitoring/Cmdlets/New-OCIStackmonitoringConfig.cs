...
{
    [Cmdlet("New", "OCIStackmonitoringConfig")]
    ...
    {
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"Details for the new configuration. This parameter also accepts subtypes <Oci.StackmonitoringService.Models.CreateLicenseAutoAssignConfigDetails>, <Oci.StackmonitoringService.Models.CreateOnboardConfigDetails>, <Oci.StackmonitoringService.Models.CreateAutoPromoteConfigDetails>, <Oci.StackmonitoringService.Models.CreateComputeAutoActivatePluginConfigDetails>, <Oci.StackmonitoringService.Models.CreateLicenseEnterpriseExtensibilityConfigDetails> of type <Oci.StackmonitoringService.Models.CreateConfigDetails>.")]
